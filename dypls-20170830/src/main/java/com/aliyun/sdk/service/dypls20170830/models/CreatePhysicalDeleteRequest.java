...
/**
 * {@link CreatePhysicalDeleteRequest} extends {@link RequestModel}
 *
 * <p>CreatePhysicalDeleteRequest</p>
 */
public class CreatePhysicalDeleteRequest extends Request {
    @Query
    @NameInMap("Bid")
    ...
    private CreatePhysicalDeleteRequest(Builder builder) {
        super(builder);
    ...
    public static CreatePhysicalDeleteRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreatePhysicalDeleteRequest, Builder> {
        private String bid; 
        private String country; 
        private String gmtWakeup; 
        private Long hid; 
        ...
        private Builder(CreatePhysicalDeleteRequest request) {
            super(request);
        ...
        @Override
        public CreatePhysicalDeleteRequest build() {
            return new CreatePhysicalDeleteRequest(this);
        } 
