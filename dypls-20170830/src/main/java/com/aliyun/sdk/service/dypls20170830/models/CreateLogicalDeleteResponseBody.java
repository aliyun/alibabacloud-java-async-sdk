...
/**
 * {@link CreateLogicalDeleteResponseBody} extends {@link TeaModel}
 *
 * <p>CreateLogicalDeleteResponseBody</p>
 */
public class CreateLogicalDeleteResponseBody extends TeaModel {
    ...
    private CreateLogicalDeleteResponseBody(Builder builder) {
    ...
    public static CreateLogicalDeleteResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateLogicalDeleteResponseBody build() {
            return new CreateLogicalDeleteResponseBody(this);
        } 
