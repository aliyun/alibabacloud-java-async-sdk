...
/**
 * {@link CreatePhysicalDeleteResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePhysicalDeleteResponseBody</p>
 */
public class CreatePhysicalDeleteResponseBody extends TeaModel {
    ...
    private CreatePhysicalDeleteResponseBody(Builder builder) {
    ...
    public static CreatePhysicalDeleteResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreatePhysicalDeleteResponseBody build() {
            return new CreatePhysicalDeleteResponseBody(this);
        } 
