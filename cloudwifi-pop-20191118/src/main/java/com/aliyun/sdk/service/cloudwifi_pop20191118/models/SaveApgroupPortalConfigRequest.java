...
/**
 * 
 * {@link SaveApgroupPortalConfigRequest} extends {@link RequestModel}
 *
 * <p>SaveApgroupPortalConfigRequest</p>
 */
public class SaveApgroupPortalConfigRequest extends Request {
    ...
    private SaveApgroupPortalConfigRequest(Builder builder) {
        super(builder);
    ...
    public static SaveApgroupPortalConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SaveApgroupPortalConfigRequest, Builder> {
        private Long apgroupId; 
        private String appAuthUrl; 
        private String appCode; 
        private String appName; 
        ...
        private Builder(SaveApgroupPortalConfigRequest request) {
            super(request);
        ...
        @Override
        public SaveApgroupPortalConfigRequest build() {
            return new SaveApgroupPortalConfigRequest(this);
        } 
