...
/**
 * 
 * {@link SaveApBasicConfigRequest} extends {@link RequestModel}
 *
 * <p>SaveApBasicConfigRequest</p>
 */
public class SaveApBasicConfigRequest extends Request {
    ...
    private SaveApBasicConfigRequest(Builder builder) {
        super(builder);
    ...
    public static SaveApBasicConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SaveApBasicConfigRequest, Builder> {
        private String appCode; 
        private String appName; 
        private String country; 
        private String dai; 
        ...
        private Builder(SaveApBasicConfigRequest request) {
            super(request);
        ...
        @Override
        public SaveApBasicConfigRequest build() {
            return new SaveApBasicConfigRequest(this);
        } 
