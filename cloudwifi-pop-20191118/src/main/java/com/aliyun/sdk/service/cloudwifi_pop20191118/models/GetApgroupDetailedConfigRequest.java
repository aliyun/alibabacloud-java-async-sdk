...
/**
 * 
 * {@link GetApgroupDetailedConfigRequest} extends {@link RequestModel}
 *
 * <p>GetApgroupDetailedConfigRequest</p>
 */
public class GetApgroupDetailedConfigRequest extends Request {
    ...
    private GetApgroupDetailedConfigRequest(Builder builder) {
        super(builder);
    ...
    public static GetApgroupDetailedConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetApgroupDetailedConfigRequest, Builder> {
        private Long apgroupId; 
        private String apgroupUuid; 
        private String appCode; 
        private String appName; 
        ...
        private Builder(GetApgroupDetailedConfigRequest request) {
            super(request);
        ...
        @Override
        public GetApgroupDetailedConfigRequest build() {
            return new GetApgroupDetailedConfigRequest(this);
        } 
