...
/**
 * 
 * {@link ListJobOrdersRequest} extends {@link RequestModel}
 *
 * <p>ListJobOrdersRequest</p>
 */
public class ListJobOrdersRequest extends Request {
    ...
    private ListJobOrdersRequest(Builder builder) {
        super(builder);
    ...
    public static ListJobOrdersRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListJobOrdersRequest, Builder> {
        private String appCode; 
        private String appName; 
        private String changingType; 
        private String clientSystem; 
        ...
        private Builder(ListJobOrdersRequest request) {
            super(request);
        ...
        @Override
        public ListJobOrdersRequest build() {
            return new ListJobOrdersRequest(this);
        } 
