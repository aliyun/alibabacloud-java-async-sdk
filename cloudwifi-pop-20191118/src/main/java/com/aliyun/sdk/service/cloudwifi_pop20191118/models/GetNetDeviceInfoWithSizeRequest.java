...
/**
 * 
 * {@link GetNetDeviceInfoWithSizeRequest} extends {@link RequestModel}
 *
 * <p>GetNetDeviceInfoWithSizeRequest</p>
 */
public class GetNetDeviceInfoWithSizeRequest extends Request {
    ...
    private GetNetDeviceInfoWithSizeRequest(Builder builder) {
        super(builder);
    ...
    public static GetNetDeviceInfoWithSizeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetNetDeviceInfoWithSizeRequest, Builder> {
        private String appCode; 
        private String appName; 
        private Long cursor; 
        private String hostName; 
        ...
        private Builder(GetNetDeviceInfoWithSizeRequest request) {
            super(request);
        ...
        @Override
        public GetNetDeviceInfoWithSizeRequest build() {
            return new GetNetDeviceInfoWithSizeRequest(this);
        } 
