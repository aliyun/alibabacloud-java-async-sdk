...
/**
 * 
 * {@link NewNetDeviceInfoRequest} extends {@link RequestModel}
 *
 * <p>NewNetDeviceInfoRequest</p>
 */
public class NewNetDeviceInfoRequest extends Request {
    ...
    private NewNetDeviceInfoRequest(Builder builder) {
        super(builder);
    ...
    public static NewNetDeviceInfoRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<NewNetDeviceInfoRequest, Builder> {
        private String appCode; 
        private String appName; 
        private java.util.List<Devices> devices; 
        private String requestId; 
        ...
        private Builder(NewNetDeviceInfoRequest request) {
            super(request);
        ...
        @Override
        public NewNetDeviceInfoRequest build() {
            return new NewNetDeviceInfoRequest(this);
        } 
    ...
    /**
     * 
     * {@link NewNetDeviceInfoRequest} extends {@link TeaModel}
     *
     * <p>NewNetDeviceInfoRequest</p>
     */
