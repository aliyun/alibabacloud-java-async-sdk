...
/**
 * 
 * {@link EnterpriseContactEditRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseContactEditRequest</p>
 */
public class EnterpriseContactEditRequest extends Request {
    ...
    private EnterpriseContactEditRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseContactEditRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseContactEditRequest, Builder> {
        private String appName; 
        private Boolean asyncEmailVerify; 
        private Boolean asyncMobileVerify; 
        private String contactEmail; 
        ...
        private Builder(EnterpriseContactEditRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseContactEditRequest build() {
            return new EnterpriseContactEditRequest(this);
        } 
