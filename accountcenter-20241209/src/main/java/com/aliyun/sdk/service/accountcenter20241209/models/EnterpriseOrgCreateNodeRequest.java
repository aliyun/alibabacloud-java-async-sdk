...
/**
 * 
 * {@link EnterpriseOrgCreateNodeRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseOrgCreateNodeRequest</p>
 */
public class EnterpriseOrgCreateNodeRequest extends Request {
    ...
    private EnterpriseOrgCreateNodeRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseOrgCreateNodeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseOrgCreateNodeRequest, Builder> {
        private String appName; 
        private String bizName; 
        private java.util.Map<String, ?> ext; 
        private Boolean isOpenApi; 
        ...
        private Builder(EnterpriseOrgCreateNodeRequest request) {
            super(request);
            ...
            this.parentNodeType = request.parentNodeType;
        ...
        public Builder parentNodeType(String parentNodeType) {
            this.putBodyParameter("ParentNodeType", parentNodeType);
        ...
        @Override
        public EnterpriseOrgCreateNodeRequest build() {
            return new EnterpriseOrgCreateNodeRequest(this);
        } 
