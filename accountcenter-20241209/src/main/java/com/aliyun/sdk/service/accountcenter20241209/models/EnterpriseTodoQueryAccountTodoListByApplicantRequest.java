...
/**
 * 
 * {@link EnterpriseTodoQueryAccountTodoListByApplicantRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseTodoQueryAccountTodoListByApplicantRequest</p>
 */
public class EnterpriseTodoQueryAccountTodoListByApplicantRequest extends Request {
    ...
    private EnterpriseTodoQueryAccountTodoListByApplicantRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseTodoQueryAccountTodoListByApplicantRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseTodoQueryAccountTodoListByApplicantRequest, Builder> {
        private String appName; 
        private Integer maxResults; 
        private String nextToken; 
        private String operatePk; 
        ...
        private Builder(EnterpriseTodoQueryAccountTodoListByApplicantRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseTodoQueryAccountTodoListByApplicantRequest build() {
            return new EnterpriseTodoQueryAccountTodoListByApplicantRequest(this);
        } 
