...
/**
 * 
 * {@link AccountContactAddRequest} extends {@link RequestModel}
 *
 * <p>AccountContactAddRequest</p>
 */
public class AccountContactAddRequest extends Request {
    ...
    private AccountContactAddRequest(Builder builder) {
        super(builder);
    ...
    public static AccountContactAddRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AccountContactAddRequest, Builder> {
        private String appName; 
        private Boolean asyncEmailVerify; 
        private Boolean asyncMobileVerify; 
        private String contactEmail; 
        ...
        private Builder(AccountContactAddRequest request) {
            super(request);
        ...
        @Override
        public AccountContactAddRequest build() {
            return new AccountContactAddRequest(this);
        } 
