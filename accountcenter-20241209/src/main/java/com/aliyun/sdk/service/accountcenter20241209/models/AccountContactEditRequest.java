...
/**
 * 
 * {@link AccountContactEditRequest} extends {@link RequestModel}
 *
 * <p>AccountContactEditRequest</p>
 */
public class AccountContactEditRequest extends Request {
    ...
    private AccountContactEditRequest(Builder builder) {
        super(builder);
    ...
    public static AccountContactEditRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AccountContactEditRequest, Builder> {
        private String appName; 
        private Boolean asyncEmailVerify; 
        private Boolean asyncMobileVerify; 
        private String contactEmail; 
        ...
        private Builder(AccountContactEditRequest request) {
            super(request);
        ...
        @Override
        public AccountContactEditRequest build() {
            return new AccountContactEditRequest(this);
        } 
