...
/**
 * 
 * {@link EnterpriseContactQueryDetailResponseBody} extends {@link TeaModel}
 *
 * <p>EnterpriseContactQueryDetailResponseBody</p>
 */
public class EnterpriseContactQueryDetailResponseBody extends TeaModel {
    ...
    private EnterpriseContactQueryDetailResponseBody(Builder builder) {
    ...
    public static EnterpriseContactQueryDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnterpriseContactQueryDetailResponseBody model) {
        ...
        public EnterpriseContactQueryDetailResponseBody build() {
            return new EnterpriseContactQueryDetailResponseBody(this);
        } 
