...
/**
 * 
 * {@link EnterpriseContactQueryPageListResponseBody} extends {@link TeaModel}
 *
 * <p>EnterpriseContactQueryPageListResponseBody</p>
 */
public class EnterpriseContactQueryPageListResponseBody extends TeaModel {
    ...
    private EnterpriseContactQueryPageListResponseBody(Builder builder) {
    ...
    public static EnterpriseContactQueryPageListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnterpriseContactQueryPageListResponseBody model) {
        ...
        public EnterpriseContactQueryPageListResponseBody build() {
            return new EnterpriseContactQueryPageListResponseBody(this);
        } 
