...
/**
 * 
 * {@link AccountContactQueryPageListRequest} extends {@link RequestModel}
 *
 * <p>AccountContactQueryPageListRequest</p>
 */
public class AccountContactQueryPageListRequest extends Request {
    ...
    private AccountContactQueryPageListRequest(Builder builder) {
        super(builder);
    ...
    public static AccountContactQueryPageListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AccountContactQueryPageListRequest, Builder> {
        private String appName; 
        private String orientedEcId; 
        private String orientedLeId; 
        private String orientedNbId; 
        ...
        private Builder(AccountContactQueryPageListRequest request) {
            super(request);
        ...
        @Override
        public AccountContactQueryPageListRequest build() {
            return new AccountContactQueryPageListRequest(this);
        } 
