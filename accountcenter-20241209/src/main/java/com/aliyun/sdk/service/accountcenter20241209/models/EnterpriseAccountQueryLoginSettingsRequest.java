...
/**
 * 
 * {@link EnterpriseAccountQueryLoginSettingsRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseAccountQueryLoginSettingsRequest</p>
 */
public class EnterpriseAccountQueryLoginSettingsRequest extends Request {
    ...
    private EnterpriseAccountQueryLoginSettingsRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseAccountQueryLoginSettingsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseAccountQueryLoginSettingsRequest, Builder> {
        private String appName; 
        private Boolean isOpenApi; 
        private String orientedEcId; 
        private String orientedLeId; 
        ...
        private Builder(EnterpriseAccountQueryLoginSettingsRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseAccountQueryLoginSettingsRequest build() {
            return new EnterpriseAccountQueryLoginSettingsRequest(this);
        } 
