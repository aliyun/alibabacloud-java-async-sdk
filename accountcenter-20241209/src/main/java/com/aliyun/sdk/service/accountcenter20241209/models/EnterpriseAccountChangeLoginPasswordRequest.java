...
/**
 * 
 * {@link EnterpriseAccountChangeLoginPasswordRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseAccountChangeLoginPasswordRequest</p>
 */
public class EnterpriseAccountChangeLoginPasswordRequest extends Request {
    ...
    private EnterpriseAccountChangeLoginPasswordRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseAccountChangeLoginPasswordRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseAccountChangeLoginPasswordRequest, Builder> {
        private String appName; 
        private String encryptPassword; 
        private String orientedEcId; 
        private String orientedLeId; 
        ...
        private Builder(EnterpriseAccountChangeLoginPasswordRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseAccountChangeLoginPasswordRequest build() {
            return new EnterpriseAccountChangeLoginPasswordRequest(this);
        } 
