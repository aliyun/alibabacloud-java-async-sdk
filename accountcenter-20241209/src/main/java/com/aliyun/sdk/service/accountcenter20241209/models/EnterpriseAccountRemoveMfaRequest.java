...
/**
 * 
 * {@link EnterpriseAccountRemoveMfaRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseAccountRemoveMfaRequest</p>
 */
public class EnterpriseAccountRemoveMfaRequest extends Request {
    ...
    private EnterpriseAccountRemoveMfaRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseAccountRemoveMfaRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseAccountRemoveMfaRequest, Builder> {
        private String appName; 
        private String orientedEcId; 
        private String orientedLeId; 
        private String orientedNbId; 
        ...
        private Builder(EnterpriseAccountRemoveMfaRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseAccountRemoveMfaRequest build() {
            return new EnterpriseAccountRemoveMfaRequest(this);
        } 
