...
/**
 * 
 * {@link AccountContactEditResponseBody} extends {@link TeaModel}
 *
 * <p>AccountContactEditResponseBody</p>
 */
public class AccountContactEditResponseBody extends TeaModel {
    ...
    private AccountContactEditResponseBody(Builder builder) {
    ...
    public static AccountContactEditResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AccountContactEditResponseBody model) {
        ...
        public AccountContactEditResponseBody build() {
            return new AccountContactEditResponseBody(this);
        } 
