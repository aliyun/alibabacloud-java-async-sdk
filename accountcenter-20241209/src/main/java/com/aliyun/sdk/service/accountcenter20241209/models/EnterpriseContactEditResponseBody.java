...
/**
 * 
 * {@link EnterpriseContactEditResponseBody} extends {@link TeaModel}
 *
 * <p>EnterpriseContactEditResponseBody</p>
 */
public class EnterpriseContactEditResponseBody extends TeaModel {
    ...
    private EnterpriseContactEditResponseBody(Builder builder) {
    ...
    public static EnterpriseContactEditResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnterpriseContactEditResponseBody model) {
        ...
        public EnterpriseContactEditResponseBody build() {
            return new EnterpriseContactEditResponseBody(this);
        } 
