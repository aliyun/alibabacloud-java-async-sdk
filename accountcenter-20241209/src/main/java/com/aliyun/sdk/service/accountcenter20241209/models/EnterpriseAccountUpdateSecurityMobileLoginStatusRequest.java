...
/**
 * 
 * {@link EnterpriseAccountUpdateSecurityMobileLoginStatusRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseAccountUpdateSecurityMobileLoginStatusRequest</p>
 */
public class EnterpriseAccountUpdateSecurityMobileLoginStatusRequest extends Request {
    ...
    private EnterpriseAccountUpdateSecurityMobileLoginStatusRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseAccountUpdateSecurityMobileLoginStatusRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseAccountUpdateSecurityMobileLoginStatusRequest, Builder> {
        private String appName; 
        private String orientedEcId; 
        private String orientedLeId; 
        private String orientedNbId; 
        ...
        private Builder(EnterpriseAccountUpdateSecurityMobileLoginStatusRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseAccountUpdateSecurityMobileLoginStatusRequest build() {
            return new EnterpriseAccountUpdateSecurityMobileLoginStatusRequest(this);
        } 
