...
/**
 * 
 * {@link EnterpriseContactQueryDetailRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseContactQueryDetailRequest</p>
 */
public class EnterpriseContactQueryDetailRequest extends Request {
    ...
    private EnterpriseContactQueryDetailRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseContactQueryDetailRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseContactQueryDetailRequest, Builder> {
        private String appName; 
        private Long contactId; 
        private String orientedEcId; 
        private String orientedLeId; 
        ...
        private Builder(EnterpriseContactQueryDetailRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseContactQueryDetailRequest build() {
            return new EnterpriseContactQueryDetailRequest(this);
        } 
