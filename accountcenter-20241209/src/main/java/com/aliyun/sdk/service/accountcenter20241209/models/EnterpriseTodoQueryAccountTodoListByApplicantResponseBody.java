...
/**
 * 
 * {@link EnterpriseTodoQueryAccountTodoListByApplicantResponseBody} extends {@link TeaModel}
 *
 * <p>EnterpriseTodoQueryAccountTodoListByApplicantResponseBody</p>
 */
public class EnterpriseTodoQueryAccountTodoListByApplicantResponseBody extends TeaModel {
    ...
    private EnterpriseTodoQueryAccountTodoListByApplicantResponseBody(Builder builder) {
    ...
    public static EnterpriseTodoQueryAccountTodoListByApplicantResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnterpriseTodoQueryAccountTodoListByApplicantResponseBody model) {
        ...
        public EnterpriseTodoQueryAccountTodoListByApplicantResponseBody build() {
            return new EnterpriseTodoQueryAccountTodoListByApplicantResponseBody(this);
        } 
