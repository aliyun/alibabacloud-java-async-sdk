...
/**
 * 
 * {@link EnterpriseContactDeleteRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseContactDeleteRequest</p>
 */
public class EnterpriseContactDeleteRequest extends Request {
    ...
    private EnterpriseContactDeleteRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseContactDeleteRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseContactDeleteRequest, Builder> {
        private String appName; 
        private Long contactId; 
        private String orientedEcId; 
        private String orientedLeId; 
        ...
        private Builder(EnterpriseContactDeleteRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseContactDeleteRequest build() {
            return new EnterpriseContactDeleteRequest(this);
        } 
