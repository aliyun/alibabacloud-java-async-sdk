...
/**
 * 
 * {@link EnterpriseContactAddResponseBody} extends {@link TeaModel}
 *
 * <p>EnterpriseContactAddResponseBody</p>
 */
public class EnterpriseContactAddResponseBody extends TeaModel {
    ...
    private EnterpriseContactAddResponseBody(Builder builder) {
    ...
    public static EnterpriseContactAddResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnterpriseContactAddResponseBody model) {
        ...
        public EnterpriseContactAddResponseBody build() {
            return new EnterpriseContactAddResponseBody(this);
        } 
