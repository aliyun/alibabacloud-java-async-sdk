...
/**
 * 
 * {@link EnterpriseRoleQueryBizRoleDetailRequest} extends {@link RequestModel}
 *
 * <p>EnterpriseRoleQueryBizRoleDetailRequest</p>
 */
public class EnterpriseRoleQueryBizRoleDetailRequest extends Request {
    ...
    private EnterpriseRoleQueryBizRoleDetailRequest(Builder builder) {
        super(builder);
    ...
    public static EnterpriseRoleQueryBizRoleDetailRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnterpriseRoleQueryBizRoleDetailRequest, Builder> {
        private String bizRoleCode; 
        private String encryptTicket; 
        private String orientedEcId; 
        private String orientedLeId; 
        ...
        private Builder(EnterpriseRoleQueryBizRoleDetailRequest request) {
            super(request);
        ...
        @Override
        public EnterpriseRoleQueryBizRoleDetailRequest build() {
            return new EnterpriseRoleQueryBizRoleDetailRequest(this);
        } 
