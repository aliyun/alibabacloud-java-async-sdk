...
/**
 * 
 * {@link AccountContactQueryDetailRequest} extends {@link RequestModel}
 *
 * <p>AccountContactQueryDetailRequest</p>
 */
public class AccountContactQueryDetailRequest extends Request {
    ...
    private AccountContactQueryDetailRequest(Builder builder) {
        super(builder);
    ...
    public static AccountContactQueryDetailRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AccountContactQueryDetailRequest, Builder> {
        private String appName; 
        private Long contactId; 
        private String orientedEcId; 
        private String orientedLeId; 
        ...
        private Builder(AccountContactQueryDetailRequest request) {
            super(request);
        ...
        @Override
        public AccountContactQueryDetailRequest build() {
            return new AccountContactQueryDetailRequest(this);
        } 
