...
public class GetDocumentListResponseBody extends TeaModel {
    ...
    private GetDocumentListResponseBody(Builder builder) {
    ...
    public static GetDocumentListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetDocumentListResponseBody model) {
        ...
        public GetDocumentListResponseBody build() {
            return new GetDocumentListResponseBody(this);
        } 
