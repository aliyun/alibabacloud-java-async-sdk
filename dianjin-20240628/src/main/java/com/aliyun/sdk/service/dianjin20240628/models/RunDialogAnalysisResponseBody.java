...
/**
 * 
 * {@link RunDialogAnalysisResponseBody} extends {@link TeaModel}
 *
 * <p>RunDialogAnalysisResponseBody</p>
 */
public class RunDialogAnalysisResponseBody extends TeaModel {
    ...
    private RunDialogAnalysisResponseBody(Builder builder) {
    ...
    public static RunDialogAnalysisResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RunDialogAnalysisResponseBody model) {
        ...
        public RunDialogAnalysisResponseBody build() {
            return new RunDialogAnalysisResponseBody(this);
        } 
    ...
    public static class DialogAnalysisRespList extends TeaModel {
        ...
        @com.aliyun.core.annotation.NameInMap("failNode")
        private java.util.List<String> failNode;
        ...
        private DialogAnalysisRespList(Builder builder) {
            ...
            this.failNode = builder.failNode;
