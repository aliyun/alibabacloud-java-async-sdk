...
/**
 * 
 * {@link GetReportTaskStatusRequest} extends {@link RequestModel}
 *
 * <p>GetReportTaskStatusRequest</p>
 */
public class GetReportTaskStatusRequest extends Request {
    ...
    private GetReportTaskStatusRequest(Builder builder) {
        super(builder);
    ...
    public static GetReportTaskStatusRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetReportTaskStatusRequest, Builder> {
        private String workspaceId; 
        private String sceneCode; 
        private String fundProduct; 
        private String outRequestNo; 
        ...
        private Builder(GetReportTaskStatusRequest request) {
            super(request);
        ...
        @Override
        public GetReportTaskStatusRequest build() {
            return new GetReportTaskStatusRequest(this);
        } 
