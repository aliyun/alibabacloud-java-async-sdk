...
/**
 * 
 * {@link GetLibraryListResponseBody} extends {@link TeaModel}
 *
 * <p>GetLibraryListResponseBody</p>
 */
public class GetLibraryListResponseBody extends TeaModel {
    ...
    private GetLibraryListResponseBody(Builder builder) {
    ...
    public static GetLibraryListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetLibraryListResponseBody model) {
        ...
        public GetLibraryListResponseBody build() {
            return new GetLibraryListResponseBody(this);
        } 
