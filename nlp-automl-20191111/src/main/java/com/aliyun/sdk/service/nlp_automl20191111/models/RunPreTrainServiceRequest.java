...
/**
 * {@link RunPreTrainServiceRequest} extends {@link RequestModel}
 *
 * <p>RunPreTrainServiceRequest</p>
 */
public class RunPreTrainServiceRequest extends Request {
    @Body
    ...
    private RunPreTrainServiceRequest(Builder builder) {
        super(builder);
    ...
    public static RunPreTrainServiceRequest create() {
    ...
    public static final class Builder extends Request.Builder<RunPreTrainServiceRequest, Builder> {
        private String predictContent; 
        private String serviceName; 
        private String serviceVersion; 
        ...
        private Builder(RunPreTrainServiceRequest request) {
            super(request);
        ...
        @Override
        public RunPreTrainServiceRequest build() {
            return new RunPreTrainServiceRequest(this);
        } 
