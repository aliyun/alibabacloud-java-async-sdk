...
/**
 * {@link ValidateConfigSettingResponseBody} extends {@link TeaModel}
 *
 * <p>ValidateConfigSettingResponseBody</p>
 */
public class ValidateConfigSettingResponseBody extends TeaModel {
    ...
    private ConfigValidationResults configValidationResults;
    ...
    private ValidateConfigSettingResponseBody(Builder builder) {
        this.code = builder.code;
        this.configValidationResults = builder.configValidationResults;
    ...
    public static ValidateConfigSettingResponseBody create() {
     ...
     */
    public ConfigValidationResults getConfigValidationResults() {
    ...
    public static final class Builder {
         ...
         */
        public Builder configValidationResults(ConfigValidationResults configValidationResults) {
        ...
        public ValidateConfigSettingResponseBody build() {
            return new ValidateConfigSettingResponseBody(this);
        } 
    ...
    public static class ConfigValidationResult extends TeaModel {
        ...
        private ConfigValidationResult(Builder builder) {
            this.configOption = builder.configOption;
            this.optionName = builder.optionName;
            this.pathName = builder.pathName;
            this.resultMessage = builder.resultMessage;
            this.resultSeverity = builder.resultSeverity;
        }
        ...
        public static ConfigValidationResult create() {
            return builder().build();
        }
        ...
        public static final class Builder {
             ...
             * ConfigOption.
             */
            public Builder configOption(ConfigOption configOption) {
             ...
             * ResultSeverity.
             */
            public Builder resultSeverity(String resultSeverity) {
                this.resultSeverity = resultSeverity;
                return this;
            }

            public ConfigValidationResult build() {
                return new ConfigValidationResult(this);
            } 

        } 

    }
    public static class ConfigValidationResults extends TeaModel {
        @NameInMap("ConfigValidationResult")
        private java.util.List < ConfigValidationResult> configValidationResult;

        private ConfigValidationResults(Builder builder) {
            this.configValidationResult = builder.configValidationResult;
        }
        ...
        public static ConfigValidationResults create() {
            return builder().build();
        }
         ...
         */
        public java.util.List < ConfigValidationResult> getConfigValidationResult() {
        ...
        public static final class Builder {
             ...
             */
            public Builder configValidationResult(java.util.List < ConfigValidationResult> configValidationResult) {
                this.configValidationResult = configValidationResult;
                return this;
            }

            public ConfigValidationResults build() {
                return new ConfigValidationResults(this);
            } 
