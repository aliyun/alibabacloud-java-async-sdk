...
/**
 * {@link DescribeGatherLogResultResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeGatherLogResultResponseBody</p>
 */
public class DescribeGatherLogResultResponseBody extends TeaModel {
    ...
    private GatherLogResult gatherLogResult;
    ...
    private DescribeGatherLogResultResponseBody(Builder builder) {
        this.code = builder.code;
        this.gatherLogResult = builder.gatherLogResult;
    ...
    public static DescribeGatherLogResultResponseBody create() {
     ...
     */
    public GatherLogResult getGatherLogResult() {
    ...
    public static final class Builder {
         ...
         * GatherLogResult.
         */
        public Builder gatherLogResult(GatherLogResult gatherLogResult) {
        ...
        public DescribeGatherLogResultResponseBody build() {
            return new DescribeGatherLogResultResponseBody(this);
        } 
    ...
    public static class GatherLogResult extends TeaModel {
        @NameInMap("Change")
        ...
        private GatherLogResult(Builder builder) {
        ...
        public static GatherLogResult create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public GatherLogResult build() {
                return new GatherLogResult(this);
            } 
