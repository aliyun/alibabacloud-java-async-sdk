...
/**
 * {@link DescribeConfigIndexResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeConfigIndexResponseBody</p>
 */
public class DescribeConfigIndexResponseBody extends TeaModel {
    ...
    private ConfigGroups configGroups;
    ...
    private DescribeConfigIndexResponseBody(Builder builder) {
        this.code = builder.code;
        this.configGroups = builder.configGroups;
    ...
    public static DescribeConfigIndexResponseBody create() {
     ...
     * @return configGroups
     */
    public ConfigGroups getConfigGroups() {
    ...
    public static final class Builder {
         ...
         * ConfigGroups.
         */
        public Builder configGroups(ConfigGroups configGroups) {
        ...
        public DescribeConfigIndexResponseBody build() {
            return new DescribeConfigIndexResponseBody(this);
        } 
    ...
    public static class ConfigPath extends TeaModel {
        ...
        private ConfigPath(Builder builder) {
            ...
            this.hiddenPath = builder.hiddenPath;
            this.pathLabel = builder.pathLabel;
            this.pathName = builder.pathName;
        }
        ...
        public static ConfigPath create() {
            return builder().build();
        }
        ...
        public static final class Builder {
             ...
             * HiddenPath.
             */
            public Builder hiddenPath(Boolean hiddenPath) {
             ...
             * PathLabel.
             */
            public Builder pathLabel(String pathLabel) {
    ...
    public static class ConfigPaths extends TeaModel {
        @NameInMap("ConfigPath")
        private java.util.List < ConfigPath> configPath;

        private ConfigPaths(Builder builder) {
        ...
        public static ConfigPaths create() {
            return builder().build();
        }
         ...
         * @return configPath
         */
        public java.util.List < ConfigPath> getConfigPath() {
        ...
        public static final class Builder {
             ...
             * ConfigPath.
             */
            public Builder configPath(java.util.List < ConfigPath> configPath) {
                this.configPath = configPath;
                return this;
            }

            public ConfigPaths build() {
    ...
    public static class ConfigGroups extends TeaModel {
        @NameInMap("ConfigGroup")
        private java.util.List < ConfigGroup> configGroup;

        private ConfigGroups(Builder builder) {
        ...
        public static ConfigGroups create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public ConfigGroups build() {
                return new ConfigGroups(this);
            } 
