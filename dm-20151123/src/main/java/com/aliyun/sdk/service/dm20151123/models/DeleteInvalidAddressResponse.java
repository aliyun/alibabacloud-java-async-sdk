...
/**
 * {@link DeleteInvalidAddressResponse} extends {@link TeaModel}
 *
 * <p>DeleteInvalidAddressResponse</p>
 */
public class DeleteInvalidAddressResponse extends Response {
    @NameInMap("headers")
    ...
    public static DeleteInvalidAddressResponse create() {
    ...
    public interface Builder extends Response.Builder<DeleteInvalidAddressResponse, Builder> {
        ...
        @Override
        DeleteInvalidAddressResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DeleteInvalidAddressResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DeleteInvalidAddressResponse build() {
            return new DeleteInvalidAddressResponse(this);
        } 
