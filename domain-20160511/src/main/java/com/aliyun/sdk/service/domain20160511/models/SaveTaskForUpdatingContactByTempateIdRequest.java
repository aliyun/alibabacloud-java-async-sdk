...
/**
 * 
 * {@link SaveTaskForUpdatingContactByTempateIdRequest} extends {@link RequestModel}
 *
 * <p>SaveTaskForUpdatingContactByTempateIdRequest</p>
 */
public class SaveTaskForUpdatingContactByTempateIdRequest extends Request {
    ...
    private SaveTaskForUpdatingContactByTempateIdRequest(Builder builder) {
        super(builder);
    ...
    public static SaveTaskForUpdatingContactByTempateIdRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SaveTaskForUpdatingContactByTempateIdRequest, Builder> {
        private Boolean addTransferLock; 
        private Long contactTemplateId; 
        private String contactType; 
        private String domainName; 
        ...
        private Builder(SaveTaskForUpdatingContactByTempateIdRequest request) {
            super(request);
        ...
        @Override
        public SaveTaskForUpdatingContactByTempateIdRequest build() {
            return new SaveTaskForUpdatingContactByTempateIdRequest(this);
        } 
