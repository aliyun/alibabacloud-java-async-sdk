...
/**
 * {@link PreCheckCreateOrderForCreateDBNodesResponseBody} extends {@link TeaModel}
 *
 * <p>PreCheckCreateOrderForCreateDBNodesResponseBody</p>
 */
public class PreCheckCreateOrderForCreateDBNodesResponseBody extends TeaModel {
    ...
    private PreCheckCreateOrderForCreateDBNodesResponseBody(Builder builder) {
    ...
    public static PreCheckCreateOrderForCreateDBNodesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public PreCheckCreateOrderForCreateDBNodesResponseBody build() {
            return new PreCheckCreateOrderForCreateDBNodesResponseBody(this);
        } 
