...
public class ModifySQLCollectorRetentionRequest extends Request {
    ...
    public static ModifySQLCollectorRetentionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifySQLCollectorRetentionRequest, Builder> {
        ...
        private Builder(ModifySQLCollectorRetentionRequest response) {
            super(response);
        ...
        @Override
        public ModifySQLCollectorRetentionRequest build() {
            return new ModifySQLCollectorRetentionRequest(this);
        } 
