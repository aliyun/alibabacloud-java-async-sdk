...
public class ModifyDBDescriptionRequest extends Request {
    ...
    public static ModifyDBDescriptionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyDBDescriptionRequest, Builder> {
        private String DBDescription; 
        private String DBInstanceId; 
        private String DBName; 
        private String ownerAccount; 
        ...
        private Builder(ModifyDBDescriptionRequest response) {
            super(response);
        ...
        @Override
        public ModifyDBDescriptionRequest build() {
            return new ModifyDBDescriptionRequest(this);
        } 
