 ...
 */
public class ReceiveDBInstanceRequest extends Request {
    ...
    private ReceiveDBInstanceRequest(Builder builder) {
        super(builder);
    ...
    public static ReceiveDBInstanceRequest create() {
    ...
    public static final class Builder extends Request.Builder<ReceiveDBInstanceRequest, Builder> {
        private String DBInstanceId; 
        private String guardDBInstanceId; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ReceiveDBInstanceRequest request) {
            super(request);
            this.DBInstanceId = request.DBInstanceId;
            this.guardDBInstanceId = request.guardDBInstanceId;
        ...
        @Override
        public ReceiveDBInstanceRequest build() {
            return new ReceiveDBInstanceRequest(this);
        } 
