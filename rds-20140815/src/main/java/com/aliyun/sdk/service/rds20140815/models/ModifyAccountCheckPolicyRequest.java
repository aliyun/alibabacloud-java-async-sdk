 ...
 */
public class ModifyAccountCheckPolicyRequest extends Request {
    ...
    private ModifyAccountCheckPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyAccountCheckPolicyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyAccountCheckPolicyRequest, Builder> {
        private String accountName; 
        private Boolean checkPolicy; 
        private String clientToken; 
        private String DBInstanceId; 
        ...
        private Builder(ModifyAccountCheckPolicyRequest request) {
            super(request);
        ...
        @Override
        public ModifyAccountCheckPolicyRequest build() {
            return new ModifyAccountCheckPolicyRequest(this);
        } 
