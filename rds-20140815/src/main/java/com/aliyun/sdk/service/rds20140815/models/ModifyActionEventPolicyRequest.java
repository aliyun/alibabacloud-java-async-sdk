 ...
 */
public class ModifyActionEventPolicyRequest extends Request {
    @Query
    ...
    private ModifyActionEventPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyActionEventPolicyRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyActionEventPolicyRequest, Builder> {
        private String enableEventLog; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        @Override
        public ModifyActionEventPolicyRequest build() {
