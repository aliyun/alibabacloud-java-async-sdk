...
public class QueryFaceImageTemplateRequest extends Request {
    ...
    public static QueryFaceImageTemplateRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryFaceImageTemplateRequest, Builder> {
        private Long pageNo; 
        private Long pageSize; 
        private String templateId; 
        ...
        private Builder(QueryFaceImageTemplateRequest request) {
            super(request);
        ...
        @Override
        public QueryFaceImageTemplateRequest build() {
            return new QueryFaceImageTemplateRequest(this);
        } 
