...
/**
 * 
 * {@link GetXDefaultConfigRequest} extends {@link RequestModel}
 *
 * <p>GetXDefaultConfigRequest</p>
 */
public class GetXDefaultConfigRequest extends Request {
    ...
    private GetXDefaultConfigRequest(Builder builder) {
        super(builder);
    ...
    public static GetXDefaultConfigRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetXDefaultConfigRequest, Builder> {
        private Long callerParentId; 
        private String customerPoolKey; 
        private Long ownerId; 
        private String reqId; 
        ...
        private Builder(GetXDefaultConfigRequest request) {
            super(request);
        ...
        @Override
        public GetXDefaultConfigRequest build() {
            return new GetXDefaultConfigRequest(this);
        } 
