...
public class UnBindXBResponseBody extends TeaModel {
    ...
    public static UnBindXBResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UnBindXBResponseBody model) {
        ...
        public UnBindXBResponseBody build() {
            return new UnBindXBResponseBody(this);
        } 
