...
/**
 * 
 * {@link CreateAggTaskGroupRequest} extends {@link RequestModel}
 *
 * <p>CreateAggTaskGroupRequest</p>
 */
public class CreateAggTaskGroupRequest extends Request {
    ...
    @com.aliyun.core.annotation.NameInMap("overrideIfExists")
    private Boolean overrideIfExists;

    private CreateAggTaskGroupRequest(Builder builder) {
        super(builder);
        ...
        this.overrideIfExists = builder.overrideIfExists;
    }
    ...
    public static CreateAggTaskGroupRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateAggTaskGroupRequest, Builder> {
        private String instanceId; 
        private String aggTaskGroupConfig; 
        private String aggTaskGroupConfigType; 
        private String aggTaskGroupName; 
        ...
        private Builder(CreateAggTaskGroupRequest request) {
            super(request);
            ...
            this.overrideIfExists = request.overrideIfExists;
        } 
        ...
        @Override
        public CreateAggTaskGroupRequest build() {
            return new CreateAggTaskGroupRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateAggTaskGroupRequest} extends {@link TeaModel}
     *
     * <p>CreateAggTaskGroupRequest</p>
     */
