...
/**
 * 
 * {@link CreateDataPipelineResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDataPipelineResponseBody</p>
 */
public class CreateDataPipelineResponseBody extends TeaModel {
    ...
    private CreateDataPipelineResponseBody(Builder builder) {
    ...
    public static CreateDataPipelineResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDataPipelineResponseBody model) {
            this.pipeline = model.pipeline;
            this.requestId = model.requestId;
        } 

        /**
         * <p>创建成功的数据流水线完整配置与运行状态。</p>
         */
        ...
        public CreateDataPipelineResponseBody build() {
            return new CreateDataPipelineResponseBody(this);
        } 
