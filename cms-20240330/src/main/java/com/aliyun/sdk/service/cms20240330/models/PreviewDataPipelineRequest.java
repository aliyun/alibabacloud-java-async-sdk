...
/**
 * 
 * {@link PreviewDataPipelineRequest} extends {@link RequestModel}
 *
 * <p>PreviewDataPipelineRequest</p>
 */
public class PreviewDataPipelineRequest extends Request {
    ...
    private PreviewDataPipelineRequest(Builder builder) {
        super(builder);
    ...
    public static PreviewDataPipelineRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<PreviewDataPipelineRequest, Builder> {
        private String workspace; 
        private String description; 
        private Long fromTime; 
        private String kind; 
        ...
        private Builder(PreviewDataPipelineRequest request) {
            super(request);
        ...
        /**
         * <p>候选数据流水线的类型。可选值为 default、custom 或 export。</p>
         * 
         * <strong>example:</strong>
         * <p>custom</p>
         */
        ...
        /**
         * <p>候选配置中的 Dataset 到客户 Logstore 绑定；预览不会实际写入。</p>
         */
        ...
        /**
         * <p>预览查询窗口的结束时间，使用 Unix 秒；与开始时间的差值不得超过 3600 秒。</p>
         * 
         * <strong>example:</strong>
         * <p>1784566800</p>
         */
        ...
        @Override
        public PreviewDataPipelineRequest build() {
            return new PreviewDataPipelineRequest(this);
        } 
