...
/**
 * 
 * {@link ResponsePlanDetail} extends {@link TeaModel}
 *
 * <p>ResponsePlanDetail</p>
 */
public class ResponsePlanDetail extends TeaModel {
    ...
    private ResponsePlanDetail(Builder builder) {
    ...
    public static ResponsePlanDetail create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResponsePlanDetail model) {
        ...
        public ResponsePlanDetail build() {
            return new ResponsePlanDetail(this);
        } 
