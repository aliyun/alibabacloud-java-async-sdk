...
/**
 * 
 * {@link DeleteServiceTaskRequest} extends {@link RequestModel}
 *
 * <p>DeleteServiceTaskRequest</p>
 */
public class DeleteServiceTaskRequest extends Request {
    ...
    private DeleteServiceTaskRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteServiceTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteServiceTaskRequest, Builder> {
        private String workspace; 
        private String serviceId; 
        private String taskId; 
        private String type; 
        ...
        private Builder(DeleteServiceTaskRequest request) {
            super(request);
        ...
        /**
         * <p>The ID of the task to delete. This is the taskId returned by the creation operation.</p>
         * 
         * <strong>example:</strong>
        ...
        @Override
        public DeleteServiceTaskRequest build() {
            return new DeleteServiceTaskRequest(this);
        } 
