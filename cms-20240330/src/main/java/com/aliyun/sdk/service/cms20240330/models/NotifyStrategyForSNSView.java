...
/**
 * 
 * {@link NotifyStrategyForSNSView} extends {@link TeaModel}
 *
 * <p>NotifyStrategyForSNSView</p>
 */
public class NotifyStrategyForSNSView extends TeaModel {
    ...
    @com.aliyun.core.annotation.NameInMap("incidentResponsePlanId")
    private String incidentResponsePlanId;
    ...
    private NotifyStrategyForSNSView(Builder builder) {
        ...
        this.incidentResponsePlanId = builder.incidentResponsePlanId;
    ...
    public static NotifyStrategyForSNSView create() {
    ...
    public static final class Builder {
        ...
        private Builder(NotifyStrategyForSNSView model) {
            ...
            this.incidentResponsePlanId = model.incidentResponsePlanId;
        ...
        public NotifyStrategyForSNSView build() {
            return new NotifyStrategyForSNSView(this);
        } 
