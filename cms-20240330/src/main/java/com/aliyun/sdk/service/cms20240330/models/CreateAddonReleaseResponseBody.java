...
/**
 * 
 * {@link CreateAddonReleaseResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAddonReleaseResponseBody</p>
 */
public class CreateAddonReleaseResponseBody extends TeaModel {
    ...
    private CreateAddonReleaseResponseBody(Builder builder) {
    ...
    public static CreateAddonReleaseResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAddonReleaseResponseBody model) {
        ...
        public CreateAddonReleaseResponseBody build() {
            return new CreateAddonReleaseResponseBody(this);
        } 
