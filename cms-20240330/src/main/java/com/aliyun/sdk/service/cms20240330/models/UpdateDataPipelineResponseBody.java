...
/**
 * 
 * {@link UpdateDataPipelineResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateDataPipelineResponseBody</p>
 */
public class UpdateDataPipelineResponseBody extends TeaModel {
    ...
    private UpdateDataPipelineResponseBody(Builder builder) {
    ...
    public static UpdateDataPipelineResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateDataPipelineResponseBody model) {
            this.pipeline = model.pipeline;
            this.requestId = model.requestId;
        } 

        /**
         * <p>修改后的数据流水线完整配置与运行状态。</p>
         */
        ...
        public UpdateDataPipelineResponseBody build() {
            return new UpdateDataPipelineResponseBody(this);
        } 
     ...
     * <p>UpdateDataPipelineResponseBody</p>
     */
    public static class PipelineProcessors extends TeaModel {
        @com.aliyun.core.annotation.NameInMap("config")
        ...
        private PipelineProcessors(Builder builder) {
            this.config = builder.config;
            this.name = builder.name;
            this.type = builder.type;
        }
        ...
        public static PipelineProcessors create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            private Builder(PipelineProcessors model) {
                this.config = model.config;
                this.name = model.name;
                this.type = model.type;
            } 
            ...
            public PipelineProcessors build() {
                return new PipelineProcessors(this);
            } 
    ...
    public static class Pipeline extends TeaModel {
        ...
        @com.aliyun.core.annotation.NameInMap("processors")
        @com.aliyun.core.annotation.Validation(required = true)
        private java.util.List<PipelineProcessors> processors;
         ...
         * @return processors
         */
        public java.util.List<PipelineProcessors> getProcessors() {
            return this.processors;
        }
        ...
        public static final class Builder {
             ...
             * <p>This parameter is required.</p>
             */
            public Builder processors(java.util.List<PipelineProcessors> processors) {
                this.processors = processors;
                return this;
            }
