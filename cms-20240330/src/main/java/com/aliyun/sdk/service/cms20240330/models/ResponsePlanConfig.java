...
/**
 * 
 * {@link ResponsePlanConfig} extends {@link TeaModel}
 *
 * <p>ResponsePlanConfig</p>
 */
public class ResponsePlanConfig extends TeaModel {
    ...
    private ResponsePlanConfig(Builder builder) {
    ...
    public static ResponsePlanConfig create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResponsePlanConfig model) {
        ...
        public ResponsePlanConfig build() {
            return new ResponsePlanConfig(this);
        } 
