...
/**
 * 
 * {@link NotifyStrategyDetail} extends {@link TeaModel}
 *
 * <p>NotifyStrategyDetail</p>
 */
public class NotifyStrategyDetail extends TeaModel {
    ...
    private NotifyStrategyDetail(Builder builder) {
    ...
    public static NotifyStrategyDetail create() {
    ...
    public static final class Builder {
        ...
        private Builder(NotifyStrategyDetail model) {
        ...
        public NotifyStrategyDetail build() {
            return new NotifyStrategyDetail(this);
        } 
