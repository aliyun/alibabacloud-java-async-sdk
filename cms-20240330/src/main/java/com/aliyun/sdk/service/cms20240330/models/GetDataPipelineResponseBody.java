...
/**
 * 
 * {@link GetDataPipelineResponseBody} extends {@link TeaModel}
 *
 * <p>GetDataPipelineResponseBody</p>
 */
public class GetDataPipelineResponseBody extends TeaModel {
    ...
    private GetDataPipelineResponseBody(Builder builder) {
    ...
    public static GetDataPipelineResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetDataPipelineResponseBody model) {
            this.pipeline = model.pipeline;
            this.requestId = model.requestId;
        } 

        /**
         * <p>查询到的数据流水线完整配置与运行状态。</p>
         */
        ...
        public GetDataPipelineResponseBody build() {
            return new GetDataPipelineResponseBody(this);
        } 
