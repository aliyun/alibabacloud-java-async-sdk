...
public class DescribePackageStateResponseBody extends TeaModel {
    ...
    public static final class Builder {
         ...
         * <ul>
         * <li><p><strong>digicert-free-1-free</strong>: DigiCert single-domain DV certificate in a three-month free trial, available only on the China site (aliyun.com).</p>
         * </li>
         ...
         * </li>
         * <li><p><strong>symantec-ov-1-personal</strong>: DigiCert single-domain OV certificate.</p>
         * </li>
         ...
         * </li>
         * <li><p><strong>cfca-ov-1-personal</strong>: CFCA single-domain OV certificate, available only on the China site (aliyun.com).</p>
         * </li>
