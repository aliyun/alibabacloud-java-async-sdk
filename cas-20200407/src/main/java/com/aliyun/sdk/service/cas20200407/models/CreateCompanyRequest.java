...
/**
 * 
 * {@link CreateCompanyRequest} extends {@link RequestModel}
 *
 * <p>CreateCompanyRequest</p>
 */
public class CreateCompanyRequest extends Request {
    ...
    private CreateCompanyRequest(Builder builder) {
        super(builder);
    ...
    public static CreateCompanyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateCompanyRequest, Builder> {
        private String city; 
        private String companyAddress; 
        private String companyCode; 
        private String companyEmail; 
        ...
        private Builder(CreateCompanyRequest request) {
            super(request);
