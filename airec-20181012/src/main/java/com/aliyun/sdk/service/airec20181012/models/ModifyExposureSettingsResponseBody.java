...
/**
 * {@link ModifyExposureSettingsResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyExposureSettingsResponseBody</p>
 */
public class ModifyExposureSettingsResponseBody extends TeaModel {
    ...
    private ModifyExposureSettingsResponseBody(Builder builder) {
    ...
    public static ModifyExposureSettingsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifyExposureSettingsResponseBody build() {
            return new ModifyExposureSettingsResponseBody(this);
        } 
