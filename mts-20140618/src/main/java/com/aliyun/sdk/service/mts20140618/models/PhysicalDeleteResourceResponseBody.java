...
/**
 * {@link PhysicalDeleteResourceResponseBody} extends {@link TeaModel}
 *
 * <p>PhysicalDeleteResourceResponseBody</p>
 */
public class PhysicalDeleteResourceResponseBody extends TeaModel {
    ...
    private PhysicalDeleteResourceResponseBody(Builder builder) {
    ...
    public static PhysicalDeleteResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public PhysicalDeleteResourceResponseBody build() {
            return new PhysicalDeleteResourceResponseBody(this);
        } 
