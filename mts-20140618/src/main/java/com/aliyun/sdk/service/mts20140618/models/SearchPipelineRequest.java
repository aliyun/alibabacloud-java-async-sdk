 ...
 */
public class SearchPipelineRequest extends Request {
    ...
    private SearchPipelineRequest(Builder builder) {
        super(builder);
    ...
    public static SearchPipelineRequest create() {
    ...
    public static final class Builder extends Request.Builder<SearchPipelineRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private Long pageNumber; 
        private Long pageSize; 
        ...
        private Builder(SearchPipelineRequest request) {
            super(request);
        ...
        @Override
        public SearchPipelineRequest build() {
            return new SearchPipelineRequest(this);
        } 
