 ...
 */
public class ListCustomViewsRequest extends Request {
    ...
    private ListCustomViewsRequest(Builder builder) {
        super(builder);
    ...
    public static ListCustomViewsRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListCustomViewsRequest, Builder> {
        private String algorithm; 
        private String customEntityId; 
        private String customGroupId; 
        private String ownerAccount; 
        ...
        private Builder(ListCustomViewsRequest request) {
            super(request);
        ...
        @Override
        public ListCustomViewsRequest build() {
            return new ListCustomViewsRequest(this);
        } 
