...
/**
 * 
 * {@link DeleteCustomEntityRequest} extends {@link RequestModel}
 *
 * <p>DeleteCustomEntityRequest</p>
 */
public class DeleteCustomEntityRequest extends Request {
    ...
    private DeleteCustomEntityRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteCustomEntityRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteCustomEntityRequest, Builder> {
        private String algorithm; 
        private String customEntityId; 
        private String customGroupId; 
        private String ownerAccount; 
        ...
        private Builder(DeleteCustomEntityRequest request) {
            super(request);
        ...
        @Override
        public DeleteCustomEntityRequest build() {
            return new DeleteCustomEntityRequest(this);
        } 
