...
/**
 * {@link PhysicalDeleteResourceRequest} extends {@link RequestModel}
 *
 * <p>PhysicalDeleteResourceRequest</p>
 */
public class PhysicalDeleteResourceRequest extends Request {
    @Query
    @NameInMap("Bid")
    ...
    private PhysicalDeleteResourceRequest(Builder builder) {
        super(builder);
    ...
    public static PhysicalDeleteResourceRequest create() {
    ...
    public static final class Builder extends Request.Builder<PhysicalDeleteResourceRequest, Builder> {
        private String bid; 
        private String country; 
        private String gmtWakeup; 
        private Long hid; 
        ...
        private Builder(PhysicalDeleteResourceRequest response) {
            super(response);
        ...
        @Override
        public PhysicalDeleteResourceRequest build() {
            return new PhysicalDeleteResourceRequest(this);
        } 
