 ...
 */
public class QuerySmarttagTemplateListRequest extends Request {
    ...
    private QuerySmarttagTemplateListRequest(Builder builder) {
        super(builder);
    ...
    public static QuerySmarttagTemplateListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QuerySmarttagTemplateListRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String resourceOwnerAccount; 
        private Long resourceOwnerId; 
        ...
        @Override
        public QuerySmarttagTemplateListRequest build() {
            return new QuerySmarttagTemplateListRequest(this);
        } 
