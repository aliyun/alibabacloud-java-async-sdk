...
/**
 * 
 * {@link BatchGetMediasResponseBody} extends {@link TeaModel}
 *
...
public class BatchGetMediasResponseBody extends TeaModel {
    ...
    private BatchGetMediasResponseBody(Builder builder) {
    ...
    public static BatchGetMediasResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BatchGetMediasResponseBody model) {
        ...
        public BatchGetMediasResponseBody build() {
            return new BatchGetMediasResponseBody(this);
        } 
