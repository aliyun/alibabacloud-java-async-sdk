...
/**
 * 
 * {@link GetMediaResponseBody} extends {@link TeaModel}
 *
 * <p>GetMediaResponseBody</p>
 */
public class GetMediaResponseBody extends TeaModel {
    ...
    private GetMediaResponseBody(Builder builder) {
    ...
    public static GetMediaResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetMediaResponseBody model) {
        ...
        public GetMediaResponseBody build() {
            return new GetMediaResponseBody(this);
        } 
