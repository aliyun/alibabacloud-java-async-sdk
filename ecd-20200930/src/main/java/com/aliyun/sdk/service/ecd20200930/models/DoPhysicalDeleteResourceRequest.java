...
/**
 * {@link DoPhysicalDeleteResourceRequest} extends {@link RequestModel}
 *
 * <p>DoPhysicalDeleteResourceRequest</p>
 */
public class DoPhysicalDeleteResourceRequest extends Request {
    @Query
    @NameInMap("Bid")
    private String bid;
    ...
    private DoPhysicalDeleteResourceRequest(Builder builder) {
        super(builder);
    ...
    public static DoPhysicalDeleteResourceRequest create() {
    ...
    public static final class Builder extends Request.Builder<DoPhysicalDeleteResourceRequest, Builder> {
        private String bid; 
        private String country; 
        private String gmtWakeup; 
        private Long hid; 
        ...
        private Builder(DoPhysicalDeleteResourceRequest response) {
            super(response);
        ...
        @Override
        public DoPhysicalDeleteResourceRequest build() {
            return new DoPhysicalDeleteResourceRequest(this);
        } 
