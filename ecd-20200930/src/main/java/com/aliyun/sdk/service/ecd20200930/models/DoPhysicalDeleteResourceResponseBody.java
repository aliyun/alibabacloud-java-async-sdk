...
/**
 * {@link DoPhysicalDeleteResourceResponseBody} extends {@link TeaModel}
 *
 * <p>DoPhysicalDeleteResourceResponseBody</p>
 */
public class DoPhysicalDeleteResourceResponseBody extends TeaModel {
    ...
    private DoPhysicalDeleteResourceResponseBody(Builder builder) {
    ...
    public static DoPhysicalDeleteResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DoPhysicalDeleteResourceResponseBody build() {
            return new DoPhysicalDeleteResourceResponseBody(this);
        } 
