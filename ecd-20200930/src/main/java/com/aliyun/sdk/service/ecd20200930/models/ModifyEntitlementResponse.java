...
/**
 * 
 * {@link ModifyEntitlementResponse} extends {@link TeaModel}
 *
 * <p>ModifyEntitlementResponse</p>
 */
public class ModifyEntitlementResponse extends Response {
    ...
    public static ModifyEntitlementResponse create() {
    ...
    public interface Builder extends Response.Builder<ModifyEntitlementResponse, Builder> {
        ...
        @Override
        ModifyEntitlementResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(ModifyEntitlementResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public ModifyEntitlementResponse build() {
            return new ModifyEntitlementResponse(this);
        } 
