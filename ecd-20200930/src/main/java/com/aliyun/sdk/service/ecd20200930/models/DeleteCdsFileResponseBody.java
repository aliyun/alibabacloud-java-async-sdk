...
public class DeleteCdsFileResponseBody extends TeaModel {
    ...
    private DeleteCdsFileResponseBody(Builder builder) {
    ...
    public static DeleteCdsFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteCdsFileResponseBody model) {
        ...
        public DeleteCdsFileResponseBody build() {
            return new DeleteCdsFileResponseBody(this);
        } 
