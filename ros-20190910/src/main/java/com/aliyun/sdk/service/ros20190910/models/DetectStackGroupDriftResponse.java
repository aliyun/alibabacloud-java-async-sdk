...
public class DetectStackGroupDriftResponse extends Response {
    ...
    private DetectStackGroupDriftResponse(BuilderImpl builder) {
        super(builder);
...
@Override
    ...
    public interface Builder extends Response.Builder<DetectStackGroupDriftResponse, Builder> {

        Builder headers(java.util.Map<String, String> headers);

        Builder statusCode(Integer statusCode);

        Builder body(DetectStackGroupDriftResponseBody body);

        @Override
        DetectStackGroupDriftResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<DetectStackGroupDriftResponse, Builder>
            implements Builder {
        private java.util.Map<String, String> headers; 
        private Integer statusCode; 
        private DetectStackGroupDriftResponseBody body; 
        ...
        private BuilderImpl(DetectStackGroupDriftResponse response) {
            super(response);
