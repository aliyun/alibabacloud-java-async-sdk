...
public class GetTemplateEstimateCostResponse extends Response {
    ...
    private GetTemplateEstimateCostResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<GetTemplateEstimateCostResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(GetTemplateEstimateCostResponseBody body);

        @Override
        GetTemplateEstimateCostResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<GetTemplateEstimateCostResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private GetTemplateEstimateCostResponseBody body; 
        ...
        private BuilderImpl(GetTemplateEstimateCostResponse response) {
            super(response);
