...
public class SetTemplatePermissionResponse extends Response {
    ...
    private SetTemplatePermissionResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<SetTemplatePermissionResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(SetTemplatePermissionResponseBody body);

        @Override
        SetTemplatePermissionResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<SetTemplatePermissionResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private SetTemplatePermissionResponseBody body; 
        ...
        private BuilderImpl(SetTemplatePermissionResponse response) {
            super(response);
