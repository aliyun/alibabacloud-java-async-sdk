...
public class ExecuteChangeSetResponse extends Response {
    ...
    private ExecuteChangeSetResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ExecuteChangeSetResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ExecuteChangeSetResponseBody body);

        @Override
        ExecuteChangeSetResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ExecuteChangeSetResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ExecuteChangeSetResponseBody body; 
        ...
        private BuilderImpl(ExecuteChangeSetResponse response) {
            super(response);
