...
public class ListStackResourcesResponse extends Response {
    ...
    public interface Builder extends Response.Builder<ListStackResourcesResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ListStackResourcesResponseBody body);

        @Override
        ListStackResourcesResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ListStackResourcesResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ListStackResourcesResponseBody body; 
        ...
        private BuilderImpl(ListStackResourcesResponse response) {
            super(response);
