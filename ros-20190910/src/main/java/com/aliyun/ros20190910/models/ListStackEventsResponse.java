...
public class ListStackEventsResponse extends Response {
    ...
    private ListStackEventsResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ListStackEventsResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(ListStackEventsResponseBody body);

        @Override
        ListStackEventsResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ListStackEventsResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private ListStackEventsResponseBody body; 
        ...
        private BuilderImpl(ListStackEventsResponse response) {
            super(response);
