...
public class GenerateTemplateByScratchResponse extends Response {
    ...
    private GenerateTemplateByScratchResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<GenerateTemplateByScratchResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(GenerateTemplateByScratchResponseBody body);

        @Override
        GenerateTemplateByScratchResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<GenerateTemplateByScratchResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private GenerateTemplateByScratchResponseBody body; 
        ...
        private BuilderImpl(GenerateTemplateByScratchResponse response) {
            super(response);
