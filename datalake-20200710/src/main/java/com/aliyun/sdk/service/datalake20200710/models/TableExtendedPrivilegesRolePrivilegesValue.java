...
/**
 * {@link TableExtendedPrivilegesRolePrivilegesValue} extends {@link TeaModel}
 *
 * <p>TableExtendedPrivilegesRolePrivilegesValue</p>
 */
public class TableExtendedPrivilegesRolePrivilegesValue extends TeaModel {
    ...
    private TableExtendedPrivilegesRolePrivilegesValue(Builder builder) {
    ...
    public static TableExtendedPrivilegesRolePrivilegesValue create() {
    ...
    public static final class Builder {
        ...
        public TableExtendedPrivilegesRolePrivilegesValue build() {
            return new TableExtendedPrivilegesRolePrivilegesValue(this);
        } 
