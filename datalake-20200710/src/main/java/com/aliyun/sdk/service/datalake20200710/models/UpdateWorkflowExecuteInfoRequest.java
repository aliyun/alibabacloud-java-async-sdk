...
/**
 * {@link UpdateWorkflowExecuteInfoRequest} extends {@link RequestModel}
 *
 * <p>UpdateWorkflowExecuteInfoRequest</p>
 */
public class UpdateWorkflowExecuteInfoRequest extends Request {
    @Body
    ...
    private UpdateWorkflowExecuteInfoRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateWorkflowExecuteInfoRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateWorkflowExecuteInfoRequest, Builder> {
        private String blueprintInstanceId; 
        private String executeCapacity; 
        private String executeParameters; 
        private String executeType; 
        ...
        private Builder(UpdateWorkflowExecuteInfoRequest response) {
            super(response);
        ...
        @Override
        public UpdateWorkflowExecuteInfoRequest build() {
            return new UpdateWorkflowExecuteInfoRequest(this);
        } 
