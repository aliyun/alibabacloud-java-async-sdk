...
/**
 * {@link BatchGetPartitionColumnStatisticsResponseBody} extends {@link TeaModel}
 *
 * <p>BatchGetPartitionColumnStatisticsResponseBody</p>
 */
public class BatchGetPartitionColumnStatisticsResponseBody extends TeaModel {
    ...
    private BatchGetPartitionColumnStatisticsResponseBody(Builder builder) {
    ...
    public static BatchGetPartitionColumnStatisticsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public BatchGetPartitionColumnStatisticsResponseBody build() {
            return new BatchGetPartitionColumnStatisticsResponseBody(this);
        } 
