...
/**
 * {@link BatchDeletePartitionsResponseBody} extends {@link TeaModel}
 *
 * <p>BatchDeletePartitionsResponseBody</p>
 */
public class BatchDeletePartitionsResponseBody extends TeaModel {
    ...
    private BatchDeletePartitionsResponseBody(Builder builder) {
    ...
    public static BatchDeletePartitionsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public BatchDeletePartitionsResponseBody build() {
            return new BatchDeletePartitionsResponseBody(this);
        } 
