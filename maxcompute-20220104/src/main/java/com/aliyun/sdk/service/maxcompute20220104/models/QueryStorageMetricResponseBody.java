...
/**
 * 
 * {@link QueryStorageMetricResponseBody} extends {@link TeaModel}
 *
 * <p>QueryStorageMetricResponseBody</p>
 */
public class QueryStorageMetricResponseBody extends TeaModel {
    ...
    private QueryStorageMetricResponseBody(Builder builder) {
    ...
    public static QueryStorageMetricResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryStorageMetricResponseBody model) {
        ...
        public QueryStorageMetricResponseBody build() {
            return new QueryStorageMetricResponseBody(this);
        } 
