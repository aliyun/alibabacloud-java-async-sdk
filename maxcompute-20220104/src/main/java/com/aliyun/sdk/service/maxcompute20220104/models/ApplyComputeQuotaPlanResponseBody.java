...
/**
 * 
 * {@link ApplyComputeQuotaPlanResponseBody} extends {@link TeaModel}
 *
 * <p>ApplyComputeQuotaPlanResponseBody</p>
 */
public class ApplyComputeQuotaPlanResponseBody extends TeaModel {
    ...
    private ApplyComputeQuotaPlanResponseBody(Builder builder) {
    ...
    public static ApplyComputeQuotaPlanResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ApplyComputeQuotaPlanResponseBody model) {
        ...
        public ApplyComputeQuotaPlanResponseBody build() {
            return new ApplyComputeQuotaPlanResponseBody(this);
        } 
