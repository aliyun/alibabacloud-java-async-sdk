...
/**
 * 
 * {@link UpdateComputeQuotaPlanResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateComputeQuotaPlanResponseBody</p>
 */
public class UpdateComputeQuotaPlanResponseBody extends TeaModel {
    ...
    private UpdateComputeQuotaPlanResponseBody(Builder builder) {
    ...
    public static UpdateComputeQuotaPlanResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateComputeQuotaPlanResponseBody build() {
            return new UpdateComputeQuotaPlanResponseBody(this);
        } 
