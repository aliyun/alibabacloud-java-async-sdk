...
/**
 * 
 * {@link SumBillsRequest} extends {@link RequestModel}
 *
 * <p>SumBillsRequest</p>
 */
public class SumBillsRequest extends Request {
    ...
    private SumBillsRequest(Builder builder) {
        super(builder);
    ...
    public static SumBillsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SumBillsRequest, Builder> {
        private Long endDate; 
        private java.util.List<String> projectNames; 
        private Long startDate; 
        private String statsType; 
        ...
        private Builder(SumBillsRequest request) {
            super(request);
        ...
        @Override
        public SumBillsRequest build() {
            return new SumBillsRequest(this);
        } 
