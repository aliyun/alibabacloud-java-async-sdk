...
/**
 * 
 * {@link QueryQuotaMetricResponseBody} extends {@link TeaModel}
 *
 * <p>QueryQuotaMetricResponseBody</p>
 */
public class QueryQuotaMetricResponseBody extends TeaModel {
    ...
    private QueryQuotaMetricResponseBody(Builder builder) {
    ...
    public static QueryQuotaMetricResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryQuotaMetricResponseBody model) {
        ...
        public QueryQuotaMetricResponseBody build() {
            return new QueryQuotaMetricResponseBody(this);
        } 
