...
/**
 * 
 * {@link DeleteComputeQuotaPlanResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteComputeQuotaPlanResponseBody</p>
 */
public class DeleteComputeQuotaPlanResponseBody extends TeaModel {
    ...
    private DeleteComputeQuotaPlanResponseBody(Builder builder) {
    ...
    public static DeleteComputeQuotaPlanResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteComputeQuotaPlanResponseBody model) {
        ...
        public DeleteComputeQuotaPlanResponseBody build() {
            return new DeleteComputeQuotaPlanResponseBody(this);
        } 
