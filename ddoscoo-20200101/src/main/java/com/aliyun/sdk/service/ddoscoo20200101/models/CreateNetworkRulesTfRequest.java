...
/**
 * {@link CreateNetworkRulesTfRequest} extends {@link RequestModel}
 *
 * <p>CreateNetworkRulesTfRequest</p>
 */
public class CreateNetworkRulesTfRequest extends Request {
    @Query
    @NameInMap("PortParam")
    ...
    private CreateNetworkRulesTfRequest(Builder builder) {
        super(builder);
    ...
    public static CreateNetworkRulesTfRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateNetworkRulesTfRequest, Builder> {
        private java.util.List < PortParam> portParam; 
        private String regionId; 
        ...
        private Builder(CreateNetworkRulesTfRequest response) {
            super(response);
        ...
        @Override
        public CreateNetworkRulesTfRequest build() {
            return new CreateNetworkRulesTfRequest(this);
        } 
