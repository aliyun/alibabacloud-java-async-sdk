...
/**
 * {@link DeleteNetworkRulesTfRequest} extends {@link RequestModel}
 *
 * <p>DeleteNetworkRulesTfRequest</p>
 */
public class DeleteNetworkRulesTfRequest extends Request {
    @Query
    @NameInMap("PortParam")
    ...
    private DeleteNetworkRulesTfRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteNetworkRulesTfRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteNetworkRulesTfRequest, Builder> {
        private java.util.List < PortParam> portParam; 
        private String regionId; 
        ...
        private Builder(DeleteNetworkRulesTfRequest response) {
            super(response);
        ...
        @Override
        public DeleteNetworkRulesTfRequest build() {
            return new DeleteNetworkRulesTfRequest(this);
        } 
