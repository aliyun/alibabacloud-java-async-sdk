...
/**
 * 
 * {@link DisableWebCCRuleRequest} extends {@link RequestModel}
 *
...
public class DisableWebCCRuleRequest extends Request {
    ...
    public static DisableWebCCRuleRequest create() {
    ...
    public static final class Builder extends Request.Builder<DisableWebCCRuleRequest, Builder> {
        ...
        @Override
        public DisableWebCCRuleRequest build() {
            return new DisableWebCCRuleRequest(this);
        } 
