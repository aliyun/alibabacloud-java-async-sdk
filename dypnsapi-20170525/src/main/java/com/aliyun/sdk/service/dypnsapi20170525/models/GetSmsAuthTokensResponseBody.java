...
public class GetSmsAuthTokensResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        private Builder(GetSmsAuthTokensResponseBody model) {
    ...
    public static class Data extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(Data model) {
                this.bizToken = model.bizToken;
                this.expireTime = model.expireTime;
                this.stsAccessKeyId = model.stsAccessKeyId;
                this.stsAccessKeySecret = model.stsAccessKeySecret;
