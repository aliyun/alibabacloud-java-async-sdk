...
public class GetMobileRequest extends Request {
    ...
    public static GetMobileRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetMobileRequest, Builder> {
        private String accessToken; 
        private String outId; 
        private Long ownerId; 
        private String resourceOwnerAccount; 
        ...
        @Override
        public GetMobileRequest build() {
            return new GetMobileRequest(this);
        } 
