...
public class VerifyMobileResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        private Builder(VerifyMobileResponseBody model) {
            this.code = model.code;
            this.gateVerifyResultDTO = model.gateVerifyResultDTO;
    ...
    public static class GateVerifyResultDTO extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(GateVerifyResultDTO model) {
                this.verifyId = model.verifyId;
