...
public class GiveUserPointRequest extends Request {
    ...
    private GiveUserPointRequest(Builder builder) {
        ...
        this.targetBizUid = builder.targetBizUid;
    ...
    public static GiveUserPointRequest create() {
    ...
    public static final class Builder extends Request.Builder<GiveUserPointRequest, Builder> {
        private String accountType; 
        private Long amount; 
        private String bizId; 
        private java.util.Map<String, ?> extInfo; 
        ...
        private Builder(GiveUserPointRequest request) {
            super(request);
            ...
            this.targetBizUid = request.targetBizUid;
        ...
        @Override
        public GiveUserPointRequest build() {
            return new GiveUserPointRequest(this);
        } 
