...
/**
 * {@link CreateOutDiscountOrderWithDesignatedTbUidResponseBody} extends {@link TeaModel}
 *
 * <p>CreateOutDiscountOrderWithDesignatedTbUidResponseBody</p>
 */
public class CreateOutDiscountOrderWithDesignatedTbUidResponseBody extends TeaModel {
    ...
    private CreateOutDiscountOrderWithDesignatedTbUidResponseBody(Builder builder) {
    ...
    public static CreateOutDiscountOrderWithDesignatedTbUidResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateOutDiscountOrderWithDesignatedTbUidResponseBody build() {
            return new CreateOutDiscountOrderWithDesignatedTbUidResponseBody(this);
        } 
