...
/**
 * 
 * {@link FreezeUserPointRequest} extends {@link RequestModel}
 *
 * <p>FreezeUserPointRequest</p>
 */
public class FreezeUserPointRequest extends Request {
    ...
    private FreezeUserPointRequest(Builder builder) {
        super(builder);
    ...
    public static FreezeUserPointRequest create() {
    ...
    public static final class Builder extends Request.Builder<FreezeUserPointRequest, Builder> {
        private String accountType; 
        private Long amount; 
        private String bizId; 
        private java.util.Map<String, ?> extInfo; 
        ...
        private Builder(FreezeUserPointRequest request) {
            super(request);
        ...
        @Override
        public FreezeUserPointRequest build() {
            return new FreezeUserPointRequest(this);
        } 
