...
/**
 * 
 * {@link QueryOrderLogisticsWithDesignatedTbUidRequest} extends {@link RequestModel}
 *
 * <p>QueryOrderLogisticsWithDesignatedTbUidRequest</p>
 */
public class QueryOrderLogisticsWithDesignatedTbUidRequest extends Request {
    ...
    private QueryOrderLogisticsWithDesignatedTbUidRequest(Builder builder) {
        super(builder);
    ...
    public static QueryOrderLogisticsWithDesignatedTbUidRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryOrderLogisticsWithDesignatedTbUidRequest, Builder> {
        private String regionId; 
        private String bizId; 
        private Long lmOrderId; 
        private String tbAccountType; 
        ...
        private Builder(QueryOrderLogisticsWithDesignatedTbUidRequest request) {
            super(request);
        ...
        @Override
        public QueryOrderLogisticsWithDesignatedTbUidRequest build() {
            return new QueryOrderLogisticsWithDesignatedTbUidRequest(this);
        } 
