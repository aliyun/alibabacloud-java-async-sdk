...
/**
 * 
 * {@link ModifyRefundWithDesignatedTbUidRequest} extends {@link RequestModel}
 *
 * <p>ModifyRefundWithDesignatedTbUidRequest</p>
 */
public class ModifyRefundWithDesignatedTbUidRequest extends Request {
    ...
    private ModifyRefundWithDesignatedTbUidRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyRefundWithDesignatedTbUidRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyRefundWithDesignatedTbUidRequest, Builder> {
        private String regionId; 
        private String bizId; 
        private Long disputeId; 
        private Integer goodsStatus; 
        ...
        private Builder(ModifyRefundWithDesignatedTbUidRequest request) {
            super(request);
        ...
        @Override
        public ModifyRefundWithDesignatedTbUidRequest build() {
            return new ModifyRefundWithDesignatedTbUidRequest(this);
        } 
    ...
    /**
     * 
     * {@link ModifyRefundWithDesignatedTbUidRequest} extends {@link TeaModel}
     *
     * <p>ModifyRefundWithDesignatedTbUidRequest</p>
     */
