...
/**
 * 
 * {@link RemoveAddressRequest} extends {@link RequestModel}
 *
 * <p>RemoveAddressRequest</p>
 */
public class RemoveAddressRequest extends Request {
    ...
    private RemoveAddressRequest(Builder builder) {
        super(builder);
    ...
    public static RemoveAddressRequest create() {
    ...
    public static final class Builder extends Request.Builder<RemoveAddressRequest, Builder> {
        private String addressInfo; 
        private String bizId; 
        private String thirdPartyUserId; 
        private Boolean useAnonymousTbAccount; 
        ...
        private Builder(RemoveAddressRequest request) {
            super(request);
        ...
        @Override
        public RemoveAddressRequest build() {
