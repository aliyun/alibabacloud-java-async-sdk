...
/**
 * {@link QueryOrderLogisticsRequest} extends {@link RequestModel}
 *
 * <p>QueryOrderLogisticsRequest</p>
 */
public class QueryOrderLogisticsRequest extends Request {
    @Query
    ...
    private QueryOrderLogisticsRequest(Builder builder) {
        super(builder);
    ...
    public static QueryOrderLogisticsRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryOrderLogisticsRequest, Builder> {
        private String accountType; 
        private String bizId; 
        private String bizUid; 
        private Long lmOrderId; 
        ...
        private Builder(QueryOrderLogisticsRequest request) {
            super(request);
        ...
        @Override
        public QueryOrderLogisticsRequest build() {
            return new QueryOrderLogisticsRequest(this);
        } 
