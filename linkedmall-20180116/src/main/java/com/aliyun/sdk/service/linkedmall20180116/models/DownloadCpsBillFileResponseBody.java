...
/**
 * 
 * {@link DownloadCpsBillFileResponseBody} extends {@link TeaModel}
 *
 * <p>DownloadCpsBillFileResponseBody</p>
 */
public class DownloadCpsBillFileResponseBody extends TeaModel {
    ...
    private DownloadCpsBillFileResponseBody(Builder builder) {
    ...
    public static DownloadCpsBillFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DownloadCpsBillFileResponseBody build() {
            return new DownloadCpsBillFileResponseBody(this);
        } 
