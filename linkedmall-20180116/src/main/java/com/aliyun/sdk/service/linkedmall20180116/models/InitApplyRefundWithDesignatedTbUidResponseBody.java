...
/**
 * {@link InitApplyRefundWithDesignatedTbUidResponseBody} extends {@link TeaModel}
 *
 * <p>InitApplyRefundWithDesignatedTbUidResponseBody</p>
 */
public class InitApplyRefundWithDesignatedTbUidResponseBody extends TeaModel {
    ...
    private InitApplyRefundWithDesignatedTbUidResponseBody(Builder builder) {
    ...
    public static InitApplyRefundWithDesignatedTbUidResponseBody create() {
    ...
    public static final class Builder {
        ...
        public InitApplyRefundWithDesignatedTbUidResponseBody build() {
            return new InitApplyRefundWithDesignatedTbUidResponseBody(this);
        } 
