...
/**
 * {@link DownloadOrderTransactionDetailFileResponseBody} extends {@link TeaModel}
 *
 * <p>DownloadOrderTransactionDetailFileResponseBody</p>
 */
public class DownloadOrderTransactionDetailFileResponseBody extends TeaModel {
    ...
    private DownloadOrderTransactionDetailFileResponseBody(Builder builder) {
    ...
    public static DownloadOrderTransactionDetailFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DownloadOrderTransactionDetailFileResponseBody build() {
            return new DownloadOrderTransactionDetailFileResponseBody(this);
        } 
