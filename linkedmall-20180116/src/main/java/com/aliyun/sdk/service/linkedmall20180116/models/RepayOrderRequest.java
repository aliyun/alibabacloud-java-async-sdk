...
/**
 * {@link RepayOrderRequest} extends {@link RequestModel}
 *
 * <p>RepayOrderRequest</p>
 */
public class RepayOrderRequest extends Request {
    @Query
    ...
    private RepayOrderRequest(Builder builder) {
        super(builder);
    ...
    public static RepayOrderRequest create() {
    ...
    public static final class Builder extends Request.Builder<RepayOrderRequest, Builder> {
        private String accountType; 
        private String bizId; 
        private String bizUid; 
        private Long lmOrderId; 
        ...
        private Builder(RepayOrderRequest request) {
            super(request);
        ...
        @Override
        public RepayOrderRequest build() {
            return new RepayOrderRequest(this);
        } 
