...
/**
 * {@link QueryOrderListWithDesignatedTbUidRequest} extends {@link RequestModel}
 *
 * <p>QueryOrderListWithDesignatedTbUidRequest</p>
 */
public class QueryOrderListWithDesignatedTbUidRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private QueryOrderListWithDesignatedTbUidRequest(Builder builder) {
        super(builder);
    ...
    public static QueryOrderListWithDesignatedTbUidRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryOrderListWithDesignatedTbUidRequest, Builder> {
        private String regionId; 
        private String bizId; 
        private String filterOption; 
        private Integer pageNumber; 
        ...
        private Builder(QueryOrderListWithDesignatedTbUidRequest request) {
            super(request);
        ...
        @Override
        public QueryOrderListWithDesignatedTbUidRequest build() {
            return new QueryOrderListWithDesignatedTbUidRequest(this);
        } 
