...
/**
 * {@link CancelOrderWithDesignatedTbUidRequest} extends {@link RequestModel}
 *
 * <p>CancelOrderWithDesignatedTbUidRequest</p>
 */
public class CancelOrderWithDesignatedTbUidRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private CancelOrderWithDesignatedTbUidRequest(Builder builder) {
        super(builder);
    ...
    public static CancelOrderWithDesignatedTbUidRequest create() {
    ...
    public static final class Builder extends Request.Builder<CancelOrderWithDesignatedTbUidRequest, Builder> {
        private String regionId; 
        private String bizId; 
        private Long lmOrderId; 
        private String tbAccountType; 
        ...
        private Builder(CancelOrderWithDesignatedTbUidRequest request) {
            super(request);
        ...
        @Override
        public CancelOrderWithDesignatedTbUidRequest build() {
            return new CancelOrderWithDesignatedTbUidRequest(this);
        } 
