...
/**
 * {@link QueryOrderCommissionRateRequest} extends {@link RequestModel}
 *
 * <p>QueryOrderCommissionRateRequest</p>
 */
public class QueryOrderCommissionRateRequest extends Request {
    @Query
    ...
    private QueryOrderCommissionRateRequest(Builder builder) {
        super(builder);
    ...
    public static QueryOrderCommissionRateRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryOrderCommissionRateRequest, Builder> {
        private String accountType; 
        private String bizId; 
        private String bizUid; 
        private Long lmOrderId; 
        ...
        private Builder(QueryOrderCommissionRateRequest request) {
            super(request);
        ...
        @Override
        public QueryOrderCommissionRateRequest build() {
            return new QueryOrderCommissionRateRequest(this);
        } 
