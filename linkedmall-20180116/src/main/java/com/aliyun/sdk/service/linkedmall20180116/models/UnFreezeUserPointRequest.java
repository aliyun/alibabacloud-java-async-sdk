...
/**
 * 
 * {@link UnFreezeUserPointRequest} extends {@link RequestModel}
 *
 * <p>UnFreezeUserPointRequest</p>
 */
public class UnFreezeUserPointRequest extends Request {
    ...
    private UnFreezeUserPointRequest(Builder builder) {
        super(builder);
    ...
    public static UnFreezeUserPointRequest create() {
    ...
    public static final class Builder extends Request.Builder<UnFreezeUserPointRequest, Builder> {
        private String accountType; 
        private Long amount; 
        private String bizId; 
        private java.util.Map<String, ?> extInfo; 
        ...
        private Builder(UnFreezeUserPointRequest request) {
            super(request);
        ...
        @Override
        public UnFreezeUserPointRequest build() {
            return new UnFreezeUserPointRequest(this);
        } 
