...
/**
 * {@link CreateMovieTicketOrderResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMovieTicketOrderResponseBody</p>
 */
public class CreateMovieTicketOrderResponseBody extends TeaModel {
    ...
    private CreateMovieTicketOrderResponseBody(Builder builder) {
    ...
    public static CreateMovieTicketOrderResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateMovieTicketOrderResponseBody build() {
            return new CreateMovieTicketOrderResponseBody(this);
        } 
