...
/**
 * {@link QueryRefundApplyWithDesignatedTbUidRequest} extends {@link RequestModel}
 *
 * <p>QueryRefundApplyWithDesignatedTbUidRequest</p>
 */
public class QueryRefundApplyWithDesignatedTbUidRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private QueryRefundApplyWithDesignatedTbUidRequest(Builder builder) {
        super(builder);
    ...
    public static QueryRefundApplyWithDesignatedTbUidRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryRefundApplyWithDesignatedTbUidRequest, Builder> {
        private String regionId; 
        private String bizId; 
        private String subLmOrderId; 
        private String tbAccountType; 
        ...
        private Builder(QueryRefundApplyWithDesignatedTbUidRequest request) {
            super(request);
        ...
        @Override
        public QueryRefundApplyWithDesignatedTbUidRequest build() {
            return new QueryRefundApplyWithDesignatedTbUidRequest(this);
        } 
