...
public class ModifyOrderDeliveryAddressResponseBody extends TeaModel {
    ...
    public static ModifyOrderDeliveryAddressResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifyOrderDeliveryAddressResponseBody build() {
            return new ModifyOrderDeliveryAddressResponseBody(this);
        } 
