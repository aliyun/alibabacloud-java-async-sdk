...
public class CreateVirtualProductOrderResponseBody extends TeaModel {
    ...
    public static CreateVirtualProductOrderResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateVirtualProductOrderResponseBody build() {
            return new CreateVirtualProductOrderResponseBody(this);
        } 
