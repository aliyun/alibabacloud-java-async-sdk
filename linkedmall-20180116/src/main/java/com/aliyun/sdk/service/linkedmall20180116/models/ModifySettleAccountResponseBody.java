...
/**
 * 
 * {@link ModifySettleAccountResponseBody} extends {@link TeaModel}
 *
 * <p>ModifySettleAccountResponseBody</p>
 */
public class ModifySettleAccountResponseBody extends TeaModel {
    ...
    private ModifySettleAccountResponseBody(Builder builder) {
    ...
    public static ModifySettleAccountResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifySettleAccountResponseBody build() {
            return new ModifySettleAccountResponseBody(this);
        } 
