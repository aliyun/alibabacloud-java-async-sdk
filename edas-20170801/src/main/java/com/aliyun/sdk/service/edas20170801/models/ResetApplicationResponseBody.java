...
/**
 * 
 * {@link ResetApplicationResponseBody} extends {@link TeaModel}
 *
 * <p>ResetApplicationResponseBody</p>
 */
public class ResetApplicationResponseBody extends TeaModel {
    ...
    private ResetApplicationResponseBody(Builder builder) {
    ...
    public static ResetApplicationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResetApplicationResponseBody model) {
        ...
        public ResetApplicationResponseBody build() {
            return new ResetApplicationResponseBody(this);
        } 
