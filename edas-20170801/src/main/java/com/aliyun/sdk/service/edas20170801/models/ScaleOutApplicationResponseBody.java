...
/**
 * 
 * {@link ScaleOutApplicationResponseBody} extends {@link TeaModel}
 *
 * <p>ScaleOutApplicationResponseBody</p>
 */
public class ScaleOutApplicationResponseBody extends TeaModel {
    ...
    private ScaleOutApplicationResponseBody(Builder builder) {
    ...
    public static ScaleOutApplicationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ScaleOutApplicationResponseBody model) {
        ...
        public ScaleOutApplicationResponseBody build() {
            return new ScaleOutApplicationResponseBody(this);
        } 
