...
/**
 * {@link MockOrderFreeFlowProductRequest} extends {@link RequestModel}
 *
 * <p>MockOrderFreeFlowProductRequest</p>
 */
public class MockOrderFreeFlowProductRequest extends Request {
    @Query
    @NameInMap("AliUid")
    private Long aliUid;
    ...
    private MockOrderFreeFlowProductRequest(Builder builder) {
        super(builder);
    ...
    public static MockOrderFreeFlowProductRequest create() {
    ...
    public static final class Builder extends Request.Builder<MockOrderFreeFlowProductRequest, Builder> {
        private Long aliUid; 
        private String channelId; 
        private String customerFlowRequestId; 
        private String flowProductId; 
        ...
        private Builder(MockOrderFreeFlowProductRequest request) {
            super(request);
        ...
        @Override
        public MockOrderFreeFlowProductRequest build() {
            return new MockOrderFreeFlowProductRequest(this);
        } 
