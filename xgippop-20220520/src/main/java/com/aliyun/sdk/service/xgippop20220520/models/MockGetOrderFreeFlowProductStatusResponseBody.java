...
/**
 * {@link MockGetOrderFreeFlowProductStatusResponseBody} extends {@link TeaModel}
 *
 * <p>MockGetOrderFreeFlowProductStatusResponseBody</p>
 */
public class MockGetOrderFreeFlowProductStatusResponseBody extends TeaModel {
    ...
    private MockGetOrderFreeFlowProductStatusResponseBody(Builder builder) {
    ...
    public static MockGetOrderFreeFlowProductStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public MockGetOrderFreeFlowProductStatusResponseBody build() {
            return new MockGetOrderFreeFlowProductStatusResponseBody(this);
        } 
