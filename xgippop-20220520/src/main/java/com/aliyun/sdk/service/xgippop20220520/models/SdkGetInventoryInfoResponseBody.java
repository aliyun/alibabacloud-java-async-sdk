...
/**
 * {@link SdkGetInventoryInfoResponseBody} extends {@link TeaModel}
 *
 * <p>SdkGetInventoryInfoResponseBody</p>
 */
public class SdkGetInventoryInfoResponseBody extends TeaModel {
    ...
    private SdkGetInventoryInfoResponseBody(Builder builder) {
    ...
    public static SdkGetInventoryInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        public SdkGetInventoryInfoResponseBody build() {
            return new SdkGetInventoryInfoResponseBody(this);
        } 
