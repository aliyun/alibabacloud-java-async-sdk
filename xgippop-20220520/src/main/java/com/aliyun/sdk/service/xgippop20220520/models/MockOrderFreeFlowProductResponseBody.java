...
/**
 * {@link MockOrderFreeFlowProductResponseBody} extends {@link TeaModel}
 *
 * <p>MockOrderFreeFlowProductResponseBody</p>
 */
public class MockOrderFreeFlowProductResponseBody extends TeaModel {
    ...
    private MockOrderFreeFlowProductResponseBody(Builder builder) {
    ...
    public static MockOrderFreeFlowProductResponseBody create() {
    ...
    public static final class Builder {
        ...
        public MockOrderFreeFlowProductResponseBody build() {
            return new MockOrderFreeFlowProductResponseBody(this);
        } 
