...
/**
 * 
 * {@link PopCreateTaskRequest} extends {@link RequestModel}
 *
 * <p>PopCreateTaskRequest</p>
 */
public class PopCreateTaskRequest extends Request {
    ...
    private PopCreateTaskRequest(Builder builder) {
        super(builder);
    ...
    public static PopCreateTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<PopCreateTaskRequest, Builder> {
        private Object dataTypeMappingFile; 
        private String dataTypeOssFileName; 
        private String dataTypeOssObjectName; 
        private String dataTypeRealFileName; 
        ...
        private Builder(PopCreateTaskRequest request) {
            super(request);
        ...
        @Override
        public PopCreateTaskRequest build() {
            return new PopCreateTaskRequest(this);
        } 
