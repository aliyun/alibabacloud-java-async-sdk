...
/**
 * 
 * {@link UpdateMcpServiceRequest} extends {@link RequestModel}
 *
 * <p>UpdateMcpServiceRequest</p>
 */
public class UpdateMcpServiceRequest extends Request {
    ...
    private UpdateMcpServiceRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateMcpServiceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateMcpServiceRequest, Builder> {
        private String name; 
        private String mcpServiceName; 
        private String regionId; 
        private Connection connection; 
        ...
        private Builder(UpdateMcpServiceRequest request) {
            super(request);
        ...
        @Override
        public UpdateMcpServiceRequest build() {
            return new UpdateMcpServiceRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateMcpServiceRequest} extends {@link TeaModel}
     *
     * <p>UpdateMcpServiceRequest</p>
     */
