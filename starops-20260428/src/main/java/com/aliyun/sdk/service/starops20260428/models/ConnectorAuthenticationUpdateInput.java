...
/**
 * 
 * {@link ConnectorAuthenticationUpdateInput} extends {@link TeaModel}
 *
 * <p>ConnectorAuthenticationUpdateInput</p>
 */
public class ConnectorAuthenticationUpdateInput extends TeaModel {
    ...
    private ConnectorAuthenticationUpdateInput(Builder builder) {
    ...
    public static ConnectorAuthenticationUpdateInput create() {
    ...
    public static final class Builder {
        ...
        private Builder(ConnectorAuthenticationUpdateInput model) {
        ...
        public ConnectorAuthenticationUpdateInput build() {
            return new ConnectorAuthenticationUpdateInput(this);
        } 
    ...
    public static class Basic extends TeaModel {
        ...
        @com.aliyun.core.annotation.Validation(maxLength = 16384, minLength = 1)
    ...
    public static class Oauth extends TeaModel {
        ...
        @com.aliyun.core.annotation.Validation(maxLength = 2048, minLength = 8)
