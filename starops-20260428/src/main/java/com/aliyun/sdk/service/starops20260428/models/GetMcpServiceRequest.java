...
/**
 * 
 * {@link GetMcpServiceRequest} extends {@link RequestModel}
 *
 * <p>GetMcpServiceRequest</p>
 */
public class GetMcpServiceRequest extends Request {
    ...
    private GetMcpServiceRequest(Builder builder) {
        super(builder);
    ...
    public static GetMcpServiceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetMcpServiceRequest, Builder> {
        private String name; 
        private String mcpServiceName; 
        private String regionId; 
        ...
        private Builder(GetMcpServiceRequest request) {
            super(request);
        ...
        @Override
        public GetMcpServiceRequest build() {
            return new GetMcpServiceRequest(this);
        } 
