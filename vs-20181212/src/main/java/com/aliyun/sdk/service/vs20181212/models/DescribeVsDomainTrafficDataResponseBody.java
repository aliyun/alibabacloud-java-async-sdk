...
/**
 * 
 * {@link DescribeVsDomainTrafficDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeVsDomainTrafficDataResponseBody</p>
 */
public class DescribeVsDomainTrafficDataResponseBody extends TeaModel {
    ...
    private DescribeVsDomainTrafficDataResponseBody(Builder builder) {
    ...
    public static DescribeVsDomainTrafficDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        /**
         * <p>The request ID for this task.</p>
         * 
         * <strong>example:</strong>
        ...
        public DescribeVsDomainTrafficDataResponseBody build() {
            return new DescribeVsDomainTrafficDataResponseBody(this);
        } 
