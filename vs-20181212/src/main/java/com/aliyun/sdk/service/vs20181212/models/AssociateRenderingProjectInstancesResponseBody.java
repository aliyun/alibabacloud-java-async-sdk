...
/**
 * 
 * {@link AssociateRenderingProjectInstancesResponseBody} extends {@link TeaModel}
 *
 * <p>AssociateRenderingProjectInstancesResponseBody</p>
 */
public class AssociateRenderingProjectInstancesResponseBody extends TeaModel {
    ...
    private AssociateRenderingProjectInstancesResponseBody(Builder builder) {
    ...
    public static AssociateRenderingProjectInstancesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AssociateRenderingProjectInstancesResponseBody model) {
        ...
        public AssociateRenderingProjectInstancesResponseBody build() {
            return new AssociateRenderingProjectInstancesResponseBody(this);
        } 
