...
/**
 * {@link DescribeVsPullStreamConfigResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeVsPullStreamConfigResponseBody</p>
 */
public class DescribeVsPullStreamConfigResponseBody extends TeaModel {
    ...
    private DescribeVsPullStreamConfigResponseBody(Builder builder) {
    ...
    public static DescribeVsPullStreamConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeVsPullStreamConfigResponseBody build() {
            return new DescribeVsPullStreamConfigResponseBody(this);
        } 
