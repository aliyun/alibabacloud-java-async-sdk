...
/**
 * 
 * {@link MoveHiveEdgeWorkersResponseBody} extends {@link TeaModel}
 *
 * <p>MoveHiveEdgeWorkersResponseBody</p>
 */
public class MoveHiveEdgeWorkersResponseBody extends TeaModel {
    ...
    private MoveHiveEdgeWorkersResponseBody(Builder builder) {
    ...
    public static MoveHiveEdgeWorkersResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(MoveHiveEdgeWorkersResponseBody model) {
        ...
        public MoveHiveEdgeWorkersResponseBody build() {
            return new MoveHiveEdgeWorkersResponseBody(this);
        } 
