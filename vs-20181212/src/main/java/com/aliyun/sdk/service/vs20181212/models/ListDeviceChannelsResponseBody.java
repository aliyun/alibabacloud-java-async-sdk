...
/**
 * {@link ListDeviceChannelsResponseBody} extends {@link TeaModel}
 *
 * <p>ListDeviceChannelsResponseBody</p>
 */
public class ListDeviceChannelsResponseBody extends TeaModel {
    ...
    private ListDeviceChannelsResponseBody(Builder builder) {
    ...
    public static ListDeviceChannelsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListDeviceChannelsResponseBody build() {
            return new ListDeviceChannelsResponseBody(this);
        } 
