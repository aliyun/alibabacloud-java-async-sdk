...
public class DescribeVsDomainReqBpsDataResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeVsDomainReqBpsDataResponseBody model) {
            this.dataInterval = model.dataInterval;
            this.domainName = model.domainName;
            this.endTime = model.endTime;
            this.reqBpsDataPerInterval = model.reqBpsDataPerInterval;
            this.requestId = model.requestId;
            this.startTime = model.startTime;
        } 

        /**
         * <p>Time interval between records, in seconds.</p>
         * 
    ...
    public static class DataModule extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(DataModule model) {
                this.reqBpsValue = model.reqBpsValue;
    ...
    public static class ReqBpsDataPerInterval extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(ReqBpsDataPerInterval model) {
