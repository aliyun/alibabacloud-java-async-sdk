...
/**
 * 
 * {@link AssociateRenderingProjectInstancesRequest} extends {@link RequestModel}
 *
 * <p>AssociateRenderingProjectInstancesRequest</p>
 */
public class AssociateRenderingProjectInstancesRequest extends Request {
    ...
    private AssociateRenderingProjectInstancesRequest(Builder builder) {
        super(builder);
    ...
    public static AssociateRenderingProjectInstancesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssociateRenderingProjectInstancesRequest, Builder> {
        private String projectId; 
        private java.util.List<String> renderingInstanceIds; 
        ...
        private Builder(AssociateRenderingProjectInstancesRequest request) {
            super(request);
        ...
        @Override
        public AssociateRenderingProjectInstancesRequest build() {
            return new AssociateRenderingProjectInstancesRequest(this);
        } 
