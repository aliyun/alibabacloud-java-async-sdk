...
/**
 * 
 * {@link DelHiveEdgeWorkersResponseBody} extends {@link TeaModel}
 *
 * <p>DelHiveEdgeWorkersResponseBody</p>
 */
public class DelHiveEdgeWorkersResponseBody extends TeaModel {
    ...
    private DelHiveEdgeWorkersResponseBody(Builder builder) {
    ...
    public static DelHiveEdgeWorkersResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DelHiveEdgeWorkersResponseBody model) {
        ...
        public DelHiveEdgeWorkersResponseBody build() {
            return new DelHiveEdgeWorkersResponseBody(this);
        } 
