...
/**
 * 
 * {@link AddHiveEdgeWorkersResponseBody} extends {@link TeaModel}
 *
 * <p>AddHiveEdgeWorkersResponseBody</p>
 */
public class AddHiveEdgeWorkersResponseBody extends TeaModel {
    ...
    private AddHiveEdgeWorkersResponseBody(Builder builder) {
    ...
    public static AddHiveEdgeWorkersResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddHiveEdgeWorkersResponseBody model) {
        ...
        public AddHiveEdgeWorkersResponseBody build() {
            return new AddHiveEdgeWorkersResponseBody(this);
        } 
