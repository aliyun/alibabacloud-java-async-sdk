...
public class DescribeVsDomainConfigsResponseBody extends TeaModel {
    ...
    public static DescribeVsDomainConfigsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeVsDomainConfigsResponseBody build() {
            return new DescribeVsDomainConfigsResponseBody(this);
        } 
