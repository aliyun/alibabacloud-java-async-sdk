...
public class BatchUnbindParentPlatformDevicesResponseBody extends TeaModel {
    ...
    public static BatchUnbindParentPlatformDevicesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BatchUnbindParentPlatformDevicesResponseBody model) {
        ...
        public BatchUnbindParentPlatformDevicesResponseBody build() {
            return new BatchUnbindParentPlatformDevicesResponseBody(this);
        } 
    ...
    public static class Results extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(Results model) {
                ...
                this.parentPlatformId = model.parentPlatformId;
            } 
