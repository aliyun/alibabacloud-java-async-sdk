...
/**
 * {@link InsertTagsRequest} extends {@link RequestModel}
 *
 * <p>InsertTagsRequest</p>
 */
public class InsertTagsRequest extends Request {
    @Query
    ...
    private InsertTagsRequest(Builder builder) {
        super(builder);
    ...
    public static InsertTagsRequest create() {
    ...
    public static final class Builder extends Request.Builder<InsertTagsRequest, Builder> {
        private String instanceName; 
        private Long resourceOwnerId; 
        private java.util.List < TagInfo> tagInfo; 
        ...
        private Builder(InsertTagsRequest request) {
            super(request);
        ...
        @Override
        public InsertTagsRequest build() {
            return new InsertTagsRequest(this);
        } 
