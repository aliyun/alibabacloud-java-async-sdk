...
/**
 * 
 * {@link DeleteNetworkResponse} extends {@link TeaModel}
 *
 * <p>DeleteNetworkResponse</p>
 */
public class DeleteNetworkResponse extends Response {
    ...
    public static DeleteNetworkResponse create() {
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DeleteNetworkResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DeleteNetworkResponse build() {
