...
/**
 * 
 * {@link MountInstanceSDGResponseBody} extends {@link TeaModel}
 *
 * <p>MountInstanceSDGResponseBody</p>
 */
public class MountInstanceSDGResponseBody extends TeaModel {
    ...
    private MountInstanceSDGResponseBody(Builder builder) {
    ...
    public static MountInstanceSDGResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(MountInstanceSDGResponseBody model) {
        ...
        public MountInstanceSDGResponseBody build() {
            return new MountInstanceSDGResponseBody(this);
        } 
