...
/**
 * 
 * {@link DescribeEnsSaleControlRequest} extends {@link RequestModel}
 *
 * <p>DescribeEnsSaleControlRequest</p>
 */
public class DescribeEnsSaleControlRequest extends Request {
    ...
    private DescribeEnsSaleControlRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeEnsSaleControlRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeEnsSaleControlRequest, Builder> {
        private String aliUidAccount; 
        private String commodityCode; 
        private String customAccount; 
        private String moduleCode; 
        ...
        private Builder(DescribeEnsSaleControlRequest request) {
            super(request);
        ...
        @Override
        public DescribeEnsSaleControlRequest build() {
            return new DescribeEnsSaleControlRequest(this);
        } 
