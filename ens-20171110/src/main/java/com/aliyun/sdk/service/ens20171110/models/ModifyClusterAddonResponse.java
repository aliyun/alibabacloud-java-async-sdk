...
public class ModifyClusterAddonResponse extends Response {
    ...
    private ModifyClusterAddonResponseBody body;
...
@Override
     ...
     * @return body
     */
    public ModifyClusterAddonResponseBody getBody() {
        return this.body;
    }
    ...
    public interface Builder extends Response.Builder<ModifyClusterAddonResponse, Builder> {
        ...
        Builder body(ModifyClusterAddonResponseBody body);
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(ModifyClusterAddonResponseBody body) {
            this.body = body;
            return this;
        }
