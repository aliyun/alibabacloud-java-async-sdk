...
public class CreateEnsServiceResponseBody extends TeaModel {
    ...
    private CreateEnsServiceResponseBody(Builder builder) {
    ...
    public static CreateEnsServiceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateEnsServiceResponseBody build() {
            return new CreateEnsServiceResponseBody(this);
        } 
