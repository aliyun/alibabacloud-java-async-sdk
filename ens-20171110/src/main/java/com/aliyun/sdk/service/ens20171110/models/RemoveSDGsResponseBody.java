...
/**
 * 
 * {@link RemoveSDGsResponseBody} extends {@link TeaModel}
 *
 * <p>RemoveSDGsResponseBody</p>
 */
public class RemoveSDGsResponseBody extends TeaModel {
    ...
    private RemoveSDGsResponseBody(Builder builder) {
    ...
    public static RemoveSDGsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RemoveSDGsResponseBody model) {
        ...
        public RemoveSDGsResponseBody build() {
            return new RemoveSDGsResponseBody(this);
        } 
