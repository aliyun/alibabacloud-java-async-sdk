...
public class DeleteBucketLifecycleResponse extends Response {
    ...
    private DeleteBucketLifecycleResponseBody body;
    ...
    public interface Builder extends Response.Builder<DeleteBucketLifecycleResponse, Builder> {
        ...
        Builder body(DeleteBucketLifecycleResponseBody body);
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DeleteBucketLifecycleResponseBody body) {
            this.body = body;
            return this;
        }
