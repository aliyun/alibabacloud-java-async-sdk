...
/**
 * 
 * {@link DetachInstanceSDGResponseBody} extends {@link TeaModel}
 *
 * <p>DetachInstanceSDGResponseBody</p>
 */
public class DetachInstanceSDGResponseBody extends TeaModel {
    ...
    private DetachInstanceSDGResponseBody(Builder builder) {
    ...
    public static DetachInstanceSDGResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DetachInstanceSDGResponseBody model) {
        ...
        public DetachInstanceSDGResponseBody build() {
            return new DetachInstanceSDGResponseBody(this);
        } 
