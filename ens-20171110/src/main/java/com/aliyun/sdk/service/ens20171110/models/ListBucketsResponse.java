...
public class ListBucketsResponse extends Response {
    ...
    public interface Builder extends Response.Builder<ListBucketsResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ListBucketsResponseBody body);

        @Override
        ListBucketsResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ListBucketsResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ListBucketsResponseBody body; 
        ...
        private BuilderImpl(ListBucketsResponse response) {
            super(response);
