...
public class DescribeClusterAttachScriptsResponse extends Response {
    ...
    private DescribeClusterAttachScriptsResponseBody body;
...
@Override
    ...
    public interface Builder extends Response.Builder<DescribeClusterAttachScriptsResponse, Builder> {
        ...
        Builder body(DescribeClusterAttachScriptsResponseBody body);
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DescribeClusterAttachScriptsResponseBody body) {
            this.body = body;
            return this;
        }
