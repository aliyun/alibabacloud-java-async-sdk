...
/**
 * 
 * {@link AddFingerprintToOIDCProviderResponseBody} extends {@link TeaModel}
 *
 * <p>AddFingerprintToOIDCProviderResponseBody</p>
 */
public class AddFingerprintToOIDCProviderResponseBody extends TeaModel {
    ...
    private AddFingerprintToOIDCProviderResponseBody(Builder builder) {
    ...
    public static AddFingerprintToOIDCProviderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddFingerprintToOIDCProviderResponseBody model) {
        ...
        public AddFingerprintToOIDCProviderResponseBody build() {
            return new AddFingerprintToOIDCProviderResponseBody(this);
        } 
