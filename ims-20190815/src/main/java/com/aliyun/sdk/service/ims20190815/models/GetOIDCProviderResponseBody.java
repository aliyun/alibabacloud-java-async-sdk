...
public class GetOIDCProviderResponseBody extends TeaModel {
    ...
    private GetOIDCProviderResponseBody(Builder builder) {
    ...
    public static GetOIDCProviderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetOIDCProviderResponseBody model) {
        ...
        public GetOIDCProviderResponseBody build() {
            return new GetOIDCProviderResponseBody(this);
        } 
