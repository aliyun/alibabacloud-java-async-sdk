...
/**
 * 
 * {@link SetVerificationInfoRequest} extends {@link RequestModel}
 *
 * <p>SetVerificationInfoRequest</p>
 */
public class SetVerificationInfoRequest extends Request {
    ...
    private SetVerificationInfoRequest(Builder builder) {
        super(builder);
    ...
    public static SetVerificationInfoRequest create() {
    ...
    public static final class Builder extends Request.Builder<SetVerificationInfoRequest, Builder> {
        private String email; 
        private String mobilePhone; 
        private String userPrincipalName; 
        private String verifyType; 
        ...
        private Builder(SetVerificationInfoRequest request) {
            super(request);
        ...
        @Override
        public SetVerificationInfoRequest build() {
            return new SetVerificationInfoRequest(this);
        } 
