...
/**
 * 
 * {@link GetExternalApplicationResponseBody} extends {@link TeaModel}
 *
 * <p>GetExternalApplicationResponseBody</p>
 */
public class GetExternalApplicationResponseBody extends TeaModel {
    ...
    private GetExternalApplicationResponseBody(Builder builder) {
    ...
    public static GetExternalApplicationResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetExternalApplicationResponseBody build() {
            return new GetExternalApplicationResponseBody(this);
        } 
