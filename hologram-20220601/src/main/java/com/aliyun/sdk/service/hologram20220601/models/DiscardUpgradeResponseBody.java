...
/**
 * 
 * {@link DiscardUpgradeResponseBody} extends {@link TeaModel}
 *
 * <p>DiscardUpgradeResponseBody</p>
 */
public class DiscardUpgradeResponseBody extends TeaModel {
    ...
    private DiscardUpgradeResponseBody(Builder builder) {
    ...
    public static DiscardUpgradeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DiscardUpgradeResponseBody model) {
        ...
        public DiscardUpgradeResponseBody build() {
            return new DiscardUpgradeResponseBody(this);
        } 
