...
/**
 * 
 * {@link GetUpgradeableResponseBody} extends {@link TeaModel}
 *
 * <p>GetUpgradeableResponseBody</p>
 */
public class GetUpgradeableResponseBody extends TeaModel {
    ...
    private GetUpgradeableResponseBody(Builder builder) {
    ...
    public static GetUpgradeableResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetUpgradeableResponseBody model) {
        ...
        public GetUpgradeableResponseBody build() {
            return new GetUpgradeableResponseBody(this);
        } 
