...
/**
 * 
 * {@link GetDomainPartRequest} extends {@link RequestModel}
 *
 * <p>GetDomainPartRequest</p>
 */
public class GetDomainPartRequest extends Request {
    ...
    private GetDomainPartRequest(Builder builder) {
        super(builder);
    ...
    public static GetDomainPartRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetDomainPartRequest, Builder> {
        private Boolean compressEnable; 
        private String dataType; 
        private String domainCode; 
        private String part; 
        ...
        private Builder(GetDomainPartRequest request) {
            super(request);
        ...
        @Override
        public GetDomainPartRequest build() {
            return new GetDomainPartRequest(this);
        } 
