...
/**
 * 
 * {@link GetReadyFlagResponseBody} extends {@link TeaModel}
 *
 * <p>GetReadyFlagResponseBody</p>
 */
public class GetReadyFlagResponseBody extends TeaModel {
    ...
    private GetReadyFlagResponseBody(Builder builder) {
    ...
    public static GetReadyFlagResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetReadyFlagResponseBody model) {
        ...
        public GetReadyFlagResponseBody build() {
            return new GetReadyFlagResponseBody(this);
        } 
