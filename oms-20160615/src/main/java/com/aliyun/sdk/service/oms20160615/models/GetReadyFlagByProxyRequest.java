...
/**
 * 
 * {@link GetReadyFlagByProxyRequest} extends {@link RequestModel}
 *
 * <p>GetReadyFlagByProxyRequest</p>
 */
public class GetReadyFlagByProxyRequest extends Request {
    ...
    private GetReadyFlagByProxyRequest(Builder builder) {
        super(builder);
    ...
    public static GetReadyFlagByProxyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetReadyFlagByProxyRequest, Builder> {
        private String apiType; 
        private Boolean compressEnable; 
        private String dataType; 
        private String domainCode; 
        ...
        private Builder(GetReadyFlagByProxyRequest request) {
            super(request);
        ...
        @Override
        public GetReadyFlagByProxyRequest build() {
            return new GetReadyFlagByProxyRequest(this);
        } 
