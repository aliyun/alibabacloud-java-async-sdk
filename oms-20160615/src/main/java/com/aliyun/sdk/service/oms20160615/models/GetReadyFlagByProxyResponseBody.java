...
/**
 * 
 * {@link GetReadyFlagByProxyResponseBody} extends {@link TeaModel}
 *
 * <p>GetReadyFlagByProxyResponseBody</p>
 */
public class GetReadyFlagByProxyResponseBody extends TeaModel {
    ...
    private GetReadyFlagByProxyResponseBody(Builder builder) {
    ...
    public static GetReadyFlagByProxyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetReadyFlagByProxyResponseBody model) {
        ...
        public GetReadyFlagByProxyResponseBody build() {
            return new GetReadyFlagByProxyResponseBody(this);
        } 
