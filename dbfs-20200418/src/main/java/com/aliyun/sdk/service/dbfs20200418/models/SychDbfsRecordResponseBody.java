...
/**
 * {@link SychDbfsRecordResponseBody} extends {@link TeaModel}
 *
 * <p>SychDbfsRecordResponseBody</p>
 */
public class SychDbfsRecordResponseBody extends TeaModel {
    @NameInMap("Records")
    ...
    private SychDbfsRecordResponseBody(Builder builder) {
    ...
    public static SychDbfsRecordResponseBody create() {
    ...
    public static final class Builder {
        ...
        public SychDbfsRecordResponseBody build() {
            return new SychDbfsRecordResponseBody(this);
        } 
