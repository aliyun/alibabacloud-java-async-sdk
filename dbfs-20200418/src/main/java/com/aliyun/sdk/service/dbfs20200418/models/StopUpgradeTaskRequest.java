...
/**
 * {@link StopUpgradeTaskRequest} extends {@link RequestModel}
 *
 * <p>StopUpgradeTaskRequest</p>
 */
public class StopUpgradeTaskRequest extends Request {
    @Query
    ...
    private StopUpgradeTaskRequest(Builder builder) {
        super(builder);
    ...
    public static StopUpgradeTaskRequest create() {
    ...
    public static final class Builder extends Request.Builder<StopUpgradeTaskRequest, Builder> {
        private String batchStrategyList; 
        private Integer pageNumber; 
        private Integer pageSize; 
        private String regionId; 
        ...
        private Builder(StopUpgradeTaskRequest response) {
            super(response);
        ...
        @Override
        public StopUpgradeTaskRequest build() {
            return new StopUpgradeTaskRequest(this);
        } 
