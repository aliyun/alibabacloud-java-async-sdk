...
/**
 * {@link GetSynchronizConstantsResponseBody} extends {@link TeaModel}
 *
 * <p>GetSynchronizConstantsResponseBody</p>
 */
public class GetSynchronizConstantsResponseBody extends TeaModel {
    ...
    private GetSynchronizConstantsResponseBody(Builder builder) {
    ...
    public static GetSynchronizConstantsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetSynchronizConstantsResponseBody build() {
            return new GetSynchronizConstantsResponseBody(this);
        } 
