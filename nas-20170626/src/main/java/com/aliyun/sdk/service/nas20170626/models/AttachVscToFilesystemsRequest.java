...
/**
 * 
 * {@link AttachVscToFilesystemsRequest} extends {@link RequestModel}
 *
 * <p>AttachVscToFilesystemsRequest</p>
 */
public class AttachVscToFilesystemsRequest extends Request {
    ...
    private AttachVscToFilesystemsRequest(Builder builder) {
        super(builder);
    ...
    public static AttachVscToFilesystemsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AttachVscToFilesystemsRequest, Builder> {
        private String clientToken; 
        private java.util.List<ResourceIds> resourceIds; 
        ...
        private Builder(AttachVscToFilesystemsRequest request) {
            super(request);
        ...
        @Override
        public AttachVscToFilesystemsRequest build() {
            return new AttachVscToFilesystemsRequest(this);
        } 
    ...
    /**
     * 
     * {@link AttachVscToFilesystemsRequest} extends {@link TeaModel}
     *
     * <p>AttachVscToFilesystemsRequest</p>
     */
