...
/**
 * 
 * {@link PushSimpleResponseBody} extends {@link TeaModel}
 *
 * <p>PushSimpleResponseBody</p>
 */
public class PushSimpleResponseBody extends TeaModel {
    ...
    private PushSimpleResponseBody(Builder builder) {
    ...
    public static PushSimpleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PushSimpleResponseBody model) {
        ...
        public PushSimpleResponseBody build() {
            return new PushSimpleResponseBody(this);
        } 
