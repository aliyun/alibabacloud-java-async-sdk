...
public class DeleteMdsWhitelistContentResponseBody extends TeaModel {
    ...
    private DeleteMdsWhitelistContentResponseBody(Builder builder) {
    ...
    public static final class Builder {
        ...
        public DeleteMdsWhitelistContentResponseBody build() {
            return new DeleteMdsWhitelistContentResponseBody(this);
        } 
