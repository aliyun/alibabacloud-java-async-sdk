...
/**
 * 
 * {@link PushTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>PushTemplateResponseBody</p>
 */
public class PushTemplateResponseBody extends TeaModel {
    ...
    private PushTemplateResponseBody(Builder builder) {
    ...
    public static PushTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PushTemplateResponseBody model) {
        ...
        public PushTemplateResponseBody build() {
            return new PushTemplateResponseBody(this);
        } 
