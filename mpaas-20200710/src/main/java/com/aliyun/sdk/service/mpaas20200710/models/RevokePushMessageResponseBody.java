...
/**
 * 
 * {@link RevokePushMessageResponseBody} extends {@link TeaModel}
 *
 * <p>RevokePushMessageResponseBody</p>
 */
public class RevokePushMessageResponseBody extends TeaModel {
    ...
    private RevokePushMessageResponseBody(Builder builder) {
    ...
    public static RevokePushMessageResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RevokePushMessageResponseBody model) {
        ...
        public RevokePushMessageResponseBody build() {
            return new RevokePushMessageResponseBody(this);
        } 
