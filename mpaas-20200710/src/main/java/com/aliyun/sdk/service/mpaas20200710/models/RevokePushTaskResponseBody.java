...
/**
 * 
 * {@link RevokePushTaskResponseBody} extends {@link TeaModel}
 *
 * <p>RevokePushTaskResponseBody</p>
 */
public class RevokePushTaskResponseBody extends TeaModel {
    ...
    private RevokePushTaskResponseBody(Builder builder) {
    ...
    public static RevokePushTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RevokePushTaskResponseBody model) {
        ...
        public RevokePushTaskResponseBody build() {
            return new RevokePushTaskResponseBody(this);
        } 
