...
public class UpdateVpcEndpointConnectionAttributeRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<UpdateVpcEndpointConnectionAttributeRequest, Builder> {
        ...
        /**
         * <p>The bandwidth of the endpoint connection that you want to modify. Unit: Mbit/s. Valid values: <strong>3072</strong> to <strong>10240</strong>.</p>
         * <blockquote>
         * <p> The bandwidth of an endpoint connection is in the range of <strong>100</strong> to <strong>10,240</strong> Mbit/s. The default bandwidth is <strong>3,072</strong> Mbit/s. When the endpoint is connected to the endpoint service, the default bandwidth is the minimum bandwidth. In this case, the connection bandwidth range is <strong>3,072</strong> to <strong>10,240</strong> Mbit/s. If Classic Load Balancer (CLB) instances or Application Load Balancer (ALB) instances are specified as service resources, you can modify the endpoint connection bandwidth based on your business requirements. This parameter is invalid if Network Load Balancer (NLB) instances are specified as service resources.</p>
         * </blockquote>
         * 
        ...
        /**
         * <p>The region ID of the endpoint connection whose bandwidth you want to modify. You can call the <a href="https://help.aliyun.com/document_detail/120468.html">DescribeRegions</a> operation to query the most recent region list.</p>
         * <p>This parameter is required.</p>
         * 
         * <strong>example:</strong>
         * <p>eu-west-1</p>
