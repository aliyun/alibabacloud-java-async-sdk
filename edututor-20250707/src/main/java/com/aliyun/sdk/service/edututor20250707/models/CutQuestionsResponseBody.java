...
/**
 * 
 * {@link CutQuestionsResponseBody} extends {@link TeaModel}
 *
 * <p>CutQuestionsResponseBody</p>
 */
public class CutQuestionsResponseBody extends TeaModel {
    ...
    private CutQuestionsResponseBody(Builder builder) {
    ...
    public static CutQuestionsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CutQuestionsResponseBody model) {
        ...
        public CutQuestionsResponseBody build() {
            return new CutQuestionsResponseBody(this);
        } 
