...
/**
 * 
 * {@link ReplyTicketResponseBody} extends {@link TeaModel}
 *
 * <p>ReplyTicketResponseBody</p>
 */
public class ReplyTicketResponseBody extends TeaModel {
    ...
    private ReplyTicketResponseBody(Builder builder) {
    ...
    public static ReplyTicketResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReplyTicketResponseBody model) {
        ...
        public ReplyTicketResponseBody build() {
            return new ReplyTicketResponseBody(this);
        } 
