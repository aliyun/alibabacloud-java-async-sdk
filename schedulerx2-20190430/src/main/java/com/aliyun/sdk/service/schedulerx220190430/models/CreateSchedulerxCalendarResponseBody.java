...
/**
 * 
 * {@link CreateSchedulerxCalendarResponseBody} extends {@link TeaModel}
 *
 * <p>CreateSchedulerxCalendarResponseBody</p>
 */
public class CreateSchedulerxCalendarResponseBody extends TeaModel {
    ...
    private CreateSchedulerxCalendarResponseBody(Builder builder) {
    ...
    public static CreateSchedulerxCalendarResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateSchedulerxCalendarResponseBody model) {
        ...
        public CreateSchedulerxCalendarResponseBody build() {
            return new CreateSchedulerxCalendarResponseBody(this);
        } 
