...
/**
 * 
 * {@link ManageSchedulerxNotificationPolicyResponseBody} extends {@link TeaModel}
 *
 * <p>ManageSchedulerxNotificationPolicyResponseBody</p>
 */
public class ManageSchedulerxNotificationPolicyResponseBody extends TeaModel {
    ...
    private ManageSchedulerxNotificationPolicyResponseBody(Builder builder) {
    ...
    public static ManageSchedulerxNotificationPolicyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ManageSchedulerxNotificationPolicyResponseBody model) {
        ...
        public ManageSchedulerxNotificationPolicyResponseBody build() {
            return new ManageSchedulerxNotificationPolicyResponseBody(this);
        } 
