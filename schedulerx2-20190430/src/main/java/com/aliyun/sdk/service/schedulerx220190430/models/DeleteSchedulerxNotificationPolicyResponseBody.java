...
/**
 * 
 * {@link DeleteSchedulerxNotificationPolicyResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteSchedulerxNotificationPolicyResponseBody</p>
 */
public class DeleteSchedulerxNotificationPolicyResponseBody extends TeaModel {
    ...
    private DeleteSchedulerxNotificationPolicyResponseBody(Builder builder) {
    ...
    public static DeleteSchedulerxNotificationPolicyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteSchedulerxNotificationPolicyResponseBody model) {
        ...
        public DeleteSchedulerxNotificationPolicyResponseBody build() {
            return new DeleteSchedulerxNotificationPolicyResponseBody(this);
        } 
