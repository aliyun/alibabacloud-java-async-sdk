...
/**
 * 
 * {@link ManageSchedulerxCalendarResponseBody} extends {@link TeaModel}
 *
 * <p>ManageSchedulerxCalendarResponseBody</p>
 */
public class ManageSchedulerxCalendarResponseBody extends TeaModel {
    ...
    private ManageSchedulerxCalendarResponseBody(Builder builder) {
    ...
    public static ManageSchedulerxCalendarResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ManageSchedulerxCalendarResponseBody model) {
        ...
        public ManageSchedulerxCalendarResponseBody build() {
            return new ManageSchedulerxCalendarResponseBody(this);
        } 
