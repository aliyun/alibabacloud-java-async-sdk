...
/**
 * 
 * {@link CreateSchedulerxCalendarRequest} extends {@link RequestModel}
 *
 * <p>CreateSchedulerxCalendarRequest</p>
 */
public class CreateSchedulerxCalendarRequest extends Request {
    ...
    private CreateSchedulerxCalendarRequest(Builder builder) {
        super(builder);
    ...
    public static CreateSchedulerxCalendarRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateSchedulerxCalendarRequest, Builder> {
        private String calendarName; 
        private String monthDaysContent; 
        private String regionId; 
        private Integer year; 
        ...
        private Builder(CreateSchedulerxCalendarRequest request) {
            super(request);
        ...
        @Override
        public CreateSchedulerxCalendarRequest build() {
            return new CreateSchedulerxCalendarRequest(this);
        } 
