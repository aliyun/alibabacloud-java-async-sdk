...
/**
 * 
 * {@link DeleteSchedulerxCalendarResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteSchedulerxCalendarResponseBody</p>
 */
public class DeleteSchedulerxCalendarResponseBody extends TeaModel {
    ...
    private DeleteSchedulerxCalendarResponseBody(Builder builder) {
    ...
    public static DeleteSchedulerxCalendarResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteSchedulerxCalendarResponseBody model) {
        ...
        public DeleteSchedulerxCalendarResponseBody build() {
            return new DeleteSchedulerxCalendarResponseBody(this);
        } 
