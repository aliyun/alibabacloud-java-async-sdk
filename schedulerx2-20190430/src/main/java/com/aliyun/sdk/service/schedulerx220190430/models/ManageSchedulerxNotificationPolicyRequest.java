...
/**
 * 
 * {@link ManageSchedulerxNotificationPolicyRequest} extends {@link RequestModel}
 *
 * <p>ManageSchedulerxNotificationPolicyRequest</p>
 */
public class ManageSchedulerxNotificationPolicyRequest extends Request {
    ...
    private ManageSchedulerxNotificationPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static ManageSchedulerxNotificationPolicyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ManageSchedulerxNotificationPolicyRequest, Builder> {
        private String channelTimeRange; 
        private String description; 
        private String policyName; 
        private String regionId; 
        ...
        private Builder(ManageSchedulerxNotificationPolicyRequest request) {
            super(request);
        ...
        @Override
        public ManageSchedulerxNotificationPolicyRequest build() {
            return new ManageSchedulerxNotificationPolicyRequest(this);
        } 
