...
public class ListFbIssueLabelsResponseBody extends TeaModel {
    ...
    private ListFbIssueLabelsResponseBody(Builder builder) {
    ...
    public static ListFbIssueLabelsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListFbIssueLabelsResponseBody build() {
            return new ListFbIssueLabelsResponseBody(this);
        } 
