...
/**
 * {@link GetVersionDownloadUrlResponseBody} extends {@link TeaModel}
 *
 * <p>GetVersionDownloadUrlResponseBody</p>
 */
public class GetVersionDownloadUrlResponseBody extends TeaModel {
    ...
    private GetVersionDownloadUrlResponseBody(Builder builder) {
    ...
    public static GetVersionDownloadUrlResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetVersionDownloadUrlResponseBody build() {
            return new GetVersionDownloadUrlResponseBody(this);
        } 
