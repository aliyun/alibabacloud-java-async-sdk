...
/**
 * 
 * {@link DetachLabelsRequest} extends {@link RequestModel}
 *
 * <p>DetachLabelsRequest</p>
 */
public class DetachLabelsRequest extends Request {
    ...
    private DetachLabelsRequest(Builder builder) {
        super(builder);
    ...
    public static DetachLabelsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DetachLabelsRequest, Builder> {
        private String labelIds; 
        private String serialNo; 
        private String serialNoList; 
        ...
        private Builder(DetachLabelsRequest request) {
            super(request);
        ...
        @Override
        public DetachLabelsRequest build() {
            return new DetachLabelsRequest(this);
        } 
