...
/**
 * 
 * {@link DisassociateResourcesResponseBody} extends {@link TeaModel}
 *
 * <p>DisassociateResourcesResponseBody</p>
 */
public class DisassociateResourcesResponseBody extends TeaModel {
    ...
    private DisassociateResourcesResponseBody(Builder builder) {
    ...
    public static DisassociateResourcesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DisassociateResourcesResponseBody model) {
        ...
        public DisassociateResourcesResponseBody build() {
            return new DisassociateResourcesResponseBody(this);
        } 
