...
/**
 * 
 * {@link DescribeAppViewTemplatesResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAppViewTemplatesResponseBody</p>
 */
public class DescribeAppViewTemplatesResponseBody extends TeaModel {
    ...
    private DescribeAppViewTemplatesResponseBody(Builder builder) {
    ...
    public static DescribeAppViewTemplatesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeAppViewTemplatesResponseBody model) {
        ...
        public DescribeAppViewTemplatesResponseBody build() {
            return new DescribeAppViewTemplatesResponseBody(this);
        } 
