...
public class DescribeSystemLayoutListResponseBody extends TeaModel {
    ...
    private DescribeSystemLayoutListResponseBody(Builder builder) {
    ...
    public static DescribeSystemLayoutListResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeSystemLayoutListResponseBody build() {
            return new DescribeSystemLayoutListResponseBody(this);
        } 
