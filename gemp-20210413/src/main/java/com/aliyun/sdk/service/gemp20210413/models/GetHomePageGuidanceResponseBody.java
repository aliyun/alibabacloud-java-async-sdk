...
public class GetHomePageGuidanceResponseBody extends TeaModel {
    ...
    public static class Data extends TeaModel {
        @com.aliyun.core.annotation.NameInMap("notifySubscriptionStatus")
        private Boolean notifySubscriptionStatus;

        @com.aliyun.core.annotation.NameInMap("serviceGroupStatus")
        private Boolean serviceGroupStatus;

        @com.aliyun.core.annotation.NameInMap("serviceStatus")
        private Boolean serviceStatus;

        @com.aliyun.core.annotation.NameInMap("usersStatus")
