...
/**
 * {@link CreateServiceGroupRequest} extends {@link RequestModel}
 *
 * <p>CreateServiceGroupRequest</p>
 */
public class CreateServiceGroupRequest extends Request {
    @Body
    ...
    private CreateServiceGroupRequest(Builder builder) {
        super(builder);
    ...
    public static CreateServiceGroupRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateServiceGroupRequest, Builder> {
        private String clientToken; 
        private String enableWebhook; 
        private java.util.List < MonitorSourceTemplates> monitorSourceTemplates; 
        private String serviceGroupDescription; 
        ...
        private Builder(CreateServiceGroupRequest response) {
            super(response);
        ...
        public CreateServiceGroupRequest build() {
            return new CreateServiceGroupRequest(this);
        } 
