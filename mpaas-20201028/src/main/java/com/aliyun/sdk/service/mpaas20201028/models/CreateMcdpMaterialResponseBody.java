...
/**
 * 
 * {@link CreateMcdpMaterialResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMcdpMaterialResponseBody</p>
 */
public class CreateMcdpMaterialResponseBody extends TeaModel {
    ...
    private CreateMcdpMaterialResponseBody(Builder builder) {
    ...
    public static CreateMcdpMaterialResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateMcdpMaterialResponseBody model) {
        ...
        public CreateMcdpMaterialResponseBody build() {
            return new CreateMcdpMaterialResponseBody(this);
        } 
