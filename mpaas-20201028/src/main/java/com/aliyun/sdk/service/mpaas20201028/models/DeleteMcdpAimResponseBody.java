...
/**
 * 
 * {@link DeleteMcdpAimResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMcdpAimResponseBody</p>
 */
public class DeleteMcdpAimResponseBody extends TeaModel {
    ...
    private DeleteMcdpAimResponseBody(Builder builder) {
    ...
    public static DeleteMcdpAimResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteMcdpAimResponseBody model) {
        ...
        public DeleteMcdpAimResponseBody build() {
            return new DeleteMcdpAimResponseBody(this);
        } 
