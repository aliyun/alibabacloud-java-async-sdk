...
/**
 * 
 * {@link QueryPayOrderToMsenceRequest} extends {@link RequestModel}
 *
 * <p>QueryPayOrderToMsenceRequest</p>
 */
public class QueryPayOrderToMsenceRequest extends Request {
    ...
    private QueryPayOrderToMsenceRequest(Builder builder) {
        super(builder);
    ...
    public static QueryPayOrderToMsenceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryPayOrderToMsenceRequest, Builder> {
        private String appId; 
        private String customId; 
        private String miniProgramId; 
        private String platformId; 
        ...
        private Builder(QueryPayOrderToMsenceRequest request) {
            super(request);
        ...
        @Override
        public QueryPayOrderToMsenceRequest build() {
            return new QueryPayOrderToMsenceRequest(this);
        } 
