...
/**
 * 
 * {@link GetUserAppEnhanceProcessInMsaResponseBody} extends {@link TeaModel}
 *
 * <p>GetUserAppEnhanceProcessInMsaResponseBody</p>
 */
public class GetUserAppEnhanceProcessInMsaResponseBody extends TeaModel {
    ...
    private GetUserAppEnhanceProcessInMsaResponseBody(Builder builder) {
    ...
    public static GetUserAppEnhanceProcessInMsaResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetUserAppEnhanceProcessInMsaResponseBody model) {
        ...
        public GetUserAppEnhanceProcessInMsaResponseBody build() {
            return new GetUserAppEnhanceProcessInMsaResponseBody(this);
        } 
