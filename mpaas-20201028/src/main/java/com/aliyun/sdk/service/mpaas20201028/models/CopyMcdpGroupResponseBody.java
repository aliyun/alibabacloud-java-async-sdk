...
/**
 * 
 * {@link CopyMcdpGroupResponseBody} extends {@link TeaModel}
 *
 * <p>CopyMcdpGroupResponseBody</p>
 */
public class CopyMcdpGroupResponseBody extends TeaModel {
    ...
    private CopyMcdpGroupResponseBody(Builder builder) {
    ...
    public static CopyMcdpGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CopyMcdpGroupResponseBody model) {
        ...
        public CopyMcdpGroupResponseBody build() {
            return new CopyMcdpGroupResponseBody(this);
        } 
