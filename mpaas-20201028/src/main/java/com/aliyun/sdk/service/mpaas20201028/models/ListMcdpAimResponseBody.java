...
/**
 * 
 * {@link ListMcdpAimResponseBody} extends {@link TeaModel}
 *
 * <p>ListMcdpAimResponseBody</p>
 */
public class ListMcdpAimResponseBody extends TeaModel {
    ...
    private ListMcdpAimResponseBody(Builder builder) {
    ...
    public static ListMcdpAimResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListMcdpAimResponseBody model) {
        ...
        public ListMcdpAimResponseBody build() {
            return new ListMcdpAimResponseBody(this);
        } 
