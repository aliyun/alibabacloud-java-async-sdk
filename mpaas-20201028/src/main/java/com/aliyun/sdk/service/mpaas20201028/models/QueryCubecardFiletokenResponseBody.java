...
/**
 * 
 * {@link QueryCubecardFiletokenResponseBody} extends {@link TeaModel}
 *
 * <p>QueryCubecardFiletokenResponseBody</p>
 */
public class QueryCubecardFiletokenResponseBody extends TeaModel {
    ...
    private QueryCubecardFiletokenResponseBody(Builder builder) {
    ...
    public static QueryCubecardFiletokenResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryCubecardFiletokenResponseBody model) {
        ...
        public QueryCubecardFiletokenResponseBody build() {
            return new QueryCubecardFiletokenResponseBody(this);
        } 
