...
/**
 * {@link CreateMcdpEventResponse} extends {@link TeaModel}
 *
 * <p>CreateMcdpEventResponse</p>
 */
public class CreateMcdpEventResponse extends Response {
    @NameInMap("headers")
    ...
    public static CreateMcdpEventResponse create() {
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(CreateMcdpEventResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public CreateMcdpEventResponse build() {
            return new CreateMcdpEventResponse(this);
        } 
