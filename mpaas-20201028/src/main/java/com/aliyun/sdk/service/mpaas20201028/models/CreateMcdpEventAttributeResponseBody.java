...
/**
 * {@link CreateMcdpEventAttributeResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMcdpEventAttributeResponseBody</p>
 */
public class CreateMcdpEventAttributeResponseBody extends TeaModel {
    ...
    private CreateMcdpEventAttributeResponseBody(Builder builder) {
    ...
    public static CreateMcdpEventAttributeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateMcdpEventAttributeResponseBody build() {
            return new CreateMcdpEventAttributeResponseBody(this);
        } 
