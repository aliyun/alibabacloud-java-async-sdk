...
/**
 * 
 * {@link CreateMdsCubeResourceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMdsCubeResourceResponseBody</p>
 */
public class CreateMdsCubeResourceResponseBody extends TeaModel {
    ...
    private CreateMdsCubeResourceResponseBody(Builder builder) {
    ...
    public static CreateMdsCubeResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateMdsCubeResourceResponseBody model) {
        ...
        public CreateMdsCubeResourceResponseBody build() {
            return new CreateMdsCubeResourceResponseBody(this);
        } 
