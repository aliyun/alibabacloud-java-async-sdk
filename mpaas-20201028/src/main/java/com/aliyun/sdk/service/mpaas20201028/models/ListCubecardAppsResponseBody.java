...
/**
 * 
 * {@link ListCubecardAppsResponseBody} extends {@link TeaModel}
 *
 * <p>ListCubecardAppsResponseBody</p>
 */
public class ListCubecardAppsResponseBody extends TeaModel {
    ...
    private ListCubecardAppsResponseBody(Builder builder) {
    ...
    public static ListCubecardAppsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListCubecardAppsResponseBody model) {
        ...
        public ListCubecardAppsResponseBody build() {
            return new ListCubecardAppsResponseBody(this);
        } 
