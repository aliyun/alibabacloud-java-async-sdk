...
/**
 * 
 * {@link AddMdsMiniConfigResponseBody} extends {@link TeaModel}
 *
 * <p>AddMdsMiniConfigResponseBody</p>
 */
public class AddMdsMiniConfigResponseBody extends TeaModel {
    ...
    private AddMdsMiniConfigResponseBody(Builder builder) {
    ...
    public static AddMdsMiniConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddMdsMiniConfigResponseBody model) {
        ...
        public AddMdsMiniConfigResponseBody build() {
            return new AddMdsMiniConfigResponseBody(this);
        } 
