...
/**
 * 
 * {@link DeleteMcdpCrowdResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMcdpCrowdResponseBody</p>
 */
public class DeleteMcdpCrowdResponseBody extends TeaModel {
    ...
    private DeleteMcdpCrowdResponseBody(Builder builder) {
    ...
    public static DeleteMcdpCrowdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteMcdpCrowdResponseBody model) {
        ...
        public DeleteMcdpCrowdResponseBody build() {
            return new DeleteMcdpCrowdResponseBody(this);
        } 
