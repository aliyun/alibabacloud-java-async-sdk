...
/**
 * 
 * {@link QueryMcdpAimResponseBody} extends {@link TeaModel}
 *
 * <p>QueryMcdpAimResponseBody</p>
 */
public class QueryMcdpAimResponseBody extends TeaModel {
    ...
    private QueryMcdpAimResponseBody(Builder builder) {
    ...
    public static QueryMcdpAimResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryMcdpAimResponseBody model) {
        ...
        public QueryMcdpAimResponseBody build() {
            return new QueryMcdpAimResponseBody(this);
        } 
