...
/**
 * 
 * {@link UpdateMdsCubeResourceResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateMdsCubeResourceResponseBody</p>
 */
public class UpdateMdsCubeResourceResponseBody extends TeaModel {
    ...
    private UpdateMdsCubeResourceResponseBody(Builder builder) {
    ...
    public static UpdateMdsCubeResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateMdsCubeResourceResponseBody model) {
        ...
        public UpdateMdsCubeResourceResponseBody build() {
            return new UpdateMdsCubeResourceResponseBody(this);
        } 
