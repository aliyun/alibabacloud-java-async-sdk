...
/**
 * 
 * {@link DeleteMdsCubeTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMdsCubeTemplateResponseBody</p>
 */
public class DeleteMdsCubeTemplateResponseBody extends TeaModel {
    ...
    private DeleteMdsCubeTemplateResponseBody(Builder builder) {
    ...
    public static DeleteMdsCubeTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteMdsCubeTemplateResponseBody model) {
        ...
        public DeleteMdsCubeTemplateResponseBody build() {
            return new DeleteMdsCubeTemplateResponseBody(this);
        } 
