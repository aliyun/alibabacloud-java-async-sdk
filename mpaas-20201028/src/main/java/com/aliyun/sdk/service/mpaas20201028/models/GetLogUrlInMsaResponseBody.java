...
/**
 * 
 * {@link GetLogUrlInMsaResponseBody} extends {@link TeaModel}
 *
 * <p>GetLogUrlInMsaResponseBody</p>
 */
public class GetLogUrlInMsaResponseBody extends TeaModel {
    ...
    private GetLogUrlInMsaResponseBody(Builder builder) {
    ...
    public static GetLogUrlInMsaResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetLogUrlInMsaResponseBody model) {
        ...
        public GetLogUrlInMsaResponseBody build() {
            return new GetLogUrlInMsaResponseBody(this);
        } 
