...
/**
 * 
 * {@link UploadBitcodeToMsaResponseBody} extends {@link TeaModel}
 *
 * <p>UploadBitcodeToMsaResponseBody</p>
 */
public class UploadBitcodeToMsaResponseBody extends TeaModel {
    ...
    private UploadBitcodeToMsaResponseBody(Builder builder) {
    ...
    public static UploadBitcodeToMsaResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UploadBitcodeToMsaResponseBody model) {
        ...
        public UploadBitcodeToMsaResponseBody build() {
            return new UploadBitcodeToMsaResponseBody(this);
        } 
