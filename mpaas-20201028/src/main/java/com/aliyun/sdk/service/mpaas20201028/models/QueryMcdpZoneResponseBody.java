...
/**
 * 
 * {@link QueryMcdpZoneResponseBody} extends {@link TeaModel}
 *
 * <p>QueryMcdpZoneResponseBody</p>
 */
public class QueryMcdpZoneResponseBody extends TeaModel {
    ...
    private QueryMcdpZoneResponseBody(Builder builder) {
    ...
    public static QueryMcdpZoneResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryMcdpZoneResponseBody model) {
        ...
        public QueryMcdpZoneResponseBody build() {
            return new QueryMcdpZoneResponseBody(this);
        } 
