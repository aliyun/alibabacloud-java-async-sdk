...
/**
 * {@link DeleteMcdpEventByIdResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMcdpEventByIdResponseBody</p>
 */
public class DeleteMcdpEventByIdResponseBody extends TeaModel {
    ...
    private DeleteMcdpEventByIdResponseBody(Builder builder) {
    ...
    public static DeleteMcdpEventByIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteMcdpEventByIdResponseBody build() {
            return new DeleteMcdpEventByIdResponseBody(this);
        } 
