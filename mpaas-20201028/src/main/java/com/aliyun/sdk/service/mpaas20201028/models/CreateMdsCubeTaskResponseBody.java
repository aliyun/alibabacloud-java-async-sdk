...
/**
 * 
 * {@link CreateMdsCubeTaskResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMdsCubeTaskResponseBody</p>
 */
public class CreateMdsCubeTaskResponseBody extends TeaModel {
    ...
    private CreateMdsCubeTaskResponseBody(Builder builder) {
    ...
    public static CreateMdsCubeTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateMdsCubeTaskResponseBody model) {
        ...
        public CreateMdsCubeTaskResponseBody build() {
            return new CreateMdsCubeTaskResponseBody(this);
        } 
