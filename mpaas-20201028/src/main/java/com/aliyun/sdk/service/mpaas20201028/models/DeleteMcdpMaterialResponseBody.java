...
/**
 * {@link DeleteMcdpMaterialResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMcdpMaterialResponseBody</p>
 */
public class DeleteMcdpMaterialResponseBody extends TeaModel {
    ...
    private DeleteMcdpMaterialResponseBody(Builder builder) {
    ...
    public static DeleteMcdpMaterialResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteMcdpMaterialResponseBody build() {
            return new DeleteMcdpMaterialResponseBody(this);
        } 
