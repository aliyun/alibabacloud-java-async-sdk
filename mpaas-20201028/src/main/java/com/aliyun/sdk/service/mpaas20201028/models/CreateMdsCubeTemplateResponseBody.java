...
/**
 * 
 * {@link CreateMdsCubeTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMdsCubeTemplateResponseBody</p>
 */
public class CreateMdsCubeTemplateResponseBody extends TeaModel {
    ...
    private CreateMdsCubeTemplateResponseBody(Builder builder) {
    ...
    public static CreateMdsCubeTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateMdsCubeTemplateResponseBody model) {
        ...
        public CreateMdsCubeTemplateResponseBody build() {
            return new CreateMdsCubeTemplateResponseBody(this);
        } 
