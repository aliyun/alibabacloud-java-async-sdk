...
/**
 * 
 * {@link ChangeMdsCubeTaskStatusResponseBody} extends {@link TeaModel}
 *
 * <p>ChangeMdsCubeTaskStatusResponseBody</p>
 */
public class ChangeMdsCubeTaskStatusResponseBody extends TeaModel {
    ...
    private ChangeMdsCubeTaskStatusResponseBody(Builder builder) {
    ...
    public static ChangeMdsCubeTaskStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ChangeMdsCubeTaskStatusResponseBody model) {
        ...
        public ChangeMdsCubeTaskStatusResponseBody build() {
            return new ChangeMdsCubeTaskStatusResponseBody(this);
        } 
