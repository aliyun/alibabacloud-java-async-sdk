...
/**
 * {@link DeleteMcdpEventAttributeByIdResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMcdpEventAttributeByIdResponseBody</p>
 */
public class DeleteMcdpEventAttributeByIdResponseBody extends TeaModel {
    ...
    private DeleteMcdpEventAttributeByIdResponseBody(Builder builder) {
    ...
    public static DeleteMcdpEventAttributeByIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteMcdpEventAttributeByIdResponseBody build() {
            return new DeleteMcdpEventAttributeByIdResponseBody(this);
        } 
