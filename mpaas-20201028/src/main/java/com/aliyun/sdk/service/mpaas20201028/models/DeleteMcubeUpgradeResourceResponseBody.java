...
/**
 * 
 * {@link DeleteMcubeUpgradeResourceResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMcubeUpgradeResourceResponseBody</p>
 */
public class DeleteMcubeUpgradeResourceResponseBody extends TeaModel {
    ...
    private DeleteMcubeUpgradeResourceResponseBody(Builder builder) {
    ...
    public static DeleteMcubeUpgradeResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteMcubeUpgradeResourceResponseBody model) {
        ...
        public DeleteMcubeUpgradeResourceResponseBody build() {
            return new DeleteMcubeUpgradeResourceResponseBody(this);
        } 
