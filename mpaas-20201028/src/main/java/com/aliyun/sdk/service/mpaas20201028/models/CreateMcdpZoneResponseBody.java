...
/**
 * 
 * {@link CreateMcdpZoneResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMcdpZoneResponseBody</p>
 */
public class CreateMcdpZoneResponseBody extends TeaModel {
    ...
    private CreateMcdpZoneResponseBody(Builder builder) {
    ...
    public static CreateMcdpZoneResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateMcdpZoneResponseBody model) {
        ...
        public CreateMcdpZoneResponseBody build() {
            return new CreateMcdpZoneResponseBody(this);
        } 
