...
/**
 * {@link QueryMgsApipageRequest} extends {@link RequestModel}
 *
 * <p>QueryMgsApipageRequest</p>
 */
public class QueryMgsApipageRequest extends Request {
    ...
    private QueryMgsApipageRequest(Builder builder) {
        super(builder);
    ...
    public static QueryMgsApipageRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryMgsApipageRequest, Builder> {
        private String regionId; 
        private String apiStatus; 
        private String apiType; 
        private String appId; 
        ...
        private Builder(QueryMgsApipageRequest request) {
            super(request);
        ...
        @Override
        public QueryMgsApipageRequest build() {
            return new QueryMgsApipageRequest(this);
        } 
