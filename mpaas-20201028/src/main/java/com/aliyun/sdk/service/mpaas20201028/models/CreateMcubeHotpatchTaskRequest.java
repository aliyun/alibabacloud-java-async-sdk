...
/**
 * 
 * {@link CreateMcubeHotpatchTaskRequest} extends {@link RequestModel}
 *
 * <p>CreateMcubeHotpatchTaskRequest</p>
 */
public class CreateMcubeHotpatchTaskRequest extends Request {
    ...
    private CreateMcubeHotpatchTaskRequest(Builder builder) {
        super(builder);
    ...
    public static CreateMcubeHotpatchTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateMcubeHotpatchTaskRequest, Builder> {
        private String regionId; 
        private String appId; 
        private String greyConfigInfo; 
        private String greyEndtimeData; 
        ...
        private Builder(CreateMcubeHotpatchTaskRequest request) {
            super(request);
        ...
        @Override
        public CreateMcubeHotpatchTaskRequest build() {
            return new CreateMcubeHotpatchTaskRequest(this);
        } 
