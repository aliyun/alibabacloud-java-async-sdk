...
/**
 * {@link QueryMgsTestreqbodyautogenResponse} extends {@link TeaModel}
 *
 * <p>QueryMgsTestreqbodyautogenResponse</p>
 */
public class QueryMgsTestreqbodyautogenResponse extends Response {
    @NameInMap("headers")
    ...
    public static QueryMgsTestreqbodyautogenResponse create() {
    ...
    public interface Builder extends Response.Builder<QueryMgsTestreqbodyautogenResponse, Builder> {
        ...
        @Override
        QueryMgsTestreqbodyautogenResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(QueryMgsTestreqbodyautogenResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public QueryMgsTestreqbodyautogenResponse build() {
            return new QueryMgsTestreqbodyautogenResponse(this);
        } 
