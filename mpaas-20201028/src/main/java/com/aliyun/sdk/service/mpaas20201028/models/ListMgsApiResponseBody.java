...
/**
 * 
 * {@link ListMgsApiResponseBody} extends {@link TeaModel}
 *
 * <p>ListMgsApiResponseBody</p>
 */
public class ListMgsApiResponseBody extends TeaModel {
    ...
    private ListMgsApiResponseBody(Builder builder) {
    ...
    public static ListMgsApiResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListMgsApiResponseBody model) {
        ...
        public ListMgsApiResponseBody build() {
            return new ListMgsApiResponseBody(this);
        } 
