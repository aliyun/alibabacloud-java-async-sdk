...
/**
 * 
 * {@link PushBindResponseBody} extends {@link TeaModel}
 *
 * <p>PushBindResponseBody</p>
 */
public class PushBindResponseBody extends TeaModel {
    ...
    private PushBindResponseBody(Builder builder) {
    ...
    public static PushBindResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PushBindResponseBody model) {
        ...
        public PushBindResponseBody build() {
            return new PushBindResponseBody(this);
        } 
