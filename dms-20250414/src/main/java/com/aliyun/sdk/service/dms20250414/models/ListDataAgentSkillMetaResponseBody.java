...
/**
 * 
 * {@link ListDataAgentSkillMetaResponseBody} extends {@link TeaModel}
 *
 * <p>ListDataAgentSkillMetaResponseBody</p>
 */
public class ListDataAgentSkillMetaResponseBody extends TeaModel {
    ...
    private ListDataAgentSkillMetaResponseBody(Builder builder) {
    ...
    public static ListDataAgentSkillMetaResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListDataAgentSkillMetaResponseBody model) {
        ...
        public ListDataAgentSkillMetaResponseBody build() {
            return new ListDataAgentSkillMetaResponseBody(this);
        } 
