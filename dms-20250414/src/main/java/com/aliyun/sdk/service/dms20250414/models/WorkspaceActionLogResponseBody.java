...
/**
 * 
 * {@link WorkspaceActionLogResponseBody} extends {@link TeaModel}
 *
 * <p>WorkspaceActionLogResponseBody</p>
 */
public class WorkspaceActionLogResponseBody extends TeaModel {
    ...
    private WorkspaceActionLogResponseBody(Builder builder) {
    ...
    public static WorkspaceActionLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(WorkspaceActionLogResponseBody model) {
        ...
        public WorkspaceActionLogResponseBody build() {
            return new WorkspaceActionLogResponseBody(this);
        } 
