...
/**
 * 
 * {@link ModifyCustomAgentResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyCustomAgentResponseBody</p>
 */
public class ModifyCustomAgentResponseBody extends TeaModel {
    ...
    private ModifyCustomAgentResponseBody(Builder builder) {
    ...
    public static ModifyCustomAgentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyCustomAgentResponseBody model) {
        ...
        public ModifyCustomAgentResponseBody build() {
            return new ModifyCustomAgentResponseBody(this);
        } 
