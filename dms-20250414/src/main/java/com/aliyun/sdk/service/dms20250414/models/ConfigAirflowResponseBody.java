...
/**
 * 
 * {@link ConfigAirflowResponseBody} extends {@link TeaModel}
 *
 * <p>ConfigAirflowResponseBody</p>
 */
public class ConfigAirflowResponseBody extends TeaModel {
    ...
    private ConfigAirflowResponseBody(Builder builder) {
    ...
    public static ConfigAirflowResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ConfigAirflowResponseBody model) {
        ...
        public ConfigAirflowResponseBody build() {
            return new ConfigAirflowResponseBody(this);
        } 
