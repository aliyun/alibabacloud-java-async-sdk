...
/**
 * 
 * {@link CreateDataAgentWorkspaceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDataAgentWorkspaceResponseBody</p>
 */
public class CreateDataAgentWorkspaceResponseBody extends TeaModel {
    ...
    private CreateDataAgentWorkspaceResponseBody(Builder builder) {
    ...
    public static CreateDataAgentWorkspaceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDataAgentWorkspaceResponseBody model) {
        ...
        public CreateDataAgentWorkspaceResponseBody build() {
            return new CreateDataAgentWorkspaceResponseBody(this);
        } 
