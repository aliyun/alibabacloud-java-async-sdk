...
/**
 * 
 * {@link AgenticDatabase} extends {@link TeaModel}
 *
 * <p>AgenticDatabase</p>
 */
public class AgenticDatabase extends TeaModel {
    ...
    private AgenticDatabase(Builder builder) {
    ...
    public static AgenticDatabase create() {
    ...
    public static final class Builder {
        ...
        private Builder(AgenticDatabase model) {
        ...
        public AgenticDatabase build() {
            return new AgenticDatabase(this);
        } 
