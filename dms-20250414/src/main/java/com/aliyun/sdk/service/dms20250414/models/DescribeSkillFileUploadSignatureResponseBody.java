...
/**
 * 
 * {@link DescribeSkillFileUploadSignatureResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeSkillFileUploadSignatureResponseBody</p>
 */
public class DescribeSkillFileUploadSignatureResponseBody extends TeaModel {
    ...
    private DescribeSkillFileUploadSignatureResponseBody(Builder builder) {
    ...
    public static DescribeSkillFileUploadSignatureResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeSkillFileUploadSignatureResponseBody model) {
        ...
        public DescribeSkillFileUploadSignatureResponseBody build() {
            return new DescribeSkillFileUploadSignatureResponseBody(this);
        } 
