...
/**
 * 
 * {@link DLTableInput} extends {@link TeaModel}
 *
 * <p>DLTableInput</p>
 */
public class DLTableInput extends TeaModel {
    ...
    private DLTableInput(Builder builder) {
    ...
    public static DLTableInput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DLTableInput model) {
        ...
        public DLTableInput build() {
            return new DLTableInput(this);
        } 
