...
/**
 * 
 * {@link ListOneMetaOssieModelsRequest} extends {@link RequestModel}
 *
 * <p>ListOneMetaOssieModelsRequest</p>
 */
public class ListOneMetaOssieModelsRequest extends Request {
    ...
    private ListOneMetaOssieModelsRequest(Builder builder) {
        super(builder);
    ...
    public static ListOneMetaOssieModelsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListOneMetaOssieModelsRequest, Builder> {
        private String regionId; 
        private String catalogUuid; 
        private String databaseUuid; 
        private Boolean enableVectorSearch; 
        ...
        private Builder(ListOneMetaOssieModelsRequest request) {
            super(request);
        ...
        @Override
        public ListOneMetaOssieModelsRequest build() {
            return new ListOneMetaOssieModelsRequest(this);
        } 
