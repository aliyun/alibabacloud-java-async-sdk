...
/**
 * 
 * {@link ImportOneMetaOssieModelRequest} extends {@link RequestModel}
 *
 * <p>ImportOneMetaOssieModelRequest</p>
 */
public class ImportOneMetaOssieModelRequest extends Request {
    ...
    private ImportOneMetaOssieModelRequest(Builder builder) {
        super(builder);
    ...
    public static ImportOneMetaOssieModelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ImportOneMetaOssieModelRequest, Builder> {
        private String regionId; 
        private String catalogUuid; 
        private String databaseUuid; 
        private String description; 
        ...
        private Builder(ImportOneMetaOssieModelRequest request) {
            super(request);
        ...
        @Override
        public ImportOneMetaOssieModelRequest build() {
            return new ImportOneMetaOssieModelRequest(this);
        } 
