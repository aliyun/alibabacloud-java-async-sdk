...
/**
 * {@link DescribeConfigOfVersionResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeConfigOfVersionResponseBody</p>
 */
public class DescribeConfigOfVersionResponseBody extends TeaModel {
    ...
    private DescribeConfigOfVersionResponseBody(Builder builder) {
    ...
    public static DescribeConfigOfVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeConfigOfVersionResponseBody build() {
            return new DescribeConfigOfVersionResponseBody(this);
        } 
