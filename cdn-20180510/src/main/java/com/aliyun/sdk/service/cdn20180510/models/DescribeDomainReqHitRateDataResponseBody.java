...
public class DescribeDomainReqHitRateDataResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeDomainReqHitRateDataResponseBody model) {
            this.dataInterval = model.dataInterval;
            this.domainName = model.domainName;
            this.endTime = model.endTime;
            this.reqHitRateInterval = model.reqHitRateInterval;
    ...
    public static class ReqHitRateInterval extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(ReqHitRateInterval model) {
