 ...
 */
public class DescribeDomainRealTimeSrcHttpCodeDataRequest extends Request {
    @Query
    ...
    private DescribeDomainRealTimeSrcHttpCodeDataRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeDomainRealTimeSrcHttpCodeDataRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeDomainRealTimeSrcHttpCodeDataRequest, Builder> {
        ...
        @Override
        public DescribeDomainRealTimeSrcHttpCodeDataRequest build() {
            return new DescribeDomainRealTimeSrcHttpCodeDataRequest(this);
        } 
