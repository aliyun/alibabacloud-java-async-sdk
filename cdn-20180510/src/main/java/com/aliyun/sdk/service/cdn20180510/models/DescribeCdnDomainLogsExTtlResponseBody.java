...
public class DescribeCdnDomainLogsExTtlResponseBody extends TeaModel {
    ...
    public static DescribeCdnDomainLogsExTtlResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeCdnDomainLogsExTtlResponseBody model) {
        ...
        public DescribeCdnDomainLogsExTtlResponseBody build() {
            return new DescribeCdnDomainLogsExTtlResponseBody(this);
        } 
