...
/**
 * {@link DescribeConfigGroupDetailResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeConfigGroupDetailResponseBody</p>
 */
public class DescribeConfigGroupDetailResponseBody extends TeaModel {
    ...
    private DescribeConfigGroupDetailResponseBody(Builder builder) {
    ...
    public static DescribeConfigGroupDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeConfigGroupDetailResponseBody build() {
            return new DescribeConfigGroupDetailResponseBody(this);
        } 
