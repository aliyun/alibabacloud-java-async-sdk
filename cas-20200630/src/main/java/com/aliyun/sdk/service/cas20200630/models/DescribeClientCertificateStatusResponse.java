...
/**
 * {@link DescribeClientCertificateStatusResponse} extends {@link TeaModel}
 *
 * <p>DescribeClientCertificateStatusResponse</p>
 */
public class DescribeClientCertificateStatusResponse extends Response {
    @NameInMap("headers")
    ...
    public static DescribeClientCertificateStatusResponse create() {
    ...
    public interface Builder extends Response.Builder<DescribeClientCertificateStatusResponse, Builder> {
        ...
        @Override
        DescribeClientCertificateStatusResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DescribeClientCertificateStatusResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DescribeClientCertificateStatusResponse build() {
            return new DescribeClientCertificateStatusResponse(this);
        } 
