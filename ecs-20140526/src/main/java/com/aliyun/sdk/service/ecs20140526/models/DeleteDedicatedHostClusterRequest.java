...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteDedicatedHostClusterRequest, Builder> {
        ...
        /**
         * <p>The ID of the region where the dedicated host cluster resides. You can call <a href="https://help.aliyun.com/document_detail/25609.html">DescribeRegions</a> to query the most recent region list.</p>
         * <p>This parameter is required.</p>
         * 
         * <strong>example:</strong>
         * <p>cn-hangzhou</p>
