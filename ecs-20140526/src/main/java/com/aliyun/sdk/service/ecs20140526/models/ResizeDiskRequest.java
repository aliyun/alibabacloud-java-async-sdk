...
public class ResizeDiskRequest extends Request {
    ...
    @com.aliyun.core.annotation.Validation(required = true, maximum = 131072, minimum = 1)
...
@Override
    ...
    public static final class Builder extends Request.Builder<ResizeDiskRequest, Builder> {
        ...
        /**
         * <p>The method that you want to use to resize the disk. Specifies whether to check the image used by the instance supports hot migration. Valid values:</p>
         * <ul>
         * <li>offline (default): resizes the disk offline. After you resize a disk offline, you must <a href="https://help.aliyun.com/document_detail/25440.html">restart the associated instance</a> in the ECS console or by calling the <a href="https://help.aliyun.com/document_detail/25502.html">RebootInstance</a> operation for the resizing operation to take effect.</li>
