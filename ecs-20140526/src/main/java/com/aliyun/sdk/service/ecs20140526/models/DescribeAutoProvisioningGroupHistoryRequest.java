...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeAutoProvisioningGroupHistoryRequest, Builder> {
        ...
        /**
         * <p>The end time for querying the scheduling history. Specify the time in the <a href="https://help.aliyun.com/document_detail/25696.html">ISO 8601</a> standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.</p>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The page number of the current page in a paged query. Minimum value: 1.</p>
         * <p>Default value: 1.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
        ...
        /**
         * <p>The number of entries per page in a paged query. Maximum value: 100.</p>
        ...
        /**
         * <p>The start time for querying the scheduling history. Specify the time in the <a href="https://help.aliyun.com/document_detail/25696.html">ISO 8601</a> standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.</p>
         * 
         * <strong>example:</strong>
