 ...
 */
public class ListPluginStatusRequest extends Request {
    ...
    private ListPluginStatusRequest(Builder builder) {
        super(builder);
    ...
    public static ListPluginStatusRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListPluginStatusRequest, Builder> {
        ...
        private Builder(ListPluginStatusRequest request) {
            super(request);
        ...
        public ListPluginStatusRequest build() {
            return new ListPluginStatusRequest(this);
        } 
