...
public class ModifySnapshotCategoryResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        private Builder(ModifySnapshotCategoryResponseBody model) {
        ...
        /**
         * <p>The ID of the archiving task. You can call the DescribeTasks operation to query the status and progress of the task.</p>
         * 
         * <strong>example:</strong>
         * <p>t-dxh34xds**d</p>
         */
