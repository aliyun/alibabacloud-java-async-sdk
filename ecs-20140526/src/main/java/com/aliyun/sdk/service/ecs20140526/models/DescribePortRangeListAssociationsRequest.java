...
/**
 * 
 * {@link DescribePortRangeListAssociationsRequest} extends {@link RequestModel}
 *
 * <p>DescribePortRangeListAssociationsRequest</p>
 */
public class DescribePortRangeListAssociationsRequest extends Request {
    ...
    private DescribePortRangeListAssociationsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribePortRangeListAssociationsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribePortRangeListAssociationsRequest, Builder> {
        private String sourceRegionId; 
        private Integer maxResults; 
        private String nextToken; 
        private String ownerAccount; 
        ...
        private Builder(DescribePortRangeListAssociationsRequest request) {
            super(request);
        ...
        @Override
        public DescribePortRangeListAssociationsRequest build() {
            return new DescribePortRangeListAssociationsRequest(this);
        } 
