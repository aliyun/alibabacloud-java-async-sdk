...
public class DeleteSnapshotGroupResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        /**
         * A collection of Operation status information when you delete an instance snapshot.
         */
    ...
    public static class OperationProgress extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * The error message. If the deletion succeeds, a null value is returned.
             * <p>
             * 
            ...
            /**
             * The error code. If the deletion succeeds, a null value is returned.
             * <p>
             * 
             * <props = "intl"> for error codes and error messages, see [error Center](https://error-center.alibabacloud.com/status/product/Ecs). </props>
             * 
            ...
            /**
             * Indicates whether the operation is successful. Success is returned if the request succeeds. ErrorCode and ErrorMsg are returned if the request fails.
             */
