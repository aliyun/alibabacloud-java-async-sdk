...
/**
 * {@link DescribeDiagnosticMetricSetsResponse} extends {@link TeaModel}
 *
 * <p>DescribeDiagnosticMetricSetsResponse</p>
 */
public class DescribeDiagnosticMetricSetsResponse extends Response {
    @NameInMap("headers")
    ...
    public static DescribeDiagnosticMetricSetsResponse create() {
    ...
    public interface Builder extends Response.Builder<DescribeDiagnosticMetricSetsResponse, Builder> {
        ...
        @Override
        DescribeDiagnosticMetricSetsResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DescribeDiagnosticMetricSetsResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DescribeDiagnosticMetricSetsResponse build() {
            return new DescribeDiagnosticMetricSetsResponse(this);
        } 
