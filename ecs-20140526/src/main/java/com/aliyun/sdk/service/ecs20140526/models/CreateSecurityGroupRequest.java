...
public class CreateSecurityGroupRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<CreateSecurityGroupRequest, Builder> {
        ...
        /**
         * The type of the security group. Valid values: Basic Security Group and Enterprise Security Group. Valid values:
         * <p>
         * 
         * -normal: normal security group.
         * -enterprise: The enterprise Security Group. For more information, see [Enterprise Security Group Overview](~~ 120621 ~~).
         */
