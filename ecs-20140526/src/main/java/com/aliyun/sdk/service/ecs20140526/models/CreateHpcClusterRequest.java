...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateHpcClusterRequest, Builder> {
        ...
        /**
         * <p>The description of the HPC cluster. The description must be 2 to 256 characters in length and cannot start with <code>http://</code> or <code>https://</code>.</p>
        ...
        /**
         * <p>The name of the HPC cluster. The name must be 2 to 128 characters in length. It must start with a letter or a Chinese character and cannot start with <code>http://</code> or <code>https://</code>. It can contain digits, periods (.), underscores (_), or hyphens (-).</p>
