...
public class DescribeDeploymentSetSupportedInstanceTypeFamilyRequest extends Request {
    ...
    public static DescribeDeploymentSetSupportedInstanceTypeFamilyRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeDeploymentSetSupportedInstanceTypeFamilyRequest, Builder> {
        ...
        @Override
        public DescribeDeploymentSetSupportedInstanceTypeFamilyRequest build() {
            return new DescribeDeploymentSetSupportedInstanceTypeFamilyRequest(this);
        } 
