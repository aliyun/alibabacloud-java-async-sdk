...
/**
 * 
 * {@link DeleteSnapshotGroupResponse} extends {@link TeaModel}
 *
 * <p>DeleteSnapshotGroupResponse</p>
 */
public class DeleteSnapshotGroupResponse extends Response {
    ...
    public static DeleteSnapshotGroupResponse create() {
    ...
    public interface Builder extends Response.Builder<DeleteSnapshotGroupResponse, Builder> {
        ...
        @Override
        DeleteSnapshotGroupResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DeleteSnapshotGroupResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DeleteSnapshotGroupResponse build() {
            return new DeleteSnapshotGroupResponse(this);
        } 
