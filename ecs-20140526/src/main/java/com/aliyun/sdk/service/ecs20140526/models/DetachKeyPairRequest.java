...
public class DetachKeyPairRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DetachKeyPairRequest, Builder> {
        ...
        /**
         * The ID of the instance to which the SSH key pair is unbound. The value can be a JSON array consisting of multiple instance ids. A maximum of 50 ids can be specified. Separate ids with commas (,).
         */
