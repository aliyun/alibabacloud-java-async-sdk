...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyDedicatedHostAutoReleaseTimeRequest, Builder> {
         ...
         * <ul>
         * <li>The release time must be at least 30 minutes from the current time.</li>
         * <li>The release time must be at most 3 years from the current time.</li>
         * <li>If the value of seconds (ss) is not 00, it is automatically set to 00.</li>
         * <li>If you do not specify the AutoReleaseTime parameter, automatic release is canceled and the dedicated host is no longer automatically released at the scheduled time.</li>
         * </ul>
         * 
        ...
        /**
         * <p>The ID of the dedicated host for which to set automatic release.</p>
