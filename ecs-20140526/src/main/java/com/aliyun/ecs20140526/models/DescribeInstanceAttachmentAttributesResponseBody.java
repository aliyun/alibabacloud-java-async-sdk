...
public class DescribeInstanceAttachmentAttributesResponseBody extends TeaModel {
    ...
    public static class Instance extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * The ID of the private pool. When "privatepooloptionsmatchcriteria" return value "open" when private pool ID for the system automatically match the assigned private pool ID.
             */
