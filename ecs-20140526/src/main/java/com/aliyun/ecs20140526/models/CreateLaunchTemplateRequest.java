...
public class CreateLaunchTemplateRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<CreateLaunchTemplateRequest, Builder> {
        ...
        private Builder(CreateLaunchTemplateRequest response) {
            super(response);
        ...
        /**
         * Join instances of one or more security groups. N. The range of and instance can add security group quota-related, more information, please see [use restrictions](~~ 25412 ~~).
         * <p>
         * 
         * > you cannot specify both "SecurityGroupId" and "SecurityGroupIds ".
         */
        ...
        /**
         * The retention period of a preemptible instance. Unit: hours. Value range is 0~6.
         * <p>
         * 
         ...
         * <p>
         * 
         * -When purchased public outlet bandwidth less than equal to 10mbit/s: 1~10, the default is 10.
