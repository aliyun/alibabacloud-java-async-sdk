...
public class DescribeSnapshotGroupsResponseBody extends TeaModel {
    ...
    public static class Snapshot extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * SOURCE Cloud ID. This field is retained if the source disk of the snapshot is released.
             */
    ...
    public static class SnapshotGroup extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * Snapshot of the consistency group state. Possible values:
             * <p>
             * 
             * -progressing: create.
             * 
            ...
            /**
             * Snapshot consistency group belongs instance ID. This parameter only when the snapshot consistency all the cloud snapshot belongs to the same instance when return value. If your snapshot consistency within the group more cloud snapshot belong to different ECS instance, you can pass return results in "snapshots. Snapshot.Tags.* "Parameter, see group a single snapshot belongs instance ID.
             */
            ...
            /**
             * Snapshot in the consistency group contains Snapshot Information array.
             */
