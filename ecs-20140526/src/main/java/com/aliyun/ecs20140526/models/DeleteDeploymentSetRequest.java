...
public class DeleteDeploymentSetRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DeleteDeploymentSetRequest, Builder> {
        ...
        private Builder(DeleteDeploymentSetRequest response) {
            super(response);
        ...
        /**
         * The ID of the deployment set. If an instance still exists in the deployment set, it cannot be deleted.
         */
