...
public class DescribeCloudAssistantStatusRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DescribeCloudAssistantStatusRequest, Builder> {
        ...
        private Builder(DescribeCloudAssistantStatusRequest response) {
            super(response);
        ...
        /**
         * The list of instance ids. A maximum of 100 instances can be requested at a time. Valid values of N: 1 to 100.
         */
