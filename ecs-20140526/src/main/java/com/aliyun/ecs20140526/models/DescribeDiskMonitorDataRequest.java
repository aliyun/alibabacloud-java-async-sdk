...
public class DescribeDiskMonitorDataRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DescribeDiskMonitorDataRequest, Builder> {
        ...
        private Builder(DescribeDiskMonitorDataRequest response) {
            super(response);
        ...
        /**
         * Data"s start time. The time follows the [ISO8601](~~ 25696 ~~) standard and uses UTC +0. The format is yyyy-MM-ddTHH:mm:ssZ. If the seconds (ss) is not 00, it is automatically set to the start of the next minute.
         */
