...
public class DeleteLaunchTemplateVersionRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DeleteLaunchTemplateVersionRequest, Builder> {
        ...
        private Builder(DeleteLaunchTemplateVersionRequest response) {
            super(response);
            this.sourceRegionId = response.sourceRegionId;
            this.resourceOwnerId = response.resourceOwnerId;
            this.deleteVersion = response.deleteVersion;
        ...
        /**
         * Need to remove the start template ID. For more information, see [DescribeLaunchTemplates](~~ 73759 ~~).
         */
