...
public class DescribeInvocationResultsResponseBody extends TeaModel {
    ...
    public static class InvocationResult extends TeaModel {
        ...
        public static final class Builder {
             ...
             * -Cycle Command: The last execution successful and exit code non -0, and the specified cycle will be aborted.
             ...
             * -Terminated: command execution when Terminated.
             * -Scheduled:
             * -Single command: not applicable, not appear.
             * -Cycle command: wait for execution.
             */
