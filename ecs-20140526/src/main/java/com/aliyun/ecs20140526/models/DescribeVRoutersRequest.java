...
/**
 * {@link DescribeVRoutersRequest} extends {@link RequestModel}
 *
 * <p>DescribeVRoutersRequest</p>
 */
public class DescribeVRoutersRequest extends Request {
    @Query
    ...
    public static DescribeVRoutersRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeVRoutersRequest, Builder> {
        ...
        @Override
        public DescribeVRoutersRequest build() {
            return new DescribeVRoutersRequest(this);
        } 
