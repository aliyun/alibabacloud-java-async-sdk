...
/**
 * {@link DeleteNetworkInterfaceRequest} extends {@link RequestModel}
 *
...
public class DeleteNetworkInterfaceRequest extends Request {
    ...
    public static DeleteNetworkInterfaceRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteNetworkInterfaceRequest, Builder> {
        ...
        private Builder(DeleteNetworkInterfaceRequest response) {
            super(response);
        ...
        @Override
        public DeleteNetworkInterfaceRequest build() {
