...
/**
 * {@link DescribePrefixListAttributesRequest} extends {@link RequestModel}
 *
...
public class DescribePrefixListAttributesRequest extends Request {
    ...
    public static DescribePrefixListAttributesRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribePrefixListAttributesRequest, Builder> {
        ...
        private Builder(DescribePrefixListAttributesRequest response) {
            super(response);
        ...
        @Override
        public DescribePrefixListAttributesRequest build() {
            return new DescribePrefixListAttributesRequest(this);
        } 
