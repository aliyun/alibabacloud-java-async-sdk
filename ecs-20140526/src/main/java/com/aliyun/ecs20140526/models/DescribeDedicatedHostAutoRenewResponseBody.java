...
public class DescribeDedicatedHostAutoRenewResponseBody extends TeaModel {
    ...
    public static class DedicatedHostRenewAttribute extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * If the expiration time of the subscription ECS instance is later than that of the dedicated host, indicates whether the dedicated host is automatically renewed with the ECS instance. Possible values:
             * <p>
             * 
