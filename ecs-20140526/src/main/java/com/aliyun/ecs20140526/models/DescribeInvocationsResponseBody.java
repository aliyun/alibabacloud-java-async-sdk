...
public class DescribeInvocationsResponseBody extends TeaModel {
    ...
    public static class InvokeInstance extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * A single instance"s command progress status, possible values:
             * <p>
             * -Pending: The system is verifying or sending commands.
             * -Invalid: specify the command type or parameter is incorrect.
             * -Aborted: To instances send command failed. Instance must be running, and the command can 1 fen zhong sent in complete.
             * -Running: The command is Running on the instance.
             * -Success:
             * -Single command: Command completes, and exit code is 0.
             * -Cycle command: Last run successful and exit code is 0, and the specified cycle has ended.
             * -Failed:
             * -Single command: Command completes, and exit code non -0.
             * -Cycle command: Last run successful and exit code non -0, and the specified cycle will be aborted.
             * -Error: command execution exception occurred while cannot continue.
             * -Timeout: command execution timed out.
             * -Cancelled: command execution action has been canceled, command have not launched.
             * -Stopping: The task is being stopped.
             * -Terminated: Command runtime Terminated.
             * -Scheduled:
             * -Single command: not applicable, not appear.
             * -Cycle command: waiting to run.
             */
            ...
            /**
             * The command process exit code. Possible values:
             * <p>
             * 
             * -Linux instance for Shell process exit code.
             * -Windows instance for Bat or PowerShell process exit code.
             */
             ...
             * -the instance is not running when create task: start execution command, the instance is not running.
             * -the command is not applicable: the command does not apply to the specified instance.
             * -the specified account does not exists: the specified account does not exist.
             * -the specified directory does not exists: the specified directory does not exist.
             * -the cron job expression is invalid: the specified cycle expression is not legal.
             ...
             * -the command execution has been interrupted: command execution task interrupted.
             ...
             * -InstanceReleased: during command execution, the instance is release.
             * -InstanceNotRunning: start execution command, the instance is not running.
             * -CommandNotApplicable: command does not apply to the specified instance.
             ...
             * -ExecutionException: command execution exception occurred.
             * -ExecutionInterrupted: command execution task interrupted.
             * -ExitCodeNonzero: command execution end, exit code non -0.
             * 
             */
    ...
    public static class Invocation extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * Command execution. Possible values:
             * <p>
             * 
            ...
            /**
             * Command overall implementation status.
             * <p>
             * > We do not recommend that you view the return value. We recommend that you view the return value of "InvocationStatus.
             */
            ...
            /**
             * In the command custom parameter.
             */
            ...
            /**
             * ECS instance execute a command in a user name.
             */
