...
public class ModifyInstanceAutoReleaseTimeRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<ModifyInstanceAutoReleaseTimeRequest, Builder> {
        ...
        private Builder(ModifyInstanceAutoReleaseTimeRequest response) {
            super(response);
        ...
        /**
         * Need to automatically release ECS instance ID.
         */
         ...
         * 
         * If not incoming parameter "autoreleasetime", indicates automatic release function has been canceled, ECS instance is no longer automatically released.
         */
