...
/**
 * {@link DeregisterManagedInstanceRequest} extends {@link RequestModel}
 *
 * <p>DeregisterManagedInstanceRequest</p>
 */
public class DeregisterManagedInstanceRequest extends Request {
    @Host
    ...
    public static DeregisterManagedInstanceRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeregisterManagedInstanceRequest, Builder> {
        ...
        private Builder(DeregisterManagedInstanceRequest response) {
            super(response);
        ...
        @Override
        public DeregisterManagedInstanceRequest build() {
            return new DeregisterManagedInstanceRequest(this);
        } 
