...
public class ModifyElasticityAssuranceRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<ModifyElasticityAssuranceRequest, Builder> {
        ...
        private Builder(ModifyElasticityAssuranceRequest response) {
            super(response);
    ...
    public static class PrivatePoolOptions extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * The name of the elastic protection service. The description must be 2 to 128 characters in length. Must be in capital lowercase letters or Chinese beginning, can"t to http:// and https:// beginning. It can contain numbers, colons (:), underscores (_), and hyphens (-).
             */
