...
public class ModifySnapshotGroupRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<ModifySnapshotGroupRequest, Builder> {
        ...
        private Builder(ModifySnapshotGroupRequest response) {
            super(response);
        ...
        /**
         * The name of the modified snapshot. The description must be 2 to 128 characters in length. It must start with a letter and cannot start with "http:// "or "https://". It can contain numbers and periods (.)., underscores (_), hyphens (-), or colons (:).
         */
