...
public class DescribeInstanceTopologyResponseBody extends TeaModel {
    ...
    public static class Topology extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * ECS instance resides physical machine identity. Encrypted, can"t direct and Alibaba Cloud resources identity match on. But different ECS instance as long as pass the parameter query to the value of is consistent, means ECS instance is in the same physical machine.
             */
