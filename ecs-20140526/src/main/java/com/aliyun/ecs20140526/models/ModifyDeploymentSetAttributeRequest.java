...
public class ModifyDeploymentSetAttributeRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<ModifyDeploymentSetAttributeRequest, Builder> {
        ...
        private Builder(ModifyDeploymentSetAttributeRequest response) {
            super(response);
        ...
        /**
         * New deployment set description information. The description must be 2 to 256 characters in length and cannot start with http:// or https.
         */
        ...
        /**
         * New deployment set name. The description must be 2 to 128 characters in length. It must start with a letter and cannot start with http:// or https. It can contain numbers, colons (:), underscores (_), and hyphens (-).
         */
