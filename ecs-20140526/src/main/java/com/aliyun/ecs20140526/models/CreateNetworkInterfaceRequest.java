...
public class CreateNetworkInterfaceRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<CreateNetworkInterfaceRequest, Builder> {
        ...
        private Builder(CreateNetworkInterfaceRequest response) {
            super(response);
            ...
            this.queuePairNumber = response.queuePairNumber;
            ...
            this.networkInterfaceTrafficMode = response.networkInterfaceTrafficMode;
