...
/**
 * 
 * {@link CloudListEnterpriseTimeResponseBody} extends {@link TeaModel}
 *
 * <p>CloudListEnterpriseTimeResponseBody</p>
 */
public class CloudListEnterpriseTimeResponseBody extends TeaModel {
    ...
    private CloudListEnterpriseTimeResponseBody(Builder builder) {
    ...
    public static CloudListEnterpriseTimeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloudListEnterpriseTimeResponseBody model) {
        ...
        public CloudListEnterpriseTimeResponseBody build() {
            return new CloudListEnterpriseTimeResponseBody(this);
        } 
