...
/**
 * 
 * {@link ClinkDescribeCdrObRequest} extends {@link RequestModel}
 *
 * <p>ClinkDescribeCdrObRequest</p>
 */
public class ClinkDescribeCdrObRequest extends Request {
    ...
    private ClinkDescribeCdrObRequest(Builder builder) {
        super(builder);
    ...
    public static ClinkDescribeCdrObRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ClinkDescribeCdrObRequest, Builder> {
        private Long enterpriseId; 
        private Long hiddenType; 
        private String mainUniqueId; 
        private Long ownerId; 
        ...
        private Builder(ClinkDescribeCdrObRequest request) {
            super(request);
        ...
        @Override
        public ClinkDescribeCdrObRequest build() {
            return new ClinkDescribeCdrObRequest(this);
        } 
