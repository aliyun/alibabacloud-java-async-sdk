...
/**
 * 
 * {@link ClinkCreateClientResponseBody} extends {@link TeaModel}
 *
 * <p>ClinkCreateClientResponseBody</p>
 */
public class ClinkCreateClientResponseBody extends TeaModel {
    ...
    private ClinkCreateClientResponseBody(Builder builder) {
    ...
    public static ClinkCreateClientResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ClinkCreateClientResponseBody model) {
        ...
        public ClinkCreateClientResponseBody build() {
            return new ClinkCreateClientResponseBody(this);
        } 
