...
/**
 * 
 * {@link ClinkDescribeCdrIbRequest} extends {@link RequestModel}
 *
 * <p>ClinkDescribeCdrIbRequest</p>
 */
public class ClinkDescribeCdrIbRequest extends Request {
    ...
    private ClinkDescribeCdrIbRequest(Builder builder) {
        super(builder);
    ...
    public static ClinkDescribeCdrIbRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ClinkDescribeCdrIbRequest, Builder> {
        private Long enterpriseId; 
        private Long hiddenType; 
        private String mainUniqueId; 
        private Long ownerId; 
        ...
        private Builder(ClinkDescribeCdrIbRequest request) {
            super(request);
        ...
        @Override
        public ClinkDescribeCdrIbRequest build() {
            return new ClinkDescribeCdrIbRequest(this);
        } 
