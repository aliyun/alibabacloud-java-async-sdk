...
public class DeleteRobotTaskResponseBody extends TeaModel {
    ...
    public static DeleteRobotTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteRobotTaskResponseBody model) {
        ...
        public DeleteRobotTaskResponseBody build() {
            return new DeleteRobotTaskResponseBody(this);
        } 
