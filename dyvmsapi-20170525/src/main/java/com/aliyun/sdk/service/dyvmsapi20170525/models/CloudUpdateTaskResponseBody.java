...
/**
 * 
 * {@link CloudUpdateTaskResponseBody} extends {@link TeaModel}
 *
 * <p>CloudUpdateTaskResponseBody</p>
 */
public class CloudUpdateTaskResponseBody extends TeaModel {
    ...
    private CloudUpdateTaskResponseBody(Builder builder) {
    ...
    public static CloudUpdateTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloudUpdateTaskResponseBody model) {
        ...
        public CloudUpdateTaskResponseBody build() {
            return new CloudUpdateTaskResponseBody(this);
        } 
