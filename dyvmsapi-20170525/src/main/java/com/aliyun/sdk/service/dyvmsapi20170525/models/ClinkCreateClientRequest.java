...
/**
 * 
 * {@link ClinkCreateClientRequest} extends {@link RequestModel}
 *
 * <p>ClinkCreateClientRequest</p>
 */
public class ClinkCreateClientRequest extends Request {
    ...
    private ClinkCreateClientRequest(Builder builder) {
        super(builder);
    ...
    public static ClinkCreateClientRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ClinkCreateClientRequest, Builder> {
        private Long active; 
        private String areaCode; 
        private Long assignType; 
        private java.util.List<String> clid; 
        ...
        private Builder(ClinkCreateClientRequest request) {
            super(request);
        ...
        @Override
        public ClinkCreateClientRequest build() {
            return new ClinkCreateClientRequest(this);
        } 
    ...
    /**
     * 
     * {@link ClinkCreateClientRequest} extends {@link TeaModel}
     *
     * <p>ClinkCreateClientRequest</p>
     */
