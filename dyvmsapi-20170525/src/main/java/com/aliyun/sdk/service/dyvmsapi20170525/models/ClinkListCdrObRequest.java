...
/**
 * 
 * {@link ClinkListCdrObRequest} extends {@link RequestModel}
 *
 * <p>ClinkListCdrObRequest</p>
 */
public class ClinkListCdrObRequest extends Request {
    ...
    private ClinkListCdrObRequest(Builder builder) {
        super(builder);
    ...
    public static ClinkListCdrObRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ClinkListCdrObRequest, Builder> {
        private Long bridgeDuration; 
        private Long bridgeDurationEnd; 
        private Long bridgeTime; 
        private Long bridgeTimeEnd; 
        ...
        private Builder(ClinkListCdrObRequest request) {
            super(request);
            ...
            this.leftClid = request.leftClid;
        ...
        public Builder leftClid(String leftClid) {
            this.putQueryParameter("LeftClid", leftClid);
        ...
        public Builder xnumber(String xnumber) {
            this.putQueryParameter("Xnumber", xnumber);
            this.xnumber = xnumber;
            return this;
        }

        @Override
        public ClinkListCdrObRequest build() {
            return new ClinkListCdrObRequest(this);
        } 
