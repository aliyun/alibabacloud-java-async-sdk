...
/**
 * 
 * {@link CloudBatchGetAgentStatusResponseBody} extends {@link TeaModel}
 *
 * <p>CloudBatchGetAgentStatusResponseBody</p>
 */
public class CloudBatchGetAgentStatusResponseBody extends TeaModel {
    ...
    private CloudBatchGetAgentStatusResponseBody(Builder builder) {
    ...
    public static CloudBatchGetAgentStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloudBatchGetAgentStatusResponseBody model) {
        ...
        public CloudBatchGetAgentStatusResponseBody build() {
            return new CloudBatchGetAgentStatusResponseBody(this);
        } 
