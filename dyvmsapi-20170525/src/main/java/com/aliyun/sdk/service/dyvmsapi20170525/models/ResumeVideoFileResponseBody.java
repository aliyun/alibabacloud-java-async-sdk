...
public class ResumeVideoFileResponseBody extends TeaModel {
    ...
    public static ResumeVideoFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResumeVideoFileResponseBody model) {
        ...
        public ResumeVideoFileResponseBody build() {
            return new ResumeVideoFileResponseBody(this);
        } 
