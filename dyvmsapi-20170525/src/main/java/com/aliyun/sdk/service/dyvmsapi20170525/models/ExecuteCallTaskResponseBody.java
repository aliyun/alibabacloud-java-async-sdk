...
public class ExecuteCallTaskResponseBody extends TeaModel {
    ...
    public static ExecuteCallTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExecuteCallTaskResponseBody model) {
        ...
        public ExecuteCallTaskResponseBody build() {
            return new ExecuteCallTaskResponseBody(this);
        } 
