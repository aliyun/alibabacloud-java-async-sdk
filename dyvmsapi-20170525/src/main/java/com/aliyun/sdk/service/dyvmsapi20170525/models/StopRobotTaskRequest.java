...
public class StopRobotTaskRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<StopRobotTaskRequest, Builder> {
        private Long ownerId; 
        private String resourceOwnerAccount; 
        private Long resourceOwnerId; 
        private Long taskId; 
        ...
        private Builder(StopRobotTaskRequest response) {
            super(response);
