...
/**
 * 
 * {@link CloudCreateExtenResponseBody} extends {@link TeaModel}
 *
 * <p>CloudCreateExtenResponseBody</p>
 */
public class CloudCreateExtenResponseBody extends TeaModel {
    ...
    private CloudCreateExtenResponseBody(Builder builder) {
    ...
    public static CloudCreateExtenResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloudCreateExtenResponseBody model) {
        ...
        public CloudCreateExtenResponseBody build() {
            return new CloudCreateExtenResponseBody(this);
        } 
