...
/**
 * 
 * {@link CloudCreateQueueResponseBody} extends {@link TeaModel}
 *
 * <p>CloudCreateQueueResponseBody</p>
 */
public class CloudCreateQueueResponseBody extends TeaModel {
    ...
    private CloudCreateQueueResponseBody(Builder builder) {
    ...
    public static CloudCreateQueueResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloudCreateQueueResponseBody model) {
        ...
        public CloudCreateQueueResponseBody build() {
            return new CloudCreateQueueResponseBody(this);
        } 
