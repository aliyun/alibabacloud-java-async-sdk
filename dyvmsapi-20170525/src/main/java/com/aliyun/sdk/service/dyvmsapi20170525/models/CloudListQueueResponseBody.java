...
/**
 * 
 * {@link CloudListQueueResponseBody} extends {@link TeaModel}
 *
 * <p>CloudListQueueResponseBody</p>
 */
public class CloudListQueueResponseBody extends TeaModel {
    ...
    private CloudListQueueResponseBody(Builder builder) {
    ...
    public static CloudListQueueResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloudListQueueResponseBody model) {
        ...
        public CloudListQueueResponseBody build() {
            return new CloudListQueueResponseBody(this);
        } 
