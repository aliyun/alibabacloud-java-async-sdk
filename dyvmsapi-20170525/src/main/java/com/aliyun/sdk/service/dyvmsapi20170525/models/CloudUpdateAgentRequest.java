...
/**
 * 
 * {@link CloudUpdateAgentRequest} extends {@link RequestModel}
 *
 * <p>CloudUpdateAgentRequest</p>
 */
public class CloudUpdateAgentRequest extends Request {
    ...
    private CloudUpdateAgentRequest(Builder builder) {
        super(builder);
    ...
    public static CloudUpdateAgentRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CloudUpdateAgentRequest, Builder> {
        private Long active; 
        private Long agentType; 
        private String areaCode; 
        private Long callPower; 
        ...
        private Builder(CloudUpdateAgentRequest request) {
            super(request);
        ...
        @Override
        public CloudUpdateAgentRequest build() {
            return new CloudUpdateAgentRequest(this);
        } 
