...
/**
 * 
 * {@link ClinkDescribeCdrObDetailsResponseBody} extends {@link TeaModel}
 *
 * <p>ClinkDescribeCdrObDetailsResponseBody</p>
 */
public class ClinkDescribeCdrObDetailsResponseBody extends TeaModel {
    ...
    private ClinkDescribeCdrObDetailsResponseBody(Builder builder) {
    ...
    public static ClinkDescribeCdrObDetailsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ClinkDescribeCdrObDetailsResponseBody model) {
        ...
        public ClinkDescribeCdrObDetailsResponseBody build() {
            return new ClinkDescribeCdrObDetailsResponseBody(this);
        } 
