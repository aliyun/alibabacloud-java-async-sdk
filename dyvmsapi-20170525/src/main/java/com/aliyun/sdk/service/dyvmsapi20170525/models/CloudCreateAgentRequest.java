...
/**
 * 
 * {@link CloudCreateAgentRequest} extends {@link RequestModel}
 *
 * <p>CloudCreateAgentRequest</p>
 */
public class CloudCreateAgentRequest extends Request {
    ...
    private CloudCreateAgentRequest(Builder builder) {
        super(builder);
    ...
    public static CloudCreateAgentRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CloudCreateAgentRequest, Builder> {
        private Long active; 
        private String areaCode; 
        private Long callPower; 
        private String cno; 
        ...
        private Builder(CloudCreateAgentRequest request) {
            super(request);
        ...
        @Override
        public CloudCreateAgentRequest build() {
            return new CloudCreateAgentRequest(this);
        } 
