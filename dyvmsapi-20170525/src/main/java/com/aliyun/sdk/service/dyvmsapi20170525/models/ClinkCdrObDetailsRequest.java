...
/**
 * 
 * {@link ClinkCdrObDetailsRequest} extends {@link RequestModel}
 *
 * <p>ClinkCdrObDetailsRequest</p>
 */
public class ClinkCdrObDetailsRequest extends Request {
    ...
    private ClinkCdrObDetailsRequest(Builder builder) {
        super(builder);
    ...
    public static ClinkCdrObDetailsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ClinkCdrObDetailsRequest, Builder> {
        private Long enterpriseId; 
        private Long hiddenType; 
        private String mainUniqueId; 
        private Long ownerId; 
        ...
        private Builder(ClinkCdrObDetailsRequest request) {
            super(request);
        ...
        @Override
        public ClinkCdrObDetailsRequest build() {
            return new ClinkCdrObDetailsRequest(this);
        } 
