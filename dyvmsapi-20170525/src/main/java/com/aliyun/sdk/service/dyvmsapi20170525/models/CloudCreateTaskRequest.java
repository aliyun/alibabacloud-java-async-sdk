...
/**
 * 
 * {@link CloudCreateTaskRequest} extends {@link RequestModel}
 *
 * <p>CloudCreateTaskRequest</p>
 */
public class CloudCreateTaskRequest extends Request {
    ...
    private CloudCreateTaskRequest(Builder builder) {
        super(builder);
    ...
    public static CloudCreateTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CloudCreateTaskRequest, Builder> {
        private String agentGroup; 
        private Long agentTimeout; 
        private Long answerRate; 
        private Long autoComplete; 
        ...
        private Builder(CloudCreateTaskRequest request) {
            super(request);
            ...
            this.callGroupType = request.callGroupType;
         ...
         * <p>0</p>
         */
        public Builder autoDelete(Long autoDelete) {
        ...
        public Builder callGroupType(Long callGroupType) {
            this.putQueryParameter("CallGroupType", callGroupType);
        ...
        @Override
        public CloudCreateTaskRequest build() {
            return new CloudCreateTaskRequest(this);
        } 
