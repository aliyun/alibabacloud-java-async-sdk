...
/**
 * 
 * {@link CloudListQueueSkillResponseBody} extends {@link TeaModel}
 *
 * <p>CloudListQueueSkillResponseBody</p>
 */
public class CloudListQueueSkillResponseBody extends TeaModel {
    ...
    private CloudListQueueSkillResponseBody(Builder builder) {
    ...
    public static CloudListQueueSkillResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloudListQueueSkillResponseBody model) {
        ...
        public CloudListQueueSkillResponseBody build() {
            return new CloudListQueueSkillResponseBody(this);
        } 
