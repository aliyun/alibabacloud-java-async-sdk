...
/**
 * 
 * {@link QueryEnumConfigByTypeResponseBody} extends {@link TeaModel}
 *
 * <p>QueryEnumConfigByTypeResponseBody</p>
 */
public class QueryEnumConfigByTypeResponseBody extends TeaModel {
    ...
    private QueryEnumConfigByTypeResponseBody(Builder builder) {
    ...
    public static QueryEnumConfigByTypeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryEnumConfigByTypeResponseBody model) {
        ...
        public QueryEnumConfigByTypeResponseBody build() {
            return new QueryEnumConfigByTypeResponseBody(this);
        } 
