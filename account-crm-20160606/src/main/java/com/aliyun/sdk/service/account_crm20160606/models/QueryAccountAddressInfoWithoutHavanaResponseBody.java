...
/**
 * 
 * {@link QueryAccountAddressInfoWithoutHavanaResponseBody} extends {@link TeaModel}
 *
 * <p>QueryAccountAddressInfoWithoutHavanaResponseBody</p>
 */
public class QueryAccountAddressInfoWithoutHavanaResponseBody extends TeaModel {
    ...
    private QueryAccountAddressInfoWithoutHavanaResponseBody(Builder builder) {
    ...
    public static QueryAccountAddressInfoWithoutHavanaResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryAccountAddressInfoWithoutHavanaResponseBody model) {
        ...
        public QueryAccountAddressInfoWithoutHavanaResponseBody build() {
            return new QueryAccountAddressInfoWithoutHavanaResponseBody(this);
        } 
