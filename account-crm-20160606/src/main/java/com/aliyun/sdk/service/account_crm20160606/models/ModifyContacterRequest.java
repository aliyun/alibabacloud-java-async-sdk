...
/**
 * 
 * {@link ModifyContacterRequest} extends {@link RequestModel}
 *
 * <p>ModifyContacterRequest</p>
 */
public class ModifyContacterRequest extends Request {
    ...
    private ModifyContacterRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyContacterRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyContacterRequest, Builder> {
        private String contacterAddress; 
        private String contacterDingding; 
        private String contacterEmail; 
        private Long contacterId; 
        ...
        private Builder(ModifyContacterRequest request) {
            super(request);
        ...
        @Override
        public ModifyContacterRequest build() {
            return new ModifyContacterRequest(this);
        } 
