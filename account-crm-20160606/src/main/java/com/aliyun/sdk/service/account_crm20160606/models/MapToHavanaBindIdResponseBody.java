...
/**
 * 
 * {@link MapToHavanaBindIdResponseBody} extends {@link TeaModel}
 *
 * <p>MapToHavanaBindIdResponseBody</p>
 */
public class MapToHavanaBindIdResponseBody extends TeaModel {
    ...
    private MapToHavanaBindIdResponseBody(Builder builder) {
    ...
    public static MapToHavanaBindIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(MapToHavanaBindIdResponseBody model) {
        ...
        public MapToHavanaBindIdResponseBody build() {
            return new MapToHavanaBindIdResponseBody(this);
        } 
