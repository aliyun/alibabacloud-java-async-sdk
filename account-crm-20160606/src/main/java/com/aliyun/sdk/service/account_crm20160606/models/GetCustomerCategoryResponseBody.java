...
/**
 * 
 * {@link GetCustomerCategoryResponseBody} extends {@link TeaModel}
 *
 * <p>GetCustomerCategoryResponseBody</p>
 */
public class GetCustomerCategoryResponseBody extends TeaModel {
    ...
    private GetCustomerCategoryResponseBody(Builder builder) {
    ...
    public static GetCustomerCategoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetCustomerCategoryResponseBody model) {
        ...
        public GetCustomerCategoryResponseBody build() {
            return new GetCustomerCategoryResponseBody(this);
        } 
