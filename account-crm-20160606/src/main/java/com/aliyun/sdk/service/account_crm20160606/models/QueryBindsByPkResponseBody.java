...
/**
 * 
 * {@link QueryBindsByPkResponseBody} extends {@link TeaModel}
 *
 * <p>QueryBindsByPkResponseBody</p>
 */
public class QueryBindsByPkResponseBody extends TeaModel {
    ...
    private QueryBindsByPkResponseBody(Builder builder) {
    ...
    public static QueryBindsByPkResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryBindsByPkResponseBody model) {
        ...
        public QueryBindsByPkResponseBody build() {
            return new QueryBindsByPkResponseBody(this);
        } 
