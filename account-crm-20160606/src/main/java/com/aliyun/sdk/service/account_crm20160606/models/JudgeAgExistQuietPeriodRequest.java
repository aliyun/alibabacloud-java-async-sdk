...
/**
 * 
 * {@link JudgeAgExistQuietPeriodRequest} extends {@link RequestModel}
 *
 * <p>JudgeAgExistQuietPeriodRequest</p>
 */
public class JudgeAgExistQuietPeriodRequest extends Request {
    ...
    private JudgeAgExistQuietPeriodRequest(Builder builder) {
        super(builder);
    ...
    public static JudgeAgExistQuietPeriodRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<JudgeAgExistQuietPeriodRequest, Builder> {
        private String agAccountType; 
        private String appName; 
        private String mpk; 
        private String pk; 
        ...
        private Builder(JudgeAgExistQuietPeriodRequest request) {
            super(request);
        ...
        @Override
        public JudgeAgExistQuietPeriodRequest build() {
            return new JudgeAgExistQuietPeriodRequest(this);
        } 
