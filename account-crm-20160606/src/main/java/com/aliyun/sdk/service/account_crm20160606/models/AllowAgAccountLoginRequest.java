...
/**
 * 
 * {@link AllowAgAccountLoginRequest} extends {@link RequestModel}
 *
 * <p>AllowAgAccountLoginRequest</p>
 */
public class AllowAgAccountLoginRequest extends Request {
    ...
    private AllowAgAccountLoginRequest(Builder builder) {
        super(builder);
    ...
    public static AllowAgAccountLoginRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AllowAgAccountLoginRequest, Builder> {
        private String agAccountType; 
        private String appName; 
        private String mpk; 
        private String pk; 
        ...
        private Builder(AllowAgAccountLoginRequest request) {
            super(request);
        ...
        @Override
        public AllowAgAccountLoginRequest build() {
            return new AllowAgAccountLoginRequest(this);
        } 
