...
/**
 * 
 * {@link UpdateCustomerInformationRequest} extends {@link RequestModel}
 *
 * <p>UpdateCustomerInformationRequest</p>
 */
public class UpdateCustomerInformationRequest extends Request {
    ...
    private UpdateCustomerInformationRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateCustomerInformationRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateCustomerInformationRequest, Builder> {
        private String biz; 
        private String customerCategory; 
        private String customerSubCategory; 
        private Long userId; 
        ...
        private Builder(UpdateCustomerInformationRequest request) {
            super(request);
        ...
        @Override
        public UpdateCustomerInformationRequest build() {
            return new UpdateCustomerInformationRequest(this);
        } 
