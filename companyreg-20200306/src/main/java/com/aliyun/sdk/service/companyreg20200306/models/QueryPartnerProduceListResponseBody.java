...
/**
 * 
 * {@link QueryPartnerProduceListResponseBody} extends {@link TeaModel}
 *
 * <p>QueryPartnerProduceListResponseBody</p>
 */
public class QueryPartnerProduceListResponseBody extends TeaModel {
    ...
    private QueryPartnerProduceListResponseBody(Builder builder) {
    ...
    public static QueryPartnerProduceListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryPartnerProduceListResponseBody model) {
        ...
        public QueryPartnerProduceListResponseBody build() {
            return new QueryPartnerProduceListResponseBody(this);
        } 
