...
/**
 * 
 * {@link DescribeMvRecommendSubTasksRequest} extends {@link RequestModel}
 *
 * <p>DescribeMvRecommendSubTasksRequest</p>
 */
public class DescribeMvRecommendSubTasksRequest extends Request {
    ...
    private DescribeMvRecommendSubTasksRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeMvRecommendSubTasksRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeMvRecommendSubTasksRequest, Builder> {
        private String actionInner; 
        private String DBClusterId; 
        private String from; 
        private String orderBy; 
        ...
        private Builder(DescribeMvRecommendSubTasksRequest request) {
            super(request);
        ...
        @Override
        public DescribeMvRecommendSubTasksRequest build() {
            return new DescribeMvRecommendSubTasksRequest(this);
        } 
