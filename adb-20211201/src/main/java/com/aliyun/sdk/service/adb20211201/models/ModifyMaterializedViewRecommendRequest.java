...
/**
 * 
 * {@link ModifyMaterializedViewRecommendRequest} extends {@link RequestModel}
 *
 * <p>ModifyMaterializedViewRecommendRequest</p>
 */
public class ModifyMaterializedViewRecommendRequest extends Request {
    ...
    private ModifyMaterializedViewRecommendRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyMaterializedViewRecommendRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyMaterializedViewRecommendRequest, Builder> {
        private String DBClusterId; 
        private String description; 
        private Integer minRewriteQueryCount; 
        private Integer minRewriteQueryPattern; 
        ...
        private Builder(ModifyMaterializedViewRecommendRequest request) {
            super(request);
        ...
        @Override
        public ModifyMaterializedViewRecommendRequest build() {
            return new ModifyMaterializedViewRecommendRequest(this);
        } 
