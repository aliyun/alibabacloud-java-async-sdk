...
/**
 * 
 * {@link DescribeLLMAnswerRequest} extends {@link RequestModel}
 *
 * <p>DescribeLLMAnswerRequest</p>
 */
public class DescribeLLMAnswerRequest extends Request {
    ...
    private DescribeLLMAnswerRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeLLMAnswerRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeLLMAnswerRequest, Builder> {
        private String DBClusterId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String query; 
        ...
        private Builder(DescribeLLMAnswerRequest request) {
            super(request);
        ...
        @Override
        public DescribeLLMAnswerRequest build() {
            return new DescribeLLMAnswerRequest(this);
        } 
