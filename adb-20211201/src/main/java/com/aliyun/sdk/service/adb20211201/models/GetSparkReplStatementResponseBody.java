...
/**
 * 
 * {@link GetSparkReplStatementResponseBody} extends {@link TeaModel}
 *
 * <p>GetSparkReplStatementResponseBody</p>
 */
public class GetSparkReplStatementResponseBody extends TeaModel {
    ...
    private GetSparkReplStatementResponseBody(Builder builder) {
    ...
    public static GetSparkReplStatementResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetSparkReplStatementResponseBody model) {
        ...
        public GetSparkReplStatementResponseBody build() {
            return new GetSparkReplStatementResponseBody(this);
        } 
