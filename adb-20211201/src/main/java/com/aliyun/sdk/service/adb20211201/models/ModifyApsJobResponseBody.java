...
/**
 * 
 * {@link ModifyApsJobResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyApsJobResponseBody</p>
 */
public class ModifyApsJobResponseBody extends TeaModel {
    ...
    private ModifyApsJobResponseBody(Builder builder) {
    ...
    public static ModifyApsJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyApsJobResponseBody model) {
        ...
        public ModifyApsJobResponseBody build() {
            return new ModifyApsJobResponseBody(this);
        } 
