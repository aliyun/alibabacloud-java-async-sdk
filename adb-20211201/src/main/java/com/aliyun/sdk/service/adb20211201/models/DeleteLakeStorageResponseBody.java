...
/**
 * 
 * {@link DeleteLakeStorageResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteLakeStorageResponseBody</p>
 */
public class DeleteLakeStorageResponseBody extends TeaModel {
    ...
    private DeleteLakeStorageResponseBody(Builder builder) {
    ...
    public static DeleteLakeStorageResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteLakeStorageResponseBody model) {
        ...
        public DeleteLakeStorageResponseBody build() {
            return new DeleteLakeStorageResponseBody(this);
        } 
