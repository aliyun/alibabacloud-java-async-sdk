...
/**
 * 
 * {@link DescribeBadSqlDetectionRequest} extends {@link RequestModel}
 *
 * <p>DescribeBadSqlDetectionRequest</p>
 */
public class DescribeBadSqlDetectionRequest extends Request {
    ...
    private DescribeBadSqlDetectionRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeBadSqlDetectionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeBadSqlDetectionRequest, Builder> {
        private String DBClusterId; 
        private String endTime; 
        private String lang; 
        private String ownerAccount; 
        ...
        private Builder(DescribeBadSqlDetectionRequest request) {
            super(request);
        ...
        @Override
        public DescribeBadSqlDetectionRequest build() {
            return new DescribeBadSqlDetectionRequest(this);
        } 
