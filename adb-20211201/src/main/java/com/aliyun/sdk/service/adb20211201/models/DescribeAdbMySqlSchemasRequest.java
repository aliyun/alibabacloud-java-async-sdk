...
/**
 * {@link DescribeAdbMySqlSchemasRequest} extends {@link RequestModel}
 *
 * <p>DescribeAdbMySqlSchemasRequest</p>
 */
public class DescribeAdbMySqlSchemasRequest extends Request {
    ...
    public static DescribeAdbMySqlSchemasRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeAdbMySqlSchemasRequest, Builder> {
        ...
        @Override
        public DescribeAdbMySqlSchemasRequest build() {
            return new DescribeAdbMySqlSchemasRequest(this);
        } 
