...
/**
 * 
 * {@link DescribeAdbMySqlColumnsResponse} extends {@link TeaModel}
 *
 * <p>DescribeAdbMySqlColumnsResponse</p>
 */
public class DescribeAdbMySqlColumnsResponse extends Response {
    ...
    public static DescribeAdbMySqlColumnsResponse create() {
    ...
    public interface Builder extends Response.Builder<DescribeAdbMySqlColumnsResponse, Builder> {
        ...
        @Override
        DescribeAdbMySqlColumnsResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DescribeAdbMySqlColumnsResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DescribeAdbMySqlColumnsResponse build() {
            return new DescribeAdbMySqlColumnsResponse(this);
        } 
