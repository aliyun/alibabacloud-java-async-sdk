...
/**
 * 
 * {@link AddKnowledgeTagsRequest} extends {@link RequestModel}
 *
 * <p>AddKnowledgeTagsRequest</p>
 */
public class AddKnowledgeTagsRequest extends Request {
    ...
    private AddKnowledgeTagsRequest(Builder builder) {
        super(builder);
    ...
    public static AddKnowledgeTagsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddKnowledgeTagsRequest, Builder> {
        private String DBClusterId; 
        private String fileLocation; 
        private String tags; 
        ...
        private Builder(AddKnowledgeTagsRequest request) {
            super(request);
        ...
        @Override
        public AddKnowledgeTagsRequest build() {
            return new AddKnowledgeTagsRequest(this);
        } 
