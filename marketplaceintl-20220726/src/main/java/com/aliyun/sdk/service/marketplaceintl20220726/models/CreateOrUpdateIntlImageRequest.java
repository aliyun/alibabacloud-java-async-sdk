...
/**
 * {@link CreateOrUpdateIntlImageRequest} extends {@link RequestModel}
 *
 * <p>CreateOrUpdateIntlImageRequest</p>
 */
public class CreateOrUpdateIntlImageRequest extends Request {
    @Body
    ...
    private CreateOrUpdateIntlImageRequest(Builder builder) {
        super(builder);
    ...
    public static CreateOrUpdateIntlImageRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateOrUpdateIntlImageRequest, Builder> {
        private AccessInfo accessInfo; 
        private BasicInfo basicInfo; 
        private BussinessInfo bussinessInfo; 
        private String callBackUrl; 
        ...
        private Builder(CreateOrUpdateIntlImageRequest request) {
            super(request);
            this.accessInfo = request.accessInfo;
            this.basicInfo = request.basicInfo;
            this.bussinessInfo = request.bussinessInfo;
            this.callBackUrl = request.callBackUrl;
            this.commodityCode = request.commodityCode;
            this.protocolInfo = request.protocolInfo;
        ...
        public Builder accessInfo(AccessInfo accessInfo) {
            this.putBodyParameter("AccessInfo", accessInfo);
        ...
        public Builder bussinessInfo(BussinessInfo bussinessInfo) {
            this.putBodyParameter("BussinessInfo", bussinessInfo);
        ...
        public Builder protocolInfo(ProtocolInfo protocolInfo) {
            this.putBodyParameter("ProtocolInfo", protocolInfo);
        ...
        @Override
        public CreateOrUpdateIntlImageRequest build() {
            return new CreateOrUpdateIntlImageRequest(this);
        } 
