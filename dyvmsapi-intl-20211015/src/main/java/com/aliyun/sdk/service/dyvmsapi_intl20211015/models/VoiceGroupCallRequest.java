...
/**
 * 
 * {@link VoiceGroupCallRequest} extends {@link RequestModel}
 *
 * <p>VoiceGroupCallRequest</p>
 */
public class VoiceGroupCallRequest extends Request {
    ...
    private VoiceGroupCallRequest(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends Request.Builder<VoiceGroupCallRequest, Builder> {
        private java.util.List<String> calledNumber; 
        private String callerIdNumber; 
        private String countryId; 
        private String outId; 
        ...
        private Builder(VoiceGroupCallRequest request) {
            super(request);
