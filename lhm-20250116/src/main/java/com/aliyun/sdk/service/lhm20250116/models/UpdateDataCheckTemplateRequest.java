...
/**
 * 
 * {@link UpdateDataCheckTemplateRequest} extends {@link RequestModel}
 *
 * <p>UpdateDataCheckTemplateRequest</p>
 */
public class UpdateDataCheckTemplateRequest extends Request {
    ...
    private UpdateDataCheckTemplateRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateDataCheckTemplateRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateDataCheckTemplateRequest, Builder> {
        private java.util.List<BasicMetricRules> basicMetricRules; 
        private Integer checkType; 
        private java.util.List<ComplexMetricRules> complexMetricRules; 
        private java.util.List<DsEngineRels> dsEngineRels; 
        ...
        private Builder(UpdateDataCheckTemplateRequest request) {
            super(request);
        ...
        @Override
        public UpdateDataCheckTemplateRequest build() {
            return new UpdateDataCheckTemplateRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateDataCheckTemplateRequest} extends {@link TeaModel}
     *
     * <p>UpdateDataCheckTemplateRequest</p>
     */
