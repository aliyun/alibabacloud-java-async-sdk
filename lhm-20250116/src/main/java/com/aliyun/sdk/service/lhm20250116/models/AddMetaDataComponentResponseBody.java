...
/**
 * 
 * {@link AddMetaDataComponentResponseBody} extends {@link TeaModel}
 *
 * <p>AddMetaDataComponentResponseBody</p>
 */
public class AddMetaDataComponentResponseBody extends TeaModel {
    ...
    private AddMetaDataComponentResponseBody(Builder builder) {
    ...
    public static AddMetaDataComponentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddMetaDataComponentResponseBody model) {
        ...
        public AddMetaDataComponentResponseBody build() {
            return new AddMetaDataComponentResponseBody(this);
        } 
