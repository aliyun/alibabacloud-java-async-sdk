...
/**
 * 
 * {@link UpdateDataCheckTaskResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateDataCheckTaskResponseBody</p>
 */
public class UpdateDataCheckTaskResponseBody extends TeaModel {
    ...
    private UpdateDataCheckTaskResponseBody(Builder builder) {
    ...
    public static UpdateDataCheckTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateDataCheckTaskResponseBody model) {
        ...
        public UpdateDataCheckTaskResponseBody build() {
            return new UpdateDataCheckTaskResponseBody(this);
        } 
