...
/**
 * 
 * {@link GetLhmDWResourceGroupStatusResponseBody} extends {@link TeaModel}
 *
 * <p>GetLhmDWResourceGroupStatusResponseBody</p>
 */
public class GetLhmDWResourceGroupStatusResponseBody extends TeaModel {
    ...
    private GetLhmDWResourceGroupStatusResponseBody(Builder builder) {
    ...
    public static GetLhmDWResourceGroupStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetLhmDWResourceGroupStatusResponseBody model) {
        ...
        public GetLhmDWResourceGroupStatusResponseBody build() {
            return new GetLhmDWResourceGroupStatusResponseBody(this);
        } 
