...
/**
 * 
 * {@link ExecSqlTransSingleScriptTranslateResponseBody} extends {@link TeaModel}
 *
 * <p>ExecSqlTransSingleScriptTranslateResponseBody</p>
 */
public class ExecSqlTransSingleScriptTranslateResponseBody extends TeaModel {
    ...
    private ExecSqlTransSingleScriptTranslateResponseBody(Builder builder) {
    ...
    public static ExecSqlTransSingleScriptTranslateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExecSqlTransSingleScriptTranslateResponseBody model) {
        ...
        public ExecSqlTransSingleScriptTranslateResponseBody build() {
            return new ExecSqlTransSingleScriptTranslateResponseBody(this);
        } 
