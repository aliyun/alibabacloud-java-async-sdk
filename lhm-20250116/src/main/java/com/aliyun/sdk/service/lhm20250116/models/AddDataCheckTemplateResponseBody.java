...
/**
 * 
 * {@link AddDataCheckTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>AddDataCheckTemplateResponseBody</p>
 */
public class AddDataCheckTemplateResponseBody extends TeaModel {
    ...
    private AddDataCheckTemplateResponseBody(Builder builder) {
    ...
    public static AddDataCheckTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddDataCheckTemplateResponseBody model) {
        ...
        public AddDataCheckTemplateResponseBody build() {
            return new AddDataCheckTemplateResponseBody(this);
        } 
