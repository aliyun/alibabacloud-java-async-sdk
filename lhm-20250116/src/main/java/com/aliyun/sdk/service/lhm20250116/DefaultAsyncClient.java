...
package com.aliyun.sdk.service.lhm20250116;

import com.aliyun.core.http.*;
import com.aliyun.sdk.service.lhm20250116.models.*;
...
public final class DefaultAsyncClient implements AsyncClient {
     ...
     * 
     * @param request the request parameters of AddDataCheckConfig  AddDataCheckConfigRequest
     * @return AddDataCheckConfigResponse
     */
    @Override
    public CompletableFuture<AddDataCheckConfigResponse> addDataCheckConfig(AddDataCheckConfigRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("AddDataCheckConfig").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/config/v3/saveConfig").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(AddDataCheckConfigResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<AddDataCheckConfigResponse> future = new CompletableFuture<>();
     ...
     * 
     * @param request the request parameters of AddDataCheckTask  AddDataCheckTaskRequest
     * @return AddDataCheckTaskResponse
     */
    @Override
    public CompletableFuture<AddDataCheckTaskResponse> addDataCheckTask(AddDataCheckTaskRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("AddDataCheckTask").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/add").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(AddDataCheckTaskResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<AddDataCheckTaskResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of AddDataCheckTemplate  AddDataCheckTemplateRequest
     * @return AddDataCheckTemplateResponse
     */
    @Override
    public CompletableFuture<AddDataCheckTemplateResponse> addDataCheckTemplate(AddDataCheckTemplateRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("AddDataCheckTemplate").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/template/v3/create").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(AddDataCheckTemplateResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<AddDataCheckTemplateResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * When <code>success</code> is <code>false</code>, use <code>errCode</code> and <code>errMessage</code> to identify the cause of the failure.</p>
     * 
     * @param request the request parameters of AddMetaDataComponent  AddMetaDataComponentRequest
     * @return AddMetaDataComponentResponse
     */
    @Override
    public CompletableFuture<AddMetaDataComponentResponse> addMetaDataComponent(AddMetaDataComponentRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("AddMetaDataComponent").setMethod(HttpMethod.POST).setPathRegex("/api/v2/meta/data-component").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(AddMetaDataComponentResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<AddMetaDataComponentResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of CreateExecuteSqlConversion  CreateExecuteSqlConversionRequest
     * @return CreateExecuteSqlConversionResponse
     */
    @Override
    public CompletableFuture<CreateExecuteSqlConversionResponse> createExecuteSqlConversion(CreateExecuteSqlConversionRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("CreateExecuteSqlConversion").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/jobMigrate/sqlTranslator/task/api/createExecute").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(CreateExecuteSqlConversionResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<CreateExecuteSqlConversionResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of CreateSqlExecJob  CreateSqlExecJobRequest
     * @return CreateSqlExecJobResponse
     */
    @Override
    public CompletableFuture<CreateSqlExecJobResponse> createSqlExecJob(CreateSqlExecJobRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("CreateSqlExecJob").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/sql-translator/execute").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(CreateSqlExecJobResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<CreateSqlExecJobResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of DeleteDataCheckConfig  DeleteDataCheckConfigRequest
     * @return DeleteDataCheckConfigResponse
     */
    @Override
    public CompletableFuture<DeleteDataCheckConfigResponse> deleteDataCheckConfig(DeleteDataCheckConfigRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("DeleteDataCheckConfig").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/config/v3/deleteConfig").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(DeleteDataCheckConfigResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<DeleteDataCheckConfigResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * <p>A common response is returned, which contains only success, errCode, errMessage, and requestId. No business data is returned. If success is true, the deletion is successful. If success is false, use errCode and errMessage to identify the cause of the failure.</p>
     * 
     * @param request the request parameters of DeleteDataCheckTask  DeleteDataCheckTaskRequest
     * @return DeleteDataCheckTaskResponse
     */
    @Override
    public CompletableFuture<DeleteDataCheckTaskResponse> deleteDataCheckTask(DeleteDataCheckTaskRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("DeleteDataCheckTask").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/delete").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(DeleteDataCheckTaskResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<DeleteDataCheckTaskResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of DeleteDataCheckTemplate  DeleteDataCheckTemplateRequest
     * @return DeleteDataCheckTemplateResponse
     */
    @Override
    public CompletableFuture<DeleteDataCheckTemplateResponse> deleteDataCheckTemplate(DeleteDataCheckTemplateRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("DeleteDataCheckTemplate").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/template/v3/delete").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(DeleteDataCheckTemplateResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<DeleteDataCheckTemplateResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of EditTaskPop  EditTaskPopRequest
     * @return EditTaskPopResponse
     */
    @Override
    public CompletableFuture<EditTaskPopResponse> editTaskPop(EditTaskPopRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("EditTaskPop").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/sql-translator/editPop").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(EditTaskPopResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<EditTaskPopResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecDataCheckDownloadReport  ExecDataCheckDownloadReportRequest
     * @return ExecDataCheckDownloadReportResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckDownloadReportResponse> execDataCheckDownloadReport(ExecDataCheckDownloadReportRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckDownloadReport").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/download").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckDownloadReportResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckDownloadReportResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecDataCheckGenerateReport  ExecDataCheckGenerateReportRequest
     * @return ExecDataCheckGenerateReportResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckGenerateReportResponse> execDataCheckGenerateReport(ExecDataCheckGenerateReportRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckGenerateReport").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/generateReport").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckGenerateReportResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckGenerateReportResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecDataCheckReRun  ExecDataCheckReRunRequest
     * @return ExecDataCheckReRunResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckReRunResponse> execDataCheckReRun(ExecDataCheckReRunRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckReRun").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/rerun").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckReRunResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckReRunResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecDataCheckRun  ExecDataCheckRunRequest
     * @return ExecDataCheckRunResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckRunResponse> execDataCheckRun(ExecDataCheckRunRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckRun").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/run").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckRunResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckRunResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecDataCheckRunFailed  ExecDataCheckRunFailedRequest
     * @return ExecDataCheckRunFailedResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckRunFailedResponse> execDataCheckRunFailed(ExecDataCheckRunFailedRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckRunFailed").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/runFailed").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckRunFailedResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckRunFailedResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * When <code>success</code> is <code>false</code>, use <code>errCode</code> and <code>errMessage</code> to identify the cause of the failure.</p>
     * 
     * @param request the request parameters of ExecDataCheckSaveTask  ExecDataCheckSaveTaskRequest
     * @return ExecDataCheckSaveTaskResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckSaveTaskResponse> execDataCheckSaveTask(ExecDataCheckSaveTaskRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckSaveTask").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/save").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckSaveTaskResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckSaveTaskResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * If <code>success</code> is <code>false</code>, use <code>errCode</code> and <code>errMessage</code> to identify the cause of the failure.</p>
     * 
     * @param request the request parameters of ExecDataCheckSqlPreview  ExecDataCheckSqlPreviewRequest
     * @return ExecDataCheckSqlPreviewResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckSqlPreviewResponse> execDataCheckSqlPreview(ExecDataCheckSqlPreviewRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckSqlPreview").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/config/v3/sql/preview").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckSqlPreviewResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckSqlPreviewResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecDataCheckStop  ExecDataCheckStopRequest
     * @return ExecDataCheckStopResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckStopResponse> execDataCheckStop(ExecDataCheckStopRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckStop").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/stop").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckStopResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckStopResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecDataCheckToggle  ExecDataCheckToggleRequest
     * @return ExecDataCheckToggleResponse
     */
    @Override
    public CompletableFuture<ExecDataCheckToggleResponse> execDataCheckToggle(ExecDataCheckToggleRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecDataCheckToggle").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/toggle").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecDataCheckToggleResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecDataCheckToggleResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecMetaDataComponentName  ExecMetaDataComponentNameRequest
     * @return ExecMetaDataComponentNameResponse
     */
    @Override
    public CompletableFuture<ExecMetaDataComponentNameResponse> execMetaDataComponentName(ExecMetaDataComponentNameRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecMetaDataComponentName").setMethod(HttpMethod.GET).setPathRegex("/api/v2/meta/data-component/check-name").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecMetaDataComponentNameResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecMetaDataComponentNameResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecSqlTransSingleScriptTranslate  ExecSqlTransSingleScriptTranslateRequest
     * @return ExecSqlTransSingleScriptTranslateResponse
     */
    @Override
    public CompletableFuture<ExecSqlTransSingleScriptTranslateResponse> execSqlTransSingleScriptTranslate(ExecSqlTransSingleScriptTranslateRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecSqlTransSingleScriptTranslate").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/sql-translator/open/single/translate-sync").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecSqlTransSingleScriptTranslateResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecSqlTransSingleScriptTranslateResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ExecWorkflowConnectivity  ExecWorkflowConnectivityRequest
     * @return ExecWorkflowConnectivityResponse
     */
    @Override
    public CompletableFuture<ExecWorkflowConnectivityResponse> execWorkflowConnectivity(ExecWorkflowConnectivityRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ExecWorkflowConnectivity").setMethod(HttpMethod.POST).setPathRegex("/api/v2/meta/data-component/workflow/connectivity").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ExecWorkflowConnectivityResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ExecWorkflowConnectivityResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
    ...
    /**
     * @param request the request parameters of GetAllRulesSummary  GetAllRulesSummaryRequest
     * @return GetAllRulesSummaryResponse
     */
    @Override
    public CompletableFuture<GetAllRulesSummaryResponse> getAllRulesSummary(GetAllRulesSummaryRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetAllRulesSummary").setMethod(HttpMethod.GET).setPathRegex("/api/bigdata/sql-translator/open/rules").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetAllRulesSummaryResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetAllRulesSummaryResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetBwmMigrationSubmitInstanceList  GetBwmMigrationSubmitInstanceListRequest
     * @return GetBwmMigrationSubmitInstanceListResponse
     */
    @Override
    public CompletableFuture<GetBwmMigrationSubmitInstanceListResponse> getBwmMigrationSubmitInstanceList(GetBwmMigrationSubmitInstanceListRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetBwmMigrationSubmitInstanceList").setMethod(HttpMethod.GET).setPathRegex("/api/bwm/task/migration/submit/instances/list").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetBwmMigrationSubmitInstanceListResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetBwmMigrationSubmitInstanceListResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetBwmMigrationTaskWriterResultPackage  GetBwmMigrationTaskWriterResultPackageRequest
     * @return GetBwmMigrationTaskWriterResultPackageResponse
     */
    @Override
    public CompletableFuture<GetBwmMigrationTaskWriterResultPackageResponse> getBwmMigrationTaskWriterResultPackage(GetBwmMigrationTaskWriterResultPackageRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetBwmMigrationTaskWriterResultPackage").setMethod(HttpMethod.GET).setPathRegex("/api/bwm/task/migration/write/result/export/package").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetBwmMigrationTaskWriterResultPackageResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetBwmMigrationTaskWriterResultPackageResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetBwmMigrationTaskWriterWorkflowList  GetBwmMigrationTaskWriterWorkflowListRequest
     * @return GetBwmMigrationTaskWriterWorkflowListResponse
     */
    @Override
    public CompletableFuture<GetBwmMigrationTaskWriterWorkflowListResponse> getBwmMigrationTaskWriterWorkflowList(GetBwmMigrationTaskWriterWorkflowListRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetBwmMigrationTaskWriterWorkflowList").setMethod(HttpMethod.GET).setPathRegex("/api/bwm/task/migration/write/result/workflow/list").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetBwmMigrationTaskWriterWorkflowListResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetBwmMigrationTaskWriterWorkflowListResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetBwmMigrationWorkflowSubmitStart  GetBwmMigrationWorkflowSubmitStartRequest
     * @return GetBwmMigrationWorkflowSubmitStartResponse
     */
    @Override
    public CompletableFuture<GetBwmMigrationWorkflowSubmitStartResponse> getBwmMigrationWorkflowSubmitStart(GetBwmMigrationWorkflowSubmitStartRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetBwmMigrationWorkflowSubmitStart").setMethod(HttpMethod.GET).setPathRegex("/api/bwm/task/migration/submit/start").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetBwmMigrationWorkflowSubmitStartResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetBwmMigrationWorkflowSubmitStartResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
    ...
    /**
     * @param request the request parameters of GetCategoryDetail  GetCategoryDetailRequest
     * @return GetCategoryDetailResponse
     */
    @Override
    public CompletableFuture<GetCategoryDetailResponse> getCategoryDetail(GetCategoryDetailRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetCategoryDetail").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/sql-translator/open/rules/categories").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetCategoryDetailResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetCategoryDetailResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetCronExecTime  GetCronExecTimeRequest
     * @return GetCronExecTimeResponse
     */
    @Override
    public CompletableFuture<GetCronExecTimeResponse> getCronExecTime(GetCronExecTimeRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetCronExecTime").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/task/v3/cron/exeTime").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetCronExecTimeResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetCronExecTimeResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetDataCheckConfig  GetDataCheckConfigRequest
     * @return GetDataCheckConfigResponse
     */
    @Override
    public CompletableFuture<GetDataCheckConfigResponse> getDataCheckConfig(GetDataCheckConfigRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetDataCheckConfig").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/config/v3/getConfig").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetDataCheckConfigResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetDataCheckConfigResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetDataCheckReportOverview  GetDataCheckReportOverviewRequest
     * @return GetDataCheckReportOverviewResponse
     */
    @Override
    public CompletableFuture<GetDataCheckReportOverviewResponse> getDataCheckReportOverview(GetDataCheckReportOverviewRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetDataCheckReportOverview").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/overview").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetDataCheckReportOverviewResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetDataCheckReportOverviewResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetDataCheckReportStatus  GetDataCheckReportStatusRequest
     * @return GetDataCheckReportStatusResponse
     */
    @Override
    public CompletableFuture<GetDataCheckReportStatusResponse> getDataCheckReportStatus(GetDataCheckReportStatusRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetDataCheckReportStatus").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/getReportStatus").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetDataCheckReportStatusResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetDataCheckReportStatusResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetDataCheckTaskConfig  GetDataCheckTaskConfigRequest
     * @return GetDataCheckTaskConfigResponse
     */
    @Override
    public CompletableFuture<GetDataCheckTaskConfigResponse> getDataCheckTaskConfig(GetDataCheckTaskConfigRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetDataCheckTaskConfig").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/task/v3/config").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetDataCheckTaskConfigResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetDataCheckTaskConfigResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetDataCheckTaskList  GetDataCheckTaskListRequest
     * @return GetDataCheckTaskListResponse
     */
    @Override
    public CompletableFuture<GetDataCheckTaskListResponse> getDataCheckTaskList(GetDataCheckTaskListRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetDataCheckTaskList").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/find").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetDataCheckTaskListResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetDataCheckTaskListResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetDataCheckTemplate  GetDataCheckTemplateRequest
     * @return GetDataCheckTemplateResponse
     */
    @Override
    public CompletableFuture<GetDataCheckTemplateResponse> getDataCheckTemplate(GetDataCheckTemplateRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetDataCheckTemplate").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/template/v3/get").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetDataCheckTemplateResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetDataCheckTemplateResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetDataCheckTemplateList  GetDataCheckTemplateListRequest
     * @return GetDataCheckTemplateListResponse
     */
    @Override
    public CompletableFuture<GetDataCheckTemplateListResponse> getDataCheckTemplateList(GetDataCheckTemplateListRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetDataCheckTemplateList").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/template/v3/list").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetDataCheckTemplateListResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetDataCheckTemplateListResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetInnerConvertAsyncResult  GetInnerConvertAsyncResultRequest
     * @return GetInnerConvertAsyncResultResponse
     */
    @Override
    public CompletableFuture<GetInnerConvertAsyncResultResponse> getInnerConvertAsyncResult(GetInnerConvertAsyncResultRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetInnerConvertAsyncResult").setMethod(HttpMethod.POST).setPathRegex("/api/skill/inner/v1/convert/async-result").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetInnerConvertAsyncResultResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetInnerConvertAsyncResultResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetInnerReadAsyncResult  GetInnerReadAsyncResultRequest
     * @return GetInnerReadAsyncResultResponse
     */
    @Override
    public CompletableFuture<GetInnerReadAsyncResultResponse> getInnerReadAsyncResult(GetInnerReadAsyncResultRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetInnerReadAsyncResult").setMethod(HttpMethod.POST).setPathRegex("/api/skill/inner/v1/read/async-result").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetInnerReadAsyncResultResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetInnerReadAsyncResultResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetLhmAgentStatus  GetLhmAgentStatusRequest
     * @return GetLhmAgentStatusResponse
     */
    @Override
    public CompletableFuture<GetLhmAgentStatusResponse> getLhmAgentStatus(GetLhmAgentStatusRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetLhmAgentStatus").setMethod(HttpMethod.GET).setPathRegex("/api/bigdata/lhm/agent/getAgentStatus").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetLhmAgentStatusResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetLhmAgentStatusResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetLhmDWResourceGroupStatus  GetLhmDWResourceGroupStatusRequest
     * @return GetLhmDWResourceGroupStatusResponse
     */
    @Override
    public CompletableFuture<GetLhmDWResourceGroupStatusResponse> getLhmDWResourceGroupStatus(GetLhmDWResourceGroupStatusRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetLhmDWResourceGroupStatus").setMethod(HttpMethod.GET).setPathRegex("/api/bigdata/lhm/resource/getDWResourceGroupStatus").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetLhmDWResourceGroupStatusResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetLhmDWResourceGroupStatusResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetMetaOssTempKey  GetMetaOssTempKeyRequest
     * @return GetMetaOssTempKeyResponse
     */
    @Override
    public CompletableFuture<GetMetaOssTempKeyResponse> getMetaOssTempKey(GetMetaOssTempKeyRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetMetaOssTempKey").setMethod(HttpMethod.POST).setPathRegex("/api/v2/meta/data-component/okss-services/file-job/sts").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetMetaOssTempKeyResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetMetaOssTempKeyResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetSqlConversionProgress  GetSqlConversionProgressRequest
     * @return GetSqlConversionProgressResponse
     */
    @Override
    public CompletableFuture<GetSqlConversionProgressResponse> getSqlConversionProgress(GetSqlConversionProgressRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetSqlConversionProgress").setMethod(HttpMethod.GET).setPathRegex("/api/bigdata/jobMigrate/sqlTranslator/task/api/progress").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetSqlConversionProgressResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetSqlConversionProgressResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetSqlConversionResult  GetSqlConversionResultRequest
     * @return GetSqlConversionResultResponse
     */
    @Override
    public CompletableFuture<GetSqlConversionResultResponse> getSqlConversionResult(GetSqlConversionResultRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetSqlConversionResult").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/jobMigrate/sqlTranslator/task/api/result").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetSqlConversionResultResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetSqlConversionResultResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetSqlTableLineage  GetSqlTableLineageRequest
     * @return GetSqlTableLineageResponse
     */
    @Override
    public CompletableFuture<GetSqlTableLineageResponse> getSqlTableLineage(GetSqlTableLineageRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetSqlTableLineage").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/sql-translator/open/single/getTableLineage").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetSqlTableLineageResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetSqlTableLineageResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetSqlTransTableMetaInfo  GetSqlTransTableMetaInfoRequest
     * @return GetSqlTransTableMetaInfoResponse
     */
    @Override
    public CompletableFuture<GetSqlTransTableMetaInfoResponse> getSqlTransTableMetaInfo(GetSqlTransTableMetaInfoRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetSqlTransTableMetaInfo").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/sql-translator/open/single/get-table-info").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetSqlTransTableMetaInfoResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetSqlTransTableMetaInfoResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of GetStepResultOverview  GetStepResultOverviewRequest
     * @return GetStepResultOverviewResponse
     */
    @Override
    public CompletableFuture<GetStepResultOverviewResponse> getStepResultOverview(GetStepResultOverviewRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GetStepResultOverview").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/result/overview").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GetStepResultOverviewResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GetStepResultOverviewResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListDataCheckColumnResults  ListDataCheckColumnResultsRequest
     * @return ListDataCheckColumnResultsResponse
     */
    @Override
    public CompletableFuture<ListDataCheckColumnResultsResponse> listDataCheckColumnResults(ListDataCheckColumnResultsRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListDataCheckColumnResults").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/column/page").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListDataCheckColumnResultsResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListDataCheckColumnResultsResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListDataCheckConfig  ListDataCheckConfigRequest
     * @return ListDataCheckConfigResponse
     */
    @Override
    public CompletableFuture<ListDataCheckConfigResponse> listDataCheckConfig(ListDataCheckConfigRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListDataCheckConfig").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/config/v3/listConfig/page").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListDataCheckConfigResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListDataCheckConfigResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListDataCheckReport  ListDataCheckReportRequest
     * @return ListDataCheckReportResponse
     */
    @Override
    public CompletableFuture<ListDataCheckReportResponse> listDataCheckReport(ListDataCheckReportRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListDataCheckReport").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/report/v3/page").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListDataCheckReportResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListDataCheckReportResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListDataCheckReportInstance  ListDataCheckReportInstanceRequest
     * @return ListDataCheckReportInstanceResponse
     */
    @Override
    public CompletableFuture<ListDataCheckReportInstanceResponse> listDataCheckReportInstance(ListDataCheckReportInstanceRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListDataCheckReportInstance").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/list").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListDataCheckReportInstanceResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListDataCheckReportInstanceResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListDataCheckReportStep  ListDataCheckReportStepRequest
     * @return ListDataCheckReportStepResponse
     */
    @Override
    public CompletableFuture<ListDataCheckReportStepResponse> listDataCheckReportStep(ListDataCheckReportStepRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListDataCheckReportStep").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/step/page").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListDataCheckReportStepResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListDataCheckReportStepResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListDataCheckReportStepByJobId  ListDataCheckReportStepByJobIdRequest
     * @return ListDataCheckReportStepByJobIdResponse
     */
    @Override
    public CompletableFuture<ListDataCheckReportStepByJobIdResponse> listDataCheckReportStepByJobId(ListDataCheckReportStepByJobIdRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListDataCheckReportStepByJobId").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/report/v3/step/pageByJobId").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListDataCheckReportStepByJobIdResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListDataCheckReportStepByJobIdResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListDataCheckTaskHistory  ListDataCheckTaskHistoryRequest
     * @return ListDataCheckTaskHistoryResponse
     */
    @Override
    public CompletableFuture<ListDataCheckTaskHistoryResponse> listDataCheckTaskHistory(ListDataCheckTaskHistoryRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListDataCheckTaskHistory").setMethod(HttpMethod.GET).setPathRegex("/dataCheck/task/v3/details").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListDataCheckTaskHistoryResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListDataCheckTaskHistoryResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of ListMetaDataComponentPage  ListMetaDataComponentPageRequest
     * @return ListMetaDataComponentPageResponse
     */
    @Override
    public CompletableFuture<ListMetaDataComponentPageResponse> listMetaDataComponentPage(ListMetaDataComponentPageRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("ListMetaDataComponentPage").setMethod(HttpMethod.POST).setPathRegex("/api/v2/meta/data-component/page").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(ListMetaDataComponentPageResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<ListMetaDataComponentPageResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of PostInnerConvert  PostInnerConvertRequest
     * @return PostInnerConvertResponse
     */
    @Override
    public CompletableFuture<PostInnerConvertResponse> postInnerConvert(PostInnerConvertRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("PostInnerConvert").setMethod(HttpMethod.POST).setPathRegex("/api/skill/inner/v1/convert").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(PostInnerConvertResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<PostInnerConvertResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of PostInnerReader  PostInnerReaderRequest
     * @return PostInnerReaderResponse
     */
    @Override
    public CompletableFuture<PostInnerReaderResponse> postInnerReader(PostInnerReaderRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("PostInnerReader").setMethod(HttpMethod.POST).setPathRegex("/api/skill/inner/v1/read").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(PostInnerReaderResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<PostInnerReaderResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of PostInnerUploadConvertPackage  PostInnerUploadConvertPackageRequest
     * @return PostInnerUploadConvertPackageResponse
     */
    @Override
    public CompletableFuture<PostInnerUploadConvertPackageResponse> postInnerUploadConvertPackage(PostInnerUploadConvertPackageRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("PostInnerUploadConvertPackage").setMethod(HttpMethod.POST).setPathRegex("/api/skill/inner/v1/convert/upload-package").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(PostInnerUploadConvertPackageResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<PostInnerUploadConvertPackageResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of SingleSqlDryRun  SingleSqlDryRunRequest
     * @return SingleSqlDryRunResponse
     */
    @Override
    public CompletableFuture<SingleSqlDryRunResponse> singleSqlDryRun(SingleSqlDryRunRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("SingleSqlDryRun").setMethod(HttpMethod.POST).setPathRegex("/api/bigdata/sql-translator/dryRun").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(SingleSqlDryRunResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<SingleSqlDryRunResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of SyntaxCheckAndTransformSqlConversionTask  SyntaxCheckAndTransformSqlConversionTaskRequest
     * @return SyntaxCheckAndTransformSqlConversionTaskResponse
     */
    @Override
    public CompletableFuture<SyntaxCheckAndTransformSqlConversionTaskResponse> syntaxCheckAndTransformSqlConversionTask(SyntaxCheckAndTransformSqlConversionTaskRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("SyntaxCheckAndTransformSqlConversionTask").setMethod(HttpMethod.GET).setPathRegex("/api/bigdata/jobMigrate/sqlTranslator/task/api/syntaxCheckAndTransformTask").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(SyntaxCheckAndTransformSqlConversionTaskResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<SyntaxCheckAndTransformSqlConversionTaskResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of UpdateDataCheckTask  UpdateDataCheckTaskRequest
     * @return UpdateDataCheckTaskResponse
     */
    @Override
    public CompletableFuture<UpdateDataCheckTaskResponse> updateDataCheckTask(UpdateDataCheckTaskRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("UpdateDataCheckTask").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/task/v3/update").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(UpdateDataCheckTaskResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<UpdateDataCheckTaskResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * 
     * @param request the request parameters of UpdateDataCheckTemplate  UpdateDataCheckTemplateRequest
     * @return UpdateDataCheckTemplateResponse
     */
    @Override
    public CompletableFuture<UpdateDataCheckTemplateResponse> updateDataCheckTemplate(UpdateDataCheckTemplateRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("UpdateDataCheckTemplate").setMethod(HttpMethod.POST).setPathRegex("/dataCheck/template/v3/update").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(UpdateDataCheckTemplateResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<UpdateDataCheckTemplateResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
