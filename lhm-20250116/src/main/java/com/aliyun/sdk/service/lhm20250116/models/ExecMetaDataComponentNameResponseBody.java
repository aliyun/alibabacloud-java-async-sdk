...
/**
 * 
 * {@link ExecMetaDataComponentNameResponseBody} extends {@link TeaModel}
 *
 * <p>ExecMetaDataComponentNameResponseBody</p>
 */
public class ExecMetaDataComponentNameResponseBody extends TeaModel {
    ...
    private ExecMetaDataComponentNameResponseBody(Builder builder) {
    ...
    public static ExecMetaDataComponentNameResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExecMetaDataComponentNameResponseBody model) {
        ...
        public ExecMetaDataComponentNameResponseBody build() {
            return new ExecMetaDataComponentNameResponseBody(this);
        } 
