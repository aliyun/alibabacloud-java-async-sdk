...
/**
 * 
 * {@link CreateExecuteSqlConversionResponseBody} extends {@link TeaModel}
 *
 * <p>CreateExecuteSqlConversionResponseBody</p>
 */
public class CreateExecuteSqlConversionResponseBody extends TeaModel {
    ...
    private CreateExecuteSqlConversionResponseBody(Builder builder) {
    ...
    public static CreateExecuteSqlConversionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateExecuteSqlConversionResponseBody model) {
        ...
        public CreateExecuteSqlConversionResponseBody build() {
            return new CreateExecuteSqlConversionResponseBody(this);
        } 
