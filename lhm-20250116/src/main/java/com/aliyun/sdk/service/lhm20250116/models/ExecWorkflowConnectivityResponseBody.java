...
/**
 * 
 * {@link ExecWorkflowConnectivityResponseBody} extends {@link TeaModel}
 *
 * <p>ExecWorkflowConnectivityResponseBody</p>
 */
public class ExecWorkflowConnectivityResponseBody extends TeaModel {
    ...
    private ExecWorkflowConnectivityResponseBody(Builder builder) {
    ...
    public static ExecWorkflowConnectivityResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExecWorkflowConnectivityResponseBody model) {
        ...
        public ExecWorkflowConnectivityResponseBody build() {
            return new ExecWorkflowConnectivityResponseBody(this);
        } 
