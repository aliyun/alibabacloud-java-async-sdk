...
public class SendByFilterResponseBody extends TeaModel {
    ...
    private SendByFilterResponseBody(Builder builder) {
    ...
    public static SendByFilterResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SendByFilterResponseBody model) {
        ...
        public SendByFilterResponseBody build() {
            return new SendByFilterResponseBody(this);
        } 
