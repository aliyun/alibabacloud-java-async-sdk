...
public class CancelByMsgIdResponseBody extends TeaModel {
    ...
    private CancelByMsgIdResponseBody(Builder builder) {
    ...
    public static CancelByMsgIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CancelByMsgIdResponseBody build() {
            return new CancelByMsgIdResponseBody(this);
        } 
