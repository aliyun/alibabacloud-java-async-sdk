...
/**
 * 
 * {@link SendByAppRequest} extends {@link RequestModel}
 *
 * <p>SendByAppRequest</p>
 */
public class SendByAppRequest extends Request {
    ...
    public static SendByAppRequest create() {
    ...
    public static final class Builder extends Request.Builder<SendByAppRequest, Builder> {
        ...
        @Override
        public SendByAppRequest build() {
            return new SendByAppRequest(this);
        } 
