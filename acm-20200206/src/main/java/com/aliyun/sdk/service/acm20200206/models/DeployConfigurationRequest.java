...
/**
 * {@link DeployConfigurationRequest} extends {@link RequestModel}
 *
...
public class DeployConfigurationRequest extends Request {
    ...
    public static DeployConfigurationRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeployConfigurationRequest, Builder> {
        private String appName; 
        private String betaIps; 
        private String content; 
        private String dataId; 
        ...
        public Builder betaIps(String betaIps) {
            this.putBodyParameter("BetaIps", betaIps);
        ...
        @Override
        public DeployConfigurationRequest build() {
            return new DeployConfigurationRequest(this);
        } 
