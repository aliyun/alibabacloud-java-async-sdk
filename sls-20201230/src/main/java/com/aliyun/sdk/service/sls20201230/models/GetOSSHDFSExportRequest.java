...
/**
 * 
 * {@link GetOSSHDFSExportRequest} extends {@link RequestModel}
 *
 * <p>GetOSSHDFSExportRequest</p>
 */
public class GetOSSHDFSExportRequest extends Request {
    ...
    private GetOSSHDFSExportRequest(Builder builder) {
        super(builder);
    ...
    public static GetOSSHDFSExportRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetOSSHDFSExportRequest, Builder> {
        private String project; 
        private String ossExportName; 
        ...
        private Builder(GetOSSHDFSExportRequest request) {
            super(request);
        ...
        public GetOSSHDFSExportRequest build() {
            return new GetOSSHDFSExportRequest(this);
        } 
