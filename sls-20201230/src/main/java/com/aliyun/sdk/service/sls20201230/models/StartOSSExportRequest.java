...
/**
 * 
 * {@link StartOSSExportRequest} extends {@link RequestModel}
 *
 * <p>StartOSSExportRequest</p>
 */
public class StartOSSExportRequest extends Request {
    ...
    private StartOSSExportRequest(Builder builder) {
        super(builder);
    ...
    public static StartOSSExportRequest create() {
    ...
    public static final class Builder extends Request.Builder<StartOSSExportRequest, Builder> {
        private String project; 
        private String ossExportName; 
        ...
        private Builder(StartOSSExportRequest request) {
            super(request);
        ...
        @Override
        public StartOSSExportRequest build() {
            return new StartOSSExportRequest(this);
        } 
