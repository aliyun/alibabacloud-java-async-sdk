...
/**
 * 
 * {@link StopOSSHDFSExportRequest} extends {@link RequestModel}
 *
 * <p>StopOSSHDFSExportRequest</p>
 */
public class StopOSSHDFSExportRequest extends Request {
    ...
    private StopOSSHDFSExportRequest(Builder builder) {
        super(builder);
    ...
    public static StopOSSHDFSExportRequest create() {
    ...
    public static final class Builder extends Request.Builder<StopOSSHDFSExportRequest, Builder> {
        private String project; 
        private String ossExportName; 
        ...
        private Builder(StopOSSHDFSExportRequest request) {
            super(request);
        ...
        @Override
        public StopOSSHDFSExportRequest build() {
            return new StopOSSHDFSExportRequest(this);
        } 
