...
/**
 * 
 * {@link PutIngestProcessorRequest} extends {@link RequestModel}
 *
 * <p>PutIngestProcessorRequest</p>
 */
public class PutIngestProcessorRequest extends Request {
    ...
    private PutIngestProcessorRequest(Builder builder) {
        super(builder);
    ...
    public static PutIngestProcessorRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<PutIngestProcessorRequest, Builder> {
        private String project; 
        private String processorName; 
        private IngestProcessorConfiguration configuration; 
        private String description; 
        ...
        private Builder(PutIngestProcessorRequest request) {
            super(request);
        ...
        public PutIngestProcessorRequest build() {
            return new PutIngestProcessorRequest(this);
        } 
