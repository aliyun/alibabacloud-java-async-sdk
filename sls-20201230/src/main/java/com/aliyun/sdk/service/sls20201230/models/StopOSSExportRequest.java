...
/**
 * 
 * {@link StopOSSExportRequest} extends {@link RequestModel}
 *
 * <p>StopOSSExportRequest</p>
 */
public class StopOSSExportRequest extends Request {
    ...
    private StopOSSExportRequest(Builder builder) {
        super(builder);
    ...
    public static StopOSSExportRequest create() {
    ...
    public static final class Builder extends Request.Builder<StopOSSExportRequest, Builder> {
        private String project; 
        private String ossExportName; 
        ...
        private Builder(StopOSSExportRequest request) {
            super(request);
        ...
        @Override
        public StopOSSExportRequest build() {
