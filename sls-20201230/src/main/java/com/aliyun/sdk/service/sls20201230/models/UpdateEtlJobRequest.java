...
/**
 * {@link UpdateEtlJobRequest} extends {@link RequestModel}
 *
 * <p>UpdateEtlJobRequest</p>
 */
public class UpdateEtlJobRequest extends Request {
    ...
    private UpdateEtlJobRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateEtlJobRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateEtlJobRequest, Builder> {
        private String project; 
        private String etlJobName; 
        private Boolean enable; 
        private FunctionConfig functionConfig; 
        ...
        private Builder(UpdateEtlJobRequest request) {
            super(request);
        ...
        @Override
        public UpdateEtlJobRequest build() {
            return new UpdateEtlJobRequest(this);
        } 
