...
/**
 * 
 * {@link DuplicateModelRequest} extends {@link RequestModel}
 *
 * <p>DuplicateModelRequest</p>
 */
public class DuplicateModelRequest extends Request {
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("CustomerModuleId")
    private Integer customerModuleId;

    private DuplicateModelRequest(Builder builder) {
        super(builder);
    ...
    public static DuplicateModelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DuplicateModelRequest, Builder> {
        private Integer customerModuleId; 
        ...
        private Builder(DuplicateModelRequest request) {
            super(request);
        ...
        @Override
        public DuplicateModelRequest build() {
            return new DuplicateModelRequest(this);
        } 
