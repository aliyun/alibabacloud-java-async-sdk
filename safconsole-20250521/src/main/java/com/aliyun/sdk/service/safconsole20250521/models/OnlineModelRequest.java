...
/**
 * 
 * {@link OnlineModelRequest} extends {@link RequestModel}
 *
 * <p>OnlineModelRequest</p>
 */
public class OnlineModelRequest extends Request {
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("CustomerModuleId")
    private Integer customerModuleId;

    private OnlineModelRequest(Builder builder) {
        super(builder);
    ...
    public static OnlineModelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<OnlineModelRequest, Builder> {
        private Integer customerModuleId; 
        ...
        private Builder(OnlineModelRequest request) {
            super(request);
        ...
        @Override
        public OnlineModelRequest build() {
            return new OnlineModelRequest(this);
        } 
