...
/**
 * 
 * {@link RollbackModelRequest} extends {@link RequestModel}
 *
 * <p>RollbackModelRequest</p>
 */
public class RollbackModelRequest extends Request {
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("CustomerModuleId")
    private Integer customerModuleId;

    private RollbackModelRequest(Builder builder) {
        super(builder);
    ...
    public static RollbackModelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<RollbackModelRequest, Builder> {
        private Integer customerModuleId; 
        ...
        private Builder(RollbackModelRequest request) {
            super(request);
        ...
        @Override
        public RollbackModelRequest build() {
            return new RollbackModelRequest(this);
        } 
