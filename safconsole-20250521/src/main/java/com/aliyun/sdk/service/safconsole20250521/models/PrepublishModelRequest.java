...
/**
 * 
 * {@link PrepublishModelRequest} extends {@link RequestModel}
 *
 * <p>PrepublishModelRequest</p>
 */
public class PrepublishModelRequest extends Request {
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("CustomerModuleId")
    private Integer customerModuleId;

    private PrepublishModelRequest(Builder builder) {
        super(builder);
    ...
    public static PrepublishModelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<PrepublishModelRequest, Builder> {
        private Integer customerModuleId; 
        ...
        private Builder(PrepublishModelRequest request) {
            super(request);
        ...
        @Override
        public PrepublishModelRequest build() {
            return new PrepublishModelRequest(this);
        } 
