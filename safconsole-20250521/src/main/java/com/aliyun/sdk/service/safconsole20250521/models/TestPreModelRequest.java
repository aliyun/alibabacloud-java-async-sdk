...
/**
 * 
 * {@link TestPreModelRequest} extends {@link RequestModel}
 *
 * <p>TestPreModelRequest</p>
 */
public class TestPreModelRequest extends Request {
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("CustomerModuleId")
    private Integer customerModuleId;

    private TestPreModelRequest(Builder builder) {
        super(builder);
    ...
    public static TestPreModelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<TestPreModelRequest, Builder> {
        private Integer customerModuleId; 
        ...
        private Builder(TestPreModelRequest request) {
            super(request);
        ...
        @Override
        public TestPreModelRequest build() {
            return new TestPreModelRequest(this);
        } 
