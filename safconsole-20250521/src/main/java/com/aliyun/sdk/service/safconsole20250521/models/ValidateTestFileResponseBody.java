...
/**
 * 
 * {@link ValidateTestFileResponseBody} extends {@link TeaModel}
 *
 * <p>ValidateTestFileResponseBody</p>
 */
public class ValidateTestFileResponseBody extends TeaModel {
    ...
    private ValidateTestFileResponseBody(Builder builder) {
    ...
    public static ValidateTestFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ValidateTestFileResponseBody model) {
        ...
        public ValidateTestFileResponseBody build() {
            return new ValidateTestFileResponseBody(this);
        } 
