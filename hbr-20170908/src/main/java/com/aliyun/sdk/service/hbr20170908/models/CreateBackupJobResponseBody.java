...
public class CreateBackupJobResponseBody extends TeaModel {
    ...
    public static CreateBackupJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateBackupJobResponseBody model) {
        ...
        public CreateBackupJobResponseBody build() {
            return new CreateBackupJobResponseBody(this);
        } 
