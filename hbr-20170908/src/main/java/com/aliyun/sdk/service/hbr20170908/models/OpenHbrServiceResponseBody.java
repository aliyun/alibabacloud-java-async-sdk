...
public class OpenHbrServiceResponseBody extends TeaModel {
    ...
    public static OpenHbrServiceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OpenHbrServiceResponseBody model) {
        ...
        public OpenHbrServiceResponseBody build() {
            return new OpenHbrServiceResponseBody(this);
        } 
