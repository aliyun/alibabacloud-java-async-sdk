...
/**
 * 
 * {@link CreateVaultReplicationRequest} extends {@link RequestModel}
 *
 * <p>CreateVaultReplicationRequest</p>
 */
public class CreateVaultReplicationRequest extends Request {
    ...
    private CreateVaultReplicationRequest(Builder builder) {
        super(builder);
    ...
    public static CreateVaultReplicationRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateVaultReplicationRequest, Builder> {
        private String replicationSourceRegionId; 
        private String replicationSourceVaultId; 
        private String replicationTargetVaultId; 
        ...
        private Builder(CreateVaultReplicationRequest request) {
            super(request);
        ...
        @Override
        public CreateVaultReplicationRequest build() {
            return new CreateVaultReplicationRequest(this);
        } 
