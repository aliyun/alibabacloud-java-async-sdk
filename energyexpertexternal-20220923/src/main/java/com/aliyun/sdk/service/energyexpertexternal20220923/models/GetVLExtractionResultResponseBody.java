...
/**
 * 
 * {@link GetVLExtractionResultResponseBody} extends {@link TeaModel}
 *
 * <p>GetVLExtractionResultResponseBody</p>
 */
public class GetVLExtractionResultResponseBody extends TeaModel {
    ...
    private GetVLExtractionResultResponseBody(Builder builder) {
    ...
    public static GetVLExtractionResultResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetVLExtractionResultResponseBody model) {
        ...
        public GetVLExtractionResultResponseBody build() {
            return new GetVLExtractionResultResponseBody(this);
        } 
