...
/**
 * {@link BatchUpdateSystemRunningPlanRequest} extends {@link RequestModel}
 *
 * <p>BatchUpdateSystemRunningPlanRequest</p>
 */
public class BatchUpdateSystemRunningPlanRequest extends Request {
    ...
    private BatchUpdateSystemRunningPlanRequest(Builder builder) {
        super(builder);
    ...
    public static BatchUpdateSystemRunningPlanRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchUpdateSystemRunningPlanRequest, Builder> {
        private Integer controlType; 
        private Integer dateType; 
        private String earliestStartupTime; 
        private String endTime; 
        ...
        private Builder(BatchUpdateSystemRunningPlanRequest request) {
            super(request);
        ...
        @Override
        public BatchUpdateSystemRunningPlanRequest build() {
            return new BatchUpdateSystemRunningPlanRequest(this);
        } 
