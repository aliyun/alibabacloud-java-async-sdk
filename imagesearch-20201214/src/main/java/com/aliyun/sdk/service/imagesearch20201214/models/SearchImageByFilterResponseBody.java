...
/**
 * 
 * {@link SearchImageByFilterResponseBody} extends {@link TeaModel}
 *
 * <p>SearchImageByFilterResponseBody</p>
 */
public class SearchImageByFilterResponseBody extends TeaModel {
    ...
    private SearchImageByFilterResponseBody(Builder builder) {
    ...
    public static SearchImageByFilterResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SearchImageByFilterResponseBody model) {
        ...
        public SearchImageByFilterResponseBody build() {
            return new SearchImageByFilterResponseBody(this);
        } 
