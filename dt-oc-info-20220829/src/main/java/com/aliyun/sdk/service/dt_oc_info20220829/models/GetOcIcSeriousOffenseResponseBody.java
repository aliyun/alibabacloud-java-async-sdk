...
/**
 * {@link GetOcIcSeriousOffenseResponseBody} extends {@link TeaModel}
 *
 * <p>GetOcIcSeriousOffenseResponseBody</p>
 */
public class GetOcIcSeriousOffenseResponseBody extends TeaModel {
    @NameInMap("Code")
    private String code;
    ...
    private GetOcIcSeriousOffenseResponseBody(Builder builder) {
    ...
    public static GetOcIcSeriousOffenseResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetOcIcSeriousOffenseResponseBody build() {
            return new GetOcIcSeriousOffenseResponseBody(this);
        } 
