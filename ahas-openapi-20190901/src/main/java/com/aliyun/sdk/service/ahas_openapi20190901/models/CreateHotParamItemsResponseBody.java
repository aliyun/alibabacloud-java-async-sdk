...
/**
 * {@link CreateHotParamItemsResponseBody} extends {@link TeaModel}
 *
 * <p>CreateHotParamItemsResponseBody</p>
 */
public class CreateHotParamItemsResponseBody extends TeaModel {
    ...
    private CreateHotParamItemsResponseBody(Builder builder) {
    ...
    public static CreateHotParamItemsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateHotParamItemsResponseBody build() {
            return new CreateHotParamItemsResponseBody(this);
        } 
