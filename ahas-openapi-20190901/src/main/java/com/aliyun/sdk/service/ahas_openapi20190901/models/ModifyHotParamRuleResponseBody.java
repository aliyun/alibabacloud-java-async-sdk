...
/**
 * {@link ModifyHotParamRuleResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyHotParamRuleResponseBody</p>
 */
public class ModifyHotParamRuleResponseBody extends TeaModel {
    ...
    private ModifyHotParamRuleResponseBody(Builder builder) {
    ...
    public static ModifyHotParamRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifyHotParamRuleResponseBody build() {
            return new ModifyHotParamRuleResponseBody(this);
        } 
