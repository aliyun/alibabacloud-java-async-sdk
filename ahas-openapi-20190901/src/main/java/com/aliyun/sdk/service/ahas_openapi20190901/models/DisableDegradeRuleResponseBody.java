...
/**
 * {@link DisableDegradeRuleResponseBody} extends {@link TeaModel}
 *
 * <p>DisableDegradeRuleResponseBody</p>
 */
public class DisableDegradeRuleResponseBody extends TeaModel {
    ...
    private DisableDegradeRuleResponseBody(Builder builder) {
    ...
    public static DisableDegradeRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DisableDegradeRuleResponseBody build() {
            return new DisableDegradeRuleResponseBody(this);
        } 
