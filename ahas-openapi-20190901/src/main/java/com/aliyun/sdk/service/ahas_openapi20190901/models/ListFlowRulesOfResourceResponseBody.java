...
/**
 * {@link ListFlowRulesOfResourceResponseBody} extends {@link TeaModel}
 *
 * <p>ListFlowRulesOfResourceResponseBody</p>
 */
public class ListFlowRulesOfResourceResponseBody extends TeaModel {
    ...
    private ListFlowRulesOfResourceResponseBody(Builder builder) {
    ...
    public static ListFlowRulesOfResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListFlowRulesOfResourceResponseBody build() {
            return new ListFlowRulesOfResourceResponseBody(this);
        } 
