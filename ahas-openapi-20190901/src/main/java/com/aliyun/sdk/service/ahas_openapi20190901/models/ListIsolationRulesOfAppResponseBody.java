...
/**
 * {@link ListIsolationRulesOfAppResponseBody} extends {@link TeaModel}
 *
 * <p>ListIsolationRulesOfAppResponseBody</p>
 */
public class ListIsolationRulesOfAppResponseBody extends TeaModel {
    ...
    private ListIsolationRulesOfAppResponseBody(Builder builder) {
    ...
    public static ListIsolationRulesOfAppResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListIsolationRulesOfAppResponseBody build() {
            return new ListIsolationRulesOfAppResponseBody(this);
        } 
