...
/**
 * {@link CreateHotParamRuleResponseBody} extends {@link TeaModel}
 *
 * <p>CreateHotParamRuleResponseBody</p>
 */
public class CreateHotParamRuleResponseBody extends TeaModel {
    ...
    private CreateHotParamRuleResponseBody(Builder builder) {
    ...
    public static CreateHotParamRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateHotParamRuleResponseBody build() {
            return new CreateHotParamRuleResponseBody(this);
        } 
