...
/**
 * {@link PushExperimentTaskRequest} extends {@link RequestModel}
 *
 * <p>PushExperimentTaskRequest</p>
 */
public class PushExperimentTaskRequest extends Request {
    @Query
    ...
    private PushExperimentTaskRequest(Builder builder) {
        super(builder);
    ...
    public static PushExperimentTaskRequest create() {
    ...
    public static final class Builder extends Request.Builder<PushExperimentTaskRequest, Builder> {
        private String ahasRegionId; 
        private String experimentTaskId; 
        private String nameSpace; 
        ...
        private Builder(PushExperimentTaskRequest response) {
            super(response);
        ...
        @Override
        public PushExperimentTaskRequest build() {
            return new PushExperimentTaskRequest(this);
        } 
