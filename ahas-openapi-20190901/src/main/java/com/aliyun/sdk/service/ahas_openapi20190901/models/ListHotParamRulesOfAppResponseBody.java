...
/**
 * {@link ListHotParamRulesOfAppResponseBody} extends {@link TeaModel}
 *
 * <p>ListHotParamRulesOfAppResponseBody</p>
 */
public class ListHotParamRulesOfAppResponseBody extends TeaModel {
    ...
    private ListHotParamRulesOfAppResponseBody(Builder builder) {
    ...
    public static ListHotParamRulesOfAppResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListHotParamRulesOfAppResponseBody build() {
            return new ListHotParamRulesOfAppResponseBody(this);
        } 
