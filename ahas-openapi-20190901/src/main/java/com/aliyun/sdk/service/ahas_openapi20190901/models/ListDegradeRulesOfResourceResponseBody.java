...
/**
 * {@link ListDegradeRulesOfResourceResponseBody} extends {@link TeaModel}
 *
 * <p>ListDegradeRulesOfResourceResponseBody</p>
 */
public class ListDegradeRulesOfResourceResponseBody extends TeaModel {
    ...
    private ListDegradeRulesOfResourceResponseBody(Builder builder) {
    ...
    public static ListDegradeRulesOfResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListDegradeRulesOfResourceResponseBody build() {
            return new ListDegradeRulesOfResourceResponseBody(this);
        } 
