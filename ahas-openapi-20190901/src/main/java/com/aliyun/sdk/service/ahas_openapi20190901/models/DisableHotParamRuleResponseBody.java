...
/**
 * {@link DisableHotParamRuleResponseBody} extends {@link TeaModel}
 *
 * <p>DisableHotParamRuleResponseBody</p>
 */
public class DisableHotParamRuleResponseBody extends TeaModel {
    ...
    private DisableHotParamRuleResponseBody(Builder builder) {
    ...
    public static DisableHotParamRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DisableHotParamRuleResponseBody build() {
            return new DisableHotParamRuleResponseBody(this);
        } 
