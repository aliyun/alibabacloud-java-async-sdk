...
/**
 * {@link DisableIsolationRuleResponseBody} extends {@link TeaModel}
 *
 * <p>DisableIsolationRuleResponseBody</p>
 */
public class DisableIsolationRuleResponseBody extends TeaModel {
    ...
    private DisableIsolationRuleResponseBody(Builder builder) {
    ...
    public static DisableIsolationRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DisableIsolationRuleResponseBody build() {
            return new DisableIsolationRuleResponseBody(this);
        } 
