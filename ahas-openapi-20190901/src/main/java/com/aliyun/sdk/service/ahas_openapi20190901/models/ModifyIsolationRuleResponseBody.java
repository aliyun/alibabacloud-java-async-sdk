...
/**
 * {@link ModifyIsolationRuleResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyIsolationRuleResponseBody</p>
 */
public class ModifyIsolationRuleResponseBody extends TeaModel {
    ...
    private ModifyIsolationRuleResponseBody(Builder builder) {
    ...
    public static ModifyIsolationRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifyIsolationRuleResponseBody build() {
            return new ModifyIsolationRuleResponseBody(this);
        } 
