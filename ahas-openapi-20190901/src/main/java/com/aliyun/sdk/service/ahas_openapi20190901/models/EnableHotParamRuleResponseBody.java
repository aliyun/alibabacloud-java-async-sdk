...
/**
 * {@link EnableHotParamRuleResponseBody} extends {@link TeaModel}
 *
 * <p>EnableHotParamRuleResponseBody</p>
 */
public class EnableHotParamRuleResponseBody extends TeaModel {
    ...
    private EnableHotParamRuleResponseBody(Builder builder) {
    ...
    public static EnableHotParamRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public EnableHotParamRuleResponseBody build() {
            return new EnableHotParamRuleResponseBody(this);
        } 
