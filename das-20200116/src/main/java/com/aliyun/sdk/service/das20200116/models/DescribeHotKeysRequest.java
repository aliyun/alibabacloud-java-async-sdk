...
public class DescribeHotKeysRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DescribeHotKeysRequest, Builder> {
        ...
        /**
         * <p>The ID of the ApsaraDB for Redis instance. You can call the <a href="https://help.aliyun.com/document_detail/60933.html">DescribeInstances</a> operation to query the instance ID.</p>
        ...
        /**
         * <p>The ID of the data shard on the ApsaraDB for Redis instance. You can call the <a href="https://help.aliyun.com/document_detail/190794.html">DescribeRoleZoneInfo</a> operation to query the data shard ID.</p>
         * 
         * <strong>example:</strong>
         * <p>r-x****-db-0</p>
         */
