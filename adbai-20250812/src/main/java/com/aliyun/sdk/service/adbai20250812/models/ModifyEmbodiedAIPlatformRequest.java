...
/**
 * 
 * {@link ModifyEmbodiedAIPlatformRequest} extends {@link RequestModel}
 *
 * <p>ModifyEmbodiedAIPlatformRequest</p>
 */
public class ModifyEmbodiedAIPlatformRequest extends Request {
    ...
    public static ModifyEmbodiedAIPlatformRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyEmbodiedAIPlatformRequest, Builder> {
        ...
        private Builder(ModifyEmbodiedAIPlatformRequest request) {
            ...
            this.rayTrainConfig = request.rayTrainConfig;
        ...
        public Builder rayTrainConfig(RayTrainConfig rayTrainConfig) {
            String rayTrainConfigShrink = shrink(rayTrainConfig, "RayTrainConfig", "json");
            this.putQueryParameter("RayTrainConfig", rayTrainConfigShrink);
        ...
        @Override
        public ModifyEmbodiedAIPlatformRequest build() {
            return new ModifyEmbodiedAIPlatformRequest(this);
        } 
    ...
    /**
     * 
     * {@link ModifyEmbodiedAIPlatformRequest} extends {@link TeaModel}
     *
     * <p>ModifyEmbodiedAIPlatformRequest</p>
     */
