...
/**
 * 
 * {@link CredentialRecognitionIntlResponseBody} extends {@link TeaModel}
 *
 * <p>CredentialRecognitionIntlResponseBody</p>
 */
public class CredentialRecognitionIntlResponseBody extends TeaModel {
    ...
    private CredentialRecognitionIntlResponseBody(Builder builder) {
    ...
    public static CredentialRecognitionIntlResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CredentialRecognitionIntlResponseBody model) {
        ...
        public CredentialRecognitionIntlResponseBody build() {
            return new CredentialRecognitionIntlResponseBody(this);
        } 
