...
/**
 * 
 * {@link DescribeMemberTotalStatInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeMemberTotalStatInfoResponseBody</p>
 */
public class DescribeMemberTotalStatInfoResponseBody extends TeaModel {
    ...
    private DescribeMemberTotalStatInfoResponseBody(Builder builder) {
    ...
    public static DescribeMemberTotalStatInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeMemberTotalStatInfoResponseBody model) {
        ...
        public DescribeMemberTotalStatInfoResponseBody build() {
            return new DescribeMemberTotalStatInfoResponseBody(this);
        } 
