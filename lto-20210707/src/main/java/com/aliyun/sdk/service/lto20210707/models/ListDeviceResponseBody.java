...
/**
 * 
 * {@link ListDeviceResponseBody} extends {@link TeaModel}
 *
 * <p>ListDeviceResponseBody</p>
 */
public class ListDeviceResponseBody extends TeaModel {
    ...
    private ListDeviceResponseBody(Builder builder) {
    ...
    public static ListDeviceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListDeviceResponseBody model) {
        ...
        public ListDeviceResponseBody build() {
            return new ListDeviceResponseBody(this);
        } 
