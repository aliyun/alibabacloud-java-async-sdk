...
/**
 * 
 * {@link DescribeMemberBizChainStatInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeMemberBizChainStatInfoResponseBody</p>
 */
public class DescribeMemberBizChainStatInfoResponseBody extends TeaModel {
    ...
    private DescribeMemberBizChainStatInfoResponseBody(Builder builder) {
    ...
    public static DescribeMemberBizChainStatInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeMemberBizChainStatInfoResponseBody model) {
        ...
        public DescribeMemberBizChainStatInfoResponseBody build() {
            return new DescribeMemberBizChainStatInfoResponseBody(this);
        } 
