...
/**
 * 
 * {@link DescribeDashboardApiInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDashboardApiInfoResponseBody</p>
 */
public class DescribeDashboardApiInfoResponseBody extends TeaModel {
    ...
    private DescribeDashboardApiInfoResponseBody(Builder builder) {
    ...
    public static DescribeDashboardApiInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeDashboardApiInfoResponseBody model) {
        ...
        public DescribeDashboardApiInfoResponseBody build() {
            return new DescribeDashboardApiInfoResponseBody(this);
        } 
