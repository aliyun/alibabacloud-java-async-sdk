...
/**
 * 
 * {@link ListAllPrivacyRuleResponseBody} extends {@link TeaModel}
 *
 * <p>ListAllPrivacyRuleResponseBody</p>
 */
public class ListAllPrivacyRuleResponseBody extends TeaModel {
    ...
    private ListAllPrivacyRuleResponseBody(Builder builder) {
    ...
    public static ListAllPrivacyRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAllPrivacyRuleResponseBody model) {
        ...
        public ListAllPrivacyRuleResponseBody build() {
            return new ListAllPrivacyRuleResponseBody(this);
        } 
