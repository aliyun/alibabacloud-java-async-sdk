...
/**
 * 
 * {@link DescribeDashboardDeviceInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDashboardDeviceInfoResponseBody</p>
 */
public class DescribeDashboardDeviceInfoResponseBody extends TeaModel {
    ...
    private DescribeDashboardDeviceInfoResponseBody(Builder builder) {
    ...
    public static DescribeDashboardDeviceInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeDashboardDeviceInfoResponseBody model) {
        ...
        public DescribeDashboardDeviceInfoResponseBody build() {
            return new DescribeDashboardDeviceInfoResponseBody(this);
        } 
