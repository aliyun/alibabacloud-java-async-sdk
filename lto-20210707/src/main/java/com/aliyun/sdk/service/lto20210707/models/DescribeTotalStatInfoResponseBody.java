...
/**
 * 
 * {@link DescribeTotalStatInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeTotalStatInfoResponseBody</p>
 */
public class DescribeTotalStatInfoResponseBody extends TeaModel {
    ...
    private DescribeTotalStatInfoResponseBody(Builder builder) {
    ...
    public static DescribeTotalStatInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeTotalStatInfoResponseBody model) {
        ...
        public DescribeTotalStatInfoResponseBody build() {
            return new DescribeTotalStatInfoResponseBody(this);
        } 
