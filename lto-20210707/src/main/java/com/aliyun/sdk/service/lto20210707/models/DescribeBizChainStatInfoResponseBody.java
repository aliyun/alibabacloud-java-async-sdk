...
/**
 * 
 * {@link DescribeBizChainStatInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeBizChainStatInfoResponseBody</p>
 */
public class DescribeBizChainStatInfoResponseBody extends TeaModel {
    ...
    private DescribeBizChainStatInfoResponseBody(Builder builder) {
    ...
    public static DescribeBizChainStatInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeBizChainStatInfoResponseBody model) {
        ...
        public DescribeBizChainStatInfoResponseBody build() {
            return new DescribeBizChainStatInfoResponseBody(this);
        } 
