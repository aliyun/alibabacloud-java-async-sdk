...
/**
 * 
 * {@link QueryBlockchainDataRequest} extends {@link RequestModel}
 *
 * <p>QueryBlockchainDataRequest</p>
 */
public class QueryBlockchainDataRequest extends Request {
    ...
    private QueryBlockchainDataRequest(Builder builder) {
        super(builder);
    ...
    public static QueryBlockchainDataRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryBlockchainDataRequest, Builder> {
        private String bizChainId; 
        private String contractName; 
        private String invokeType; 
        private String iotDataDID; 
        ...
        private Builder(QueryBlockchainDataRequest request) {
            super(request);
        ...
        @Override
        public QueryBlockchainDataRequest build() {
            return new QueryBlockchainDataRequest(this);
        } 
