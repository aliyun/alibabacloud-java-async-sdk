...
/**
 * 
 * {@link GetRayHistoryServerResponseBody} extends {@link TeaModel}
 *
 * <p>GetRayHistoryServerResponseBody</p>
 */
public class GetRayHistoryServerResponseBody extends TeaModel {
    ...
    private GetRayHistoryServerResponseBody(Builder builder) {
    ...
    public static GetRayHistoryServerResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetRayHistoryServerResponseBody model) {
        ...
        public GetRayHistoryServerResponseBody build() {
            return new GetRayHistoryServerResponseBody(this);
        } 
