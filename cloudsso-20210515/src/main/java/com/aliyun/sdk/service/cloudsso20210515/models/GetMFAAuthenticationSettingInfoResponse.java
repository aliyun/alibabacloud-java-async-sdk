...
/**
 * {@link GetMFAAuthenticationSettingInfoResponse} extends {@link TeaModel}
 *
 * <p>GetMFAAuthenticationSettingInfoResponse</p>
 */
public class GetMFAAuthenticationSettingInfoResponse extends Response {
    @NameInMap("headers")
    ...
    public static GetMFAAuthenticationSettingInfoResponse create() {
    ...
    public interface Builder extends Response.Builder<GetMFAAuthenticationSettingInfoResponse, Builder> {
        ...
        @Override
        GetMFAAuthenticationSettingInfoResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(GetMFAAuthenticationSettingInfoResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public GetMFAAuthenticationSettingInfoResponse build() {
            return new GetMFAAuthenticationSettingInfoResponse(this);
        } 
