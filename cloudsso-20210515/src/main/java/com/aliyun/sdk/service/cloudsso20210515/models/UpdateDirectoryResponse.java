...
public class UpdateDirectoryResponse extends Response {
    ...
    private UpdateDirectoryResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<UpdateDirectoryResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(UpdateDirectoryResponseBody body);

        @Override
        UpdateDirectoryResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<UpdateDirectoryResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private UpdateDirectoryResponseBody body; 
        ...
        private BuilderImpl(UpdateDirectoryResponse response) {
            super(response);
