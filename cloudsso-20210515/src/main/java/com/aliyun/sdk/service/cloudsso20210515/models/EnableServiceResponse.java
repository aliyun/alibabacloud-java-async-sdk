...
public class EnableServiceResponse extends Response {
    ...
    private EnableServiceResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<EnableServiceResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(EnableServiceResponseBody body);

        @Override
        EnableServiceResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<EnableServiceResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private EnableServiceResponseBody body; 
        ...
        private BuilderImpl(EnableServiceResponse response) {
            super(response);
