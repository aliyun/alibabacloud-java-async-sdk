...
public class RemoveExternalSAMLIdPCertificateResponse extends Response {
    ...
    private RemoveExternalSAMLIdPCertificateResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<RemoveExternalSAMLIdPCertificateResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(RemoveExternalSAMLIdPCertificateResponseBody body);

        @Override
        RemoveExternalSAMLIdPCertificateResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<RemoveExternalSAMLIdPCertificateResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private RemoveExternalSAMLIdPCertificateResponseBody body; 
        ...
        private BuilderImpl(RemoveExternalSAMLIdPCertificateResponse response) {
            super(response);
