...
public class SetExternalSAMLIdentityProviderResponse extends Response {
    ...
    private SetExternalSAMLIdentityProviderResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<SetExternalSAMLIdentityProviderResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(SetExternalSAMLIdentityProviderResponseBody body);

        @Override
        SetExternalSAMLIdentityProviderResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<SetExternalSAMLIdentityProviderResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private SetExternalSAMLIdentityProviderResponseBody body; 
        ...
        private BuilderImpl(SetExternalSAMLIdentityProviderResponse response) {
            super(response);
