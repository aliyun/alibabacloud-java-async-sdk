...
/**
 * 
 * {@link UpdateExperimentBasicInfoResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateExperimentBasicInfoResponseBody</p>
 */
public class UpdateExperimentBasicInfoResponseBody extends TeaModel {
    ...
    private UpdateExperimentBasicInfoResponseBody(Builder builder) {
    ...
    public static UpdateExperimentBasicInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateExperimentBasicInfoResponseBody build() {
            return new UpdateExperimentBasicInfoResponseBody(this);
        } 
