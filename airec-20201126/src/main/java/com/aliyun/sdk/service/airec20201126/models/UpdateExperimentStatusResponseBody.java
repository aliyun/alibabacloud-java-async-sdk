...
/**
 * 
 * {@link UpdateExperimentStatusResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateExperimentStatusResponseBody</p>
 */
public class UpdateExperimentStatusResponseBody extends TeaModel {
    ...
    private UpdateExperimentStatusResponseBody(Builder builder) {
    ...
    public static UpdateExperimentStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateExperimentStatusResponseBody build() {
            return new UpdateExperimentStatusResponseBody(this);
        } 
