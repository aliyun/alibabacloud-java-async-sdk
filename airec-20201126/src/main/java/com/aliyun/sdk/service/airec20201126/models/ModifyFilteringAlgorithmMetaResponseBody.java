...
/**
 * 
 * {@link ModifyFilteringAlgorithmMetaResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyFilteringAlgorithmMetaResponseBody</p>
 */
public class ModifyFilteringAlgorithmMetaResponseBody extends TeaModel {
    ...
    private ModifyFilteringAlgorithmMetaResponseBody(Builder builder) {
    ...
    public static ModifyFilteringAlgorithmMetaResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifyFilteringAlgorithmMetaResponseBody build() {
            return new ModifyFilteringAlgorithmMetaResponseBody(this);
        } 
