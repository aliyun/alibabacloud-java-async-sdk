...
/**
 * 
 * {@link ListFilteringAlgorithmsResponseBody} extends {@link TeaModel}
 *
 * <p>ListFilteringAlgorithmsResponseBody</p>
 */
public class ListFilteringAlgorithmsResponseBody extends TeaModel {
    ...
    private ListFilteringAlgorithmsResponseBody(Builder builder) {
    ...
    public static ListFilteringAlgorithmsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListFilteringAlgorithmsResponseBody build() {
            return new ListFilteringAlgorithmsResponseBody(this);
        } 
