...
/**
 * 
 * {@link DescribeLatestTaskResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeLatestTaskResponseBody</p>
 */
public class DescribeLatestTaskResponseBody extends TeaModel {
    ...
    private DescribeLatestTaskResponseBody(Builder builder) {
    ...
    public static DescribeLatestTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeLatestTaskResponseBody build() {
            return new DescribeLatestTaskResponseBody(this);
        } 
