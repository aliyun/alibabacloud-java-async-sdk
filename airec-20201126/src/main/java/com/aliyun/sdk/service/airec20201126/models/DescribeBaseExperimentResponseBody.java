...
/**
 * 
 * {@link DescribeBaseExperimentResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeBaseExperimentResponseBody</p>
 */
public class DescribeBaseExperimentResponseBody extends TeaModel {
    ...
    private DescribeBaseExperimentResponseBody(Builder builder) {
    ...
    public static DescribeBaseExperimentResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeBaseExperimentResponseBody build() {
            return new DescribeBaseExperimentResponseBody(this);
        } 
