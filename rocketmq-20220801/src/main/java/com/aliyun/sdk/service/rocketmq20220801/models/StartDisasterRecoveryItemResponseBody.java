...
/**
 * 
 * {@link StartDisasterRecoveryItemResponseBody} extends {@link TeaModel}
 *
 * <p>StartDisasterRecoveryItemResponseBody</p>
 */
public class StartDisasterRecoveryItemResponseBody extends TeaModel {
    ...
    private StartDisasterRecoveryItemResponseBody(Builder builder) {
    ...
    public static StartDisasterRecoveryItemResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartDisasterRecoveryItemResponseBody model) {
        ...
        public StartDisasterRecoveryItemResponseBody build() {
            return new StartDisasterRecoveryItemResponseBody(this);
        } 
