...
/**
 * 
 * {@link UpdateInstanceAccountResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateInstanceAccountResponseBody</p>
 */
public class UpdateInstanceAccountResponseBody extends TeaModel {
    ...
    private UpdateInstanceAccountResponseBody(Builder builder) {
    ...
    public static UpdateInstanceAccountResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateInstanceAccountResponseBody model) {
        ...
        public UpdateInstanceAccountResponseBody build() {
            return new UpdateInstanceAccountResponseBody(this);
        } 
