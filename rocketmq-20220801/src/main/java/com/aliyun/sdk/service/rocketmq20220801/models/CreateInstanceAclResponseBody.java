...
public class CreateInstanceAclResponseBody extends TeaModel {
    ...
    private CreateInstanceAclResponseBody(Builder builder) {
    ...
    public static CreateInstanceAclResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateInstanceAclResponseBody model) {
        ...
        public CreateInstanceAclResponseBody build() {
            return new CreateInstanceAclResponseBody(this);
        } 
