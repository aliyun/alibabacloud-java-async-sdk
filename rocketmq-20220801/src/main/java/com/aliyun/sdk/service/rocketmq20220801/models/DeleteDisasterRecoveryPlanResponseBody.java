...
/**
 * 
 * {@link DeleteDisasterRecoveryPlanResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteDisasterRecoveryPlanResponseBody</p>
 */
public class DeleteDisasterRecoveryPlanResponseBody extends TeaModel {
    ...
    private DeleteDisasterRecoveryPlanResponseBody(Builder builder) {
    ...
    public static DeleteDisasterRecoveryPlanResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteDisasterRecoveryPlanResponseBody model) {
        ...
        public DeleteDisasterRecoveryPlanResponseBody build() {
            return new DeleteDisasterRecoveryPlanResponseBody(this);
        } 
