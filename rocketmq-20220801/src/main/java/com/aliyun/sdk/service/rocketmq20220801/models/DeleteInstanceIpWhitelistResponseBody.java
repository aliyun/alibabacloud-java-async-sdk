...
public class DeleteInstanceIpWhitelistResponseBody extends TeaModel {
    ...
    private DeleteInstanceIpWhitelistResponseBody(Builder builder) {
    ...
    public static DeleteInstanceIpWhitelistResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteInstanceIpWhitelistResponseBody model) {
        ...
        public DeleteInstanceIpWhitelistResponseBody build() {
            return new DeleteInstanceIpWhitelistResponseBody(this);
        } 
