...
/**
 * 
 * {@link UpdateDisasterRecoveryPlanResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateDisasterRecoveryPlanResponseBody</p>
 */
public class UpdateDisasterRecoveryPlanResponseBody extends TeaModel {
    ...
    private UpdateDisasterRecoveryPlanResponseBody(Builder builder) {
    ...
    public static UpdateDisasterRecoveryPlanResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateDisasterRecoveryPlanResponseBody model) {
        ...
        public UpdateDisasterRecoveryPlanResponseBody build() {
            return new UpdateDisasterRecoveryPlanResponseBody(this);
        } 
