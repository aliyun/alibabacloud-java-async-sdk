...
public class VerifySendMessageResponseBody extends TeaModel {
    ...
    private VerifySendMessageResponseBody(Builder builder) {
    ...
    public static VerifySendMessageResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(VerifySendMessageResponseBody model) {
        ...
        public VerifySendMessageResponseBody build() {
            return new VerifySendMessageResponseBody(this);
        } 
