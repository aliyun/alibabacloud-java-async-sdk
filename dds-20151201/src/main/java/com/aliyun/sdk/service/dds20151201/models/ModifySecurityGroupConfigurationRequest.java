 ...
 */
public class ModifySecurityGroupConfigurationRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    public static ModifySecurityGroupConfigurationRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifySecurityGroupConfigurationRequest, Builder> {
        ...
        @Override
        public ModifySecurityGroupConfigurationRequest build() {
            return new ModifySecurityGroupConfigurationRequest(this);
        } 
