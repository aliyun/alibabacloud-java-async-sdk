...
public class DescribeActiveOperationTaskTypeRequest extends Request {
    ...
    public static DescribeActiveOperationTaskTypeRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeActiveOperationTaskTypeRequest, Builder> {
        ...
        @Override
        public DescribeActiveOperationTaskTypeRequest build() {
            return new DescribeActiveOperationTaskTypeRequest(this);
        } 
