 ...
 */
public class DescribeBackupStorageRequest extends Request {
    ...
    private DescribeBackupStorageRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeBackupStorageRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeBackupStorageRequest, Builder> {
        private String DBInstanceId; 
        private String nodeId; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(DescribeBackupStorageRequest request) {
            super(request);
        ...
        @Override
        public DescribeBackupStorageRequest build() {
            return new DescribeBackupStorageRequest(this);
        } 
