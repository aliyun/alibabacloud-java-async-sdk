...
/**
 * {@link DescribeAppResourceAllocResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAppResourceAllocResponseBody</p>
 */
public class DescribeAppResourceAllocResponseBody extends TeaModel {
    ...
    private DescribeAppResourceAllocResponseBody(Builder builder) {
    ...
    public static DescribeAppResourceAllocResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeAppResourceAllocResponseBody build() {
            return new DescribeAppResourceAllocResponseBody(this);
        } 
