...
/**
 * 
 * {@link GetProtectionPolicyRequest} extends {@link RequestModel}
 *
 * <p>GetProtectionPolicyRequest</p>
 */
public class GetProtectionPolicyRequest extends Request {
    @com.aliyun.core.annotation.Path
    @com.aliyun.core.annotation.NameInMap("ProtectionPolicyId")
    @com.aliyun.core.annotation.Validation(required = true)
    private String protectionPolicyId;

    private GetProtectionPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static GetProtectionPolicyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetProtectionPolicyRequest, Builder> {
        private String protectionPolicyId; 
        ...
        private Builder(GetProtectionPolicyRequest request) {
            super(request);
        ...
        public GetProtectionPolicyRequest build() {
            return new GetProtectionPolicyRequest(this);
        } 
