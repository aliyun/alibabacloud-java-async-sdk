...
/**
 * 
 * {@link ListVccGrantRulesRequest} extends {@link RequestModel}
 *
 * <p>ListVccGrantRulesRequest</p>
 */
public class ListVccGrantRulesRequest extends Request {
    ...
    private ListVccGrantRulesRequest(Builder builder) {
        super(builder);
    ...
    public static ListVccGrantRulesRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListVccGrantRulesRequest, Builder> {
        private Boolean enablePage; 
        private String erId; 
        private Boolean forSelect; 
        private String grantRuleId; 
        ...
        private Builder(ListVccGrantRulesRequest request) {
            super(request);
        ...
        @Override
        public ListVccGrantRulesRequest build() {
            return new ListVccGrantRulesRequest(this);
        } 
