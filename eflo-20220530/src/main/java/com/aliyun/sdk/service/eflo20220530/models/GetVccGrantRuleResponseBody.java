...
/**
 * 
 * {@link GetVccGrantRuleResponseBody} extends {@link TeaModel}
 *
 * <p>GetVccGrantRuleResponseBody</p>
 */
public class GetVccGrantRuleResponseBody extends TeaModel {
    ...
    private GetVccGrantRuleResponseBody(Builder builder) {
    ...
    public static GetVccGrantRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetVccGrantRuleResponseBody model) {
        ...
        public GetVccGrantRuleResponseBody build() {
            return new GetVccGrantRuleResponseBody(this);
        } 
