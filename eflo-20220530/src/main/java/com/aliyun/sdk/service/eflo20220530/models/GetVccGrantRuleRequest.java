...
/**
 * 
 * {@link GetVccGrantRuleRequest} extends {@link RequestModel}
 *
 * <p>GetVccGrantRuleRequest</p>
 */
public class GetVccGrantRuleRequest extends Request {
    ...
    private GetVccGrantRuleRequest(Builder builder) {
        super(builder);
    ...
    public static GetVccGrantRuleRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetVccGrantRuleRequest, Builder> {
        private String erId; 
        private String grantRuleId; 
        private String grantTenantId; 
        private String instanceId; 
        ...
        private Builder(GetVccGrantRuleRequest request) {
            super(request);
        ...
        @Override
        public GetVccGrantRuleRequest build() {
            return new GetVccGrantRuleRequest(this);
        } 
