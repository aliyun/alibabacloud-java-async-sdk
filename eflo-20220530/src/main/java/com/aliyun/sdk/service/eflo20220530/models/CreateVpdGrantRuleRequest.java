...
/**
 * 
 * {@link CreateVpdGrantRuleRequest} extends {@link RequestModel}
 *
 * <p>CreateVpdGrantRuleRequest</p>
 */
public class CreateVpdGrantRuleRequest extends Request {
    ...
    private CreateVpdGrantRuleRequest(Builder builder) {
        super(builder);
    ...
    public static CreateVpdGrantRuleRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateVpdGrantRuleRequest, Builder> {
        private String erId; 
        private String grantTenantId; 
        private String instanceId; 
        private String regionId; 
        ...
        private Builder(CreateVpdGrantRuleRequest request) {
            super(request);
        ...
        @Override
        public CreateVpdGrantRuleRequest build() {
            return new CreateVpdGrantRuleRequest(this);
        } 
