...
public class AllocateAnycastEipAddressResponse extends Response {
    ...
    private AllocateAnycastEipAddressResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<AllocateAnycastEipAddressResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(AllocateAnycastEipAddressResponseBody body);

        @Override
        AllocateAnycastEipAddressResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<AllocateAnycastEipAddressResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private AllocateAnycastEipAddressResponseBody body; 
        ...
        private BuilderImpl(AllocateAnycastEipAddressResponse response) {
            super(response);
