...
public class GetSubtaskResponseBody extends TeaModel {
    ...
    @com.aliyun.core.annotation.NameInMap("Subtask")
    private SimpleSubtask subtask;

    @com.aliyun.core.annotation.NameInMap("Success")
    private Boolean success;

    private GetSubtaskResponseBody(Builder builder) {
    ...
    public static final class Builder {
         ...
         * Subtask.
         */
        public Builder subtask(SimpleSubtask subtask) {
        ...
        public GetSubtaskResponseBody build() {
            return new GetSubtaskResponseBody(this);
        } 
