...
public class GetTaskTemplateQuestionsResponseBody extends TeaModel {
    ...
    private GetTaskTemplateQuestionsResponseBody(Builder builder) {
    ...
    public static final class Builder {
        ...
        public GetTaskTemplateQuestionsResponseBody build() {
            return new GetTaskTemplateQuestionsResponseBody(this);
        } 
