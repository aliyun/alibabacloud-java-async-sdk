...
/**
 * 
 * {@link DescribeAutoRepairPolicyResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAutoRepairPolicyResponseBody</p>
 */
public class DescribeAutoRepairPolicyResponseBody extends TeaModel {
    ...
    private DescribeAutoRepairPolicyResponseBody(Builder builder) {
        this.id = builder.id;
    ...
    public static DescribeAutoRepairPolicyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeAutoRepairPolicyResponseBody model) {
            this.id = model.id;
        ...
        public DescribeAutoRepairPolicyResponseBody build() {
            return new DescribeAutoRepairPolicyResponseBody(this);
        } 
