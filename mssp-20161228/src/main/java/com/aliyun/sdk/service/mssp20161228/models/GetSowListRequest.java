...
/**
 * 
 * {@link GetSowListRequest} extends {@link RequestModel}
 *
 * <p>GetSowListRequest</p>
 */
public class GetSowListRequest extends Request {
    ...
    private GetSowListRequest(Builder builder) {
        super(builder);
    ...
    public static GetSowListRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetSowListRequest, Builder> {
        private String dateType; 
        private Long endDate; 
        private Long startDate; 
        private String suspEventSource; 
        ...
        private Builder(GetSowListRequest request) {
            super(request);
        ...
        @Override
        public GetSowListRequest build() {
            return new GetSowListRequest(this);
        } 
