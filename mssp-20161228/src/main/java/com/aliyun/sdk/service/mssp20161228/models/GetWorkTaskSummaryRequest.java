...
/**
 * 
 * {@link GetWorkTaskSummaryRequest} extends {@link RequestModel}
 *
 * <p>GetWorkTaskSummaryRequest</p>
 */
public class GetWorkTaskSummaryRequest extends Request {
    ...
    private GetWorkTaskSummaryRequest(Builder builder) {
        super(builder);
    ...
    public static GetWorkTaskSummaryRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetWorkTaskSummaryRequest, Builder> {
        private String dateType; 
        private Long endDate; 
        private Long startDate; 
        private String suspEventSource; 
        ...
        private Builder(GetWorkTaskSummaryRequest request) {
            super(request);
        ...
        @Override
        public GetWorkTaskSummaryRequest build() {
            return new GetWorkTaskSummaryRequest(this);
        } 
