...
/**
 * 
 * {@link GetSuspEventSummaryRequest} extends {@link RequestModel}
 *
 * <p>GetSuspEventSummaryRequest</p>
 */
public class GetSuspEventSummaryRequest extends Request {
    ...
    private GetSuspEventSummaryRequest(Builder builder) {
        super(builder);
    ...
    public static GetSuspEventSummaryRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetSuspEventSummaryRequest, Builder> {
        private String dateType; 
        private Long endDate; 
        private Long startDate; 
        private String suspEventSource; 
        ...
        private Builder(GetSuspEventSummaryRequest request) {
            super(request);
        ...
        @Override
        public GetSuspEventSummaryRequest build() {
            return new GetSuspEventSummaryRequest(this);
        } 
