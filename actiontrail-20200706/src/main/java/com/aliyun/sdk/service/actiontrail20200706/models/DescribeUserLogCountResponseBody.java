...
/**
 * 
 * {@link DescribeUserLogCountResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeUserLogCountResponseBody</p>
 */
public class DescribeUserLogCountResponseBody extends TeaModel {
    ...
    private DescribeUserLogCountResponseBody(Builder builder) {
    ...
    public static DescribeUserLogCountResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeUserLogCountResponseBody model) {
        ...
        public DescribeUserLogCountResponseBody build() {
            return new DescribeUserLogCountResponseBody(this);
        } 
