...
/**
 * 
 * {@link DescribeUserTrailCountResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeUserTrailCountResponseBody</p>
 */
public class DescribeUserTrailCountResponseBody extends TeaModel {
    ...
    private DescribeUserTrailCountResponseBody(Builder builder) {
    ...
    public static DescribeUserTrailCountResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeUserTrailCountResponseBody model) {
        ...
        public DescribeUserTrailCountResponseBody build() {
            return new DescribeUserTrailCountResponseBody(this);
        } 
