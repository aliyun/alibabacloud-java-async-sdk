...
/**
 * 
 * {@link UpdateAdvancedQueryTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAdvancedQueryTemplateResponseBody</p>
 */
public class UpdateAdvancedQueryTemplateResponseBody extends TeaModel {
    ...
    private UpdateAdvancedQueryTemplateResponseBody(Builder builder) {
    ...
    public static UpdateAdvancedQueryTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAdvancedQueryTemplateResponseBody model) {
        ...
        public UpdateAdvancedQueryTemplateResponseBody build() {
            return new UpdateAdvancedQueryTemplateResponseBody(this);
        } 
