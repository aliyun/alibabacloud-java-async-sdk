...
/**
 * 
 * {@link PutInsightSelectorsResponseBody} extends {@link TeaModel}
 *
 * <p>PutInsightSelectorsResponseBody</p>
 */
public class PutInsightSelectorsResponseBody extends TeaModel {
    ...
    private PutInsightSelectorsResponseBody(Builder builder) {
    ...
    public static PutInsightSelectorsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PutInsightSelectorsResponseBody model) {
        ...
        public PutInsightSelectorsResponseBody build() {
            return new PutInsightSelectorsResponseBody(this);
        } 
