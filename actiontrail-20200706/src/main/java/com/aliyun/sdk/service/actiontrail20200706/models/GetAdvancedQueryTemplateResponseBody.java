...
/**
 * 
 * {@link GetAdvancedQueryTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>GetAdvancedQueryTemplateResponseBody</p>
 */
public class GetAdvancedQueryTemplateResponseBody extends TeaModel {
    ...
    private GetAdvancedQueryTemplateResponseBody(Builder builder) {
    ...
    public static GetAdvancedQueryTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAdvancedQueryTemplateResponseBody model) {
        ...
        public GetAdvancedQueryTemplateResponseBody build() {
            return new GetAdvancedQueryTemplateResponseBody(this);
        } 
