...
public class RecognizeTaxClearanceCertificateRequest extends Request {
    ...
    public static RecognizeTaxClearanceCertificateRequest create() {
    ...
    public static final class Builder extends Request.Builder<RecognizeTaxClearanceCertificateRequest, Builder> {
        private String url; 
        private java.io.InputStream body; 
        ...
        @Override
        public RecognizeTaxClearanceCertificateRequest build() {
            return new RecognizeTaxClearanceCertificateRequest(this);
        } 
