...
/**
 * {@link RecognizeJanpaneseRequest} extends {@link RequestModel}
 *
 * <p>RecognizeJanpaneseRequest</p>
 */
public class RecognizeJanpaneseRequest extends Request {
    @Query
    ...
    private RecognizeJanpaneseRequest(Builder builder) {
        super(builder);
    ...
    public static RecognizeJanpaneseRequest create() {
    ...
    public static final class Builder extends Request.Builder<RecognizeJanpaneseRequest, Builder> {
        private Boolean needRotate; 
        private Boolean outputCharInfo; 
        private Boolean outputTable; 
        private String url; 
        ...
        private Builder(RecognizeJanpaneseRequest response) {
            super(response);
        ...
        @Override
        public RecognizeJanpaneseRequest build() {
            return new RecognizeJanpaneseRequest(this);
        } 
