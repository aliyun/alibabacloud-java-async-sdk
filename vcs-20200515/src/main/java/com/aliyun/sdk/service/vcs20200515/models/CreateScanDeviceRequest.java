...
/**
 * {@link CreateScanDeviceRequest} extends {@link RequestModel}
 *
 * <p>CreateScanDeviceRequest</p>
 */
public class CreateScanDeviceRequest extends Request {
    @Body
    ...
    private CreateScanDeviceRequest(Builder builder) {
        super(builder);
    ...
    public static CreateScanDeviceRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateScanDeviceRequest, Builder> {
        private String audioEnable; 
        private String cityCode; 
        private String corpId; 
        private String dataSourceType; 
        ...
        private Builder(CreateScanDeviceRequest response) {
            super(response);
        ...
        @Override
        public CreateScanDeviceRequest build() {
            return new CreateScanDeviceRequest(this);
        } 
