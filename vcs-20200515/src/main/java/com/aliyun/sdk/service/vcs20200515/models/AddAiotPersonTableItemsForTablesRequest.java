...
/**
 * {@link AddAiotPersonTableItemsForTablesRequest} extends {@link RequestModel}
 *
 * <p>AddAiotPersonTableItemsForTablesRequest</p>
 */
public class AddAiotPersonTableItemsForTablesRequest extends Request {
    @Body
    ...
    private AddAiotPersonTableItemsForTablesRequest(Builder builder) {
        super(builder);
    ...
    public static AddAiotPersonTableItemsForTablesRequest create() {
    ...
    public static final class Builder extends Request.Builder<AddAiotPersonTableItemsForTablesRequest, Builder> {
        private java.util.List < PersonTableItemList> personTableItemList; 
        private java.util.List < PersonTableList> personTableList; 
        ...
        private Builder(AddAiotPersonTableItemsForTablesRequest response) {
            super(response);
            this.personTableItemList = response.personTableItemList;
            this.personTableList = response.personTableList;
        } 
        ...
        public Builder personTableList(java.util.List < PersonTableList> personTableList) {
            this.putBodyParameter("PersonTableList", personTableList);
            this.personTableList = personTableList;
            return this;
        }

        @Override
        public AddAiotPersonTableItemsForTablesRequest build() {
            return new AddAiotPersonTableItemsForTablesRequest(this);
        } 
