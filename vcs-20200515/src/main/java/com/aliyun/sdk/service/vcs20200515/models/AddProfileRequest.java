...
/**
 * {@link AddProfileRequest} extends {@link RequestModel}
 *
 * <p>AddProfileRequest</p>
 */
public class AddProfileRequest extends Request {
    @Body
    @NameInMap("BizId")
    ...
    private AddProfileRequest(Builder builder) {
        super(builder);
    ...
    public static AddProfileRequest create() {
    ...
    public static final class Builder extends Request.Builder<AddProfileRequest, Builder> {
        private String bizId; 
        private Long catalogId; 
        private String corpId; 
        private String faceUrl; 
        ...
        private Builder(AddProfileRequest response) {
            super(response);
