...
/**
 * {@link UpdateAiotPersonTableItemRequest} extends {@link RequestModel}
 *
 * <p>UpdateAiotPersonTableItemRequest</p>
 */
public class UpdateAiotPersonTableItemRequest extends Request {
    @Body
    @NameInMap("Id")
    ...
    private UpdateAiotPersonTableItemRequest(Builder builder) {
        super(builder);
        this.id = builder.id;
    ...
    public static UpdateAiotPersonTableItemRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateAiotPersonTableItemRequest, Builder> {
        private String id; 
        private String personTableId; 
        private PersonTableItem personTableItem; 
        ...
        private Builder(UpdateAiotPersonTableItemRequest response) {
            super(response);
            this.id = response.id;
        ...
        @Override
        public UpdateAiotPersonTableItemRequest build() {
            return new UpdateAiotPersonTableItemRequest(this);
        } 
    ...
    public static class FeatureInfo extends TeaModel {
        ...
        public static final class Builder {
             ...
             * TabIeId.
             */
            public Builder tabIeId(String tabIeId) {
