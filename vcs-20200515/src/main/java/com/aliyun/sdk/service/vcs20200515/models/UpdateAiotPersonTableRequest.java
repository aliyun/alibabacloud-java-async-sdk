...
/**
 * {@link UpdateAiotPersonTableRequest} extends {@link RequestModel}
 *
 * <p>UpdateAiotPersonTableRequest</p>
 */
public class UpdateAiotPersonTableRequest extends Request {
    @Body
    @NameInMap("Id")
    ...
    private UpdateAiotPersonTableRequest(Builder builder) {
        super(builder);
        this.id = builder.id;
    ...
    public static UpdateAiotPersonTableRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateAiotPersonTableRequest, Builder> {
        private String id; 
        private PersonTable personTable; 
        ...
        private Builder(UpdateAiotPersonTableRequest response) {
            super(response);
            this.id = response.id;
        ...
        @Override
        public UpdateAiotPersonTableRequest build() {
            return new UpdateAiotPersonTableRequest(this);
        } 
