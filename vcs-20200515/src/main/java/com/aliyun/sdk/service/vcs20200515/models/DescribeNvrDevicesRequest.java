...
/**
 * {@link DescribeNvrDevicesRequest} extends {@link RequestModel}
 *
 * <p>DescribeNvrDevicesRequest</p>
 */
public class DescribeNvrDevicesRequest extends Request {
    @Body
    ...
    private DescribeNvrDevicesRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeNvrDevicesRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeNvrDevicesRequest, Builder> {
        private String corpIdList; 
        private String deviceFilter; 
        private String nvrDeviceIdList; 
        private Long pageNum; 
        ...
        private Builder(DescribeNvrDevicesRequest response) {
            super(response);
        ...
        @Override
        public DescribeNvrDevicesRequest build() {
            return new DescribeNvrDevicesRequest(this);
        } 
