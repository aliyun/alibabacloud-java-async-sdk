...
/**
 * {@link AddAiotVehicleTableItemsRequest} extends {@link RequestModel}
 *
 * <p>AddAiotVehicleTableItemsRequest</p>
 */
public class AddAiotVehicleTableItemsRequest extends Request {
    @Body
    @NameInMap("Id")
    ...
    private AddAiotVehicleTableItemsRequest(Builder builder) {
        super(builder);
        this.id = builder.id;
    ...
    public static AddAiotVehicleTableItemsRequest create() {
    ...
    public static final class Builder extends Request.Builder<AddAiotVehicleTableItemsRequest, Builder> {
        private String id; 
        private String vehicleTableId; 
        private VehicleTableItem vehicleTableItem; 
        ...
        private Builder(AddAiotVehicleTableItemsRequest response) {
            super(response);
            this.id = response.id;
        ...
        @Override
        public AddAiotVehicleTableItemsRequest build() {
            return new AddAiotVehicleTableItemsRequest(this);
        } 
