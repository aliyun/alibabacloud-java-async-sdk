...
/**
 * 
 * {@link CreateFlashSmsAccessProfileRequest} extends {@link RequestModel}
 *
 * <p>CreateFlashSmsAccessProfileRequest</p>
 */
public class CreateFlashSmsAccessProfileRequest extends Request {
    ...
    private CreateFlashSmsAccessProfileRequest(Builder builder) {
        super(builder);
    ...
    public static CreateFlashSmsAccessProfileRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateFlashSmsAccessProfileRequest, Builder> {
        private AccessProfile accessProfile; 
        private String instanceId; 
        private String providerId; 
        ...
        private Builder(CreateFlashSmsAccessProfileRequest request) {
            super(request);
        ...
        @Override
        public CreateFlashSmsAccessProfileRequest build() {
            return new CreateFlashSmsAccessProfileRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateFlashSmsAccessProfileRequest} extends {@link TeaModel}
     *
     * <p>CreateFlashSmsAccessProfileRequest</p>
     */
