...
/**
 * 
 * {@link UpdateScriptVersionRequest} extends {@link RequestModel}
 *
 * <p>UpdateScriptVersionRequest</p>
 */
public class UpdateScriptVersionRequest extends Request {
    ...
    private UpdateScriptVersionRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateScriptVersionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateScriptVersionRequest, Builder> {
        private String instanceId; 
        private InteractionConfig interactionConfig; 
        private java.util.List<LabelConfigs> labelConfigs; 
        private String scriptId; 
        ...
        private Builder(UpdateScriptVersionRequest request) {
            super(request);
        ...
        @Override
        public UpdateScriptVersionRequest build() {
            return new UpdateScriptVersionRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateScriptVersionRequest} extends {@link TeaModel}
     *
     * <p>UpdateScriptVersionRequest</p>
     */
