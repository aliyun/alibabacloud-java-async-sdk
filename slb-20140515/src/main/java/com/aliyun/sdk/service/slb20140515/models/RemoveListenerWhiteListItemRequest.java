 ...
 */
public class RemoveListenerWhiteListItemRequest extends Request {
    @Query
    ...
    private RemoveListenerWhiteListItemRequest(Builder builder) {
        super(builder);
    ...
    public static RemoveListenerWhiteListItemRequest create() {
    ...
    public static final class Builder extends Request.Builder<RemoveListenerWhiteListItemRequest, Builder> {
        private Integer listenerPort; 
        private String listenerProtocol; 
        private String loadBalancerId; 
        private String ownerAccount; 
        ...
        @Override
        public RemoveListenerWhiteListItemRequest build() {
            return new RemoveListenerWhiteListItemRequest(this);
        } 
