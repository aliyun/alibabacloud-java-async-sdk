...
/**
 * 
 * {@link ModifyVServerGroupBackendServersResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyVServerGroupBackendServersResponseBody</p>
 */
public class ModifyVServerGroupBackendServersResponseBody extends TeaModel {
    ...
    private ModifyVServerGroupBackendServersResponseBody(Builder builder) {
    ...
    public static ModifyVServerGroupBackendServersResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyVServerGroupBackendServersResponseBody model) {
        ...
        public ModifyVServerGroupBackendServersResponseBody build() {
            return new ModifyVServerGroupBackendServersResponseBody(this);
        } 
