...
/**
 * {@link QueryPushStatByAppResponse} extends {@link TeaModel}
 *
 * <p>QueryPushStatByAppResponse</p>
 */
public class QueryPushStatByAppResponse extends Response {
    ...
    public static QueryPushStatByAppResponse create() {
    ...
    public interface Builder extends Response.Builder<QueryPushStatByAppResponse, Builder> {
        ...
        @Override
        QueryPushStatByAppResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(QueryPushStatByAppResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public QueryPushStatByAppResponse build() {
            return new QueryPushStatByAppResponse(this);
        } 
