...
/**
 * 
 * {@link GetAfterAnswerDelayPlaybackResponseBody} extends {@link TeaModel}
 *
 * <p>GetAfterAnswerDelayPlaybackResponseBody</p>
 */
public class GetAfterAnswerDelayPlaybackResponseBody extends TeaModel {
    ...
    private GetAfterAnswerDelayPlaybackResponseBody(Builder builder) {
    ...
    public static GetAfterAnswerDelayPlaybackResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAfterAnswerDelayPlaybackResponseBody model) {
            this.afterAnswerDelayPlayback = model.afterAnswerDelayPlayback;
        ...
        public GetAfterAnswerDelayPlaybackResponseBody build() {
            return new GetAfterAnswerDelayPlaybackResponseBody(this);
        } 
