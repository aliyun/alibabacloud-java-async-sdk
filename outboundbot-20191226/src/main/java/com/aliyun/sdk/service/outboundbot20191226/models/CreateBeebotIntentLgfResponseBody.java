...
/**
 * 
 * {@link CreateBeebotIntentLgfResponseBody} extends {@link TeaModel}
 *
 * <p>CreateBeebotIntentLgfResponseBody</p>
 */
public class CreateBeebotIntentLgfResponseBody extends TeaModel {
    ...
    private CreateBeebotIntentLgfResponseBody(Builder builder) {
    ...
    public static CreateBeebotIntentLgfResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateBeebotIntentLgfResponseBody model) {
        ...
        public CreateBeebotIntentLgfResponseBody build() {
            return new CreateBeebotIntentLgfResponseBody(this);
        } 
