...
/**
 * 
 * {@link DeleteBeebotIntentUserSayResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteBeebotIntentUserSayResponseBody</p>
 */
public class DeleteBeebotIntentUserSayResponseBody extends TeaModel {
    ...
    private DeleteBeebotIntentUserSayResponseBody(Builder builder) {
    ...
    public static DeleteBeebotIntentUserSayResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteBeebotIntentUserSayResponseBody model) {
        ...
        public DeleteBeebotIntentUserSayResponseBody build() {
            return new DeleteBeebotIntentUserSayResponseBody(this);
        } 
