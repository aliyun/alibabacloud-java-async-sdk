...
/**
 * 
 * {@link CreateBeebotIntentUserSayRequest} extends {@link RequestModel}
 *
 * <p>CreateBeebotIntentUserSayRequest</p>
 */
public class CreateBeebotIntentUserSayRequest extends Request {
    ...
    private CreateBeebotIntentUserSayRequest(Builder builder) {
        super(builder);
    ...
    public static CreateBeebotIntentUserSayRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateBeebotIntentUserSayRequest, Builder> {
        private String instanceId; 
        private String scriptId; 
        private UserSayDefinition userSayDefinition; 
        ...
        private Builder(CreateBeebotIntentUserSayRequest request) {
            super(request);
        ...
        @Override
        public CreateBeebotIntentUserSayRequest build() {
            return new CreateBeebotIntentUserSayRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateBeebotIntentUserSayRequest} extends {@link TeaModel}
     *
     * <p>CreateBeebotIntentUserSayRequest</p>
     */
