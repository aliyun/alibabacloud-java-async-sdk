...
/**
 * 
 * {@link ModifyScriptVoiceConfigResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyScriptVoiceConfigResponseBody</p>
 */
public class ModifyScriptVoiceConfigResponseBody extends TeaModel {
    ...
    private ModifyScriptVoiceConfigResponseBody(Builder builder) {
    ...
    public static ModifyScriptVoiceConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyScriptVoiceConfigResponseBody model) {
        ...
        public ModifyScriptVoiceConfigResponseBody build() {
            return new ModifyScriptVoiceConfigResponseBody(this);
        } 
