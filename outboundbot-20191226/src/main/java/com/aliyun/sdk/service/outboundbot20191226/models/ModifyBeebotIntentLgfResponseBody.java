...
/**
 * 
 * {@link ModifyBeebotIntentLgfResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyBeebotIntentLgfResponseBody</p>
 */
public class ModifyBeebotIntentLgfResponseBody extends TeaModel {
    ...
    private ModifyBeebotIntentLgfResponseBody(Builder builder) {
    ...
    public static ModifyBeebotIntentLgfResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyBeebotIntentLgfResponseBody model) {
        ...
        public ModifyBeebotIntentLgfResponseBody build() {
            return new ModifyBeebotIntentLgfResponseBody(this);
        } 
