...
/**
 * 
 * {@link CreateGlobalQuestionResponseBody} extends {@link TeaModel}
 *
 * <p>CreateGlobalQuestionResponseBody</p>
 */
public class CreateGlobalQuestionResponseBody extends TeaModel {
    ...
    private CreateGlobalQuestionResponseBody(Builder builder) {
    ...
    public static CreateGlobalQuestionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateGlobalQuestionResponseBody model) {
        ...
        public CreateGlobalQuestionResponseBody build() {
            return new CreateGlobalQuestionResponseBody(this);
        } 
