...
/**
 * 
 * {@link CreateDialogueFlowResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDialogueFlowResponseBody</p>
 */
public class CreateDialogueFlowResponseBody extends TeaModel {
    ...
    private CreateDialogueFlowResponseBody(Builder builder) {
    ...
    public static CreateDialogueFlowResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDialogueFlowResponseBody model) {
        ...
        public CreateDialogueFlowResponseBody build() {
            return new CreateDialogueFlowResponseBody(this);
        } 
