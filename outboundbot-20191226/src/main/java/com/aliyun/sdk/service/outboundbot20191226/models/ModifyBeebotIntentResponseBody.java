...
/**
 * 
 * {@link ModifyBeebotIntentResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyBeebotIntentResponseBody</p>
 */
public class ModifyBeebotIntentResponseBody extends TeaModel {
    ...
    private ModifyBeebotIntentResponseBody(Builder builder) {
    ...
    public static ModifyBeebotIntentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyBeebotIntentResponseBody model) {
        ...
        public ModifyBeebotIntentResponseBody build() {
            return new ModifyBeebotIntentResponseBody(this);
        } 
