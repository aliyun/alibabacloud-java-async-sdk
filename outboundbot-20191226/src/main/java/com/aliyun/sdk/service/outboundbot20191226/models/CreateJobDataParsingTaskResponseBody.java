...
/**
 * 
 * {@link CreateJobDataParsingTaskResponseBody} extends {@link TeaModel}
 *
 * <p>CreateJobDataParsingTaskResponseBody</p>
 */
public class CreateJobDataParsingTaskResponseBody extends TeaModel {
    ...
    private CreateJobDataParsingTaskResponseBody(Builder builder) {
    ...
    public static CreateJobDataParsingTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateJobDataParsingTaskResponseBody model) {
        ...
        public CreateJobDataParsingTaskResponseBody build() {
            return new CreateJobDataParsingTaskResponseBody(this);
        } 
