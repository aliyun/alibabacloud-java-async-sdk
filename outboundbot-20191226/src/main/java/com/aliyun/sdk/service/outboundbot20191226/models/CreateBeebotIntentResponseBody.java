...
/**
 * 
 * {@link CreateBeebotIntentResponseBody} extends {@link TeaModel}
 *
 * <p>CreateBeebotIntentResponseBody</p>
 */
public class CreateBeebotIntentResponseBody extends TeaModel {
    ...
    private CreateBeebotIntentResponseBody(Builder builder) {
    ...
    public static CreateBeebotIntentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateBeebotIntentResponseBody model) {
        ...
        public CreateBeebotIntentResponseBody build() {
            return new CreateBeebotIntentResponseBody(this);
        } 
