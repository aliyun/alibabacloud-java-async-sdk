...
/**
 * 
 * {@link ModifyScriptResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyScriptResponseBody</p>
 */
public class ModifyScriptResponseBody extends TeaModel {
    ...
    private ModifyScriptResponseBody(Builder builder) {
    ...
    public static ModifyScriptResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyScriptResponseBody model) {
        ...
        public ModifyScriptResponseBody build() {
            return new ModifyScriptResponseBody(this);
        } 
