...
/**
 * 
 * {@link CreateOutboundCallNumberResponseBody} extends {@link TeaModel}
 *
 * <p>CreateOutboundCallNumberResponseBody</p>
 */
public class CreateOutboundCallNumberResponseBody extends TeaModel {
    ...
    private CreateOutboundCallNumberResponseBody(Builder builder) {
    ...
    public static CreateOutboundCallNumberResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateOutboundCallNumberResponseBody model) {
        ...
        public CreateOutboundCallNumberResponseBody build() {
            return new CreateOutboundCallNumberResponseBody(this);
        } 
