...
/**
 * 
 * {@link UpdateNamespaceVpcResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateNamespaceVpcResponseBody</p>
 */
public class UpdateNamespaceVpcResponseBody extends TeaModel {
    ...
    private UpdateNamespaceVpcResponseBody(Builder builder) {
    ...
    public static UpdateNamespaceVpcResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateNamespaceVpcResponseBody model) {
        ...
        public UpdateNamespaceVpcResponseBody build() {
            return new UpdateNamespaceVpcResponseBody(this);
        } 
