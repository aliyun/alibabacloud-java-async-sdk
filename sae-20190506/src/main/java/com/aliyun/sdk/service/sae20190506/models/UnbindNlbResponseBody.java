...
/**
 * 
 * {@link UnbindNlbResponseBody} extends {@link TeaModel}
 *
 * <p>UnbindNlbResponseBody</p>
 */
public class UnbindNlbResponseBody extends TeaModel {
    ...
    private UnbindNlbResponseBody(Builder builder) {
    ...
    public static UnbindNlbResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UnbindNlbResponseBody model) {
        ...
        public UnbindNlbResponseBody build() {
            return new UnbindNlbResponseBody(this);
        } 
