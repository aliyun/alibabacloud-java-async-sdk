...
/**
 * 
 * {@link ResumeTrafficResponseBody} extends {@link TeaModel}
 *
 * <p>ResumeTrafficResponseBody</p>
 */
public class ResumeTrafficResponseBody extends TeaModel {
    ...
    private ResumeTrafficResponseBody(Builder builder) {
    ...
    public static ResumeTrafficResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResumeTrafficResponseBody model) {
        ...
        public ResumeTrafficResponseBody build() {
            return new ResumeTrafficResponseBody(this);
        } 
