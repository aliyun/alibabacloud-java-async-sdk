...
public class UpdateIngressResponseBody extends TeaModel {
    ...
    private UpdateIngressResponseBody(Builder builder) {
    ...
    public static UpdateIngressResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateIngressResponseBody model) {
        ...
        public UpdateIngressResponseBody build() {
            return new UpdateIngressResponseBody(this);
        } 
