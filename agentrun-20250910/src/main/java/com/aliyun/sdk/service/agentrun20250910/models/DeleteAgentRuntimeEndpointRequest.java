...
/**
 * 
 * {@link DeleteAgentRuntimeEndpointRequest} extends {@link RequestModel}
 *
 * <p>DeleteAgentRuntimeEndpointRequest</p>
 */
public class DeleteAgentRuntimeEndpointRequest extends Request {
    ...
    private DeleteAgentRuntimeEndpointRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteAgentRuntimeEndpointRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteAgentRuntimeEndpointRequest, Builder> {
        private String agentRuntimeId; 
        private String agentRuntimeEndpointId; 
        ...
        private Builder(DeleteAgentRuntimeEndpointRequest request) {
            super(request);
