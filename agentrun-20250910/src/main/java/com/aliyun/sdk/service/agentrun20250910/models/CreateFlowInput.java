...
/**
 * 
 * {@link CreateFlowInput} extends {@link TeaModel}
 *
 * <p>CreateFlowInput</p>
 */
public class CreateFlowInput extends TeaModel {
    ...
    private CreateFlowInput(Builder builder) {
    ...
    public static CreateFlowInput create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateFlowInput model) {
        ...
        public CreateFlowInput build() {
            return new CreateFlowInput(this);
        } 
