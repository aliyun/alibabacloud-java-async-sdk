...
/**
 * 
 * {@link ToolsetAuthorization} extends {@link TeaModel}
 *
 * <p>ToolsetAuthorization</p>
 */
public class ToolsetAuthorization extends TeaModel {
    ...
    private ToolsetAuthorization(Builder builder) {
    ...
    public static ToolsetAuthorization create() {
    ...
    public static final class Builder {
        ...
        private Builder(ToolsetAuthorization model) {
        ...
        public ToolsetAuthorization build() {
            return new ToolsetAuthorization(this);
        } 
