...
/**
 * 
 * {@link DeployVllmModelOutput} extends {@link TeaModel}
 *
 * <p>DeployVllmModelOutput</p>
 */
public class DeployVllmModelOutput extends TeaModel {
    ...
    private DeployVllmModelOutput(Builder builder) {
    ...
    public static DeployVllmModelOutput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeployVllmModelOutput model) {
        ...
        public DeployVllmModelOutput build() {
            return new DeployVllmModelOutput(this);
        } 
