...
/**
 * 
 * {@link ListToolsetsRequest} extends {@link RequestModel}
 *
 * <p>ListToolsetsRequest</p>
 */
public class ListToolsetsRequest extends Request {
    ...
    private ListToolsetsRequest(Builder builder) {
        super(builder);
    ...
    public static ListToolsetsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListToolsetsRequest, Builder> {
        private String keyword; 
        private java.util.List<String> labelSelector; 
        private Long pageNumber; 
        private Long pageSize; 
        ...
        private Builder(ListToolsetsRequest request) {
            super(request);
        ...
        @Override
        public ListToolsetsRequest build() {
