...
/**
 * 
 * {@link DeployModelScopeModelInput} extends {@link TeaModel}
 *
...
public class DeployModelScopeModelInput extends TeaModel {
    ...
    private DeployModelScopeModelInput(Builder builder) {
    ...
    public static DeployModelScopeModelInput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeployModelScopeModelInput model) {
        ...
        public DeployModelScopeModelInput build() {
            return new DeployModelScopeModelInput(this);
        } 
