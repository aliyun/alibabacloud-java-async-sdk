...
/**
 * {@link CodeupEventPayload} extends {@link TeaModel}
 *
 * <p>CodeupEventPayload</p>
 */
public class CodeupEventPayload extends TeaModel {
    ...
    private CodeupEventPayload(Builder builder) {
    ...
    public static CodeupEventPayload create() {
    ...
    public static final class Builder {
        ...
        public CodeupEventPayload build() {
            return new CodeupEventPayload(this);
        } 
