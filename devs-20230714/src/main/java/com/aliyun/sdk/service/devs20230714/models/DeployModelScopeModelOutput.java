...
/**
 * 
 * {@link DeployModelScopeModelOutput} extends {@link TeaModel}
 *
 * <p>DeployModelScopeModelOutput</p>
 */
public class DeployModelScopeModelOutput extends TeaModel {
    ...
    private DeployModelScopeModelOutput(Builder builder) {
    ...
    public static DeployModelScopeModelOutput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeployModelScopeModelOutput model) {
        ...
        public DeployModelScopeModelOutput build() {
            return new DeployModelScopeModelOutput(this);
        } 
