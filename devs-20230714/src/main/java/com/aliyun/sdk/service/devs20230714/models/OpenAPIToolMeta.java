...
/**
 * 
 * {@link OpenAPIToolMeta} extends {@link TeaModel}
 *
 * <p>OpenAPIToolMeta</p>
 */
public class OpenAPIToolMeta extends TeaModel {
    ...
    private OpenAPIToolMeta(Builder builder) {
    ...
    public static OpenAPIToolMeta create() {
    ...
    public static final class Builder {
        ...
        private Builder(OpenAPIToolMeta model) {
        ...
        public OpenAPIToolMeta build() {
            return new OpenAPIToolMeta(this);
        } 
