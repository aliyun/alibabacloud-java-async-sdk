...
public class DeployVllmModelInput extends TeaModel {
    ...
    private DeployVllmModelInput(Builder builder) {
    ...
    public static DeployVllmModelInput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeployVllmModelInput model) {
        ...
        public DeployVllmModelInput build() {
            return new DeployVllmModelInput(this);
        } 
     ...
     * <p>DeployVllmModelInput</p>
     */
    public static class FmkVllmConfig extends TeaModel {
        ...
        @com.aliyun.core.annotation.NameInMap("gpuMemoryUtilization")
        private Float gpuMemoryUtilization;

        @com.aliyun.core.annotation.NameInMap("loadFormat")
        private String loadFormat;

        @com.aliyun.core.annotation.NameInMap("maxModelLen")
        private Integer maxModelLen;

        @com.aliyun.core.annotation.NameInMap("maxParallelLoadingWorkers")
        private Integer maxParallelLoadingWorkers;
        ...
        @com.aliyun.core.annotation.NameInMap("swapSpace")
        private Integer swapSpace;

        private FmkVllmConfig(Builder builder) {
            this.apiKey = builder.apiKey;
            this.blockSize = builder.blockSize;
            this.chatTemplate = builder.chatTemplate;
            this.dtype = builder.dtype;
            this.fullTextPostfix = builder.fullTextPostfix;
            this.gpuMemoryUtilization = builder.gpuMemoryUtilization;
            this.loadFormat = builder.loadFormat;
            this.maxModelLen = builder.maxModelLen;
            this.maxParallelLoadingWorkers = builder.maxParallelLoadingWorkers;
            this.quantization = builder.quantization;
            this.servedModelName = builder.servedModelName;
            this.swapSpace = builder.swapSpace;
        }
        ...
        public static FmkVllmConfig create() {
            return builder().build();
        }
        ...
        /**
         * @return maxParallelLoadingWorkers
         */
        ...
        public static final class Builder {
            ...
            private Builder(FmkVllmConfig model) {
                ...
                this.gpuMemoryUtilization = model.gpuMemoryUtilization;
                this.loadFormat = model.loadFormat;
                this.maxModelLen = model.maxModelLen;
                this.maxParallelLoadingWorkers = model.maxParallelLoadingWorkers;
                this.quantization = model.quantization;
                this.servedModelName = model.servedModelName;
                this.swapSpace = model.swapSpace;
            } 
             ...
             */
            public Builder gpuMemoryUtilization(Float gpuMemoryUtilization) {
             ...
             * maxModelLen.
             */
            public Builder maxModelLen(Integer maxModelLen) {
             ...
             */
            public Builder maxParallelLoadingWorkers(Integer maxParallelLoadingWorkers) {
             ...
             * swapSpace.
             */
            public Builder swapSpace(Integer swapSpace) {
                this.swapSpace = swapSpace;
                return this;
            }

            public FmkVllmConfig build() {
                return new FmkVllmConfig(this);
            } 
    ...
    public static class ModelConfig extends TeaModel {
        @com.aliyun.core.annotation.NameInMap("fmkVllmConfig")
        ...
        /**
         * @return fmkVllmConfig
         */
        public FmkVllmConfig getFmkVllmConfig() {
        ...
        public static final class Builder {
            ...
            private Builder(ModelConfig model) {
                this.fmkVllmConfig = model.fmkVllmConfig;
             ...
             * fmkVllmConfig.
             */
            public Builder fmkVllmConfig(FmkVllmConfig fmkVllmConfig) {
