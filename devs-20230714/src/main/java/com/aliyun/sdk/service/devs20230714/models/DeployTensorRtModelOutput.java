...
/**
 * 
 * {@link DeployTensorRtModelOutput} extends {@link TeaModel}
 *
 * <p>DeployTensorRtModelOutput</p>
 */
public class DeployTensorRtModelOutput extends TeaModel {
    ...
    private DeployTensorRtModelOutput(Builder builder) {
    ...
    public static DeployTensorRtModelOutput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeployTensorRtModelOutput model) {
        ...
        public DeployTensorRtModelOutput build() {
            return new DeployTensorRtModelOutput(this);
        } 
