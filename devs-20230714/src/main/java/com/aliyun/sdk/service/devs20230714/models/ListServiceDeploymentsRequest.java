...
/**
 * 
 * {@link ListServiceDeploymentsRequest} extends {@link RequestModel}
 *
 * <p>ListServiceDeploymentsRequest</p>
 */
public class ListServiceDeploymentsRequest extends Request {
    ...
    private ListServiceDeploymentsRequest(Builder builder) {
        super(builder);
    ...
    public static ListServiceDeploymentsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListServiceDeploymentsRequest, Builder> {
        private String keyword; 
        private java.util.List<String> labelSelector; 
        private Long pageNumber; 
        private Long pageSize; 
        ...
        private Builder(ListServiceDeploymentsRequest request) {
            super(request);
