...
/**
 * 
 * {@link DeploySGLangModelOutput} extends {@link TeaModel}
 *
 * <p>DeploySGLangModelOutput</p>
 */
public class DeploySGLangModelOutput extends TeaModel {
    ...
    private DeploySGLangModelOutput(Builder builder) {
    ...
    public static DeploySGLangModelOutput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeploySGLangModelOutput model) {
        ...
        public DeploySGLangModelOutput build() {
            return new DeploySGLangModelOutput(this);
        } 
