...
/**
 * 
 * {@link DeployHuggingFaceModelOutput} extends {@link TeaModel}
 *
 * <p>DeployHuggingFaceModelOutput</p>
 */
public class DeployHuggingFaceModelOutput extends TeaModel {
    ...
    private DeployHuggingFaceModelOutput(Builder builder) {
    ...
    public static DeployHuggingFaceModelOutput create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeployHuggingFaceModelOutput model) {
        ...
        public DeployHuggingFaceModelOutput build() {
            return new DeployHuggingFaceModelOutput(this);
        } 
