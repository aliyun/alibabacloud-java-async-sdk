...
/**
 * 
 * {@link UpdateApplicationVersionRequest} extends {@link RequestModel}
 *
 * <p>UpdateApplicationVersionRequest</p>
 */
public class UpdateApplicationVersionRequest extends Request {
    ...
    private UpdateApplicationVersionRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateApplicationVersionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateApplicationVersionRequest, Builder> {
        private String applicationId; 
        private String businessUnitId; 
        private InteractionConfig interactionConfig; 
        private ScriptProfile scriptProfile; 
        ...
        private Builder(UpdateApplicationVersionRequest request) {
            super(request);
        ...
        @Override
        public UpdateApplicationVersionRequest build() {
            return new UpdateApplicationVersionRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateApplicationVersionRequest} extends {@link TeaModel}
     *
     * <p>UpdateApplicationVersionRequest</p>
     */
