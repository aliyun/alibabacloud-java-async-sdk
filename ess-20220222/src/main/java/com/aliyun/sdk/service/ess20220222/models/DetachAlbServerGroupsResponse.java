...
/**
 * 
 * {@link DetachAlbServerGroupsResponse} extends {@link TeaModel}
 *
 * <p>DetachAlbServerGroupsResponse</p>
 */
public class DetachAlbServerGroupsResponse extends Response {
    ...
    public static DetachAlbServerGroupsResponse create() {
    ...
    public interface Builder extends Response.Builder<DetachAlbServerGroupsResponse, Builder> {
        ...
        @Override
        DetachAlbServerGroupsResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DetachAlbServerGroupsResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DetachAlbServerGroupsResponse build() {
            return new DetachAlbServerGroupsResponse(this);
        } 
