...
/**
 * {@link DetachDBInstancesResponse} extends {@link TeaModel}
 *
 * <p>DetachDBInstancesResponse</p>
 */
public class DetachDBInstancesResponse extends Response {
    @NameInMap("headers")
    ...
    public static DetachDBInstancesResponse create() {
    ...
    public interface Builder extends Response.Builder<DetachDBInstancesResponse, Builder> {
        ...
        @Override
        DetachDBInstancesResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DetachDBInstancesResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DetachDBInstancesResponse build() {
            return new DetachDBInstancesResponse(this);
        } 
