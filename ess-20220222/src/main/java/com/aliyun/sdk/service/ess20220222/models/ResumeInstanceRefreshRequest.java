...
/**
 * 
 * {@link ResumeInstanceRefreshRequest} extends {@link RequestModel}
 *
 * <p>ResumeInstanceRefreshRequest</p>
 */
public class ResumeInstanceRefreshRequest extends Request {
    ...
    private ResumeInstanceRefreshRequest(Builder builder) {
        super(builder);
    ...
    public static ResumeInstanceRefreshRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ResumeInstanceRefreshRequest, Builder> {
        private String instanceRefreshTaskId; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(ResumeInstanceRefreshRequest request) {
            super(request);
        ...
        @Override
        public ResumeInstanceRefreshRequest build() {
            return new ResumeInstanceRefreshRequest(this);
        } 
