 ...
 */
public class CancelInstanceRefreshRequest extends Request {
    ...
    private CancelInstanceRefreshRequest(Builder builder) {
        super(builder);
    ...
    public static CancelInstanceRefreshRequest create() {
    ...
    public static final class Builder extends Request.Builder<CancelInstanceRefreshRequest, Builder> {
        private String instanceRefreshTaskId; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(CancelInstanceRefreshRequest request) {
            super(request);
        ...
        @Override
        public CancelInstanceRefreshRequest build() {
            return new CancelInstanceRefreshRequest(this);
        } 
