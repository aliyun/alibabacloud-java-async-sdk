...
/**
 * 
 * {@link QueryPredictiveMetricRequest} extends {@link RequestModel}
 *
 * <p>QueryPredictiveMetricRequest</p>
 */
public class QueryPredictiveMetricRequest extends Request {
    ...
    private QueryPredictiveMetricRequest(Builder builder) {
        super(builder);
    ...
    public static QueryPredictiveMetricRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryPredictiveMetricRequest, Builder> {
        private String endTime; 
        private String metricName; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(QueryPredictiveMetricRequest request) {
            super(request);
        ...
        @Override
        public QueryPredictiveMetricRequest build() {
            return new QueryPredictiveMetricRequest(this);
        } 
