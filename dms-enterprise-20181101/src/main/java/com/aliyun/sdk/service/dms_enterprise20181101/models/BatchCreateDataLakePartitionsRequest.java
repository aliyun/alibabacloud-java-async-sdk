...
/**
 * 
 * {@link BatchCreateDataLakePartitionsRequest} extends {@link RequestModel}
 *
 * <p>BatchCreateDataLakePartitionsRequest</p>
 */
public class BatchCreateDataLakePartitionsRequest extends Request {
    ...
    @com.aliyun.core.annotation.NameInMap("PartitionInputs")
    @com.aliyun.core.annotation.Validation(required = true)
    ...
    private BatchCreateDataLakePartitionsRequest(Builder builder) {
        super(builder);
    ...
    public static BatchCreateDataLakePartitionsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<BatchCreateDataLakePartitionsRequest, Builder> {
        private String regionId; 
        private String catalogName; 
        private String dataRegion; 
        private String dbName; 
        ...
        private Builder(BatchCreateDataLakePartitionsRequest request) {
            super(request);
        ...
        public Builder partitionInputs(java.util.List<DLPartitionInput> partitionInputs) {
            String partitionInputsShrink = shrink(partitionInputs, "PartitionInputs", "json");
            this.putBodyParameter("PartitionInputs", partitionInputsShrink);
        ...
        @Override
        public BatchCreateDataLakePartitionsRequest build() {
            return new BatchCreateDataLakePartitionsRequest(this);
        } 
