...
/**
 * 
 * {@link GetDataLakePartitionResponseBody} extends {@link TeaModel}
 *
 * <p>GetDataLakePartitionResponseBody</p>
 */
public class GetDataLakePartitionResponseBody extends TeaModel {
    ...
    private GetDataLakePartitionResponseBody(Builder builder) {
    ...
    public static GetDataLakePartitionResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetDataLakePartitionResponseBody build() {
            return new GetDataLakePartitionResponseBody(this);
        } 
