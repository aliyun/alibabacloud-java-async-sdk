...
/**
 * 
 * {@link UpdateDataLakePartitionRequest} extends {@link RequestModel}
 *
 * <p>UpdateDataLakePartitionRequest</p>
 */
public class UpdateDataLakePartitionRequest extends Request {
    ...
    private UpdateDataLakePartitionRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateDataLakePartitionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateDataLakePartitionRequest, Builder> {
        private String regionId; 
        private String catalogName; 
        private String dataRegion; 
        private String dbName; 
        ...
        private Builder(UpdateDataLakePartitionRequest request) {
            super(request);
        ...
        @Override
        public UpdateDataLakePartitionRequest build() {
            return new UpdateDataLakePartitionRequest(this);
        } 
