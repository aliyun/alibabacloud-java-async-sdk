...
/**
 * 
 * {@link CreateDataLakeTableRequest} extends {@link RequestModel}
 *
 * <p>CreateDataLakeTableRequest</p>
 */
public class CreateDataLakeTableRequest extends Request {
    ...
    private CreateDataLakeTableRequest(Builder builder) {
        super(builder);
    ...
    public static CreateDataLakeTableRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateDataLakeTableRequest, Builder> {
        private String regionId; 
        private String catalogName; 
        private String dataRegion; 
        private String dbName; 
        ...
        private Builder(CreateDataLakeTableRequest request) {
            super(request);
        ...
        @Override
        public CreateDataLakeTableRequest build() {
            return new CreateDataLakeTableRequest(this);
        } 
