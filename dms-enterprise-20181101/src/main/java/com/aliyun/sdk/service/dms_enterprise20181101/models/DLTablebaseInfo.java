...
/**
 * 
 * {@link DLTablebaseInfo} extends {@link TeaModel}
 *
 * <p>DLTablebaseInfo</p>
 */
public class DLTablebaseInfo extends TeaModel {
    ...
    private DLTablebaseInfo(Builder builder) {
    ...
    public static DLTablebaseInfo create() {
    ...
    public static final class Builder {
        ...
        private Builder(DLTablebaseInfo model) {
        ...
        public DLTablebaseInfo build() {
            return new DLTablebaseInfo(this);
        } 
