...
/**
 * 
 * {@link CreateDataTrackOrderResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDataTrackOrderResponseBody</p>
 */
public class CreateDataTrackOrderResponseBody extends TeaModel {
    ...
    private CreateDataTrackOrderResponseBody(Builder builder) {
    ...
    public static CreateDataTrackOrderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDataTrackOrderResponseBody model) {
        ...
        public CreateDataTrackOrderResponseBody build() {
            return new CreateDataTrackOrderResponseBody(this);
        } 
