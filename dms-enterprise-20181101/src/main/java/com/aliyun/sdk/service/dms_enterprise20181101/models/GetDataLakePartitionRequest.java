...
/**
 * 
 * {@link GetDataLakePartitionRequest} extends {@link RequestModel}
 *
 * <p>GetDataLakePartitionRequest</p>
 */
public class GetDataLakePartitionRequest extends Request {
    ...
    private GetDataLakePartitionRequest(Builder builder) {
        super(builder);
    ...
    public static GetDataLakePartitionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetDataLakePartitionRequest, Builder> {
        private String regionId; 
        private String catalogName; 
        private String dataRegion; 
        private String dbName; 
        ...
        private Builder(GetDataLakePartitionRequest request) {
            super(request);
        ...
        @Override
        public GetDataLakePartitionRequest build() {
            return new GetDataLakePartitionRequest(this);
        } 
