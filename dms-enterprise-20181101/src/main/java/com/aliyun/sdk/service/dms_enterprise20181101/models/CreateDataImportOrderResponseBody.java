...
/**
 * 
 * {@link CreateDataImportOrderResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDataImportOrderResponseBody</p>
 */
public class CreateDataImportOrderResponseBody extends TeaModel {
    ...
    private CreateDataImportOrderResponseBody(Builder builder) {
    ...
    public static CreateDataImportOrderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDataImportOrderResponseBody model) {
        ...
        public CreateDataImportOrderResponseBody build() {
            return new CreateDataImportOrderResponseBody(this);
        } 
