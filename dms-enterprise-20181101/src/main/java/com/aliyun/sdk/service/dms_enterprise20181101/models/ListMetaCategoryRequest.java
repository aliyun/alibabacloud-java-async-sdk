...
/**
 * 
 * {@link ListMetaCategoryRequest} extends {@link RequestModel}
 *
 * <p>ListMetaCategoryRequest</p>
 */
public class ListMetaCategoryRequest extends Request {
    ...
    private ListMetaCategoryRequest(Builder builder) {
        super(builder);
    ...
    public static ListMetaCategoryRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListMetaCategoryRequest, Builder> {
        private String regionId; 
        private Integer pageNumber; 
        private Integer pageSize; 
        private Long parentCategoryId; 
        ...
        private Builder(ListMetaCategoryRequest request) {
            super(request);
        ...
        @Override
        public ListMetaCategoryRequest build() {
            return new ListMetaCategoryRequest(this);
        } 
