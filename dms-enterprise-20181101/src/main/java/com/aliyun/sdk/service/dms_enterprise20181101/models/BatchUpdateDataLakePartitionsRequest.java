...
/**
 * 
 * {@link BatchUpdateDataLakePartitionsRequest} extends {@link RequestModel}
 *
 * <p>BatchUpdateDataLakePartitionsRequest</p>
 */
public class BatchUpdateDataLakePartitionsRequest extends Request {
    ...
    public static BatchUpdateDataLakePartitionsRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchUpdateDataLakePartitionsRequest, Builder> {
        ...
        private Builder(BatchUpdateDataLakePartitionsRequest request) {
            super(request);
        ...
        @Override
        public BatchUpdateDataLakePartitionsRequest build() {
            return new BatchUpdateDataLakePartitionsRequest(this);
        } 
