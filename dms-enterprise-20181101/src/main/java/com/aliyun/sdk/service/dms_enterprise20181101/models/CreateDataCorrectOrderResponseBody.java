...
/**
 * 
 * {@link CreateDataCorrectOrderResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDataCorrectOrderResponseBody</p>
 */
public class CreateDataCorrectOrderResponseBody extends TeaModel {
    ...
    private CreateDataCorrectOrderResponseBody(Builder builder) {
    ...
    public static CreateDataCorrectOrderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDataCorrectOrderResponseBody model) {
        ...
        public CreateDataCorrectOrderResponseBody build() {
            return new CreateDataCorrectOrderResponseBody(this);
        } 
