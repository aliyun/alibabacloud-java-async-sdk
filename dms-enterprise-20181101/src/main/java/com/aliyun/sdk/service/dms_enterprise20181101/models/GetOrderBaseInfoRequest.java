...
/**
 * 
 * {@link GetOrderBaseInfoRequest} extends {@link RequestModel}
 *
...
public class GetOrderBaseInfoRequest extends Request {
    ...
    public static GetOrderBaseInfoRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetOrderBaseInfoRequest, Builder> {
        ...
        @Override
        public GetOrderBaseInfoRequest build() {
            return new GetOrderBaseInfoRequest(this);
        } 
