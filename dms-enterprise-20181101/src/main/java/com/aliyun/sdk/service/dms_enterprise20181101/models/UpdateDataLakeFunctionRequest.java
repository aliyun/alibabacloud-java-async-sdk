...
/**
 * 
 * {@link UpdateDataLakeFunctionRequest} extends {@link RequestModel}
 *
 * <p>UpdateDataLakeFunctionRequest</p>
 */
public class UpdateDataLakeFunctionRequest extends Request {
    ...
    private UpdateDataLakeFunctionRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateDataLakeFunctionRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateDataLakeFunctionRequest, Builder> {
        private String regionId; 
        private String catalogName; 
        private String dataRegion; 
        private String dbName; 
        ...
        private Builder(UpdateDataLakeFunctionRequest request) {
            super(request);
        ...
        @Override
        public UpdateDataLakeFunctionRequest build() {
            return new UpdateDataLakeFunctionRequest(this);
        } 
