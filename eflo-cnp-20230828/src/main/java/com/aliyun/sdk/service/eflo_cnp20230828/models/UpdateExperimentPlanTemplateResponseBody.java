...
/**
 * 
 * {@link UpdateExperimentPlanTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateExperimentPlanTemplateResponseBody</p>
 */
public class UpdateExperimentPlanTemplateResponseBody extends TeaModel {
    ...
    private UpdateExperimentPlanTemplateResponseBody(Builder builder) {
    ...
    public static UpdateExperimentPlanTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateExperimentPlanTemplateResponseBody model) {
        ...
        public UpdateExperimentPlanTemplateResponseBody build() {
            return new UpdateExperimentPlanTemplateResponseBody(this);
        } 
