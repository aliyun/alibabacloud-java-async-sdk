...
/**
 * 
 * {@link GetExperimentPlanTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>GetExperimentPlanTemplateResponseBody</p>
 */
public class GetExperimentPlanTemplateResponseBody extends TeaModel {
    ...
    private GetExperimentPlanTemplateResponseBody(Builder builder) {
    ...
    public static GetExperimentPlanTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetExperimentPlanTemplateResponseBody model) {
        ...
        public GetExperimentPlanTemplateResponseBody build() {
            return new GetExperimentPlanTemplateResponseBody(this);
        } 
