...
/**
 * {@link ListBotChatHistorysResponseBody} extends {@link TeaModel}
 *
 * <p>ListBotChatHistorysResponseBody</p>
 */
public class ListBotChatHistorysResponseBody extends TeaModel {
    ...
    private ListBotChatHistorysResponseBody(Builder builder) {
    ...
    public static ListBotChatHistorysResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListBotChatHistorysResponseBody build() {
            return new ListBotChatHistorysResponseBody(this);
        } 
