...
/**
 * {@link GetBotDsStatDataResponseBody} extends {@link TeaModel}
 *
 * <p>GetBotDsStatDataResponseBody</p>
 */
public class GetBotDsStatDataResponseBody extends TeaModel {
    ...
    private GetBotDsStatDataResponseBody(Builder builder) {
    ...
    public static GetBotDsStatDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetBotDsStatDataResponseBody build() {
            return new GetBotDsStatDataResponseBody(this);
        } 
