...
/**
 * {@link ListBotHotDsDatasResponseBody} extends {@link TeaModel}
 *
 * <p>ListBotHotDsDatasResponseBody</p>
 */
public class ListBotHotDsDatasResponseBody extends TeaModel {
    ...
    private ListBotHotDsDatasResponseBody(Builder builder) {
    ...
    public static ListBotHotDsDatasResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListBotHotDsDatasResponseBody build() {
            return new ListBotHotDsDatasResponseBody(this);
        } 
