...
/**
 * 
 * {@link StartOfflineTaskResponseBody} extends {@link TeaModel}
 *
 * <p>StartOfflineTaskResponseBody</p>
 */
public class StartOfflineTaskResponseBody extends TeaModel {
    ...
    private StartOfflineTaskResponseBody(Builder builder) {
    ...
    public static StartOfflineTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartOfflineTaskResponseBody model) {
        ...
        public StartOfflineTaskResponseBody build() {
            return new StartOfflineTaskResponseBody(this);
        } 
