...
/**
 * 
 * {@link GetOfflineTaskResponseBody} extends {@link TeaModel}
 *
 * <p>GetOfflineTaskResponseBody</p>
 */
public class GetOfflineTaskResponseBody extends TeaModel {
    ...
    private GetOfflineTaskResponseBody(Builder builder) {
    ...
    public static GetOfflineTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetOfflineTaskResponseBody model) {
        ...
        public GetOfflineTaskResponseBody build() {
            return new GetOfflineTaskResponseBody(this);
        } 
