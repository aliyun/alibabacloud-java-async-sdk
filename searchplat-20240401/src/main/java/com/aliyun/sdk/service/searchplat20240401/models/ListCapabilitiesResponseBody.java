...
/**
 * 
 * {@link ListCapabilitiesResponseBody} extends {@link TeaModel}
 *
 * <p>ListCapabilitiesResponseBody</p>
 */
public class ListCapabilitiesResponseBody extends TeaModel {
    ...
    private ListCapabilitiesResponseBody(Builder builder) {
    ...
    public static ListCapabilitiesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListCapabilitiesResponseBody model) {
        ...
        public ListCapabilitiesResponseBody build() {
            return new ListCapabilitiesResponseBody(this);
        } 
