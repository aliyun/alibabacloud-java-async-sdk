...
/**
 * 
 * {@link StopOfflineTaskResponseBody} extends {@link TeaModel}
 *
 * <p>StopOfflineTaskResponseBody</p>
 */
public class StopOfflineTaskResponseBody extends TeaModel {
    ...
    private StopOfflineTaskResponseBody(Builder builder) {
    ...
    public static StopOfflineTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StopOfflineTaskResponseBody model) {
        ...
        public StopOfflineTaskResponseBody build() {
            return new StopOfflineTaskResponseBody(this);
        } 
