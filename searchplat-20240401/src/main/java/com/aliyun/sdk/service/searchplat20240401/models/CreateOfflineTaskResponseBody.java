...
/**
 * 
 * {@link CreateOfflineTaskResponseBody} extends {@link TeaModel}
 *
 * <p>CreateOfflineTaskResponseBody</p>
 */
public class CreateOfflineTaskResponseBody extends TeaModel {
    ...
    private CreateOfflineTaskResponseBody(Builder builder) {
    ...
    public static CreateOfflineTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateOfflineTaskResponseBody model) {
        ...
        public CreateOfflineTaskResponseBody build() {
            return new CreateOfflineTaskResponseBody(this);
        } 
