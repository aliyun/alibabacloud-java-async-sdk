...
/**
 * {@link QueryDevicePictureFileResponseBody} extends {@link TeaModel}
 *
 * <p>QueryDevicePictureFileResponseBody</p>
 */
public class QueryDevicePictureFileResponseBody extends TeaModel {
    ...
    private QueryDevicePictureFileResponseBody(Builder builder) {
    ...
    public static QueryDevicePictureFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryDevicePictureFileResponseBody build() {
            return new QueryDevicePictureFileResponseBody(this);
        } 
