...
/**
 * {@link DeployModelBatchRequest} extends {@link RequestModel}
 *
 * <p>DeployModelBatchRequest</p>
 */
public class DeployModelBatchRequest extends Request {
    @Query
    ...
    private DeployModelBatchRequest(Builder builder) {
        super(builder);
    ...
    public static DeployModelBatchRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeployModelBatchRequest, Builder> {
        private java.util.List < DeviceList> deviceList; 
        private Long modelId; 
        ...
        private Builder(DeployModelBatchRequest response) {
            super(response);
        ...
        @Override
        public DeployModelBatchRequest build() {
            return new DeployModelBatchRequest(this);
        } 
