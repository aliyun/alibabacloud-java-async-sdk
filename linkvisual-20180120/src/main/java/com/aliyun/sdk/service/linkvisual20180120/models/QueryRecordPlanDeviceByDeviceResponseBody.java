...
/**
 * {@link QueryRecordPlanDeviceByDeviceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryRecordPlanDeviceByDeviceResponseBody</p>
 */
public class QueryRecordPlanDeviceByDeviceResponseBody extends TeaModel {
    ...
    private QueryRecordPlanDeviceByDeviceResponseBody(Builder builder) {
    ...
    public static QueryRecordPlanDeviceByDeviceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryRecordPlanDeviceByDeviceResponseBody build() {
            return new QueryRecordPlanDeviceByDeviceResponseBody(this);
        } 
