...
/**
 * {@link QueryEventRecordPlanDetailResponseBody} extends {@link TeaModel}
 *
 * <p>QueryEventRecordPlanDetailResponseBody</p>
 */
public class QueryEventRecordPlanDetailResponseBody extends TeaModel {
    ...
    private QueryEventRecordPlanDetailResponseBody(Builder builder) {
    ...
    public static QueryEventRecordPlanDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryEventRecordPlanDetailResponseBody build() {
            return new QueryEventRecordPlanDetailResponseBody(this);
        } 
