...
/**
 * {@link QueryRecordPlanDetailResponseBody} extends {@link TeaModel}
 *
 * <p>QueryRecordPlanDetailResponseBody</p>
 */
public class QueryRecordPlanDetailResponseBody extends TeaModel {
    ...
    private QueryRecordPlanDetailResponseBody(Builder builder) {
    ...
    public static QueryRecordPlanDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryRecordPlanDetailResponseBody build() {
            return new QueryRecordPlanDetailResponseBody(this);
        } 
