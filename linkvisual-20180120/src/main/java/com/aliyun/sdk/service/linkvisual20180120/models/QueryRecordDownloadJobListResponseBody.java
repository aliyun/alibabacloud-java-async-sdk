...
/**
 * {@link QueryRecordDownloadJobListResponseBody} extends {@link TeaModel}
 *
 * <p>QueryRecordDownloadJobListResponseBody</p>
 */
public class QueryRecordDownloadJobListResponseBody extends TeaModel {
    ...
    private QueryRecordDownloadJobListResponseBody(Builder builder) {
    ...
    public static QueryRecordDownloadJobListResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryRecordDownloadJobListResponseBody build() {
            return new QueryRecordDownloadJobListResponseBody(this);
        } 
