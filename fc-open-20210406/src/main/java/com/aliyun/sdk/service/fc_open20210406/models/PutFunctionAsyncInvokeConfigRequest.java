...
public class PutFunctionAsyncInvokeConfigRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<PutFunctionAsyncInvokeConfigRequest, Builder> {
        ...
        /**
         * Optional. The maximum number of retries after the asynchronous invocation fails. Valid values: \[0,8]. If you do not configure this parameter, the default number of retries is 3.
         */
