...
public class ListStatefulAsyncInvocationsResponse extends Response {
    ...
    private ListStatefulAsyncInvocationsResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ListStatefulAsyncInvocationsResponse, Builder> {
        ...
        Builder body(ListStatefulAsyncInvocationsResponseBody body);

        @Override
        ListStatefulAsyncInvocationsResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ListStatefulAsyncInvocationsResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ListStatefulAsyncInvocationsResponseBody body; 
        ...
        private BuilderImpl(ListStatefulAsyncInvocationsResponse response) {
            super(response);
