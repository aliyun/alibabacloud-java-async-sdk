...
public class PermanentDeleteLayerVersionRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<PermanentDeleteLayerVersionRequest, Builder> {
        private String userID; 
        private String layerName; 
        private String version; 
        private String accountID; 
        ...
        private Builder(PermanentDeleteLayerVersionRequest response) {
            super(response);
