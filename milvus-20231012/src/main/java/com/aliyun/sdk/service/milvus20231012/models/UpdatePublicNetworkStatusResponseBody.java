...
/**
 * 
 * {@link UpdatePublicNetworkStatusResponseBody} extends {@link TeaModel}
 *
 * <p>UpdatePublicNetworkStatusResponseBody</p>
 */
public class UpdatePublicNetworkStatusResponseBody extends TeaModel {
    ...
    private UpdatePublicNetworkStatusResponseBody(Builder builder) {
    ...
    public static UpdatePublicNetworkStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdatePublicNetworkStatusResponseBody model) {
        ...
        public UpdatePublicNetworkStatusResponseBody build() {
            return new UpdatePublicNetworkStatusResponseBody(this);
        } 
