...
/**
 * 
 * {@link ListCaCertificateRequest} extends {@link RequestModel}
 *
 * <p>ListCaCertificateRequest</p>
 */
public class ListCaCertificateRequest extends Request {
    ...
    private ListCaCertificateRequest(Builder builder) {
        super(builder);
    ...
    public static ListCaCertificateRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListCaCertificateRequest, Builder> {
        private String mqttInstanceId; 
        private String pageNo; 
        private String pageSize; 
        ...
        private Builder(ListCaCertificateRequest request) {
            super(request);
        ...
        @Override
        public ListCaCertificateRequest build() {
            return new ListCaCertificateRequest(this);
        } 
