...
public class AddCustomAuthConnectBlackResponseBody extends TeaModel {
    ...
    private AddCustomAuthConnectBlackResponseBody(Builder builder) {
    ...
    public static AddCustomAuthConnectBlackResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddCustomAuthConnectBlackResponseBody model) {
        ...
        public AddCustomAuthConnectBlackResponseBody build() {
            return new AddCustomAuthConnectBlackResponseBody(this);
        } 
