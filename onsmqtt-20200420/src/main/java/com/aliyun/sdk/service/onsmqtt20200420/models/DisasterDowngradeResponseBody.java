...
/**
 * 
 * {@link DisasterDowngradeResponseBody} extends {@link TeaModel}
 *
 * <p>DisasterDowngradeResponseBody</p>
 */
public class DisasterDowngradeResponseBody extends TeaModel {
    ...
    private DisasterDowngradeResponseBody(Builder builder) {
    ...
    public static DisasterDowngradeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DisasterDowngradeResponseBody model) {
        ...
        public DisasterDowngradeResponseBody build() {
            return new DisasterDowngradeResponseBody(this);
        } 
