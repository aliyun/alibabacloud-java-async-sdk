...
/**
 * 
 * {@link ListAggregateRecommendManagedRulesRequest} extends {@link RequestModel}
 *
 * <p>ListAggregateRecommendManagedRulesRequest</p>
 */
public class ListAggregateRecommendManagedRulesRequest extends Request {
    ...
    private ListAggregateRecommendManagedRulesRequest(Builder builder) {
        super(builder);
    ...
    public static ListAggregateRecommendManagedRulesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListAggregateRecommendManagedRulesRequest, Builder> {
        private String aggregatorId; 
        private String excludeRegionIdsScope; 
        private String excludeResourceGroupIdsScope; 
        private String excludeResourceIdsScope; 
        ...
        private Builder(ListAggregateRecommendManagedRulesRequest request) {
            super(request);
        ...
        @Override
        public ListAggregateRecommendManagedRulesRequest build() {
            return new ListAggregateRecommendManagedRulesRequest(this);
        } 
