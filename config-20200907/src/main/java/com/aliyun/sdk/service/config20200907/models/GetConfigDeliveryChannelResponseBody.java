...
/**
 * 
 * {@link GetConfigDeliveryChannelResponseBody} extends {@link TeaModel}
 *
 * <p>GetConfigDeliveryChannelResponseBody</p>
 */
public class GetConfigDeliveryChannelResponseBody extends TeaModel {
    ...
    private GetConfigDeliveryChannelResponseBody(Builder builder) {
    ...
    public static GetConfigDeliveryChannelResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetConfigDeliveryChannelResponseBody model) {
        ...
        public GetConfigDeliveryChannelResponseBody build() {
            return new GetConfigDeliveryChannelResponseBody(this);
        } 
