...
/**
 * 
 * {@link ListRecommendManagedRulesResponseBody} extends {@link TeaModel}
 *
 * <p>ListRecommendManagedRulesResponseBody</p>
 */
public class ListRecommendManagedRulesResponseBody extends TeaModel {
    ...
    private ListRecommendManagedRulesResponseBody(Builder builder) {
    ...
    public static ListRecommendManagedRulesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListRecommendManagedRulesResponseBody model) {
        ...
        public ListRecommendManagedRulesResponseBody build() {
            return new ListRecommendManagedRulesResponseBody(this);
        } 
