...
public class GetResourceComplianceByPackResponseBody extends TeaModel {
    ...
    private GetResourceComplianceByPackResponseBody(Builder builder) {
    ...
    public static GetResourceComplianceByPackResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetResourceComplianceByPackResponseBody model) {
        ...
        public GetResourceComplianceByPackResponseBody build() {
            return new GetResourceComplianceByPackResponseBody(this);
        } 
