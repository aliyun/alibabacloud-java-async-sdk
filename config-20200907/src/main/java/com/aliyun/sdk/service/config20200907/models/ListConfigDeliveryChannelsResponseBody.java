...
/**
 * 
 * {@link ListConfigDeliveryChannelsResponseBody} extends {@link TeaModel}
 *
 * <p>ListConfigDeliveryChannelsResponseBody</p>
 */
public class ListConfigDeliveryChannelsResponseBody extends TeaModel {
    ...
    private ListConfigDeliveryChannelsResponseBody(Builder builder) {
    ...
    public static ListConfigDeliveryChannelsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListConfigDeliveryChannelsResponseBody build() {
            return new ListConfigDeliveryChannelsResponseBody(this);
        } 
