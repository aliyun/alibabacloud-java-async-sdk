...
public class GetAggregateResourceComplianceGroupByResourceTypeResponseBody extends TeaModel {
    ...
    public static GetAggregateResourceComplianceGroupByResourceTypeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAggregateResourceComplianceGroupByResourceTypeResponseBody model) {
        ...
        public GetAggregateResourceComplianceGroupByResourceTypeResponseBody build() {
            return new GetAggregateResourceComplianceGroupByResourceTypeResponseBody(this);
        } 
