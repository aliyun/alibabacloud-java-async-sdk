...
public class DetachAggregateConfigRuleToCompliancePackResponseBody extends TeaModel {
    ...
    private DetachAggregateConfigRuleToCompliancePackResponseBody(Builder builder) {
    ...
    public static DetachAggregateConfigRuleToCompliancePackResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DetachAggregateConfigRuleToCompliancePackResponseBody model) {
        ...
        public DetachAggregateConfigRuleToCompliancePackResponseBody build() {
            return new DetachAggregateConfigRuleToCompliancePackResponseBody(this);
        } 
