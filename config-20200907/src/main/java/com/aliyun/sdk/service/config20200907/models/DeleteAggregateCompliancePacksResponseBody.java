...
public class DeleteAggregateCompliancePacksResponseBody extends TeaModel {
    ...
    public static DeleteAggregateCompliancePacksResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteAggregateCompliancePacksResponseBody build() {
            return new DeleteAggregateCompliancePacksResponseBody(this);
        } 
