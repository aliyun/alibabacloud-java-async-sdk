...
/**
 * 
 * {@link OfflineRecallManagementServiceRequest} extends {@link RequestModel}
 *
 * <p>OfflineRecallManagementServiceRequest</p>
 */
public class OfflineRecallManagementServiceRequest extends Request {
    ...
    private OfflineRecallManagementServiceRequest(Builder builder) {
        super(builder);
    ...
    public static OfflineRecallManagementServiceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<OfflineRecallManagementServiceRequest, Builder> {
        private String recallManagementServiceId; 
        private String regionId; 
        private String instanceId; 
        ...
        private Builder(OfflineRecallManagementServiceRequest request) {
            super(request);
        ...
        @Override
        public OfflineRecallManagementServiceRequest build() {
            return new OfflineRecallManagementServiceRequest(this);
        } 
