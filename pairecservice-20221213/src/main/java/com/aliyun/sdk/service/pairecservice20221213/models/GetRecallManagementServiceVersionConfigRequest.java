...
/**
 * 
 * {@link GetRecallManagementServiceVersionConfigRequest} extends {@link RequestModel}
 *
 * <p>GetRecallManagementServiceVersionConfigRequest</p>
 */
public class GetRecallManagementServiceVersionConfigRequest extends Request {
    ...
    private GetRecallManagementServiceVersionConfigRequest(Builder builder) {
        super(builder);
    ...
    public static GetRecallManagementServiceVersionConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetRecallManagementServiceVersionConfigRequest, Builder> {
        private String recallManagementServiceId; 
        private String recallManagementServiceVersionId; 
        private String recallManagementServiceVersionConfigId; 
        private String regionId; 
        ...
        private Builder(GetRecallManagementServiceVersionConfigRequest request) {
            super(request);
        ...
        @Override
        public GetRecallManagementServiceVersionConfigRequest build() {
            return new GetRecallManagementServiceVersionConfigRequest(this);
        } 
