...
/**
 * 
 * {@link GetRecallManagementTableRequest} extends {@link RequestModel}
 *
 * <p>GetRecallManagementTableRequest</p>
 */
public class GetRecallManagementTableRequest extends Request {
    ...
    private GetRecallManagementTableRequest(Builder builder) {
        super(builder);
    ...
    public static GetRecallManagementTableRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetRecallManagementTableRequest, Builder> {
        private String recallManagementTableId; 
        private String regionId; 
        private String instanceId; 
        ...
        private Builder(GetRecallManagementTableRequest request) {
            super(request);
        ...
        @Override
        public GetRecallManagementTableRequest build() {
            return new GetRecallManagementTableRequest(this);
        } 
