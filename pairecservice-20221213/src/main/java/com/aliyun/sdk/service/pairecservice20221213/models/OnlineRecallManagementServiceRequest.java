...
/**
 * 
 * {@link OnlineRecallManagementServiceRequest} extends {@link RequestModel}
 *
 * <p>OnlineRecallManagementServiceRequest</p>
 */
public class OnlineRecallManagementServiceRequest extends Request {
    ...
    private OnlineRecallManagementServiceRequest(Builder builder) {
        super(builder);
    ...
    public static OnlineRecallManagementServiceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<OnlineRecallManagementServiceRequest, Builder> {
        private String recallManagementServiceId; 
        private String regionId; 
        private String instanceId; 
        ...
        private Builder(OnlineRecallManagementServiceRequest request) {
            super(request);
        ...
        @Override
        public OnlineRecallManagementServiceRequest build() {
            return new OnlineRecallManagementServiceRequest(this);
        } 
