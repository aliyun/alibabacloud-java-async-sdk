...
/**
 * 
 * {@link DeleteRecallManagementServiceVersionRequest} extends {@link RequestModel}
 *
 * <p>DeleteRecallManagementServiceVersionRequest</p>
 */
public class DeleteRecallManagementServiceVersionRequest extends Request {
    ...
    private DeleteRecallManagementServiceVersionRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteRecallManagementServiceVersionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteRecallManagementServiceVersionRequest, Builder> {
        private String recallManagementServiceId; 
        private String recallManagementServiceVersionId; 
        private String regionId; 
        private String instanceId; 
        ...
        private Builder(DeleteRecallManagementServiceVersionRequest request) {
            super(request);
        ...
        @Override
        public DeleteRecallManagementServiceVersionRequest build() {
            return new DeleteRecallManagementServiceVersionRequest(this);
        } 
