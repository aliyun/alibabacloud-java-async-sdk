...
/**
 * 
 * {@link StopTrafficControlTargetRequest} extends {@link RequestModel}
 *
 * <p>StopTrafficControlTargetRequest</p>
 */
public class StopTrafficControlTargetRequest extends Request {
    ...
    private StopTrafficControlTargetRequest(Builder builder) {
        super(builder);
    ...
    public static StopTrafficControlTargetRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<StopTrafficControlTargetRequest, Builder> {
        private String trafficControlTargetId; 
        private String regionId; 
        private String instanceId; 
        ...
        private Builder(StopTrafficControlTargetRequest request) {
            super(request);
        ...
        @Override
        public StopTrafficControlTargetRequest build() {
            return new StopTrafficControlTargetRequest(this);
        } 
