...
/**
 * 
 * {@link GetSampleConsistencyJobResponseBody} extends {@link TeaModel}
 *
 * <p>GetSampleConsistencyJobResponseBody</p>
 */
public class GetSampleConsistencyJobResponseBody extends TeaModel {
    ...
    private GetSampleConsistencyJobResponseBody(Builder builder) {
    ...
    public static GetSampleConsistencyJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetSampleConsistencyJobResponseBody model) {
        ...
        public GetSampleConsistencyJobResponseBody build() {
            return new GetSampleConsistencyJobResponseBody(this);
        } 
