...
/**
 * 
 * {@link PushResourceRuleResponseBody} extends {@link TeaModel}
 *
 * <p>PushResourceRuleResponseBody</p>
 */
public class PushResourceRuleResponseBody extends TeaModel {
    ...
    private PushResourceRuleResponseBody(Builder builder) {
    ...
    public static PushResourceRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PushResourceRuleResponseBody model) {
        ...
        public PushResourceRuleResponseBody build() {
            return new PushResourceRuleResponseBody(this);
        } 
