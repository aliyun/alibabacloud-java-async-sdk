...
/**
 * {@link InsertUnbeianIpCheckTypeResponseBody} extends {@link TeaModel}
 *
 * <p>InsertUnbeianIpCheckTypeResponseBody</p>
 */
public class InsertUnbeianIpCheckTypeResponseBody extends TeaModel {
    ...
    private InsertUnbeianIpCheckTypeResponseBody(Builder builder) {
    ...
    public static InsertUnbeianIpCheckTypeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public InsertUnbeianIpCheckTypeResponseBody build() {
            return new InsertUnbeianIpCheckTypeResponseBody(this);
        } 
