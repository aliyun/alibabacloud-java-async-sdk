 ...
 */
public class DescribeSslVpnClientCertRequest extends Request {
    @Query
    ...
    private DescribeSslVpnClientCertRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSslVpnClientCertRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeSslVpnClientCertRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        @Override
        public DescribeSslVpnClientCertRequest build() {
            return new DescribeSslVpnClientCertRequest(this);
        } 
