 ...
 */
public class ModifyGlobalAccelerationInstanceSpecRequest extends Request {
    @Query
    @NameInMap("Bandwidth")
    ...
    private ModifyGlobalAccelerationInstanceSpecRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyGlobalAccelerationInstanceSpecRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyGlobalAccelerationInstanceSpecRequest, Builder> {
        private String bandwidth; 
        private String globalAccelerationInstanceId; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ModifyGlobalAccelerationInstanceSpecRequest response) {
            super(response);
        ...
        @Override
        public ModifyGlobalAccelerationInstanceSpecRequest build() {
            return new ModifyGlobalAccelerationInstanceSpecRequest(this);
        } 
