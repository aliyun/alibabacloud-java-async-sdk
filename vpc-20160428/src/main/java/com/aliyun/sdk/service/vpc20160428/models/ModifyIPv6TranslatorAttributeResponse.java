...
/**
 * 
 * {@link ModifyIPv6TranslatorAttributeResponse} extends {@link TeaModel}
 *
 * <p>ModifyIPv6TranslatorAttributeResponse</p>
 */
public class ModifyIPv6TranslatorAttributeResponse extends Response {
    ...
    public static ModifyIPv6TranslatorAttributeResponse create() {
    ...
    public interface Builder extends Response.Builder<ModifyIPv6TranslatorAttributeResponse, Builder> {
        ...
        @Override
        ModifyIPv6TranslatorAttributeResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(ModifyIPv6TranslatorAttributeResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public ModifyIPv6TranslatorAttributeResponse build() {
            return new ModifyIPv6TranslatorAttributeResponse(this);
        } 
