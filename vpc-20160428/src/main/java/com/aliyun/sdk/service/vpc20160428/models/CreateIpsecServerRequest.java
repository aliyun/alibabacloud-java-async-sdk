...
public class CreateIpsecServerRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<CreateIpsecServerRequest, Builder> {
         ...
         * 
         * If you do not specify a pre-shared key, the system randomly generates a 16-character string as the pre-shared key. You can call the [ListIpsecServers](~~2794120~~) operation to query the pre-shared keys that are generated by the system.
         * 
