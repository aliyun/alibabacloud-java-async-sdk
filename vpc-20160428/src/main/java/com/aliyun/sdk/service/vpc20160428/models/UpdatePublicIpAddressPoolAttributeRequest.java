...
/**
 * 
 * {@link UpdatePublicIpAddressPoolAttributeRequest} extends {@link RequestModel}
 *
 * <p>UpdatePublicIpAddressPoolAttributeRequest</p>
 */
public class UpdatePublicIpAddressPoolAttributeRequest extends Request {
    ...
    private UpdatePublicIpAddressPoolAttributeRequest(Builder builder) {
        super(builder);
    ...
    public static UpdatePublicIpAddressPoolAttributeRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdatePublicIpAddressPoolAttributeRequest, Builder> {
        private String clientToken; 
        private String description; 
        private Boolean dryRun; 
        private String name; 
        ...
        private Builder(UpdatePublicIpAddressPoolAttributeRequest request) {
            super(request);
        ...
        public UpdatePublicIpAddressPoolAttributeRequest build() {
            return new UpdatePublicIpAddressPoolAttributeRequest(this);
        } 
