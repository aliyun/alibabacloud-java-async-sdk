...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteTrafficMirrorFilterRulesRequest, Builder> {
         ...
         * </li>
         * <li><p><strong>false</strong> (default): performs a dry run and sends the request. If the request passes the dry run, inbound or outbound rules are deleted.</p>
         * </li>
         * </ul>
         * 
         * <strong>example:</strong>
        ...
        /**
         * <p>The instance IDs of the inbound or outbound rules.</p>
         * <p>This parameter is required.</p>
         * 
         * <strong>example:</strong>
