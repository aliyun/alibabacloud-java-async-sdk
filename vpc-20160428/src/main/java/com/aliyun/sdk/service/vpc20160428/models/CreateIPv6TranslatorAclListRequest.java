 ...
 */
public class CreateIPv6TranslatorAclListRequest extends Request {
    ...
    private CreateIPv6TranslatorAclListRequest(Builder builder) {
        super(builder);
    ...
    public static CreateIPv6TranslatorAclListRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateIPv6TranslatorAclListRequest, Builder> {
        private String aclName; 
        private String clientToken; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        @Override
        public CreateIPv6TranslatorAclListRequest build() {
            return new CreateIPv6TranslatorAclListRequest(this);
        } 
