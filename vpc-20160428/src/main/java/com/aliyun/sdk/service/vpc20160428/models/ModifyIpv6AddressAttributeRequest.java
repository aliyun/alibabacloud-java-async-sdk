...
public class ModifyIpv6AddressAttributeRequest extends Request {
    ...
    public static ModifyIpv6AddressAttributeRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyIpv6AddressAttributeRequest, Builder> {
        ...
        private Builder(ModifyIpv6AddressAttributeRequest response) {
            super(response);
        ...
        @Override
        public ModifyIpv6AddressAttributeRequest build() {
            return new ModifyIpv6AddressAttributeRequest(this);
        } 
