...
public class UpdateVirtualBorderBandwidthResponseBody extends TeaModel {
    ...
    public static UpdateVirtualBorderBandwidthResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateVirtualBorderBandwidthResponseBody model) {
        ...
        public UpdateVirtualBorderBandwidthResponseBody build() {
            return new UpdateVirtualBorderBandwidthResponseBody(this);
        } 
