...
public class CreateVpnRouteEntryResponseBody extends TeaModel {
    ...
    public static final class Builder {
         ...
         * <p>The timestamp follows the UNIX time format, which represents the total number of milliseconds that have elapsed since January 1, 1970, 00:00:00 UTC, to the time when the destination route was created.</p>
         * 
