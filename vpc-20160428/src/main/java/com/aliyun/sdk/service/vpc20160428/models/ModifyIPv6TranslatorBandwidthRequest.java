 ...
 */
public class ModifyIPv6TranslatorBandwidthRequest extends Request {
    ...
    private ModifyIPv6TranslatorBandwidthRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyIPv6TranslatorBandwidthRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyIPv6TranslatorBandwidthRequest, Builder> {
        private Boolean autoPay; 
        private Integer bandwidth; 
        private String clientToken; 
        private String ipv6TranslatorId; 
        ...
        @Override
        public ModifyIPv6TranslatorBandwidthRequest build() {
            return new ModifyIPv6TranslatorBandwidthRequest(this);
        } 
