...
/**
 * {@link ModifyCommonBandwidthPackageSpecResponse} extends {@link TeaModel}
 *
 * <p>ModifyCommonBandwidthPackageSpecResponse</p>
 */
public class ModifyCommonBandwidthPackageSpecResponse extends Response {
    @NameInMap("headers")
    ...
    public static ModifyCommonBandwidthPackageSpecResponse create() {
    ...
    public interface Builder extends Response.Builder<ModifyCommonBandwidthPackageSpecResponse, Builder> {
        ...
        @Override
        ModifyCommonBandwidthPackageSpecResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(ModifyCommonBandwidthPackageSpecResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public ModifyCommonBandwidthPackageSpecResponse build() {
            return new ModifyCommonBandwidthPackageSpecResponse(this);
        } 
