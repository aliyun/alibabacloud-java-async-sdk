...
public class SetHighDefinitionMonitorLogStatusResponseBody extends TeaModel {
    ...
    public static SetHighDefinitionMonitorLogStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public SetHighDefinitionMonitorLogStatusResponseBody build() {
            return new SetHighDefinitionMonitorLogStatusResponseBody(this);
        } 
