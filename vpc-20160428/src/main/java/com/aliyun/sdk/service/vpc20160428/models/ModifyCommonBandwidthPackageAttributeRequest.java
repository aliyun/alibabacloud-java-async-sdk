 ...
 */
public class ModifyCommonBandwidthPackageAttributeRequest extends Request {
    @Query
    ...
    private ModifyCommonBandwidthPackageAttributeRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyCommonBandwidthPackageAttributeRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyCommonBandwidthPackageAttributeRequest, Builder> {
        private String bandwidthPackageId; 
        private String description; 
        private String name; 
        private String ownerAccount; 
        ...
        private Builder(ModifyCommonBandwidthPackageAttributeRequest request) {
            super(request);
        ...
        @Override
        public ModifyCommonBandwidthPackageAttributeRequest build() {
            return new ModifyCommonBandwidthPackageAttributeRequest(this);
        } 
