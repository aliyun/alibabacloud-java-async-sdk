...
/**
 * 
 * {@link ReleaseIpv6AddressRequest} extends {@link RequestModel}
 *
 * <p>ReleaseIpv6AddressRequest</p>
 */
public class ReleaseIpv6AddressRequest extends Request {
    ...
    private ReleaseIpv6AddressRequest(Builder builder) {
        super(builder);
    ...
    public static ReleaseIpv6AddressRequest create() {
    ...
    public static final class Builder extends Request.Builder<ReleaseIpv6AddressRequest, Builder> {
        private String clientToken; 
        private Boolean dryRun; 
        private String ipv6AddressId; 
        private String ownerAccount; 
        ...
        private Builder(ReleaseIpv6AddressRequest request) {
            super(request);
        ...
        public ReleaseIpv6AddressRequest build() {
            return new ReleaseIpv6AddressRequest(this);
        } 
