...
/**
 * 
 * {@link GetCreateBEClusterInquiryRequest} extends {@link RequestModel}
 *
 * <p>GetCreateBEClusterInquiryRequest</p>
 */
public class GetCreateBEClusterInquiryRequest extends Request {
    ...
    private GetCreateBEClusterInquiryRequest(Builder builder) {
        super(builder);
    ...
    public static GetCreateBEClusterInquiryRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetCreateBEClusterInquiryRequest, Builder> {
        private Long cacheSize; 
        private String chargeType; 
        private String commodityCode; 
        private Long computeSize; 
        ...
        private Builder(GetCreateBEClusterInquiryRequest request) {
            super(request);
        ...
        @Override
        public GetCreateBEClusterInquiryRequest build() {
            return new GetCreateBEClusterInquiryRequest(this);
        } 
