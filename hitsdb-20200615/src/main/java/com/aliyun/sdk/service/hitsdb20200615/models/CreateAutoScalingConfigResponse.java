...
public class CreateAutoScalingConfigResponse extends Response {
    ...
    private CreateAutoScalingConfigResponseBody body;
    ...
    public interface Builder extends Response.Builder<CreateAutoScalingConfigResponse, Builder> {
        ...
        Builder body(CreateAutoScalingConfigResponseBody body);
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(CreateAutoScalingConfigResponseBody body) {
            this.body = body;
            return this;
        }
