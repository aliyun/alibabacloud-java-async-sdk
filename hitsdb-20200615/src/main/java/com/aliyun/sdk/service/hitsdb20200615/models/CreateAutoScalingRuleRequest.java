...
/**
 * 
 * {@link CreateAutoScalingRuleRequest} extends {@link RequestModel}
 *
 * <p>CreateAutoScalingRuleRequest</p>
 */
public class CreateAutoScalingRuleRequest extends Request {
    ...
    private CreateAutoScalingRuleRequest(Builder builder) {
        super(builder);
    ...
    public static CreateAutoScalingRuleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateAutoScalingRuleRequest, Builder> {
        private String regionId; 
        private String configId; 
        private Boolean enabled; 
        private String endTime; 
        ...
        private Builder(CreateAutoScalingRuleRequest request) {
            super(request);
        ...
        @Override
        public CreateAutoScalingRuleRequest build() {
            return new CreateAutoScalingRuleRequest(this);
        } 
