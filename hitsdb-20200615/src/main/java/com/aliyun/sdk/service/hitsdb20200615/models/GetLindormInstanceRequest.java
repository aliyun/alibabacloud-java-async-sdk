...
public class GetLindormInstanceRequest extends Request {
    ...
    public static GetLindormInstanceRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetLindormInstanceRequest, Builder> {
        ...
        private Builder(GetLindormInstanceRequest response) {
            super(response);
        ...
        @Override
        public GetLindormInstanceRequest build() {
            return new GetLindormInstanceRequest(this);
        } 
