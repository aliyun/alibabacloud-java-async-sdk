...
/**
 * 
 * {@link GetAutoScalingConfigResponseBody} extends {@link TeaModel}
 *
 * <p>GetAutoScalingConfigResponseBody</p>
 */
public class GetAutoScalingConfigResponseBody extends TeaModel {
    ...
    private GetAutoScalingConfigResponseBody(Builder builder) {
    ...
    public static GetAutoScalingConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAutoScalingConfigResponseBody model) {
        ...
        public GetAutoScalingConfigResponseBody build() {
            return new GetAutoScalingConfigResponseBody(this);
        } 
