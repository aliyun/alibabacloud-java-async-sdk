...
/**
 * 
 * {@link GetLindormV2InstanceDetailsResponseBody} extends {@link TeaModel}
 *
 * <p>GetLindormV2InstanceDetailsResponseBody</p>
 */
public class GetLindormV2InstanceDetailsResponseBody extends TeaModel {
    ...
    private GetLindormV2InstanceDetailsResponseBody(Builder builder) {
    ...
    public static GetLindormV2InstanceDetailsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetLindormV2InstanceDetailsResponseBody model) {
        ...
        public GetLindormV2InstanceDetailsResponseBody build() {
            return new GetLindormV2InstanceDetailsResponseBody(this);
        } 
