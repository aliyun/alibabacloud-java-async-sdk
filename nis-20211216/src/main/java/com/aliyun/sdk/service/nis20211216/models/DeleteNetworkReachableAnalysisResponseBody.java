...
public class DeleteNetworkReachableAnalysisResponseBody extends TeaModel {
    ...
    public static DeleteNetworkReachableAnalysisResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteNetworkReachableAnalysisResponseBody build() {
            return new DeleteNetworkReachableAnalysisResponseBody(this);
        } 
