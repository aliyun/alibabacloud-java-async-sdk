...
public class DescribeDcdnDomainHitRateDataResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeDcdnDomainHitRateDataResponseBody model) {
            this.dataInterval = model.dataInterval;
            this.domainName = model.domainName;
            this.endTime = model.endTime;
            this.hitRatePerInterval = model.hitRatePerInterval;
    ...
    public static class HitRatePerInterval extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(HitRatePerInterval model) {
