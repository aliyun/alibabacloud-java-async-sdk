...
/**
 * 
 * {@link DescribeDcdnUserDomainsByFuncResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDcdnUserDomainsByFuncResponseBody</p>
 */
public class DescribeDcdnUserDomainsByFuncResponseBody extends TeaModel {
    ...
    private DescribeDcdnUserDomainsByFuncResponseBody(Builder builder) {
    ...
    public static DescribeDcdnUserDomainsByFuncResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeDcdnUserDomainsByFuncResponseBody model) {
        ...
        public DescribeDcdnUserDomainsByFuncResponseBody build() {
            return new DescribeDcdnUserDomainsByFuncResponseBody(this);
        } 
