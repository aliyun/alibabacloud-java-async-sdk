...
/**
 * {@link DescribeDcdnDomainHttpCodeDataByLayerRequest} extends {@link RequestModel}
 *
 * <p>DescribeDcdnDomainHttpCodeDataByLayerRequest</p>
 */
public class DescribeDcdnDomainHttpCodeDataByLayerRequest extends Request {
    ...
    private DescribeDcdnDomainHttpCodeDataByLayerRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeDcdnDomainHttpCodeDataByLayerRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeDcdnDomainHttpCodeDataByLayerRequest, Builder> {
        private String domainName; 
        private String endTime; 
        private String interval; 
        private String ispNameEn; 
        ...
        private Builder(DescribeDcdnDomainHttpCodeDataByLayerRequest request) {
            super(request);
        ...
        @Override
        public DescribeDcdnDomainHttpCodeDataByLayerRequest build() {
            return new DescribeDcdnDomainHttpCodeDataByLayerRequest(this);
        } 
