...
/**
 * 
 * {@link DescribeDcdnSSLCertificateListResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDcdnSSLCertificateListResponseBody</p>
 */
public class DescribeDcdnSSLCertificateListResponseBody extends TeaModel {
    ...
    private DescribeDcdnSSLCertificateListResponseBody(Builder builder) {
    ...
    public static DescribeDcdnSSLCertificateListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeDcdnSSLCertificateListResponseBody model) {
        ...
        public DescribeDcdnSSLCertificateListResponseBody build() {
            return new DescribeDcdnSSLCertificateListResponseBody(this);
        } 
