...
/**
 * {@link DescribeDcdnUserSecDropByMinuteResponse} extends {@link TeaModel}
 *
 * <p>DescribeDcdnUserSecDropByMinuteResponse</p>
 */
public class DescribeDcdnUserSecDropByMinuteResponse extends Response {
    ...
    public static DescribeDcdnUserSecDropByMinuteResponse create() {
    ...
    public interface Builder extends Response.Builder<DescribeDcdnUserSecDropByMinuteResponse, Builder> {
        ...
        @Override
        DescribeDcdnUserSecDropByMinuteResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DescribeDcdnUserSecDropByMinuteResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DescribeDcdnUserSecDropByMinuteResponse build() {
            return new DescribeDcdnUserSecDropByMinuteResponse(this);
        } 
