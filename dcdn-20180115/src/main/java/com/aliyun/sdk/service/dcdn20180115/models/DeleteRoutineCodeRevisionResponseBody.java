...
public class DeleteRoutineCodeRevisionResponseBody extends TeaModel {
    ...
    public static DeleteRoutineCodeRevisionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteRoutineCodeRevisionResponseBody model) {
        ...
        public DeleteRoutineCodeRevisionResponseBody build() {
            return new DeleteRoutineCodeRevisionResponseBody(this);
        } 
