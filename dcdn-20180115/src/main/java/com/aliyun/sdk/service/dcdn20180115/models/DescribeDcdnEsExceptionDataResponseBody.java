...
/**
 * {@link DescribeDcdnEsExceptionDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDcdnEsExceptionDataResponseBody</p>
 */
public class DescribeDcdnEsExceptionDataResponseBody extends TeaModel {
    ...
    private DescribeDcdnEsExceptionDataResponseBody(Builder builder) {
    ...
    public static DescribeDcdnEsExceptionDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeDcdnEsExceptionDataResponseBody build() {
            return new DescribeDcdnEsExceptionDataResponseBody(this);
        } 
