...
public class DescribeDcdnDomainRegionDataRequest extends Request {
    ...
    public static DescribeDcdnDomainRegionDataRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeDcdnDomainRegionDataRequest, Builder> {
        ...
        private Builder(DescribeDcdnDomainRegionDataRequest response) {
            super(response);
        ...
        @Override
        public DescribeDcdnDomainRegionDataRequest build() {
            return new DescribeDcdnDomainRegionDataRequest(this);
        } 
