...
/**
 * 
 * {@link StopDatasetJobRequest} extends {@link RequestModel}
 *
 * <p>StopDatasetJobRequest</p>
 */
public class StopDatasetJobRequest extends Request {
    ...
    private StopDatasetJobRequest(Builder builder) {
        super(builder);
    ...
    public static StopDatasetJobRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<StopDatasetJobRequest, Builder> {
        private String datasetId; 
        private String datasetJobId; 
        private String datasetVersion; 
        private String workspaceId; 
        ...
        private Builder(StopDatasetJobRequest request) {
            super(request);
        ...
        @Override
        public StopDatasetJobRequest build() {
            return new StopDatasetJobRequest(this);
        } 
