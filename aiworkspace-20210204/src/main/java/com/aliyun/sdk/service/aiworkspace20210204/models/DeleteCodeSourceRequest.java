...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteCodeSourceRequest, Builder> {
        ...
        /**
         * <p>The ID of the code source to be deleted. You can call <a href="https://help.aliyun.com/document_detail/459922.html">ListCodeSources</a> to query the code source ID.</p>
