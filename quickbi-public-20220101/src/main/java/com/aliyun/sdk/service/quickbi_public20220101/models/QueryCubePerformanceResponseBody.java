...
public class QueryCubePerformanceResponseBody extends TeaModel {
    ...
    private QueryCubePerformanceResponseBody(Builder builder) {
    ...
    public static QueryCubePerformanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryCubePerformanceResponseBody build() {
            return new QueryCubePerformanceResponseBody(this);
        } 
