 ...
 */
public class QueryComponentPerformanceRequest extends Request {
    ...
    private QueryComponentPerformanceRequest(Builder builder) {
        super(builder);
    ...
    public static QueryComponentPerformanceRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryComponentPerformanceRequest, Builder> {
        private Integer costTimeAvgMin; 
        private Integer pageNum; 
        private Integer pageSize; 
        private String queryType; 
        ...
        private Builder(QueryComponentPerformanceRequest request) {
            super(request);
        ...
        @Override
        public QueryComponentPerformanceRequest build() {
            return new QueryComponentPerformanceRequest(this);
        } 
