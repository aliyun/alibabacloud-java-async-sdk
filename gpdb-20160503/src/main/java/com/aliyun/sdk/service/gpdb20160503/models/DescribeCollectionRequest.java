 ...
 */
public class DescribeCollectionRequest extends Request {
    @Query
    ...
    public static DescribeCollectionRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeCollectionRequest, Builder> {
        ...
        private Builder(DescribeCollectionRequest request) {
            super(request);
        ...
        public DescribeCollectionRequest build() {
            return new DescribeCollectionRequest(this);
        } 
