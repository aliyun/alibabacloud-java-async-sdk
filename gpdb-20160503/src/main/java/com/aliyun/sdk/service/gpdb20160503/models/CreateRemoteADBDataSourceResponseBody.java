...
/**
 * 
 * {@link CreateRemoteADBDataSourceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateRemoteADBDataSourceResponseBody</p>
 */
public class CreateRemoteADBDataSourceResponseBody extends TeaModel {
    ...
    private CreateRemoteADBDataSourceResponseBody(Builder builder) {
    ...
    public static CreateRemoteADBDataSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateRemoteADBDataSourceResponseBody model) {
        ...
        public CreateRemoteADBDataSourceResponseBody build() {
            return new CreateRemoteADBDataSourceResponseBody(this);
        } 
