 ...
 *
 * <p>CancelUpsertCollectionDataJobRequest</p>
 */
public class CancelUpsertCollectionDataJobRequest extends Request {
    @Body
    ...
    public static CancelUpsertCollectionDataJobRequest create() {
    ...
    public static final class Builder extends Request.Builder<CancelUpsertCollectionDataJobRequest, Builder> {
        ...
        private Builder(CancelUpsertCollectionDataJobRequest request) {
            super(request);
        ...
        @Override
        public CancelUpsertCollectionDataJobRequest build() {
            return new CancelUpsertCollectionDataJobRequest(this);
        } 
