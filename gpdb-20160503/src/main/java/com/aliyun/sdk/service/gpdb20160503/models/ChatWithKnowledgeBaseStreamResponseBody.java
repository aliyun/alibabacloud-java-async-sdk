...
/**
 * 
 * {@link ChatWithKnowledgeBaseStreamResponseBody} extends {@link TeaModel}
 *
 * <p>ChatWithKnowledgeBaseStreamResponseBody</p>
 */
public class ChatWithKnowledgeBaseStreamResponseBody extends TeaModel {
    ...
    private ChatWithKnowledgeBaseStreamResponseBody(Builder builder) {
    ...
    public static ChatWithKnowledgeBaseStreamResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ChatWithKnowledgeBaseStreamResponseBody model) {
        ...
        public ChatWithKnowledgeBaseStreamResponseBody build() {
            return new ChatWithKnowledgeBaseStreamResponseBody(this);
        } 
