...
/**
 * 
 * {@link ChatWithKnowledgeBaseRequest} extends {@link RequestModel}
 *
 * <p>ChatWithKnowledgeBaseRequest</p>
 */
public class ChatWithKnowledgeBaseRequest extends Request {
    ...
    private ChatWithKnowledgeBaseRequest(Builder builder) {
        super(builder);
    ...
    public static ChatWithKnowledgeBaseRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ChatWithKnowledgeBaseRequest, Builder> {
        private String DBInstanceId; 
        private Boolean includeKnowledgeBaseResults; 
        private KnowledgeParams knowledgeParams; 
        private ModelParams modelParams; 
        ...
        private Builder(ChatWithKnowledgeBaseRequest request) {
            super(request);
        ...
        @Override
        public ChatWithKnowledgeBaseRequest build() {
            return new ChatWithKnowledgeBaseRequest(this);
        } 
    ...
    /**
     * 
     * {@link ChatWithKnowledgeBaseRequest} extends {@link TeaModel}
     *
     * <p>ChatWithKnowledgeBaseRequest</p>
     */
