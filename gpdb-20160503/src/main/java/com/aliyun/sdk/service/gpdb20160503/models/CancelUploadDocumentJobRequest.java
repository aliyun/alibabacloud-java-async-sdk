...
/**
 * 
 * {@link CancelUploadDocumentJobRequest} extends {@link RequestModel}
 *
 * <p>CancelUploadDocumentJobRequest</p>
 */
public class CancelUploadDocumentJobRequest extends Request {
    ...
    private CancelUploadDocumentJobRequest(Builder builder) {
        super(builder);
    ...
    public static CancelUploadDocumentJobRequest create() {
    ...
    public static final class Builder extends Request.Builder<CancelUploadDocumentJobRequest, Builder> {
        private String collection; 
        private String DBInstanceId; 
        private String jobId; 
        private String namespace; 
        ...
        private Builder(CancelUploadDocumentJobRequest request) {
            super(request);
        ...
        @Override
        public CancelUploadDocumentJobRequest build() {
            return new CancelUploadDocumentJobRequest(this);
        } 
