...
/**
 * {@link QueryContentRequest} extends {@link RequestModel}
 *
 * <p>QueryContentRequest</p>
 */
public class QueryContentRequest extends Request {
    @Query
    ...
    private QueryContentRequest(Builder builder) {
        super(builder);
    ...
    public static QueryContentRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryContentRequest, Builder> {
        private String collection; 
        private String content; 
        private String DBInstanceId; 
        private String filter; 
        ...
        private Builder(QueryContentRequest request) {
            super(request);
            ...
            this.useFullTextRetrieval = request.useFullTextRetrieval;
        } 
        ...
        public Builder useFullTextRetrieval(Boolean useFullTextRetrieval) {
            this.putQueryParameter("UseFullTextRetrieval", useFullTextRetrieval);
            this.useFullTextRetrieval = useFullTextRetrieval;
            return this;
        }

        @Override
        public QueryContentRequest build() {
            return new QueryContentRequest(this);
        } 
