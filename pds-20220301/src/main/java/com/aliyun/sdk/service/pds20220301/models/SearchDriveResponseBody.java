...
/**
 * 
 * {@link SearchDriveResponseBody} extends {@link TeaModel}
 *
 * <p>SearchDriveResponseBody</p>
 */
public class SearchDriveResponseBody extends TeaModel {
    ...
    private SearchDriveResponseBody(Builder builder) {
    ...
    public static SearchDriveResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SearchDriveResponseBody model) {
        ...
        public SearchDriveResponseBody build() {
            return new SearchDriveResponseBody(this);
        } 
