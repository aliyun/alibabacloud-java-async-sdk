 ...
 */
public class ListGroupRequest extends Request {
    ...
    public static ListGroupRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListGroupRequest, Builder> {
        private String domainId; 
        private Integer limit; 
        private String marker; 
        ...
        private Builder(ListGroupRequest request) {
            super(request);
        ...
        public ListGroupRequest build() {
            return new ListGroupRequest(this);
        } 
