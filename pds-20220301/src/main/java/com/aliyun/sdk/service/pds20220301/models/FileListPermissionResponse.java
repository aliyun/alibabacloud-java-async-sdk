...
public class FileListPermissionResponse extends Response {
    ...
    public static FileListPermissionResponse create() {
    ...
    private static final class BuilderImpl
        ...
        private BuilderImpl(FileListPermissionResponse response) {
            super(response);
        ...
        @Override
        public FileListPermissionResponse build() {
            return new FileListPermissionResponse(this);
        } 
