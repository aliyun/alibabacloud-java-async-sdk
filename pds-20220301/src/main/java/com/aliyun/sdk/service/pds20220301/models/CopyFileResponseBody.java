...
public class CopyFileResponseBody extends TeaModel {
    ...
    private CopyFileResponseBody(Builder builder) {
    ...
    public static CopyFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CopyFileResponseBody build() {
            return new CopyFileResponseBody(this);
        } 
