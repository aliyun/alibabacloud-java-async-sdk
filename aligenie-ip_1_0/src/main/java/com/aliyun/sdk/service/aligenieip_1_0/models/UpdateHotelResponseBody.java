...
/**
 * 
 * {@link UpdateHotelResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateHotelResponseBody</p>
 */
public class UpdateHotelResponseBody extends TeaModel {
    ...
    private UpdateHotelResponseBody(Builder builder) {
    ...
    public static UpdateHotelResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateHotelResponseBody model) {
        ...
        public UpdateHotelResponseBody build() {
            return new UpdateHotelResponseBody(this);
        } 
