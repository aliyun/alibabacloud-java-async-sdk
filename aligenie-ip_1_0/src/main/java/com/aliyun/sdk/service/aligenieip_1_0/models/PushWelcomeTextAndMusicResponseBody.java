...
public class PushWelcomeTextAndMusicResponseBody extends TeaModel {
    ...
    public static PushWelcomeTextAndMusicResponseBody create() {
    ...
    public static final class Builder {
        ...
        public PushWelcomeTextAndMusicResponseBody build() {
            return new PushWelcomeTextAndMusicResponseBody(this);
        } 
