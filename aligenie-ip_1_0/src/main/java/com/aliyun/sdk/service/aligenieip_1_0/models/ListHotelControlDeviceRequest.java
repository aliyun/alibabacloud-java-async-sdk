...
public class ListHotelControlDeviceRequest extends Request {
    ...
    public static ListHotelControlDeviceRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListHotelControlDeviceRequest, Builder> {
        private UserInfo userInfo; 
        ...
        private Builder(ListHotelControlDeviceRequest request) {
            super(request);
        ...
        @Override
        public ListHotelControlDeviceRequest build() {
            return new ListHotelControlDeviceRequest(this);
        } 
