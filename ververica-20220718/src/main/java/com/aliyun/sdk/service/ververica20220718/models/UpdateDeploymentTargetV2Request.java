...
/**
 * 
 * {@link UpdateDeploymentTargetV2Request} extends {@link RequestModel}
 *
 * <p>UpdateDeploymentTargetV2Request</p>
 */
public class UpdateDeploymentTargetV2Request extends Request {
    ...
    private UpdateDeploymentTargetV2Request(Builder builder) {
        super(builder);
    ...
    public static UpdateDeploymentTargetV2Request create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateDeploymentTargetV2Request, Builder> {
        private String namespace; 
        private String deploymentTargetName; 
        private Resource body; 
        private String workspace; 
        ...
        private Builder(UpdateDeploymentTargetV2Request request) {
            super(request);
        ...
        @Override
        public UpdateDeploymentTargetV2Request build() {
            return new UpdateDeploymentTargetV2Request(this);
        } 
