...
/**
 * {@link ListCustomConnectorsResponseBody} extends {@link TeaModel}
 *
 * <p>ListCustomConnectorsResponseBody</p>
 */
public class ListCustomConnectorsResponseBody extends TeaModel {
    ...
    private ListCustomConnectorsResponseBody(Builder builder) {
    ...
    public static ListCustomConnectorsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListCustomConnectorsResponseBody build() {
            return new ListCustomConnectorsResponseBody(this);
        } 
