...
public class ListVariablesResponseBody extends TeaModel {
    ...
    private java.util.List<Variable> data;
    ...
    private ListVariablesResponseBody(Builder builder) {
    ...
    public static ListVariablesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListVariablesResponseBody model) {
        ...
        public ListVariablesResponseBody build() {
            return new ListVariablesResponseBody(this);
        } 
