...
public class DeleteVariableResponseBody extends TeaModel {
    ...
    private DeleteVariableResponseBody(Builder builder) {
    ...
    public static DeleteVariableResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteVariableResponseBody build() {
            return new DeleteVariableResponseBody(this);
        } 
