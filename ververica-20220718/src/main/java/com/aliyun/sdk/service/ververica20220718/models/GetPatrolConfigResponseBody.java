...
/**
 * 
 * {@link GetPatrolConfigResponseBody} extends {@link TeaModel}
 *
 * <p>GetPatrolConfigResponseBody</p>
 */
public class GetPatrolConfigResponseBody extends TeaModel {
    ...
    private GetPatrolConfigResponseBody(Builder builder) {
    ...
    public static GetPatrolConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetPatrolConfigResponseBody model) {
        ...
        public GetPatrolConfigResponseBody build() {
            return new GetPatrolConfigResponseBody(this);
        } 
