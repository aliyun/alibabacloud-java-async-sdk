...
/**
 * 
 * {@link GetUdfArtifactsResponseBody} extends {@link TeaModel}
 *
 * <p>GetUdfArtifactsResponseBody</p>
 */
public class GetUdfArtifactsResponseBody extends TeaModel {
    @com.aliyun.core.annotation.NameInMap("data")
    private java.util.List<UdfArtifact> data;
    ...
    private GetUdfArtifactsResponseBody(Builder builder) {
    ...
    public static GetUdfArtifactsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetUdfArtifactsResponseBody model) {
         ...
         */
        public Builder data(java.util.List<UdfArtifact> data) {
            this.data = data;
            return this;
        }
        ...
        public GetUdfArtifactsResponseBody build() {
            return new GetUdfArtifactsResponseBody(this);
        } 
