...
/**
 * 
 * {@link CancelSqlPreviewRequest} extends {@link RequestModel}
 *
 * <p>CancelSqlPreviewRequest</p>
 */
public class CancelSqlPreviewRequest extends Request {
    ...
    private CancelSqlPreviewRequest(Builder builder) {
        super(builder);
    ...
    public static CancelSqlPreviewRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CancelSqlPreviewRequest, Builder> {
        private String namespace; 
        private String queryId; 
        private String sessionClusterName; 
        private String sessionId; 
        ...
        private Builder(CancelSqlPreviewRequest request) {
            super(request);
        ...
        @Override
        public CancelSqlPreviewRequest build() {
            return new CancelSqlPreviewRequest(this);
        } 
