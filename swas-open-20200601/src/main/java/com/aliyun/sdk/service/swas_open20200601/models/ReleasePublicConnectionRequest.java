...
/**
 * 
 * {@link ReleasePublicConnectionRequest} extends {@link RequestModel}
 *
 * <p>ReleasePublicConnectionRequest</p>
 */
public class ReleasePublicConnectionRequest extends Request {
    ...
    private ReleasePublicConnectionRequest(Builder builder) {
        super(builder);
    ...
    public static ReleasePublicConnectionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ReleasePublicConnectionRequest, Builder> {
        private String clientToken; 
        private String databaseInstanceId; 
        private String regionId; 
        ...
        private Builder(ReleasePublicConnectionRequest request) {
            super(request);
        ...
        @Override
        public ReleasePublicConnectionRequest build() {
            return new ReleasePublicConnectionRequest(this);
        } 
