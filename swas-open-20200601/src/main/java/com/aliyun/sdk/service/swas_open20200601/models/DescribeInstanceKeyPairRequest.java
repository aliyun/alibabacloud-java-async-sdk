...
/**
 * 
 * {@link DescribeInstanceKeyPairRequest} extends {@link RequestModel}
 *
 * <p>DescribeInstanceKeyPairRequest</p>
 */
public class DescribeInstanceKeyPairRequest extends Request {
    ...
    private DescribeInstanceKeyPairRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeInstanceKeyPairRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeInstanceKeyPairRequest, Builder> {
        private String clientToken; 
        private String instanceId; 
        private String regionId; 
        ...
        private Builder(DescribeInstanceKeyPairRequest request) {
            super(request);
        ...
        @Override
        public DescribeInstanceKeyPairRequest build() {
            return new DescribeInstanceKeyPairRequest(this);
        } 
