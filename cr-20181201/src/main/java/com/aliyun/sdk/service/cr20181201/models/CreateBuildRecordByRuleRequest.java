...
public class CreateBuildRecordByRuleRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<CreateBuildRecordByRuleRequest, Builder> {
        private String buildRuleId; 
        private String instanceId; 
        private String regionId; 
        private String repoId; 
        ...
        private Builder(CreateBuildRecordByRuleRequest response) {
            super(response);
