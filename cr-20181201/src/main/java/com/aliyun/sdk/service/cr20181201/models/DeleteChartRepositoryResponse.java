...
public class DeleteChartRepositoryResponse extends Response {
    ...
    private DeleteChartRepositoryResponse(BuilderImpl builder) {
        super(builder);
...
@Override
    ...
    public interface Builder extends Response.Builder<DeleteChartRepositoryResponse, Builder> {

        Builder headers(java.util.Map<String, String> headers);

        Builder statusCode(Integer statusCode);

        Builder body(DeleteChartRepositoryResponseBody body);

        @Override
        DeleteChartRepositoryResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<DeleteChartRepositoryResponse, Builder>
            implements Builder {
        private java.util.Map<String, String> headers; 
        private Integer statusCode; 
        private DeleteChartRepositoryResponseBody body; 
        ...
        private BuilderImpl(DeleteChartRepositoryResponse response) {
            super(response);
