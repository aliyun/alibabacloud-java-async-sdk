...
public class UpdateInstanceEndpointStatusResponse extends Response {
    ...
    private UpdateInstanceEndpointStatusResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<UpdateInstanceEndpointStatusResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(UpdateInstanceEndpointStatusResponseBody body);

        @Override
        UpdateInstanceEndpointStatusResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<UpdateInstanceEndpointStatusResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private UpdateInstanceEndpointStatusResponseBody body; 
        ...
        private BuilderImpl(UpdateInstanceEndpointStatusResponse response) {
            super(response);
