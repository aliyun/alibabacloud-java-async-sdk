...
public class GetRepoBuildRecordStatusRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<GetRepoBuildRecordStatusRequest, Builder> {
        private String buildRecordId; 
        private String instanceId; 
        private String regionId; 
        private String repoId; 
        ...
        private Builder(GetRepoBuildRecordStatusRequest response) {
            super(response);
