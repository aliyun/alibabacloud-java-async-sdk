...
public class ListChainResponse extends Response {
    ...
    private ListChainResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ListChainResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ListChainResponseBody body);

        @Override
        ListChainResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ListChainResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ListChainResponseBody body; 
        ...
        private BuilderImpl(ListChainResponse response) {
            super(response);
