...
public class CreateChainResponse extends Response {
    ...
    private CreateChainResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<CreateChainResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(CreateChainResponseBody body);

        @Override
        CreateChainResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<CreateChainResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private CreateChainResponseBody body; 
        ...
        private BuilderImpl(CreateChainResponse response) {
            super(response);
