...
/**
 * 
 * {@link QueryCardSmsStatisticsListRequest} extends {@link RequestModel}
 *
 * <p>QueryCardSmsStatisticsListRequest</p>
 */
public class QueryCardSmsStatisticsListRequest extends Request {
    ...
    private QueryCardSmsStatisticsListRequest(Builder builder) {
        super(builder);
    ...
    public static QueryCardSmsStatisticsListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryCardSmsStatisticsListRequest, Builder> {
        private String customTmpCode; 
        private String sendDateEnd; 
        private String sendDateStart; 
        private String signName; 
        ...
        private Builder(QueryCardSmsStatisticsListRequest request) {
            super(request);
        ...
        @Override
        public QueryCardSmsStatisticsListRequest build() {
            return new QueryCardSmsStatisticsListRequest(this);
        } 
