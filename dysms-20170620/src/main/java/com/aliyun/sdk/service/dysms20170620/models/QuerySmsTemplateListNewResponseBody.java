...
/**
 * 
 * {@link QuerySmsTemplateListNewResponseBody} extends {@link TeaModel}
 *
 * <p>QuerySmsTemplateListNewResponseBody</p>
 */
public class QuerySmsTemplateListNewResponseBody extends TeaModel {
    ...
    private QuerySmsTemplateListNewResponseBody(Builder builder) {
    ...
    public static QuerySmsTemplateListNewResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QuerySmsTemplateListNewResponseBody model) {
        ...
        public QuerySmsTemplateListNewResponseBody build() {
            return new QuerySmsTemplateListNewResponseBody(this);
        } 
    ...
    public static class SmsTemplate extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(SmsTemplate model) {
                ...
                this.id = model.id;
                this.intelligentApproval = model.intelligentApproval;
