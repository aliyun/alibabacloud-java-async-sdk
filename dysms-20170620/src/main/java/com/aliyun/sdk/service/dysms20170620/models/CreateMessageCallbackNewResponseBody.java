...
/**
 * 
 * {@link CreateMessageCallbackNewResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMessageCallbackNewResponseBody</p>
 */
public class CreateMessageCallbackNewResponseBody extends TeaModel {
    ...
    private CreateMessageCallbackNewResponseBody(Builder builder) {
    ...
    public static CreateMessageCallbackNewResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateMessageCallbackNewResponseBody model) {
        ...
        public CreateMessageCallbackNewResponseBody build() {
            return new CreateMessageCallbackNewResponseBody(this);
        } 
