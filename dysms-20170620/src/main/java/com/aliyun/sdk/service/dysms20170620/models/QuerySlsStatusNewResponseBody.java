...
/**
 * 
 * {@link QuerySlsStatusNewResponseBody} extends {@link TeaModel}
 *
 * <p>QuerySlsStatusNewResponseBody</p>
 */
public class QuerySlsStatusNewResponseBody extends TeaModel {
    ...
    private QuerySlsStatusNewResponseBody(Builder builder) {
    ...
    public static QuerySlsStatusNewResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QuerySlsStatusNewResponseBody model) {
        ...
        public QuerySlsStatusNewResponseBody build() {
            return new QuerySlsStatusNewResponseBody(this);
        } 
