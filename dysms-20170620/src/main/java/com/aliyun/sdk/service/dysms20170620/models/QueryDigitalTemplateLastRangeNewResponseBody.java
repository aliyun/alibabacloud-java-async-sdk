...
/**
 * 
 * {@link QueryDigitalTemplateLastRangeNewResponseBody} extends {@link TeaModel}
 *
 * <p>QueryDigitalTemplateLastRangeNewResponseBody</p>
 */
public class QueryDigitalTemplateLastRangeNewResponseBody extends TeaModel {
    ...
    private QueryDigitalTemplateLastRangeNewResponseBody(Builder builder) {
    ...
    public static QueryDigitalTemplateLastRangeNewResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryDigitalTemplateLastRangeNewResponseBody model) {
        ...
        public QueryDigitalTemplateLastRangeNewResponseBody build() {
            return new QueryDigitalTemplateLastRangeNewResponseBody(this);
        } 
