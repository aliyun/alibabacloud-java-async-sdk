...
/**
 * 
 * {@link QueryMonthlyBillInfoLeafNewRequest} extends {@link RequestModel}
 *
 * <p>QueryMonthlyBillInfoLeafNewRequest</p>
 */
public class QueryMonthlyBillInfoLeafNewRequest extends Request {
    ...
    private QueryMonthlyBillInfoLeafNewRequest(Builder builder) {
        super(builder);
    ...
    public static QueryMonthlyBillInfoLeafNewRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryMonthlyBillInfoLeafNewRequest, Builder> {
        private String billCycle; 
        private String itemId; 
        private String itemName; 
        private Long ownerId; 
        ...
        private Builder(QueryMonthlyBillInfoLeafNewRequest request) {
            super(request);
        ...
        @Override
        public QueryMonthlyBillInfoLeafNewRequest build() {
            return new QueryMonthlyBillInfoLeafNewRequest(this);
        } 
