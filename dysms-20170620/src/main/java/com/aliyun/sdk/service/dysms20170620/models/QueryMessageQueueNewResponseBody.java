...
/**
 * 
 * {@link QueryMessageQueueNewResponseBody} extends {@link TeaModel}
 *
 * <p>QueryMessageQueueNewResponseBody</p>
 */
public class QueryMessageQueueNewResponseBody extends TeaModel {
    ...
    private QueryMessageQueueNewResponseBody(Builder builder) {
    ...
    public static QueryMessageQueueNewResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryMessageQueueNewResponseBody model) {
        ...
        public QueryMessageQueueNewResponseBody build() {
            return new QueryMessageQueueNewResponseBody(this);
        } 
