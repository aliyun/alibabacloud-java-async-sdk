...
/**
 * 
 * {@link CreateCardMessageCallbackResponseBody} extends {@link TeaModel}
 *
 * <p>CreateCardMessageCallbackResponseBody</p>
 */
public class CreateCardMessageCallbackResponseBody extends TeaModel {
    ...
    private CreateCardMessageCallbackResponseBody(Builder builder) {
    ...
    public static CreateCardMessageCallbackResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateCardMessageCallbackResponseBody model) {
        ...
        public CreateCardMessageCallbackResponseBody build() {
            return new CreateCardMessageCallbackResponseBody(this);
        } 
