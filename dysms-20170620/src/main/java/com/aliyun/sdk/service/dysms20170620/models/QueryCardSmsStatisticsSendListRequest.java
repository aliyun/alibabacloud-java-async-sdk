...
/**
 * 
 * {@link QueryCardSmsStatisticsSendListRequest} extends {@link RequestModel}
 *
 * <p>QueryCardSmsStatisticsSendListRequest</p>
 */
public class QueryCardSmsStatisticsSendListRequest extends Request {
    ...
    private QueryCardSmsStatisticsSendListRequest(Builder builder) {
        super(builder);
    ...
    public static QueryCardSmsStatisticsSendListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryCardSmsStatisticsSendListRequest, Builder> {
        private String customTmpCode; 
        private String sendDateEnd; 
        private String sendDateStart; 
        private String signName; 
        ...
        private Builder(QueryCardSmsStatisticsSendListRequest request) {
            super(request);
        ...
        @Override
        public QueryCardSmsStatisticsSendListRequest build() {
            return new QueryCardSmsStatisticsSendListRequest(this);
        } 
