...
/**
 * 
 * {@link ExportCardSmsHistoryResponseBody} extends {@link TeaModel}
 *
 * <p>ExportCardSmsHistoryResponseBody</p>
 */
public class ExportCardSmsHistoryResponseBody extends TeaModel {
    ...
    private ExportCardSmsHistoryResponseBody(Builder builder) {
    ...
    public static ExportCardSmsHistoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExportCardSmsHistoryResponseBody model) {
        ...
        public ExportCardSmsHistoryResponseBody build() {
            return new ExportCardSmsHistoryResponseBody(this);
        } 
