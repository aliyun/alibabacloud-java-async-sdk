...
/**
 * 
 * {@link CreateWarningThresholdNewRequest} extends {@link RequestModel}
 *
 * <p>CreateWarningThresholdNewRequest</p>
 */
public class CreateWarningThresholdNewRequest extends Request {
    ...
    private CreateWarningThresholdNewRequest(Builder builder) {
        super(builder);
    ...
    public static CreateWarningThresholdNewRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateWarningThresholdNewRequest, Builder> {
        private String bizType; 
        private Integer dailyHaltLimit; 
        private Integer dailyWarningLimit; 
        private Integer monthlyHaltLimit; 
        ...
        private Builder(CreateWarningThresholdNewRequest request) {
            super(request);
        ...
        @Override
        public CreateWarningThresholdNewRequest build() {
            return new CreateWarningThresholdNewRequest(this);
        } 
