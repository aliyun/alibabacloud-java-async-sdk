...
/**
 * 
 * {@link SendSmsTestNewRequest} extends {@link RequestModel}
 *
 * <p>SendSmsTestNewRequest</p>
 */
public class SendSmsTestNewRequest extends Request {
    ...
    private SendSmsTestNewRequest(Builder builder) {
        super(builder);
    ...
    public static SendSmsTestNewRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SendSmsTestNewRequest, Builder> {
        private String ncToken; 
        private Long ownerId; 
        private String phoneNumber; 
        private String prodCode; 
        ...
        private Builder(SendSmsTestNewRequest request) {
            super(request);
        ...
        @Override
        public SendSmsTestNewRequest build() {
            return new SendSmsTestNewRequest(this);
        } 
