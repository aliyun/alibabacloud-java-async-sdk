...
/**
 * 
 * {@link QueryTmpEffectReportDataResponseBody} extends {@link TeaModel}
 *
 * <p>QueryTmpEffectReportDataResponseBody</p>
 */
public class QueryTmpEffectReportDataResponseBody extends TeaModel {
    ...
    private QueryTmpEffectReportDataResponseBody(Builder builder) {
    ...
    public static QueryTmpEffectReportDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryTmpEffectReportDataResponseBody model) {
        ...
        public QueryTmpEffectReportDataResponseBody build() {
            return new QueryTmpEffectReportDataResponseBody(this);
        } 
