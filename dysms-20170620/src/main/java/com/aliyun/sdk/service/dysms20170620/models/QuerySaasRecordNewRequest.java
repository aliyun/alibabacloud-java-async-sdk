...
/**
 * 
 * {@link QuerySaasRecordNewRequest} extends {@link RequestModel}
 *
 * <p>QuerySaasRecordNewRequest</p>
 */
public class QuerySaasRecordNewRequest extends Request {
    ...
    private QuerySaasRecordNewRequest(Builder builder) {
        super(builder);
    ...
    public static QuerySaasRecordNewRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QuerySaasRecordNewRequest, Builder> {
        private String bizType; 
        private String indexCol; 
        private Long ownerId; 
        private Integer pageNo; 
        ...
        private Builder(QuerySaasRecordNewRequest request) {
            super(request);
        ...
        @Override
        public QuerySaasRecordNewRequest build() {
            return new QuerySaasRecordNewRequest(this);
        } 
