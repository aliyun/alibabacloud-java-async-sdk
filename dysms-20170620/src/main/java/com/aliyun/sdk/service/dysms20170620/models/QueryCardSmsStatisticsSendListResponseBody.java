...
/**
 * 
 * {@link QueryCardSmsStatisticsSendListResponseBody} extends {@link TeaModel}
 *
 * <p>QueryCardSmsStatisticsSendListResponseBody</p>
 */
public class QueryCardSmsStatisticsSendListResponseBody extends TeaModel {
    ...
    private QueryCardSmsStatisticsSendListResponseBody(Builder builder) {
    ...
    public static QueryCardSmsStatisticsSendListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryCardSmsStatisticsSendListResponseBody model) {
        ...
        public QueryCardSmsStatisticsSendListResponseBody build() {
            return new QueryCardSmsStatisticsSendListResponseBody(this);
        } 
