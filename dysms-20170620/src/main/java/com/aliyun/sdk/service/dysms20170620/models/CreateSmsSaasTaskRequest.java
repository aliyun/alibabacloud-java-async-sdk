...
/**
 * 
 * {@link CreateSmsSaasTaskRequest} extends {@link RequestModel}
 *
 * <p>CreateSmsSaasTaskRequest</p>
 */
public class CreateSmsSaasTaskRequest extends Request {
    ...
    private CreateSmsSaasTaskRequest(Builder builder) {
        super(builder);
    ...
    public static CreateSmsSaasTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateSmsSaasTaskRequest, Builder> {
        private String bizType; 
        private String clientIp; 
        private String dataType; 
        private String orderTime; 
        ...
        private Builder(CreateSmsSaasTaskRequest request) {
            super(request);
        ...
        @Override
        public CreateSmsSaasTaskRequest build() {
            return new CreateSmsSaasTaskRequest(this);
        } 
