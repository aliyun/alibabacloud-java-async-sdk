...
/**
 * 
 * {@link QueryTmpEffectReportDayDataRequest} extends {@link RequestModel}
 *
 * <p>QueryTmpEffectReportDayDataRequest</p>
 */
public class QueryTmpEffectReportDayDataRequest extends Request {
    ...
    private QueryTmpEffectReportDayDataRequest(Builder builder) {
        super(builder);
    ...
    public static QueryTmpEffectReportDayDataRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryTmpEffectReportDayDataRequest, Builder> {
        private String endDate; 
        private Long pageNo; 
        private Long pageSize; 
        private String startDate; 
        ...
        private Builder(QueryTmpEffectReportDayDataRequest request) {
            super(request);
        ...
        @Override
        public QueryTmpEffectReportDayDataRequest build() {
            return new QueryTmpEffectReportDayDataRequest(this);
        } 
