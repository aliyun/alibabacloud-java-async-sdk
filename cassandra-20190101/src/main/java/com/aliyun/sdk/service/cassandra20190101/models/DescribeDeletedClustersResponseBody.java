...
/**
 * {@link DescribeDeletedClustersResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDeletedClustersResponseBody</p>
 */
public class DescribeDeletedClustersResponseBody extends TeaModel {
    ...
    private DescribeDeletedClustersResponseBody(Builder builder) {
    ...
    public static DescribeDeletedClustersResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeDeletedClustersResponseBody build() {
            return new DescribeDeletedClustersResponseBody(this);
        } 
