...
/**
 * 
 * {@link UpdateDetectConfigRequest} extends {@link RequestModel}
 *
 * <p>UpdateDetectConfigRequest</p>
 */
public class UpdateDetectConfigRequest extends Request {
    ...
    private UpdateDetectConfigRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateDetectConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateDetectConfigRequest, Builder> {
        private String detectConfigId; 
        private java.util.List<AlarmConfigs> alarmConfigs; 
        private String clientToken; 
        private String cronExpression; 
        ...
        private Builder(UpdateDetectConfigRequest request) {
            super(request);
        ...
        @Override
        public UpdateDetectConfigRequest build() {
            return new UpdateDetectConfigRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateDetectConfigRequest} extends {@link TeaModel}
     *
     * <p>UpdateDetectConfigRequest</p>
     */
