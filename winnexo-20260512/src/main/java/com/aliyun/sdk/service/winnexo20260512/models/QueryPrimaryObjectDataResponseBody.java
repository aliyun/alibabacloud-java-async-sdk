...
/**
 * 
 * {@link QueryPrimaryObjectDataResponseBody} extends {@link TeaModel}
 *
 * <p>QueryPrimaryObjectDataResponseBody</p>
 */
public class QueryPrimaryObjectDataResponseBody extends TeaModel {
    ...
    private java.util.List<java.util.Map<String, String>> items;
    ...
    private QueryPrimaryObjectDataResponseBody(Builder builder) {
    ...
    public static QueryPrimaryObjectDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryPrimaryObjectDataResponseBody model) {
        ...
        public QueryPrimaryObjectDataResponseBody build() {
            return new QueryPrimaryObjectDataResponseBody(this);
        } 
