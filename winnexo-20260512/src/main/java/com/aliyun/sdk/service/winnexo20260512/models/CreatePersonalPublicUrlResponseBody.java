...
/**
 * 
 * {@link CreatePersonalPublicUrlResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePersonalPublicUrlResponseBody</p>
 */
public class CreatePersonalPublicUrlResponseBody extends TeaModel {
    ...
    private CreatePersonalPublicUrlResponseBody(Builder builder) {
    ...
    public static CreatePersonalPublicUrlResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreatePersonalPublicUrlResponseBody model) {
        ...
        public CreatePersonalPublicUrlResponseBody build() {
            return new CreatePersonalPublicUrlResponseBody(this);
        } 
