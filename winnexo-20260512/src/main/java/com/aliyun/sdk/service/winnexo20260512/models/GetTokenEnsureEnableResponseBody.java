...
/**
 * 
 * {@link GetTokenEnsureEnableResponseBody} extends {@link TeaModel}
 *
 * <p>GetTokenEnsureEnableResponseBody</p>
 */
public class GetTokenEnsureEnableResponseBody extends TeaModel {
    ...
    private GetTokenEnsureEnableResponseBody(Builder builder) {
    ...
    public static GetTokenEnsureEnableResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetTokenEnsureEnableResponseBody model) {
        ...
        public GetTokenEnsureEnableResponseBody build() {
            return new GetTokenEnsureEnableResponseBody(this);
        } 
