...
/**
 * 
 * {@link ReplaceGroupSourceFileResponseBody} extends {@link TeaModel}
 *
 * <p>ReplaceGroupSourceFileResponseBody</p>
 */
public class ReplaceGroupSourceFileResponseBody extends TeaModel {
    ...
    private ReplaceGroupSourceFileResponseBody(Builder builder) {
    ...
    public static ReplaceGroupSourceFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReplaceGroupSourceFileResponseBody model) {
        ...
        public ReplaceGroupSourceFileResponseBody build() {
            return new ReplaceGroupSourceFileResponseBody(this);
        } 
