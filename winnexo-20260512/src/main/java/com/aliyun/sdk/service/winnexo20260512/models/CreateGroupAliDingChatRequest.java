...
/**
 * 
 * {@link CreateGroupAliDingChatRequest} extends {@link RequestModel}
 *
 * <p>CreateGroupAliDingChatRequest</p>
 */
public class CreateGroupAliDingChatRequest extends Request {
    ...
    private CreateGroupAliDingChatRequest(Builder builder) {
        super(builder);
    ...
    public static CreateGroupAliDingChatRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateGroupAliDingChatRequest, Builder> {
        private String chatId; 
        private String chatName; 
        private String description; 
        private String directoryId; 
        ...
        private Builder(CreateGroupAliDingChatRequest request) {
            super(request);
        ...
        @Override
        public CreateGroupAliDingChatRequest build() {
            return new CreateGroupAliDingChatRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateGroupAliDingChatRequest} extends {@link TeaModel}
     *
     * <p>CreateGroupAliDingChatRequest</p>
     */
