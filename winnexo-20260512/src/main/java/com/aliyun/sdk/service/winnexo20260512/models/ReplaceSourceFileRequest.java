...
/**
 * 
 * {@link ReplaceSourceFileRequest} extends {@link RequestModel}
 *
 * <p>ReplaceSourceFileRequest</p>
 */
public class ReplaceSourceFileRequest extends Request {
    ...
    private ReplaceSourceFileRequest(Builder builder) {
        super(builder);
    ...
    public static ReplaceSourceFileRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReplaceSourceFileRequest, Builder> {
        private String fileName; 
        private String filePath; 
        private String filePublicUrl; 
        private String fileRecordId; 
        ...
        private Builder(ReplaceSourceFileRequest request) {
            super(request);
        ...
        @Override
        public ReplaceSourceFileRequest build() {
            return new ReplaceSourceFileRequest(this);
        } 
