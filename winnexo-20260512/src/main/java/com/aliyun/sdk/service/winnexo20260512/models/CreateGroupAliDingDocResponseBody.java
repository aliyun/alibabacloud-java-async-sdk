...
/**
 * 
 * {@link CreateGroupAliDingDocResponseBody} extends {@link TeaModel}
 *
 * <p>CreateGroupAliDingDocResponseBody</p>
 */
public class CreateGroupAliDingDocResponseBody extends TeaModel {
    ...
    private CreateGroupAliDingDocResponseBody(Builder builder) {
    ...
    public static CreateGroupAliDingDocResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateGroupAliDingDocResponseBody model) {
        ...
        public CreateGroupAliDingDocResponseBody build() {
            return new CreateGroupAliDingDocResponseBody(this);
        } 
