...
/**
 * 
 * {@link EnableTokenResponseBody} extends {@link TeaModel}
 *
 * <p>EnableTokenResponseBody</p>
 */
public class EnableTokenResponseBody extends TeaModel {
    ...
    private EnableTokenResponseBody(Builder builder) {
    ...
    public static EnableTokenResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnableTokenResponseBody model) {
        ...
        public EnableTokenResponseBody build() {
            return new EnableTokenResponseBody(this);
        } 
