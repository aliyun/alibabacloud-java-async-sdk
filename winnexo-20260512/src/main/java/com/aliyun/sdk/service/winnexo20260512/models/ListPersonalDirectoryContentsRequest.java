...
/**
 * 
 * {@link ListPersonalDirectoryContentsRequest} extends {@link RequestModel}
 *
 * <p>ListPersonalDirectoryContentsRequest</p>
 */
public class ListPersonalDirectoryContentsRequest extends Request {
    ...
    private ListPersonalDirectoryContentsRequest(Builder builder) {
        super(builder);
    ...
    public static ListPersonalDirectoryContentsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListPersonalDirectoryContentsRequest, Builder> {
        private String directoryId; 
        private String operatingObjectName; 
        private Long page; 
        private Long pageSize; 
        ...
        private Builder(ListPersonalDirectoryContentsRequest request) {
            super(request);
        ...
        @Override
        public ListPersonalDirectoryContentsRequest build() {
            return new ListPersonalDirectoryContentsRequest(this);
        } 
