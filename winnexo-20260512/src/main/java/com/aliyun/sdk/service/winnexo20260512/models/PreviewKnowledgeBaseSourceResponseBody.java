...
/**
 * 
 * {@link PreviewKnowledgeBaseSourceResponseBody} extends {@link TeaModel}
 *
 * <p>PreviewKnowledgeBaseSourceResponseBody</p>
 */
public class PreviewKnowledgeBaseSourceResponseBody extends TeaModel {
    ...
    private PreviewKnowledgeBaseSourceResponseBody(Builder builder) {
    ...
    public static PreviewKnowledgeBaseSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PreviewKnowledgeBaseSourceResponseBody model) {
        ...
        public PreviewKnowledgeBaseSourceResponseBody build() {
            return new PreviewKnowledgeBaseSourceResponseBody(this);
        } 
