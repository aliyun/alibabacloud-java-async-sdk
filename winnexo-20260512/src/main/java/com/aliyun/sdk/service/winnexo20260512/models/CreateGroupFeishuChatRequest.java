...
/**
 * 
 * {@link CreateGroupFeishuChatRequest} extends {@link RequestModel}
 *
 * <p>CreateGroupFeishuChatRequest</p>
 */
public class CreateGroupFeishuChatRequest extends Request {
    ...
    private CreateGroupFeishuChatRequest(Builder builder) {
        super(builder);
    ...
    public static CreateGroupFeishuChatRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateGroupFeishuChatRequest, Builder> {
        private String chatId; 
        private String description; 
        private String directoryId; 
        private String groupId; 
        ...
        private Builder(CreateGroupFeishuChatRequest request) {
            super(request);
        ...
        @Override
        public CreateGroupFeishuChatRequest build() {
            return new CreateGroupFeishuChatRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateGroupFeishuChatRequest} extends {@link TeaModel}
     *
     * <p>CreateGroupFeishuChatRequest</p>
     */
