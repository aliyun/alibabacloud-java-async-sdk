...
/**
 * 
 * {@link CreateKnowledgeBaseFeishuDocRequest} extends {@link RequestModel}
 *
 * <p>CreateKnowledgeBaseFeishuDocRequest</p>
 */
public class CreateKnowledgeBaseFeishuDocRequest extends Request {
    ...
    private CreateKnowledgeBaseFeishuDocRequest(Builder builder) {
        super(builder);
    ...
    public static CreateKnowledgeBaseFeishuDocRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateKnowledgeBaseFeishuDocRequest, Builder> {
        private String description; 
        private String directoryId; 
        private String docUrl; 
        private String name; 
        ...
        private Builder(CreateKnowledgeBaseFeishuDocRequest request) {
            super(request);
        ...
        @Override
        public CreateKnowledgeBaseFeishuDocRequest build() {
            return new CreateKnowledgeBaseFeishuDocRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateKnowledgeBaseFeishuDocRequest} extends {@link TeaModel}
     *
     * <p>CreateKnowledgeBaseFeishuDocRequest</p>
     */
