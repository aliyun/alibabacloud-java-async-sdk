...
/**
 * 
 * {@link CreatePersonalFeishuDocResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePersonalFeishuDocResponseBody</p>
 */
public class CreatePersonalFeishuDocResponseBody extends TeaModel {
    ...
    private CreatePersonalFeishuDocResponseBody(Builder builder) {
    ...
    public static CreatePersonalFeishuDocResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreatePersonalFeishuDocResponseBody model) {
        ...
        public CreatePersonalFeishuDocResponseBody build() {
            return new CreatePersonalFeishuDocResponseBody(this);
        } 
