...
public interface AsyncClient extends SdkAutoCloseable {
     ...
     */
    CompletableFuture<CreateGroupAliDingDocResponse> createGroupAliDingDoc(CreateGroupAliDingDocRequest request);
     ...
     */
    CompletableFuture<CreateGroupDirectoryResponse> createGroupDirectory(CreateGroupDirectoryRequest request);
     ...
     */
    CompletableFuture<CreateGroupFeishuChatResponse> createGroupFeishuChat(CreateGroupFeishuChatRequest request);
     ...
     */
    CompletableFuture<CreateGroupFileResponse> createGroupFile(CreateGroupFileRequest request);
     ...
     */
    CompletableFuture<CreateGroupPublicUrlResponse> createGroupPublicUrl(CreateGroupPublicUrlRequest request);
     ...
     */
    CompletableFuture<CreateGroupTextResponse> createGroupText(CreateGroupTextRequest request);
     ...
     */
    CompletableFuture<CreateKnowledgeBasePublicUrlResponse> createKnowledgeBasePublicUrl(CreateKnowledgeBasePublicUrlRequest request);
     ...
     */
    CompletableFuture<CreatePersonalPublicUrlResponse> createPersonalPublicUrl(CreatePersonalPublicUrlRequest request);
     ...
     */
    CompletableFuture<GetGroupSourceResponse> getGroupSource(GetGroupSourceRequest request);
     ...
     */
    CompletableFuture<ListGroupDirectoriesResponse> listGroupDirectories(ListGroupDirectoriesRequest request);
     ...
     */
    CompletableFuture<ListGroupDirectoryResponse> listGroupDirectory(ListGroupDirectoryRequest request);
     ...
     */
    CompletableFuture<MoveGroupResourceResponse> moveGroupResource(MoveGroupResourceRequest request);
     ...
     */
    CompletableFuture<PreviewGroupSourceResponse> previewGroupSource(PreviewGroupSourceRequest request);
     ...
     */
    CompletableFuture<ReparseGroupSourceResponse> reparseGroupSource(ReparseGroupSourceRequest request);
     ...
     */
    CompletableFuture<ReplaceGroupSourceFileResponse> replaceGroupSourceFile(ReplaceGroupSourceFileRequest request);
     ...
     */
    CompletableFuture<SaveGraphDraftBatchDefineResponse> saveGraphDraftBatchDefine(SaveGraphDraftBatchDefineRequest request);
...
<ReturnT> CompletableFuture<ReturnT> streamChatMessageWithAsyncResponseHandler(StreamChatMessageRequest request, AsyncResponseHandler<StreamChatMessageResponse, ReturnT> responseHandler);
     ...
     */
    CompletableFuture<UpdateGroupDirectoryResponse> updateGroupDirectory(UpdateGroupDirectoryRequest request);
     ...
     */
    CompletableFuture<UpdateGroupSourceContentResponse> updateGroupSourceContent(UpdateGroupSourceContentRequest request);
