...
/**
 * 
 * {@link ReplaceKnowledgeBaseSourceFileResponseBody} extends {@link TeaModel}
 *
 * <p>ReplaceKnowledgeBaseSourceFileResponseBody</p>
 */
public class ReplaceKnowledgeBaseSourceFileResponseBody extends TeaModel {
    ...
    private ReplaceKnowledgeBaseSourceFileResponseBody(Builder builder) {
    ...
    public static ReplaceKnowledgeBaseSourceFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReplaceKnowledgeBaseSourceFileResponseBody model) {
        ...
        public ReplaceKnowledgeBaseSourceFileResponseBody build() {
            return new ReplaceKnowledgeBaseSourceFileResponseBody(this);
        } 
