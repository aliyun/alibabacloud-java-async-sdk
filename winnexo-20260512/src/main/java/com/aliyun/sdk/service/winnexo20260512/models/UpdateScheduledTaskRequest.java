...
/**
 * 
 * {@link UpdateScheduledTaskRequest} extends {@link RequestModel}
 *
 * <p>UpdateScheduledTaskRequest</p>
 */
public class UpdateScheduledTaskRequest extends Request {
    ...
    public static UpdateScheduledTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateScheduledTaskRequest, Builder> {
        ...
        private Builder(UpdateScheduledTaskRequest request) {
            super(request);
        ...
        public UpdateScheduledTaskRequest build() {
            return new UpdateScheduledTaskRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateScheduledTaskRequest} extends {@link TeaModel}
     *
     * <p>UpdateScheduledTaskRequest</p>
     */
