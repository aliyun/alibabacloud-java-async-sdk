...
/**
 * 
 * {@link CreatePersonalAliDingMeetingResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePersonalAliDingMeetingResponseBody</p>
 */
public class CreatePersonalAliDingMeetingResponseBody extends TeaModel {
    ...
    private CreatePersonalAliDingMeetingResponseBody(Builder builder) {
    ...
    public static CreatePersonalAliDingMeetingResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreatePersonalAliDingMeetingResponseBody model) {
        ...
        public CreatePersonalAliDingMeetingResponseBody build() {
            return new CreatePersonalAliDingMeetingResponseBody(this);
        } 
