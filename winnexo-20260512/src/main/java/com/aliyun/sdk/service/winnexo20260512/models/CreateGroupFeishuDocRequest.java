...
/**
 * 
 * {@link CreateGroupFeishuDocRequest} extends {@link RequestModel}
 *
 * <p>CreateGroupFeishuDocRequest</p>
 */
public class CreateGroupFeishuDocRequest extends Request {
    ...
    private CreateGroupFeishuDocRequest(Builder builder) {
        super(builder);
    ...
    public static CreateGroupFeishuDocRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateGroupFeishuDocRequest, Builder> {
        private String description; 
        private String directoryId; 
        private String docUrl; 
        private String groupId; 
        ...
        private Builder(CreateGroupFeishuDocRequest request) {
            super(request);
        ...
        @Override
        public CreateGroupFeishuDocRequest build() {
            return new CreateGroupFeishuDocRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateGroupFeishuDocRequest} extends {@link TeaModel}
     *
     * <p>CreateGroupFeishuDocRequest</p>
     */
