...
/**
 * 
 * {@link RemoveUserGroupMembersResponseBody} extends {@link TeaModel}
 *
 * <p>RemoveUserGroupMembersResponseBody</p>
 */
public class RemoveUserGroupMembersResponseBody extends TeaModel {
    ...
    private RemoveUserGroupMembersResponseBody(Builder builder) {
    ...
    public static RemoveUserGroupMembersResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RemoveUserGroupMembersResponseBody model) {
        ...
        public RemoveUserGroupMembersResponseBody build() {
            return new RemoveUserGroupMembersResponseBody(this);
        } 
