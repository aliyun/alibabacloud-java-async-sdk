...
/**
 * 
 * {@link QueryModifySpecTypePriceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryModifySpecTypePriceResponseBody</p>
 */
public class QueryModifySpecTypePriceResponseBody extends TeaModel {
    ...
    private QueryModifySpecTypePriceResponseBody(Builder builder) {
    ...
    public static QueryModifySpecTypePriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryModifySpecTypePriceResponseBody model) {
        ...
        public QueryModifySpecTypePriceResponseBody build() {
            return new QueryModifySpecTypePriceResponseBody(this);
        } 
