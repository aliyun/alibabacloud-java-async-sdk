...
/**
 * 
 * {@link QueryModifyDiskTypePriceRequest} extends {@link RequestModel}
 *
 * <p>QueryModifyDiskTypePriceRequest</p>
 */
public class QueryModifyDiskTypePriceRequest extends Request {
    ...
    private QueryModifyDiskTypePriceRequest(Builder builder) {
        super(builder);
    ...
    public static QueryModifyDiskTypePriceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryModifyDiskTypePriceRequest, Builder> {
        private String regionId; 
        private String instanceId; 
        private String nodeGroupId; 
        private String promotionOptionNo; 
        ...
        private Builder(QueryModifyDiskTypePriceRequest request) {
            super(request);
        ...
        @Override
        public QueryModifyDiskTypePriceRequest build() {
            return new QueryModifyDiskTypePriceRequest(this);
        } 
