...
/**
 * 
 * {@link CreateAgentResourceRequest} extends {@link RequestModel}
 *
 * <p>CreateAgentResourceRequest</p>
 */
public class CreateAgentResourceRequest extends Request {
    ...
    private CreateAgentResourceRequest(Builder builder) {
        super(builder);
    ...
    public static CreateAgentResourceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateAgentResourceRequest, Builder> {
        private String regionId; 
        private Boolean autoRenew; 
        private Integer cu; 
        private Integer duration; 
        ...
        private Builder(CreateAgentResourceRequest request) {
            super(request);
        ...
        @Override
        public CreateAgentResourceRequest build() {
            return new CreateAgentResourceRequest(this);
        } 
