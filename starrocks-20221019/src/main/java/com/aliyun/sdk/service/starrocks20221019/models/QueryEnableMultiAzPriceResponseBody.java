...
/**
 * 
 * {@link QueryEnableMultiAzPriceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryEnableMultiAzPriceResponseBody</p>
 */
public class QueryEnableMultiAzPriceResponseBody extends TeaModel {
    ...
    private QueryEnableMultiAzPriceResponseBody(Builder builder) {
    ...
    public static QueryEnableMultiAzPriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryEnableMultiAzPriceResponseBody model) {
        ...
        public QueryEnableMultiAzPriceResponseBody build() {
            return new QueryEnableMultiAzPriceResponseBody(this);
        } 
