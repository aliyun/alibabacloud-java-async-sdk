...
/**
 * 
 * {@link QueryModifyChargeTypePriceRequest} extends {@link RequestModel}
 *
 * <p>QueryModifyChargeTypePriceRequest</p>
 */
public class QueryModifyChargeTypePriceRequest extends Request {
    ...
    private QueryModifyChargeTypePriceRequest(Builder builder) {
        super(builder);
    ...
    public static QueryModifyChargeTypePriceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryModifyChargeTypePriceRequest, Builder> {
        private String regionId; 
        private Boolean autoRenew; 
        private String billingInstanceIds; 
        private String duration; 
        ...
        private Builder(QueryModifyChargeTypePriceRequest request) {
            super(request);
        ...
        @Override
        public QueryModifyChargeTypePriceRequest build() {
            return new QueryModifyChargeTypePriceRequest(this);
        } 
