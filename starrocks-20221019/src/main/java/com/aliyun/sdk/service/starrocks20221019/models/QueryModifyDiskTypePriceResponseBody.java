...
/**
 * 
 * {@link QueryModifyDiskTypePriceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryModifyDiskTypePriceResponseBody</p>
 */
public class QueryModifyDiskTypePriceResponseBody extends TeaModel {
    ...
    private QueryModifyDiskTypePriceResponseBody(Builder builder) {
    ...
    public static QueryModifyDiskTypePriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryModifyDiskTypePriceResponseBody model) {
        ...
        public QueryModifyDiskTypePriceResponseBody build() {
            return new QueryModifyDiskTypePriceResponseBody(this);
        } 
