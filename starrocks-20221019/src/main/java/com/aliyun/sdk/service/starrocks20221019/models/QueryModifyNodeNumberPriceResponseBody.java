...
/**
 * 
 * {@link QueryModifyNodeNumberPriceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryModifyNodeNumberPriceResponseBody</p>
 */
public class QueryModifyNodeNumberPriceResponseBody extends TeaModel {
    ...
    private QueryModifyNodeNumberPriceResponseBody(Builder builder) {
    ...
    public static QueryModifyNodeNumberPriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryModifyNodeNumberPriceResponseBody model) {
        ...
        public QueryModifyNodeNumberPriceResponseBody build() {
            return new QueryModifyNodeNumberPriceResponseBody(this);
        } 
