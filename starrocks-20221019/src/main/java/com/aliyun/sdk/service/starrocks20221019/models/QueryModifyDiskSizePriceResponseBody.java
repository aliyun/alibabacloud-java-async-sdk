...
/**
 * 
 * {@link QueryModifyDiskSizePriceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryModifyDiskSizePriceResponseBody</p>
 */
public class QueryModifyDiskSizePriceResponseBody extends TeaModel {
    ...
    private QueryModifyDiskSizePriceResponseBody(Builder builder) {
    ...
    public static QueryModifyDiskSizePriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryModifyDiskSizePriceResponseBody model) {
        ...
        public QueryModifyDiskSizePriceResponseBody build() {
            return new QueryModifyDiskSizePriceResponseBody(this);
        } 
