...
/**
 * 
 * {@link EnableMultiAzRequest} extends {@link RequestModel}
 *
 * <p>EnableMultiAzRequest</p>
 */
public class EnableMultiAzRequest extends Request {
    ...
    private EnableMultiAzRequest(Builder builder) {
        super(builder);
    ...
    public static EnableMultiAzRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnableMultiAzRequest, Builder> {
        private String regionId; 
        private String instanceId; 
        private java.util.List<Observers> observers; 
        private String promotionOptionNo; 
        ...
        private Builder(EnableMultiAzRequest request) {
            super(request);
        ...
        @Override
        public EnableMultiAzRequest build() {
            return new EnableMultiAzRequest(this);
        } 
    ...
    /**
     * 
     * {@link EnableMultiAzRequest} extends {@link TeaModel}
     *
     * <p>EnableMultiAzRequest</p>
     */
