...
/**
 * 
 * {@link QueryPriceV1ResponseBody} extends {@link TeaModel}
 *
 * <p>QueryPriceV1ResponseBody</p>
 */
public class QueryPriceV1ResponseBody extends TeaModel {
    ...
    private QueryPriceV1ResponseBody(Builder builder) {
    ...
    public static QueryPriceV1ResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryPriceV1ResponseBody model) {
        ...
        public QueryPriceV1ResponseBody build() {
            return new QueryPriceV1ResponseBody(this);
        } 
