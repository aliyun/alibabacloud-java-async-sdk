...
/**
 * 
 * {@link QueryModifyDiskNumberPriceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryModifyDiskNumberPriceResponseBody</p>
 */
public class QueryModifyDiskNumberPriceResponseBody extends TeaModel {
    ...
    private QueryModifyDiskNumberPriceResponseBody(Builder builder) {
    ...
    public static QueryModifyDiskNumberPriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryModifyDiskNumberPriceResponseBody model) {
        ...
        public QueryModifyDiskNumberPriceResponseBody build() {
            return new QueryModifyDiskNumberPriceResponseBody(this);
        } 
