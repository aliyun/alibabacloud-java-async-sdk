...
public class DescribeAvailableZonesResponseBody extends TeaModel {
    ...
    public static class Data extends TeaModel {
        @com.aliyun.core.annotation.NameInMap("OfficialAvailableZones")
        private java.util.List<String> officialAvailableZones;

        @com.aliyun.core.annotation.NameInMap("TrialAvailableZones")
        private java.util.List<String> trialAvailableZones;

        private Data(Builder builder) {
            this.officialAvailableZones = builder.officialAvailableZones;
            this.trialAvailableZones = builder.trialAvailableZones;
        }
        ...
        public static final class Builder {
            ...
            private Builder(Data model) {
                this.officialAvailableZones = model.officialAvailableZones;
                this.trialAvailableZones = model.trialAvailableZones;
            } 
