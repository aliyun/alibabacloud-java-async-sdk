...
/**
 * {@link DescribeAvailableEslModelsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAvailableEslModelsResponseBody</p>
 */
public class DescribeAvailableEslModelsResponseBody extends TeaModel {
    ...
    private DescribeAvailableEslModelsResponseBody(Builder builder) {
    ...
    public static DescribeAvailableEslModelsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeAvailableEslModelsResponseBody build() {
            return new DescribeAvailableEslModelsResponseBody(this);
        } 
