...
public class BatchInsertItemsResponseBody extends TeaModel {
    ...
    private java.util.List < BatchResults> batchResults;
     ...
     * @return batchResults
     */
    public java.util.List < BatchResults> getBatchResults() {
    ...
    public static final class Builder {
         ...
         * BatchResults.
         */
        public Builder batchResults(java.util.List < BatchResults> batchResults) {
