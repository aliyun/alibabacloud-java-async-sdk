...
/**
 * {@link AbortMultipartUploadResponse} extends {@link TeaModel}
 *
 * <p>AbortMultipartUploadResponse</p>
 */
public class AbortMultipartUploadResponse extends Response {
    ...
    public interface Builder extends Response.Builder<AbortMultipartUploadResponse, Builder> {
        ...
        @Override
        AbortMultipartUploadResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<AbortMultipartUploadResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        ...
        private BuilderImpl(AbortMultipartUploadResponse response) {
            super(response);
