...
public class DeleteBucketEncryptionResponse extends Response {
    ...
    public interface Builder extends Response.Builder<DeleteBucketEncryptionResponse, Builder> {
    ...
    private static final class BuilderImpl
            extends Response.BuilderImpl<DeleteBucketEncryptionResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        ...
        private BuilderImpl(DeleteBucketEncryptionResponse response) {
            super(response);
