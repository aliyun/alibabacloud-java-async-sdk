...
/**
 * 
 * {@link GetYzdStsAKResponseBody} extends {@link TeaModel}
 *
 * <p>GetYzdStsAKResponseBody</p>
 */
public class GetYzdStsAKResponseBody extends TeaModel {
    ...
    private GetYzdStsAKResponseBody(Builder builder) {
    ...
    public static GetYzdStsAKResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetYzdStsAKResponseBody model) {
        ...
        public GetYzdStsAKResponseBody build() {
            return new GetYzdStsAKResponseBody(this);
        } 
