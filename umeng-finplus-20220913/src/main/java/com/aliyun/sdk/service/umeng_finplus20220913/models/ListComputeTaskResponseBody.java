...
/**
 * 
 * {@link ListComputeTaskResponseBody} extends {@link TeaModel}
 *
 * <p>ListComputeTaskResponseBody</p>
 */
public class ListComputeTaskResponseBody extends TeaModel {
    ...
    private ListComputeTaskResponseBody(Builder builder) {
    ...
    public static ListComputeTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListComputeTaskResponseBody model) {
        ...
        public ListComputeTaskResponseBody build() {
            return new ListComputeTaskResponseBody(this);
        } 
