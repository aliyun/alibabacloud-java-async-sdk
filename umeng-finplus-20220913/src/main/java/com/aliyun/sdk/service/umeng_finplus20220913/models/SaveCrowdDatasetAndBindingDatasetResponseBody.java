...
/**
 * 
 * {@link SaveCrowdDatasetAndBindingDatasetResponseBody} extends {@link TeaModel}
 *
 * <p>SaveCrowdDatasetAndBindingDatasetResponseBody</p>
 */
public class SaveCrowdDatasetAndBindingDatasetResponseBody extends TeaModel {
    ...
    private SaveCrowdDatasetAndBindingDatasetResponseBody(Builder builder) {
    ...
    public static SaveCrowdDatasetAndBindingDatasetResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SaveCrowdDatasetAndBindingDatasetResponseBody model) {
        ...
        public SaveCrowdDatasetAndBindingDatasetResponseBody build() {
            return new SaveCrowdDatasetAndBindingDatasetResponseBody(this);
        } 
