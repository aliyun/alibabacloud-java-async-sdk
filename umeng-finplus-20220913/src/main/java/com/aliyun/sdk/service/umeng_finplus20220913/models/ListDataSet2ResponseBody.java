...
/**
 * 
 * {@link ListDataSet2ResponseBody} extends {@link TeaModel}
 *
 * <p>ListDataSet2ResponseBody</p>
 */
public class ListDataSet2ResponseBody extends TeaModel {
    ...
    private ListDataSet2ResponseBody(Builder builder) {
    ...
    public static ListDataSet2ResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListDataSet2ResponseBody model) {
        ...
        public ListDataSet2ResponseBody build() {
            return new ListDataSet2ResponseBody(this);
        } 
