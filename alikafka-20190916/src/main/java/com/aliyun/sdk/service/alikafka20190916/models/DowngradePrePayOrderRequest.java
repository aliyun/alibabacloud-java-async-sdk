...
/**
 * 
 * {@link DowngradePrePayOrderRequest} extends {@link RequestModel}
 *
 * <p>DowngradePrePayOrderRequest</p>
 */
public class DowngradePrePayOrderRequest extends Request {
    ...
    private DowngradePrePayOrderRequest(Builder builder) {
        super(builder);
    ...
    public static DowngradePrePayOrderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DowngradePrePayOrderRequest, Builder> {
        private ConfluentConfig confluentConfig; 
        private Integer diskSize; 
        private Integer eipMax; 
        private Boolean eipModel; 
        ...
        private Builder(DowngradePrePayOrderRequest request) {
            super(request);
        ...
        @Override
        public DowngradePrePayOrderRequest build() {
            return new DowngradePrePayOrderRequest(this);
        } 
    ...
    /**
     * 
     * {@link DowngradePrePayOrderRequest} extends {@link TeaModel}
     *
     * <p>DowngradePrePayOrderRequest</p>
     */
