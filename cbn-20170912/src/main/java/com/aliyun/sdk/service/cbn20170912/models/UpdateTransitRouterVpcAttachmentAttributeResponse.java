...
public class UpdateTransitRouterVpcAttachmentAttributeResponse extends Response {
    ...
    private UpdateTransitRouterVpcAttachmentAttributeResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<UpdateTransitRouterVpcAttachmentAttributeResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(UpdateTransitRouterVpcAttachmentAttributeResponseBody body);

        @Override
        UpdateTransitRouterVpcAttachmentAttributeResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<UpdateTransitRouterVpcAttachmentAttributeResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private UpdateTransitRouterVpcAttachmentAttributeResponseBody body; 
        ...
        private BuilderImpl(UpdateTransitRouterVpcAttachmentAttributeResponse response) {
            super(response);
