...
public class CreateTransitRouterVbrAttachmentResponse extends Response {
    ...
    private CreateTransitRouterVbrAttachmentResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<CreateTransitRouterVbrAttachmentResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(CreateTransitRouterVbrAttachmentResponseBody body);

        @Override
        CreateTransitRouterVbrAttachmentResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<CreateTransitRouterVbrAttachmentResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private CreateTransitRouterVbrAttachmentResponseBody body; 
        ...
        private BuilderImpl(CreateTransitRouterVbrAttachmentResponse response) {
            super(response);
