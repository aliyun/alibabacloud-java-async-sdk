...
/**
 * {@link DeleteTransitRouterPrefixListAssociationRequest} extends {@link RequestModel}
 *
 * <p>DeleteTransitRouterPrefixListAssociationRequest</p>
 */
public class DeleteTransitRouterPrefixListAssociationRequest extends Request {
    @Query
    ...
    private DeleteTransitRouterPrefixListAssociationRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteTransitRouterPrefixListAssociationRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteTransitRouterPrefixListAssociationRequest, Builder> {
        private String clientToken; 
        private Boolean dryRun; 
        private String nextHop; 
        private String nextHopType; 
        ...
        private Builder(DeleteTransitRouterPrefixListAssociationRequest request) {
            super(request);
        ...
        @Override
        public DeleteTransitRouterPrefixListAssociationRequest build() {
            return new DeleteTransitRouterPrefixListAssociationRequest(this);
        } 
