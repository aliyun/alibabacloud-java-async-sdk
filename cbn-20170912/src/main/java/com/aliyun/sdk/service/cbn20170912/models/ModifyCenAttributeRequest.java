 ...
 */
public class ModifyCenAttributeRequest extends Request {
    ...
    private ModifyCenAttributeRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyCenAttributeRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyCenAttributeRequest, Builder> {
        private String cenId; 
        private String description; 
        private String name; 
        private String ownerAccount; 
        ...
        public ModifyCenAttributeRequest build() {
            return new ModifyCenAttributeRequest(this);
        } 
