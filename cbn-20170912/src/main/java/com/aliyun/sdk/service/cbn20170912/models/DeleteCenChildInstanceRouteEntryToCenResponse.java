...
public class DeleteCenChildInstanceRouteEntryToCenResponse extends Response {
    ...
    private DeleteCenChildInstanceRouteEntryToCenResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<DeleteCenChildInstanceRouteEntryToCenResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(DeleteCenChildInstanceRouteEntryToCenResponseBody body);

        @Override
        DeleteCenChildInstanceRouteEntryToCenResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<DeleteCenChildInstanceRouteEntryToCenResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private DeleteCenChildInstanceRouteEntryToCenResponseBody body; 
        ...
        private BuilderImpl(DeleteCenChildInstanceRouteEntryToCenResponse response) {
            super(response);
