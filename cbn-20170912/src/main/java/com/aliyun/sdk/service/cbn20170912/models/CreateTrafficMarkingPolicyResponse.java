...
public class CreateTrafficMarkingPolicyResponse extends Response {
    ...
    private CreateTrafficMarkingPolicyResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<CreateTrafficMarkingPolicyResponse, Builder> {

        Builder headers(java.util.Map<String, String> headers);

        Builder statusCode(Integer statusCode);

        Builder body(CreateTrafficMarkingPolicyResponseBody body);

        @Override
        CreateTrafficMarkingPolicyResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<CreateTrafficMarkingPolicyResponse, Builder>
            implements Builder {
        private java.util.Map<String, String> headers; 
        private Integer statusCode; 
        private CreateTrafficMarkingPolicyResponseBody body; 
        ...
        private BuilderImpl(CreateTrafficMarkingPolicyResponse response) {
            super(response);
