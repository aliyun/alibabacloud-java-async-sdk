...
@Override
    ...
    public static final class Builder extends Request.Builder<DisableTransitRouterRouteTablePropagationRequest, Builder> {
         ...
         * <ul>
         * <li><strong>false</strong> (default): Sends a normal request. If the request passes the check, the route learning relationship is removed.</li>
         * <li><strong>true</strong>: Sends a check request. Only the validation is performed, and the route learning relationship is not removed. The system checks whether the required parameters are specified and whether the request format is valid. If the check fails, the corresponding error is returned. If the check passes, the error code <code>DryRunOperation</code> is returned.</li>
         * </ul>
         * 
         * <strong>example:</strong>
         * <p>false</p>
