 ...
 */
public class ListTransitRouterCidrRequest extends Request {
    @Query
    ...
    private ListTransitRouterCidrRequest(Builder builder) {
        super(builder);
    ...
    public static ListTransitRouterCidrRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListTransitRouterCidrRequest, Builder> {
        private String clientToken; 
        private Boolean dryRun; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ListTransitRouterCidrRequest request) {
            super(request);
        ...
        @Override
        public ListTransitRouterCidrRequest build() {
            return new ListTransitRouterCidrRequest(this);
        } 
