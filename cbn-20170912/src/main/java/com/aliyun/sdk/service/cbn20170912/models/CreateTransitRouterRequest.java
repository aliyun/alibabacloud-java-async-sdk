...
public class CreateTransitRouterRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<CreateTransitRouterRequest, Builder> {
        ...
        private Builder(CreateTransitRouterRequest response) {
            super(response);
            ...
            this.transitRouterDescription = response.transitRouterDescription;
            this.transitRouterName = response.transitRouterName;
        } 
