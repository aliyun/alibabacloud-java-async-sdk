...
public class DescribeGeographicRegionMembershipRequest extends Request {
    ...
    private DescribeGeographicRegionMembershipRequest(Builder builder) {
        super(builder);
        this.geographicRegionId = builder.geographicRegionId;
    ...
    public static DescribeGeographicRegionMembershipRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeGeographicRegionMembershipRequest, Builder> {
        private String geographicRegionId; 
        private String ownerAccount; 
        private Long ownerId; 
        private Integer pageNumber; 
        ...
        @Override
        public DescribeGeographicRegionMembershipRequest build() {
            return new DescribeGeographicRegionMembershipRequest(this);
        } 
