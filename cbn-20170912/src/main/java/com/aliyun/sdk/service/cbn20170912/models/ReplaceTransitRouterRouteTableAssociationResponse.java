...
public class ReplaceTransitRouterRouteTableAssociationResponse extends Response {
    ...
    private ReplaceTransitRouterRouteTableAssociationResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ReplaceTransitRouterRouteTableAssociationResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ReplaceTransitRouterRouteTableAssociationResponseBody body);

        @Override
        ReplaceTransitRouterRouteTableAssociationResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ReplaceTransitRouterRouteTableAssociationResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ReplaceTransitRouterRouteTableAssociationResponseBody body; 
        ...
        private BuilderImpl(ReplaceTransitRouterRouteTableAssociationResponse response) {
            super(response);
