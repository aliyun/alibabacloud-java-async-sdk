...
public class CreateCenChildInstanceRouteEntryToAttachmentResponse extends Response {
    ...
    private CreateCenChildInstanceRouteEntryToAttachmentResponse(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends Response.Builder {
        ...
        private Builder(CreateCenChildInstanceRouteEntryToAttachmentResponse response) {
            super(response);
