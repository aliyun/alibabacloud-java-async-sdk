...
public class DeleteCenChildInstanceRouteEntryToAttachmentResponse extends Response {
    ...
    private DeleteCenChildInstanceRouteEntryToAttachmentResponse(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends Response.Builder {
        ...
        private Builder(DeleteCenChildInstanceRouteEntryToAttachmentResponse response) {
            super(response);
