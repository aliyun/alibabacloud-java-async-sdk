...
public class AssociateTransitRouterAttachmentWithRouteTableResponse extends Response {
    ...
    private AssociateTransitRouterAttachmentWithRouteTableResponse(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends Response.Builder {
        ...
        private Builder(AssociateTransitRouterAttachmentWithRouteTableResponse response) {
            super(response);
