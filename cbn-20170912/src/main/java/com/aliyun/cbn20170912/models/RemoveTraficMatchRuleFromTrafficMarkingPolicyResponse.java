...
public class RemoveTraficMatchRuleFromTrafficMarkingPolicyResponse extends Response {
    ...
    private RemoveTraficMatchRuleFromTrafficMarkingPolicyResponse(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends Response.Builder {
        ...
        private Builder(RemoveTraficMatchRuleFromTrafficMarkingPolicyResponse response) {
            super(response);
