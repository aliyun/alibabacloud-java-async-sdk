...
/**
 * 
 * {@link ListAppCommoditySpecificationsForPartnerResponseBody} extends {@link TeaModel}
 *
 * <p>ListAppCommoditySpecificationsForPartnerResponseBody</p>
 */
public class ListAppCommoditySpecificationsForPartnerResponseBody extends TeaModel {
    ...
    private ListAppCommoditySpecificationsForPartnerResponseBody(Builder builder) {
    ...
    public static ListAppCommoditySpecificationsForPartnerResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAppCommoditySpecificationsForPartnerResponseBody model) {
        ...
        public ListAppCommoditySpecificationsForPartnerResponseBody build() {
            return new ListAppCommoditySpecificationsForPartnerResponseBody(this);
        } 
    ...
    public static class Module extends TeaModel {
        ...
        private java.util.Map<String, ModuleVersionsValue> versions;
        ...
        public static final class Builder {
             ...
             * Versions.
             */
            public Builder versions(java.util.Map<String, ModuleVersionsValue> versions) {
