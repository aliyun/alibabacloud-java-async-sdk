...
/**
 * 
 * {@link CopyAppPluginConfigResponseBody} extends {@link TeaModel}
 *
 * <p>CopyAppPluginConfigResponseBody</p>
 */
public class CopyAppPluginConfigResponseBody extends TeaModel {
    ...
    private CopyAppPluginConfigResponseBody(Builder builder) {
    ...
    public static CopyAppPluginConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CopyAppPluginConfigResponseBody model) {
        ...
        public CopyAppPluginConfigResponseBody build() {
            return new CopyAppPluginConfigResponseBody(this);
        } 
