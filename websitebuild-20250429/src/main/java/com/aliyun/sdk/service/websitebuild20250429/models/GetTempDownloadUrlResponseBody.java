...
/**
 * 
 * {@link GetTempDownloadUrlResponseBody} extends {@link TeaModel}
 *
 * <p>GetTempDownloadUrlResponseBody</p>
 */
public class GetTempDownloadUrlResponseBody extends TeaModel {
    ...
    private GetTempDownloadUrlResponseBody(Builder builder) {
    ...
    public static GetTempDownloadUrlResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetTempDownloadUrlResponseBody model) {
        ...
        public GetTempDownloadUrlResponseBody build() {
            return new GetTempDownloadUrlResponseBody(this);
        } 
