...
/**
 * 
 * {@link OfflineAppInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>OfflineAppInstanceResponseBody</p>
 */
public class OfflineAppInstanceResponseBody extends TeaModel {
    ...
    private OfflineAppInstanceResponseBody(Builder builder) {
    ...
    public static OfflineAppInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OfflineAppInstanceResponseBody model) {
        ...
        public OfflineAppInstanceResponseBody build() {
            return new OfflineAppInstanceResponseBody(this);
        } 
