...
/**
 * 
 * {@link EditPluginConfigResponseBody} extends {@link TeaModel}
 *
 * <p>EditPluginConfigResponseBody</p>
 */
public class EditPluginConfigResponseBody extends TeaModel {
    ...
    private EditPluginConfigResponseBody(Builder builder) {
    ...
    public static EditPluginConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EditPluginConfigResponseBody model) {
        ...
        public EditPluginConfigResponseBody build() {
            return new EditPluginConfigResponseBody(this);
        } 
