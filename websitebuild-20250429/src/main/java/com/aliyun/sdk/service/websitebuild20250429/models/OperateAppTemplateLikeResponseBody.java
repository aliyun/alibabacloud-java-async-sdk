...
/**
 * 
 * {@link OperateAppTemplateLikeResponseBody} extends {@link TeaModel}
 *
 * <p>OperateAppTemplateLikeResponseBody</p>
 */
public class OperateAppTemplateLikeResponseBody extends TeaModel {
    ...
    private OperateAppTemplateLikeResponseBody(Builder builder) {
    ...
    public static OperateAppTemplateLikeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OperateAppTemplateLikeResponseBody model) {
        ...
        public OperateAppTemplateLikeResponseBody build() {
            return new OperateAppTemplateLikeResponseBody(this);
        } 
