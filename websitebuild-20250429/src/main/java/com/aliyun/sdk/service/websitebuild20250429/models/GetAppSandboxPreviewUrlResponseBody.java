...
/**
 * 
 * {@link GetAppSandboxPreviewUrlResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppSandboxPreviewUrlResponseBody</p>
 */
public class GetAppSandboxPreviewUrlResponseBody extends TeaModel {
    ...
    private GetAppSandboxPreviewUrlResponseBody(Builder builder) {
    ...
    public static GetAppSandboxPreviewUrlResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppSandboxPreviewUrlResponseBody model) {
        ...
        public GetAppSandboxPreviewUrlResponseBody build() {
            return new GetAppSandboxPreviewUrlResponseBody(this);
        } 
