...
/**
 * 
 * {@link UpdateAppFileResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAppFileResponseBody</p>
 */
public class UpdateAppFileResponseBody extends TeaModel {
    ...
    private UpdateAppFileResponseBody(Builder builder) {
    ...
    public static UpdateAppFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAppFileResponseBody model) {
        ...
        public UpdateAppFileResponseBody build() {
            return new UpdateAppFileResponseBody(this);
        } 
