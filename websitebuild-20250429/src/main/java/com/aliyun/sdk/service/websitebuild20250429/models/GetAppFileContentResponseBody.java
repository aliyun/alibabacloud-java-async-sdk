...
/**
 * 
 * {@link GetAppFileContentResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppFileContentResponseBody</p>
 */
public class GetAppFileContentResponseBody extends TeaModel {
    ...
    private GetAppFileContentResponseBody(Builder builder) {
    ...
    public static GetAppFileContentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppFileContentResponseBody model) {
        ...
        public GetAppFileContentResponseBody build() {
            return new GetAppFileContentResponseBody(this);
        } 
