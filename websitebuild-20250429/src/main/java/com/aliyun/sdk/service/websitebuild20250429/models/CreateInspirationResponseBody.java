...
/**
 * 
 * {@link CreateInspirationResponseBody} extends {@link TeaModel}
 *
 * <p>CreateInspirationResponseBody</p>
 */
public class CreateInspirationResponseBody extends TeaModel {
    ...
    private CreateInspirationResponseBody(Builder builder) {
    ...
    public static CreateInspirationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateInspirationResponseBody model) {
        ...
        public CreateInspirationResponseBody build() {
            return new CreateInspirationResponseBody(this);
        } 
