...
/**
 * 
 * {@link DeleteAppDomainRedirectResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteAppDomainRedirectResponseBody</p>
 */
public class DeleteAppDomainRedirectResponseBody extends TeaModel {
    ...
    private DeleteAppDomainRedirectResponseBody(Builder builder) {
    ...
    public static DeleteAppDomainRedirectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteAppDomainRedirectResponseBody model) {
        ...
        public DeleteAppDomainRedirectResponseBody build() {
            return new DeleteAppDomainRedirectResponseBody(this);
        } 
