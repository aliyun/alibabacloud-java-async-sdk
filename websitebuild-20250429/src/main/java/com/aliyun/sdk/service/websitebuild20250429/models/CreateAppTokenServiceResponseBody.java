...
/**
 * 
 * {@link CreateAppTokenServiceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAppTokenServiceResponseBody</p>
 */
public class CreateAppTokenServiceResponseBody extends TeaModel {
    ...
    private CreateAppTokenServiceResponseBody(Builder builder) {
    ...
    public static CreateAppTokenServiceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAppTokenServiceResponseBody model) {
        ...
        public CreateAppTokenServiceResponseBody build() {
            return new CreateAppTokenServiceResponseBody(this);
        } 
