...
/**
 * 
 * {@link CreateAIStaffChatResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAIStaffChatResponseBody</p>
 */
public class CreateAIStaffChatResponseBody extends TeaModel {
    ...
    private CreateAIStaffChatResponseBody(Builder builder) {
    ...
    public static CreateAIStaffChatResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAIStaffChatResponseBody model) {
        ...
        public CreateAIStaffChatResponseBody build() {
            return new CreateAIStaffChatResponseBody(this);
        } 
