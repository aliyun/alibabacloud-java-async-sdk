...
/**
 * 
 * {@link ListAppPluginFilesResponseBody} extends {@link TeaModel}
 *
 * <p>ListAppPluginFilesResponseBody</p>
 */
public class ListAppPluginFilesResponseBody extends TeaModel {
    ...
    private ListAppPluginFilesResponseBody(Builder builder) {
    ...
    public static ListAppPluginFilesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAppPluginFilesResponseBody model) {
        ...
        public ListAppPluginFilesResponseBody build() {
            return new ListAppPluginFilesResponseBody(this);
        } 
