...
/**
 * 
 * {@link MoveMaterialFileResponseBody} extends {@link TeaModel}
 *
 * <p>MoveMaterialFileResponseBody</p>
 */
public class MoveMaterialFileResponseBody extends TeaModel {
    ...
    private MoveMaterialFileResponseBody(Builder builder) {
    ...
    public static MoveMaterialFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(MoveMaterialFileResponseBody model) {
        ...
        public MoveMaterialFileResponseBody build() {
            return new MoveMaterialFileResponseBody(this);
        } 
