...
/**
 * 
 * {@link QueryInspirationBalanceResponseBody} extends {@link TeaModel}
 *
 * <p>QueryInspirationBalanceResponseBody</p>
 */
public class QueryInspirationBalanceResponseBody extends TeaModel {
    ...
    private QueryInspirationBalanceResponseBody(Builder builder) {
    ...
    public static QueryInspirationBalanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryInspirationBalanceResponseBody model) {
        ...
        public QueryInspirationBalanceResponseBody build() {
            return new QueryInspirationBalanceResponseBody(this);
        } 
