...
/**
 * 
 * {@link DeleteRbacPermissionResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteRbacPermissionResponseBody</p>
 */
public class DeleteRbacPermissionResponseBody extends TeaModel {
    ...
    private DeleteRbacPermissionResponseBody(Builder builder) {
    ...
    public static DeleteRbacPermissionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteRbacPermissionResponseBody model) {
        ...
        public DeleteRbacPermissionResponseBody build() {
            return new DeleteRbacPermissionResponseBody(this);
        } 
