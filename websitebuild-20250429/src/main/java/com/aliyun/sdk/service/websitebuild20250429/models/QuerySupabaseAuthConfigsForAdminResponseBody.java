...
/**
 * 
 * {@link QuerySupabaseAuthConfigsForAdminResponseBody} extends {@link TeaModel}
 *
 * <p>QuerySupabaseAuthConfigsForAdminResponseBody</p>
 */
public class QuerySupabaseAuthConfigsForAdminResponseBody extends TeaModel {
    ...
    private QuerySupabaseAuthConfigsForAdminResponseBody(Builder builder) {
    ...
    public static QuerySupabaseAuthConfigsForAdminResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QuerySupabaseAuthConfigsForAdminResponseBody model) {
        ...
        public QuerySupabaseAuthConfigsForAdminResponseBody build() {
            return new QuerySupabaseAuthConfigsForAdminResponseBody(this);
        } 
