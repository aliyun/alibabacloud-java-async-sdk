...
/**
 * 
 * {@link CheckResourceMeasureResponseBody} extends {@link TeaModel}
 *
 * <p>CheckResourceMeasureResponseBody</p>
 */
public class CheckResourceMeasureResponseBody extends TeaModel {
    ...
    private CheckResourceMeasureResponseBody(Builder builder) {
    ...
    public static CheckResourceMeasureResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CheckResourceMeasureResponseBody model) {
        ...
        public CheckResourceMeasureResponseBody build() {
            return new CheckResourceMeasureResponseBody(this);
        } 
