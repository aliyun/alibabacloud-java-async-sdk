...
/**
 * 
 * {@link ExportMaterialFileResponseBody} extends {@link TeaModel}
 *
 * <p>ExportMaterialFileResponseBody</p>
 */
public class ExportMaterialFileResponseBody extends TeaModel {
    ...
    private ExportMaterialFileResponseBody(Builder builder) {
    ...
    public static ExportMaterialFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExportMaterialFileResponseBody model) {
        ...
        public ExportMaterialFileResponseBody build() {
            return new ExportMaterialFileResponseBody(this);
        } 
