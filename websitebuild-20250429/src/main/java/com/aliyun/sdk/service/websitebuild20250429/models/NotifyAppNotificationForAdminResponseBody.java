...
/**
 * 
 * {@link NotifyAppNotificationForAdminResponseBody} extends {@link TeaModel}
 *
 * <p>NotifyAppNotificationForAdminResponseBody</p>
 */
public class NotifyAppNotificationForAdminResponseBody extends TeaModel {
    ...
    private NotifyAppNotificationForAdminResponseBody(Builder builder) {
    ...
    public static NotifyAppNotificationForAdminResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(NotifyAppNotificationForAdminResponseBody model) {
        ...
        public NotifyAppNotificationForAdminResponseBody build() {
            return new NotifyAppNotificationForAdminResponseBody(this);
        } 
