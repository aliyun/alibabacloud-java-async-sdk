...
/**
 * 
 * {@link CheckAppVerifyCodeResponseBody} extends {@link TeaModel}
 *
 * <p>CheckAppVerifyCodeResponseBody</p>
 */
public class CheckAppVerifyCodeResponseBody extends TeaModel {
    ...
    private CheckAppVerifyCodeResponseBody(Builder builder) {
    ...
    public static CheckAppVerifyCodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CheckAppVerifyCodeResponseBody model) {
        ...
        public CheckAppVerifyCodeResponseBody build() {
            return new CheckAppVerifyCodeResponseBody(this);
        } 
    ...
    public static class Module extends TeaModel {
        @com.aliyun.core.annotation.NameInMap("MaskedTarget")
        ...
        private Module(Builder builder) {
            this.maskedTarget = builder.maskedTarget;
        ...
        public static final class Builder {
            ...
            private Builder(Module model) {
                this.maskedTarget = model.maskedTarget;
             ...
             * MaskedTarget.
             */
            public Builder maskedTarget(String maskedTarget) {
