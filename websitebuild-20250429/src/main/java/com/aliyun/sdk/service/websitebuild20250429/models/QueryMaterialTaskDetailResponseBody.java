...
/**
 * 
 * {@link QueryMaterialTaskDetailResponseBody} extends {@link TeaModel}
 *
 * <p>QueryMaterialTaskDetailResponseBody</p>
 */
public class QueryMaterialTaskDetailResponseBody extends TeaModel {
    ...
    private AppMaterialTask module;
    ...
    private QueryMaterialTaskDetailResponseBody(Builder builder) {
    ...
    public static QueryMaterialTaskDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryMaterialTaskDetailResponseBody model) {
         ...
         * Module.
         */
        public Builder module(AppMaterialTask module) {
            this.module = module;
            return this;
        }
        ...
        public QueryMaterialTaskDetailResponseBody build() {
            return new QueryMaterialTaskDetailResponseBody(this);
        } 
