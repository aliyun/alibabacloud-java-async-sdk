...
/**
 * 
 * {@link OnlineAppInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>OnlineAppInstanceResponseBody</p>
 */
public class OnlineAppInstanceResponseBody extends TeaModel {
    ...
    private OnlineAppInstanceResponseBody(Builder builder) {
    ...
    public static OnlineAppInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OnlineAppInstanceResponseBody model) {
        ...
        public OnlineAppInstanceResponseBody build() {
            return new OnlineAppInstanceResponseBody(this);
        } 
