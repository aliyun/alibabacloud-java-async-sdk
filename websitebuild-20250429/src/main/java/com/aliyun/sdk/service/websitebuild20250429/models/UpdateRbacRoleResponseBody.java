...
/**
 * 
 * {@link UpdateRbacRoleResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateRbacRoleResponseBody</p>
 */
public class UpdateRbacRoleResponseBody extends TeaModel {
    ...
    private UpdateRbacRoleResponseBody(Builder builder) {
    ...
    public static UpdateRbacRoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateRbacRoleResponseBody model) {
        ...
        public UpdateRbacRoleResponseBody build() {
            return new UpdateRbacRoleResponseBody(this);
        } 
