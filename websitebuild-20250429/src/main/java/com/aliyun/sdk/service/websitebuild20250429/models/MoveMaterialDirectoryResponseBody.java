...
/**
 * 
 * {@link MoveMaterialDirectoryResponseBody} extends {@link TeaModel}
 *
 * <p>MoveMaterialDirectoryResponseBody</p>
 */
public class MoveMaterialDirectoryResponseBody extends TeaModel {
    ...
    private MoveMaterialDirectoryResponseBody(Builder builder) {
    ...
    public static MoveMaterialDirectoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(MoveMaterialDirectoryResponseBody model) {
        ...
        public MoveMaterialDirectoryResponseBody build() {
            return new MoveMaterialDirectoryResponseBody(this);
        } 
