...
/**
 * 
 * {@link GetAppConversationLockStatusResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppConversationLockStatusResponseBody</p>
 */
public class GetAppConversationLockStatusResponseBody extends TeaModel {
    ...
    private GetAppConversationLockStatusResponseBody(Builder builder) {
    ...
    public static GetAppConversationLockStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppConversationLockStatusResponseBody model) {
        ...
        public GetAppConversationLockStatusResponseBody build() {
            return new GetAppConversationLockStatusResponseBody(this);
        } 
