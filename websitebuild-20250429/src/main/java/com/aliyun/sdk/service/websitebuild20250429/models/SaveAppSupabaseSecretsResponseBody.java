...
/**
 * 
 * {@link SaveAppSupabaseSecretsResponseBody} extends {@link TeaModel}
 *
 * <p>SaveAppSupabaseSecretsResponseBody</p>
 */
public class SaveAppSupabaseSecretsResponseBody extends TeaModel {
    ...
    private SaveAppSupabaseSecretsResponseBody(Builder builder) {
    ...
    public static SaveAppSupabaseSecretsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SaveAppSupabaseSecretsResponseBody model) {
        ...
        public SaveAppSupabaseSecretsResponseBody build() {
            return new SaveAppSupabaseSecretsResponseBody(this);
        } 
