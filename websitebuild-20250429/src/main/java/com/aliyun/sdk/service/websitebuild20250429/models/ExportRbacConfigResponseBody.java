...
/**
 * 
 * {@link ExportRbacConfigResponseBody} extends {@link TeaModel}
 *
 * <p>ExportRbacConfigResponseBody</p>
 */
public class ExportRbacConfigResponseBody extends TeaModel {
    ...
    private ExportRbacConfigResponseBody(Builder builder) {
    ...
    public static ExportRbacConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExportRbacConfigResponseBody model) {
        ...
        public ExportRbacConfigResponseBody build() {
            return new ExportRbacConfigResponseBody(this);
        } 
