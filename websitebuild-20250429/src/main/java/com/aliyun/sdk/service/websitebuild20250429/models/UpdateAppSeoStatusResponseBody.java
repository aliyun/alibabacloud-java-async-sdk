...
/**
 * 
 * {@link UpdateAppSeoStatusResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAppSeoStatusResponseBody</p>
 */
public class UpdateAppSeoStatusResponseBody extends TeaModel {
    ...
    private UpdateAppSeoStatusResponseBody(Builder builder) {
    ...
    public static UpdateAppSeoStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAppSeoStatusResponseBody model) {
        ...
        public UpdateAppSeoStatusResponseBody build() {
            return new UpdateAppSeoStatusResponseBody(this);
        } 
