...
/**
 * 
 * {@link PushResourceMeasureResponseBody} extends {@link TeaModel}
 *
 * <p>PushResourceMeasureResponseBody</p>
 */
public class PushResourceMeasureResponseBody extends TeaModel {
    ...
    private PushResourceMeasureResponseBody(Builder builder) {
    ...
    public static PushResourceMeasureResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PushResourceMeasureResponseBody model) {
        ...
        public PushResourceMeasureResponseBody build() {
            return new PushResourceMeasureResponseBody(this);
        } 
