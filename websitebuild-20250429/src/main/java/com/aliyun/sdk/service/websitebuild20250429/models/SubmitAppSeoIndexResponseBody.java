...
/**
 * 
 * {@link SubmitAppSeoIndexResponseBody} extends {@link TeaModel}
 *
 * <p>SubmitAppSeoIndexResponseBody</p>
 */
public class SubmitAppSeoIndexResponseBody extends TeaModel {
    ...
    private SubmitAppSeoIndexResponseBody(Builder builder) {
    ...
    public static SubmitAppSeoIndexResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SubmitAppSeoIndexResponseBody model) {
        ...
        public SubmitAppSeoIndexResponseBody build() {
            return new SubmitAppSeoIndexResponseBody(this);
        } 
