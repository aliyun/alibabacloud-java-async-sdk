...
/**
 * 
 * {@link RevokeRbacUserRoleResponseBody} extends {@link TeaModel}
 *
 * <p>RevokeRbacUserRoleResponseBody</p>
 */
public class RevokeRbacUserRoleResponseBody extends TeaModel {
    ...
    private RevokeRbacUserRoleResponseBody(Builder builder) {
    ...
    public static RevokeRbacUserRoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RevokeRbacUserRoleResponseBody model) {
        ...
        public RevokeRbacUserRoleResponseBody build() {
            return new RevokeRbacUserRoleResponseBody(this);
        } 
