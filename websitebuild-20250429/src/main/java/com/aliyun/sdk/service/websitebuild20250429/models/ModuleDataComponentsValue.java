...
/**
 * 
 * {@link ModuleDataComponentsValue} extends {@link TeaModel}
 *
 * <p>ModuleDataComponentsValue</p>
 */
public class ModuleDataComponentsValue extends TeaModel {
    ...
    private java.util.Map<String, ModuleDataComponentsValuePropertiesValue> properties;

    @com.aliyun.core.annotation.NameInMap("ModuleAttrStatus")
    private Integer moduleAttrStatus;

    private ModuleDataComponentsValue(Builder builder) {
    ...
    public static ModuleDataComponentsValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleDataComponentsValue model) {
         ...
         * Properties.
         */
        public Builder properties(java.util.Map<String, ModuleDataComponentsValuePropertiesValue> properties) {
        ...
        public ModuleDataComponentsValue build() {
            return new ModuleDataComponentsValue(this);
        } 
