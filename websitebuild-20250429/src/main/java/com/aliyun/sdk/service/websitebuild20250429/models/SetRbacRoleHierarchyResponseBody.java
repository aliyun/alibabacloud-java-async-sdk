...
/**
 * 
 * {@link SetRbacRoleHierarchyResponseBody} extends {@link TeaModel}
 *
 * <p>SetRbacRoleHierarchyResponseBody</p>
 */
public class SetRbacRoleHierarchyResponseBody extends TeaModel {
    ...
    private SetRbacRoleHierarchyResponseBody(Builder builder) {
    ...
    public static SetRbacRoleHierarchyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SetRbacRoleHierarchyResponseBody model) {
        ...
        public SetRbacRoleHierarchyResponseBody build() {
            return new SetRbacRoleHierarchyResponseBody(this);
        } 
