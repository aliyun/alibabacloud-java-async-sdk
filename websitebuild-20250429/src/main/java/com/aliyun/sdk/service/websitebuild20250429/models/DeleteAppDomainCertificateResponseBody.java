...
/**
 * 
 * {@link DeleteAppDomainCertificateResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteAppDomainCertificateResponseBody</p>
 */
public class DeleteAppDomainCertificateResponseBody extends TeaModel {
    ...
    private DeleteAppDomainCertificateResponseBody(Builder builder) {
    ...
    public static DeleteAppDomainCertificateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteAppDomainCertificateResponseBody model) {
        ...
        public DeleteAppDomainCertificateResponseBody build() {
            return new DeleteAppDomainCertificateResponseBody(this);
        } 
