...
/**
 * 
 * {@link UpdateAppInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAppInstanceResponseBody</p>
 */
public class UpdateAppInstanceResponseBody extends TeaModel {
    ...
    private UpdateAppInstanceResponseBody(Builder builder) {
    ...
    public static UpdateAppInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAppInstanceResponseBody model) {
        ...
        public UpdateAppInstanceResponseBody build() {
            return new UpdateAppInstanceResponseBody(this);
        } 
