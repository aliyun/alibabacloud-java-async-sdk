...
/**
 * 
 * {@link ListRbacRoleHierarchyResponseBody} extends {@link TeaModel}
 *
 * <p>ListRbacRoleHierarchyResponseBody</p>
 */
public class ListRbacRoleHierarchyResponseBody extends TeaModel {
    ...
    private ListRbacRoleHierarchyResponseBody(Builder builder) {
    ...
    public static ListRbacRoleHierarchyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListRbacRoleHierarchyResponseBody model) {
        ...
        public ListRbacRoleHierarchyResponseBody build() {
            return new ListRbacRoleHierarchyResponseBody(this);
        } 
    ...
    public static class Data extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(Data model) {
                this.childRoleId = model.childRoleId;
