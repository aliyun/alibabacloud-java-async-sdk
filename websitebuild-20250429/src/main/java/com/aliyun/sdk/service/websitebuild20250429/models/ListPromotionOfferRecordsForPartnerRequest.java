...
/**
 * 
 * {@link ListPromotionOfferRecordsForPartnerRequest} extends {@link RequestModel}
 *
 * <p>ListPromotionOfferRecordsForPartnerRequest</p>
 */
public class ListPromotionOfferRecordsForPartnerRequest extends Request {
    ...
    private ListPromotionOfferRecordsForPartnerRequest(Builder builder) {
        super(builder);
    ...
    public static ListPromotionOfferRecordsForPartnerRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListPromotionOfferRecordsForPartnerRequest, Builder> {
        private String regionId; 
        private String activityCode; 
        private String belongId; 
        private Integer maxResults; 
        ...
        private Builder(ListPromotionOfferRecordsForPartnerRequest request) {
            super(request);
        ...
        @Override
        public ListPromotionOfferRecordsForPartnerRequest build() {
            return new ListPromotionOfferRecordsForPartnerRequest(this);
        } 
