...
/**
 * 
 * {@link SaveAppRequirementResponseBody} extends {@link TeaModel}
 *
 * <p>SaveAppRequirementResponseBody</p>
 */
public class SaveAppRequirementResponseBody extends TeaModel {
    ...
    private SaveAppRequirementResponseBody(Builder builder) {
    ...
    public static SaveAppRequirementResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SaveAppRequirementResponseBody model) {
        ...
        public SaveAppRequirementResponseBody build() {
            return new SaveAppRequirementResponseBody(this);
        } 
