...
/**
 * 
 * {@link OperateSupabaseForAdminResponseBody} extends {@link TeaModel}
 *
 * <p>OperateSupabaseForAdminResponseBody</p>
 */
public class OperateSupabaseForAdminResponseBody extends TeaModel {
    ...
    private OperateSupabaseForAdminResponseBody(Builder builder) {
    ...
    public static OperateSupabaseForAdminResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OperateSupabaseForAdminResponseBody model) {
        ...
        public OperateSupabaseForAdminResponseBody build() {
            return new OperateSupabaseForAdminResponseBody(this);
        } 
