...
/**
 * 
 * {@link QueryMaterialFileDetailResponseBody} extends {@link TeaModel}
 *
 * <p>QueryMaterialFileDetailResponseBody</p>
 */
public class QueryMaterialFileDetailResponseBody extends TeaModel {
    ...
    private AppMaterialFile module;
    ...
    private QueryMaterialFileDetailResponseBody(Builder builder) {
    ...
    public static QueryMaterialFileDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryMaterialFileDetailResponseBody model) {
         ...
         * Module.
         */
        public Builder module(AppMaterialFile module) {
            this.module = module;
            return this;
        }
        ...
        public QueryMaterialFileDetailResponseBody build() {
            return new QueryMaterialFileDetailResponseBody(this);
        } 
