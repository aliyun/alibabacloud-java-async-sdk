...
/**
 * 
 * {@link DeleteAppFileResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteAppFileResponseBody</p>
 */
public class DeleteAppFileResponseBody extends TeaModel {
    ...
    private DeleteAppFileResponseBody(Builder builder) {
    ...
    public static DeleteAppFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteAppFileResponseBody model) {
        ...
        public DeleteAppFileResponseBody build() {
            return new DeleteAppFileResponseBody(this);
        } 
