...
/**
 * 
 * {@link UnbindAppDomainResponseBody} extends {@link TeaModel}
 *
 * <p>UnbindAppDomainResponseBody</p>
 */
public class UnbindAppDomainResponseBody extends TeaModel {
    ...
    private UnbindAppDomainResponseBody(Builder builder) {
    ...
    public static UnbindAppDomainResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UnbindAppDomainResponseBody model) {
        ...
        public UnbindAppDomainResponseBody build() {
            return new UnbindAppDomainResponseBody(this);
        } 
