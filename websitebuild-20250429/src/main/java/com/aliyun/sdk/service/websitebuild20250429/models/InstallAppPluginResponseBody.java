...
/**
 * 
 * {@link InstallAppPluginResponseBody} extends {@link TeaModel}
 *
 * <p>InstallAppPluginResponseBody</p>
 */
public class InstallAppPluginResponseBody extends TeaModel {
    ...
    private InstallAppPluginResponseBody(Builder builder) {
    ...
    public static InstallAppPluginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(InstallAppPluginResponseBody model) {
        ...
        public InstallAppPluginResponseBody build() {
            return new InstallAppPluginResponseBody(this);
        } 
