...
/**
 * 
 * {@link DeleteMaterialDirectoryResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMaterialDirectoryResponseBody</p>
 */
public class DeleteMaterialDirectoryResponseBody extends TeaModel {
    ...
    private DeleteMaterialDirectoryResponseBody(Builder builder) {
    ...
    public static DeleteMaterialDirectoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteMaterialDirectoryResponseBody model) {
        ...
        public DeleteMaterialDirectoryResponseBody build() {
            return new DeleteMaterialDirectoryResponseBody(this);
        } 
