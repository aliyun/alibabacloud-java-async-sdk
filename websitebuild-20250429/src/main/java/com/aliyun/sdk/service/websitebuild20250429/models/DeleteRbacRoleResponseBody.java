...
/**
 * 
 * {@link DeleteRbacRoleResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteRbacRoleResponseBody</p>
 */
public class DeleteRbacRoleResponseBody extends TeaModel {
    ...
    private DeleteRbacRoleResponseBody(Builder builder) {
    ...
    public static DeleteRbacRoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteRbacRoleResponseBody model) {
        ...
        public DeleteRbacRoleResponseBody build() {
            return new DeleteRbacRoleResponseBody(this);
        } 
