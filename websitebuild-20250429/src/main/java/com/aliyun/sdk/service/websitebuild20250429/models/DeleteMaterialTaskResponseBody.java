...
/**
 * 
 * {@link DeleteMaterialTaskResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteMaterialTaskResponseBody</p>
 */
public class DeleteMaterialTaskResponseBody extends TeaModel {
    ...
    private DeleteMaterialTaskResponseBody(Builder builder) {
    ...
    public static DeleteMaterialTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteMaterialTaskResponseBody model) {
        ...
        public DeleteMaterialTaskResponseBody build() {
            return new DeleteMaterialTaskResponseBody(this);
        } 
