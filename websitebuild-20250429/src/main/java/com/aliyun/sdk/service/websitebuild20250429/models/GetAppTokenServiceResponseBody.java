...
/**
 * 
 * {@link GetAppTokenServiceResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppTokenServiceResponseBody</p>
 */
public class GetAppTokenServiceResponseBody extends TeaModel {
    ...
    private GetAppTokenServiceResponseBody(Builder builder) {
    ...
    public static GetAppTokenServiceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppTokenServiceResponseBody model) {
        ...
        public GetAppTokenServiceResponseBody build() {
            return new GetAppTokenServiceResponseBody(this);
        } 
