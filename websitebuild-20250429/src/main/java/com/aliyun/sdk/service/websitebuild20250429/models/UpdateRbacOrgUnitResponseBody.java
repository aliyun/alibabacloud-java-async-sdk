...
/**
 * 
 * {@link UpdateRbacOrgUnitResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateRbacOrgUnitResponseBody</p>
 */
public class UpdateRbacOrgUnitResponseBody extends TeaModel {
    ...
    private UpdateRbacOrgUnitResponseBody(Builder builder) {
    ...
    public static UpdateRbacOrgUnitResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateRbacOrgUnitResponseBody model) {
        ...
        public UpdateRbacOrgUnitResponseBody build() {
            return new UpdateRbacOrgUnitResponseBody(this);
        } 
