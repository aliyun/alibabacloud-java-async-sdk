...
/**
 * 
 * {@link DeleteAppPluginResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteAppPluginResponseBody</p>
 */
public class DeleteAppPluginResponseBody extends TeaModel {
    ...
    private DeleteAppPluginResponseBody(Builder builder) {
    ...
    public static DeleteAppPluginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteAppPluginResponseBody model) {
        ...
        public DeleteAppPluginResponseBody build() {
            return new DeleteAppPluginResponseBody(this);
        } 
