...
/**
 * 
 * {@link DeleteAppSupabaseSecretsResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteAppSupabaseSecretsResponseBody</p>
 */
public class DeleteAppSupabaseSecretsResponseBody extends TeaModel {
    ...
    private DeleteAppSupabaseSecretsResponseBody(Builder builder) {
    ...
    public static DeleteAppSupabaseSecretsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteAppSupabaseSecretsResponseBody model) {
        ...
        public DeleteAppSupabaseSecretsResponseBody build() {
            return new DeleteAppSupabaseSecretsResponseBody(this);
        } 
