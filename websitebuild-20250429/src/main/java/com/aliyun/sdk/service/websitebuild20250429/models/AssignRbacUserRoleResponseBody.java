...
/**
 * 
 * {@link AssignRbacUserRoleResponseBody} extends {@link TeaModel}
 *
 * <p>AssignRbacUserRoleResponseBody</p>
 */
public class AssignRbacUserRoleResponseBody extends TeaModel {
    ...
    private AssignRbacUserRoleResponseBody(Builder builder) {
    ...
    public static AssignRbacUserRoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AssignRbacUserRoleResponseBody model) {
        ...
        public AssignRbacUserRoleResponseBody build() {
            return new AssignRbacUserRoleResponseBody(this);
        } 
