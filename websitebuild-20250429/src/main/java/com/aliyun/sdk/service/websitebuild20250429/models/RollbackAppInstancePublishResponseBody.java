...
/**
 * 
 * {@link RollbackAppInstancePublishResponseBody} extends {@link TeaModel}
 *
 * <p>RollbackAppInstancePublishResponseBody</p>
 */
public class RollbackAppInstancePublishResponseBody extends TeaModel {
    ...
    private RollbackAppInstancePublishResponseBody(Builder builder) {
    ...
    public static RollbackAppInstancePublishResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RollbackAppInstancePublishResponseBody model) {
        ...
        public RollbackAppInstancePublishResponseBody build() {
            return new RollbackAppInstancePublishResponseBody(this);
        } 
