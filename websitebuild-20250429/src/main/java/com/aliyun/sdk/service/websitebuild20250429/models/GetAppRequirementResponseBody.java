...
/**
 * 
 * {@link GetAppRequirementResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppRequirementResponseBody</p>
 */
public class GetAppRequirementResponseBody extends TeaModel {
    ...
    private GetAppRequirementResponseBody(Builder builder) {
    ...
    public static GetAppRequirementResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppRequirementResponseBody model) {
        ...
        public GetAppRequirementResponseBody build() {
            return new GetAppRequirementResponseBody(this);
        } 
