...
/**
 * 
 * {@link QuerySupabaseConfigsForAdminResponseBody} extends {@link TeaModel}
 *
 * <p>QuerySupabaseConfigsForAdminResponseBody</p>
 */
public class QuerySupabaseConfigsForAdminResponseBody extends TeaModel {
    ...
    private QuerySupabaseConfigsForAdminResponseBody(Builder builder) {
    ...
    public static QuerySupabaseConfigsForAdminResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QuerySupabaseConfigsForAdminResponseBody model) {
        ...
        public QuerySupabaseConfigsForAdminResponseBody build() {
            return new QuerySupabaseConfigsForAdminResponseBody(this);
        } 
