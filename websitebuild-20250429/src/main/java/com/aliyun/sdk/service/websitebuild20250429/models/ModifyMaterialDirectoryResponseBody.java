...
/**
 * 
 * {@link ModifyMaterialDirectoryResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyMaterialDirectoryResponseBody</p>
 */
public class ModifyMaterialDirectoryResponseBody extends TeaModel {
    ...
    private ModifyMaterialDirectoryResponseBody(Builder builder) {
    ...
    public static ModifyMaterialDirectoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyMaterialDirectoryResponseBody model) {
        ...
        public ModifyMaterialDirectoryResponseBody build() {
            return new ModifyMaterialDirectoryResponseBody(this);
        } 
