...
/**
 * 
 * {@link ModifyMaterialFileStatusResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyMaterialFileStatusResponseBody</p>
 */
public class ModifyMaterialFileStatusResponseBody extends TeaModel {
    ...
    private ModifyMaterialFileStatusResponseBody(Builder builder) {
    ...
    public static ModifyMaterialFileStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyMaterialFileStatusResponseBody model) {
        ...
        public ModifyMaterialFileStatusResponseBody build() {
            return new ModifyMaterialFileStatusResponseBody(this);
        } 
