...
/**
 * 
 * {@link CheckResourceMeasureRequest} extends {@link RequestModel}
 *
 * <p>CheckResourceMeasureRequest</p>
 */
public class CheckResourceMeasureRequest extends Request {
    ...
    private CheckResourceMeasureRequest(Builder builder) {
        super(builder);
    ...
    public static CheckResourceMeasureRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CheckResourceMeasureRequest, Builder> {
        private String regionId; 
        private String belongId; 
        private String belongIdType; 
        private String bizType; 
        ...
        private Builder(CheckResourceMeasureRequest request) {
            super(request);
            ...
            this.resourceValue = request.resourceValue;
        } 
        ...
        public Builder resourceValue(Long resourceValue) {
            this.putQueryParameter("ResourceValue", resourceValue);
            this.resourceValue = resourceValue;
            return this;
        }

        @Override
        public CheckResourceMeasureRequest build() {
            return new CheckResourceMeasureRequest(this);
        } 
