...
/**
 * 
 * {@link RenewAppSandboxResponseBody} extends {@link TeaModel}
 *
 * <p>RenewAppSandboxResponseBody</p>
 */
public class RenewAppSandboxResponseBody extends TeaModel {
    ...
    private RenewAppSandboxResponseBody(Builder builder) {
    ...
    public static RenewAppSandboxResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RenewAppSandboxResponseBody model) {
        ...
        public RenewAppSandboxResponseBody build() {
            return new RenewAppSandboxResponseBody(this);
        } 
    ...
    public static class Module extends TeaModel {
        @com.aliyun.core.annotation.NameInMap("PreviewUrls")
        private java.util.Map<String, String> previewUrls;

        private Module(Builder builder) {
            this.previewUrls = builder.previewUrls;
        }
        ...
        public static final class Builder {
            ...
            private Builder(Module model) {
                this.previewUrls = model.previewUrls;
            } 

            /**
             * PreviewUrls.
             */
            public Builder previewUrls(java.util.Map<String, String> previewUrls) {
