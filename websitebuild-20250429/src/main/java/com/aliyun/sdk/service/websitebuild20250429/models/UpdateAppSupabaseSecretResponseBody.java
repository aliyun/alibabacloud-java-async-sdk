...
/**
 * 
 * {@link UpdateAppSupabaseSecretResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAppSupabaseSecretResponseBody</p>
 */
public class UpdateAppSupabaseSecretResponseBody extends TeaModel {
    ...
    private UpdateAppSupabaseSecretResponseBody(Builder builder) {
    ...
    public static UpdateAppSupabaseSecretResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAppSupabaseSecretResponseBody model) {
        ...
        public UpdateAppSupabaseSecretResponseBody build() {
            return new UpdateAppSupabaseSecretResponseBody(this);
        } 
