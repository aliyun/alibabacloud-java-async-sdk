...
/**
 * 
 * {@link CreateAppPluginResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAppPluginResponseBody</p>
 */
public class CreateAppPluginResponseBody extends TeaModel {
    ...
    private CreateAppPluginResponseBody(Builder builder) {
    ...
    public static CreateAppPluginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAppPluginResponseBody model) {
        ...
        public CreateAppPluginResponseBody build() {
            return new CreateAppPluginResponseBody(this);
        } 
