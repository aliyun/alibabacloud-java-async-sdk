...
/**
 * 
 * {@link GetAppInstanceForAdminResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppInstanceForAdminResponseBody</p>
 */
public class GetAppInstanceForAdminResponseBody extends TeaModel {
    ...
    private AppInstanceAggregate module;
    ...
    private GetAppInstanceForAdminResponseBody(Builder builder) {
    ...
    public static GetAppInstanceForAdminResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppInstanceForAdminResponseBody model) {
        ...
        public GetAppInstanceForAdminResponseBody build() {
            return new GetAppInstanceForAdminResponseBody(this);
        } 
