...
/**
 * 
 * {@link ListIsvPaymentPluginConfigsResponseBody} extends {@link TeaModel}
 *
 * <p>ListIsvPaymentPluginConfigsResponseBody</p>
 */
public class ListIsvPaymentPluginConfigsResponseBody extends TeaModel {
    ...
    private ListIsvPaymentPluginConfigsResponseBody(Builder builder) {
    ...
    public static ListIsvPaymentPluginConfigsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListIsvPaymentPluginConfigsResponseBody model) {
        ...
        public ListIsvPaymentPluginConfigsResponseBody build() {
            return new ListIsvPaymentPluginConfigsResponseBody(this);
        } 
