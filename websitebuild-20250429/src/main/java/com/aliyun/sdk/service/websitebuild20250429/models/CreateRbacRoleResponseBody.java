...
/**
 * 
 * {@link CreateRbacRoleResponseBody} extends {@link TeaModel}
 *
 * <p>CreateRbacRoleResponseBody</p>
 */
public class CreateRbacRoleResponseBody extends TeaModel {
    ...
    private CreateRbacRoleResponseBody(Builder builder) {
    ...
    public static CreateRbacRoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateRbacRoleResponseBody model) {
        ...
        public CreateRbacRoleResponseBody build() {
            return new CreateRbacRoleResponseBody(this);
        } 
