...
/**
 * 
 * {@link GetAppSitemapResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppSitemapResponseBody</p>
 */
public class GetAppSitemapResponseBody extends TeaModel {
    ...
    private GetAppSitemapResponseBody(Builder builder) {
    ...
    public static GetAppSitemapResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppSitemapResponseBody model) {
        ...
        public GetAppSitemapResponseBody build() {
            return new GetAppSitemapResponseBody(this);
        } 
