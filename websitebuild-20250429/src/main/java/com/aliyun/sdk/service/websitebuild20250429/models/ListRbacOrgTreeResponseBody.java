...
/**
 * 
 * {@link ListRbacOrgTreeResponseBody} extends {@link TeaModel}
 *
 * <p>ListRbacOrgTreeResponseBody</p>
 */
public class ListRbacOrgTreeResponseBody extends TeaModel {
    ...
    private ListRbacOrgTreeResponseBody(Builder builder) {
    ...
    public static ListRbacOrgTreeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListRbacOrgTreeResponseBody model) {
        ...
        public ListRbacOrgTreeResponseBody build() {
            return new ListRbacOrgTreeResponseBody(this);
        } 
