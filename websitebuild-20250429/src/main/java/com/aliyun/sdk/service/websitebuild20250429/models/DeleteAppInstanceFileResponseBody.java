...
/**
 * 
 * {@link DeleteAppInstanceFileResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteAppInstanceFileResponseBody</p>
 */
public class DeleteAppInstanceFileResponseBody extends TeaModel {
    ...
    private DeleteAppInstanceFileResponseBody(Builder builder) {
    ...
    public static DeleteAppInstanceFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteAppInstanceFileResponseBody model) {
        ...
        public DeleteAppInstanceFileResponseBody build() {
            return new DeleteAppInstanceFileResponseBody(this);
        } 
