...
/**
 * 
 * {@link DeleteRbacOrgUnitResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteRbacOrgUnitResponseBody</p>
 */
public class DeleteRbacOrgUnitResponseBody extends TeaModel {
    ...
    private DeleteRbacOrgUnitResponseBody(Builder builder) {
    ...
    public static DeleteRbacOrgUnitResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteRbacOrgUnitResponseBody model) {
        ...
        public DeleteRbacOrgUnitResponseBody build() {
            return new DeleteRbacOrgUnitResponseBody(this);
        } 
