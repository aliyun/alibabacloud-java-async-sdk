...
/**
 * 
 * {@link SetAppDomainCertificateResponseBody} extends {@link TeaModel}
 *
 * <p>SetAppDomainCertificateResponseBody</p>
 */
public class SetAppDomainCertificateResponseBody extends TeaModel {
    ...
    private SetAppDomainCertificateResponseBody(Builder builder) {
    ...
    public static SetAppDomainCertificateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SetAppDomainCertificateResponseBody model) {
        ...
        public SetAppDomainCertificateResponseBody build() {
            return new SetAppDomainCertificateResponseBody(this);
        } 
