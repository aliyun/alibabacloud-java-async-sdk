...
/**
 * 
 * {@link GetAppSupabaseAuthConfigResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppSupabaseAuthConfigResponseBody</p>
 */
public class GetAppSupabaseAuthConfigResponseBody extends TeaModel {
    ...
    private GetAppSupabaseAuthConfigResponseBody(Builder builder) {
    ...
    public static GetAppSupabaseAuthConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppSupabaseAuthConfigResponseBody model) {
        ...
        public GetAppSupabaseAuthConfigResponseBody build() {
            return new GetAppSupabaseAuthConfigResponseBody(this);
        } 
