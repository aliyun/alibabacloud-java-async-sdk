...
/**
 * 
 * {@link ConfirmAppInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>ConfirmAppInstanceResponseBody</p>
 */
public class ConfirmAppInstanceResponseBody extends TeaModel {
    ...
    private ConfirmAppInstanceResponseBody(Builder builder) {
    ...
    public static ConfirmAppInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ConfirmAppInstanceResponseBody model) {
        ...
        public ConfirmAppInstanceResponseBody build() {
            return new ConfirmAppInstanceResponseBody(this);
        } 
