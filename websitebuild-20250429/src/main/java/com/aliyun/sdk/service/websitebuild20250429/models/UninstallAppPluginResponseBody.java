...
/**
 * 
 * {@link UninstallAppPluginResponseBody} extends {@link TeaModel}
 *
 * <p>UninstallAppPluginResponseBody</p>
 */
public class UninstallAppPluginResponseBody extends TeaModel {
    ...
    private UninstallAppPluginResponseBody(Builder builder) {
    ...
    public static UninstallAppPluginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UninstallAppPluginResponseBody model) {
        ...
        public UninstallAppPluginResponseBody build() {
            return new UninstallAppPluginResponseBody(this);
        } 
