...
/**
 * 
 * {@link UpdateAppCodeResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAppCodeResponseBody</p>
 */
public class UpdateAppCodeResponseBody extends TeaModel {
    ...
    private UpdateAppCodeResponseBody(Builder builder) {
    ...
    public static UpdateAppCodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAppCodeResponseBody model) {
        ...
        public UpdateAppCodeResponseBody build() {
            return new UpdateAppCodeResponseBody(this);
        } 
