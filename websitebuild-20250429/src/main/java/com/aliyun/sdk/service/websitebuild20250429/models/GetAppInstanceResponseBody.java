...
/**
 * 
 * {@link GetAppInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>GetAppInstanceResponseBody</p>
 */
public class GetAppInstanceResponseBody extends TeaModel {
    ...
    private GetAppInstanceResponseBody(Builder builder) {
    ...
    public static GetAppInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAppInstanceResponseBody model) {
        ...
        public GetAppInstanceResponseBody build() {
            return new GetAppInstanceResponseBody(this);
        } 
