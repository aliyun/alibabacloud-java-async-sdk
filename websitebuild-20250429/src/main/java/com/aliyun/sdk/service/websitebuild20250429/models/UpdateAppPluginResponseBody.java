...
/**
 * 
 * {@link UpdateAppPluginResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAppPluginResponseBody</p>
 */
public class UpdateAppPluginResponseBody extends TeaModel {
    ...
    private UpdateAppPluginResponseBody(Builder builder) {
    ...
    public static UpdateAppPluginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAppPluginResponseBody model) {
        ...
        public UpdateAppPluginResponseBody build() {
            return new UpdateAppPluginResponseBody(this);
        } 
