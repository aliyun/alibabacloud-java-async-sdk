...
/**
 * 
 * {@link CreateRbacOrgUnitResponseBody} extends {@link TeaModel}
 *
 * <p>CreateRbacOrgUnitResponseBody</p>
 */
public class CreateRbacOrgUnitResponseBody extends TeaModel {
    ...
    private CreateRbacOrgUnitResponseBody(Builder builder) {
    ...
    public static CreateRbacOrgUnitResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateRbacOrgUnitResponseBody model) {
        ...
        public CreateRbacOrgUnitResponseBody build() {
            return new CreateRbacOrgUnitResponseBody(this);
        } 
