...
/**
 * 
 * {@link UploadAppSiteValidationFileResponseBody} extends {@link TeaModel}
 *
 * <p>UploadAppSiteValidationFileResponseBody</p>
 */
public class UploadAppSiteValidationFileResponseBody extends TeaModel {
    ...
    private UploadAppSiteValidationFileResponseBody(Builder builder) {
    ...
    public static UploadAppSiteValidationFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UploadAppSiteValidationFileResponseBody model) {
        ...
        public UploadAppSiteValidationFileResponseBody build() {
            return new UploadAppSiteValidationFileResponseBody(this);
        } 
