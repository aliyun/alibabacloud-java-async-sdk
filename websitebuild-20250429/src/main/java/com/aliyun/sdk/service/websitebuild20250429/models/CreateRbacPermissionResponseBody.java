...
/**
 * 
 * {@link CreateRbacPermissionResponseBody} extends {@link TeaModel}
 *
 * <p>CreateRbacPermissionResponseBody</p>
 */
public class CreateRbacPermissionResponseBody extends TeaModel {
    ...
    private CreateRbacPermissionResponseBody(Builder builder) {
    ...
    public static CreateRbacPermissionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateRbacPermissionResponseBody model) {
        ...
        public CreateRbacPermissionResponseBody build() {
            return new CreateRbacPermissionResponseBody(this);
        } 
