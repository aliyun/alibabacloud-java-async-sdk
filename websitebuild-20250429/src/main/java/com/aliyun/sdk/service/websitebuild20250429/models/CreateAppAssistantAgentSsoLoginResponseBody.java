...
/**
 * 
 * {@link CreateAppAssistantAgentSsoLoginResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAppAssistantAgentSsoLoginResponseBody</p>
 */
public class CreateAppAssistantAgentSsoLoginResponseBody extends TeaModel {
    ...
    private CreateAppAssistantAgentSsoLoginResponseBody(Builder builder) {
    ...
    public static CreateAppAssistantAgentSsoLoginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAppAssistantAgentSsoLoginResponseBody model) {
        ...
        public CreateAppAssistantAgentSsoLoginResponseBody build() {
            return new CreateAppAssistantAgentSsoLoginResponseBody(this);
        } 
