...
/**
 * {@link GetFirstFrameDelayDataResponseBody} extends {@link TeaModel}
 *
 * <p>GetFirstFrameDelayDataResponseBody</p>
 */
public class GetFirstFrameDelayDataResponseBody extends TeaModel {
    ...
    private GetFirstFrameDelayDataResponseBody(Builder builder) {
    ...
    public static GetFirstFrameDelayDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetFirstFrameDelayDataResponseBody build() {
            return new GetFirstFrameDelayDataResponseBody(this);
        } 
