...
/**
 * {@link GetBalanceTrafficDataResponseBody} extends {@link TeaModel}
 *
 * <p>GetBalanceTrafficDataResponseBody</p>
 */
public class GetBalanceTrafficDataResponseBody extends TeaModel {
    ...
    private GetBalanceTrafficDataResponseBody(Builder builder) {
    ...
    public static GetBalanceTrafficDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetBalanceTrafficDataResponseBody build() {
            return new GetBalanceTrafficDataResponseBody(this);
        } 
