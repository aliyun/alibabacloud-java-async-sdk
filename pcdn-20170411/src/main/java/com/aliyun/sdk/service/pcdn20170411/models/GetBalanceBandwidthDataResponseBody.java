...
/**
 * {@link GetBalanceBandwidthDataResponseBody} extends {@link TeaModel}
 *
 * <p>GetBalanceBandwidthDataResponseBody</p>
 */
public class GetBalanceBandwidthDataResponseBody extends TeaModel {
    ...
    private GetBalanceBandwidthDataResponseBody(Builder builder) {
    ...
    public static GetBalanceBandwidthDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetBalanceBandwidthDataResponseBody build() {
            return new GetBalanceBandwidthDataResponseBody(this);
        } 
