...
/**
 * {@link UpdateHttpTriggerConfigResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateHttpTriggerConfigResponseBody</p>
 */
public class UpdateHttpTriggerConfigResponseBody extends TeaModel {
    ...
    private UpdateHttpTriggerConfigResponseBody(Builder builder) {
    ...
    public static UpdateHttpTriggerConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateHttpTriggerConfigResponseBody build() {
            return new UpdateHttpTriggerConfigResponseBody(this);
        } 
