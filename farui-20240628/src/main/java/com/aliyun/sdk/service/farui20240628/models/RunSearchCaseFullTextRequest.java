...
/**
 * 
 * {@link RunSearchCaseFullTextRequest} extends {@link RequestModel}
 *
 * <p>RunSearchCaseFullTextRequest</p>
 */
public class RunSearchCaseFullTextRequest extends Request {
    ...
    private RunSearchCaseFullTextRequest(Builder builder) {
        super(builder);
    ...
    public static RunSearchCaseFullTextRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<RunSearchCaseFullTextRequest, Builder> {
        private String workspaceId; 
        private String regionId; 
        private String appId; 
        private FilterCondition filterCondition; 
        ...
        private Builder(RunSearchCaseFullTextRequest request) {
            super(request);
         ...
         * sortKeyAndDirection.
         */
        public Builder sortKeyAndDirection(java.util.Map<String, String> sortKeyAndDirection) {
            String sortKeyAndDirectionShrink = shrink(sortKeyAndDirection, "sortKeyAndDirection", "json");
            this.putBodyParameter("sortKeyAndDirection", sortKeyAndDirectionShrink);
        ...
        @Override
        public RunSearchCaseFullTextRequest build() {
            return new RunSearchCaseFullTextRequest(this);
        } 
    ...
    /**
     * 
     * {@link RunSearchCaseFullTextRequest} extends {@link TeaModel}
     *
     * <p>RunSearchCaseFullTextRequest</p>
     */
