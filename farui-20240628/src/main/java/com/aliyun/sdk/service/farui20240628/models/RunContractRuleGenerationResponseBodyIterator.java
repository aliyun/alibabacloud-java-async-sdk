...
public class RunContractRuleGenerationResponseBodyIterator extends SSEResponseIterator<RunContractRuleGenerationResponseBody> {
    ...
    @Override
    protected RunContractRuleGenerationResponseBody toModel(String data) {
        RunContractRuleGenerationResponseBody result = RunContractRuleGenerationResponseBody.create();
