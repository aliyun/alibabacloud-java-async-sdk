...
/**
 * 
 * {@link OrderClusterHealthCheckRiskNoticeResponseBody} extends {@link TeaModel}
 *
 * <p>OrderClusterHealthCheckRiskNoticeResponseBody</p>
 */
public class OrderClusterHealthCheckRiskNoticeResponseBody extends TeaModel {
    ...
    private OrderClusterHealthCheckRiskNoticeResponseBody(Builder builder) {
    ...
    public static OrderClusterHealthCheckRiskNoticeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OrderClusterHealthCheckRiskNoticeResponseBody model) {
        ...
        public OrderClusterHealthCheckRiskNoticeResponseBody build() {
            return new OrderClusterHealthCheckRiskNoticeResponseBody(this);
        } 
