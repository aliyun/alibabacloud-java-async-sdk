...
/**
 * 
 * {@link EnableHttp2ResponseBody} extends {@link TeaModel}
 *
 * <p>EnableHttp2ResponseBody</p>
 */
public class EnableHttp2ResponseBody extends TeaModel {
    ...
    private EnableHttp2ResponseBody(Builder builder) {
    ...
    public static EnableHttp2ResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnableHttp2ResponseBody model) {
        ...
        public EnableHttp2ResponseBody build() {
            return new EnableHttp2ResponseBody(this);
        } 
