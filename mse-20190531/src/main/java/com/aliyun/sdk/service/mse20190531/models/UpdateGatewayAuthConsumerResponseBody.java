...
/**
 * 
 * {@link UpdateGatewayAuthConsumerResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateGatewayAuthConsumerResponseBody</p>
 */
public class UpdateGatewayAuthConsumerResponseBody extends TeaModel {
    ...
    private UpdateGatewayAuthConsumerResponseBody(Builder builder) {
    ...
    public static UpdateGatewayAuthConsumerResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGatewayAuthConsumerResponseBody model) {
        ...
        public UpdateGatewayAuthConsumerResponseBody build() {
            return new UpdateGatewayAuthConsumerResponseBody(this);
        } 
