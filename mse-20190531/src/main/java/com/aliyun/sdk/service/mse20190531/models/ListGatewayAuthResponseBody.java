...
/**
 * 
 * {@link ListGatewayAuthResponseBody} extends {@link TeaModel}
 *
 * <p>ListGatewayAuthResponseBody</p>
 */
public class ListGatewayAuthResponseBody extends TeaModel {
    ...
    private ListGatewayAuthResponseBody(Builder builder) {
    ...
    public static ListGatewayAuthResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListGatewayAuthResponseBody model) {
        ...
        public ListGatewayAuthResponseBody build() {
            return new ListGatewayAuthResponseBody(this);
        } 
