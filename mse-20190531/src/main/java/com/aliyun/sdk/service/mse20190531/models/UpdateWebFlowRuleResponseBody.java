...
/**
 * 
 * {@link UpdateWebFlowRuleResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateWebFlowRuleResponseBody</p>
 */
public class UpdateWebFlowRuleResponseBody extends TeaModel {
    ...
    private UpdateWebFlowRuleResponseBody(Builder builder) {
    ...
    public static UpdateWebFlowRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateWebFlowRuleResponseBody model) {
        ...
        public UpdateWebFlowRuleResponseBody build() {
            return new UpdateWebFlowRuleResponseBody(this);
        } 
