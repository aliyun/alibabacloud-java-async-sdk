...
public class AddGatewayServiceVersionResponseBody extends TeaModel {
    ...
    private AddGatewayServiceVersionResponseBody(Builder builder) {
    ...
    public static AddGatewayServiceVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddGatewayServiceVersionResponseBody model) {
        ...
        public AddGatewayServiceVersionResponseBody build() {
            return new AddGatewayServiceVersionResponseBody(this);
        } 
