...
/**
 * 
 * {@link DeleteGatewayAuthConsumerResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteGatewayAuthConsumerResponseBody</p>
 */
public class DeleteGatewayAuthConsumerResponseBody extends TeaModel {
    ...
    private DeleteGatewayAuthConsumerResponseBody(Builder builder) {
    ...
    public static DeleteGatewayAuthConsumerResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteGatewayAuthConsumerResponseBody model) {
        ...
        public DeleteGatewayAuthConsumerResponseBody build() {
            return new DeleteGatewayAuthConsumerResponseBody(this);
        } 
