...
/**
 * 
 * {@link UpdateGatewayAuthConsumerStatusResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateGatewayAuthConsumerStatusResponseBody</p>
 */
public class UpdateGatewayAuthConsumerStatusResponseBody extends TeaModel {
    ...
    private UpdateGatewayAuthConsumerStatusResponseBody(Builder builder) {
    ...
    public static UpdateGatewayAuthConsumerStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGatewayAuthConsumerStatusResponseBody model) {
        ...
        public UpdateGatewayAuthConsumerStatusResponseBody build() {
            return new UpdateGatewayAuthConsumerStatusResponseBody(this);
        } 
