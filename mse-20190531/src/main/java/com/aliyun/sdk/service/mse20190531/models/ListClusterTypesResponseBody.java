...
public class ListClusterTypesResponseBody extends TeaModel {
    ...
    private ListClusterTypesResponseBody(Builder builder) {
    ...
    public static ListClusterTypesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListClusterTypesResponseBody build() {
            return new ListClusterTypesResponseBody(this);
        } 
