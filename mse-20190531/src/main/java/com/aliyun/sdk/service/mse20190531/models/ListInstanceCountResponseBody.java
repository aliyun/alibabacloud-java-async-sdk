...
public class ListInstanceCountResponseBody extends TeaModel {
    ...
    private ListInstanceCountResponseBody(Builder builder) {
    ...
    public static ListInstanceCountResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListInstanceCountResponseBody model) {
        ...
        public ListInstanceCountResponseBody build() {
            return new ListInstanceCountResponseBody(this);
        } 
