...
/**
 * 
 * {@link UpdateGatewayAuthConsumerResourceResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateGatewayAuthConsumerResourceResponseBody</p>
 */
public class UpdateGatewayAuthConsumerResourceResponseBody extends TeaModel {
    ...
    private UpdateGatewayAuthConsumerResourceResponseBody(Builder builder) {
    ...
    public static UpdateGatewayAuthConsumerResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGatewayAuthConsumerResourceResponseBody model) {
        ...
        public UpdateGatewayAuthConsumerResourceResponseBody build() {
            return new UpdateGatewayAuthConsumerResourceResponseBody(this);
        } 
