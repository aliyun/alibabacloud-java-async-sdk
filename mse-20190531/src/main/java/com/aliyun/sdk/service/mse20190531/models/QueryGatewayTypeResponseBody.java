...
public class QueryGatewayTypeResponseBody extends TeaModel {
    ...
    private QueryGatewayTypeResponseBody(Builder builder) {
    ...
    public static QueryGatewayTypeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryGatewayTypeResponseBody build() {
            return new QueryGatewayTypeResponseBody(this);
        } 
