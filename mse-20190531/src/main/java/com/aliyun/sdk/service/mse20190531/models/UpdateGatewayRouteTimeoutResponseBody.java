...
public class UpdateGatewayRouteTimeoutResponseBody extends TeaModel {
    ...
    private UpdateGatewayRouteTimeoutResponseBody(Builder builder) {
    ...
    public static UpdateGatewayRouteTimeoutResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGatewayRouteTimeoutResponseBody model) {
        ...
        public UpdateGatewayRouteTimeoutResponseBody build() {
            return new UpdateGatewayRouteTimeoutResponseBody(this);
        } 
