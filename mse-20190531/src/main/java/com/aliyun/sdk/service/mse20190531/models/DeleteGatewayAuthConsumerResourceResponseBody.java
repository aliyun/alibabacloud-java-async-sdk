...
/**
 * 
 * {@link DeleteGatewayAuthConsumerResourceResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteGatewayAuthConsumerResourceResponseBody</p>
 */
public class DeleteGatewayAuthConsumerResourceResponseBody extends TeaModel {
    ...
    private DeleteGatewayAuthConsumerResourceResponseBody(Builder builder) {
    ...
    public static DeleteGatewayAuthConsumerResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteGatewayAuthConsumerResourceResponseBody model) {
        ...
        public DeleteGatewayAuthConsumerResourceResponseBody build() {
            return new DeleteGatewayAuthConsumerResourceResponseBody(this);
        } 
