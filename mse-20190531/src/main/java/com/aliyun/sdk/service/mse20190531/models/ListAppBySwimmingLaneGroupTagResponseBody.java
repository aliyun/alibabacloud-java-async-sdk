...
public class ListAppBySwimmingLaneGroupTagResponseBody extends TeaModel {
    ...
    private ListAppBySwimmingLaneGroupTagResponseBody(Builder builder) {
    ...
    public static ListAppBySwimmingLaneGroupTagResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListAppBySwimmingLaneGroupTagResponseBody build() {
            return new ListAppBySwimmingLaneGroupTagResponseBody(this);
        } 
