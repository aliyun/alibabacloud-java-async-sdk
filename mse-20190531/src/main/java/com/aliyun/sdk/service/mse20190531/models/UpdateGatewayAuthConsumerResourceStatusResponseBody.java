...
public class UpdateGatewayAuthConsumerResourceStatusResponseBody extends TeaModel {
    ...
    private UpdateGatewayAuthConsumerResourceStatusResponseBody(Builder builder) {
    ...
    public static UpdateGatewayAuthConsumerResourceStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGatewayAuthConsumerResourceStatusResponseBody model) {
        ...
        public UpdateGatewayAuthConsumerResourceStatusResponseBody build() {
            return new UpdateGatewayAuthConsumerResourceStatusResponseBody(this);
        } 
