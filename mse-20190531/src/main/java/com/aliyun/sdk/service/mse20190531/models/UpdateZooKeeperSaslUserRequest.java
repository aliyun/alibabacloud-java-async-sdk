...
/**
 * 
 * {@link UpdateZooKeeperSaslUserRequest} extends {@link RequestModel}
 *
 * <p>UpdateZooKeeperSaslUserRequest</p>
 */
public class UpdateZooKeeperSaslUserRequest extends Request {
    ...
    private UpdateZooKeeperSaslUserRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateZooKeeperSaslUserRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateZooKeeperSaslUserRequest, Builder> {
        private String acceptLanguage; 
        private String instanceId; 
        private Boolean reload; 
        private java.util.List<SaslUser> saslUser; 
        ...
        private Builder(UpdateZooKeeperSaslUserRequest request) {
            super(request);
        ...
        @Override
        public UpdateZooKeeperSaslUserRequest build() {
            return new UpdateZooKeeperSaslUserRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateZooKeeperSaslUserRequest} extends {@link TeaModel}
     *
     * <p>UpdateZooKeeperSaslUserRequest</p>
     */
    public static class SaslUser extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(SaslUser model) {
                ...
                this.originPassword = model.originPassword;
