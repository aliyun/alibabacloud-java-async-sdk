...
/**
 * 
 * {@link UpdateGatewayOptionResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateGatewayOptionResponseBody</p>
 */
public class UpdateGatewayOptionResponseBody extends TeaModel {
    ...
    private UpdateGatewayOptionResponseBody(Builder builder) {
    ...
    public static UpdateGatewayOptionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGatewayOptionResponseBody model) {
        ...
        public UpdateGatewayOptionResponseBody build() {
            return new UpdateGatewayOptionResponseBody(this);
        } 
