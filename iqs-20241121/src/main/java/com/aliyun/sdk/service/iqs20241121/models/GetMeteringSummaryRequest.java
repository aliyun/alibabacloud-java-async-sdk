...
/**
 * 
 * {@link GetMeteringSummaryRequest} extends {@link RequestModel}
 *
 * <p>GetMeteringSummaryRequest</p>
 */
public class GetMeteringSummaryRequest extends Request {
    ...
    private GetMeteringSummaryRequest(Builder builder) {
        super(builder);
    ...
    public static GetMeteringSummaryRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetMeteringSummaryRequest, Builder> {
        private String billPeriod; 
        private String billingItem; 
        private String endTime; 
        private String startTime; 
        ...
        private Builder(GetMeteringSummaryRequest request) {
            super(request);
        ...
        @Override
        public GetMeteringSummaryRequest build() {
            return new GetMeteringSummaryRequest(this);
        } 
