...
public class GetRetcodeDataByQueryResponseBody extends TeaModel {
    ...
    private GetRetcodeDataByQueryResponseBody(Builder builder) {
    ...
    public static GetRetcodeDataByQueryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetRetcodeDataByQueryResponseBody model) {
        ...
        public GetRetcodeDataByQueryResponseBody build() {
            return new GetRetcodeDataByQueryResponseBody(this);
        } 
