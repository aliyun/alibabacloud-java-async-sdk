...
public class CreateRumUploadFileUrlResponseBody extends TeaModel {
    ...
    private CreateRumUploadFileUrlResponseBody(Builder builder) {
    ...
    public static CreateRumUploadFileUrlResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateRumUploadFileUrlResponseBody model) {
        ...
        public CreateRumUploadFileUrlResponseBody build() {
            return new CreateRumUploadFileUrlResponseBody(this);
        } 
