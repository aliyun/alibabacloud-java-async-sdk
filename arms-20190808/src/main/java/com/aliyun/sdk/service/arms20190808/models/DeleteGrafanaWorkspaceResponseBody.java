...
public class DeleteGrafanaWorkspaceResponseBody extends TeaModel {
    ...
    private DeleteGrafanaWorkspaceResponseBody(Builder builder) {
    ...
    public static DeleteGrafanaWorkspaceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteGrafanaWorkspaceResponseBody model) {
        ...
        public DeleteGrafanaWorkspaceResponseBody build() {
            return new DeleteGrafanaWorkspaceResponseBody(this);
        } 
