...
public class AddAliClusterIdsToPrometheusGlobalViewResponseBody extends TeaModel {
    ...
    public static AddAliClusterIdsToPrometheusGlobalViewResponseBody create() {
    ...
    public static final class Builder {
        ...
        public AddAliClusterIdsToPrometheusGlobalViewResponseBody build() {
            return new AddAliClusterIdsToPrometheusGlobalViewResponseBody(this);
        } 
