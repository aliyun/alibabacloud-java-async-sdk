...
public class UpdateTimingSyntheticTaskResponseBody extends TeaModel {
    ...
    private UpdateTimingSyntheticTaskResponseBody(Builder builder) {
    ...
    public static UpdateTimingSyntheticTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateTimingSyntheticTaskResponseBody model) {
        ...
        public UpdateTimingSyntheticTaskResponseBody build() {
            return new UpdateTimingSyntheticTaskResponseBody(this);
        } 
