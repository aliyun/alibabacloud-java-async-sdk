...
/**
 * 
 * {@link UpdateGrafanaWorkspaceResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateGrafanaWorkspaceResponseBody</p>
 */
public class UpdateGrafanaWorkspaceResponseBody extends TeaModel {
    ...
    private UpdateGrafanaWorkspaceResponseBody(Builder builder) {
    ...
    public static UpdateGrafanaWorkspaceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGrafanaWorkspaceResponseBody model) {
        ...
        public UpdateGrafanaWorkspaceResponseBody build() {
            return new UpdateGrafanaWorkspaceResponseBody(this);
        } 
