...
public class QueryDatasetRequest extends Request {
    ...
    public static QueryDatasetRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryDatasetRequest, Builder> {
        private Long datasetId; 
        private String dateStr; 
        private java.util.List < Dimensions> dimensions; 
        private Boolean hungryMode; 
        ...
        private Builder(QueryDatasetRequest response) {
            super(response);
            this.datasetId = response.datasetId;
            this.dateStr = response.dateStr;
            this.dimensions = response.dimensions;
            this.hungryMode = response.hungryMode;
            this.intervalInSec = response.intervalInSec;
            this.isDrillDown = response.isDrillDown;
            this.limit = response.limit;
            this.maxTime = response.maxTime;
            this.measures = response.measures;
            this.minTime = response.minTime;
            this.optionalDims = response.optionalDims;
            this.orderByKey = response.orderByKey;
            this.proxyUserId = response.proxyUserId;
            this.reduceTail = response.reduceTail;
            this.regionId = response.regionId;
            this.requiredDims = response.requiredDims;
        } 
        ...
        @Override
        public QueryDatasetRequest build() {
            return new QueryDatasetRequest(this);
        } 
