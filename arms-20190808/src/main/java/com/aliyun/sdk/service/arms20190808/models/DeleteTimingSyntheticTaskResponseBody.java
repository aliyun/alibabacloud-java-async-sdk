...
/**
 * 
 * {@link DeleteTimingSyntheticTaskResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteTimingSyntheticTaskResponseBody</p>
 */
public class DeleteTimingSyntheticTaskResponseBody extends TeaModel {
    ...
    private DeleteTimingSyntheticTaskResponseBody(Builder builder) {
    ...
    public static DeleteTimingSyntheticTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteTimingSyntheticTaskResponseBody model) {
        ...
        public DeleteTimingSyntheticTaskResponseBody build() {
            return new DeleteTimingSyntheticTaskResponseBody(this);
        } 
