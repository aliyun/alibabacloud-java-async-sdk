...
public class GetGrafanaWorkspaceResponseBody extends TeaModel {
    ...
    private GetGrafanaWorkspaceResponseBody(Builder builder) {
    ...
    public static GetGrafanaWorkspaceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetGrafanaWorkspaceResponseBody model) {
        ...
        public GetGrafanaWorkspaceResponseBody build() {
            return new GetGrafanaWorkspaceResponseBody(this);
        } 
