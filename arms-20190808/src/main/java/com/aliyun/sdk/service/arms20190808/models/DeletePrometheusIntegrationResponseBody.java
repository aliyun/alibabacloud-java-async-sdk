...
public class DeletePrometheusIntegrationResponseBody extends TeaModel {
    ...
    private DeletePrometheusIntegrationResponseBody(Builder builder) {
    ...
    public static DeletePrometheusIntegrationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeletePrometheusIntegrationResponseBody model) {
        ...
        public DeletePrometheusIntegrationResponseBody build() {
            return new DeletePrometheusIntegrationResponseBody(this);
        } 
