...
/**
 * {@link GetArmsAgentDownLoadUrlResponseBody} extends {@link TeaModel}
 *
 * <p>GetArmsAgentDownLoadUrlResponseBody</p>
 */
public class GetArmsAgentDownLoadUrlResponseBody extends TeaModel {
    ...
    private GetArmsAgentDownLoadUrlResponseBody(Builder builder) {
    ...
    public static GetArmsAgentDownLoadUrlResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetArmsAgentDownLoadUrlResponseBody build() {
            return new GetArmsAgentDownLoadUrlResponseBody(this);
        } 
