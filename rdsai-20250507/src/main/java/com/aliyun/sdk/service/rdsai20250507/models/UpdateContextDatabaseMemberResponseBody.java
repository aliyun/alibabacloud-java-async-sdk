...
/**
 * 
 * {@link UpdateContextDatabaseMemberResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateContextDatabaseMemberResponseBody</p>
 */
public class UpdateContextDatabaseMemberResponseBody extends TeaModel {
    ...
    private UpdateContextDatabaseMemberResponseBody(Builder builder) {
    ...
    public static UpdateContextDatabaseMemberResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateContextDatabaseMemberResponseBody model) {
        ...
        public UpdateContextDatabaseMemberResponseBody build() {
            return new UpdateContextDatabaseMemberResponseBody(this);
        } 
