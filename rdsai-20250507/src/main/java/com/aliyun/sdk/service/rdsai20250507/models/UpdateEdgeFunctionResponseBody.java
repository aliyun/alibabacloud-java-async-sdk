...
/**
 * 
 * {@link UpdateEdgeFunctionResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateEdgeFunctionResponseBody</p>
 */
public class UpdateEdgeFunctionResponseBody extends TeaModel {
    ...
    private UpdateEdgeFunctionResponseBody(Builder builder) {
    ...
    public static UpdateEdgeFunctionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateEdgeFunctionResponseBody model) {
        ...
        public UpdateEdgeFunctionResponseBody build() {
            return new UpdateEdgeFunctionResponseBody(this);
        } 
