...
/**
 * 
 * {@link CreateContextDatabaseApiKeyResponseBody} extends {@link TeaModel}
 *
 * <p>CreateContextDatabaseApiKeyResponseBody</p>
 */
public class CreateContextDatabaseApiKeyResponseBody extends TeaModel {
    ...
    private CreateContextDatabaseApiKeyResponseBody(Builder builder) {
    ...
    public static CreateContextDatabaseApiKeyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateContextDatabaseApiKeyResponseBody model) {
        ...
        public CreateContextDatabaseApiKeyResponseBody build() {
            return new CreateContextDatabaseApiKeyResponseBody(this);
        } 
