...
/**
 * 
 * {@link CreateEdgeFunctionRequest} extends {@link RequestModel}
 *
 * <p>CreateEdgeFunctionRequest</p>
 */
public class CreateEdgeFunctionRequest extends Request {
    ...
    private java.util.Map<String, Integer> customConfig;
    ...
    private CreateEdgeFunctionRequest(Builder builder) {
        super(builder);
    ...
    public static CreateEdgeFunctionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateEdgeFunctionRequest, Builder> {
        private String clientToken; 
        private Code code; 
        private java.util.Map<String, Integer> customConfig; 
        private String edgeFunctionName; 
        ...
        private Builder(CreateEdgeFunctionRequest request) {
            super(request);
        ...
        @Override
        public CreateEdgeFunctionRequest build() {
            return new CreateEdgeFunctionRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateEdgeFunctionRequest} extends {@link TeaModel}
     *
     * <p>CreateEdgeFunctionRequest</p>
     */
