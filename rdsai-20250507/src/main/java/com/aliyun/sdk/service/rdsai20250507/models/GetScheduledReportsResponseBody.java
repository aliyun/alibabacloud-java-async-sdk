...
/**
 * 
 * {@link GetScheduledReportsResponseBody} extends {@link TeaModel}
 *
 * <p>GetScheduledReportsResponseBody</p>
 */
public class GetScheduledReportsResponseBody extends TeaModel {
    ...
    private GetScheduledReportsResponseBody(Builder builder) {
    ...
    public static GetScheduledReportsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetScheduledReportsResponseBody model) {
        ...
        public GetScheduledReportsResponseBody build() {
            return new GetScheduledReportsResponseBody(this);
        } 
