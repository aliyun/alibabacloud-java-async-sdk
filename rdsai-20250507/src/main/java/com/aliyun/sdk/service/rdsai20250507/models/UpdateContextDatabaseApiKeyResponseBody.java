...
/**
 * 
 * {@link UpdateContextDatabaseApiKeyResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateContextDatabaseApiKeyResponseBody</p>
 */
public class UpdateContextDatabaseApiKeyResponseBody extends TeaModel {
    ...
    private UpdateContextDatabaseApiKeyResponseBody(Builder builder) {
    ...
    public static UpdateContextDatabaseApiKeyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateContextDatabaseApiKeyResponseBody model) {
        ...
        public UpdateContextDatabaseApiKeyResponseBody build() {
            return new UpdateContextDatabaseApiKeyResponseBody(this);
        } 
