...
/**
 * {@link CreateSceneModelRequest} extends {@link RequestModel}
 *
 * <p>CreateSceneModelRequest</p>
 */
public class CreateSceneModelRequest extends Request {
    @Body
    ...
    private CreateSceneModelRequest(Builder builder) {
        super(builder);
    ...
    public static CreateSceneModelRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateSceneModelRequest, Builder> {
        private String fcFunctionName; 
        private String fcHandler; 
        private String fcInitializer; 
        private String fcRegionNo; 
        ...
        private Builder(CreateSceneModelRequest request) {
            super(request);
        ...
        @Override
        public CreateSceneModelRequest build() {
            return new CreateSceneModelRequest(this);
        } 
