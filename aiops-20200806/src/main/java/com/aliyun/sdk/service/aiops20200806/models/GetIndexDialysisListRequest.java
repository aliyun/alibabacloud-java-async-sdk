...
/**
 * {@link GetIndexDialysisListRequest} extends {@link RequestModel}
 *
 * <p>GetIndexDialysisListRequest</p>
 */
public class GetIndexDialysisListRequest extends Request {
    @Query
    ...
    private GetIndexDialysisListRequest(Builder builder) {
        super(builder);
    ...
    public static GetIndexDialysisListRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetIndexDialysisListRequest, Builder> {
        private String businessGroupId; 
        private String cloudResourceId; 
        private String cloudTypeName; 
        private Integer currentPage; 
        ...
        private Builder(GetIndexDialysisListRequest request) {
            super(request);
        ...
        @Override
        public GetIndexDialysisListRequest build() {
            return new GetIndexDialysisListRequest(this);
        } 
