...
/**
 * {@link UpdateHandleRiskBaseRequest} extends {@link RequestModel}
 *
 * <p>UpdateHandleRiskBaseRequest</p>
 */
public class UpdateHandleRiskBaseRequest extends Request {
    @Query
    ...
    private UpdateHandleRiskBaseRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateHandleRiskBaseRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateHandleRiskBaseRequest, Builder> {
        private String handleDescribe; 
        private String operaUid; 
        private String patrolDetailIds; 
        private Long patrolId; 
        ...
        private Builder(UpdateHandleRiskBaseRequest request) {
            super(request);
        ...
        @Override
        public UpdateHandleRiskBaseRequest build() {
            return new UpdateHandleRiskBaseRequest(this);
        } 
