...
/**
 * {@link ListConfirmAuthorizationRequest} extends {@link RequestModel}
 *
 * <p>ListConfirmAuthorizationRequest</p>
 */
public class ListConfirmAuthorizationRequest extends Request {
    @Query
    ...
    private ListConfirmAuthorizationRequest(Builder builder) {
        super(builder);
    ...
    public static ListConfirmAuthorizationRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListConfirmAuthorizationRequest, Builder> {
        private Integer currentPage; 
        private Integer pageSize; 
        private Integer permissionType; 
        private String switchFrontOperaUid; 
        ...
        private Builder(ListConfirmAuthorizationRequest request) {
            super(request);
        ...
        @Override
        public ListConfirmAuthorizationRequest build() {
            return new ListConfirmAuthorizationRequest(this);
        } 
