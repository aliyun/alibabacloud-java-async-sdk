...
/**
 * 
 * {@link GetArEditCommonMaterialResponseBody} extends {@link TeaModel}
 *
 * <p>GetArEditCommonMaterialResponseBody</p>
 */
public class GetArEditCommonMaterialResponseBody extends TeaModel {
    ...
    private GetArEditCommonMaterialResponseBody(Builder builder) {
    ...
    public static GetArEditCommonMaterialResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetArEditCommonMaterialResponseBody model) {
        ...
        public GetArEditCommonMaterialResponseBody build() {
            return new GetArEditCommonMaterialResponseBody(this);
        } 
