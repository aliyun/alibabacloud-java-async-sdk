...
/**
 * 
 * {@link LoginAppResponseBody} extends {@link TeaModel}
 *
 * <p>LoginAppResponseBody</p>
 */
public class LoginAppResponseBody extends TeaModel {
    ...
    private LoginAppResponseBody(Builder builder) {
    ...
    public static LoginAppResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(LoginAppResponseBody model) {
        ...
        public LoginAppResponseBody build() {
            return new LoginAppResponseBody(this);
        } 
