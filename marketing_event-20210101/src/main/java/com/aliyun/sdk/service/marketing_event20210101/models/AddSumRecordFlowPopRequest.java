...
/**
 * 
 * {@link AddSumRecordFlowPopRequest} extends {@link RequestModel}
 *
 * <p>AddSumRecordFlowPopRequest</p>
 */
public class AddSumRecordFlowPopRequest extends Request {
    ...
    private AddSumRecordFlowPopRequest(Builder builder) {
        super(builder);
    ...
    public static AddSumRecordFlowPopRequest create() {
    ...
    public static final class Builder extends Request.Builder<AddSumRecordFlowPopRequest, Builder> {
        private String regionId; 
        private String activityId; 
        private String code; 
        private String conferenceName; 
        ...
        private Builder(AddSumRecordFlowPopRequest request) {
            super(request);
        ...
        @Override
        public AddSumRecordFlowPopRequest build() {
            return new AddSumRecordFlowPopRequest(this);
        } 
