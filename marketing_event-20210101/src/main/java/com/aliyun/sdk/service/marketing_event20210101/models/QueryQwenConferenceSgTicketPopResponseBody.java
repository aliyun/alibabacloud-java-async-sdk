...
/**
 * 
 * {@link QueryQwenConferenceSgTicketPopResponseBody} extends {@link TeaModel}
 *
 * <p>QueryQwenConferenceSgTicketPopResponseBody</p>
 */
public class QueryQwenConferenceSgTicketPopResponseBody extends TeaModel {
    ...
    private QueryQwenConferenceSgTicketPopResponseBody(Builder builder) {
    ...
    public static QueryQwenConferenceSgTicketPopResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryQwenConferenceSgTicketPopResponseBody model) {
        ...
        public QueryQwenConferenceSgTicketPopResponseBody build() {
            return new QueryQwenConferenceSgTicketPopResponseBody(this);
        } 
