...
/**
 * 
 * {@link BindExhibitorRfidPopRequest} extends {@link RequestModel}
 *
 * <p>BindExhibitorRfidPopRequest</p>
 */
public class BindExhibitorRfidPopRequest extends Request {
    ...
    private BindExhibitorRfidPopRequest(Builder builder) {
        super(builder);
    ...
    public static BindExhibitorRfidPopRequest create() {
    ...
    public static final class Builder extends Request.Builder<BindExhibitorRfidPopRequest, Builder> {
        private String regionId; 
        private Long activityId; 
        private String deviceId; 
        private String gmtCreate; 
        ...
        private Builder(BindExhibitorRfidPopRequest request) {
            super(request);
        ...
        @Override
        public BindExhibitorRfidPopRequest build() {
            return new BindExhibitorRfidPopRequest(this);
        } 
