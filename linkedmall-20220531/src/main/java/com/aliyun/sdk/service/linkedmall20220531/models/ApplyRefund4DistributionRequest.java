...
/**
 * {@link ApplyRefund4DistributionRequest} extends {@link RequestModel}
 *
 * <p>ApplyRefund4DistributionRequest</p>
 */
public class ApplyRefund4DistributionRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private ApplyRefund4DistributionRequest(Builder builder) {
        super(builder);
    ...
    public static ApplyRefund4DistributionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ApplyRefund4DistributionRequest, Builder> {
        private String regionId; 
        private Long applyReasonTextId; 
        private Integer applyRefundCount; 
        private Long applyRefundFee; 
        ...
        private Builder(ApplyRefund4DistributionRequest request) {
            super(request);
        ...
        @Override
        public ApplyRefund4DistributionRequest build() {
            return new ApplyRefund4DistributionRequest(this);
        } 
