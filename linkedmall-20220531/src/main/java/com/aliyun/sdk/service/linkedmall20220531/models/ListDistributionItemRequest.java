...
/**
 * {@link ListDistributionItemRequest} extends {@link RequestModel}
 *
 * <p>ListDistributionItemRequest</p>
 */
public class ListDistributionItemRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private ListDistributionItemRequest(Builder builder) {
        super(builder);
    ...
    public static ListDistributionItemRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListDistributionItemRequest, Builder> {
        private String regionId; 
        private String distributionMallId; 
        private String distributorId; 
        private Integer itemStatus; 
        ...
        private Builder(ListDistributionItemRequest request) {
            super(request);
        ...
        @Override
        public ListDistributionItemRequest build() {
            return new ListDistributionItemRequest(this);
        } 
