...
public class CancelOrderResponseBody extends TeaModel {
    ...
    @NameInMap("Header")
    private CancelOrderResponseBodyHeader header;
    ...
    public static final class Builder {
         ...
         * Header.
         */
        public Builder header(CancelOrderResponseBodyHeader header) {
            this.header = header;
            return this;
        }
    ...
    public static class CancelOrderResponseBodyHeader extends TeaModel {
        ...
        private CancelOrderResponseBodyHeader(Builder builder) {
        ...
        public static CancelOrderResponseBodyHeader create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public CancelOrderResponseBodyHeader build() {
                return new CancelOrderResponseBodyHeader(this);
            } 
