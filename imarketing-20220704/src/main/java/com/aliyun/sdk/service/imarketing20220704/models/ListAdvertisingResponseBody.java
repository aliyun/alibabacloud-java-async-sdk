...
/**
 * {@link ListAdvertisingResponseBody} extends {@link TeaModel}
 *
 * <p>ListAdvertisingResponseBody</p>
 */
public class ListAdvertisingResponseBody extends TeaModel {
    ...
    @NameInMap("Header")
    private ListAdvertisingResponseBodyHeader header;
    ...
    private ListAdvertisingResponseBody(Builder builder) {
    ...
    public static ListAdvertisingResponseBody create() {
    ...
    public static final class Builder {
         ...
         * Header.
         */
        public Builder header(ListAdvertisingResponseBodyHeader header) {
            this.header = header;
            return this;
        }
        ...
        public ListAdvertisingResponseBody build() {
            return new ListAdvertisingResponseBody(this);
        } 
    ...
    public static class ListAdvertisingResponseBodyHeader extends TeaModel {
        ...
        private ListAdvertisingResponseBodyHeader(Builder builder) {
        ...
        public static ListAdvertisingResponseBodyHeader create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public ListAdvertisingResponseBodyHeader build() {
                return new ListAdvertisingResponseBodyHeader(this);
            } 
