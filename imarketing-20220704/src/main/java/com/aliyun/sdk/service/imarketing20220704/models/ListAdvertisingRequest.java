...
/**
 * {@link ListAdvertisingRequest} extends {@link RequestModel}
 *
 * <p>ListAdvertisingRequest</p>
 */
public class ListAdvertisingRequest extends Request {
    @Query
    @NameInMap("App")
    private App app;
    ...
    private ListAdvertisingRequest(Builder builder) {
        super(builder);
    ...
    public static ListAdvertisingRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListAdvertisingRequest, Builder> {
        private App app; 
        private Integer dealtype; 
        private Device device; 
        private java.util.Map < String, ? > ext; 
        ...
        private Builder(ListAdvertisingRequest request) {
            super(request);
        ...
        @Override
        public ListAdvertisingRequest build() {
            return new ListAdvertisingRequest(this);
        } 
