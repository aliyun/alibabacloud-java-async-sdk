...
/**
 * {@link ConfirmSampleShippedResponseBody} extends {@link TeaModel}
 *
 * <p>ConfirmSampleShippedResponseBody</p>
 */
public class ConfirmSampleShippedResponseBody extends TeaModel {
    ...
    @NameInMap("Header")
    private ConfirmSampleShippedResponseBodyHeader header;
    ...
    private ConfirmSampleShippedResponseBody(Builder builder) {
    ...
    public static ConfirmSampleShippedResponseBody create() {
    ...
    public static final class Builder {
         ...
         * Header.
         */
        public Builder header(ConfirmSampleShippedResponseBodyHeader header) {
            this.header = header;
            return this;
        }
        ...
        public ConfirmSampleShippedResponseBody build() {
            return new ConfirmSampleShippedResponseBody(this);
        } 
    ...
    public static class ConfirmSampleShippedResponseBodyHeader extends TeaModel {
        ...
        private ConfirmSampleShippedResponseBodyHeader(Builder builder) {
        ...
        public static ConfirmSampleShippedResponseBodyHeader create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public ConfirmSampleShippedResponseBodyHeader build() {
                return new ConfirmSampleShippedResponseBodyHeader(this);
            } 
