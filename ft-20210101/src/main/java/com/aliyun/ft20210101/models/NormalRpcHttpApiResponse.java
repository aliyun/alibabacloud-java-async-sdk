...
public class NormalRpcHttpApiResponse extends Response {
    ...
    private NormalRpcHttpApiResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<NormalRpcHttpApiResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(NormalRpcHttpApiResponseBody body);

        @Override
        NormalRpcHttpApiResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<NormalRpcHttpApiResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private NormalRpcHttpApiResponseBody body; 
        ...
        private BuilderImpl(NormalRpcHttpApiResponse response) {
            super(response);
