...
/**
 * {@link CommonAsset} extends {@link TeaModel}
 *
 * <p>CommonAsset</p>
 */
public class CommonAsset extends TeaModel {
    ...
    @NameInMap("Images")
    private java.util.List < CommonMediaResource > images;
    ...
    @NameInMap("Videos")
    private java.util.List < CommonMediaResource > videos;

    private CommonAsset(Builder builder) {
    ...
    public static CommonAsset create() {
    ...
    public static final class Builder {
         ...
         * 图像资源
         */
        public Builder images(java.util.List < CommonMediaResource > images) {
            this.images = images;
            return this;
        }
         ...
         * 视频资源
         */
        public Builder videos(java.util.List < CommonMediaResource > videos) {
            this.videos = videos;
            return this;
        }

        public CommonAsset build() {
            return new CommonAsset(this);
        } 
