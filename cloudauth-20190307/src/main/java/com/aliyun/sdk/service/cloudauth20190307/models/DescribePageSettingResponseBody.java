...
/**
 * 
 * {@link DescribePageSettingResponseBody} extends {@link TeaModel}
 *
 * <p>DescribePageSettingResponseBody</p>
 */
public class DescribePageSettingResponseBody extends TeaModel {
    @com.aliyun.core.annotation.NameInMap("FailReasons")
    private java.util.Map<String, ?> failReasons;

    @com.aliyun.core.annotation.NameInMap("RequestId")
    private String requestId;

    private DescribePageSettingResponseBody(Builder builder) {
    ...
    public static DescribePageSettingResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribePageSettingResponseBody model) {
         ...
         *         }</p>
         */
        public Builder failReasons(java.util.Map<String, ?> failReasons) {
        ...
        public DescribePageSettingResponseBody build() {
            return new DescribePageSettingResponseBody(this);
        } 
