...
/**
 * 
 * {@link DownloadVerifyRecordsRequest} extends {@link RequestModel}
 *
 * <p>DownloadVerifyRecordsRequest</p>
 */
public class DownloadVerifyRecordsRequest extends Request {
    ...
    private DownloadVerifyRecordsRequest(Builder builder) {
        super(builder);
    ...
    public static DownloadVerifyRecordsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DownloadVerifyRecordsRequest, Builder> {
        private String bizParam; 
        private String productType; 
        ...
        private Builder(DownloadVerifyRecordsRequest request) {
            super(request);
         ...
         */
        public Builder bizParam(String bizParam) {
            this.putQueryParameter("BizParam", bizParam);
        ...
        @Override
        public DownloadVerifyRecordsRequest build() {
            return new DownloadVerifyRecordsRequest(this);
        } 
