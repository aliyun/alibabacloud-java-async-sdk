...
/**
 * {@link UploadMPCoSPhaseDigestInfoByDeviceRequest} extends {@link RequestModel}
 *
 * <p>UploadMPCoSPhaseDigestInfoByDeviceRequest</p>
 */
public class UploadMPCoSPhaseDigestInfoByDeviceRequest extends Request {
    @Query
    ...
    private UploadMPCoSPhaseDigestInfoByDeviceRequest(Builder builder) {
        super(builder);
    ...
    public static UploadMPCoSPhaseDigestInfoByDeviceRequest create() {
    ...
    public static final class Builder extends Request.Builder<UploadMPCoSPhaseDigestInfoByDeviceRequest, Builder> {
        private String apiVersion; 
        private String bizChainId; 
        private String dataKey; 
        private String dataSeq; 
        ...
        private Builder(UploadMPCoSPhaseDigestInfoByDeviceRequest request) {
            super(request);
        ...
        @Override
        public UploadMPCoSPhaseDigestInfoByDeviceRequest build() {
            return new UploadMPCoSPhaseDigestInfoByDeviceRequest(this);
        } 
