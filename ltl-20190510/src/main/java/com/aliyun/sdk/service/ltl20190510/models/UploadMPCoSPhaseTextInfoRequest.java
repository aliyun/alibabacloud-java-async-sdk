...
/**
 * {@link UploadMPCoSPhaseTextInfoRequest} extends {@link RequestModel}
 *
 * <p>UploadMPCoSPhaseTextInfoRequest</p>
 */
public class UploadMPCoSPhaseTextInfoRequest extends Request {
    @Query
    ...
    private UploadMPCoSPhaseTextInfoRequest(Builder builder) {
        super(builder);
    ...
    public static UploadMPCoSPhaseTextInfoRequest create() {
    ...
    public static final class Builder extends Request.Builder<UploadMPCoSPhaseTextInfoRequest, Builder> {
        private String apiVersion; 
        private String bizChainId; 
        private String dataKey; 
        private String dataSeq; 
        ...
        private Builder(UploadMPCoSPhaseTextInfoRequest request) {
            super(request);
        ...
        @Override
        public UploadMPCoSPhaseTextInfoRequest build() {
            return new UploadMPCoSPhaseTextInfoRequest(this);
        } 
