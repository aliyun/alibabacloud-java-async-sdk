...
/**
 * {@link BatchUploadMPCoSPhaseTextInfoRequest} extends {@link RequestModel}
 *
 * <p>BatchUploadMPCoSPhaseTextInfoRequest</p>
 */
public class BatchUploadMPCoSPhaseTextInfoRequest extends Request {
    @Query
    ...
    private BatchUploadMPCoSPhaseTextInfoRequest(Builder builder) {
        super(builder);
    ...
    public static BatchUploadMPCoSPhaseTextInfoRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchUploadMPCoSPhaseTextInfoRequest, Builder> {
        private String apiVersion; 
        private String bizChainId; 
        private java.util.Map < String, ? > phaseDataList; 
        private String phaseGroupId; 
        ...
        private Builder(BatchUploadMPCoSPhaseTextInfoRequest request) {
            super(request);
        ...
        @Override
        public BatchUploadMPCoSPhaseTextInfoRequest build() {
            return new BatchUploadMPCoSPhaseTextInfoRequest(this);
        } 
