...
/**
 * {@link CreateMPCoSPhaseRequest} extends {@link RequestModel}
 *
 * <p>CreateMPCoSPhaseRequest</p>
 */
public class CreateMPCoSPhaseRequest extends Request {
    @Query
    ...
    private CreateMPCoSPhaseRequest(Builder builder) {
        super(builder);
    ...
    public static CreateMPCoSPhaseRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateMPCoSPhaseRequest, Builder> {
        private String apiVersion; 
        private String bizChainId; 
        private String name; 
        private String phaseGroupId; 
        ...
        private Builder(CreateMPCoSPhaseRequest request) {
            super(request);
        ...
        @Override
        public CreateMPCoSPhaseRequest build() {
            return new CreateMPCoSPhaseRequest(this);
        } 
