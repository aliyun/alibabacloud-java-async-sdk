...
/**
 * {@link AttachDataWithSignatureRequest} extends {@link RequestModel}
 *
 * <p>AttachDataWithSignatureRequest</p>
 */
public class AttachDataWithSignatureRequest extends Request {
    @Query
    ...
    private AttachDataWithSignatureRequest(Builder builder) {
        super(builder);
    ...
    public static AttachDataWithSignatureRequest create() {
    ...
    public static final class Builder extends Request.Builder<AttachDataWithSignatureRequest, Builder> {
        private String apiVersion; 
        private String businessId; 
        private String iotAuthType; 
        private String iotDataDigest; 
        ...
        private Builder(AttachDataWithSignatureRequest request) {
            super(request);
        ...
        @Override
        public AttachDataWithSignatureRequest build() {
            return new AttachDataWithSignatureRequest(this);
        } 
