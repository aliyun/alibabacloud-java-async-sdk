...
/**
 * {@link BatchUploadMPCoSPhaseDigestInfoByDeviceRequest} extends {@link RequestModel}
 *
 * <p>BatchUploadMPCoSPhaseDigestInfoByDeviceRequest</p>
 */
public class BatchUploadMPCoSPhaseDigestInfoByDeviceRequest extends Request {
    @Query
    ...
    private BatchUploadMPCoSPhaseDigestInfoByDeviceRequest(Builder builder) {
        super(builder);
    ...
    public static BatchUploadMPCoSPhaseDigestInfoByDeviceRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchUploadMPCoSPhaseDigestInfoByDeviceRequest, Builder> {
        private String apiVersion; 
        private String bizChainId; 
        private String iotAuthType; 
        private String iotDataDigest; 
        ...
        private Builder(BatchUploadMPCoSPhaseDigestInfoByDeviceRequest request) {
            super(request);
        ...
        @Override
        public BatchUploadMPCoSPhaseDigestInfoByDeviceRequest build() {
            return new BatchUploadMPCoSPhaseDigestInfoByDeviceRequest(this);
        } 
