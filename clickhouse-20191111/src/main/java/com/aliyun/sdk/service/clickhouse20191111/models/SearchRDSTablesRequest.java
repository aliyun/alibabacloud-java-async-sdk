...
/**
 * {@link SearchRDSTablesRequest} extends {@link RequestModel}
 *
 * <p>SearchRDSTablesRequest</p>
 */
public class SearchRDSTablesRequest extends Request {
    @Query
    ...
    private SearchRDSTablesRequest(Builder builder) {
        super(builder);
    ...
    public static SearchRDSTablesRequest create() {
    ...
    public static final class Builder extends Request.Builder<SearchRDSTablesRequest, Builder> {
        private String dbClusterId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String rdsId; 
        ...
        private Builder(SearchRDSTablesRequest response) {
            super(response);
        ...
        @Override
        public SearchRDSTablesRequest build() {
            return new SearchRDSTablesRequest(this);
        } 
