 ...
 */
public class ModifyMinorVersionGreadeTypeRequest extends Request {
    ...
    private ModifyMinorVersionGreadeTypeRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyMinorVersionGreadeTypeRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyMinorVersionGreadeTypeRequest, Builder> {
        private String DBClusterId; 
        private Boolean maintainAutoType; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ModifyMinorVersionGreadeTypeRequest request) {
            super(request);
            this.DBClusterId = request.DBClusterId;
            this.maintainAutoType = request.maintainAutoType;
        ...
        @Override
        public ModifyMinorVersionGreadeTypeRequest build() {
            return new ModifyMinorVersionGreadeTypeRequest(this);
        } 
