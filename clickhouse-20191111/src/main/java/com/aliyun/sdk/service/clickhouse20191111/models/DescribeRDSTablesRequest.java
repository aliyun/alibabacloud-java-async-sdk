...
/**
 * {@link DescribeRDSTablesRequest} extends {@link RequestModel}
 *
 * <p>DescribeRDSTablesRequest</p>
 */
public class DescribeRDSTablesRequest extends Request {
    @Query
    ...
    private DescribeRDSTablesRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeRDSTablesRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeRDSTablesRequest, Builder> {
        private String dbClusterId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String rdsId; 
        ...
        private Builder(DescribeRDSTablesRequest response) {
            super(response);
        ...
        @Override
        public DescribeRDSTablesRequest build() {
            return new DescribeRDSTablesRequest(this);
        } 
