...
public class DeleteBackupPolicyResponse extends Response {
    ...
    private DeleteBackupPolicyResponse(BuilderImpl builder) {
        super(builder);
...
@Override
    ...
    public interface Builder extends Response.Builder<DeleteBackupPolicyResponse, Builder> {

        Builder headers(java.util.Map<String, String> headers);

        Builder statusCode(Integer statusCode);

        Builder body(DeleteBackupPolicyResponseBody body);

        @Override
        DeleteBackupPolicyResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<DeleteBackupPolicyResponse, Builder>
            implements Builder {
        private java.util.Map<String, String> headers; 
        private Integer statusCode; 
        private DeleteBackupPolicyResponseBody body; 
        ...
        private BuilderImpl(DeleteBackupPolicyResponse response) {
            super(response);
