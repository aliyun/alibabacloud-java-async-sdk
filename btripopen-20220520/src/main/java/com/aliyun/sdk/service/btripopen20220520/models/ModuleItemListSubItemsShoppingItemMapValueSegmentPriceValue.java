...
/**
 * 
 * {@link ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue} extends {@link TeaModel}
 *
 * <p>ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue</p>
 */
public class ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue extends TeaModel {
    ...
    private ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue(Builder builder) {
    ...
    public static ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue model) {
        ...
        public ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue build() {
            return new ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue(this);
        } 
