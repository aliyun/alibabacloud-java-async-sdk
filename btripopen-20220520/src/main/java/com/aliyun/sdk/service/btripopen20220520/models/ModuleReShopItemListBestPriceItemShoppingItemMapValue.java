...
/**
 * 
 * {@link ModuleReShopItemListBestPriceItemShoppingItemMapValue} extends {@link TeaModel}
 *
 * <p>ModuleReShopItemListBestPriceItemShoppingItemMapValue</p>
 */
public class ModuleReShopItemListBestPriceItemShoppingItemMapValue extends TeaModel {
    ...
    private ModuleReShopItemListBestPriceItemShoppingItemMapValue(Builder builder) {
    ...
    public static ModuleReShopItemListBestPriceItemShoppingItemMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleReShopItemListBestPriceItemShoppingItemMapValue model) {
        ...
        public ModuleReShopItemListBestPriceItemShoppingItemMapValue build() {
            return new ModuleReShopItemListBestPriceItemShoppingItemMapValue(this);
        } 
