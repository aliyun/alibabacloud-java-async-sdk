...
/**
 * 
 * {@link MealApplyModifyRequest} extends {@link RequestModel}
 *
 * <p>MealApplyModifyRequest</p>
 */
public class MealApplyModifyRequest extends Request {
    ...
    private MealApplyModifyRequest(Builder builder) {
        super(builder);
    ...
    public static MealApplyModifyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<MealApplyModifyRequest, Builder> {
        private ApplyUser applyUser; 
        private Long costCenterId; 
        private String extendField; 
        private Long invoiceId; 
        ...
        private Builder(MealApplyModifyRequest request) {
            super(request);
        ...
        @Override
        public MealApplyModifyRequest build() {
            return new MealApplyModifyRequest(this);
        } 
    ...
    /**
     * 
     * {@link MealApplyModifyRequest} extends {@link TeaModel}
     *
     * <p>MealApplyModifyRequest</p>
     */
