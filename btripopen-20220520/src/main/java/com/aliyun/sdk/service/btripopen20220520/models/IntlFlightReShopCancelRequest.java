...
/**
 * 
 * {@link IntlFlightReShopCancelRequest} extends {@link RequestModel}
 *
 * <p>IntlFlightReShopCancelRequest</p>
 */
public class IntlFlightReShopCancelRequest extends Request {
    ...
    private IntlFlightReShopCancelRequest(Builder builder) {
        super(builder);
    ...
    public static IntlFlightReShopCancelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<IntlFlightReShopCancelRequest, Builder> {
        private String orderId; 
        private String outOrderId; 
        private String outReShopApplyId; 
        private String reShopApplyId; 
        ...
        private Builder(IntlFlightReShopCancelRequest request) {
            super(request);
        ...
        public Builder reShopApplyId(String reShopApplyId) {
            this.putBodyParameter("re_shop_apply_id", reShopApplyId);
        ...
        @Override
        public IntlFlightReShopCancelRequest build() {
            return new IntlFlightReShopCancelRequest(this);
        } 
