...
/**
 * 
 * {@link ModuleItemListShoppingItemMapValueSegmentPriceValue} extends {@link TeaModel}
 *
 * <p>ModuleItemListShoppingItemMapValueSegmentPriceValue</p>
 */
public class ModuleItemListShoppingItemMapValueSegmentPriceValue extends TeaModel {
    ...
    private ModuleItemListShoppingItemMapValueSegmentPriceValue(Builder builder) {
    ...
    public static ModuleItemListShoppingItemMapValueSegmentPriceValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleItemListShoppingItemMapValueSegmentPriceValue model) {
        ...
        public ModuleItemListShoppingItemMapValueSegmentPriceValue build() {
            return new ModuleItemListShoppingItemMapValueSegmentPriceValue(this);
        } 
