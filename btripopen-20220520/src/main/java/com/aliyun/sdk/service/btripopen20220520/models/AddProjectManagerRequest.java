...
/**
 * 
 * {@link AddProjectManagerRequest} extends {@link RequestModel}
 *
 * <p>AddProjectManagerRequest</p>
 */
public class AddProjectManagerRequest extends Request {
    ...
    private AddProjectManagerRequest(Builder builder) {
        super(builder);
    ...
    public static AddProjectManagerRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddProjectManagerRequest, Builder> {
        private java.util.List<OrgEntities> orgEntities; 
        private String outProjectId; 
        private Long projectId; 
        private String xAcsBtripCorpToken; 
        ...
        private Builder(AddProjectManagerRequest request) {
            super(request);
        ...
        @Override
        public AddProjectManagerRequest build() {
            return new AddProjectManagerRequest(this);
        } 
    ...
    /**
     * 
     * {@link AddProjectManagerRequest} extends {@link TeaModel}
     *
     * <p>AddProjectManagerRequest</p>
     */
