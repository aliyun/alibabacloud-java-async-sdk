...
/**
 * 
 * {@link ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue} extends {@link TeaModel}
 *
 * <p>ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue</p>
 */
public class ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue extends TeaModel {
    ...
    private ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue(Builder builder) {
    ...
    public static ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue model) {
        ...
        public ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue build() {
            return new ModuleItemListSubItemsShoppingItemMapValueCabinQuantityValue(this);
        } 
