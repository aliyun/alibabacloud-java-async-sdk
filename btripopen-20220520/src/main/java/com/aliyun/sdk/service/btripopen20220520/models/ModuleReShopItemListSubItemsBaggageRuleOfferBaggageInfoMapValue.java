...
/**
 * 
 * {@link ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue} extends {@link TeaModel}
 *
 * <p>ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue</p>
 */
public class ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue extends TeaModel {
    ...
    private ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue(Builder builder) {
    ...
    public static ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue model) {
        ...
        public ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue build() {
            return new ModuleReShopItemListSubItemsBaggageRuleOfferBaggageInfoMapValue(this);
        } 
