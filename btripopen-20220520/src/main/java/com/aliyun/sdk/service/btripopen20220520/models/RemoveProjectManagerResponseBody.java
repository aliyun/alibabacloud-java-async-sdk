...
/**
 * 
 * {@link RemoveProjectManagerResponseBody} extends {@link TeaModel}
 *
 * <p>RemoveProjectManagerResponseBody</p>
 */
public class RemoveProjectManagerResponseBody extends TeaModel {
    ...
    private RemoveProjectManagerResponseBody(Builder builder) {
    ...
    public static RemoveProjectManagerResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RemoveProjectManagerResponseBody model) {
        ...
        public RemoveProjectManagerResponseBody build() {
            return new RemoveProjectManagerResponseBody(this);
        } 
