...
/**
 * 
 * {@link TicketChangingDetailRequest} extends {@link RequestModel}
 *
 * <p>TicketChangingDetailRequest</p>
 */
public class TicketChangingDetailRequest extends Request {
    ...
    private TicketChangingDetailRequest(Builder builder) {
        super(builder);
    ...
    public static TicketChangingDetailRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<TicketChangingDetailRequest, Builder> {
        private String disOrderId; 
        private String disSubOrderId; 
        private String xAcsBtripCorpToken; 
        ...
        private Builder(TicketChangingDetailRequest request) {
            super(request);
        ...
        @Override
        public TicketChangingDetailRequest build() {
            return new TicketChangingDetailRequest(this);
        } 
