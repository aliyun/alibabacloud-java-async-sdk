...
/**
 * 
 * {@link IntlFlightReShopOtaSearchRequest} extends {@link RequestModel}
 *
 * <p>IntlFlightReShopOtaSearchRequest</p>
 */
public class IntlFlightReShopOtaSearchRequest extends Request {
    ...
    private IntlFlightReShopOtaSearchRequest(Builder builder) {
        super(builder);
    ...
    public static IntlFlightReShopOtaSearchRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<IntlFlightReShopOtaSearchRequest, Builder> {
        private String orderId; 
        private String outOrderId; 
        private Boolean outWheelSearch; 
        private String passengerJourneyGroupKey; 
        ...
        private Builder(IntlFlightReShopOtaSearchRequest request) {
            super(request);
        ...
        @Override
        public IntlFlightReShopOtaSearchRequest build() {
            return new IntlFlightReShopOtaSearchRequest(this);
        } 
    ...
    /**
     * 
     * {@link IntlFlightReShopOtaSearchRequest} extends {@link TeaModel}
     *
     * <p>IntlFlightReShopOtaSearchRequest</p>
     */
