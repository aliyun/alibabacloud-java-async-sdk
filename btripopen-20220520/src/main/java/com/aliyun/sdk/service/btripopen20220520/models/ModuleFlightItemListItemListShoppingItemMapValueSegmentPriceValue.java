...
public class ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue extends TeaModel {
    ...
    public static ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue model) {
        ...
        public ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue build() {
            return new ModuleFlightItemListItemListShoppingItemMapValueSegmentPriceValue(this);
        } 
