...
/**
 * {@link TrainOrderListQueryRequest} extends {@link RequestModel}
 *
 * <p>TrainOrderListQueryRequest</p>
 */
public class TrainOrderListQueryRequest extends Request {
    ...
    private TrainOrderListQueryRequest(Builder builder) {
        super(builder);
    ...
    public static TrainOrderListQueryRequest create() {
    ...
    public static final class Builder extends Request.Builder<TrainOrderListQueryRequest, Builder> {
        private Boolean allApply; 
        private Long applyId; 
        private String departId; 
        private String endTime; 
        ...
        private Builder(TrainOrderListQueryRequest request) {
            super(request);
        ...
        @Override
        public TrainOrderListQueryRequest build() {
            return new TrainOrderListQueryRequest(this);
        } 
