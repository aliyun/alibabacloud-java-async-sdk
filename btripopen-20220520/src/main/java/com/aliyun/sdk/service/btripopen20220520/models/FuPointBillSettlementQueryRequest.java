...
/**
 * 
 * {@link FuPointBillSettlementQueryRequest} extends {@link RequestModel}
 *
 * <p>FuPointBillSettlementQueryRequest</p>
 */
public class FuPointBillSettlementQueryRequest extends Request {
    ...
    private FuPointBillSettlementQueryRequest(Builder builder) {
        super(builder);
    ...
    public static FuPointBillSettlementQueryRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<FuPointBillSettlementQueryRequest, Builder> {
        ...
        private Builder(FuPointBillSettlementQueryRequest request) {
            super(request);
        ...
        @Override
        public FuPointBillSettlementQueryRequest build() {
            return new FuPointBillSettlementQueryRequest(this);
        } 
