...
/**
 * 
 * {@link ConfirmPreBillResponseBody} extends {@link TeaModel}
 *
 * <p>ConfirmPreBillResponseBody</p>
 */
public class ConfirmPreBillResponseBody extends TeaModel {
    ...
    private ConfirmPreBillResponseBody(Builder builder) {
    ...
    public static ConfirmPreBillResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ConfirmPreBillResponseBody model) {
        ...
        public ConfirmPreBillResponseBody build() {
            return new ConfirmPreBillResponseBody(this);
        } 
