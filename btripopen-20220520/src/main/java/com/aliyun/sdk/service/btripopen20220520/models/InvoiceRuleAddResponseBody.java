...
/**
 * 
 * {@link InvoiceRuleAddResponseBody} extends {@link TeaModel}
 *
 * <p>InvoiceRuleAddResponseBody</p>
 */
public class InvoiceRuleAddResponseBody extends TeaModel {
    ...
    private InvoiceRuleAddResponseBody(Builder builder) {
    ...
    public static InvoiceRuleAddResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(InvoiceRuleAddResponseBody model) {
        ...
        public InvoiceRuleAddResponseBody build() {
            return new InvoiceRuleAddResponseBody(this);
        } 
