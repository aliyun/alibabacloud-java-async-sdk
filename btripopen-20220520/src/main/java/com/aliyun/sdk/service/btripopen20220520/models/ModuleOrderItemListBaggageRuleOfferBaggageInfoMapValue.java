...
/**
 * 
 * {@link ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue} extends {@link TeaModel}
 *
 * <p>ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue</p>
 */
public class ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue extends TeaModel {
    ...
    private ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue(Builder builder) {
    ...
    public static ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue model) {
        ...
        public ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue build() {
            return new ModuleOrderItemListBaggageRuleOfferBaggageInfoMapValue(this);
        } 
