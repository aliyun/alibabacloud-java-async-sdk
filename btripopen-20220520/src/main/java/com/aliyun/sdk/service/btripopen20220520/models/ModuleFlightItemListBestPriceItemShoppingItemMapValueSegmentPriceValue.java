 ...
 */
public class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue extends TeaModel {
    ...
    private ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue(Builder builder) {
    ...
    public static ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue model) {
        ...
        public ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue build() {
            return new ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue(this);
        } 
