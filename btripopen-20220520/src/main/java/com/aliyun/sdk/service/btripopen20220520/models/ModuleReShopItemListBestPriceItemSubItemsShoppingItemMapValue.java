...
/**
 * 
 * {@link ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue} extends {@link TeaModel}
 *
 * <p>ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue</p>
 */
public class ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue extends TeaModel {
    ...
    private ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue(Builder builder) {
    ...
    public static ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue model) {
        ...
        public ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue build() {
            return new ModuleReShopItemListBestPriceItemSubItemsShoppingItemMapValue(this);
        } 
