...
public class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue extends TeaModel {
    ...
    public static ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue model) {
            this.id = model.id;
        ...
        public ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue build() {
            return new ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue(this);
        } 
