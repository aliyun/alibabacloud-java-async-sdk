...
/**
 * 
 * {@link ModuleReShopItemListShoppingItemMapValue} extends {@link TeaModel}
 *
 * <p>ModuleReShopItemListShoppingItemMapValue</p>
 */
public class ModuleReShopItemListShoppingItemMapValue extends TeaModel {
    ...
    private ModuleReShopItemListShoppingItemMapValue(Builder builder) {
    ...
    public static ModuleReShopItemListShoppingItemMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleReShopItemListShoppingItemMapValue model) {
        ...
        public ModuleReShopItemListShoppingItemMapValue build() {
            return new ModuleReShopItemListShoppingItemMapValue(this);
        } 
