...
/**
 * 
 * {@link ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue} extends {@link TeaModel}
 *
 * <p>ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue</p>
 */
public class ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue extends TeaModel {
    ...
    private ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue(Builder builder) {
    ...
    public static ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue model) {
        ...
        public ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue build() {
            return new ModuleReShopItemListSubItemsRefundChangeRuleOfferPenaltyInfoMapValue(this);
        } 
