...
public class ModuleFlightItemListItemListSubItemsShoppingItemMapValue extends TeaModel {
    ...
    public static ModuleFlightItemListItemListSubItemsShoppingItemMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleFlightItemListItemListSubItemsShoppingItemMapValue model) {
            this.id = model.id;
        ...
        public ModuleFlightItemListItemListSubItemsShoppingItemMapValue build() {
            return new ModuleFlightItemListItemListSubItemsShoppingItemMapValue(this);
        } 
