...
/**
 * 
 * {@link ApplyAddResponseBody} extends {@link TeaModel}
 *
 * <p>ApplyAddResponseBody</p>
 */
public class ApplyAddResponseBody extends TeaModel {
    ...
    private ApplyAddResponseBody(Builder builder) {
    ...
    public static ApplyAddResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ApplyAddResponseBody model) {
        ...
        public ApplyAddResponseBody build() {
            return new ApplyAddResponseBody(this);
        } 
