...
public class ModuleFlightItemListBestPriceItemShoppingItemMapValue extends TeaModel {
    ...
    public static ModuleFlightItemListBestPriceItemShoppingItemMapValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleFlightItemListBestPriceItemShoppingItemMapValue model) {
        ...
        public ModuleFlightItemListBestPriceItemShoppingItemMapValue build() {
            return new ModuleFlightItemListBestPriceItemShoppingItemMapValue(this);
        } 
