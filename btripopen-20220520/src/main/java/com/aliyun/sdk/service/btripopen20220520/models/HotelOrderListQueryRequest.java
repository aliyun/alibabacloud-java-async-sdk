...
public class HotelOrderListQueryRequest extends Request {
    ...
    public static HotelOrderListQueryRequest create() {
    ...
    public static final class Builder extends Request.Builder<HotelOrderListQueryRequest, Builder> {
        ...
        private Builder(HotelOrderListQueryRequest request) {
            super(request);
        ...
        @Override
        public HotelOrderListQueryRequest build() {
            return new HotelOrderListQueryRequest(this);
        } 
