...
public class CreateSubCorpResponseBody extends TeaModel {
    ...
    private CreateSubCorpResponseBody(Builder builder) {
    ...
    public static CreateSubCorpResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateSubCorpResponseBody model) {
        ...
        public CreateSubCorpResponseBody build() {
            return new CreateSubCorpResponseBody(this);
        } 
