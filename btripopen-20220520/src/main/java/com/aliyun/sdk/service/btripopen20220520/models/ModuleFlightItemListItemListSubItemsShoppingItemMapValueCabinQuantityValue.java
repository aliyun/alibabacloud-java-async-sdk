...
public class ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue extends TeaModel {
    ...
    public static ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue model) {
        ...
        public ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue build() {
            return new ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue(this);
        } 
