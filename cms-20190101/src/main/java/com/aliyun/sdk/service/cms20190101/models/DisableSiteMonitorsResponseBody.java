...
public class DisableSiteMonitorsResponseBody extends TeaModel {
    ...
    public static DisableSiteMonitorsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DisableSiteMonitorsResponseBody model) {
        ...
        public DisableSiteMonitorsResponseBody build() {
            return new DisableSiteMonitorsResponseBody(this);
        } 
