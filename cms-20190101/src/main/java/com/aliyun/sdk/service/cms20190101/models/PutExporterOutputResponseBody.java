...
public class PutExporterOutputResponseBody extends TeaModel {
    ...
    private PutExporterOutputResponseBody(Builder builder) {
    ...
    public static PutExporterOutputResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PutExporterOutputResponseBody model) {
        ...
        public PutExporterOutputResponseBody build() {
            return new PutExporterOutputResponseBody(this);
        } 
