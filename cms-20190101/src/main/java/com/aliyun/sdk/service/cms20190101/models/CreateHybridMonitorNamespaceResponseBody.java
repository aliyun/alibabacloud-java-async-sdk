...
public class CreateHybridMonitorNamespaceResponseBody extends TeaModel {
    ...
    public static CreateHybridMonitorNamespaceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateHybridMonitorNamespaceResponseBody model) {
        ...
        public CreateHybridMonitorNamespaceResponseBody build() {
            return new CreateHybridMonitorNamespaceResponseBody(this);
        } 
