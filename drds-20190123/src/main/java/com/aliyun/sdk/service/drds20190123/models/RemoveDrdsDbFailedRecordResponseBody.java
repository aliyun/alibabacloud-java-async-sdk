...
public class RemoveDrdsDbFailedRecordResponseBody extends TeaModel {
    ...
    public static RemoveDrdsDbFailedRecordResponseBody create() {
    ...
    public static final class Builder {
        ...
        public RemoveDrdsDbFailedRecordResponseBody build() {
            return new RemoveDrdsDbFailedRecordResponseBody(this);
        } 
