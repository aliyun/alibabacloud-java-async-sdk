...
public class RollbackInstanceVersionResponseBody extends TeaModel {
    ...
    public static RollbackInstanceVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        public RollbackInstanceVersionResponseBody build() {
            return new RollbackInstanceVersionResponseBody(this);
        } 
