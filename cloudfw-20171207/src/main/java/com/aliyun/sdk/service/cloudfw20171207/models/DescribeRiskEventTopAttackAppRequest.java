...
/**
 * 
 * {@link DescribeRiskEventTopAttackAppRequest} extends {@link RequestModel}
 *
 * <p>DescribeRiskEventTopAttackAppRequest</p>
 */
public class DescribeRiskEventTopAttackAppRequest extends Request {
    ...
    private DescribeRiskEventTopAttackAppRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeRiskEventTopAttackAppRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeRiskEventTopAttackAppRequest, Builder> {
        private java.util.List<String> attackApp; 
        private String attackType; 
        private String buyVersion; 
        private String endTime; 
        ...
        private Builder(DescribeRiskEventTopAttackAppRequest request) {
            super(request);
        ...
        @Override
        public DescribeRiskEventTopAttackAppRequest build() {
            return new DescribeRiskEventTopAttackAppRequest(this);
        } 
