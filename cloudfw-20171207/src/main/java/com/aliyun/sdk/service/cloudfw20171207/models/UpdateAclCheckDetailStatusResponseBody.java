...
/**
 * 
 * {@link UpdateAclCheckDetailStatusResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAclCheckDetailStatusResponseBody</p>
 */
public class UpdateAclCheckDetailStatusResponseBody extends TeaModel {
    ...
    private UpdateAclCheckDetailStatusResponseBody(Builder builder) {
    ...
    public static UpdateAclCheckDetailStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAclCheckDetailStatusResponseBody model) {
        ...
        public UpdateAclCheckDetailStatusResponseBody build() {
            return new UpdateAclCheckDetailStatusResponseBody(this);
        } 
    ...
    public static class CheckRecord extends TeaModel {
        ...
        @com.aliyun.core.annotation.NameInMap("PolicyTotalCount")
        ...
        private CheckRecord(Builder builder) {
            ...
            this.policyTotalCount = builder.policyTotalCount;
        ...
        public static final class Builder {
            ...
            private Builder(CheckRecord model) {
                ...
                this.policyTotalCount = model.policyTotalCount;
