...
public class GetResourceTagsResponse extends Response {
    ...
    @NameInMap("body")
    @Validation(required = true)
    private GetResourceTagsOutput body;
     ...
     * @return body
     */
    public GetResourceTagsOutput getBody() {
        return this.body;
    }
    ...
    public interface Builder extends Response.Builder<GetResourceTagsResponse, Builder> {
        ...
        Builder body(GetResourceTagsOutput body);
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(GetResourceTagsOutput body) {
            this.body = body;
            return this;
        }
