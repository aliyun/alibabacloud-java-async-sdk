...
/**
 * 
 * {@link DescribeAlarmHistoryResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAlarmHistoryResponseBody</p>
 */
public class DescribeAlarmHistoryResponseBody extends TeaModel {
    ...
    private DescribeAlarmHistoryResponseBody(Builder builder) {
    ...
    public static DescribeAlarmHistoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeAlarmHistoryResponseBody model) {
        ...
        public DescribeAlarmHistoryResponseBody build() {
            return new DescribeAlarmHistoryResponseBody(this);
        } 
