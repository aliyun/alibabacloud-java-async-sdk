...
/**
 * 
 * {@link GetMyGroupsResponseBody} extends {@link TeaModel}
 *
 * <p>GetMyGroupsResponseBody</p>
 */
public class GetMyGroupsResponseBody extends TeaModel {
    ...
    private GetMyGroupsResponseBody(Builder builder) {
    ...
    public static GetMyGroupsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetMyGroupsResponseBody model) {
        ...
        public GetMyGroupsResponseBody build() {
            return new GetMyGroupsResponseBody(this);
        } 
