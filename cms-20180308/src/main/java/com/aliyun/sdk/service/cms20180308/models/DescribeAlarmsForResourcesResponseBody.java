...
/**
 * 
 * {@link DescribeAlarmsForResourcesResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAlarmsForResourcesResponseBody</p>
 */
public class DescribeAlarmsForResourcesResponseBody extends TeaModel {
    ...
    private DescribeAlarmsForResourcesResponseBody(Builder builder) {
    ...
    public static DescribeAlarmsForResourcesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeAlarmsForResourcesResponseBody model) {
        ...
        public DescribeAlarmsForResourcesResponseBody build() {
            return new DescribeAlarmsForResourcesResponseBody(this);
        } 
