...
/**
 * 
 * {@link RejectPushResponseBody} extends {@link TeaModel}
 *
 * <p>RejectPushResponseBody</p>
 */
public class RejectPushResponseBody extends TeaModel {
    ...
    private RejectPushResponseBody(Builder builder) {
    ...
    public static RejectPushResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RejectPushResponseBody model) {
        ...
        public RejectPushResponseBody build() {
            return new RejectPushResponseBody(this);
        } 
