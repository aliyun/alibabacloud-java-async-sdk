...
/**
 * 
 * {@link QueryCloseoutDomainInfoResponseBody} extends {@link TeaModel}
 *
 * <p>QueryCloseoutDomainInfoResponseBody</p>
 */
public class QueryCloseoutDomainInfoResponseBody extends TeaModel {
    ...
    private QueryCloseoutDomainInfoResponseBody(Builder builder) {
    ...
    public static QueryCloseoutDomainInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryCloseoutDomainInfoResponseBody model) {
        ...
        public QueryCloseoutDomainInfoResponseBody build() {
            return new QueryCloseoutDomainInfoResponseBody(this);
        } 
