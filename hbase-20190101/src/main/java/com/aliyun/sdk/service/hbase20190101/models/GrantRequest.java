...
/**
 * {@link GrantRequest} extends {@link RequestModel}
 *
 * <p>GrantRequest</p>
 */
public class GrantRequest extends Request {
    ...
    public static GrantRequest create() {
    ...
    public static final class Builder extends Request.Builder<GrantRequest, Builder> {
        private String accountName; 
        private String aclActions; 
        private String clusterId; 
        private String namespace; 
        ...
        private Builder(GrantRequest request) {
            super(request);
