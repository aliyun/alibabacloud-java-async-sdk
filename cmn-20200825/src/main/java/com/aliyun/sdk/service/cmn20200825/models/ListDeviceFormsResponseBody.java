...
/**
 * {@link ListDeviceFormsResponseBody} extends {@link TeaModel}
 *
 * <p>ListDeviceFormsResponseBody</p>
 */
public class ListDeviceFormsResponseBody extends TeaModel {
    @NameInMap("DeviceForms")
    private java.util.List < DeviceForms> deviceForms;
    ...
    private ListDeviceFormsResponseBody(Builder builder) {
        this.deviceForms = builder.deviceForms;
    ...
    public static ListDeviceFormsResponseBody create() {
     ...
     * @return deviceForms
     */
    public java.util.List < DeviceForms> getDeviceForms() {
    ...
    public static final class Builder {
         ...
         * DeviceForms.
         */
        public Builder deviceForms(java.util.List < DeviceForms> deviceForms) {
        ...
        public ListDeviceFormsResponseBody build() {
            return new ListDeviceFormsResponseBody(this);
        } 
    ...
    public static class DeviceForms extends TeaModel {
        ...
        private DeviceForms(Builder builder) {
        ...
        public static DeviceForms create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public DeviceForms build() {
                return new DeviceForms(this);
            } 
