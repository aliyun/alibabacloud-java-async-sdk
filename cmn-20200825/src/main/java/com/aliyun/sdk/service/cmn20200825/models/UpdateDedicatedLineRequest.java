...
/**
 * {@link UpdateDedicatedLineRequest} extends {@link RequestModel}
 *
 * <p>UpdateDedicatedLineRequest</p>
 */
public class UpdateDedicatedLineRequest extends Request {
    @Body
    @NameInMap("Bandwidth")
    ...
    private UpdateDedicatedLineRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateDedicatedLineRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateDedicatedLineRequest, Builder> {
        private Integer bandwidth; 
        private String contact; 
        private String dedicatedLineGateway; 
        private String dedicatedLineId; 
        ...
        private Builder(UpdateDedicatedLineRequest request) {
            super(request);
        ...
        @Override
        public UpdateDedicatedLineRequest build() {
            return new UpdateDedicatedLineRequest(this);
        } 
