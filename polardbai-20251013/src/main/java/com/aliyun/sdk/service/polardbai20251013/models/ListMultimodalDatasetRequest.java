...
/**
 * 
 * {@link ListMultimodalDatasetRequest} extends {@link RequestModel}
 *
 * <p>ListMultimodalDatasetRequest</p>
 */
public class ListMultimodalDatasetRequest extends Request {
    ...
    public static ListMultimodalDatasetRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListMultimodalDatasetRequest, Builder> {
        ...
        private Builder(ListMultimodalDatasetRequest request) {
            super(request);
        ...
        @Override
        public ListMultimodalDatasetRequest build() {
            return new ListMultimodalDatasetRequest(this);
        } 
