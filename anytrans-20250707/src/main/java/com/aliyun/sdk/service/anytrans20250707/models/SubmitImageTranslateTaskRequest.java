...
/**
 * 
 * {@link SubmitImageTranslateTaskRequest} extends {@link RequestModel}
 *
 * <p>SubmitImageTranslateTaskRequest</p>
 */
public class SubmitImageTranslateTaskRequest extends Request {
    ...
    @com.aliyun.core.annotation.Validation(required = true)
    private java.util.List<String> targetLanguage;
    ...
    private SubmitImageTranslateTaskRequest(Builder builder) {
        super(builder);
    ...
    public static SubmitImageTranslateTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SubmitImageTranslateTaskRequest, Builder> {
        private Ext ext; 
        private String format; 
        private String scene; 
        private String sourceLanguage; 
        ...
        private Builder(SubmitImageTranslateTaskRequest request) {
            super(request);
         ...
         * <p>This parameter is required.</p>
         */
        public Builder targetLanguage(java.util.List<String> targetLanguage) {
            String targetLanguageShrink = shrink(targetLanguage, "targetLanguage", "json");
            this.putBodyParameter("targetLanguage", targetLanguageShrink);
        ...
        @Override
        public SubmitImageTranslateTaskRequest build() {
            return new SubmitImageTranslateTaskRequest(this);
        } 
    ...
    /**
     * 
     * {@link SubmitImageTranslateTaskRequest} extends {@link TeaModel}
     *
     * <p>SubmitImageTranslateTaskRequest</p>
     */
