...
/**
 * 
 * {@link TermEditResponseBody} extends {@link TeaModel}
 *
 * <p>TermEditResponseBody</p>
 */
public class TermEditResponseBody extends TeaModel {
    ...
    private TermEditResponseBody(Builder builder) {
    ...
    public static TermEditResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(TermEditResponseBody model) {
        ...
        public TermEditResponseBody build() {
            return new TermEditResponseBody(this);
        } 
