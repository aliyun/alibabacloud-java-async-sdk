...
/**
 * 
 * {@link BatchTranslateResponseBody} extends {@link TeaModel}
 *
 * <p>BatchTranslateResponseBody</p>
 */
public class BatchTranslateResponseBody extends TeaModel {
    ...
    private BatchTranslateResponseBody(Builder builder) {
    ...
    public static BatchTranslateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BatchTranslateResponseBody model) {
        ...
        public BatchTranslateResponseBody build() {
            return new BatchTranslateResponseBody(this);
        } 
