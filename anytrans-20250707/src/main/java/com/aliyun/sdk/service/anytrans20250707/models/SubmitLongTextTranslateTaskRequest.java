...
/**
 * 
 * {@link SubmitLongTextTranslateTaskRequest} extends {@link RequestModel}
 *
 * <p>SubmitLongTextTranslateTaskRequest</p>
 */
public class SubmitLongTextTranslateTaskRequest extends Request {
    ...
    private SubmitLongTextTranslateTaskRequest(Builder builder) {
        super(builder);
    ...
    public static SubmitLongTextTranslateTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SubmitLongTextTranslateTaskRequest, Builder> {
        private Ext ext; 
        private String format; 
        private String scene; 
        private String sourceLanguage; 
        ...
        private Builder(SubmitLongTextTranslateTaskRequest request) {
            super(request);
        ...
        @Override
        public SubmitLongTextTranslateTaskRequest build() {
            return new SubmitLongTextTranslateTaskRequest(this);
        } 
    ...
    /**
     * 
     * {@link SubmitLongTextTranslateTaskRequest} extends {@link TeaModel}
     *
     * <p>SubmitLongTextTranslateTaskRequest</p>
     */
