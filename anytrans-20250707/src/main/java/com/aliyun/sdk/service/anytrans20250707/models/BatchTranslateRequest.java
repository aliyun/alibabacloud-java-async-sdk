...
/**
 * 
 * {@link BatchTranslateRequest} extends {@link RequestModel}
 *
...
public class BatchTranslateRequest extends Request {
    ...
    public static BatchTranslateRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<BatchTranslateRequest, Builder> {
        ...
        @Override
        public BatchTranslateRequest build() {
            return new BatchTranslateRequest(this);
        } 
