...
/**
 * 
 * {@link BatchContentAsyncDetectRequest} extends {@link RequestModel}
 *
 * <p>BatchContentAsyncDetectRequest</p>
 */
public class BatchContentAsyncDetectRequest extends Request {
    ...
    private BatchContentAsyncDetectRequest(Builder builder) {
        super(builder);
    ...
    public static BatchContentAsyncDetectRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchContentAsyncDetectRequest, Builder> {
        private String regionId; 
        private String sceneName; 
        private String serviceName; 
        private java.util.List<ServiceParameterList> serviceParameterList; 
        ...
        private Builder(BatchContentAsyncDetectRequest request) {
            super(request);
        ...
        @Override
        public BatchContentAsyncDetectRequest build() {
            return new BatchContentAsyncDetectRequest(this);
        } 
    ...
    /**
     * 
     * {@link BatchContentAsyncDetectRequest} extends {@link TeaModel}
     *
     * <p>BatchContentAsyncDetectRequest</p>
     */
