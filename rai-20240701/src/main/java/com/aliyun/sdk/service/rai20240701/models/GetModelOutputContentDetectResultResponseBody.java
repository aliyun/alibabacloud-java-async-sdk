...
/**
 * 
 * {@link GetModelOutputContentDetectResultResponseBody} extends {@link TeaModel}
 *
 * <p>GetModelOutputContentDetectResultResponseBody</p>
 */
public class GetModelOutputContentDetectResultResponseBody extends TeaModel {
    ...
    private GetModelOutputContentDetectResultResponseBody(Builder builder) {
    ...
    public static GetModelOutputContentDetectResultResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetModelOutputContentDetectResultResponseBody model) {
        ...
        public GetModelOutputContentDetectResultResponseBody build() {
            return new GetModelOutputContentDetectResultResponseBody(this);
        } 
