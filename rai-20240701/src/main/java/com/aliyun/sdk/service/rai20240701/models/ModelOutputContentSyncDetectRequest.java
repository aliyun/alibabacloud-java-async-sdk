...
/**
 * 
 * {@link ModelOutputContentSyncDetectRequest} extends {@link RequestModel}
 *
 * <p>ModelOutputContentSyncDetectRequest</p>
 */
public class ModelOutputContentSyncDetectRequest extends Request {
    ...
    private ModelOutputContentSyncDetectRequest(Builder builder) {
        super(builder);
    ...
    public static ModelOutputContentSyncDetectRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModelOutputContentSyncDetectRequest, Builder> {
        private BodyData bodyData; 
        private String policyIdentifier; 
        private String regionId; 
        private String sceneName; 
        ...
        private Builder(ModelOutputContentSyncDetectRequest request) {
            super(request);
        ...
        @Override
        public ModelOutputContentSyncDetectRequest build() {
            return new ModelOutputContentSyncDetectRequest(this);
        } 
    ...
    /**
     * 
     * {@link ModelOutputContentSyncDetectRequest} extends {@link TeaModel}
     *
     * <p>ModelOutputContentSyncDetectRequest</p>
     */
