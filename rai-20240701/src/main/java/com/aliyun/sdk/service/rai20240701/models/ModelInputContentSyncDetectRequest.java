...
/**
 * 
 * {@link ModelInputContentSyncDetectRequest} extends {@link RequestModel}
 *
 * <p>ModelInputContentSyncDetectRequest</p>
 */
public class ModelInputContentSyncDetectRequest extends Request {
    ...
    private ModelInputContentSyncDetectRequest(Builder builder) {
        super(builder);
    ...
    public static ModelInputContentSyncDetectRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModelInputContentSyncDetectRequest, Builder> {
        private BodyData bodyData; 
        private String policyIdentifier; 
        private String regionId; 
        private String sceneName; 
        ...
        private Builder(ModelInputContentSyncDetectRequest request) {
            super(request);
        ...
        @Override
        public ModelInputContentSyncDetectRequest build() {
            return new ModelInputContentSyncDetectRequest(this);
        } 
    ...
    /**
     * 
     * {@link ModelInputContentSyncDetectRequest} extends {@link TeaModel}
     *
     * <p>ModelInputContentSyncDetectRequest</p>
     */
