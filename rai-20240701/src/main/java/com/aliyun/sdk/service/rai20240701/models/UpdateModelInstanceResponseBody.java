...
/**
 * 
 * {@link UpdateModelInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateModelInstanceResponseBody</p>
 */
public class UpdateModelInstanceResponseBody extends TeaModel {
    ...
    private UpdateModelInstanceResponseBody(Builder builder) {
    ...
    public static UpdateModelInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateModelInstanceResponseBody model) {
        ...
        public UpdateModelInstanceResponseBody build() {
            return new UpdateModelInstanceResponseBody(this);
        } 
