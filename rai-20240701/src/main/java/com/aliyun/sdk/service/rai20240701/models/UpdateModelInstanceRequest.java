...
/**
 * 
 * {@link UpdateModelInstanceRequest} extends {@link RequestModel}
 *
 * <p>UpdateModelInstanceRequest</p>
 */
public class UpdateModelInstanceRequest extends Request {
    ...
    private UpdateModelInstanceRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateModelInstanceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateModelInstanceRequest, Builder> {
        private String description; 
        private String easServiceId; 
        private String easServiceName; 
        private String modelCallName; 
        ...
        private Builder(UpdateModelInstanceRequest request) {
            super(request);
        ...
        @Override
        public UpdateModelInstanceRequest build() {
            return new UpdateModelInstanceRequest(this);
        } 
