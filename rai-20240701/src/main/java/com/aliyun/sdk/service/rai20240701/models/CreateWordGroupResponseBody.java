...
/**
 * 
 * {@link CreateWordGroupResponseBody} extends {@link TeaModel}
 *
 * <p>CreateWordGroupResponseBody</p>
 */
public class CreateWordGroupResponseBody extends TeaModel {
    ...
    private CreateWordGroupResponseBody(Builder builder) {
    ...
    public static CreateWordGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateWordGroupResponseBody model) {
        ...
        public CreateWordGroupResponseBody build() {
            return new CreateWordGroupResponseBody(this);
        } 
