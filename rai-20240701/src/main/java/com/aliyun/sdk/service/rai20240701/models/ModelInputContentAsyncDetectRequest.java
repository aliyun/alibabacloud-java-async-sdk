...
/**
 * 
 * {@link ModelInputContentAsyncDetectRequest} extends {@link RequestModel}
 *
 * <p>ModelInputContentAsyncDetectRequest</p>
 */
public class ModelInputContentAsyncDetectRequest extends Request {
    ...
    private ModelInputContentAsyncDetectRequest(Builder builder) {
        super(builder);
    ...
    public static ModelInputContentAsyncDetectRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModelInputContentAsyncDetectRequest, Builder> {
        private BodyData bodyData; 
        private String policyIdentifier; 
        private String regionId; 
        private String sceneName; 
        ...
        private Builder(ModelInputContentAsyncDetectRequest request) {
            super(request);
        ...
        @Override
        public ModelInputContentAsyncDetectRequest build() {
            return new ModelInputContentAsyncDetectRequest(this);
        } 
    ...
    /**
     * 
     * {@link ModelInputContentAsyncDetectRequest} extends {@link TeaModel}
     *
     * <p>ModelInputContentAsyncDetectRequest</p>
     */
