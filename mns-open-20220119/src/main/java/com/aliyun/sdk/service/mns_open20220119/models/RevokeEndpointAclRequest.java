...
/**
 * 
 * {@link RevokeEndpointAclRequest} extends {@link RequestModel}
 *
 * <p>RevokeEndpointAclRequest</p>
 */
public class RevokeEndpointAclRequest extends Request {
    ...
    private RevokeEndpointAclRequest(Builder builder) {
        super(builder);
    ...
    public static RevokeEndpointAclRequest create() {
    ...
    public static final class Builder extends Request.Builder<RevokeEndpointAclRequest, Builder> {
        private String regionId; 
        private String aclStrategy; 
        private java.util.List<String> cidrList; 
        private String endpointType; 
        ...
        private Builder(RevokeEndpointAclRequest request) {
            super(request);
        ...
        @Override
        public RevokeEndpointAclRequest build() {
            return new RevokeEndpointAclRequest(this);
        } 
