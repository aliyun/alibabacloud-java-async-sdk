...
/**
 * {@link CreateDbscRequest} extends {@link RequestModel}
 *
 * <p>CreateDbscRequest</p>
 */
public class CreateDbscRequest extends Request {
    @Query
    @NameInMap("Azone")
    ...
    private CreateDbscRequest(Builder builder) {
        super(builder);
    ...
    public static CreateDbscRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateDbscRequest, Builder> {
        private String azone; 
        private Long capacity; 
        private String dbscId; 
        private String dbscName; 
        ...
        private Builder(CreateDbscRequest response) {
            super(response);
        ...
        @Override
        public CreateDbscRequest build() {
            return new CreateDbscRequest(this);
        } 
