 ...
 */
public class DescribeEnterpriseSnapshotPolicyRequest extends Request {
    ...
    public static DescribeEnterpriseSnapshotPolicyRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeEnterpriseSnapshotPolicyRequest, Builder> {
        ...
        private Builder(DescribeEnterpriseSnapshotPolicyRequest request) {
            super(request);
        ...
        @Override
        public DescribeEnterpriseSnapshotPolicyRequest build() {
            return new DescribeEnterpriseSnapshotPolicyRequest(this);
        } 
