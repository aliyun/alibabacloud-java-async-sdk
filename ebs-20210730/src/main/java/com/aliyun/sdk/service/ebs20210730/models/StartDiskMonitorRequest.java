...
/**
 * {@link StartDiskMonitorRequest} extends {@link RequestModel}
 *
 * <p>StartDiskMonitorRequest</p>
 */
public class StartDiskMonitorRequest extends Request {
    @Query
    @NameInMap("DiskIds")
    ...
    private StartDiskMonitorRequest(Builder builder) {
        super(builder);
    ...
    public static StartDiskMonitorRequest create() {
    ...
    public static final class Builder extends Request.Builder<StartDiskMonitorRequest, Builder> {
        private java.util.List < String > diskIds; 
        private String regionId; 
        ...
        private Builder(StartDiskMonitorRequest request) {
            super(request);
        ...
        @Override
        public StartDiskMonitorRequest build() {
            return new StartDiskMonitorRequest(this);
        } 
