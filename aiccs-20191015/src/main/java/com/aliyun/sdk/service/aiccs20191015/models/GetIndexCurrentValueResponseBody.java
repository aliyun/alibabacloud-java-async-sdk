...
public class GetIndexCurrentValueResponseBody extends TeaModel {
    ...
    public static GetIndexCurrentValueResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetIndexCurrentValueResponseBody model) {
        ...
        public GetIndexCurrentValueResponseBody build() {
            return new GetIndexCurrentValueResponseBody(this);
        } 
