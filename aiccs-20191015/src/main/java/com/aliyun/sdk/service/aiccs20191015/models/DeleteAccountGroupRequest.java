...
/**
 * {@link DeleteAccountGroupRequest} extends {@link RequestModel}
 *
 * <p>DeleteAccountGroupRequest</p>
 */
public class DeleteAccountGroupRequest extends Request {
    @Query
    ...
    public static DeleteAccountGroupRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteAccountGroupRequest, Builder> {
        private String outerAccountId; 
        private String outerAccountType; 
        private String outerGroupId; 
        private String outerGroupType; 
        ...
        private Builder(DeleteAccountGroupRequest response) {
            super(response);
