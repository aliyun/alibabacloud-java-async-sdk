...
/**
 * {@link GetSkillGroupAndAgentStatusSummaryRequest} extends {@link RequestModel}
 *
 * <p>GetSkillGroupAndAgentStatusSummaryRequest</p>
 */
public class GetSkillGroupAndAgentStatusSummaryRequest extends Request {
    @Query
    ...
    private GetSkillGroupAndAgentStatusSummaryRequest(Builder builder) {
        super(builder);
    ...
    public static GetSkillGroupAndAgentStatusSummaryRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetSkillGroupAndAgentStatusSummaryRequest, Builder> {
        private Integer currentPage; 
        private java.util.List < Long > depIds; 
        private Long endDate; 
        private Boolean existDepartmentGrouping; 
        ...
        private Builder(GetSkillGroupAndAgentStatusSummaryRequest response) {
            super(response);
        ...
        @Override
        public GetSkillGroupAndAgentStatusSummaryRequest build() {
            return new GetSkillGroupAndAgentStatusSummaryRequest(this);
        } 
