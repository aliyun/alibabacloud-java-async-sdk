...
/**
 * 
 * {@link JoinThirdCallRequest} extends {@link RequestModel}
 *
 * <p>JoinThirdCallRequest</p>
 */
public class JoinThirdCallRequest extends Request {
    ...
    private JoinThirdCallRequest(Builder builder) {
        super(builder);
    ...
    public static JoinThirdCallRequest create() {
    ...
    public static final class Builder extends Request.Builder<JoinThirdCallRequest, Builder> {
        private String accountName; 
        private String callId; 
        private String clientToken; 
        private String connectionId; 
        ...
        @Override
        public JoinThirdCallRequest build() {
            return new JoinThirdCallRequest(this);
        } 
