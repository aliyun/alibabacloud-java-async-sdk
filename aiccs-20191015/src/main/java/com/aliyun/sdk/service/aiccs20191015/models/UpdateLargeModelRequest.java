...
/**
 * 
 * {@link UpdateLargeModelRequest} extends {@link RequestModel}
 *
 * <p>UpdateLargeModelRequest</p>
 */
public class UpdateLargeModelRequest extends Request {
    ...
    private UpdateLargeModelRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateLargeModelRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateLargeModelRequest, Builder> {
        private String authCode; 
        private java.util.List<String> baseModel; 
        private String modelCode; 
        private String modelName; 
        ...
        private Builder(UpdateLargeModelRequest request) {
            super(request);
        ...
        @Override
        public UpdateLargeModelRequest build() {
            return new UpdateLargeModelRequest(this);
        } 
