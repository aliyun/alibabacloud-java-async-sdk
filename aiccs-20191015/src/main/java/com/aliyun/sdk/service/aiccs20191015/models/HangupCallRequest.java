...
/**
 * 
 * {@link HangupCallRequest} extends {@link RequestModel}
 *
 * <p>HangupCallRequest</p>
 */
public class HangupCallRequest extends Request {
    ...
    private HangupCallRequest(Builder builder) {
        super(builder);
    ...
    public static HangupCallRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<HangupCallRequest, Builder> {
        private String accountName; 
        private String callId; 
        private String clientToken; 
        private String connectionId; 
        ...
        /**
         * <p>Unique customer request ID. Used for idempotency validation and can be generated using UUID.</p>
         * 
         * <strong>example:</strong>
