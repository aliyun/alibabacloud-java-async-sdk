...
public class HangUpDoubleCallResponseBody extends TeaModel {
    ...
    public static HangUpDoubleCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(HangUpDoubleCallResponseBody model) {
        ...
        public HangUpDoubleCallResponseBody build() {
            return new HangUpDoubleCallResponseBody(this);
        } 
