...
/**
 * {@link GetSkillGroupStatusTotalRequest} extends {@link RequestModel}
 *
 * <p>GetSkillGroupStatusTotalRequest</p>
 */
public class GetSkillGroupStatusTotalRequest extends Request {
    @Query
    @NameInMap("AgentIds")
    ...
    private GetSkillGroupStatusTotalRequest(Builder builder) {
        super(builder);
    ...
    public static GetSkillGroupStatusTotalRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetSkillGroupStatusTotalRequest, Builder> {
        private java.util.List < Long > agentIds; 
        private Integer currentPage; 
        private java.util.List < Long > depIds; 
        private Long endDate; 
        ...
        private Builder(GetSkillGroupStatusTotalRequest response) {
            super(response);
        ...
        @Override
        public GetSkillGroupStatusTotalRequest build() {
            return new GetSkillGroupStatusTotalRequest(this);
        } 
