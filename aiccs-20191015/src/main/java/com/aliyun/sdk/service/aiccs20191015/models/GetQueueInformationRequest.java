...
/**
 * 
 * {@link GetQueueInformationRequest} extends {@link RequestModel}
 *
 * <p>GetQueueInformationRequest</p>
 */
public class GetQueueInformationRequest extends Request {
    ...
    private GetQueueInformationRequest(Builder builder) {
        super(builder);
    ...
    public static GetQueueInformationRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetQueueInformationRequest, Builder> {
        private Integer currentPage; 
        private java.util.List<Long> depIds; 
        private Long endDate; 
        private Boolean existDepartmentGrouping; 
        ...
        @Override
        public GetQueueInformationRequest build() {
            return new GetQueueInformationRequest(this);
        } 
