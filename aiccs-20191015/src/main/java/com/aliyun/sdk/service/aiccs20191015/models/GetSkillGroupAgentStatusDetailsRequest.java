...
/**
 * {@link GetSkillGroupAgentStatusDetailsRequest} extends {@link RequestModel}
 *
 * <p>GetSkillGroupAgentStatusDetailsRequest</p>
 */
public class GetSkillGroupAgentStatusDetailsRequest extends Request {
    @Query
    ...
    private GetSkillGroupAgentStatusDetailsRequest(Builder builder) {
        super(builder);
    ...
    public static GetSkillGroupAgentStatusDetailsRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetSkillGroupAgentStatusDetailsRequest, Builder> {
        private Integer currentPage; 
        private java.util.List < Long > depIds; 
        private Long endDate; 
        private Boolean existDepartmentGrouping; 
        ...
        private Builder(GetSkillGroupAgentStatusDetailsRequest response) {
            super(response);
        ...
        @Override
        public GetSkillGroupAgentStatusDetailsRequest build() {
            return new GetSkillGroupAgentStatusDetailsRequest(this);
        } 
