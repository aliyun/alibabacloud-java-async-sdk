...
public class GetAgentDetailReportRequest extends Request {
    ...
    public static GetAgentDetailReportRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetAgentDetailReportRequest, Builder> {
        ...
        private Builder(GetAgentDetailReportRequest response) {
            super(response);
        ...
        @Override
        public GetAgentDetailReportRequest build() {
            return new GetAgentDetailReportRequest(this);
        } 
