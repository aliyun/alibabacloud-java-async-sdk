...
/**
 * 
 * {@link CreateAnswerLibResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAnswerLibResponseBody</p>
 */
public class CreateAnswerLibResponseBody extends TeaModel {
    ...
    private CreateAnswerLibResponseBody(Builder builder) {
    ...
    public static CreateAnswerLibResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAnswerLibResponseBody model) {
        ...
        public CreateAnswerLibResponseBody build() {
            return new CreateAnswerLibResponseBody(this);
        } 
