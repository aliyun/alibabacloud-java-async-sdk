...
/**
 * 
 * {@link GetScanResultRequest} extends {@link RequestModel}
 *
 * <p>GetScanResultRequest</p>
 */
public class GetScanResultRequest extends Request {
    ...
    private GetScanResultRequest(Builder builder) {
        super(builder);
    ...
    public static GetScanResultRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetScanResultRequest, Builder> {
        private Integer currentPage; 
        private String endDate; 
        private Integer pageSize; 
        private java.util.Map<String, String> query; 
        ...
        private Builder(GetScanResultRequest request) {
            super(request);
        ...
        @Override
        public GetScanResultRequest build() {
