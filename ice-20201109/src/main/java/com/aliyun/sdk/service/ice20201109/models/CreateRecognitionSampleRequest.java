...
/**
 * 
 * {@link CreateRecognitionSampleRequest} extends {@link RequestModel}
 *
 * <p>CreateRecognitionSampleRequest</p>
 */
public class CreateRecognitionSampleRequest extends Request {
    ...
    private CreateRecognitionSampleRequest(Builder builder) {
        super(builder);
    ...
    public static CreateRecognitionSampleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateRecognitionSampleRequest, Builder> {
        private String algorithm; 
        private String entityId; 
        private String imageUrl; 
        private String labelPrompt; 
        ...
        private Builder(CreateRecognitionSampleRequest request) {
            super(request);
        ...
        @Override
        public CreateRecognitionSampleRequest build() {
            return new CreateRecognitionSampleRequest(this);
        } 
