...
/**
 * 
 * {@link ListDNADBRequest} extends {@link RequestModel}
 *
 * <p>ListDNADBRequest</p>
 */
public class ListDNADBRequest extends Request {
    ...
    private ListDNADBRequest(Builder builder) {
        super(builder);
    ...
    public static ListDNADBRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListDNADBRequest, Builder> {
        private String DBIds; 
        private String ownerAccount; 
        private Long ownerId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(ListDNADBRequest request) {
            super(request);
        ...
        @Override
        public ListDNADBRequest build() {
            return new ListDNADBRequest(this);
        } 
