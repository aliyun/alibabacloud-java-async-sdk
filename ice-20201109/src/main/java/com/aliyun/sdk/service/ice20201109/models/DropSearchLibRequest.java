 ...
 */
public class DropSearchLibRequest extends Request {
    ...
    public static DropSearchLibRequest create() {
    ...
    public static final class Builder extends Request.Builder<DropSearchLibRequest, Builder> {
        private String regionId; 
        private String searchLibName; 
        ...
        private Builder(DropSearchLibRequest request) {
            super(request);
        ...
        @Override
        public DropSearchLibRequest build() {
            return new DropSearchLibRequest(this);
        } 
