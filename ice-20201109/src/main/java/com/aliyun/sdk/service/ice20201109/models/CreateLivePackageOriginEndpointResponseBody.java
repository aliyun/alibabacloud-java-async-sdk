...
/**
 * 
 * {@link CreateLivePackageOriginEndpointResponseBody} extends {@link TeaModel}
 *
 * <p>CreateLivePackageOriginEndpointResponseBody</p>
 */
public class CreateLivePackageOriginEndpointResponseBody extends TeaModel {
    ...
    private CreateLivePackageOriginEndpointResponseBody(Builder builder) {
    ...
    public static CreateLivePackageOriginEndpointResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateLivePackageOriginEndpointResponseBody model) {
        ...
        public CreateLivePackageOriginEndpointResponseBody build() {
            return new CreateLivePackageOriginEndpointResponseBody(this);
        } 
