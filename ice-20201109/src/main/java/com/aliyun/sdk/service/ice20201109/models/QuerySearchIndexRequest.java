...
public class QuerySearchIndexRequest extends Request {
    ...
    public static QuerySearchIndexRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QuerySearchIndexRequest, Builder> {
        private String regionId; 
        private String indexType; 
        private String searchLibName; 
        ...
        private Builder(QuerySearchIndexRequest request) {
            super(request);
        ...
        @Override
        public QuerySearchIndexRequest build() {
            return new QuerySearchIndexRequest(this);
        } 
