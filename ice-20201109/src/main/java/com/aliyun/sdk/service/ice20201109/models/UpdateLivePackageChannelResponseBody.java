...
/**
 * 
 * {@link UpdateLivePackageChannelResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateLivePackageChannelResponseBody</p>
 */
public class UpdateLivePackageChannelResponseBody extends TeaModel {
    ...
    private UpdateLivePackageChannelResponseBody(Builder builder) {
    ...
    public static UpdateLivePackageChannelResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateLivePackageChannelResponseBody build() {
            return new UpdateLivePackageChannelResponseBody(this);
        } 
