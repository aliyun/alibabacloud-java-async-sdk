...
/**
 * 
 * {@link DeleteRecognitionSampleRequest} extends {@link RequestModel}
 *
 * <p>DeleteRecognitionSampleRequest</p>
 */
public class DeleteRecognitionSampleRequest extends Request {
    ...
    private DeleteRecognitionSampleRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteRecognitionSampleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteRecognitionSampleRequest, Builder> {
        private String algorithm; 
        private String entityId; 
        private String libId; 
        private String ownerAccount; 
        ...
        private Builder(DeleteRecognitionSampleRequest request) {
            super(request);
        ...
        @Override
        public DeleteRecognitionSampleRequest build() {
            return new DeleteRecognitionSampleRequest(this);
        } 
