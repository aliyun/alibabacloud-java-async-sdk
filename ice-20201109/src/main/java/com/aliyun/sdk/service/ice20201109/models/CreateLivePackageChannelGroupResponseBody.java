...
/**
 * 
 * {@link CreateLivePackageChannelGroupResponseBody} extends {@link TeaModel}
 *
 * <p>CreateLivePackageChannelGroupResponseBody</p>
 */
public class CreateLivePackageChannelGroupResponseBody extends TeaModel {
    ...
    private CreateLivePackageChannelGroupResponseBody(Builder builder) {
    ...
    public static CreateLivePackageChannelGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateLivePackageChannelGroupResponseBody model) {
        ...
        public CreateLivePackageChannelGroupResponseBody build() {
            return new CreateLivePackageChannelGroupResponseBody(this);
        } 
