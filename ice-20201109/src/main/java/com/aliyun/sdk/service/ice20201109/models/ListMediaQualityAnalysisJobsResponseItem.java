...
/**
 * 
 * {@link ListMediaQualityAnalysisJobsResponseItem} extends {@link TeaModel}
 *
 * <p>ListMediaQualityAnalysisJobsResponseItem</p>
 */
public class ListMediaQualityAnalysisJobsResponseItem extends TeaModel {
    ...
    private ListMediaQualityAnalysisJobsResponseItem(Builder builder) {
    ...
    public static ListMediaQualityAnalysisJobsResponseItem create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListMediaQualityAnalysisJobsResponseItem model) {
        ...
        public ListMediaQualityAnalysisJobsResponseItem build() {
            return new ListMediaQualityAnalysisJobsResponseItem(this);
        } 
