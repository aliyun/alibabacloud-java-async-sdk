...
/**
 * 
 * {@link UpdateLivePackageChannelGroupResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateLivePackageChannelGroupResponseBody</p>
 */
public class UpdateLivePackageChannelGroupResponseBody extends TeaModel {
    ...
    private UpdateLivePackageChannelGroupResponseBody(Builder builder) {
    ...
    public static UpdateLivePackageChannelGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateLivePackageChannelGroupResponseBody model) {
        ...
        public UpdateLivePackageChannelGroupResponseBody build() {
            return new UpdateLivePackageChannelGroupResponseBody(this);
        } 
