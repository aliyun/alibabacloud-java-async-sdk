...
/**
 * 
 * {@link CallbackTaskRequest} extends {@link RequestModel}
 *
 * <p>CallbackTaskRequest</p>
 */
public class CallbackTaskRequest extends Request {
    ...
    private CallbackTaskRequest(Builder builder) {
        super(builder);
    ...
    public static CallbackTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CallbackTaskRequest, Builder> {
        private String aliyunKp; 
        private String apiType; 
        private String bid; 
        private String bizCode; 
        ...
        private Builder(CallbackTaskRequest request) {
            super(request);
            ...
            this.outTaskId = request.outTaskId;
        ...
        public Builder outTaskId(String outTaskId) {
            this.putQueryParameter("OutTaskId", outTaskId);
        ...
        @Override
        public CallbackTaskRequest build() {
            return new CallbackTaskRequest(this);
        } 
