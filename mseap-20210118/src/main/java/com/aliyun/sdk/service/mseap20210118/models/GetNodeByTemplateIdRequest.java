...
/**
 * 
 * {@link GetNodeByTemplateIdRequest} extends {@link RequestModel}
 *
 * <p>GetNodeByTemplateIdRequest</p>
 */
public class GetNodeByTemplateIdRequest extends Request {
    ...
    private GetNodeByTemplateIdRequest(Builder builder) {
        super(builder);
    ...
    public static GetNodeByTemplateIdRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetNodeByTemplateIdRequest, Builder> {
        private String aliyunKp; 
        private String apiType; 
        private String bid; 
        private String lang; 
        ...
        private Builder(GetNodeByTemplateIdRequest request) {
            super(request);
        ...
        @Override
        public GetNodeByTemplateIdRequest build() {
            return new GetNodeByTemplateIdRequest(this);
        } 
