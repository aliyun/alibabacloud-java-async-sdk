...
/**
 * 
 * {@link GetVariableRequest} extends {@link RequestModel}
 *
 * <p>GetVariableRequest</p>
 */
public class GetVariableRequest extends Request {
    ...
    private GetVariableRequest(Builder builder) {
        super(builder);
    ...
    public static GetVariableRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetVariableRequest, Builder> {
        private String aliyunKp; 
        private String apiType; 
        private String bid; 
        private String lang; 
        ...
        private Builder(GetVariableRequest request) {
            super(request);
        ...
        @Override
        public GetVariableRequest build() {
