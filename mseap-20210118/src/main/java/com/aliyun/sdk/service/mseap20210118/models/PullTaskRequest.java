...
/**
 * 
 * {@link PullTaskRequest} extends {@link RequestModel}
 *
 * <p>PullTaskRequest</p>
 */
public class PullTaskRequest extends Request {
    ...
    private PullTaskRequest(Builder builder) {
        super(builder);
    ...
    public static PullTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<PullTaskRequest, Builder> {
        private String aliyunKp; 
        private String apiType; 
        private String bid; 
        private String bizCode; 
        ...
        private Builder(PullTaskRequest request) {
            super(request);
        ...
        @Override
        public PullTaskRequest build() {
            return new PullTaskRequest(this);
        } 
