...
/**
 * 
 * {@link GetProxyByTypeRequest} extends {@link RequestModel}
 *
 * <p>GetProxyByTypeRequest</p>
 */
public class GetProxyByTypeRequest extends Request {
    ...
    private GetProxyByTypeRequest(Builder builder) {
        super(builder);
    ...
    public static GetProxyByTypeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetProxyByTypeRequest, Builder> {
        private String aliyunKp; 
        private String apiType; 
        private String bid; 
        private String lang; 
        ...
        private Builder(GetProxyByTypeRequest request) {
            super(request);
        ...
        @Override
        public GetProxyByTypeRequest build() {
            return new GetProxyByTypeRequest(this);
        } 
