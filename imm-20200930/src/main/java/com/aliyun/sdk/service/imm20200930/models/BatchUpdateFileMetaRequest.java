 ...
 */
public class BatchUpdateFileMetaRequest extends Request {
    ...
    private BatchUpdateFileMetaRequest(Builder builder) {
        super(builder);
    ...
    public static BatchUpdateFileMetaRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<BatchUpdateFileMetaRequest, Builder> {
        ...
        private Builder(BatchUpdateFileMetaRequest request) {
            super(request);
        ...
        @Override
        public BatchUpdateFileMetaRequest build() {
            return new BatchUpdateFileMetaRequest(this);
        } 
