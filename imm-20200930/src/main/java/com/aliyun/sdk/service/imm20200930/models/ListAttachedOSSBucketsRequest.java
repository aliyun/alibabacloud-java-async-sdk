...
/**
 * 
 * {@link ListAttachedOSSBucketsRequest} extends {@link RequestModel}
 *
 * <p>ListAttachedOSSBucketsRequest</p>
 */
public class ListAttachedOSSBucketsRequest extends Request {
    ...
    private ListAttachedOSSBucketsRequest(Builder builder) {
        super(builder);
    ...
    public static ListAttachedOSSBucketsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListAttachedOSSBucketsRequest, Builder> {
        private String regionId; 
        private Long maxResults; 
        private String nextToken; 
        private String projectName; 
        ...
        private Builder(ListAttachedOSSBucketsRequest request) {
            super(request);
        ...
        @Override
        public ListAttachedOSSBucketsRequest build() {
            return new ListAttachedOSSBucketsRequest(this);
        } 
