...
/**
 * 
 * {@link DetectImageCarsRequest} extends {@link RequestModel}
 *
 * <p>DetectImageCarsRequest</p>
 */
public class DetectImageCarsRequest extends Request {
    ...
    private DetectImageCarsRequest(Builder builder) {
        super(builder);
    ...
    public static DetectImageCarsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DetectImageCarsRequest, Builder> {
        private String regionId; 
        private CredentialConfig credentialConfig; 
        private String projectName; 
        private String sourceURI; 
        ...
        private Builder(DetectImageCarsRequest request) {
            super(request);
        ...
        /**
         * <p>The URI of the Object Storage Service (OSS) bucket in which you store the image file.</p>
        ...
        @Override
        public DetectImageCarsRequest build() {
            return new DetectImageCarsRequest(this);
        } 
