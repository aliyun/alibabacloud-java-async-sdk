...
public class JoinClusterResponseBody extends TeaModel {
    ...
    private JoinClusterResponseBody(Builder builder) {
    ...
    public static JoinClusterResponseBody create() {
    ...
    public static final class Builder {
        ...
        public JoinClusterResponseBody build() {
            return new JoinClusterResponseBody(this);
        } 
