...
/**
 * 
 * {@link QuickInitInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>QuickInitInstanceResponseBody</p>
 */
public class QuickInitInstanceResponseBody extends TeaModel {
    ...
    private QuickInitInstanceResponseBody(Builder builder) {
    ...
    public static QuickInitInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QuickInitInstanceResponseBody model) {
            this.job = model.job;
        ...
        public QuickInitInstanceResponseBody build() {
            return new QuickInitInstanceResponseBody(this);
        } 
