...
/**
 * {@link DescribeProjectStepMetricResponse} extends {@link TeaModel}
 *
 * <p>DescribeProjectStepMetricResponse</p>
 */
public class DescribeProjectStepMetricResponse extends Response {
    @NameInMap("headers")
    ...
    public static DescribeProjectStepMetricResponse create() {
    ...
    public interface Builder extends Response.Builder<DescribeProjectStepMetricResponse, Builder> {
        ...
        @Override
        DescribeProjectStepMetricResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DescribeProjectStepMetricResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DescribeProjectStepMetricResponse build() {
            return new DescribeProjectStepMetricResponse(this);
        } 
