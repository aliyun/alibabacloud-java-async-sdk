...
/**
 * 
 * {@link CreateMySqlDataSourceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateMySqlDataSourceResponseBody</p>
 */
public class CreateMySqlDataSourceResponseBody extends TeaModel {
    ...
    private CreateMySqlDataSourceResponseBody(Builder builder) {
    ...
    public static CreateMySqlDataSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateMySqlDataSourceResponseBody model) {
        ...
        public CreateMySqlDataSourceResponseBody build() {
            return new CreateMySqlDataSourceResponseBody(this);
        } 
