...
/**
 * 
 * {@link UpdateProjectConfigResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateProjectConfigResponseBody</p>
 */
public class UpdateProjectConfigResponseBody extends TeaModel {
    ...
    private UpdateProjectConfigResponseBody(Builder builder) {
    ...
    public static UpdateProjectConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateProjectConfigResponseBody model) {
        ...
        public UpdateProjectConfigResponseBody build() {
            return new UpdateProjectConfigResponseBody(this);
        } 
