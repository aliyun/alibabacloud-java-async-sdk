...
/**
 * {@link ReleaseOmsOpenAPIProjectRequest} extends {@link RequestModel}
 *
 * <p>ReleaseOmsOpenAPIProjectRequest</p>
 */
public class ReleaseOmsOpenAPIProjectRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private ReleaseOmsOpenAPIProjectRequest(Builder builder) {
        super(builder);
    ...
    public static ReleaseOmsOpenAPIProjectRequest create() {
    ...
    public static final class Builder extends Request.Builder<ReleaseOmsOpenAPIProjectRequest, Builder> {
        private String regionId; 
        private Integer pageNumber; 
        private Integer pageSize; 
        private String projectId; 
        ...
        private Builder(ReleaseOmsOpenAPIProjectRequest request) {
            super(request);
        ...
        @Override
        public ReleaseOmsOpenAPIProjectRequest build() {
            return new ReleaseOmsOpenAPIProjectRequest(this);
        } 
