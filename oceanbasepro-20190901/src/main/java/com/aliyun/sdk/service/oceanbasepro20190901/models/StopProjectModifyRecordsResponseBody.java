...
/**
 * 
 * {@link StopProjectModifyRecordsResponseBody} extends {@link TeaModel}
 *
 * <p>StopProjectModifyRecordsResponseBody</p>
 */
public class StopProjectModifyRecordsResponseBody extends TeaModel {
    ...
    private StopProjectModifyRecordsResponseBody(Builder builder) {
    ...
    public static StopProjectModifyRecordsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StopProjectModifyRecordsResponseBody model) {
        ...
        public StopProjectModifyRecordsResponseBody build() {
            return new StopProjectModifyRecordsResponseBody(this);
        } 
