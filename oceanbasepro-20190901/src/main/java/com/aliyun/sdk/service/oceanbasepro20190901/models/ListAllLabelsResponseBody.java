...
/**
 * 
 * {@link ListAllLabelsResponseBody} extends {@link TeaModel}
 *
 * <p>ListAllLabelsResponseBody</p>
 */
public class ListAllLabelsResponseBody extends TeaModel {
    ...
    private ListAllLabelsResponseBody(Builder builder) {
    ...
    public static ListAllLabelsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAllLabelsResponseBody model) {
        ...
        public ListAllLabelsResponseBody build() {
            return new ListAllLabelsResponseBody(this);
        } 
