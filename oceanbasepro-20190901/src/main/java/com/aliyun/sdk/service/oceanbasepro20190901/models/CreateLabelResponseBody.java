...
/**
 * 
 * {@link CreateLabelResponseBody} extends {@link TeaModel}
 *
 * <p>CreateLabelResponseBody</p>
 */
public class CreateLabelResponseBody extends TeaModel {
    ...
    private CreateLabelResponseBody(Builder builder) {
    ...
    public static CreateLabelResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateLabelResponseBody model) {
        ...
        public CreateLabelResponseBody build() {
            return new CreateLabelResponseBody(this);
        } 
