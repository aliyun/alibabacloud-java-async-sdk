...
/**
 * 
 * {@link CreateProjectModifyRecordsResponseBody} extends {@link TeaModel}
 *
 * <p>CreateProjectModifyRecordsResponseBody</p>
 */
public class CreateProjectModifyRecordsResponseBody extends TeaModel {
    ...
    private CreateProjectModifyRecordsResponseBody(Builder builder) {
    ...
    public static CreateProjectModifyRecordsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateProjectModifyRecordsResponseBody model) {
        ...
        public CreateProjectModifyRecordsResponseBody build() {
            return new CreateProjectModifyRecordsResponseBody(this);
        } 
