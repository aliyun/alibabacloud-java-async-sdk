...
/**
 * {@link ReleaseOmsOpenAPIProjectResponseBody} extends {@link TeaModel}
 *
 * <p>ReleaseOmsOpenAPIProjectResponseBody</p>
 */
public class ReleaseOmsOpenAPIProjectResponseBody extends TeaModel {
    ...
    private ReleaseOmsOpenAPIProjectResponseBody(Builder builder) {
    ...
    public static ReleaseOmsOpenAPIProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ReleaseOmsOpenAPIProjectResponseBody build() {
            return new ReleaseOmsOpenAPIProjectResponseBody(this);
        } 
