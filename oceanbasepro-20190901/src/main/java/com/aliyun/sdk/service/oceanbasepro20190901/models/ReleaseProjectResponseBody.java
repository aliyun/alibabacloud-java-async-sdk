...
/**
 * 
 * {@link ReleaseProjectResponseBody} extends {@link TeaModel}
 *
 * <p>ReleaseProjectResponseBody</p>
 */
public class ReleaseProjectResponseBody extends TeaModel {
    ...
    private ReleaseProjectResponseBody(Builder builder) {
    ...
    public static ReleaseProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReleaseProjectResponseBody model) {
        ...
        public ReleaseProjectResponseBody build() {
            return new ReleaseProjectResponseBody(this);
        } 
