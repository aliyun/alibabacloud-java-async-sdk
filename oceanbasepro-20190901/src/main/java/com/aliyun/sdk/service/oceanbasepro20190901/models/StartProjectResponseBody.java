...
/**
 * 
 * {@link StartProjectResponseBody} extends {@link TeaModel}
 *
 * <p>StartProjectResponseBody</p>
 */
public class StartProjectResponseBody extends TeaModel {
    ...
    private StartProjectResponseBody(Builder builder) {
    ...
    public static StartProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartProjectResponseBody model) {
        ...
        public StartProjectResponseBody build() {
            return new StartProjectResponseBody(this);
        } 
