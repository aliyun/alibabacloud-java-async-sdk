...
/**
 * 
 * {@link CreateRdsPostgreSQLDataSourceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateRdsPostgreSQLDataSourceResponseBody</p>
 */
public class CreateRdsPostgreSQLDataSourceResponseBody extends TeaModel {
    ...
    private CreateRdsPostgreSQLDataSourceResponseBody(Builder builder) {
    ...
    public static CreateRdsPostgreSQLDataSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateRdsPostgreSQLDataSourceResponseBody model) {
        ...
        public CreateRdsPostgreSQLDataSourceResponseBody build() {
            return new CreateRdsPostgreSQLDataSourceResponseBody(this);
        } 
