...
/**
 * 
 * {@link CreateOceanBaseDataSourceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateOceanBaseDataSourceResponseBody</p>
 */
public class CreateOceanBaseDataSourceResponseBody extends TeaModel {
    ...
    private CreateOceanBaseDataSourceResponseBody(Builder builder) {
    ...
    public static CreateOceanBaseDataSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateOceanBaseDataSourceResponseBody model) {
        ...
        public CreateOceanBaseDataSourceResponseBody build() {
            return new CreateOceanBaseDataSourceResponseBody(this);
        } 
