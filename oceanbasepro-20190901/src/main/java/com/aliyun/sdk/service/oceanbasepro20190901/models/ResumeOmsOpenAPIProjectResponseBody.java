...
/**
 * {@link ResumeOmsOpenAPIProjectResponseBody} extends {@link TeaModel}
 *
 * <p>ResumeOmsOpenAPIProjectResponseBody</p>
 */
public class ResumeOmsOpenAPIProjectResponseBody extends TeaModel {
    ...
    private ResumeOmsOpenAPIProjectResponseBody(Builder builder) {
    ...
    public static ResumeOmsOpenAPIProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ResumeOmsOpenAPIProjectResponseBody build() {
            return new ResumeOmsOpenAPIProjectResponseBody(this);
        } 
