...
/**
 * 
 * {@link ListWorkerInstancesResponseBody} extends {@link TeaModel}
 *
 * <p>ListWorkerInstancesResponseBody</p>
 */
public class ListWorkerInstancesResponseBody extends TeaModel {
    ...
    private ListWorkerInstancesResponseBody(Builder builder) {
    ...
    public static ListWorkerInstancesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListWorkerInstancesResponseBody model) {
        ...
        public ListWorkerInstancesResponseBody build() {
            return new ListWorkerInstancesResponseBody(this);
        } 
