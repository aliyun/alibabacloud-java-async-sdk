...
/**
 * 
 * {@link ReleaseWorkerInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>ReleaseWorkerInstanceResponseBody</p>
 */
public class ReleaseWorkerInstanceResponseBody extends TeaModel {
    ...
    private ReleaseWorkerInstanceResponseBody(Builder builder) {
    ...
    public static ReleaseWorkerInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReleaseWorkerInstanceResponseBody model) {
        ...
        public ReleaseWorkerInstanceResponseBody build() {
            return new ReleaseWorkerInstanceResponseBody(this);
        } 
