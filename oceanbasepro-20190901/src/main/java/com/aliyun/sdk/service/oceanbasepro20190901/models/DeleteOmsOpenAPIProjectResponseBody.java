...
/**
 * {@link DeleteOmsOpenAPIProjectResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteOmsOpenAPIProjectResponseBody</p>
 */
public class DeleteOmsOpenAPIProjectResponseBody extends TeaModel {
    ...
    private DeleteOmsOpenAPIProjectResponseBody(Builder builder) {
    ...
    public static DeleteOmsOpenAPIProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteOmsOpenAPIProjectResponseBody build() {
            return new DeleteOmsOpenAPIProjectResponseBody(this);
        } 
