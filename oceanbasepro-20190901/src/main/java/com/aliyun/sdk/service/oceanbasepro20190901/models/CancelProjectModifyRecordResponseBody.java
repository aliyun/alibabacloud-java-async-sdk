...
/**
 * 
 * {@link CancelProjectModifyRecordResponseBody} extends {@link TeaModel}
 *
 * <p>CancelProjectModifyRecordResponseBody</p>
 */
public class CancelProjectModifyRecordResponseBody extends TeaModel {
    ...
    private CancelProjectModifyRecordResponseBody(Builder builder) {
    ...
    public static CancelProjectModifyRecordResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CancelProjectModifyRecordResponseBody model) {
        ...
        public CancelProjectModifyRecordResponseBody build() {
            return new CancelProjectModifyRecordResponseBody(this);
        } 
