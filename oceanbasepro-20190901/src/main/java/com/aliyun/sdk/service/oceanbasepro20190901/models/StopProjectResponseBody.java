...
/**
 * 
 * {@link StopProjectResponseBody} extends {@link TeaModel}
 *
 * <p>StopProjectResponseBody</p>
 */
public class StopProjectResponseBody extends TeaModel {
    ...
    private StopProjectResponseBody(Builder builder) {
    ...
    public static StopProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StopProjectResponseBody model) {
        ...
        public StopProjectResponseBody build() {
            return new StopProjectResponseBody(this);
        } 
