...
/**
 * 
 * {@link ModifyTenantSecurityIpGroupResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyTenantSecurityIpGroupResponseBody</p>
 */
public class ModifyTenantSecurityIpGroupResponseBody extends TeaModel {
    ...
    private ModifyTenantSecurityIpGroupResponseBody(Builder builder) {
    ...
    public static ModifyTenantSecurityIpGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyTenantSecurityIpGroupResponseBody model) {
        ...
        public ModifyTenantSecurityIpGroupResponseBody build() {
            return new ModifyTenantSecurityIpGroupResponseBody(this);
        } 
