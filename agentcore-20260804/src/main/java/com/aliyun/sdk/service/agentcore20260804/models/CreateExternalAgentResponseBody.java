...
public class CreateExternalAgentResponseBody extends TeaModel {
    ...
    private CreateExternalAgentResponseBody(Builder builder) {
    ...
    public static CreateExternalAgentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateExternalAgentResponseBody model) {
        ...
        public CreateExternalAgentResponseBody build() {
            return new CreateExternalAgentResponseBody(this);
        } 
