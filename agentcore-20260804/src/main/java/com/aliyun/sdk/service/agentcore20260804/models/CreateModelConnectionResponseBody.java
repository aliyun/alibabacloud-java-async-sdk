...
/**
 * 
 * {@link CreateModelConnectionResponseBody} extends {@link TeaModel}
 *
 * <p>CreateModelConnectionResponseBody</p>
 */
public class CreateModelConnectionResponseBody extends TeaModel {
    ...
    private CreateModelConnectionResponseBody(Builder builder) {
    ...
    public static CreateModelConnectionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateModelConnectionResponseBody model) {
        ...
        public CreateModelConnectionResponseBody build() {
            return new CreateModelConnectionResponseBody(this);
        } 
