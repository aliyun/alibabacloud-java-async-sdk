...
/**
 * 
 * {@link UpdateAgentIMChannelResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAgentIMChannelResponseBody</p>
 */
public class UpdateAgentIMChannelResponseBody extends TeaModel {
    ...
    private UpdateAgentIMChannelResponseBody(Builder builder) {
    ...
    public static UpdateAgentIMChannelResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAgentIMChannelResponseBody model) {
        ...
        public UpdateAgentIMChannelResponseBody build() {
            return new UpdateAgentIMChannelResponseBody(this);
        } 
