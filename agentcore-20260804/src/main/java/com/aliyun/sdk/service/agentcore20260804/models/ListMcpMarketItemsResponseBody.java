...
/**
 * 
 * {@link ListMcpMarketItemsResponseBody} extends {@link TeaModel}
 *
 * <p>ListMcpMarketItemsResponseBody</p>
 */
public class ListMcpMarketItemsResponseBody extends TeaModel {
    ...
    private ListMcpMarketItemsResponseBody(Builder builder) {
    ...
    public static ListMcpMarketItemsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListMcpMarketItemsResponseBody model) {
        ...
        public ListMcpMarketItemsResponseBody build() {
            return new ListMcpMarketItemsResponseBody(this);
        } 
    ...
    public static class Items extends TeaModel {
        ...
        private java.util.Map<String, ItemsI18nValue> i18n;
        ...
        public static final class Builder {
             ...
             */
            public Builder i18n(java.util.Map<String, ItemsI18nValue> i18n) {
                this.i18n = i18n;
                return this;
            }
