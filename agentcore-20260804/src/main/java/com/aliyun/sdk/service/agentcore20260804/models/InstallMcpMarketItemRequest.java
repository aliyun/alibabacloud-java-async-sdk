...
/**
 * 
 * {@link InstallMcpMarketItemRequest} extends {@link RequestModel}
 *
 * <p>InstallMcpMarketItemRequest</p>
 */
public class InstallMcpMarketItemRequest extends Request {
    ...
    private InstallMcpMarketItemRequestBody body;
    ...
    private InstallMcpMarketItemRequest(Builder builder) {
        super(builder);
    ...
    public static InstallMcpMarketItemRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<InstallMcpMarketItemRequest, Builder> {
        private String workspaceId; 
        private String marketItemId; 
        private String regionId; 
        private InstallMcpMarketItemRequestBody body; 
        ...
        private Builder(InstallMcpMarketItemRequest request) {
            super(request);
         ...
         */
        public Builder body(InstallMcpMarketItemRequestBody body) {
        ...
        @Override
        public InstallMcpMarketItemRequest build() {
            return new InstallMcpMarketItemRequest(this);
        } 
    ...
    /**
     * 
     * {@link InstallMcpMarketItemRequest} extends {@link TeaModel}
     *
     * <p>InstallMcpMarketItemRequest</p>
     */
    ...
    public static class InstallMcpMarketItemRequestBody extends TeaModel {
        ...
        public static InstallMcpMarketItemRequestBody create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public InstallMcpMarketItemRequestBody build() {
                return new InstallMcpMarketItemRequestBody(this);
            } 
