...
/**
 * 
 * {@link DownloadAgentSpecViaOssRequest} extends {@link RequestModel}
 *
 * <p>DownloadAgentSpecViaOssRequest</p>
 */
public class DownloadAgentSpecViaOssRequest extends Request {
    ...
    private DownloadAgentSpecViaOssRequest(Builder builder) {
        super(builder);
    ...
    public static DownloadAgentSpecViaOssRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DownloadAgentSpecViaOssRequest, Builder> {
        private String workspaceId; 
        private String agentSpecName; 
        private String agentSpecVersion; 
        ...
        private Builder(DownloadAgentSpecViaOssRequest request) {
            super(request);
        ...
        @Override
        public DownloadAgentSpecViaOssRequest build() {
            return new DownloadAgentSpecViaOssRequest(this);
        } 
