...
/**
 * 
 * {@link GetAgentSpecImportFileUrlResponseBody} extends {@link TeaModel}
 *
 * <p>GetAgentSpecImportFileUrlResponseBody</p>
 */
public class GetAgentSpecImportFileUrlResponseBody extends TeaModel {
    ...
    private GetAgentSpecImportFileUrlResponseBody(Builder builder) {
    ...
    public static GetAgentSpecImportFileUrlResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAgentSpecImportFileUrlResponseBody model) {
        ...
        public GetAgentSpecImportFileUrlResponseBody build() {
            return new GetAgentSpecImportFileUrlResponseBody(this);
        } 
