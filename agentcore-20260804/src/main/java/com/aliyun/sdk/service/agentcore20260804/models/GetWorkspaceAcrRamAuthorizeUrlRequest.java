...
/**
 * 
 * {@link GetWorkspaceAcrRamAuthorizeUrlRequest} extends {@link RequestModel}
 *
 * <p>GetWorkspaceAcrRamAuthorizeUrlRequest</p>
 */
public class GetWorkspaceAcrRamAuthorizeUrlRequest extends Request {
    ...
    private GetWorkspaceAcrRamAuthorizeUrlRequest(Builder builder) {
        super(builder);
    ...
    public static GetWorkspaceAcrRamAuthorizeUrlRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetWorkspaceAcrRamAuthorizeUrlRequest, Builder> {
        private String workspaceId; 
        private String acrInstanceId; 
        private String namespace; 
        private String repository; 
        ...
        private Builder(GetWorkspaceAcrRamAuthorizeUrlRequest request) {
            super(request);
        ...
        @Override
        public GetWorkspaceAcrRamAuthorizeUrlRequest build() {
            return new GetWorkspaceAcrRamAuthorizeUrlRequest(this);
        } 
