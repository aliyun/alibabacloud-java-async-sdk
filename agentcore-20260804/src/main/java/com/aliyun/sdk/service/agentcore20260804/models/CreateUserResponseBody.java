...
public class CreateUserResponseBody extends TeaModel {
    ...
    public static class Data extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * <p>The authentication method of the user. A value of password indicates local password authentication within the workspace. Values of dingtalk and feishu indicate that the user is synchronized and authenticated by the corresponding external identity provider.</p>
             * 
             * <strong>example:</strong>
             * <p>password</p>
             */
            ...
            /**
             * <p>The time when the user was created, in UTC and RFC 3339 format.</p>
             * 
             * <strong>example:</strong>
            ...
            /**
             * <p>The initial password of the user. If password was specified during creation, the specified password is returned. If password was not specified, a random password generated by the server is returned.</p>
             * 
             * <strong>example:</strong>
             * <p>Example@2026</p>
             */
            ...
            /**
             * <p>The username. The username is unique within the workspace and can contain only lowercase letters, digits, and hyphens. It must start and end with a lowercase letter or digit and be 1 to 32 characters in length.</p>
             * 
             * <strong>example:</strong>
             * <p>user-01</p>
             */
            ...
            /**
             * <p>The time when the user was last modified, in UTC and RFC 3339 format.</p>
             * 
             * <strong>example:</strong>
             * <p>2026-08-12T03:04:05Z</p>
             */
