...
/**
 * 
 * {@link UpdateMcpTemplateConfigRequest} extends {@link RequestModel}
 *
 * <p>UpdateMcpTemplateConfigRequest</p>
 */
public class UpdateMcpTemplateConfigRequest extends Request {
    ...
    private UpdateMcpTemplateConfigRequestBody body;
    ...
    private UpdateMcpTemplateConfigRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateMcpTemplateConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateMcpTemplateConfigRequest, Builder> {
        private String workspaceId; 
        private String mcpServerId; 
        private String regionId; 
        private UpdateMcpTemplateConfigRequestBody body; 
        ...
        private Builder(UpdateMcpTemplateConfigRequest request) {
            super(request);
         ...
         */
        public Builder body(UpdateMcpTemplateConfigRequestBody body) {
        ...
        @Override
        public UpdateMcpTemplateConfigRequest build() {
            return new UpdateMcpTemplateConfigRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateMcpTemplateConfigRequest} extends {@link TeaModel}
     *
     * <p>UpdateMcpTemplateConfigRequest</p>
     */
    ...
    public static class UpdateMcpTemplateConfigRequestBody extends TeaModel {
        ...
        private UpdateMcpTemplateConfigRequestBody(Builder builder) {
        ...
        public static UpdateMcpTemplateConfigRequestBody create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            private Builder(UpdateMcpTemplateConfigRequestBody model) {
            ...
            public UpdateMcpTemplateConfigRequestBody build() {
                return new UpdateMcpTemplateConfigRequestBody(this);
            } 
