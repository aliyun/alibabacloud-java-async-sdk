...
public class CreateTicketRequest extends Request {
    ...
    @com.aliyun.core.annotation.NameInMap("CommonQuestionId")
    ...
    private CreateTicketRequest(Builder builder) {
        super(builder);
        this.commonQuestionId = builder.commonQuestionId;
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateTicketRequest, Builder> {
        ...
        private Builder(CreateTicketRequest request) {
            super(request);
            this.commonQuestionId = request.commonQuestionId;
         ...
         * CommonQuestionId.
         */
        public Builder commonQuestionId(Long commonQuestionId) {
            this.putQueryParameter("CommonQuestionId", commonQuestionId);
         ...
         * FileNameList.
         */
        public Builder fileNameList(String fileNameList) {
