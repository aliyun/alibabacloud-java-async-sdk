...
/**
 * 
 * {@link DeleteMem0MemoryRequest} extends {@link RequestModel}
 *
 * <p>DeleteMem0MemoryRequest</p>
 */
public class DeleteMem0MemoryRequest extends Request {
    ...
    private DeleteMem0MemoryRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteMem0MemoryRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteMem0MemoryRequest, Builder> {
        private String memoryId; 
        private String agentSpace; 
        private String contextStoreId; 
        private String orgId; 
        ...
        private Builder(DeleteMem0MemoryRequest request) {
            super(request);
        ...
        @Override
        public DeleteMem0MemoryRequest build() {
            return new DeleteMem0MemoryRequest(this);
        } 
