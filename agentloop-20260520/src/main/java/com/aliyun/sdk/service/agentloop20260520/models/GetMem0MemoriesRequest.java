...
/**
 * 
 * {@link GetMem0MemoriesRequest} extends {@link RequestModel}
 *
 * <p>GetMem0MemoriesRequest</p>
 */
public class GetMem0MemoriesRequest extends Request {
    ...
    private GetMem0MemoriesRequest(Builder builder) {
        super(builder);
    ...
    public static GetMem0MemoriesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetMem0MemoriesRequest, Builder> {
        private String agentSpace; 
        private java.util.Map<String, ?> body; 
        private String contextStoreId; 
        private Boolean enableGraph; 
        ...
        private Builder(GetMem0MemoriesRequest request) {
            super(request);
        ...
        @Override
        public GetMem0MemoriesRequest build() {
            return new GetMem0MemoriesRequest(this);
        } 
