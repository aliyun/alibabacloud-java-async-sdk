...
/**
 * 
 * {@link CreateOpenSourcePermissionRequest} extends {@link RequestModel}
 *
 * <p>CreateOpenSourcePermissionRequest</p>
 */
public class CreateOpenSourcePermissionRequest extends Request {
    ...
    private CreateOpenSourcePermissionRequest(Builder builder) {
        super(builder);
    ...
    public static CreateOpenSourcePermissionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateOpenSourcePermissionRequest, Builder> {
        private String regionId; 
        private String clientToken; 
        private String configure; 
        private String instanceId; 
        ...
        private Builder(CreateOpenSourcePermissionRequest request) {
            super(request);
        ...
        @Override
        public CreateOpenSourcePermissionRequest build() {
            return new CreateOpenSourcePermissionRequest(this);
        } 
