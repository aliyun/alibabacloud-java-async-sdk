...
/**
 * {@link ListDNSServiceRulesRequest} extends {@link RequestModel}
 *
 * <p>ListDNSServiceRulesRequest</p>
 */
public class ListDNSServiceRulesRequest extends Request {
    @Query
    ...
    private ListDNSServiceRulesRequest(Builder builder) {
        super(builder);
    ...
    public static ListDNSServiceRulesRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListDNSServiceRulesRequest, Builder> {
        private java.util.List < String > DNSServiceRuleIds; 
        private java.util.List < String > DNSServiceRuleName; 
        private java.util.List < String > DNSServiceRuleStatus; 
        private java.util.List < String > destination; 
        ...
        private Builder(ListDNSServiceRulesRequest request) {
            super(request);
        ...
        @Override
        public ListDNSServiceRulesRequest build() {
            return new ListDNSServiceRulesRequest(this);
        } 
