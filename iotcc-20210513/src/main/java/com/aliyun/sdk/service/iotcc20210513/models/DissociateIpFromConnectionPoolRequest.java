...
/**
 * {@link DissociateIpFromConnectionPoolRequest} extends {@link RequestModel}
 *
 * <p>DissociateIpFromConnectionPoolRequest</p>
 */
public class DissociateIpFromConnectionPoolRequest extends Request {
    @Query
    ...
    private DissociateIpFromConnectionPoolRequest(Builder builder) {
        super(builder);
    ...
    public static DissociateIpFromConnectionPoolRequest create() {
    ...
    public static final class Builder extends Request.Builder<DissociateIpFromConnectionPoolRequest, Builder> {
        private String clientToken; 
        private String connectionPoolId; 
        private Boolean dryRun; 
        private String ioTCloudConnectorId; 
        ...
        private Builder(DissociateIpFromConnectionPoolRequest request) {
            super(request);
        ...
        @Override
        public DissociateIpFromConnectionPoolRequest build() {
            return new DissociateIpFromConnectionPoolRequest(this);
        } 
