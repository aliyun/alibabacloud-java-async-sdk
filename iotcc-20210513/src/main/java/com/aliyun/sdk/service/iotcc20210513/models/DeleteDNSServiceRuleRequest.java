...
/**
 * {@link DeleteDNSServiceRuleRequest} extends {@link RequestModel}
 *
 * <p>DeleteDNSServiceRuleRequest</p>
 */
public class DeleteDNSServiceRuleRequest extends Request {
    @Query
    ...
    private DeleteDNSServiceRuleRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteDNSServiceRuleRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteDNSServiceRuleRequest, Builder> {
        private String clientToken; 
        private String DNSServiceRuleId; 
        private Boolean dryRun; 
        private String ioTCloudConnectorId; 
        ...
        private Builder(DeleteDNSServiceRuleRequest request) {
            super(request);
        ...
        @Override
        public DeleteDNSServiceRuleRequest build() {
            return new DeleteDNSServiceRuleRequest(this);
        } 
