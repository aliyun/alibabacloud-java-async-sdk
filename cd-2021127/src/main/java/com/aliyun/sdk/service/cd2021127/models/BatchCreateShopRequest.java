...
/**
 * 
 * {@link BatchCreateShopRequest} extends {@link RequestModel}
 *
 * <p>BatchCreateShopRequest</p>
 */
public class BatchCreateShopRequest extends Request {
    ...
    private BatchCreateShopRequest(Builder builder) {
        super(builder);
    ...
    public static BatchCreateShopRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchCreateShopRequest, Builder> {
        private String country; 
        private java.util.List<ShopList> shopList; 
        ...
        private Builder(BatchCreateShopRequest request) {
            super(request);
        ...
        @Override
        public BatchCreateShopRequest build() {
            return new BatchCreateShopRequest(this);
        } 
    ...
    /**
     * 
     * {@link BatchCreateShopRequest} extends {@link TeaModel}
     *
     * <p>BatchCreateShopRequest</p>
     */
