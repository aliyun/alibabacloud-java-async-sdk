...
public class ExecuteSqlInstanceResponseBody extends TeaModel {
    ...
    private ExecuteSqlInstanceResponseBody(Builder builder) {
    ...
    public static ExecuteSqlInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExecuteSqlInstanceResponseBody model) {
        ...
        public ExecuteSqlInstanceResponseBody build() {
            return new ExecuteSqlInstanceResponseBody(this);
        } 
