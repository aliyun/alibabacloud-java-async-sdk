...
/**
 * 
 * {@link CreateSqlInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateSqlInstanceResponseBody</p>
 */
public class CreateSqlInstanceResponseBody extends TeaModel {
    ...
    private CreateSqlInstanceResponseBody(Builder builder) {
    ...
    public static CreateSqlInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateSqlInstanceResponseBody model) {
        ...
        public CreateSqlInstanceResponseBody build() {
            return new CreateSqlInstanceResponseBody(this);
        } 
