...
/**
 * 
 * {@link CloneSqlInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>CloneSqlInstanceResponseBody</p>
 */
public class CloneSqlInstanceResponseBody extends TeaModel {
    ...
    private CloneSqlInstanceResponseBody(Builder builder) {
    ...
    public static CloneSqlInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloneSqlInstanceResponseBody model) {
        ...
        public CloneSqlInstanceResponseBody build() {
            return new CloneSqlInstanceResponseBody(this);
        } 
