...
public class UpdateSqlInstanceContentResponseBody extends TeaModel {
    ...
    private UpdateSqlInstanceContentResponseBody(Builder builder) {
    ...
    public static UpdateSqlInstanceContentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateSqlInstanceContentResponseBody model) {
        ...
        public UpdateSqlInstanceContentResponseBody build() {
            return new UpdateSqlInstanceContentResponseBody(this);
        } 
