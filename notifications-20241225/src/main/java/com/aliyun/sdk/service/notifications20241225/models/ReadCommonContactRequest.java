...
/**
 * 
 * {@link ReadCommonContactRequest} extends {@link RequestModel}
 *
 * <p>ReadCommonContactRequest</p>
 */
public class ReadCommonContactRequest extends Request {
    ...
    private ReadCommonContactRequest(Builder builder) {
        super(builder);
    ...
    public static ReadCommonContactRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadCommonContactRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadCommonContactRequest request) {
            super(request);
        ...
        @Override
        public ReadCommonContactRequest build() {
            return new ReadCommonContactRequest(this);
        } 
