...
/**
 * 
 * {@link ReadAllMessageRequest} extends {@link RequestModel}
 *
 * <p>ReadAllMessageRequest</p>
 */
public class ReadAllMessageRequest extends Request {
    ...
    private ReadAllMessageRequest(Builder builder) {
        super(builder);
    ...
    public static ReadAllMessageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadAllMessageRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadAllMessageRequest request) {
            super(request);
        ...
        @Override
        public ReadAllMessageRequest build() {
            return new ReadAllMessageRequest(this);
        } 
