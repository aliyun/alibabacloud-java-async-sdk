...
/**
 * 
 * {@link ReadAllCommonContactsRequest} extends {@link RequestModel}
 *
 * <p>ReadAllCommonContactsRequest</p>
 */
public class ReadAllCommonContactsRequest extends Request {
    ...
    private ReadAllCommonContactsRequest(Builder builder) {
        super(builder);
    ...
    public static ReadAllCommonContactsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadAllCommonContactsRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadAllCommonContactsRequest request) {
            super(request);
        ...
        @Override
        public ReadAllCommonContactsRequest build() {
            return new ReadAllCommonContactsRequest(this);
        } 
