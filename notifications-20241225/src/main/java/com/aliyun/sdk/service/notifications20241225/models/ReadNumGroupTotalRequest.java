...
/**
 * 
 * {@link ReadNumGroupTotalRequest} extends {@link RequestModel}
 *
 * <p>ReadNumGroupTotalRequest</p>
 */
public class ReadNumGroupTotalRequest extends Request {
    ...
    private ReadNumGroupTotalRequest(Builder builder) {
        super(builder);
    ...
    public static ReadNumGroupTotalRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadNumGroupTotalRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadNumGroupTotalRequest request) {
            super(request);
        ...
        /**
         * <p>System parameter. You do not need to set this parameter.</p>
         * 
         * <strong>example:</strong>
         * <p>/</p>
         */
         ...
         * 
         * <strong>example:</strong>
         * <p>Can \&quot;Financial expenses_interest income\&quot; be considered as income?</p>
         */
        ...
        @Override
        public ReadNumGroupTotalRequest build() {
            return new ReadNumGroupTotalRequest(this);
        } 
