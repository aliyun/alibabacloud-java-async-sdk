...
/**
 * 
 * {@link ReadMessageLanguageRequest} extends {@link RequestModel}
 *
 * <p>ReadMessageLanguageRequest</p>
 */
public class ReadMessageLanguageRequest extends Request {
    ...
    @com.aliyun.core.annotation.Body
    @com.aliyun.core.annotation.NameInMap("ReturnDefaultLang")
    private String returnDefaultLang;
    ...
    private ReadMessageLanguageRequest(Builder builder) {
        super(builder);
        ...
        this.returnDefaultLang = builder.returnDefaultLang;
    ...
    public static ReadMessageLanguageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadMessageLanguageRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadMessageLanguageRequest request) {
            super(request);
            ...
            this.returnDefaultLang = request.returnDefaultLang;
        ...
        @Override
        public ReadMessageLanguageRequest build() {
            return new ReadMessageLanguageRequest(this);
        } 
