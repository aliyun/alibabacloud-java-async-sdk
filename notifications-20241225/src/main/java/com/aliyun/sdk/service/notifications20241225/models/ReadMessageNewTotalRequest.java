...
/**
 * 
 * {@link ReadMessageNewTotalRequest} extends {@link RequestModel}
 *
 * <p>ReadMessageNewTotalRequest</p>
 */
public class ReadMessageNewTotalRequest extends Request {
    ...
    private ReadMessageNewTotalRequest(Builder builder) {
        super(builder);
    ...
    public static ReadMessageNewTotalRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadMessageNewTotalRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadMessageNewTotalRequest request) {
            super(request);
        ...
        @Override
        public ReadMessageNewTotalRequest build() {
            return new ReadMessageNewTotalRequest(this);
        } 
