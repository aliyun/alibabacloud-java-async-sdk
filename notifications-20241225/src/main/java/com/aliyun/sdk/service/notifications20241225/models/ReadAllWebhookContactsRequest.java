...
/**
 * 
 * {@link ReadAllWebhookContactsRequest} extends {@link RequestModel}
 *
 * <p>ReadAllWebhookContactsRequest</p>
 */
public class ReadAllWebhookContactsRequest extends Request {
    ...
    private ReadAllWebhookContactsRequest(Builder builder) {
        super(builder);
    ...
    public static ReadAllWebhookContactsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadAllWebhookContactsRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadAllWebhookContactsRequest request) {
            super(request);
        ...
        @Override
        public ReadAllWebhookContactsRequest build() {
            return new ReadAllWebhookContactsRequest(this);
        } 
