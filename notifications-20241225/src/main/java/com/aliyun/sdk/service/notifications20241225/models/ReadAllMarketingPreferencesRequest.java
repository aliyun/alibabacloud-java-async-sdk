...
/**
 * 
 * {@link ReadAllMarketingPreferencesRequest} extends {@link RequestModel}
 *
 * <p>ReadAllMarketingPreferencesRequest</p>
 */
public class ReadAllMarketingPreferencesRequest extends Request {
    ...
    private ReadAllMarketingPreferencesRequest(Builder builder) {
        super(builder);
    ...
    public static ReadAllMarketingPreferencesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadAllMarketingPreferencesRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadAllMarketingPreferencesRequest request) {
            super(request);
        ...
        @Override
        public ReadAllMarketingPreferencesRequest build() {
            return new ReadAllMarketingPreferencesRequest(this);
        } 
