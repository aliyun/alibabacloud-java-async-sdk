...
/**
 * 
 * {@link ReadClassNameRequest} extends {@link RequestModel}
 *
 * <p>ReadClassNameRequest</p>
 */
public class ReadClassNameRequest extends Request {
    ...
    private ReadClassNameRequest(Builder builder) {
        super(builder);
    ...
    public static ReadClassNameRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadClassNameRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadClassNameRequest request) {
            super(request);
        ...
        @Override
        public ReadClassNameRequest build() {
            return new ReadClassNameRequest(this);
        } 
