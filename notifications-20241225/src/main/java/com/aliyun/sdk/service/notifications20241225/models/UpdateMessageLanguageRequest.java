...
/**
 * 
 * {@link UpdateMessageLanguageRequest} extends {@link RequestModel}
 *
 * <p>UpdateMessageLanguageRequest</p>
 */
public class UpdateMessageLanguageRequest extends Request {
    ...
    @com.aliyun.core.annotation.Body
    @com.aliyun.core.annotation.NameInMap("PreferLang")
    ...
    private UpdateMessageLanguageRequest(Builder builder) {
        super(builder);
        ...
        this.preferLang = builder.preferLang;
    ...
    public static UpdateMessageLanguageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateMessageLanguageRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(UpdateMessageLanguageRequest request) {
            super(request);
            ...
            this.preferLang = request.preferLang;
         ...
         * PreferLang.
         */
        public Builder preferLang(String preferLang) {
            this.putBodyParameter("PreferLang", preferLang);
        ...
        @Override
        public UpdateMessageLanguageRequest build() {
            return new UpdateMessageLanguageRequest(this);
        } 
