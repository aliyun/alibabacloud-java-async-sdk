...
/**
 * 
 * {@link ReadMarketingPreferenceRequest} extends {@link RequestModel}
 *
 * <p>ReadMarketingPreferenceRequest</p>
 */
public class ReadMarketingPreferenceRequest extends Request {
    ...
    private ReadMarketingPreferenceRequest(Builder builder) {
        super(builder);
    ...
    public static ReadMarketingPreferenceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadMarketingPreferenceRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadMarketingPreferenceRequest request) {
            super(request);
        ...
        @Override
        public ReadMarketingPreferenceRequest build() {
            return new ReadMarketingPreferenceRequest(this);
        } 
