...
/**
 * 
 * {@link DelMessageRequest} extends {@link RequestModel}
 *
 * <p>DelMessageRequest</p>
 */
public class DelMessageRequest extends Request {
    ...
    private DelMessageRequest(Builder builder) {
        super(builder);
    ...
    public static DelMessageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DelMessageRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(DelMessageRequest request) {
            super(request);
        ...
        @Override
        public DelMessageRequest build() {
            return new DelMessageRequest(this);
        } 
