...
/**
 * 
 * {@link UpdateMarketingPreferenceRequest} extends {@link RequestModel}
 *
 * <p>UpdateMarketingPreferenceRequest</p>
 */
public class UpdateMarketingPreferenceRequest extends Request {
    ...
    private UpdateMarketingPreferenceRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateMarketingPreferenceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateMarketingPreferenceRequest, Builder> {
        private String acceptLanguage; 
        private Boolean allowMarketing; 
        private String appName; 
        private String bizName; 
        ...
        private Builder(UpdateMarketingPreferenceRequest request) {
            super(request);
            this.acceptLanguage = request.acceptLanguage;
            this.allowMarketing = request.allowMarketing;
        ...
        @Override
        public UpdateMarketingPreferenceRequest build() {
            return new UpdateMarketingPreferenceRequest(this);
        } 
