...
/**
 * 
 * {@link ReadMessageRequest} extends {@link RequestModel}
 *
 * <p>ReadMessageRequest</p>
 */
public class ReadMessageRequest extends Request {
    ...
    public static ReadMessageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadMessageRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadMessageRequest request) {
            super(request);
        ...
        public ReadMessageRequest build() {
            return new ReadMessageRequest(this);
        } 
