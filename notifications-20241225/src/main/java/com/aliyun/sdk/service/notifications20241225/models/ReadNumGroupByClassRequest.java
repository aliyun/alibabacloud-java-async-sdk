...
/**
 * 
 * {@link ReadNumGroupByClassRequest} extends {@link RequestModel}
 *
 * <p>ReadNumGroupByClassRequest</p>
 */
public class ReadNumGroupByClassRequest extends Request {
    ...
    private ReadNumGroupByClassRequest(Builder builder) {
        super(builder);
    ...
    public static ReadNumGroupByClassRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadNumGroupByClassRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadNumGroupByClassRequest request) {
            super(request);
        ...
        @Override
        public ReadNumGroupByClassRequest build() {
            return new ReadNumGroupByClassRequest(this);
        } 
