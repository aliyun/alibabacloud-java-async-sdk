...
/**
 * 
 * {@link DeleteAllMessageRequest} extends {@link RequestModel}
 *
 * <p>DeleteAllMessageRequest</p>
 */
public class DeleteAllMessageRequest extends Request {
    ...
    private DeleteAllMessageRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteAllMessageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteAllMessageRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(DeleteAllMessageRequest request) {
            super(request);
        ...
        @Override
        public DeleteAllMessageRequest build() {
            return new DeleteAllMessageRequest(this);
        } 
