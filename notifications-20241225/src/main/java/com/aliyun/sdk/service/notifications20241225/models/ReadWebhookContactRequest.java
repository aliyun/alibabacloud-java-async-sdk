...
/**
 * 
 * {@link ReadWebhookContactRequest} extends {@link RequestModel}
 *
 * <p>ReadWebhookContactRequest</p>
 */
public class ReadWebhookContactRequest extends Request {
    ...
    private ReadWebhookContactRequest(Builder builder) {
        super(builder);
    ...
    public static ReadWebhookContactRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ReadWebhookContactRequest, Builder> {
        private String acceptLanguage; 
        private String appName; 
        private String bizName; 
        private String callerProtocol; 
        ...
        private Builder(ReadWebhookContactRequest request) {
            super(request);
        ...
        @Override
        public ReadWebhookContactRequest build() {
            return new ReadWebhookContactRequest(this);
        } 
