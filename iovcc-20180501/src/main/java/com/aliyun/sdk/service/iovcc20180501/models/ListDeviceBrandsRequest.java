...
/**
 * {@link ListDeviceBrandsRequest} extends {@link RequestModel}
 *
 * <p>ListDeviceBrandsRequest</p>
 */
public class ListDeviceBrandsRequest extends Request {
    @Query
    ...
    private ListDeviceBrandsRequest(Builder builder) {
        super(builder);
    ...
    public static ListDeviceBrandsRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListDeviceBrandsRequest, Builder> {
        private String deviceBrand; 
        private Long deviceBrandId; 
        private String length; 
        private String projectId; 
        ...
        private Builder(ListDeviceBrandsRequest response) {
            super(response);
        ...
        @Override
        public ListDeviceBrandsRequest build() {
            return new ListDeviceBrandsRequest(this);
        } 
