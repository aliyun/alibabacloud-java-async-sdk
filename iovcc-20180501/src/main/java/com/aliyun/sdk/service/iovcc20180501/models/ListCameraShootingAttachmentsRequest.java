...
/**
 * {@link ListCameraShootingAttachmentsRequest} extends {@link RequestModel}
 *
 * <p>ListCameraShootingAttachmentsRequest</p>
 */
public class ListCameraShootingAttachmentsRequest extends Request {
    @Query
    ...
    private ListCameraShootingAttachmentsRequest(Builder builder) {
        super(builder);
    ...
    public static ListCameraShootingAttachmentsRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListCameraShootingAttachmentsRequest, Builder> {
        private String edgeDeviceId; 
        private String projectId; 
        private String regionId; 
        private Long shootingRecordId; 
        ...
        private Builder(ListCameraShootingAttachmentsRequest response) {
            super(response);
        ...
        @Override
        public ListCameraShootingAttachmentsRequest build() {
            return new ListCameraShootingAttachmentsRequest(this);
        } 
