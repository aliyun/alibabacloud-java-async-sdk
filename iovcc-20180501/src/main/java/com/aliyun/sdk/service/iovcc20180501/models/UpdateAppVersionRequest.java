...
/**
 * {@link UpdateAppVersionRequest} extends {@link RequestModel}
 *
 * <p>UpdateAppVersionRequest</p>
 */
public class UpdateAppVersionRequest extends Request {
    @Query
    @NameInMap("ApkMd5")
    ...
    private UpdateAppVersionRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateAppVersionRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateAppVersionRequest, Builder> {
        private String apkMd5; 
        private String appId; 
        private String appVersion; 
        private String blackVersionList; 
        ...
        private Builder(UpdateAppVersionRequest response) {
            super(response);
        ...
        @Override
        public UpdateAppVersionRequest build() {
            return new UpdateAppVersionRequest(this);
        } 
