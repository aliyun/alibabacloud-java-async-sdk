...
/**
 * {@link DeleteVersionGroupDeviceRequest} extends {@link RequestModel}
 *
 * <p>DeleteVersionGroupDeviceRequest</p>
 */
public class DeleteVersionGroupDeviceRequest extends Request {
    @Query
    ...
    private DeleteVersionGroupDeviceRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteVersionGroupDeviceRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteVersionGroupDeviceRequest, Builder> {
        private String deviceGroupId; 
        private String deviceIdType; 
        private String deviceIds; 
        private String projectId; 
        ...
        private Builder(DeleteVersionGroupDeviceRequest response) {
            super(response);
        ...
        @Override
        public DeleteVersionGroupDeviceRequest build() {
            return new DeleteVersionGroupDeviceRequest(this);
        } 
