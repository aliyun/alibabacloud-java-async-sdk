...
/**
 * {@link FindVersionWhiteDevicesResponseBody} extends {@link TeaModel}
 *
 * <p>FindVersionWhiteDevicesResponseBody</p>
 */
public class FindVersionWhiteDevicesResponseBody extends TeaModel {
    ...
    private FindVersionWhiteDevicesResponseBody(Builder builder) {
    ...
    public static FindVersionWhiteDevicesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public FindVersionWhiteDevicesResponseBody build() {
            return new FindVersionWhiteDevicesResponseBody(this);
        } 
