...
/**
 * {@link DescribeDeviceBrandResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDeviceBrandResponseBody</p>
 */
public class DescribeDeviceBrandResponseBody extends TeaModel {
    ...
    private DescribeDeviceBrandResponseBody(Builder builder) {
    ...
    public static DescribeDeviceBrandResponseBody create() {
    ...
    public static final class Builder {
         ...
         * DeviceBrand.
         */
        public Builder deviceBrand(DeviceBrand deviceBrand) {
        ...
        public DescribeDeviceBrandResponseBody build() {
            return new DescribeDeviceBrandResponseBody(this);
        } 

    } 

    public static class DeviceBrand extends TeaModel {
        ...
        private DeviceBrand(Builder builder) {
        ...
        public static DeviceBrand create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public DeviceBrand build() {
                return new DeviceBrand(this);
            } 
