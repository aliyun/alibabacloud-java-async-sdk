...
/**
 * {@link UpdateGeoFenceRequest} extends {@link RequestModel}
 *
 * <p>UpdateGeoFenceRequest</p>
 */
public class UpdateGeoFenceRequest extends Request {
    @Query
    ...
    private UpdateGeoFenceRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateGeoFenceRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateGeoFenceRequest, Builder> {
        private String alarmCondition; 
        private Float area; 
        private String center; 
        private String cityCode; 
        ...
        private Builder(UpdateGeoFenceRequest response) {
            super(response);
        ...
        public UpdateGeoFenceRequest build() {
            return new UpdateGeoFenceRequest(this);
        } 
