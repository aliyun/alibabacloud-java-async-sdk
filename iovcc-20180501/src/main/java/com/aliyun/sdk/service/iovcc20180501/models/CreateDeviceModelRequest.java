...
/**
 * {@link CreateDeviceModelRequest} extends {@link RequestModel}
 *
 * <p>CreateDeviceModelRequest</p>
 */
public class CreateDeviceModelRequest extends Request {
    @Query
    @NameInMap("BrandName")
    ...
    private CreateDeviceModelRequest(Builder builder) {
        super(builder);
    ...
    public static CreateDeviceModelRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateDeviceModelRequest, Builder> {
        private String brandName; 
        private String canCreateDeviceId; 
        private String description; 
        private String deviceName; 
        ...
        private Builder(CreateDeviceModelRequest response) {
            super(response);
        ...
        @Override
        public CreateDeviceModelRequest build() {
            return new CreateDeviceModelRequest(this);
        } 
