...
/**
 * 
 * {@link UpdateCheckItemRequest} extends {@link RequestModel}
 *
 * <p>UpdateCheckItemRequest</p>
 */
public class UpdateCheckItemRequest extends Request {
    ...
    private UpdateCheckItemRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateCheckItemRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateCheckItemRequest, Builder> {
        private AssistInfo assistInfo; 
        private Long checkId; 
        private String checkRule; 
        private String checkShowName; 
        ...
        private Builder(UpdateCheckItemRequest request) {
            super(request);
        ...
        public UpdateCheckItemRequest build() {
            return new UpdateCheckItemRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateCheckItemRequest} extends {@link TeaModel}
     *
     * <p>UpdateCheckItemRequest</p>
     */
