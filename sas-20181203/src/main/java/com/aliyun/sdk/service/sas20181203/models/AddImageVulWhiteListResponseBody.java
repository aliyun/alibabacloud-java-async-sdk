...
public class AddImageVulWhiteListResponseBody extends TeaModel {
    ...
    private AddImageVulWhiteListResponseBody(Builder builder) {
    ...
    public static AddImageVulWhiteListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddImageVulWhiteListResponseBody model) {
        ...
        public AddImageVulWhiteListResponseBody build() {
            return new AddImageVulWhiteListResponseBody(this);
        } 
