...
public class ModifyNoticeConfigResponse extends Response {
    ...
    private ModifyNoticeConfigResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ModifyNoticeConfigResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ModifyNoticeConfigResponseBody body);

        @Override
        ModifyNoticeConfigResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ModifyNoticeConfigResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ModifyNoticeConfigResponseBody body; 
        ...
        private BuilderImpl(ModifyNoticeConfigResponse response) {
            super(response);
