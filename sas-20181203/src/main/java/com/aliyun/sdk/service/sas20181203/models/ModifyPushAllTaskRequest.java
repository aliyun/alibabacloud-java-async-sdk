...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyPushAllTaskRequest, Builder> {
        ...
        /**
         * <p>The check items to include in the security check. Separate multiple check items with commas (,). Valid values:</p>
         * <ul>
         * <li><strong>OVAL_ENTITY</strong>: CVE vulnerabilities</li>
         * <li><strong>CMS</strong>: Web-CMS vulnerabilities</li>
         * <li><strong>SYSVUL</strong>: system vulnerabilities</li>
         * <li><strong>SCA</strong>: application vulnerabilities</li>
         * <li><strong>HEALTH_CHECK</strong>: baselines</li>
         * <li><strong>WEBSHELL</strong>: web shells</li>
         ...
         * <li><strong>SOFTWARE_SNAPSHOT</strong>: software</li>
        ...
        /**
         * <p>The UUIDs of the servers on which you want to perform security checks. Separate multiple UUIDs with commas (,).</p>
         * <p>This parameter is required.</p>
         * 
         * <strong>example:</strong>
