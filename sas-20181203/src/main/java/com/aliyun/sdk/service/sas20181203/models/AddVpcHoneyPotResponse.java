...
public class AddVpcHoneyPotResponse extends Response {
    ...
    private AddVpcHoneyPotResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<AddVpcHoneyPotResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(AddVpcHoneyPotResponseBody body);

        @Override
        AddVpcHoneyPotResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<AddVpcHoneyPotResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private AddVpcHoneyPotResponseBody body; 
        ...
        private BuilderImpl(AddVpcHoneyPotResponse response) {
            super(response);
