...
public class UninstallBackupClientResponse extends Response {
    ...
    private UninstallBackupClientResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<UninstallBackupClientResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(UninstallBackupClientResponseBody body);

        @Override
        UninstallBackupClientResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<UninstallBackupClientResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private UninstallBackupClientResponseBody body; 
        ...
        private BuilderImpl(UninstallBackupClientResponse response) {
            super(response);
