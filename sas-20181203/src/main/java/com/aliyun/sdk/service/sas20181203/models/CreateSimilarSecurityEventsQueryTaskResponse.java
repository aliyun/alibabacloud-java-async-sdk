...
public class CreateSimilarSecurityEventsQueryTaskResponse extends Response {
    ...
    private CreateSimilarSecurityEventsQueryTaskResponse(BuilderImpl builder) {
        super(builder);
...
@Override
    ...
    public interface Builder extends Response.Builder<CreateSimilarSecurityEventsQueryTaskResponse, Builder> {

        Builder headers(java.util.Map<String, String> headers);

        Builder statusCode(Integer statusCode);

        Builder body(CreateSimilarSecurityEventsQueryTaskResponseBody body);

        @Override
        CreateSimilarSecurityEventsQueryTaskResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<CreateSimilarSecurityEventsQueryTaskResponse, Builder>
            implements Builder {
        private java.util.Map<String, String> headers; 
        private Integer statusCode; 
        private CreateSimilarSecurityEventsQueryTaskResponseBody body; 
        ...
        private BuilderImpl(CreateSimilarSecurityEventsQueryTaskResponse response) {
            super(response);
