...
public class UpdateClientAlertModeResponseBody extends TeaModel {
    ...
    private UpdateClientAlertModeResponseBody(Builder builder) {
    ...
    public static UpdateClientAlertModeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateClientAlertModeResponseBody model) {
        ...
        public UpdateClientAlertModeResponseBody build() {
            return new UpdateClientAlertModeResponseBody(this);
        } 
