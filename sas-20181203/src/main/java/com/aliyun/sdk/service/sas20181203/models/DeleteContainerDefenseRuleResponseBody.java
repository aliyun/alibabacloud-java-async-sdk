...
/**
 * 
 * {@link DeleteContainerDefenseRuleResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteContainerDefenseRuleResponseBody</p>
 */
public class DeleteContainerDefenseRuleResponseBody extends TeaModel {
    ...
    private DeleteContainerDefenseRuleResponseBody(Builder builder) {
    ...
    public static DeleteContainerDefenseRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteContainerDefenseRuleResponseBody model) {
        ...
        public DeleteContainerDefenseRuleResponseBody build() {
            return new DeleteContainerDefenseRuleResponseBody(this);
        } 
