...
/**
 * 
 * {@link CreateAttackPathWhitelistRequest} extends {@link RequestModel}
 *
 * <p>CreateAttackPathWhitelistRequest</p>
 */
public class CreateAttackPathWhitelistRequest extends Request {
    ...
    private CreateAttackPathWhitelistRequest(Builder builder) {
        super(builder);
    ...
    public static CreateAttackPathWhitelistRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateAttackPathWhitelistRequest, Builder> {
        private java.util.List<AttackPathAssetList> attackPathAssetList; 
        private String pathName; 
        private String pathType; 
        private String remark; 
        ...
        private Builder(CreateAttackPathWhitelistRequest request) {
            super(request);
        ...
        @Override
        public CreateAttackPathWhitelistRequest build() {
            return new CreateAttackPathWhitelistRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateAttackPathWhitelistRequest} extends {@link TeaModel}
     *
     * <p>CreateAttackPathWhitelistRequest</p>
     */
