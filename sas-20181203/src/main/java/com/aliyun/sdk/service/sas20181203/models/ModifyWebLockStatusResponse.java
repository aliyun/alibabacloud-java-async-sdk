...
public class ModifyWebLockStatusResponse extends Response {
    ...
    private ModifyWebLockStatusResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ModifyWebLockStatusResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ModifyWebLockStatusResponseBody body);

        @Override
        ModifyWebLockStatusResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ModifyWebLockStatusResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ModifyWebLockStatusResponseBody body; 
        ...
        private BuilderImpl(ModifyWebLockStatusResponse response) {
            super(response);
