...
public class DescribeExcludeSystemPathResponse extends Response {
    ...
    private DescribeExcludeSystemPathResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<DescribeExcludeSystemPathResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(DescribeExcludeSystemPathResponseBody body);

        @Override
        DescribeExcludeSystemPathResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<DescribeExcludeSystemPathResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private DescribeExcludeSystemPathResponseBody body; 
        ...
        private BuilderImpl(DescribeExcludeSystemPathResponse response) {
            super(response);
