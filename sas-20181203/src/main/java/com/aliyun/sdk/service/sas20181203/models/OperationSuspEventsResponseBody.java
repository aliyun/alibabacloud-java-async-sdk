...
public class OperationSuspEventsResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        /**
         * <p>Indicates whether you have the access permission. Valid values:</p>
         * <ul>
         * <li><strong>pass</strong>: You have the permission.</li>
         * <li><strong>no_permission</strong>: You do not have the permission.</li>
         * </ul>
         * 
