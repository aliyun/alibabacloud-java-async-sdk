...
public class UpdatePostPaidBindRelResponseBody extends TeaModel {
    ...
    public static final class Builder {
         ...
         * <li><strong>3</strong>: Insufficient server authorization core quota.</li>
         * <li><strong>4</strong>: Pay-as-you-go billing is not enabled.</li>
         * <li><strong>5</strong>: Service suspended due to overdue payment.</li>
         * <li><strong>6</strong>: Serverless protection is not enabled.</li>
         * <li><strong>7</strong>: Pay-as-you-go host and container security service is not enabled.</li>
