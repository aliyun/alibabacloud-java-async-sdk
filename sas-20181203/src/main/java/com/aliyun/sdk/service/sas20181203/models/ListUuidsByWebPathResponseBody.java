...
public class ListUuidsByWebPathResponseBody extends TeaModel {
    ...
    private ListUuidsByWebPathResponseBody(Builder builder) {
    ...
    public static ListUuidsByWebPathResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListUuidsByWebPathResponseBody build() {
            return new ListUuidsByWebPathResponseBody(this);
        } 
