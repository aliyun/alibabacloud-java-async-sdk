...
public class UpdateCommonSwitchConfigResponse extends Response {
    ...
    public static UpdateCommonSwitchConfigResponse create() {
...
@Override
    ...
    public interface Builder extends Response.Builder<UpdateCommonSwitchConfigResponse, Builder> {
        ...
        Builder body(UpdateCommonSwitchConfigResponseBody body);

        @Override
        UpdateCommonSwitchConfigResponse build();
    ...
    private static final class BuilderImpl
        ...
        private BuilderImpl(UpdateCommonSwitchConfigResponse response) {
            super(response);
         ...
         */
        @Override
        public Builder body(UpdateCommonSwitchConfigResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public UpdateCommonSwitchConfigResponse build() {
            return new UpdateCommonSwitchConfigResponse(this);
        } 
