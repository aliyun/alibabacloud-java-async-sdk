...
public class GetVulStatisticsResponse extends Response {
    ...
    private GetVulStatisticsResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<GetVulStatisticsResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(GetVulStatisticsResponseBody body);

        @Override
        GetVulStatisticsResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<GetVulStatisticsResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private GetVulStatisticsResponseBody body; 
        ...
        private BuilderImpl(GetVulStatisticsResponse response) {
            super(response);
