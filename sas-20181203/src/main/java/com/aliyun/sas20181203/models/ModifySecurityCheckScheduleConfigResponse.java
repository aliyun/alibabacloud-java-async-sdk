...
public class ModifySecurityCheckScheduleConfigResponse extends Response {
    ...
    private ModifySecurityCheckScheduleConfigResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ModifySecurityCheckScheduleConfigResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(ModifySecurityCheckScheduleConfigResponseBody body);

        @Override
        ModifySecurityCheckScheduleConfigResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ModifySecurityCheckScheduleConfigResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private ModifySecurityCheckScheduleConfigResponseBody body; 
        ...
        private BuilderImpl(ModifySecurityCheckScheduleConfigResponse response) {
            super(response);
