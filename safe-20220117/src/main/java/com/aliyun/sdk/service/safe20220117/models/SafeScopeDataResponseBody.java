...
/**
 * 
 * {@link SafeScopeDataResponseBody} extends {@link TeaModel}
 *
 * <p>SafeScopeDataResponseBody</p>
 */
public class SafeScopeDataResponseBody extends TeaModel {
    ...
    private SafeScopeDataResponseBody(Builder builder) {
    ...
    public static SafeScopeDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SafeScopeDataResponseBody model) {
        ...
        public SafeScopeDataResponseBody build() {
            return new SafeScopeDataResponseBody(this);
        } 
