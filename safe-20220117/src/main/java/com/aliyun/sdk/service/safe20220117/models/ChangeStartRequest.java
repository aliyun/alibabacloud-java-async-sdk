...
/**
 * 
 * {@link ChangeStartRequest} extends {@link RequestModel}
 *
 * <p>ChangeStartRequest</p>
 */
public class ChangeStartRequest extends Request {
    ...
    private ChangeStartRequest(Builder builder) {
        super(builder);
    ...
    public static ChangeStartRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ChangeStartRequest, Builder> {
        private String authKey; 
        private String authSign; 
        private Long changeEndTime; 
        private String changeObject; 
        ...
        private Builder(ChangeStartRequest request) {
            super(request);
        ...
        public Builder changeObject(String changeObject) {
            this.putQueryParameter("ChangeObject", changeObject);
        ...
        public Builder changeOptType(String changeOptType) {
            this.putQueryParameter("ChangeOptType", changeOptType);
        ...
        public Builder changeTitle(String changeTitle) {
            this.putQueryParameter("ChangeTitle", changeTitle);
        ...
        @Override
        public ChangeStartRequest build() {
            return new ChangeStartRequest(this);
        } 
