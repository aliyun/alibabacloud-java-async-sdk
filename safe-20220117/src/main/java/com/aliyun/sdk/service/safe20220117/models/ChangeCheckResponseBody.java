...
/**
 * 
 * {@link ChangeCheckResponseBody} extends {@link TeaModel}
 *
 * <p>ChangeCheckResponseBody</p>
 */
public class ChangeCheckResponseBody extends TeaModel {
    ...
    private ChangeCheckResponseBody(Builder builder) {
    ...
    public static ChangeCheckResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ChangeCheckResponseBody model) {
        ...
        public ChangeCheckResponseBody build() {
            return new ChangeCheckResponseBody(this);
        } 
