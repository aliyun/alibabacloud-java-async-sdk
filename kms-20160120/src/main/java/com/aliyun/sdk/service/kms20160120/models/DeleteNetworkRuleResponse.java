...
/**
 * {@link DeleteNetworkRuleResponse} extends {@link TeaModel}
 *
 * <p>DeleteNetworkRuleResponse</p>
 */
public class DeleteNetworkRuleResponse extends Response {
    ...
    public static DeleteNetworkRuleResponse create() {
    ...
    public interface Builder extends Response.Builder<DeleteNetworkRuleResponse, Builder> {
        ...
        @Override
        DeleteNetworkRuleResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(DeleteNetworkRuleResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public DeleteNetworkRuleResponse build() {
            return new DeleteNetworkRuleResponse(this);
        } 
