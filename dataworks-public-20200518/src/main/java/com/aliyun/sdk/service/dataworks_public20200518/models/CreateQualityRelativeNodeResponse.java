...
/**
 * 
 * {@link CreateQualityRelativeNodeResponse} extends {@link TeaModel}
 *
 * <p>CreateQualityRelativeNodeResponse</p>
 */
public class CreateQualityRelativeNodeResponse extends Response {
    ...
    public static CreateQualityRelativeNodeResponse create() {
    ...
    public interface Builder extends Response.Builder<CreateQualityRelativeNodeResponse, Builder> {
        ...
        @Override
        CreateQualityRelativeNodeResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(CreateQualityRelativeNodeResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public CreateQualityRelativeNodeResponse build() {
            return new CreateQualityRelativeNodeResponse(this);
        } 
