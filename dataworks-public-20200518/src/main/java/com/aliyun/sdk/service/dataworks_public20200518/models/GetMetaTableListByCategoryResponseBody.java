...
public class GetMetaTableListByCategoryResponseBody extends TeaModel {
    ...
    private GetMetaTableListByCategoryResponseBody(Builder builder) {
    ...
    public static GetMetaTableListByCategoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetMetaTableListByCategoryResponseBody build() {
            return new GetMetaTableListByCategoryResponseBody(this);
        } 
    ...
    public static class Data extends TeaModel {
        ...
        private Data(Builder builder) {
            ...
            this.tableGuidList = builder.tableGuidList;
