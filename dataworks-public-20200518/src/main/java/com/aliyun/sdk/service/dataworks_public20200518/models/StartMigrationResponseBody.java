...
public class StartMigrationResponseBody extends TeaModel {
    ...
    private StartMigrationResponseBody(Builder builder) {
    ...
    public static StartMigrationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartMigrationResponseBody model) {
        ...
        public StartMigrationResponseBody build() {
            return new StartMigrationResponseBody(this);
        } 
