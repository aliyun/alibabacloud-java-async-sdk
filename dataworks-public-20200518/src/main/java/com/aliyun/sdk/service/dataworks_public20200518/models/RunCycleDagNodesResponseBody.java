...
public class RunCycleDagNodesResponseBody extends TeaModel {
    ...
    public static RunCycleDagNodesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RunCycleDagNodesResponseBody model) {
        ...
        public RunCycleDagNodesResponseBody build() {
            return new RunCycleDagNodesResponseBody(this);
        } 
