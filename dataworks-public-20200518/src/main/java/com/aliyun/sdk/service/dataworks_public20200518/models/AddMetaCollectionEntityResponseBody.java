...
public class AddMetaCollectionEntityResponseBody extends TeaModel {
    ...
    public static AddMetaCollectionEntityResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddMetaCollectionEntityResponseBody model) {
        ...
        public AddMetaCollectionEntityResponseBody build() {
            return new AddMetaCollectionEntityResponseBody(this);
        } 
