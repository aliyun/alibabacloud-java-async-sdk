...
/**
 * 
 * {@link DsgGetVisitStatResponseBody} extends {@link TeaModel}
 *
 * <p>DsgGetVisitStatResponseBody</p>
 */
public class DsgGetVisitStatResponseBody extends TeaModel {
    ...
    private DsgGetVisitStatResponseBody(Builder builder) {
    ...
    public static DsgGetVisitStatResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DsgGetVisitStatResponseBody model) {
        ...
        public DsgGetVisitStatResponseBody build() {
            return new DsgGetVisitStatResponseBody(this);
        } 
