...
/**
 * 
 * {@link QuerySensNodeInfoResponseBody} extends {@link TeaModel}
 *
 * <p>QuerySensNodeInfoResponseBody</p>
 */
public class QuerySensNodeInfoResponseBody extends TeaModel {
    ...
    private QuerySensNodeInfoResponseBody(Builder builder) {
    ...
    public static QuerySensNodeInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QuerySensNodeInfoResponseBody model) {
        ...
        public QuerySensNodeInfoResponseBody build() {
            return new QuerySensNodeInfoResponseBody(this);
        } 
