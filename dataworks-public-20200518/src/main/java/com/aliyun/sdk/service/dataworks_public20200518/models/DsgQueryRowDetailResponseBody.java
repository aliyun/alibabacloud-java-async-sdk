...
/**
 * 
 * {@link DsgQueryRowDetailResponseBody} extends {@link TeaModel}
 *
 * <p>DsgQueryRowDetailResponseBody</p>
 */
public class DsgQueryRowDetailResponseBody extends TeaModel {
    ...
    private DsgQueryRowDetailResponseBody(Builder builder) {
    ...
    public static DsgQueryRowDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DsgQueryRowDetailResponseBody model) {
        ...
        public DsgQueryRowDetailResponseBody build() {
            return new DsgQueryRowDetailResponseBody(this);
        } 
