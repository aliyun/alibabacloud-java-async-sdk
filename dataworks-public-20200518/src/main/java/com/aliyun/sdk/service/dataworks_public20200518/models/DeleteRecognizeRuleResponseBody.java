...
public class DeleteRecognizeRuleResponseBody extends TeaModel {
    ...
    private DeleteRecognizeRuleResponseBody(Builder builder) {
    ...
    public static DeleteRecognizeRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteRecognizeRuleResponseBody model) {
        ...
        public DeleteRecognizeRuleResponseBody build() {
            return new DeleteRecognizeRuleResponseBody(this);
        } 
