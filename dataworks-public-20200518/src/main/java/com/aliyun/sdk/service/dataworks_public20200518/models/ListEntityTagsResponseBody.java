...
public class ListEntityTagsResponseBody extends TeaModel {
    ...
    public static ListEntityTagsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListEntityTagsResponseBody model) {
        ...
        public ListEntityTagsResponseBody build() {
            return new ListEntityTagsResponseBody(this);
        } 
