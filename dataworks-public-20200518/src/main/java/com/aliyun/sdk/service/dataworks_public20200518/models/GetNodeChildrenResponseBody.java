...
public class GetNodeChildrenResponseBody extends TeaModel {
    ...
    public static class Nodes extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * <p>The CRON expression. The expression is used for timed scheduling to execute the node task.</p>
             * 
             * <strong>example:</strong>
             * <p>00 00 * * * *</p>
             */
             ...
             * <li>MANUAL: manual node. The node is not scheduled on a regular basis.</li>
             * <li>PAUSE: paused node. The node is scheduled on a regular basis but is set to failed when scheduling starts.</li>
             * <li>SKIP: dry-run node. The node is scheduled on a regular basis but is set to successful when scheduling starts.</li>
             * </ul>
             * 
             * <strong>example:</strong>
             * <p>NORMAL</p>
