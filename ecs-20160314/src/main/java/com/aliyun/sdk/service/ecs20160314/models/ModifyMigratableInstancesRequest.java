...
/**
 * {@link ModifyMigratableInstancesRequest} extends {@link RequestModel}
 *
 * <p>ModifyMigratableInstancesRequest</p>
 */
public class ModifyMigratableInstancesRequest extends Request {
    @Query
    ...
    private ModifyMigratableInstancesRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyMigratableInstancesRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyMigratableInstancesRequest, Builder> {
        private Integer businessMigrationType; 
        private java.util.List < String > instanceId; 
        private Integer networkMigrationType; 
        private Long ownerId; 
        ...
        @Override
        public ModifyMigratableInstancesRequest build() {
            return new ModifyMigratableInstancesRequest(this);
        } 
