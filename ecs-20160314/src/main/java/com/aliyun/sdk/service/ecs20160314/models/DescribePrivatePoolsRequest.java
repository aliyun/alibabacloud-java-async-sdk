...
/**
 * {@link DescribePrivatePoolsRequest} extends {@link RequestModel}
 *
...
public class DescribePrivatePoolsRequest extends Request {
    ...
    public static DescribePrivatePoolsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribePrivatePoolsRequest, Builder> {
        ...
        public Builder startTimeType(String startTimeType) {
            this.putQueryParameter("StartTimeType", startTimeType);
        ...
        @Override
        public DescribePrivatePoolsRequest build() {
            return new DescribePrivatePoolsRequest(this);
        } 
