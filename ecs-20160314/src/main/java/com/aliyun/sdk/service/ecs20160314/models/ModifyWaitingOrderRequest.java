...
/**
 * {@link ModifyWaitingOrderRequest} extends {@link RequestModel}
 *
 * <p>ModifyWaitingOrderRequest</p>
 */
public class ModifyWaitingOrderRequest extends Request {
    @Query
    ...
    private ModifyWaitingOrderRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyWaitingOrderRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyWaitingOrderRequest, Builder> {
        private String clientToken; 
        private Long instanceAmount; 
        private String ownerAccount; 
        private String regionId; 
        ...
        @Override
        public ModifyWaitingOrderRequest build() {
            return new ModifyWaitingOrderRequest(this);
        } 
