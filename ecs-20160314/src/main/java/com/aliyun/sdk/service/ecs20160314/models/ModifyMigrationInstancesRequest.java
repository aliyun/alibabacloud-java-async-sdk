...
/**
 * {@link ModifyMigrationInstancesRequest} extends {@link RequestModel}
 *
 * <p>ModifyMigrationInstancesRequest</p>
 */
public class ModifyMigrationInstancesRequest extends Request {
    @Query
    ...
    private ModifyMigrationInstancesRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyMigrationInstancesRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyMigrationInstancesRequest, Builder> {
        private String globalMigrationTime; 
        private java.util.List < String > instanceId; 
        private String networkMigrationType; 
        private Long ownerId; 
        ...
        private Builder(ModifyMigrationInstancesRequest request) {
            super(request);
        ...
        @Override
        public ModifyMigrationInstancesRequest build() {
            return new ModifyMigrationInstancesRequest(this);
        } 
