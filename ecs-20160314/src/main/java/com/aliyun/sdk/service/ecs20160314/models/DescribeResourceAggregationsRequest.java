...
/**
 * {@link DescribeResourceAggregationsRequest} extends {@link RequestModel}
 *
 * <p>DescribeResourceAggregationsRequest</p>
 */
public class DescribeResourceAggregationsRequest extends Request {
    @Query
    @NameInMap("Aggregators")
    @Validation(required = true)
    private java.util.List < String > aggregators;
    ...
    private DescribeResourceAggregationsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeResourceAggregationsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeResourceAggregationsRequest, Builder> {
        private java.util.List < String > aggregators; 
        private java.util.List < Filter> filter; 
        private String global; 
        private String keyword; 
         ...
         * Aggregators.
         */
        public Builder aggregators(java.util.List < String > aggregators) {
            this.putQueryParameter("Aggregators", aggregators);
        ...
        @Override
        public DescribeResourceAggregationsRequest build() {
            return new DescribeResourceAggregationsRequest(this);
        } 
