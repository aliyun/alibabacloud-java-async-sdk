...
/**
 * {@link InnerDescribeNetworkInterfaceInGroupResponseBody} extends {@link TeaModel}
 *
 * <p>InnerDescribeNetworkInterfaceInGroupResponseBody</p>
 */
public class InnerDescribeNetworkInterfaceInGroupResponseBody extends TeaModel {
    ...
    private InnerDescribeNetworkInterfaceInGroupResponseBody(Builder builder) {
    ...
    public static InnerDescribeNetworkInterfaceInGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        public InnerDescribeNetworkInterfaceInGroupResponseBody build() {
            return new InnerDescribeNetworkInterfaceInGroupResponseBody(this);
        } 
