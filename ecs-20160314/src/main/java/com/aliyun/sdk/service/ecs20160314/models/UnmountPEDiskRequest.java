...
/**
 * {@link UnmountPEDiskRequest} extends {@link RequestModel}
 *
...
public class UnmountPEDiskRequest extends Request {
    ...
    public static UnmountPEDiskRequest create() {
    ...
    public static final class Builder extends Request.Builder<UnmountPEDiskRequest, Builder> {
        ...
        @Override
        public UnmountPEDiskRequest build() {
            return new UnmountPEDiskRequest(this);
        } 
