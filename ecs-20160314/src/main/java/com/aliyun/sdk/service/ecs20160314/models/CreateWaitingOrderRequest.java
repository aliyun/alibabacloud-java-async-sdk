...
/**
 * {@link CreateWaitingOrderRequest} extends {@link RequestModel}
 *
...
public class CreateWaitingOrderRequest extends Request {
    ...
    private CreateWaitingOrderRequest(Builder builder) {
        super(builder);
    ...
    public static CreateWaitingOrderRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateWaitingOrderRequest, Builder> {
        private CpuOptions cpuOptions; 
        private HibernationOptions hibernationOptions; 
        private PrivatePoolOptions privatePoolOptions; 
        private SchedulerOptions schedulerOptions; 
        ...
        @Override
        public CreateWaitingOrderRequest build() {
            return new CreateWaitingOrderRequest(this);
        } 
