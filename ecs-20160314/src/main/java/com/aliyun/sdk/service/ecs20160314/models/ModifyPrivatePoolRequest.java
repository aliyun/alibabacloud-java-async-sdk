...
/**
 * {@link ModifyPrivatePoolRequest} extends {@link RequestModel}
 *
...
public class ModifyPrivatePoolRequest extends Request {
    ...
    private ModifyPrivatePoolRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyPrivatePoolRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyPrivatePoolRequest, Builder> {
        private PrivatePoolOptions privatePoolOptions; 
        private String description; 
        private String endTime; 
        private String endTimeType; 
        ...
        @Override
        public ModifyPrivatePoolRequest build() {
            return new ModifyPrivatePoolRequest(this);
        } 
