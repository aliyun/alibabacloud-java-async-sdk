...
/**
 * {@link ModifyReservationDemandRequest} extends {@link RequestModel}
 *
 * <p>ModifyReservationDemandRequest</p>
 */
public class ModifyReservationDemandRequest extends Request {
    @Query
    ...
    private ModifyReservationDemandRequest(Builder builder) {
        super(builder);
        ...
        this.reservedInstanceGroupId = builder.reservedInstanceGroupId;
    ...
    public static ModifyReservationDemandRequest create() {
    ...
    /**
     * @return reservedInstanceGroupId
     */
    ...
    public static final class Builder extends Request.Builder<ModifyReservationDemandRequest, Builder> {
        private String clientToken; 
        private String confirmType; 
        private Boolean couponAuto; 
        private String couponType; 
        ...
        private Builder(ModifyReservationDemandRequest response) {
            super(response);
            ...
            this.reservedInstanceGroupId = response.reservedInstanceGroupId;
        ...
        /**
         * ReservedInstanceGroupId.
         */
        public Builder reservedInstanceGroupId(String reservedInstanceGroupId) {
            this.putQueryParameter("ReservedInstanceGroupId", reservedInstanceGroupId);
        ...
        @Override
        public ModifyReservationDemandRequest build() {
            return new ModifyReservationDemandRequest(this);
        } 
