...
public class RunInstancesRequest extends Request {
    ...
    private java.util.List < SecurityGroupRule> securityGroupRule;
    ...
    private RunInstancesRequest(Builder builder) {
        ...
        this.recycleBinResourceId = builder.recycleBinResourceId;
        this.regionId = builder.regionId;
        this.relationOrderId = builder.relationOrderId;
    ...
    public static final class Builder extends Request.Builder<RunInstancesRequest, Builder> {
        ...
        public Builder maxAmount(Integer maxAmount) {
            this.putQueryParameter("MaxAmount", maxAmount);
         ...
         */
        public Builder recycleBinResourceId(String recycleBinResourceId) {
            this.putQueryParameter("RecycleBinResourceId", recycleBinResourceId);
         ...
         * RelationOrderId.
         */
        public Builder relationOrderId(String relationOrderId) {
            this.putQueryParameter("RelationOrderId", relationOrderId);
         ...
         * SecurityGroupRule.
         */
        public Builder securityGroupRule(java.util.List < SecurityGroupRule> securityGroupRule) {
            this.putQueryParameter("SecurityGroupRule", securityGroupRule);
