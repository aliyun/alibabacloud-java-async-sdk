...
/**
 * 
 * {@link RecoverAppRequest} extends {@link RequestModel}
 *
 * <p>RecoverAppRequest</p>
 */
public class RecoverAppRequest extends Request {
    ...
    private RecoverAppRequest(Builder builder) {
        super(builder);
    ...
    public static RecoverAppRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<RecoverAppRequest, Builder> {
        private java.util.List<String> androidInstanceIdList; 
        private String backupFileId; 
        private String backupFilePath; 
        private String uploadEndpoint; 
        ...
        private Builder(RecoverAppRequest request) {
            super(request);
        ...
        @Override
        public RecoverAppRequest build() {
            return new RecoverAppRequest(this);
        } 
