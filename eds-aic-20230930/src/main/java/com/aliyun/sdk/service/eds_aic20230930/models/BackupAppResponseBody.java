...
/**
 * 
 * {@link BackupAppResponseBody} extends {@link TeaModel}
 *
 * <p>BackupAppResponseBody</p>
 */
public class BackupAppResponseBody extends TeaModel {
    ...
    private BackupAppResponseBody(Builder builder) {
    ...
    public static BackupAppResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BackupAppResponseBody model) {
        ...
        public BackupAppResponseBody build() {
            return new BackupAppResponseBody(this);
        } 
