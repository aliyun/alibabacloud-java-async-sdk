...
/**
 * 
 * {@link BackupAndroidInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>BackupAndroidInstanceResponseBody</p>
 */
public class BackupAndroidInstanceResponseBody extends TeaModel {
    ...
    private BackupAndroidInstanceResponseBody(Builder builder) {
    ...
    public static BackupAndroidInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BackupAndroidInstanceResponseBody model) {
        ...
        public BackupAndroidInstanceResponseBody build() {
            return new BackupAndroidInstanceResponseBody(this);
        } 
