...
/**
 * 
 * {@link GetNetworkMinuteTrendResponseBody} extends {@link TeaModel}
 *
 * <p>GetNetworkMinuteTrendResponseBody</p>
 */
public class GetNetworkMinuteTrendResponseBody extends TeaModel {
    ...
    private GetNetworkMinuteTrendResponseBody(Builder builder) {
    ...
    public static GetNetworkMinuteTrendResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetNetworkMinuteTrendResponseBody build() {
            return new GetNetworkMinuteTrendResponseBody(this);
        } 
