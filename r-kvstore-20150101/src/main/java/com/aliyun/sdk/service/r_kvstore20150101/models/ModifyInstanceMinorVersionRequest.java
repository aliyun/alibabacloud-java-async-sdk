...
public class ModifyInstanceMinorVersionRequest extends Request {
    ...
    public static ModifyInstanceMinorVersionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyInstanceMinorVersionRequest, Builder> {
        private String regionId; 
        private String effectiveTime; 
        private String instanceId; 
        private String minorversion; 
        ...
        private Builder(ModifyInstanceMinorVersionRequest request) {
            super(request);
        ...
        @Override
        public ModifyInstanceMinorVersionRequest build() {
            return new ModifyInstanceMinorVersionRequest(this);
        } 
