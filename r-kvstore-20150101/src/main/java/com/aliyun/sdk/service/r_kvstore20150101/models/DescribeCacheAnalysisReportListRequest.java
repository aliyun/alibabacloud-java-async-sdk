 ...
 */
public class DescribeCacheAnalysisReportListRequest extends Request {
    ...
    private DescribeCacheAnalysisReportListRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeCacheAnalysisReportListRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeCacheAnalysisReportListRequest, Builder> {
        private String regionId; 
        private Integer days; 
        private String instanceId; 
        private String nodeId; 
        ...
        private Builder(DescribeCacheAnalysisReportListRequest request) {
            super(request);
        ...
        @Override
        public DescribeCacheAnalysisReportListRequest build() {
            return new DescribeCacheAnalysisReportListRequest(this);
        } 
