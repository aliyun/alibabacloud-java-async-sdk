...
/**
 * 
 * {@link UpgradeProxyRequest} extends {@link RequestModel}
 *
 * <p>UpgradeProxyRequest</p>
 */
public class UpgradeProxyRequest extends Request {
    ...
    private UpgradeProxyRequest(Builder builder) {
        super(builder);
    ...
    public static UpgradeProxyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpgradeProxyRequest, Builder> {
        private String regionId; 
        private String instanceId; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(UpgradeProxyRequest request) {
            super(request);
         ...
         * <p>Immediately</p>
         */
        public Builder switchTimeMode(Integer switchTimeMode) {
        ...
        @Override
        public UpgradeProxyRequest build() {
            return new UpgradeProxyRequest(this);
        } 
