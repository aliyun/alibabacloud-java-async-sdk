 ...
 */
public class ModifyInstanceMajorVersionRequest extends Request {
    ...
    private ModifyInstanceMajorVersionRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyInstanceMajorVersionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyInstanceMajorVersionRequest, Builder> {
        private String regionId; 
        private String effectiveTime; 
        private String instanceId; 
        private String majorVersion; 
        ...
        private Builder(ModifyInstanceMajorVersionRequest request) {
            super(request);
        ...
        @Override
        public ModifyInstanceMajorVersionRequest build() {
            return new ModifyInstanceMajorVersionRequest(this);
        } 
