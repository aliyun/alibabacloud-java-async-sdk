...
/**
 * 
 * {@link PrepaidTextTranslateResponseBody} extends {@link TeaModel}
 *
 * <p>PrepaidTextTranslateResponseBody</p>
 */
public class PrepaidTextTranslateResponseBody extends TeaModel {
    ...
    private PrepaidTextTranslateResponseBody(Builder builder) {
    ...
    public static PrepaidTextTranslateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PrepaidTextTranslateResponseBody model) {
        ...
        public PrepaidTextTranslateResponseBody build() {
            return new PrepaidTextTranslateResponseBody(this);
        } 
