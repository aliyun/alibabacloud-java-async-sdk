...
/**
 * 
 * {@link LanguageDetectResponseBody} extends {@link TeaModel}
 *
 * <p>LanguageDetectResponseBody</p>
 */
public class LanguageDetectResponseBody extends TeaModel {
    ...
    private LanguageDetectResponseBody(Builder builder) {
    ...
    public static LanguageDetectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(LanguageDetectResponseBody model) {
        ...
        public LanguageDetectResponseBody build() {
            return new LanguageDetectResponseBody(this);
        } 
