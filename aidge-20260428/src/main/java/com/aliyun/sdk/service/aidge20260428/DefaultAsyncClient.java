...
public final class DefaultAsyncClient implements AsyncClient {
     ...
     * </tbody></table>
     * 
     * @param request the request parameters of AiTryOn  AiTryOnRequest
     * @return AiTryOnResponse
     */
    @Override
    public CompletableFuture<AiTryOnResponse> aiTryOn(AiTryOnRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("AiTryOn").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(AiTryOnResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<AiTryOnResponse> future = new CompletableFuture<>();
     ...
     * </ul>
     * 
     * @param request the request parameters of DiduiAreaDeductionPro  DiduiAreaDeductionProRequest
     * @return DiduiAreaDeductionProResponse
     */
    @Override
    public CompletableFuture<DiduiAreaDeductionProResponse> diduiAreaDeductionPro(DiduiAreaDeductionProRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("DiduiAreaDeductionPro").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(DiduiAreaDeductionProResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<DiduiAreaDeductionProResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * </ol>
     * 
     * @param request the request parameters of GeneralRephotographyDetection  GeneralRephotographyDetectionRequest
     * @return GeneralRephotographyDetectionResponse
     */
    @Override
    public CompletableFuture<GeneralRephotographyDetectionResponse> generalRephotographyDetection(GeneralRephotographyDetectionRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("GeneralRephotographyDetection").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GeneralRephotographyDetectionResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<GeneralRephotographyDetectionResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * </ul>
     * 
     * @param request the request parameters of MerchandisePlacementDetectionPro  MerchandisePlacementDetectionProRequest
     * @return MerchandisePlacementDetectionProResponse
     */
    @Override
    public CompletableFuture<MerchandisePlacementDetectionProResponse> merchandisePlacementDetectionPro(MerchandisePlacementDetectionProRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("MerchandisePlacementDetectionPro").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(MerchandisePlacementDetectionProResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<MerchandisePlacementDetectionProResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * </ol>
     * 
     * @param request the request parameters of PetHealthAnalysis  PetHealthAnalysisRequest
     * @return PetHealthAnalysisResponse
     */
    @Override
    public CompletableFuture<PetHealthAnalysisResponse> petHealthAnalysis(PetHealthAnalysisRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("PetHealthAnalysis").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(PetHealthAnalysisResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<PetHealthAnalysisResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     */
    @Override
    public CompletableFuture<PrepaidTextTranslateResponse> prepaidTextTranslate(PrepaidTextTranslateRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("PrepaidTextTranslate").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(true).setReqBodyType(BodyType.FORM).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(PrepaidTextTranslateResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
    ...
    /**
     * @param request the request parameters of SubmitProductMatch  SubmitProductMatchRequest
     * @return SubmitProductMatchResponse
     */
    @Override
    public CompletableFuture<SubmitProductMatchResponse> submitProductMatch(SubmitProductMatchRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("SubmitProductMatch").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(SubmitProductMatchResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<SubmitProductMatchResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * </ul>
     * 
     * @param request the request parameters of VideoGeneration  VideoGenerationRequest
     * @return VideoGenerationResponse
     */
    @Override
    public CompletableFuture<VideoGenerationResponse> videoGeneration(VideoGenerationRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("VideoGeneration").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(VideoGenerationResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<VideoGenerationResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     */
    @Override
    public CompletableFuture<VideoTranslationResponse> videoTranslation(VideoTranslationRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("VideoTranslation").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(true).setReqBodyType(BodyType.FORM).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(VideoTranslationResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<VideoTranslationResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
     ...
     * </tbody></table>
     * 
     * @param request the request parameters of VirtualTryOn  VirtualTryOnRequest
     * @return VirtualTryOnResponse
     */
    @Override
    public CompletableFuture<VirtualTryOnResponse> virtualTryOn(VirtualTryOnRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RPC).setAction("VirtualTryOn").setMethod(HttpMethod.POST).setPathRegex("/").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(VirtualTryOnResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<VirtualTryOnResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
