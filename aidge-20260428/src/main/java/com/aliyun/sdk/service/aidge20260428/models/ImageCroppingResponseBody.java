...
/**
 * 
 * {@link ImageCroppingResponseBody} extends {@link TeaModel}
 *
 * <p>ImageCroppingResponseBody</p>
 */
public class ImageCroppingResponseBody extends TeaModel {
    ...
    private ImageCroppingResponseBody(Builder builder) {
    ...
    public static ImageCroppingResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ImageCroppingResponseBody model) {
        ...
        public ImageCroppingResponseBody build() {
            return new ImageCroppingResponseBody(this);
        } 
