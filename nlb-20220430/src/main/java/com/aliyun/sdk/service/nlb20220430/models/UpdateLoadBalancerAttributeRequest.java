...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateLoadBalancerAttributeRequest, Builder> {
        ...
        /**
         * <p>The maximum number of new connections per second in each zone supported by the NLB instance (virtual IP address). Valid values: <strong>1</strong> to <strong>1000000</strong>.</p>
         * 
         * <strong>example:</strong>
         * <p>1</p>
         */
