 ...
 */
public class DeleteVirtualNodeRequest extends Request {
    ...
    private DeleteVirtualNodeRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteVirtualNodeRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteVirtualNodeRequest, Builder> {
        private String clientToken; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(DeleteVirtualNodeRequest request) {
            super(request);
        ...
        @Override
        public DeleteVirtualNodeRequest build() {
            return new DeleteVirtualNodeRequest(this);
        } 
