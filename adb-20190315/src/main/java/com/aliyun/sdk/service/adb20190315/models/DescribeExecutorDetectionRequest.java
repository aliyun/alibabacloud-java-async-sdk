...
/**
 * 
 * {@link DescribeExecutorDetectionRequest} extends {@link RequestModel}
 *
 * <p>DescribeExecutorDetectionRequest</p>
 */
public class DescribeExecutorDetectionRequest extends Request {
    ...
    private DescribeExecutorDetectionRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeExecutorDetectionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeExecutorDetectionRequest, Builder> {
        private String DBClusterId; 
        private String endTime; 
        private String lang; 
        private String ownerAccount; 
        ...
        private Builder(DescribeExecutorDetectionRequest request) {
            super(request);
        ...
        @Override
        public DescribeExecutorDetectionRequest build() {
            return new DescribeExecutorDetectionRequest(this);
        } 
