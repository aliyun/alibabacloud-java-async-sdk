...
public class BindDBResourcePoolWithUserRequest extends Request {
    ...
    public static BindDBResourcePoolWithUserRequest create() {
    ...
    public static final class Builder extends Request.Builder<BindDBResourcePoolWithUserRequest, Builder> {
        ...
        private Builder(BindDBResourcePoolWithUserRequest response) {
            super(response);
        ...
        @Override
        public BindDBResourcePoolWithUserRequest build() {
            return new BindDBResourcePoolWithUserRequest(this);
        } 
