...
public class DescribeBackupsRequest extends Request {
    ...
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("CrossRole")
    private String crossRole;

    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("CrossUid")
    ...
    private DescribeBackupsRequest(Builder builder) {
        ...
        this.crossRole = builder.crossRole;
        this.crossUid = builder.crossUid;
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeBackupsRequest, Builder> {
        ...
        private Builder(DescribeBackupsRequest request) {
            ...
            this.crossRole = request.crossRole;
            this.crossUid = request.crossUid;
         ...
         * <p>role-for-xxx</p>
         */
        public Builder crossRole(String crossRole) {
            this.putQueryParameter("CrossRole", crossRole);
         ...
         * <p>195****</p>
         */
        public Builder crossUid(String crossUid) {
            this.putQueryParameter("CrossUid", crossUid);
