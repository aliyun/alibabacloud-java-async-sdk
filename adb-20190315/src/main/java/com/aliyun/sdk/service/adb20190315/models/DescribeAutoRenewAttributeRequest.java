...
/**
 * {@link DescribeAutoRenewAttributeRequest} extends {@link RequestModel}
 *
 * <p>DescribeAutoRenewAttributeRequest</p>
 */
public class DescribeAutoRenewAttributeRequest extends Request {
    ...
    public static DescribeAutoRenewAttributeRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeAutoRenewAttributeRequest, Builder> {
        ...
        private Builder(DescribeAutoRenewAttributeRequest response) {
            super(response);
        ...
        @Override
        public DescribeAutoRenewAttributeRequest build() {
            return new DescribeAutoRenewAttributeRequest(this);
        } 
