...
/**
 * 
 * {@link DescribeAbnormalPatternDetectionRequest} extends {@link RequestModel}
 *
 * <p>DescribeAbnormalPatternDetectionRequest</p>
 */
public class DescribeAbnormalPatternDetectionRequest extends Request {
    ...
    private DescribeAbnormalPatternDetectionRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeAbnormalPatternDetectionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeAbnormalPatternDetectionRequest, Builder> {
        private String DBClusterId; 
        private String endTime; 
        private String lang; 
        private String ownerAccount; 
        ...
        private Builder(DescribeAbnormalPatternDetectionRequest request) {
            super(request);
        ...
        @Override
        public DescribeAbnormalPatternDetectionRequest build() {
            return new DescribeAbnormalPatternDetectionRequest(this);
        } 
