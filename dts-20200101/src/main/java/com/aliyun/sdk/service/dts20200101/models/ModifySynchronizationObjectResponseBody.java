...
public class ModifySynchronizationObjectResponseBody extends TeaModel {
    ...
    private ModifySynchronizationObjectResponseBody(Builder builder) {
    ...
    public static ModifySynchronizationObjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifySynchronizationObjectResponseBody build() {
            return new ModifySynchronizationObjectResponseBody(this);
        } 
