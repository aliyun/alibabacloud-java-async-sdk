...
/**
 * 
 * {@link DeleteDtsJobsResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteDtsJobsResponseBody</p>
 */
public class DeleteDtsJobsResponseBody extends TeaModel {
    ...
    private DeleteDtsJobsResponseBody(Builder builder) {
    ...
    public static DeleteDtsJobsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteDtsJobsResponseBody model) {
        ...
        public DeleteDtsJobsResponseBody build() {
            return new DeleteDtsJobsResponseBody(this);
        } 
