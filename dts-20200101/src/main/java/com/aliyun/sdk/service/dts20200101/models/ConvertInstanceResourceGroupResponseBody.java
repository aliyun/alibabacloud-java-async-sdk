...
/**
 * 
 * {@link ConvertInstanceResourceGroupResponseBody} extends {@link TeaModel}
 *
 * <p>ConvertInstanceResourceGroupResponseBody</p>
 */
public class ConvertInstanceResourceGroupResponseBody extends TeaModel {
    ...
    private ConvertInstanceResourceGroupResponseBody(Builder builder) {
    ...
    public static ConvertInstanceResourceGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ConvertInstanceResourceGroupResponseBody model) {
        ...
        public ConvertInstanceResourceGroupResponseBody build() {
            return new ConvertInstanceResourceGroupResponseBody(this);
        } 
