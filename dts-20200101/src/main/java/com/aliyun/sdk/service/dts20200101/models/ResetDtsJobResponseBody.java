...
/**
 * 
 * {@link ResetDtsJobResponseBody} extends {@link TeaModel}
 *
 * <p>ResetDtsJobResponseBody</p>
 */
public class ResetDtsJobResponseBody extends TeaModel {
    ...
    private ResetDtsJobResponseBody(Builder builder) {
    ...
    public static ResetDtsJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResetDtsJobResponseBody model) {
        ...
        public ResetDtsJobResponseBody build() {
            return new ResetDtsJobResponseBody(this);
        } 
