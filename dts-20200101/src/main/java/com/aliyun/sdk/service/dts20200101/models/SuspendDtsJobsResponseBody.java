...
/**
 * 
 * {@link SuspendDtsJobsResponseBody} extends {@link TeaModel}
 *
 * <p>SuspendDtsJobsResponseBody</p>
 */
public class SuspendDtsJobsResponseBody extends TeaModel {
    ...
    private SuspendDtsJobsResponseBody(Builder builder) {
    ...
    public static SuspendDtsJobsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SuspendDtsJobsResponseBody model) {
        ...
        public SuspendDtsJobsResponseBody build() {
            return new SuspendDtsJobsResponseBody(this);
        } 
