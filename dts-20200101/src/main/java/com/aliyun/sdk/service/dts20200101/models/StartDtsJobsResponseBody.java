...
/**
 * 
 * {@link StartDtsJobsResponseBody} extends {@link TeaModel}
 *
 * <p>StartDtsJobsResponseBody</p>
 */
public class StartDtsJobsResponseBody extends TeaModel {
    ...
    private StartDtsJobsResponseBody(Builder builder) {
    ...
    public static StartDtsJobsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartDtsJobsResponseBody model) {
        ...
        public StartDtsJobsResponseBody build() {
            return new StartDtsJobsResponseBody(this);
        } 
