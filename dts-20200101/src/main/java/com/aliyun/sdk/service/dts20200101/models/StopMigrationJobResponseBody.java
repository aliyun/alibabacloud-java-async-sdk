...
/**
 * 
 * {@link StopMigrationJobResponseBody} extends {@link TeaModel}
 *
 * <p>StopMigrationJobResponseBody</p>
 */
public class StopMigrationJobResponseBody extends TeaModel {
    ...
    private StopMigrationJobResponseBody(Builder builder) {
    ...
    public static StopMigrationJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StopMigrationJobResponseBody model) {
        ...
        public StopMigrationJobResponseBody build() {
            return new StopMigrationJobResponseBody(this);
        } 
