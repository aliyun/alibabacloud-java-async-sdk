...
/**
 * 
 * {@link ModifyDynamicConfigResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyDynamicConfigResponseBody</p>
 */
public class ModifyDynamicConfigResponseBody extends TeaModel {
    ...
    private ModifyDynamicConfigResponseBody(Builder builder) {
    ...
    public static ModifyDynamicConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyDynamicConfigResponseBody model) {
        ...
        public ModifyDynamicConfigResponseBody build() {
            return new ModifyDynamicConfigResponseBody(this);
        } 
