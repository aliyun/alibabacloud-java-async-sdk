 ...
 */
public class GetTimeMachineTaskResponseBody extends TeaModel {
    ...
    private GetTimeMachineTaskResponseBody(Builder builder) {
    ...
    public static GetTimeMachineTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetTimeMachineTaskResponseBody build() {
            return new GetTimeMachineTaskResponseBody(this);
        } 
