...
/**
 * 
 * {@link QueryMemoryConfigResponseBody} extends {@link TeaModel}
 *
 * <p>QueryMemoryConfigResponseBody</p>
 */
public class QueryMemoryConfigResponseBody extends TeaModel {
    ...
    private QueryMemoryConfigResponseBody(Builder builder) {
    ...
    public static QueryMemoryConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryMemoryConfigResponseBody model) {
        ...
        public QueryMemoryConfigResponseBody build() {
            return new QueryMemoryConfigResponseBody(this);
        } 
