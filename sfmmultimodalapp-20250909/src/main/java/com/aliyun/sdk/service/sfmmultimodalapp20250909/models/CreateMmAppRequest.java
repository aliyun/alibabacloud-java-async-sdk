...
/**
 * 
 * {@link CreateMmAppRequest} extends {@link RequestModel}
 *
 * <p>CreateMmAppRequest</p>
 */
public class CreateMmAppRequest extends Request {
    ...
    private CreateMmAppRequest(Builder builder) {
        super(builder);
    ...
    public static CreateMmAppRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateMmAppRequest, Builder> {
        private String appName; 
        private BindingConfig bindingConfig; 
        private ConversationConfig conversationConfig; 
        private ModelConfig modelConfig; 
        ...
        private Builder(CreateMmAppRequest request) {
            super(request);
        ...
        @Override
        public CreateMmAppRequest build() {
            return new CreateMmAppRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateMmAppRequest} extends {@link TeaModel}
     *
     * <p>CreateMmAppRequest</p>
     */
