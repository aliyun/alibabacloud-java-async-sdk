...
/**
 * 
 * {@link ListLivyComputeTokenRequest} extends {@link RequestModel}
 *
 * <p>ListLivyComputeTokenRequest</p>
 */
public class ListLivyComputeTokenRequest extends Request {
    ...
    private ListLivyComputeTokenRequest(Builder builder) {
        super(builder);
    ...
    public static ListLivyComputeTokenRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListLivyComputeTokenRequest, Builder> {
        private String workspaceBizId; 
        private String livyComputeId; 
        private String regionId; 
        ...
        private Builder(ListLivyComputeTokenRequest request) {
            super(request);
        ...
        @Override
        public ListLivyComputeTokenRequest build() {
            return new ListLivyComputeTokenRequest(this);
        } 
