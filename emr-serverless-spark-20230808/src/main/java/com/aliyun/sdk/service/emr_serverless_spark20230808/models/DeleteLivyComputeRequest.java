...
/**
 * 
 * {@link DeleteLivyComputeRequest} extends {@link RequestModel}
 *
 * <p>DeleteLivyComputeRequest</p>
 */
public class DeleteLivyComputeRequest extends Request {
    ...
    private DeleteLivyComputeRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteLivyComputeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteLivyComputeRequest, Builder> {
        private String workspaceBizId; 
        private String livyComputeId; 
        private String regionId; 
        ...
        private Builder(DeleteLivyComputeRequest request) {
            super(request);
        ...
        @Override
        public DeleteLivyComputeRequest build() {
            return new DeleteLivyComputeRequest(this);
        } 
