...
/**
 * 
 * {@link CreateRayClusterRequest} extends {@link RequestModel}
 *
 * <p>CreateRayClusterRequest</p>
 */
public class CreateRayClusterRequest extends Request {
    ...
    private CreateRayClusterRequest(Builder builder) {
        super(builder);
    ...
    public static CreateRayClusterRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateRayClusterRequest, Builder> {
        private String workspaceId; 
        private String description; 
        private String displayReleaseVersion; 
        private String extraParam; 
        ...
        private Builder(CreateRayClusterRequest request) {
            super(request);
        ...
        @Override
        public CreateRayClusterRequest build() {
            return new CreateRayClusterRequest(this);
        } 
