...
/**
 * 
 * {@link StopLivyComputeRequest} extends {@link RequestModel}
 *
 * <p>StopLivyComputeRequest</p>
 */
public class StopLivyComputeRequest extends Request {
    ...
    private StopLivyComputeRequest(Builder builder) {
        super(builder);
    ...
    public static StopLivyComputeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<StopLivyComputeRequest, Builder> {
        private String workspaceBizId; 
        private String livyComputeId; 
        private String regionId; 
        ...
        private Builder(StopLivyComputeRequest request) {
            super(request);
        ...
        @Override
        public StopLivyComputeRequest build() {
            return new StopLivyComputeRequest(this);
        } 
