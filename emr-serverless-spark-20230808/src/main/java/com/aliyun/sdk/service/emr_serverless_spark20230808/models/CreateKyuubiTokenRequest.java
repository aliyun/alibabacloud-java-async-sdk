...
/**
 * 
 * {@link CreateKyuubiTokenRequest} extends {@link RequestModel}
 *
 * <p>CreateKyuubiTokenRequest</p>
 */
public class CreateKyuubiTokenRequest extends Request {
    ...
    private CreateKyuubiTokenRequest(Builder builder) {
        super(builder);
    ...
    public static CreateKyuubiTokenRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateKyuubiTokenRequest, Builder> {
        private String workspaceId; 
        private String kyuubiServiceId; 
        private AutoExpireConfiguration autoExpireConfiguration; 
        private java.util.List<String> memberArns; 
        ...
        private Builder(CreateKyuubiTokenRequest request) {
            super(request);
        ...
        @Override
        public CreateKyuubiTokenRequest build() {
            return new CreateKyuubiTokenRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateKyuubiTokenRequest} extends {@link TeaModel}
     *
     * <p>CreateKyuubiTokenRequest</p>
     */
