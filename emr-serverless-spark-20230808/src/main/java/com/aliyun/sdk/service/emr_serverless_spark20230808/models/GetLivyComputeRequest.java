...
/**
 * 
 * {@link GetLivyComputeRequest} extends {@link RequestModel}
 *
 * <p>GetLivyComputeRequest</p>
 */
public class GetLivyComputeRequest extends Request {
    ...
    private GetLivyComputeRequest(Builder builder) {
        super(builder);
    ...
    public static GetLivyComputeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetLivyComputeRequest, Builder> {
        private String workspaceBizId; 
        private String livyComputeId; 
        private String regionId; 
        ...
        private Builder(GetLivyComputeRequest request) {
            super(request);
        ...
        @Override
        public GetLivyComputeRequest build() {
            return new GetLivyComputeRequest(this);
        } 
