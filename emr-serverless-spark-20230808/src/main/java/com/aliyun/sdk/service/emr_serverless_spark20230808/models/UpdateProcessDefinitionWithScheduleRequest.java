...
/**
 * 
 * {@link UpdateProcessDefinitionWithScheduleRequest} extends {@link RequestModel}
 *
 * <p>UpdateProcessDefinitionWithScheduleRequest</p>
 */
public class UpdateProcessDefinitionWithScheduleRequest extends Request {
    ...
    private UpdateProcessDefinitionWithScheduleRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateProcessDefinitionWithScheduleRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateProcessDefinitionWithScheduleRequest, Builder> {
        private String bizId; 
        private Long code; 
        private String alertEmailAddress; 
        private String description; 
        ...
        private Builder(UpdateProcessDefinitionWithScheduleRequest request) {
            super(request);
            ...
            this.releaseState = request.releaseState;
        ...
        @Override
        public UpdateProcessDefinitionWithScheduleRequest build() {
            return new UpdateProcessDefinitionWithScheduleRequest(this);
        } 
