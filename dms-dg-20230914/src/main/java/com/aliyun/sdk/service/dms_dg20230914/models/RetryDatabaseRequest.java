...
/**
 * {@link RetryDatabaseRequest} extends {@link RequestModel}
 *
 * <p>RetryDatabaseRequest</p>
 */
public class RetryDatabaseRequest extends Request {
    ...
    private RetryDatabaseRequest(Builder builder) {
        super(builder);
    ...
    public static RetryDatabaseRequest create() {
    ...
    public static final class Builder extends Request.Builder<RetryDatabaseRequest, Builder> {
        private String clientToken; 
        private String dbDescription; 
        private String dbName; 
        private String dbPassword; 
        ...
        private Builder(RetryDatabaseRequest request) {
            super(request);
        ...
        @Override
        public RetryDatabaseRequest build() {
            return new RetryDatabaseRequest(this);
        } 
