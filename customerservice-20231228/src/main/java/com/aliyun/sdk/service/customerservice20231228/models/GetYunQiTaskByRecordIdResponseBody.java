...
/**
 * {@link GetYunQiTaskByRecordIdResponseBody} extends {@link TeaModel}
 *
 * <p>GetYunQiTaskByRecordIdResponseBody</p>
 */
public class GetYunQiTaskByRecordIdResponseBody extends TeaModel {
    ...
    private GetYunQiTaskByRecordIdResponseBody(Builder builder) {
    ...
    public static GetYunQiTaskByRecordIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetYunQiTaskByRecordIdResponseBody build() {
            return new GetYunQiTaskByRecordIdResponseBody(this);
        } 
