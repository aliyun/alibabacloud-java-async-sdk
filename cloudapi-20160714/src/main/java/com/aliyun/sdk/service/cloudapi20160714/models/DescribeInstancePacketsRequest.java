...
/**
 * 
 * {@link DescribeInstancePacketsRequest} extends {@link RequestModel}
 *
 * <p>DescribeInstancePacketsRequest</p>
 */
public class DescribeInstancePacketsRequest extends Request {
    ...
    private DescribeInstancePacketsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeInstancePacketsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeInstancePacketsRequest, Builder> {
        private String endTime; 
        private String instanceId; 
        private String sbcName; 
        private String securityToken; 
        ...
        private Builder(DescribeInstancePacketsRequest request) {
            super(request);
        ...
        @Override
        public DescribeInstancePacketsRequest build() {
            return new DescribeInstancePacketsRequest(this);
        } 
