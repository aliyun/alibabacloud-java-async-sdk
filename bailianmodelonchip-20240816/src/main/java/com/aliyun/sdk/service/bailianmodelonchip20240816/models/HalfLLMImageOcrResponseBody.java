...
/**
 * 
 * {@link HalfLLMImageOcrResponseBody} extends {@link TeaModel}
 *
 * <p>HalfLLMImageOcrResponseBody</p>
 */
public class HalfLLMImageOcrResponseBody extends TeaModel {
    ...
    private HalfLLMImageOcrResponseBody(Builder builder) {
    ...
    public static HalfLLMImageOcrResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(HalfLLMImageOcrResponseBody model) {
        ...
        public HalfLLMImageOcrResponseBody build() {
            return new HalfLLMImageOcrResponseBody(this);
        } 
