...
/**
 * 
 * {@link ActiveInteractionEuCreateResponseBody} extends {@link TeaModel}
 *
 * <p>ActiveInteractionEuCreateResponseBody</p>
 */
public class ActiveInteractionEuCreateResponseBody extends TeaModel {
    ...
    private ActiveInteractionEuCreateResponseBody(Builder builder) {
    ...
    public static ActiveInteractionEuCreateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ActiveInteractionEuCreateResponseBody model) {
        ...
        public ActiveInteractionEuCreateResponseBody build() {
            return new ActiveInteractionEuCreateResponseBody(this);
        } 
