...
/**
 * 
 * {@link HalfLLMImageChatResponseBody} extends {@link TeaModel}
 *
 * <p>HalfLLMImageChatResponseBody</p>
 */
public class HalfLLMImageChatResponseBody extends TeaModel {
    ...
    private HalfLLMImageChatResponseBody(Builder builder) {
    ...
    public static HalfLLMImageChatResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(HalfLLMImageChatResponseBody model) {
        ...
        public HalfLLMImageChatResponseBody build() {
            return new HalfLLMImageChatResponseBody(this);
        } 
