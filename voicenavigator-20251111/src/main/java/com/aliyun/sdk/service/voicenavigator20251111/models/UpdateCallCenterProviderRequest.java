...
/**
 * 
 * {@link UpdateCallCenterProviderRequest} extends {@link RequestModel}
 *
 * <p>UpdateCallCenterProviderRequest</p>
 */
public class UpdateCallCenterProviderRequest extends Request {
    ...
    private UpdateCallCenterProviderRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateCallCenterProviderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateCallCenterProviderRequest, Builder> {
        private String destination; 
        private String displayName; 
        private String extras; 
        private String instanceId; 
        ...
        private Builder(UpdateCallCenterProviderRequest request) {
            super(request);
        ...
        @Override
        public UpdateCallCenterProviderRequest build() {
            return new UpdateCallCenterProviderRequest(this);
        } 
