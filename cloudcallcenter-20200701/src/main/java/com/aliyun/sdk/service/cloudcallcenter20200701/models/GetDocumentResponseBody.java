...
/**
 * 
 * {@link GetDocumentResponseBody} extends {@link TeaModel}
 *
 * <p>GetDocumentResponseBody</p>
 */
public class GetDocumentResponseBody extends TeaModel {
    ...
    private GetDocumentResponseBody(Builder builder) {
    ...
    public static GetDocumentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetDocumentResponseBody model) {
        ...
        public GetDocumentResponseBody build() {
            return new GetDocumentResponseBody(this);
        } 
    ...
    public static class Data extends TeaModel {
        ...
        private java.util.Map<String, ?> document;
        ...
        public static final class Builder {
             ...
             * Document.
             */
            public Builder document(java.util.Map<String, ?> document) {
