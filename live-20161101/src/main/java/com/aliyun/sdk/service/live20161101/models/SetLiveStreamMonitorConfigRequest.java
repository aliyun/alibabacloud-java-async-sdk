...
/**
 * {@link SetLiveStreamMonitorConfigRequest} extends {@link RequestModel}
 *
 * <p>SetLiveStreamMonitorConfigRequest</p>
 */
public class SetLiveStreamMonitorConfigRequest extends Request {
    @Query
    @NameInMap("App")
    private String app;
    ...
    private SetLiveStreamMonitorConfigRequest(Builder builder) {
        super(builder);
    ...
    public static SetLiveStreamMonitorConfigRequest create() {
    ...
    public static final class Builder extends Request.Builder<SetLiveStreamMonitorConfigRequest, Builder> {
        private String app; 
        private String domain; 
        private String inputList; 
        private String monitorId; 
        ...
        private Builder(SetLiveStreamMonitorConfigRequest response) {
            super(response);
        ...
        @Override
        public SetLiveStreamMonitorConfigRequest build() {
            return new SetLiveStreamMonitorConfigRequest(this);
        } 
