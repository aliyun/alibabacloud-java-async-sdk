...
/**
 * 
 * {@link RestartTranscodeTaskRequest} extends {@link RequestModel}
 *
 * <p>RestartTranscodeTaskRequest</p>
 */
public class RestartTranscodeTaskRequest extends Request {
    ...
    private RestartTranscodeTaskRequest(Builder builder) {
        super(builder);
    ...
    public static RestartTranscodeTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<RestartTranscodeTaskRequest, Builder> {
        private String app; 
        private String pushDomain; 
        private String securityToken; 
        private String streamName; 
        ...
        private Builder(RestartTranscodeTaskRequest request) {
            super(request);
        ...
        @Override
        public RestartTranscodeTaskRequest build() {
            return new RestartTranscodeTaskRequest(this);
        } 
