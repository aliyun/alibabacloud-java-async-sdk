...
/**
 * 
 * {@link ListLiveTagResourcesRequest} extends {@link RequestModel}
 *
 * <p>ListLiveTagResourcesRequest</p>
 */
public class ListLiveTagResourcesRequest extends Request {
    ...
    private ListLiveTagResourcesRequest(Builder builder) {
        super(builder);
    ...
    public static ListLiveTagResourcesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListLiveTagResourcesRequest, Builder> {
        private String nextToken; 
        private Long ownerId; 
        private String regionId; 
        private java.util.List<String> resourceId; 
        ...
        private Builder(ListLiveTagResourcesRequest request) {
            super(request);
        ...
        @Override
        public ListLiveTagResourcesRequest build() {
            return new ListLiveTagResourcesRequest(this);
        } 
    ...
    /**
     * 
     * {@link ListLiveTagResourcesRequest} extends {@link TeaModel}
     *
     * <p>ListLiveTagResourcesRequest</p>
     */
