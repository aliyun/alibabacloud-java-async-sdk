...
public class DescribeLiveDomainMappingRequest extends Request {
    ...
    public static DescribeLiveDomainMappingRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeLiveDomainMappingRequest, Builder> {
        ...
        private Builder(DescribeLiveDomainMappingRequest response) {
            super(response);
        ...
        @Override
        public DescribeLiveDomainMappingRequest build() {
            return new DescribeLiveDomainMappingRequest(this);
        } 
