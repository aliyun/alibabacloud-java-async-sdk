...
/**
 * 
 * {@link DescribeLiveHttpsDomainListResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeLiveHttpsDomainListResponseBody</p>
 */
public class DescribeLiveHttpsDomainListResponseBody extends TeaModel {
    ...
    private DescribeLiveHttpsDomainListResponseBody(Builder builder) {
    ...
    public static DescribeLiveHttpsDomainListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeLiveHttpsDomainListResponseBody model) {
        ...
        public DescribeLiveHttpsDomainListResponseBody build() {
            return new DescribeLiveHttpsDomainListResponseBody(this);
        } 
