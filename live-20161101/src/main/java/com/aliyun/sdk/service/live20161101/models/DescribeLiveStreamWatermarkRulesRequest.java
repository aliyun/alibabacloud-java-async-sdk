...
public class DescribeLiveStreamWatermarkRulesRequest extends Request {
    ...
    public static DescribeLiveStreamWatermarkRulesRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeLiveStreamWatermarkRulesRequest, Builder> {
        ...
        @Override
        public DescribeLiveStreamWatermarkRulesRequest build() {
            return new DescribeLiveStreamWatermarkRulesRequest(this);
        } 
