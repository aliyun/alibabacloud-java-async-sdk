...
/**
 * 
 * {@link StartLiveMPUTaskRequest} extends {@link RequestModel}
 *
 * <p>StartLiveMPUTaskRequest</p>
 */
public class StartLiveMPUTaskRequest extends Request {
    ...
    private StartLiveMPUTaskRequest(Builder builder) {
        super(builder);
    ...
    public static StartLiveMPUTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<StartLiveMPUTaskRequest, Builder> {
        private String appId; 
        private String channelId; 
        private String maxIdleTime; 
        private String mixMode; 
        ...
        private Builder(StartLiveMPUTaskRequest request) {
            super(request);
        ...
        @Override
        public StartLiveMPUTaskRequest build() {
            return new StartLiveMPUTaskRequest(this);
        } 
    ...
    /**
     * 
     * {@link StartLiveMPUTaskRequest} extends {@link TeaModel}
     *
     * <p>StartLiveMPUTaskRequest</p>
     */
