...
/**
 * 
 * {@link DescribeLiveCenterTransferRequest} extends {@link RequestModel}
 *
 * <p>DescribeLiveCenterTransferRequest</p>
 */
public class DescribeLiveCenterTransferRequest extends Request {
    ...
    private DescribeLiveCenterTransferRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeLiveCenterTransferRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeLiveCenterTransferRequest, Builder> {
        private String appName; 
        private String domainName; 
        private String dstUrl; 
        private Long ownerId; 
        ...
        private Builder(DescribeLiveCenterTransferRequest request) {
            super(request);
        ...
        @Override
        public DescribeLiveCenterTransferRequest build() {
            return new DescribeLiveCenterTransferRequest(this);
        } 
