...
/**
 * 
 * {@link DescribeLiveTrafficDomainLogResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeLiveTrafficDomainLogResponseBody</p>
 */
public class DescribeLiveTrafficDomainLogResponseBody extends TeaModel {
    ...
    private DescribeLiveTrafficDomainLogResponseBody(Builder builder) {
    ...
    public static DescribeLiveTrafficDomainLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeLiveTrafficDomainLogResponseBody model) {
        ...
        public DescribeLiveTrafficDomainLogResponseBody build() {
            return new DescribeLiveTrafficDomainLogResponseBody(this);
        } 
