...
/**
 * 
 * {@link GetEdgeTranscodeJobResponseBody} extends {@link TeaModel}
 *
 * <p>GetEdgeTranscodeJobResponseBody</p>
 */
public class GetEdgeTranscodeJobResponseBody extends TeaModel {
    ...
    private GetEdgeTranscodeJobResponseBody(Builder builder) {
    ...
    public static GetEdgeTranscodeJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetEdgeTranscodeJobResponseBody model) {
            this.job = model.job;
        ...
        public GetEdgeTranscodeJobResponseBody build() {
            return new GetEdgeTranscodeJobResponseBody(this);
        } 
