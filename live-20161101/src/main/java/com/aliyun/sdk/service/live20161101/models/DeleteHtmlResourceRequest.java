...
/**
 * {@link DeleteHtmlResourceRequest} extends {@link RequestModel}
 *
 * <p>DeleteHtmlResourceRequest</p>
 */
public class DeleteHtmlResourceRequest extends Request {
    @Query
    @NameInMap("CasterId")
    ...
    private DeleteHtmlResourceRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteHtmlResourceRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteHtmlResourceRequest, Builder> {
        private String casterId; 
        private String htmlResourceId; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(DeleteHtmlResourceRequest response) {
            super(response);
        ...
        @Override
        public DeleteHtmlResourceRequest build() {
            return new DeleteHtmlResourceRequest(this);
        } 
