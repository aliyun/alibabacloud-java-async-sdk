...
/**
 * 
 * {@link AddLivePackageConfigRequest} extends {@link RequestModel}
 *
 * <p>AddLivePackageConfigRequest</p>
 */
public class AddLivePackageConfigRequest extends Request {
    ...
    private AddLivePackageConfigRequest(Builder builder) {
        super(builder);
    ...
    public static AddLivePackageConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddLivePackageConfigRequest, Builder> {
        private String appName; 
        private String domainName; 
        private Boolean ignoreTranscode; 
        private Long ownerId; 
        ...
        private Builder(AddLivePackageConfigRequest request) {
            super(request);
        ...
        @Override
        public AddLivePackageConfigRequest build() {
            return new AddLivePackageConfigRequest(this);
        } 
