...
/**
 * 
 * {@link DescribeLiveUserTrafficLogResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeLiveUserTrafficLogResponseBody</p>
 */
public class DescribeLiveUserTrafficLogResponseBody extends TeaModel {
    ...
    private DescribeLiveUserTrafficLogResponseBody(Builder builder) {
    ...
    public static DescribeLiveUserTrafficLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeLiveUserTrafficLogResponseBody model) {
        ...
        public DescribeLiveUserTrafficLogResponseBody build() {
            return new DescribeLiveUserTrafficLogResponseBody(this);
        } 
