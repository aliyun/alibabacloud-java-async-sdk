...
/**
 * 
 * {@link ListLiveMessageGroupByPageResponseBody} extends {@link TeaModel}
 *
 * <p>ListLiveMessageGroupByPageResponseBody</p>
 */
public class ListLiveMessageGroupByPageResponseBody extends TeaModel {
    ...
    private ListLiveMessageGroupByPageResponseBody(Builder builder) {
    ...
    public static ListLiveMessageGroupByPageResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListLiveMessageGroupByPageResponseBody model) {
        ...
        public ListLiveMessageGroupByPageResponseBody build() {
            return new ListLiveMessageGroupByPageResponseBody(this);
        } 
