...
/**
 * {@link DescribeHtmlResourceRequest} extends {@link RequestModel}
 *
 * <p>DescribeHtmlResourceRequest</p>
 */
public class DescribeHtmlResourceRequest extends Request {
    @Query
    @NameInMap("CasterId")
    ...
    private DescribeHtmlResourceRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeHtmlResourceRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeHtmlResourceRequest, Builder> {
        private String casterId; 
        private String htmlResourceId; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(DescribeHtmlResourceRequest response) {
            super(response);
        ...
        @Override
        public DescribeHtmlResourceRequest build() {
            return new DescribeHtmlResourceRequest(this);
        } 
