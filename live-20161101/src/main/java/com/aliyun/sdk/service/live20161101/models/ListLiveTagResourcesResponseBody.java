...
/**
 * 
 * {@link ListLiveTagResourcesResponseBody} extends {@link TeaModel}
 *
 * <p>ListLiveTagResourcesResponseBody</p>
 */
public class ListLiveTagResourcesResponseBody extends TeaModel {
    ...
    private ListLiveTagResourcesResponseBody(Builder builder) {
    ...
    public static ListLiveTagResourcesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListLiveTagResourcesResponseBody model) {
        ...
        public ListLiveTagResourcesResponseBody build() {
            return new ListLiveTagResourcesResponseBody(this);
        } 
