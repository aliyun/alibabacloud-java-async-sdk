...
/**
 * {@link UpdateLiveASRConfigRequest} extends {@link RequestModel}
 *
 * <p>UpdateLiveASRConfigRequest</p>
 */
public class UpdateLiveASRConfigRequest extends Request {
    @Query
    @NameInMap("AppName")
    ...
    private UpdateLiveASRConfigRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateLiveASRConfigRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateLiveASRConfigRequest, Builder> {
        private String appName; 
        private String domainName; 
        private String httpCallbackURL; 
        private String mnsRegion; 
        ...
        private Builder(UpdateLiveASRConfigRequest response) {
            super(response);
        ...
        @Override
        public UpdateLiveASRConfigRequest build() {
            return new UpdateLiveASRConfigRequest(this);
        } 
