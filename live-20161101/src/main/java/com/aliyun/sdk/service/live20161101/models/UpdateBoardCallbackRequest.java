...
/**
 * {@link UpdateBoardCallbackRequest} extends {@link RequestModel}
 *
 * <p>UpdateBoardCallbackRequest</p>
 */
public class UpdateBoardCallbackRequest extends Request {
    @Query
    @NameInMap("AppId")
    ...
    private UpdateBoardCallbackRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateBoardCallbackRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateBoardCallbackRequest, Builder> {
        private String appId; 
        private String authKey; 
        private String authSwitch; 
        private Integer callbackEnable; 
        ...
        private Builder(UpdateBoardCallbackRequest response) {
            super(response);
        ...
        @Override
        public UpdateBoardCallbackRequest build() {
            return new UpdateBoardCallbackRequest(this);
        } 
