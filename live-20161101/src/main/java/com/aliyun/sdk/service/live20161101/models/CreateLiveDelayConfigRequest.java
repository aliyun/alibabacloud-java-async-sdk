...
/**
 * 
 * {@link CreateLiveDelayConfigRequest} extends {@link RequestModel}
 *
 * <p>CreateLiveDelayConfigRequest</p>
 */
public class CreateLiveDelayConfigRequest extends Request {
    ...
    private CreateLiveDelayConfigRequest(Builder builder) {
        super(builder);
    ...
    public static CreateLiveDelayConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateLiveDelayConfigRequest, Builder> {
        private String app; 
        private Integer delayTime; 
        private String domain; 
        private Long ownerId; 
        ...
        private Builder(CreateLiveDelayConfigRequest request) {
            super(request);
        ...
        @Override
        public CreateLiveDelayConfigRequest build() {
            return new CreateLiveDelayConfigRequest(this);
        } 
