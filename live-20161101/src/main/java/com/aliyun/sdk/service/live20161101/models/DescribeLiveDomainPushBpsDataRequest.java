...
/**
 * 
 * {@link DescribeLiveDomainPushBpsDataRequest} extends {@link RequestModel}
 *
 * <p>DescribeLiveDomainPushBpsDataRequest</p>
 */
public class DescribeLiveDomainPushBpsDataRequest extends Request {
    ...
    private DescribeLiveDomainPushBpsDataRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeLiveDomainPushBpsDataRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeLiveDomainPushBpsDataRequest, Builder> {
        private String domainName; 
        private String endTime; 
        private String interval; 
        private String ispNameEn; 
        ...
        private Builder(DescribeLiveDomainPushBpsDataRequest request) {
            super(request);
        ...
        /**
         * <p>The end of the time range to query. Specify the time in the ISO 8601 standard in the <em>yyyy-MM-dd</em>T<em>HH:mm:ss</em>Z format. The time must be in UTC. The end time must be later than the start time.</p>
         * 
         * <strong>example:</strong>
        ...
        @Override
        public DescribeLiveDomainPushBpsDataRequest build() {
            return new DescribeLiveDomainPushBpsDataRequest(this);
        } 
