...
/**
 * 
 * {@link DescribeLiveDomainEdgeLogResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeLiveDomainEdgeLogResponseBody</p>
 */
public class DescribeLiveDomainEdgeLogResponseBody extends TeaModel {
    ...
    private DescribeLiveDomainEdgeLogResponseBody(Builder builder) {
    ...
    public static DescribeLiveDomainEdgeLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeLiveDomainEdgeLogResponseBody model) {
        ...
        public DescribeLiveDomainEdgeLogResponseBody build() {
            return new DescribeLiveDomainEdgeLogResponseBody(this);
        } 
