...
/**
 * 
 * {@link UpdateLivePullToPushResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateLivePullToPushResponseBody</p>
 */
public class UpdateLivePullToPushResponseBody extends TeaModel {
    ...
    private UpdateLivePullToPushResponseBody(Builder builder) {
    ...
    public static UpdateLivePullToPushResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateLivePullToPushResponseBody model) {
        ...
        public UpdateLivePullToPushResponseBody build() {
            return new UpdateLivePullToPushResponseBody(this);
        } 
