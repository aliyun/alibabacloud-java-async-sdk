...
/**
 * 
 * {@link ListEdgeTranscodeTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>ListEdgeTranscodeTemplateResponseBody</p>
 */
public class ListEdgeTranscodeTemplateResponseBody extends TeaModel {
    ...
    private ListEdgeTranscodeTemplateResponseBody(Builder builder) {
    ...
    public static ListEdgeTranscodeTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListEdgeTranscodeTemplateResponseBody model) {
        ...
        public ListEdgeTranscodeTemplateResponseBody build() {
            return new ListEdgeTranscodeTemplateResponseBody(this);
        } 
