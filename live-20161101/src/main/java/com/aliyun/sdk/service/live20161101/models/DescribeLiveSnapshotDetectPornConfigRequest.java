...
public class DescribeLiveSnapshotDetectPornConfigRequest extends Request {
    ...
    public static DescribeLiveSnapshotDetectPornConfigRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeLiveSnapshotDetectPornConfigRequest, Builder> {
        private String appName; 
        private String domainName; 
        private String order; 
        private Long ownerId; 
        ...
        @Override
        public DescribeLiveSnapshotDetectPornConfigRequest build() {
            return new DescribeLiveSnapshotDetectPornConfigRequest(this);
        } 
