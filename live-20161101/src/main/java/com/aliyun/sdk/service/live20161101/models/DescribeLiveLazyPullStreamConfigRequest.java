...
public class DescribeLiveLazyPullStreamConfigRequest extends Request {
    ...
    public static DescribeLiveLazyPullStreamConfigRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeLiveLazyPullStreamConfigRequest, Builder> {
        ...
        private Builder(DescribeLiveLazyPullStreamConfigRequest response) {
            super(response);
        ...
        @Override
        public DescribeLiveLazyPullStreamConfigRequest build() {
            return new DescribeLiveLazyPullStreamConfigRequest(this);
        } 
