...
/**
 * 
 * {@link WalkingDirectionNovaResponseBody} extends {@link TeaModel}
 *
 * <p>WalkingDirectionNovaResponseBody</p>
 */
public class WalkingDirectionNovaResponseBody extends TeaModel {
    ...
    private WalkingDirectionNovaResponseBody(Builder builder) {
    ...
    public static WalkingDirectionNovaResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(WalkingDirectionNovaResponseBody model) {
        ...
        public WalkingDirectionNovaResponseBody build() {
            return new WalkingDirectionNovaResponseBody(this);
        } 
