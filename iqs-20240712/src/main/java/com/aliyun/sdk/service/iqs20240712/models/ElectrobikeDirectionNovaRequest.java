...
/**
 * 
 * {@link ElectrobikeDirectionNovaRequest} extends {@link RequestModel}
 *
 * <p>ElectrobikeDirectionNovaRequest</p>
 */
public class ElectrobikeDirectionNovaRequest extends Request {
    ...
    private ElectrobikeDirectionNovaRequest(Builder builder) {
        super(builder);
    ...
    public static ElectrobikeDirectionNovaRequest create() {
    ...
    public static final class Builder extends Request.Builder<ElectrobikeDirectionNovaRequest, Builder> {
        private String destinationLatitude; 
        private String destinationLongitude; 
        private String originLatitude; 
        private String originLongitude; 
        ...
        private Builder(ElectrobikeDirectionNovaRequest request) {
            super(request);
        ...
        @Override
        public ElectrobikeDirectionNovaRequest build() {
            return new ElectrobikeDirectionNovaRequest(this);
        } 
