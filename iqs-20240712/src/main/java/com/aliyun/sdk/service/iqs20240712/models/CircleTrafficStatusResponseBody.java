...
/**
 * 
 * {@link CircleTrafficStatusResponseBody} extends {@link TeaModel}
 *
 * <p>CircleTrafficStatusResponseBody</p>
 */
public class CircleTrafficStatusResponseBody extends TeaModel {
    ...
    private CircleTrafficStatusResponseBody(Builder builder) {
    ...
    public static CircleTrafficStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CircleTrafficStatusResponseBody build() {
            return new CircleTrafficStatusResponseBody(this);
        } 
