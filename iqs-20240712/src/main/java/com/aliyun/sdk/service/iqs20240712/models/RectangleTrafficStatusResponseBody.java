...
/**
 * 
 * {@link RectangleTrafficStatusResponseBody} extends {@link TeaModel}
 *
 * <p>RectangleTrafficStatusResponseBody</p>
 */
public class RectangleTrafficStatusResponseBody extends TeaModel {
    ...
    private RectangleTrafficStatusResponseBody(Builder builder) {
    ...
    public static RectangleTrafficStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public RectangleTrafficStatusResponseBody build() {
            return new RectangleTrafficStatusResponseBody(this);
        } 
