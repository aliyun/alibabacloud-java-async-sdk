...
/**
 * 
 * {@link WalkingDirectionRequest} extends {@link RequestModel}
 *
 * <p>WalkingDirectionRequest</p>
 */
public class WalkingDirectionRequest extends Request {
    ...
    private WalkingDirectionRequest(Builder builder) {
        super(builder);
    ...
    public static WalkingDirectionRequest create() {
    ...
    public static final class Builder extends Request.Builder<WalkingDirectionRequest, Builder> {
        private String destinationLatitude; 
        private String destinationLongitude; 
        private String originLatitude; 
        private String originLongitude; 
        ...
        private Builder(WalkingDirectionRequest request) {
            super(request);
        ...
        @Override
        public WalkingDirectionRequest build() {
            return new WalkingDirectionRequest(this);
        } 
