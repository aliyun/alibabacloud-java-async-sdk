...
/**
 * 
 * {@link ElectrobikeDirectionResponseBody} extends {@link TeaModel}
 *
 * <p>ElectrobikeDirectionResponseBody</p>
 */
public class ElectrobikeDirectionResponseBody extends TeaModel {
    ...
    private ElectrobikeDirectionResponseBody(Builder builder) {
    ...
    public static ElectrobikeDirectionResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ElectrobikeDirectionResponseBody build() {
            return new ElectrobikeDirectionResponseBody(this);
        } 
