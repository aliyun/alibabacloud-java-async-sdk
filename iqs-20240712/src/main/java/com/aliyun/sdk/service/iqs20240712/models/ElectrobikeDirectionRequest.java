...
/**
 * 
 * {@link ElectrobikeDirectionRequest} extends {@link RequestModel}
 *
 * <p>ElectrobikeDirectionRequest</p>
 */
public class ElectrobikeDirectionRequest extends Request {
    ...
    private ElectrobikeDirectionRequest(Builder builder) {
        super(builder);
    ...
    public static ElectrobikeDirectionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ElectrobikeDirectionRequest, Builder> {
        private String destinationLatitude; 
        private String destinationLongitude; 
        private String originLatitude; 
        private String originLongitude; 
        ...
        private Builder(ElectrobikeDirectionRequest request) {
            super(request);
        ...
        @Override
        public ElectrobikeDirectionRequest build() {
            return new ElectrobikeDirectionRequest(this);
        } 
