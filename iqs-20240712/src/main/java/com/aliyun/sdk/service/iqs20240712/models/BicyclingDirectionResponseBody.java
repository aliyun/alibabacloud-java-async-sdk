...
/**
 * 
 * {@link BicyclingDirectionResponseBody} extends {@link TeaModel}
 *
 * <p>BicyclingDirectionResponseBody</p>
 */
public class BicyclingDirectionResponseBody extends TeaModel {
    ...
    private BicyclingDirectionResponseBody(Builder builder) {
    ...
    public static BicyclingDirectionResponseBody create() {
    ...
    public static final class Builder {
        ...
        public BicyclingDirectionResponseBody build() {
            return new BicyclingDirectionResponseBody(this);
        } 
