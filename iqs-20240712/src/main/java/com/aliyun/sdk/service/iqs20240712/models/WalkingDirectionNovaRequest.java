...
/**
 * 
 * {@link WalkingDirectionNovaRequest} extends {@link RequestModel}
 *
 * <p>WalkingDirectionNovaRequest</p>
 */
public class WalkingDirectionNovaRequest extends Request {
    ...
    private WalkingDirectionNovaRequest(Builder builder) {
        super(builder);
    ...
    public static WalkingDirectionNovaRequest create() {
    ...
    public static final class Builder extends Request.Builder<WalkingDirectionNovaRequest, Builder> {
        private String destinationLatitude; 
        private String destinationLongitude; 
        private String originLatitude; 
        private String originLongitude; 
        ...
        private Builder(WalkingDirectionNovaRequest request) {
            super(request);
        ...
        @Override
        public WalkingDirectionNovaRequest build() {
            return new WalkingDirectionNovaRequest(this);
        } 
