...
/**
 * 
 * {@link BicyclingDirectionRequest} extends {@link RequestModel}
 *
 * <p>BicyclingDirectionRequest</p>
 */
public class BicyclingDirectionRequest extends Request {
    ...
    private BicyclingDirectionRequest(Builder builder) {
        super(builder);
    ...
    public static BicyclingDirectionRequest create() {
    ...
    public static final class Builder extends Request.Builder<BicyclingDirectionRequest, Builder> {
        private String destinationLatitude; 
        private String destinationLongitude; 
        private String originLatitude; 
        private String originLongitude; 
        ...
        private Builder(BicyclingDirectionRequest request) {
            super(request);
        ...
        @Override
        public BicyclingDirectionRequest build() {
            return new BicyclingDirectionRequest(this);
        } 
