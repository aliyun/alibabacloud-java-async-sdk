...
/**
 * 
 * {@link DeleteFilesResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteFilesResponseBody</p>
 */
public class DeleteFilesResponseBody extends TeaModel {
    ...
    private DeleteFilesResponseBody(Builder builder) {
    ...
    public static DeleteFilesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteFilesResponseBody model) {
        ...
        public DeleteFilesResponseBody build() {
            return new DeleteFilesResponseBody(this);
        } 
