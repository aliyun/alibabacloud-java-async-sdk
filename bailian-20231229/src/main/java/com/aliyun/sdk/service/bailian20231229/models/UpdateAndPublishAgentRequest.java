...
/**
 * {@link UpdateAndPublishAgentRequest} extends {@link RequestModel}
 *
...
public class UpdateAndPublishAgentRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<UpdateAndPublishAgentRequest, Builder> {
        ...
        private Builder(UpdateAndPublishAgentRequest request) {
            super(request);
        ...
        @Override
        public UpdateAndPublishAgentRequest build() {
