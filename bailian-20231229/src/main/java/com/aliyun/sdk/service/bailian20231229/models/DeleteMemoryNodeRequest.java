...
/**
 * {@link DeleteMemoryNodeRequest} extends {@link RequestModel}
 *
 * <p>DeleteMemoryNodeRequest</p>
 */
public class DeleteMemoryNodeRequest extends Request {
    ...
    private DeleteMemoryNodeRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteMemoryNodeRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteMemoryNodeRequest, Builder> {
        private String workspaceId; 
        private String memoryId; 
        private String memoryNodeId; 
        private String regionId; 
        ...
        private Builder(DeleteMemoryNodeRequest request) {
            super(request);
        ...
        @Override
        public DeleteMemoryNodeRequest build() {
            return new DeleteMemoryNodeRequest(this);
        } 
