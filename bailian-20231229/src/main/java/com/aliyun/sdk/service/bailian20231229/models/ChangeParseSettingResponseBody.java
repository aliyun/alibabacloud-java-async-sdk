...
/**
 * 
 * {@link ChangeParseSettingResponseBody} extends {@link TeaModel}
 *
 * <p>ChangeParseSettingResponseBody</p>
 */
public class ChangeParseSettingResponseBody extends TeaModel {
    ...
    private ChangeParseSettingResponseBody(Builder builder) {
    ...
    public static ChangeParseSettingResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ChangeParseSettingResponseBody model) {
        ...
        public ChangeParseSettingResponseBody build() {
            return new ChangeParseSettingResponseBody(this);
        } 
