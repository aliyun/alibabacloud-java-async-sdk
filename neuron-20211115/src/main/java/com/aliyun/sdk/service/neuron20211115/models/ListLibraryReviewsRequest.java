...
/**
 * 
 * {@link ListLibraryReviewsRequest} extends {@link RequestModel}
 *
 * <p>ListLibraryReviewsRequest</p>
 */
public class ListLibraryReviewsRequest extends Request {
    ...
    private ListLibraryReviewsRequest(Builder builder) {
        super(builder);
    ...
    public static ListLibraryReviewsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListLibraryReviewsRequest, Builder> {
        private String applicant; 
        private Long marketId; 
        private String orderBy; 
        private String orderDirection; 
        ...
        private Builder(ListLibraryReviewsRequest request) {
            super(request);
        ...
        @Override
        public ListLibraryReviewsRequest build() {
            return new ListLibraryReviewsRequest(this);
        } 
