...
/**
 * 
 * {@link MonitorMqAlert} extends {@link TeaModel}
 *
 * <p>MonitorMqAlert</p>
 */
public class MonitorMqAlert extends TeaModel {
    ...
    private MonitorMqAlert(Builder builder) {
    ...
    public static MonitorMqAlert create() {
    ...
    public static final class Builder {
        ...
        private Builder(MonitorMqAlert model) {
        ...
        public MonitorMqAlert build() {
            return new MonitorMqAlert(this);
        } 
