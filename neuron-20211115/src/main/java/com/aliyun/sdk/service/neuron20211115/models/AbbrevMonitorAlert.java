...
/**
 * 
 * {@link AbbrevMonitorAlert} extends {@link TeaModel}
 *
 * <p>AbbrevMonitorAlert</p>
 */
public class AbbrevMonitorAlert extends TeaModel {
    @com.aliyun.core.annotation.NameInMap("abbrevMonitorAlertRules")
    private java.util.List<AbbrevMonitorAlertRule> abbrevMonitorAlertRules;
    ...
    private AbbrevMonitorAlert(Builder builder) {
        this.abbrevMonitorAlertRules = builder.abbrevMonitorAlertRules;
    ...
    public static AbbrevMonitorAlert create() {
    ...
    /**
     * @return abbrevMonitorAlertRules
     */
    ...
    public static final class Builder {
        ...
        private Builder(AbbrevMonitorAlert model) {
            this.abbrevMonitorAlertRules = model.abbrevMonitorAlertRules;
         ...
         */
        public Builder abbrevMonitorAlertRules(java.util.List<AbbrevMonitorAlertRule> abbrevMonitorAlertRules) {
        ...
        public AbbrevMonitorAlert build() {
            return new AbbrevMonitorAlert(this);
        } 
