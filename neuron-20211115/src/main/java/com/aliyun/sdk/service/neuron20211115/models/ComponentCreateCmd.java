...
/**
 * 
 * {@link ComponentCreateCmd} extends {@link TeaModel}
 *
 * <p>ComponentCreateCmd</p>
 */
public class ComponentCreateCmd extends TeaModel {
    ...
    @com.aliyun.core.annotation.NameInMap("scopeServiceIds")
    private String scopeServiceIds;
    ...
    private ComponentCreateCmd(Builder builder) {
        ...
        this.scopeServiceIds = builder.scopeServiceIds;
    ...
    public static ComponentCreateCmd create() {
    ...
    public static final class Builder {
        ...
        private Builder(ComponentCreateCmd model) {
            ...
            this.scopeServiceIds = model.scopeServiceIds;
         ...
         * scopeServiceIds.
         */
        public Builder scopeServiceIds(String scopeServiceIds) {
        ...
        public ComponentCreateCmd build() {
            return new ComponentCreateCmd(this);
        } 
