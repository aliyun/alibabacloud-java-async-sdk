...
/**
 * 
 * {@link DeletePbcInvokeRequest} extends {@link RequestModel}
 *
 * <p>DeletePbcInvokeRequest</p>
 */
public class DeletePbcInvokeRequest extends Request {
    ...
    private DeletePbcInvokeRequest(Builder builder) {
        super(builder);
    ...
    public static DeletePbcInvokeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeletePbcInvokeRequest, Builder> {
        private String applicant; 
        private Long companyId; 
        private Long marketId; 
        private Long pbcId; 
        ...
        private Builder(DeletePbcInvokeRequest request) {
            super(request);
        ...
        @Override
        public DeletePbcInvokeRequest build() {
            return new DeletePbcInvokeRequest(this);
        } 
