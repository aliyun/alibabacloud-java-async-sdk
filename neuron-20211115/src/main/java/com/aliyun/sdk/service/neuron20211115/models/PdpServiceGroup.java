...
/**
 * 
 * {@link PdpServiceGroup} extends {@link TeaModel}
 *
 * <p>PdpServiceGroup</p>
 */
public class PdpServiceGroup extends TeaModel {
    ...
    private PdpServiceGroup(Builder builder) {
    ...
    public static PdpServiceGroup create() {
    ...
    public static final class Builder {
        ...
        private Builder(PdpServiceGroup model) {
        ...
        public PdpServiceGroup build() {
            return new PdpServiceGroup(this);
        } 
