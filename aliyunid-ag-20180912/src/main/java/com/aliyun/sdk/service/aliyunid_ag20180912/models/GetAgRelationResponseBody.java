...
/**
 * 
 * {@link GetAgRelationResponseBody} extends {@link TeaModel}
 *
 * <p>GetAgRelationResponseBody</p>
 */
public class GetAgRelationResponseBody extends TeaModel {
    ...
    private GetAgRelationResponseBody(Builder builder) {
    ...
    public static GetAgRelationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAgRelationResponseBody model) {
        ...
        public GetAgRelationResponseBody build() {
            return new GetAgRelationResponseBody(this);
        } 
