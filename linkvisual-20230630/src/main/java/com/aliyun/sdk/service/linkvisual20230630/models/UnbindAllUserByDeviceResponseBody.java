...
/**
 * {@link UnbindAllUserByDeviceResponseBody} extends {@link TeaModel}
 *
 * <p>UnbindAllUserByDeviceResponseBody</p>
 */
public class UnbindAllUserByDeviceResponseBody extends TeaModel {
    ...
    private UnbindAllUserByDeviceResponseBody(Builder builder) {
    ...
    public static UnbindAllUserByDeviceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UnbindAllUserByDeviceResponseBody build() {
            return new UnbindAllUserByDeviceResponseBody(this);
        } 
