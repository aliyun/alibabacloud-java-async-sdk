...
/**
 * {@link CreateAndPayStorageOrderResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAndPayStorageOrderResponseBody</p>
 */
public class CreateAndPayStorageOrderResponseBody extends TeaModel {
    ...
    private CreateAndPayStorageOrderResponseBody(Builder builder) {
    ...
    public static CreateAndPayStorageOrderResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateAndPayStorageOrderResponseBody build() {
            return new CreateAndPayStorageOrderResponseBody(this);
        } 
