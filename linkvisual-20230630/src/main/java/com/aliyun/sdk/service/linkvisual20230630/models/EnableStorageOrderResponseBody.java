...
/**
 * {@link EnableStorageOrderResponseBody} extends {@link TeaModel}
 *
 * <p>EnableStorageOrderResponseBody</p>
 */
public class EnableStorageOrderResponseBody extends TeaModel {
    ...
    private EnableStorageOrderResponseBody(Builder builder) {
    ...
    public static EnableStorageOrderResponseBody create() {
    ...
    public static final class Builder {
        ...
        public EnableStorageOrderResponseBody build() {
            return new EnableStorageOrderResponseBody(this);
        } 
