...
/**
 * {@link ConsumeFreeStorageResponseBody} extends {@link TeaModel}
 *
 * <p>ConsumeFreeStorageResponseBody</p>
 */
public class ConsumeFreeStorageResponseBody extends TeaModel {
    ...
    private ConsumeFreeStorageResponseBody(Builder builder) {
    ...
    public static ConsumeFreeStorageResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ConsumeFreeStorageResponseBody build() {
            return new ConsumeFreeStorageResponseBody(this);
        } 
