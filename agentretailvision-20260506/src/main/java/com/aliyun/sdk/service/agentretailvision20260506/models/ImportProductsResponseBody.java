...
/**
 * 
 * {@link ImportProductsResponseBody} extends {@link TeaModel}
 *
 * <p>ImportProductsResponseBody</p>
 */
public class ImportProductsResponseBody extends TeaModel {
    ...
    private ImportProductsResponseBody(Builder builder) {
    ...
    public static ImportProductsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ImportProductsResponseBody model) {
        ...
        public ImportProductsResponseBody build() {
            return new ImportProductsResponseBody(this);
        } 
