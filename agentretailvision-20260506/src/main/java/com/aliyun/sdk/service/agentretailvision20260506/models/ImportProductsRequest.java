...
/**
 * 
 * {@link ImportProductsRequest} extends {@link RequestModel}
 *
 * <p>ImportProductsRequest</p>
 */
public class ImportProductsRequest extends Request {
    ...
    private ImportProductsRequest(Builder builder) {
        super(builder);
    ...
    public static ImportProductsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ImportProductsRequest, Builder> {
        private String deviceId; 
        private java.util.List<String> extraImages; 
        private String imageTitle; 
        private String itemUniqueId; 
        ...
        private Builder(ImportProductsRequest request) {
            super(request);
    ...
    /**
     * 
     * {@link ImportProductsRequest} extends {@link TeaModel}
     *
     * <p>ImportProductsRequest</p>
     */
