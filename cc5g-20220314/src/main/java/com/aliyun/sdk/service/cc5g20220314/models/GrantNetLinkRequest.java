...
/**
 * {@link GrantNetLinkRequest} extends {@link RequestModel}
 *
 * <p>GrantNetLinkRequest</p>
 */
public class GrantNetLinkRequest extends Request {
    ...
    private GrantNetLinkRequest(Builder builder) {
        super(builder);
    ...
    public static GrantNetLinkRequest create() {
    ...
    public static final class Builder extends Request.Builder<GrantNetLinkRequest, Builder> {
        private String clientToken; 
        private Boolean dryRun; 
        private Long grantAliUid; 
        private String netLinkId; 
        ...
        private Builder(GrantNetLinkRequest request) {
            super(request);
            this.clientToken = request.clientToken;
            this.dryRun = request.dryRun;
            this.grantAliUid = request.grantAliUid;
         ...
         * GrantAliUid.
         */
        public Builder grantAliUid(Long grantAliUid) {
            this.putQueryParameter("GrantAliUid", grantAliUid);
        ...
        @Override
        public GrantNetLinkRequest build() {
            return new GrantNetLinkRequest(this);
        } 
