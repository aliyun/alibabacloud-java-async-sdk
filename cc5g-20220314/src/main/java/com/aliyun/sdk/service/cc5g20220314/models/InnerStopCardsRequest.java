...
/**
 * {@link InnerStopCardsRequest} extends {@link RequestModel}
 *
 * <p>InnerStopCardsRequest</p>
 */
public class InnerStopCardsRequest extends Request {
    ...
    private InnerStopCardsRequest(Builder builder) {
        super(builder);
    ...
    public static InnerStopCardsRequest create() {
    ...
    public static final class Builder extends Request.Builder<InnerStopCardsRequest, Builder> {
        private String clientToken; 
        private Boolean dryRun; 
        private java.util.List < String > iccids; 
        private Boolean innerApi; 
        ...
        private Builder(InnerStopCardsRequest request) {
            super(request);
        ...
        @Override
        public InnerStopCardsRequest build() {
            return new InnerStopCardsRequest(this);
        } 
