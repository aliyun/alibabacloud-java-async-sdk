...
/**
 * {@link AddGroupDnsAuthorizationRuleRequest} extends {@link RequestModel}
 *
 * <p>AddGroupDnsAuthorizationRuleRequest</p>
 */
public class AddGroupDnsAuthorizationRuleRequest extends Request {
    ...
    private AddGroupDnsAuthorizationRuleRequest(Builder builder) {
        super(builder);
    ...
    public static AddGroupDnsAuthorizationRuleRequest create() {
    ...
    public static final class Builder extends Request.Builder<AddGroupDnsAuthorizationRuleRequest, Builder> {
        private String clientToken; 
        private String description; 
        private String destinationIp; 
        private Boolean dryRun; 
        ...
        private Builder(AddGroupDnsAuthorizationRuleRequest request) {
            super(request);
        ...
        @Override
        public AddGroupDnsAuthorizationRuleRequest build() {
            return new AddGroupDnsAuthorizationRuleRequest(this);
        } 
