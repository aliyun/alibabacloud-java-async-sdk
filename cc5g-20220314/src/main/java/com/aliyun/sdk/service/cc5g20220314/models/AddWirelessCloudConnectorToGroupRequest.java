...
/**
 * {@link AddWirelessCloudConnectorToGroupRequest} extends {@link RequestModel}
 *
 * <p>AddWirelessCloudConnectorToGroupRequest</p>
 */
public class AddWirelessCloudConnectorToGroupRequest extends Request {
    ...
    private AddWirelessCloudConnectorToGroupRequest(Builder builder) {
        super(builder);
    ...
    public static AddWirelessCloudConnectorToGroupRequest create() {
    ...
    public static final class Builder extends Request.Builder<AddWirelessCloudConnectorToGroupRequest, Builder> {
        private String clientToken; 
        private Boolean dryRun; 
        private String regionId; 
        private String wirelessCloudConnectorGroupId; 
        ...
        private Builder(AddWirelessCloudConnectorToGroupRequest request) {
            super(request);
        ...
        @Override
        public AddWirelessCloudConnectorToGroupRequest build() {
            return new AddWirelessCloudConnectorToGroupRequest(this);
        } 
