...
/**
 * 
 * {@link UpdateSchemaPropertyRequest} extends {@link RequestModel}
 *
 * <p>UpdateSchemaPropertyRequest</p>
 */
public class UpdateSchemaPropertyRequest extends Request {
    ...
    private UpdateSchemaPropertyRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateSchemaPropertyRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateSchemaPropertyRequest, Builder> {
        private String instanceId; 
        private Property property; 
        private String requestId; 
        private String schemaId; 
        ...
        private Builder(UpdateSchemaPropertyRequest request) {
            super(request);
        ...
        @Override
        public UpdateSchemaPropertyRequest build() {
            return new UpdateSchemaPropertyRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateSchemaPropertyRequest} extends {@link TeaModel}
     *
     * <p>UpdateSchemaPropertyRequest</p>
     */
