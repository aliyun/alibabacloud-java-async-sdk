...
/**
 * 
 * {@link BargeInCallResponseBody} extends {@link TeaModel}
 *
 * <p>BargeInCallResponseBody</p>
 */
public class BargeInCallResponseBody extends TeaModel {
    ...
    private BargeInCallResponseBody(Builder builder) {
    ...
    public static BargeInCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BargeInCallResponseBody model) {
        ...
        public BargeInCallResponseBody build() {
            return new BargeInCallResponseBody(this);
        } 
