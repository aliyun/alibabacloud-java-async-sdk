...
/**
 * 
 * {@link LaunchSurveyResponseBody} extends {@link TeaModel}
 *
 * <p>LaunchSurveyResponseBody</p>
 */
public class LaunchSurveyResponseBody extends TeaModel {
    ...
    private LaunchSurveyResponseBody(Builder builder) {
    ...
    public static LaunchSurveyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(LaunchSurveyResponseBody model) {
        ...
        public LaunchSurveyResponseBody build() {
            return new LaunchSurveyResponseBody(this);
        } 
