...
/**
 * 
 * {@link BlindTransferResponseBody} extends {@link TeaModel}
 *
 * <p>BlindTransferResponseBody</p>
 */
public class BlindTransferResponseBody extends TeaModel {
    ...
    private BlindTransferResponseBody(Builder builder) {
    ...
    public static BlindTransferResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BlindTransferResponseBody model) {
        ...
        public BlindTransferResponseBody build() {
            return new BlindTransferResponseBody(this);
        } 
