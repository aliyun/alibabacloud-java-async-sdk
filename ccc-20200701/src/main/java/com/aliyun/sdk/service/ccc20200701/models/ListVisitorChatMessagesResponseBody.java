...
/**
 * 
 * {@link ListVisitorChatMessagesResponseBody} extends {@link TeaModel}
 *
 * <p>ListVisitorChatMessagesResponseBody</p>
 */
public class ListVisitorChatMessagesResponseBody extends TeaModel {
    ...
    private ListVisitorChatMessagesResponseBody(Builder builder) {
    ...
    public static ListVisitorChatMessagesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListVisitorChatMessagesResponseBody model) {
        ...
        public ListVisitorChatMessagesResponseBody build() {
            return new ListVisitorChatMessagesResponseBody(this);
        } 
