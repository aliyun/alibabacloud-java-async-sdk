...
/**
 * 
 * {@link UnmuteCallResponseBody} extends {@link TeaModel}
 *
 * <p>UnmuteCallResponseBody</p>
 */
public class UnmuteCallResponseBody extends TeaModel {
    ...
    private UnmuteCallResponseBody(Builder builder) {
    ...
    public static UnmuteCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UnmuteCallResponseBody model) {
        ...
        public UnmuteCallResponseBody build() {
            return new UnmuteCallResponseBody(this);
        } 
