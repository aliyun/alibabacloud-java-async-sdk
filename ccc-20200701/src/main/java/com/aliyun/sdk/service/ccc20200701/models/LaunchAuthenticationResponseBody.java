...
/**
 * 
 * {@link LaunchAuthenticationResponseBody} extends {@link TeaModel}
 *
 * <p>LaunchAuthenticationResponseBody</p>
 */
public class LaunchAuthenticationResponseBody extends TeaModel {
    ...
    private LaunchAuthenticationResponseBody(Builder builder) {
    ...
    public static LaunchAuthenticationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(LaunchAuthenticationResponseBody model) {
        ...
        public LaunchAuthenticationResponseBody build() {
            return new LaunchAuthenticationResponseBody(this);
        } 
