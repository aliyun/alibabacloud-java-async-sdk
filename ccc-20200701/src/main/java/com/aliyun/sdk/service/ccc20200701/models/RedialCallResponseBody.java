...
/**
 * 
 * {@link RedialCallResponseBody} extends {@link TeaModel}
 *
 * <p>RedialCallResponseBody</p>
 */
public class RedialCallResponseBody extends TeaModel {
    ...
    private RedialCallResponseBody(Builder builder) {
    ...
    public static RedialCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RedialCallResponseBody model) {
        ...
        public RedialCallResponseBody build() {
            return new RedialCallResponseBody(this);
        } 
