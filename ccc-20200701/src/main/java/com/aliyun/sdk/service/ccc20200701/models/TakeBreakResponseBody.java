...
/**
 * 
 * {@link TakeBreakResponseBody} extends {@link TeaModel}
 *
 * <p>TakeBreakResponseBody</p>
 */
public class TakeBreakResponseBody extends TeaModel {
    ...
    private TakeBreakResponseBody(Builder builder) {
    ...
    public static TakeBreakResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(TakeBreakResponseBody model) {
        ...
        public TakeBreakResponseBody build() {
            return new TakeBreakResponseBody(this);
        } 
