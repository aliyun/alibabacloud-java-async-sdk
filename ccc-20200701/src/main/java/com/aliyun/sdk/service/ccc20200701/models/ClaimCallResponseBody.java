...
/**
 * 
 * {@link ClaimCallResponseBody} extends {@link TeaModel}
 *
 * <p>ClaimCallResponseBody</p>
 */
public class ClaimCallResponseBody extends TeaModel {
    ...
    private ClaimCallResponseBody(Builder builder) {
    ...
    public static ClaimCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ClaimCallResponseBody model) {
        ...
        public ClaimCallResponseBody build() {
            return new ClaimCallResponseBody(this);
        } 
