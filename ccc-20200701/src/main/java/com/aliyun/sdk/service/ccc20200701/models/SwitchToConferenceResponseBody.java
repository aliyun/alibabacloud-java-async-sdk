...
/**
 * 
 * {@link SwitchToConferenceResponseBody} extends {@link TeaModel}
 *
 * <p>SwitchToConferenceResponseBody</p>
 */
public class SwitchToConferenceResponseBody extends TeaModel {
    ...
    private SwitchToConferenceResponseBody(Builder builder) {
    ...
    public static SwitchToConferenceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SwitchToConferenceResponseBody model) {
        ...
        public SwitchToConferenceResponseBody build() {
            return new SwitchToConferenceResponseBody(this);
        } 
