...
public class SignOutGroupResponseBody extends TeaModel {
    ...
    public static SignOutGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SignOutGroupResponseBody model) {
        ...
        public SignOutGroupResponseBody build() {
            return new SignOutGroupResponseBody(this);
        } 
