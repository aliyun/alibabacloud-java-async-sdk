...
/**
 * 
 * {@link StartConferenceResponseBody} extends {@link TeaModel}
 *
 * <p>StartConferenceResponseBody</p>
 */
public class StartConferenceResponseBody extends TeaModel {
    ...
    private StartConferenceResponseBody(Builder builder) {
    ...
    public static StartConferenceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartConferenceResponseBody model) {
        ...
        public StartConferenceResponseBody build() {
            return new StartConferenceResponseBody(this);
        } 
