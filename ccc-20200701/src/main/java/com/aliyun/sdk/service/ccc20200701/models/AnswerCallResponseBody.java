...
/**
 * 
 * {@link AnswerCallResponseBody} extends {@link TeaModel}
 *
 * <p>AnswerCallResponseBody</p>
 */
public class AnswerCallResponseBody extends TeaModel {
    ...
    private AnswerCallResponseBody(Builder builder) {
    ...
    public static AnswerCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AnswerCallResponseBody model) {
        ...
        public AnswerCallResponseBody build() {
            return new AnswerCallResponseBody(this);
        } 
