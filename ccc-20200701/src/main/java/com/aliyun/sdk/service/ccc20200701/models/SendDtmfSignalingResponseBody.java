...
/**
 * 
 * {@link SendDtmfSignalingResponseBody} extends {@link TeaModel}
 *
 * <p>SendDtmfSignalingResponseBody</p>
 */
public class SendDtmfSignalingResponseBody extends TeaModel {
    ...
    private SendDtmfSignalingResponseBody(Builder builder) {
    ...
    public static SendDtmfSignalingResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SendDtmfSignalingResponseBody model) {
        ...
        public SendDtmfSignalingResponseBody build() {
            return new SendDtmfSignalingResponseBody(this);
        } 
