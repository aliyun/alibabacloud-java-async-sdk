...
/**
 * 
 * {@link ChangeWorkModeResponseBody} extends {@link TeaModel}
 *
 * <p>ChangeWorkModeResponseBody</p>
 */
public class ChangeWorkModeResponseBody extends TeaModel {
    ...
    private ChangeWorkModeResponseBody(Builder builder) {
    ...
    public static ChangeWorkModeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ChangeWorkModeResponseBody model) {
        ...
        public ChangeWorkModeResponseBody build() {
            return new ChangeWorkModeResponseBody(this);
        } 
