...
public class ReleaseCallResponseBody extends TeaModel {
    ...
    private ReleaseCallResponseBody(Builder builder) {
    ...
    public static ReleaseCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ReleaseCallResponseBody build() {
            return new ReleaseCallResponseBody(this);
        } 
