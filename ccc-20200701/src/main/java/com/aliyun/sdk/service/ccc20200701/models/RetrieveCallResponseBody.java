...
/**
 * 
 * {@link RetrieveCallResponseBody} extends {@link TeaModel}
 *
 * <p>RetrieveCallResponseBody</p>
 */
public class RetrieveCallResponseBody extends TeaModel {
    ...
    private RetrieveCallResponseBody(Builder builder) {
    ...
    public static RetrieveCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RetrieveCallResponseBody model) {
        ...
        public RetrieveCallResponseBody build() {
            return new RetrieveCallResponseBody(this);
        } 
