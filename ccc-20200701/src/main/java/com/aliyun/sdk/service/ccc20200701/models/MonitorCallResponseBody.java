...
/**
 * 
 * {@link MonitorCallResponseBody} extends {@link TeaModel}
 *
 * <p>MonitorCallResponseBody</p>
 */
public class MonitorCallResponseBody extends TeaModel {
    ...
    private MonitorCallResponseBody(Builder builder) {
    ...
    public static MonitorCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(MonitorCallResponseBody model) {
        ...
        public MonitorCallResponseBody build() {
            return new MonitorCallResponseBody(this);
        } 
