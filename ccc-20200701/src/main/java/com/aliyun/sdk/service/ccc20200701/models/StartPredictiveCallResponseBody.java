...
/**
 * 
 * {@link StartPredictiveCallResponseBody} extends {@link TeaModel}
 *
 * <p>StartPredictiveCallResponseBody</p>
 */
public class StartPredictiveCallResponseBody extends TeaModel {
    ...
    private StartPredictiveCallResponseBody(Builder builder) {
    ...
    public static StartPredictiveCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartPredictiveCallResponseBody model) {
        ...
        public StartPredictiveCallResponseBody build() {
            return new StartPredictiveCallResponseBody(this);
        } 
