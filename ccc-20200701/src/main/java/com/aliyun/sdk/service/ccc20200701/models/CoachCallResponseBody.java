...
public class CoachCallResponseBody extends TeaModel {
    ...
    public static CoachCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CoachCallResponseBody model) {
        ...
        public CoachCallResponseBody build() {
            return new CoachCallResponseBody(this);
        } 
