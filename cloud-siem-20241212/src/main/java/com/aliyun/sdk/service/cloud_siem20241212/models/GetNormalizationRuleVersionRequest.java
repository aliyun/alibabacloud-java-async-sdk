...
/**
 * 
 * {@link GetNormalizationRuleVersionRequest} extends {@link RequestModel}
 *
 * <p>GetNormalizationRuleVersionRequest</p>
 */
public class GetNormalizationRuleVersionRequest extends Request {
    ...
    private GetNormalizationRuleVersionRequest(Builder builder) {
        super(builder);
    ...
    public static GetNormalizationRuleVersionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetNormalizationRuleVersionRequest, Builder> {
        private String lang; 
        private String normalizationRuleId; 
        private Integer normalizationRuleVersion; 
        private String regionId; 
        ...
        private Builder(GetNormalizationRuleVersionRequest request) {
            super(request);
        ...
        @Override
        public GetNormalizationRuleVersionRequest build() {
            return new GetNormalizationRuleVersionRequest(this);
        } 
