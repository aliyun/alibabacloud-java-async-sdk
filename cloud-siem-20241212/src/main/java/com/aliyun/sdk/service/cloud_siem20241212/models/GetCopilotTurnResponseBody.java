...
/**
 * 
 * {@link GetCopilotTurnResponseBody} extends {@link TeaModel}
 *
 * <p>GetCopilotTurnResponseBody</p>
 */
public class GetCopilotTurnResponseBody extends TeaModel {
    ...
    private GetCopilotTurnResponseBody(Builder builder) {
    ...
    public static GetCopilotTurnResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetCopilotTurnResponseBody model) {
        ...
        public GetCopilotTurnResponseBody build() {
            return new GetCopilotTurnResponseBody(this);
        } 
