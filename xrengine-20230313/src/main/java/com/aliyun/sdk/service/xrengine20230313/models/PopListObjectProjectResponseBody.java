...
/**
 * {@link PopListObjectProjectResponseBody} extends {@link TeaModel}
 *
 * <p>PopListObjectProjectResponseBody</p>
 */
public class PopListObjectProjectResponseBody extends TeaModel {
    ...
    private PopListObjectProjectResponseBody(Builder builder) {
    ...
    public static PopListObjectProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        public PopListObjectProjectResponseBody build() {
            return new PopListObjectProjectResponseBody(this);
        } 
