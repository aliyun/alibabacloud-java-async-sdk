...
/**
 * {@link PopObjectProjectDetailResponseBody} extends {@link TeaModel}
 *
 * <p>PopObjectProjectDetailResponseBody</p>
 */
public class PopObjectProjectDetailResponseBody extends TeaModel {
    ...
    private PopObjectProjectDetailResponseBody(Builder builder) {
    ...
    public static PopObjectProjectDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        public PopObjectProjectDetailResponseBody build() {
            return new PopObjectProjectDetailResponseBody(this);
        } 
