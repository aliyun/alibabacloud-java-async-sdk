...
/**
 * {@link PopListAITryOnJobsResponseBody} extends {@link TeaModel}
 *
 * <p>PopListAITryOnJobsResponseBody</p>
 */
public class PopListAITryOnJobsResponseBody extends TeaModel {
    ...
    private PopListAITryOnJobsResponseBody(Builder builder) {
    ...
    public static PopListAITryOnJobsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public PopListAITryOnJobsResponseBody build() {
            return new PopListAITryOnJobsResponseBody(this);
        } 
