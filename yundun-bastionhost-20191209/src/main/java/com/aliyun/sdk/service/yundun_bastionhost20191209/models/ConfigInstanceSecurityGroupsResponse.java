...
public class ConfigInstanceSecurityGroupsResponse extends Response {
    ...
    private ConfigInstanceSecurityGroupsResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ConfigInstanceSecurityGroupsResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ConfigInstanceSecurityGroupsResponseBody body);

        @Override
        ConfigInstanceSecurityGroupsResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ConfigInstanceSecurityGroupsResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ConfigInstanceSecurityGroupsResponseBody body; 
        ...
        private BuilderImpl(ConfigInstanceSecurityGroupsResponse response) {
            super(response);
