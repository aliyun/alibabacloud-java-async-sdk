...
/**
 * 
 * {@link GetTagRequest} extends {@link RequestModel}
 *
 * <p>GetTagRequest</p>
 */
public class GetTagRequest extends Request {
    ...
    public static GetTagRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetTagRequest, Builder> {
        private Long baseMeAgentId; 
        private String jsonStr; 
        ...
        private Builder(GetTagRequest request) {
            super(request);
