...
public class AddRuleCategoryResponseBody extends TeaModel {
    ...
    public static AddRuleCategoryResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddRuleCategoryResponseBody model) {
        ...
        public AddRuleCategoryResponseBody build() {
            return new AddRuleCategoryResponseBody(this);
        } 
