...
public class GetRuleByIdResponseBody extends TeaModel {
    ...
    public static GetRuleByIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetRuleByIdResponseBody model) {
        ...
        public GetRuleByIdResponseBody build() {
            return new GetRuleByIdResponseBody(this);
        } 
