...
/**
 * {@link GetSyncQualityCheckResultResponseBody} extends {@link TeaModel}
 *
 * <p>GetSyncQualityCheckResultResponseBody</p>
 */
public class GetSyncQualityCheckResultResponseBody extends TeaModel {
    @NameInMap("Code")
    private String code;
    ...
    private GetSyncQualityCheckResultResponseBody(Builder builder) {
    ...
    public static GetSyncQualityCheckResultResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetSyncQualityCheckResultResponseBody build() {
            return new GetSyncQualityCheckResultResponseBody(this);
        } 
