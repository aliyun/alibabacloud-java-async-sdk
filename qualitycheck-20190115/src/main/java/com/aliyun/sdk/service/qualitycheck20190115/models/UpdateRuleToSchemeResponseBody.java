...
public class UpdateRuleToSchemeResponseBody extends TeaModel {
    ...
    private UpdateRuleToSchemeResponseBody(Builder builder) {
    ...
    public static UpdateRuleToSchemeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateRuleToSchemeResponseBody model) {
        ...
        public UpdateRuleToSchemeResponseBody build() {
            return new UpdateRuleToSchemeResponseBody(this);
        } 
