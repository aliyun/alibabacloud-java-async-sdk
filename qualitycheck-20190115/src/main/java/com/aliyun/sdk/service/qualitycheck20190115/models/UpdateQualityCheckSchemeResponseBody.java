...
public class UpdateQualityCheckSchemeResponseBody extends TeaModel {
    ...
    private UpdateQualityCheckSchemeResponseBody(Builder builder) {
    ...
    public static UpdateQualityCheckSchemeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateQualityCheckSchemeResponseBody model) {
        ...
        public UpdateQualityCheckSchemeResponseBody build() {
            return new UpdateQualityCheckSchemeResponseBody(this);
        } 
