...
public class UploadRuleResponseBody extends TeaModel {
    ...
    public static UploadRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UploadRuleResponseBody model) {
        ...
        public UploadRuleResponseBody build() {
            return new UploadRuleResponseBody(this);
        } 
