...
public class DescribeInstanceSpecInfoRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DescribeInstanceSpecInfoRequest, Builder> {
        private String instanceId; 
        private String regionId; 
        private String resourceGroupId; 
        ...
        private Builder(DescribeInstanceSpecInfoRequest request) {
            super(request);
