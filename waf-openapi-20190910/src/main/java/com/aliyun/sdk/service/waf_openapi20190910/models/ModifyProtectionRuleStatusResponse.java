...
public class ModifyProtectionRuleStatusResponse extends Response {
    ...
    private ModifyProtectionRuleStatusResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ModifyProtectionRuleStatusResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ModifyProtectionRuleStatusResponseBody body);

        @Override
        ModifyProtectionRuleStatusResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ModifyProtectionRuleStatusResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ModifyProtectionRuleStatusResponseBody body; 
        ...
        private BuilderImpl(ModifyProtectionRuleStatusResponse response) {
            super(response);
