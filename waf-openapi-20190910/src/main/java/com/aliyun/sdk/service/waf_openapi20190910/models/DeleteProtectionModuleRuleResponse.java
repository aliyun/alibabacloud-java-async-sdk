...
public class DeleteProtectionModuleRuleResponse extends Response {
    ...
    private DeleteProtectionModuleRuleResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<DeleteProtectionModuleRuleResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(DeleteProtectionModuleRuleResponseBody body);

        @Override
        DeleteProtectionModuleRuleResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<DeleteProtectionModuleRuleResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private DeleteProtectionModuleRuleResponseBody body; 
        ...
        private BuilderImpl(DeleteProtectionModuleRuleResponse response) {
            super(response);
