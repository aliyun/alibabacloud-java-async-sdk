...
public class DescribeProtectionModuleRulesRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DescribeProtectionModuleRulesRequest, Builder> {
        private String defenseType; 
        private String domain; 
        private String instanceId; 
        private String lang; 
        ...
        private Builder(DescribeProtectionModuleRulesRequest request) {
            super(request);
