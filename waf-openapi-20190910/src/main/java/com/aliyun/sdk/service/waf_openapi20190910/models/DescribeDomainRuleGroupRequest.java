...
public class DescribeDomainRuleGroupRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DescribeDomainRuleGroupRequest, Builder> {
        private String domain; 
        private String instanceId; 
        private String regionId; 
        private String resourceGroupId; 
        ...
        private Builder(DescribeDomainRuleGroupRequest request) {
            super(request);
