...
public class DeleteProtectionModuleRuleRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<DeleteProtectionModuleRuleRequest, Builder> {
        private String defenseType; 
        private String domain; 
        private String instanceId; 
        private String regionId; 
        ...
        private Builder(DeleteProtectionModuleRuleRequest request) {
            super(request);
