...
public class CreateCertificateByCertificateIdResponse extends Response {
    ...
    private CreateCertificateByCertificateIdResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<CreateCertificateByCertificateIdResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(CreateCertificateByCertificateIdResponseBody body);

        @Override
        CreateCertificateByCertificateIdResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<CreateCertificateByCertificateIdResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private CreateCertificateByCertificateIdResponseBody body; 
        ...
        private BuilderImpl(CreateCertificateByCertificateIdResponse response) {
            super(response);
