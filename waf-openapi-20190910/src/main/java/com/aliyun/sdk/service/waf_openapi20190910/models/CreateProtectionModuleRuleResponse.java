...
public class CreateProtectionModuleRuleResponse extends Response {
    ...
    private CreateProtectionModuleRuleResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<CreateProtectionModuleRuleResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(CreateProtectionModuleRuleResponseBody body);

        @Override
        CreateProtectionModuleRuleResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<CreateProtectionModuleRuleResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private CreateProtectionModuleRuleResponseBody body; 
        ...
        private BuilderImpl(CreateProtectionModuleRuleResponse response) {
            super(response);
