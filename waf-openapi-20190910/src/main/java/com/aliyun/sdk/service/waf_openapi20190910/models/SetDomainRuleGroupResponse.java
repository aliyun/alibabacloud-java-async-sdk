...
public class SetDomainRuleGroupResponse extends Response {
    ...
    private SetDomainRuleGroupResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<SetDomainRuleGroupResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(SetDomainRuleGroupResponseBody body);

        @Override
        SetDomainRuleGroupResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<SetDomainRuleGroupResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private SetDomainRuleGroupResponseBody body; 
        ...
        private BuilderImpl(SetDomainRuleGroupResponse response) {
            super(response);
