...
public class ModifyLogRetrievalStatusResponse extends Response {
    ...
    private ModifyLogRetrievalStatusResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ModifyLogRetrievalStatusResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder statusCode(Integer statusCode);

        Builder body(ModifyLogRetrievalStatusResponseBody body);

        @Override
        ModifyLogRetrievalStatusResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ModifyLogRetrievalStatusResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ModifyLogRetrievalStatusResponseBody body; 
        ...
        private BuilderImpl(ModifyLogRetrievalStatusResponse response) {
            super(response);
