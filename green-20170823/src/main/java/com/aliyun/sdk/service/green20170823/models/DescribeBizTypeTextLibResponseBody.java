...
/**
 * {@link DescribeBizTypeTextLibResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeBizTypeTextLibResponseBody</p>
 */
public class DescribeBizTypeTextLibResponseBody extends TeaModel {
    ...
    private DescribeBizTypeTextLibResponseBody(Builder builder) {
    ...
    public static DescribeBizTypeTextLibResponseBody create() {
    ...
    public static final class Builder {
         ...
         * Ignore.
         */
        public Builder ignore(Ignore ignore) {
            this.ignore = ignore;
            return this;
        }
        ...
        public DescribeBizTypeTextLibResponseBody build() {
            return new DescribeBizTypeTextLibResponseBody(this);
        } 
    ...
    public static class IgnoreAll extends TeaModel {
        @NameInMap("Code")
        private String code;
        ...
        private IgnoreAll(Builder builder) {
            this.code = builder.code;
            this.name = builder.name;
        }
        ...
        public static IgnoreAll create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public IgnoreAll build() {
                return new IgnoreAll(this);
            } 

        } 

    }
    public static class IgnoreSelected extends TeaModel {
        @NameInMap("Code")
        private String code;
        ...
        private IgnoreSelected(Builder builder) {
            this.code = builder.code;
            this.name = builder.name;
        }
        ...
        public static IgnoreSelected create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public IgnoreSelected build() {
                return new IgnoreSelected(this);
            } 

        } 

    }
    public static class Ignore extends TeaModel {
        @NameInMap("All")
        private java.util.List < IgnoreAll> all;

        @NameInMap("Selected")
        private java.util.List < IgnoreSelected> selected;

        private Ignore(Builder builder) {
            this.all = builder.all;
            this.selected = builder.selected;
        }
         ...
         * @return all
         */
        public java.util.List < IgnoreAll> getAll() {
            return this.all;
        }
         ...
         * @return selected
         */
        public java.util.List < IgnoreSelected> getSelected() {
            return this.selected;
        }
        ...
        public static final class Builder {
             ...
             * All.
             */
            public Builder all(java.util.List < IgnoreAll> all) {
                this.all = all;
                return this;
            }
             ...
             * Selected.
             */
            public Builder selected(java.util.List < IgnoreSelected> selected) {
                this.selected = selected;
                return this;
            }
