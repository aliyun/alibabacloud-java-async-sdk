...
public class ListUserTemplatesResponseBody extends TeaModel {
    ...
    private ListUserTemplatesResponseBody(Builder builder) {
    ...
    public static ListUserTemplatesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListUserTemplatesResponseBody build() {
            return new ListUserTemplatesResponseBody(this);
        } 
