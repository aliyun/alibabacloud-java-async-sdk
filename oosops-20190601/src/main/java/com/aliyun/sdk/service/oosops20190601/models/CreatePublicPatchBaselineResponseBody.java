...
public class CreatePublicPatchBaselineResponseBody extends TeaModel {
    ...
    private CreatePublicPatchBaselineResponseBody(Builder builder) {
    ...
    public static CreatePublicPatchBaselineResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreatePublicPatchBaselineResponseBody build() {
            return new CreatePublicPatchBaselineResponseBody(this);
        } 
