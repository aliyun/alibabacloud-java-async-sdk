...
/**
 * 
 * {@link UpdatePublicPatchBaselineResponseBody} extends {@link TeaModel}
 *
 * <p>UpdatePublicPatchBaselineResponseBody</p>
 */
public class UpdatePublicPatchBaselineResponseBody extends TeaModel {
    ...
    private UpdatePublicPatchBaselineResponseBody(Builder builder) {
    ...
    public static UpdatePublicPatchBaselineResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdatePublicPatchBaselineResponseBody build() {
            return new UpdatePublicPatchBaselineResponseBody(this);
        } 
