...
/**
 * 
 * {@link CreatePublicParameterResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePublicParameterResponseBody</p>
 */
public class CreatePublicParameterResponseBody extends TeaModel {
    ...
    private CreatePublicParameterResponseBody(Builder builder) {
    ...
    public static CreatePublicParameterResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreatePublicParameterResponseBody build() {
            return new CreatePublicParameterResponseBody(this);
        } 
