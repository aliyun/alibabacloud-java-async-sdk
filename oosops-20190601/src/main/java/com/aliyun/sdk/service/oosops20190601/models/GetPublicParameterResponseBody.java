...
/**
 * 
 * {@link GetPublicParameterResponseBody} extends {@link TeaModel}
 *
 * <p>GetPublicParameterResponseBody</p>
 */
public class GetPublicParameterResponseBody extends TeaModel {
    ...
    private GetPublicParameterResponseBody(Builder builder) {
    ...
    public static GetPublicParameterResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetPublicParameterResponseBody build() {
            return new GetPublicParameterResponseBody(this);
        } 
