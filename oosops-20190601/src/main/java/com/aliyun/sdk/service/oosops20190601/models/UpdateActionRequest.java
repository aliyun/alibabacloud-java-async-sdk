...
public class UpdateActionRequest extends Request {
    ...
    private UpdateActionRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateActionRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateActionRequest, Builder> {
        private String actionName; 
        private String actionType; 
        private String content; 
        private Integer popularity; 
        ...
        private Builder(UpdateActionRequest request) {
            super(request);
