...
/**
 * 
 * {@link GetPublishTaskStateResponseBody} extends {@link TeaModel}
 *
 * <p>GetPublishTaskStateResponseBody</p>
 */
public class GetPublishTaskStateResponseBody extends TeaModel {
    ...
    private GetPublishTaskStateResponseBody(Builder builder) {
    ...
    public static GetPublishTaskStateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetPublishTaskStateResponseBody model) {
        ...
        public GetPublishTaskStateResponseBody build() {
            return new GetPublishTaskStateResponseBody(this);
        } 
