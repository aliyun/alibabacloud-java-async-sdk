...
public class DescribeSceneAllEventNameCodeListResponseBody extends TeaModel {
    ...
    private DescribeSceneAllEventNameCodeListResponseBody(Builder builder) {
    ...
    public static final class Builder {
        ...
        public DescribeSceneAllEventNameCodeListResponseBody build() {
            return new DescribeSceneAllEventNameCodeListResponseBody(this);
        } 
