...
/**
 * 
 * {@link DescribeHitRuleTrendResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeHitRuleTrendResponseBody</p>
 */
public class DescribeHitRuleTrendResponseBody extends TeaModel {
    ...
    private DescribeHitRuleTrendResponseBody(Builder builder) {
    ...
    public static DescribeHitRuleTrendResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeHitRuleTrendResponseBody model) {
        ...
        public DescribeHitRuleTrendResponseBody build() {
            return new DescribeHitRuleTrendResponseBody(this);
        } 
