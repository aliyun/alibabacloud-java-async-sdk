...
/**
 * 
 * {@link DescribeTagsBarChartResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeTagsBarChartResponseBody</p>
 */
public class DescribeTagsBarChartResponseBody extends TeaModel {
    ...
    private DescribeTagsBarChartResponseBody(Builder builder) {
    ...
    public static DescribeTagsBarChartResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeTagsBarChartResponseBody model) {
        ...
        public DescribeTagsBarChartResponseBody build() {
            return new DescribeTagsBarChartResponseBody(this);
        } 
