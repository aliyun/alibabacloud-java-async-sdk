...
/**
 * {@link DescribeTagsNumLineChartRequest} extends {@link RequestModel}
 *
 * <p>DescribeTagsNumLineChartRequest</p>
 */
public class DescribeTagsNumLineChartRequest extends Request {
    ...
    private DescribeTagsNumLineChartRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeTagsNumLineChartRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeTagsNumLineChartRequest, Builder> {
        private String lang; 
        private String beginTime; 
        private String byPassEventCodes; 
        private String endTime; 
        ...
        private Builder(DescribeTagsNumLineChartRequest request) {
            super(request);
        ...
        @Override
        public DescribeTagsNumLineChartRequest build() {
            return new DescribeTagsNumLineChartRequest(this);
        } 
