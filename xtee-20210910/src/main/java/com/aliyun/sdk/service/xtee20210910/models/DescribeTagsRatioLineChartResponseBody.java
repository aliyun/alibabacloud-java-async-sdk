...
public class DescribeTagsRatioLineChartResponseBody extends TeaModel {
    ...
    private DescribeTagsRatioLineChartResponseBody(Builder builder) {
    ...
    public static DescribeTagsRatioLineChartResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeTagsRatioLineChartResponseBody build() {
            return new DescribeTagsRatioLineChartResponseBody(this);
        } 
