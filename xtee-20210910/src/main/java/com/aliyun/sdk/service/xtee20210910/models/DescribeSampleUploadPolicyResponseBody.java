...
public class DescribeSampleUploadPolicyResponseBody extends TeaModel {
    ...
    private DescribeSampleUploadPolicyResponseBody(Builder builder) {
    ...
    public static final class Builder {
        ...
        public DescribeSampleUploadPolicyResponseBody build() {
            return new DescribeSampleUploadPolicyResponseBody(this);
        } 
