...
/**
 * 
 * {@link DescribeScoreSectionNumLineChartResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScoreSectionNumLineChartResponseBody</p>
 */
public class DescribeScoreSectionNumLineChartResponseBody extends TeaModel {
    ...
    private DescribeScoreSectionNumLineChartResponseBody(Builder builder) {
    ...
    public static DescribeScoreSectionNumLineChartResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeScoreSectionNumLineChartResponseBody model) {
        ...
        public DescribeScoreSectionNumLineChartResponseBody build() {
            return new DescribeScoreSectionNumLineChartResponseBody(this);
        } 
