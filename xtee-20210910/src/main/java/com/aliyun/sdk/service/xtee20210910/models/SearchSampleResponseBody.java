...
/**
 * 
 * {@link SearchSampleResponseBody} extends {@link TeaModel}
 *
 * <p>SearchSampleResponseBody</p>
 */
public class SearchSampleResponseBody extends TeaModel {
    ...
    private SearchSampleResponseBody(Builder builder) {
    ...
    public static SearchSampleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SearchSampleResponseBody model) {
        ...
        public SearchSampleResponseBody build() {
            return new SearchSampleResponseBody(this);
        } 
