...
/**
 * 
 * {@link DescribeSampleDataByBatchUUidPageRequest} extends {@link RequestModel}
 *
 * <p>DescribeSampleDataByBatchUUidPageRequest</p>
 */
public class DescribeSampleDataByBatchUUidPageRequest extends Request {
    ...
    private DescribeSampleDataByBatchUUidPageRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSampleDataByBatchUUidPageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSampleDataByBatchUUidPageRequest, Builder> {
        private String lang; 
        private String batchUuid; 
        private Integer currentPage; 
        private String dataValue; 
        ...
        private Builder(DescribeSampleDataByBatchUUidPageRequest request) {
            super(request);
        ...
        @Override
        public DescribeSampleDataByBatchUUidPageRequest build() {
            return new DescribeSampleDataByBatchUUidPageRequest(this);
        } 
