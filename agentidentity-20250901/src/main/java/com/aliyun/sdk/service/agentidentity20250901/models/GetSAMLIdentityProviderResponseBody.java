...
/**
 * 
 * {@link GetSAMLIdentityProviderResponseBody} extends {@link TeaModel}
 *
 * <p>GetSAMLIdentityProviderResponseBody</p>
 */
public class GetSAMLIdentityProviderResponseBody extends TeaModel {
    ...
    private GetSAMLIdentityProviderResponseBody(Builder builder) {
    ...
    public static GetSAMLIdentityProviderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetSAMLIdentityProviderResponseBody model) {
        ...
        public GetSAMLIdentityProviderResponseBody build() {
            return new GetSAMLIdentityProviderResponseBody(this);
        } 
