...
/**
 * 
 * {@link CreateWorkloadIdentityResponseBody} extends {@link TeaModel}
 *
 * <p>CreateWorkloadIdentityResponseBody</p>
 */
public class CreateWorkloadIdentityResponseBody extends TeaModel {
    ...
    private CreateWorkloadIdentityResponseBody(Builder builder) {
    ...
    public static CreateWorkloadIdentityResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateWorkloadIdentityResponseBody model) {
        ...
        public CreateWorkloadIdentityResponseBody build() {
            return new CreateWorkloadIdentityResponseBody(this);
        } 
