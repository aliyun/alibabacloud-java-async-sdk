...
/**
 * 
 * {@link SetSpecificIdentityProviderResponseBody} extends {@link TeaModel}
 *
 * <p>SetSpecificIdentityProviderResponseBody</p>
 */
public class SetSpecificIdentityProviderResponseBody extends TeaModel {
    ...
    private SetSpecificIdentityProviderResponseBody(Builder builder) {
    ...
    public static SetSpecificIdentityProviderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SetSpecificIdentityProviderResponseBody model) {
        ...
        public SetSpecificIdentityProviderResponseBody build() {
            return new SetSpecificIdentityProviderResponseBody(this);
        } 
