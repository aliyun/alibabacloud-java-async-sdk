...
/**
 * 
 * {@link UpdateUserPoolRequest} extends {@link RequestModel}
 *
 * <p>UpdateUserPoolRequest</p>
 */
public class UpdateUserPoolRequest extends Request {
    ...
    public static UpdateUserPoolRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateUserPoolRequest, Builder> {
        private String description; 
        private String userPoolName; 
        ...
        private Builder(UpdateUserPoolRequest request) {
            super(request);
