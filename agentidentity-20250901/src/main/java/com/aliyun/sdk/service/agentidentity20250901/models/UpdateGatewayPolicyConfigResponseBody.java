...
/**
 * 
 * {@link UpdateGatewayPolicyConfigResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateGatewayPolicyConfigResponseBody</p>
 */
public class UpdateGatewayPolicyConfigResponseBody extends TeaModel {
    ...
    private UpdateGatewayPolicyConfigResponseBody(Builder builder) {
    ...
    public static UpdateGatewayPolicyConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGatewayPolicyConfigResponseBody model) {
        ...
        public UpdateGatewayPolicyConfigResponseBody build() {
            return new UpdateGatewayPolicyConfigResponseBody(this);
        } 
