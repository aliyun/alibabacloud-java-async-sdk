...
/**
 * 
 * {@link GetAPIKeyCredentialProviderResponseBody} extends {@link TeaModel}
 *
 * <p>GetAPIKeyCredentialProviderResponseBody</p>
 */
public class GetAPIKeyCredentialProviderResponseBody extends TeaModel {
    ...
    private GetAPIKeyCredentialProviderResponseBody(Builder builder) {
    ...
    public static GetAPIKeyCredentialProviderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAPIKeyCredentialProviderResponseBody model) {
        ...
        public GetAPIKeyCredentialProviderResponseBody build() {
            return new GetAPIKeyCredentialProviderResponseBody(this);
        } 
