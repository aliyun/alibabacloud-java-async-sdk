...
/**
 * 
 * {@link AttachExpressConnectRouterChildInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>AttachExpressConnectRouterChildInstanceResponseBody</p>
 */
public class AttachExpressConnectRouterChildInstanceResponseBody extends TeaModel {
    ...
    private AttachExpressConnectRouterChildInstanceResponseBody(Builder builder) {
    ...
    public static AttachExpressConnectRouterChildInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AttachExpressConnectRouterChildInstanceResponseBody model) {
        ...
        public AttachExpressConnectRouterChildInstanceResponseBody build() {
            return new AttachExpressConnectRouterChildInstanceResponseBody(this);
        } 
