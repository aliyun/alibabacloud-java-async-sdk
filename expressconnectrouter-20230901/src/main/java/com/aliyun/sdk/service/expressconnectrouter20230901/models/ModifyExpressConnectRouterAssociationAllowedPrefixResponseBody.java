...
/**
 * 
 * {@link ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody</p>
 */
public class ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody extends TeaModel {
    ...
    private ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody(Builder builder) {
    ...
    public static ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody model) {
        ...
        public ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody build() {
            return new ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody(this);
        } 
