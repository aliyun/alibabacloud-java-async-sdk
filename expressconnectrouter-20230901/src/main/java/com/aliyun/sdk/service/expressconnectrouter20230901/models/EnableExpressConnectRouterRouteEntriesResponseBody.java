...
/**
 * 
 * {@link EnableExpressConnectRouterRouteEntriesResponseBody} extends {@link TeaModel}
 *
 * <p>EnableExpressConnectRouterRouteEntriesResponseBody</p>
 */
public class EnableExpressConnectRouterRouteEntriesResponseBody extends TeaModel {
    ...
    private EnableExpressConnectRouterRouteEntriesResponseBody(Builder builder) {
    ...
    public static EnableExpressConnectRouterRouteEntriesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(EnableExpressConnectRouterRouteEntriesResponseBody model) {
        ...
        public EnableExpressConnectRouterRouteEntriesResponseBody build() {
            return new EnableExpressConnectRouterRouteEntriesResponseBody(this);
        } 
