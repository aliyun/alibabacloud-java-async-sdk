...
/**
 * {@link RevokeInstanceFromExpressConnectRouterRequest} extends {@link RequestModel}
 *
 * <p>RevokeInstanceFromExpressConnectRouterRequest</p>
 */
public class RevokeInstanceFromExpressConnectRouterRequest extends Request {
    @Body
    ...
    public static RevokeInstanceFromExpressConnectRouterRequest create() {
    ...
    public static final class Builder extends Request.Builder<RevokeInstanceFromExpressConnectRouterRequest, Builder> {
        ...
        private Builder(RevokeInstanceFromExpressConnectRouterRequest request) {
            super(request);
        ...
        @Override
        public RevokeInstanceFromExpressConnectRouterRequest build() {
            return new RevokeInstanceFromExpressConnectRouterRequest(this);
        } 
