...
/**
 * 
 * {@link RevokeInstanceFromExpressConnectRouterResponseBody} extends {@link TeaModel}
 *
 * <p>RevokeInstanceFromExpressConnectRouterResponseBody</p>
 */
public class RevokeInstanceFromExpressConnectRouterResponseBody extends TeaModel {
    ...
    private RevokeInstanceFromExpressConnectRouterResponseBody(Builder builder) {
    ...
    public static RevokeInstanceFromExpressConnectRouterResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RevokeInstanceFromExpressConnectRouterResponseBody model) {
        ...
        public RevokeInstanceFromExpressConnectRouterResponseBody build() {
            return new RevokeInstanceFromExpressConnectRouterResponseBody(this);
        } 
