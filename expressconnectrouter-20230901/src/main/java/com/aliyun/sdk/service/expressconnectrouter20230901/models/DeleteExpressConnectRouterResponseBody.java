...
/**
 * 
 * {@link DeleteExpressConnectRouterResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteExpressConnectRouterResponseBody</p>
 */
public class DeleteExpressConnectRouterResponseBody extends TeaModel {
    ...
    private DeleteExpressConnectRouterResponseBody(Builder builder) {
    ...
    public static DeleteExpressConnectRouterResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteExpressConnectRouterResponseBody model) {
        ...
        public DeleteExpressConnectRouterResponseBody build() {
            return new DeleteExpressConnectRouterResponseBody(this);
        } 
