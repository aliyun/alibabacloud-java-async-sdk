...
/**
 * 
 * {@link CreateExpressConnectRouterAssociationResponseBody} extends {@link TeaModel}
 *
 * <p>CreateExpressConnectRouterAssociationResponseBody</p>
 */
public class CreateExpressConnectRouterAssociationResponseBody extends TeaModel {
    ...
    private CreateExpressConnectRouterAssociationResponseBody(Builder builder) {
    ...
    public static CreateExpressConnectRouterAssociationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateExpressConnectRouterAssociationResponseBody model) {
        ...
        public CreateExpressConnectRouterAssociationResponseBody build() {
            return new CreateExpressConnectRouterAssociationResponseBody(this);
        } 
