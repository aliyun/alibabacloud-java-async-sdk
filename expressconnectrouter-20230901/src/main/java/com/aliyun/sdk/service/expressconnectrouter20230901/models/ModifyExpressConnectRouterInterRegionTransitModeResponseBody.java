...
/**
 * 
 * {@link ModifyExpressConnectRouterInterRegionTransitModeResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyExpressConnectRouterInterRegionTransitModeResponseBody</p>
 */
public class ModifyExpressConnectRouterInterRegionTransitModeResponseBody extends TeaModel {
    ...
    private ModifyExpressConnectRouterInterRegionTransitModeResponseBody(Builder builder) {
    ...
    public static ModifyExpressConnectRouterInterRegionTransitModeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyExpressConnectRouterInterRegionTransitModeResponseBody model) {
        ...
        public ModifyExpressConnectRouterInterRegionTransitModeResponseBody build() {
            return new ModifyExpressConnectRouterInterRegionTransitModeResponseBody(this);
        } 
