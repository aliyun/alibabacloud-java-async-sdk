...
/**
 * 
 * {@link DeactivateFlowLogResponseBody} extends {@link TeaModel}
 *
 * <p>DeactivateFlowLogResponseBody</p>
 */
public class DeactivateFlowLogResponseBody extends TeaModel {
    ...
    private DeactivateFlowLogResponseBody(Builder builder) {
    ...
    public static DeactivateFlowLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeactivateFlowLogResponseBody model) {
        ...
        public DeactivateFlowLogResponseBody build() {
            return new DeactivateFlowLogResponseBody(this);
        } 
