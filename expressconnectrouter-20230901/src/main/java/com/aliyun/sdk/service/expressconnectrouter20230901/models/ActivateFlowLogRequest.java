...
/**
 * 
 * {@link ActivateFlowLogRequest} extends {@link RequestModel}
 *
 * <p>ActivateFlowLogRequest</p>
 */
public class ActivateFlowLogRequest extends Request {
    ...
    public static ActivateFlowLogRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ActivateFlowLogRequest, Builder> {
        ...
        private Builder(ActivateFlowLogRequest request) {
            super(request);
        ...
        @Override
        public ActivateFlowLogRequest build() {
            return new ActivateFlowLogRequest(this);
        } 
