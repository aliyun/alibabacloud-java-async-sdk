...
/**
 * 
 * {@link SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody} extends {@link TeaModel}
 *
 * <p>SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody</p>
 */
public class SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody extends TeaModel {
    ...
    private SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody(Builder builder) {
    ...
    public static SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody model) {
        ...
        public SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody build() {
            return new SynchronizeExpressConnectRouterInterRegionBandwidthResponseBody(this);
        } 
