...
/**
 * 
 * {@link ActivateFlowLogResponseBody} extends {@link TeaModel}
 *
 * <p>ActivateFlowLogResponseBody</p>
 */
public class ActivateFlowLogResponseBody extends TeaModel {
    ...
    private ActivateFlowLogResponseBody(Builder builder) {
    ...
    public static ActivateFlowLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ActivateFlowLogResponseBody model) {
        ...
        public ActivateFlowLogResponseBody build() {
            return new ActivateFlowLogResponseBody(this);
        } 
