...
/**
 * 
 * {@link ModifyExpressConnectRouterResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyExpressConnectRouterResponseBody</p>
 */
public class ModifyExpressConnectRouterResponseBody extends TeaModel {
    ...
    private ModifyExpressConnectRouterResponseBody(Builder builder) {
    ...
    public static ModifyExpressConnectRouterResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyExpressConnectRouterResponseBody model) {
        ...
        public ModifyExpressConnectRouterResponseBody build() {
            return new ModifyExpressConnectRouterResponseBody(this);
        } 
