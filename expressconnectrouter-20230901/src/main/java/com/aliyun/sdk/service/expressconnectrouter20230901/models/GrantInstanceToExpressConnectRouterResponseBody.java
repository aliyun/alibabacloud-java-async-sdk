...
/**
 * 
 * {@link GrantInstanceToExpressConnectRouterResponseBody} extends {@link TeaModel}
 *
 * <p>GrantInstanceToExpressConnectRouterResponseBody</p>
 */
public class GrantInstanceToExpressConnectRouterResponseBody extends TeaModel {
    ...
    private GrantInstanceToExpressConnectRouterResponseBody(Builder builder) {
    ...
    public static GrantInstanceToExpressConnectRouterResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GrantInstanceToExpressConnectRouterResponseBody model) {
        ...
        public GrantInstanceToExpressConnectRouterResponseBody build() {
            return new GrantInstanceToExpressConnectRouterResponseBody(this);
        } 
