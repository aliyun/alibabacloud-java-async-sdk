...
/**
 * 
 * {@link DescribeExpressConnectRouterRegionResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeExpressConnectRouterRegionResponseBody</p>
 */
public class DescribeExpressConnectRouterRegionResponseBody extends TeaModel {
    ...
    @com.aliyun.core.annotation.NameInMap("RegionIdList")
    ...
    private DescribeExpressConnectRouterRegionResponseBody(Builder builder) {
    ...
    public static DescribeExpressConnectRouterRegionResponseBody create() {
    ...
    public static final class Builder {
        ...
        /**
         * <p>The region in which the ECR feature is activated.</p>
         */
        public Builder regionIdList(java.util.List<String> regionIdList) {
        ...
        public DescribeExpressConnectRouterRegionResponseBody build() {
            return new DescribeExpressConnectRouterRegionResponseBody(this);
        } 
