...
/**
 * 
 * {@link DetachExpressConnectRouterChildInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>DetachExpressConnectRouterChildInstanceResponseBody</p>
 */
public class DetachExpressConnectRouterChildInstanceResponseBody extends TeaModel {
    ...
    private DetachExpressConnectRouterChildInstanceResponseBody(Builder builder) {
    ...
    public static DetachExpressConnectRouterChildInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DetachExpressConnectRouterChildInstanceResponseBody model) {
        ...
        public DetachExpressConnectRouterChildInstanceResponseBody build() {
            return new DetachExpressConnectRouterChildInstanceResponseBody(this);
        } 
