...
/**
 * 
 * {@link DisableExpressConnectRouterRouteEntriesResponseBody} extends {@link TeaModel}
 *
 * <p>DisableExpressConnectRouterRouteEntriesResponseBody</p>
 */
public class DisableExpressConnectRouterRouteEntriesResponseBody extends TeaModel {
    ...
    private DisableExpressConnectRouterRouteEntriesResponseBody(Builder builder) {
    ...
    public static DisableExpressConnectRouterRouteEntriesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DisableExpressConnectRouterRouteEntriesResponseBody model) {
        ...
        public DisableExpressConnectRouterRouteEntriesResponseBody build() {
            return new DisableExpressConnectRouterRouteEntriesResponseBody(this);
        } 
