...
/**
 * 
 * {@link ForceDeleteExpressConnectRouterResponseBody} extends {@link TeaModel}
 *
 * <p>ForceDeleteExpressConnectRouterResponseBody</p>
 */
public class ForceDeleteExpressConnectRouterResponseBody extends TeaModel {
    ...
    private ForceDeleteExpressConnectRouterResponseBody(Builder builder) {
    ...
    public static ForceDeleteExpressConnectRouterResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ForceDeleteExpressConnectRouterResponseBody model) {
        ...
        public ForceDeleteExpressConnectRouterResponseBody build() {
            return new ForceDeleteExpressConnectRouterResponseBody(this);
        } 
