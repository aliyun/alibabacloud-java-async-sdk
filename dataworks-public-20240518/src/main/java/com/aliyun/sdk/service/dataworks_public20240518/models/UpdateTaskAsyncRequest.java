...
/**
 * 
 * {@link UpdateTaskAsyncRequest} extends {@link RequestModel}
 *
 * <p>UpdateTaskAsyncRequest</p>
 */
public class UpdateTaskAsyncRequest extends Request {
    ...
    private UpdateTaskAsyncRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateTaskAsyncRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateTaskAsyncRequest, Builder> {
        private String regionId; 
        private String clientUniqueCode; 
        private DataSource dataSource; 
        private java.util.List<Dependencies> dependencies; 
        ...
        private Builder(UpdateTaskAsyncRequest request) {
            super(request);
        ...
        @Override
        public UpdateTaskAsyncRequest build() {
            return new UpdateTaskAsyncRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateTaskAsyncRequest} extends {@link TeaModel}
     *
     * <p>UpdateTaskAsyncRequest</p>
     */
