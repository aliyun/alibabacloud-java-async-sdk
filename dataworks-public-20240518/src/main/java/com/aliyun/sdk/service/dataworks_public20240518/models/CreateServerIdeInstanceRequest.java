...
/**
 * 
 * {@link CreateServerIdeInstanceRequest} extends {@link RequestModel}
 *
 * <p>CreateServerIdeInstanceRequest</p>
 */
public class CreateServerIdeInstanceRequest extends Request {
    ...
    private CreateServerIdeInstanceRequest(Builder builder) {
        super(builder);
    ...
    public static CreateServerIdeInstanceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateServerIdeInstanceRequest, Builder> {
        private String regionId; 
        private CredentialConfig credentialConfig; 
        private Integer cu; 
        private java.util.List<Datasets> datasets; 
        ...
        private Builder(CreateServerIdeInstanceRequest request) {
            super(request);
        ...
        public Builder userCommand(UserCommand userCommand) {
            ...
            this.putBodyParameter("UserCommand", userCommandShrink);
        ...
        @Override
        public CreateServerIdeInstanceRequest build() {
            return new CreateServerIdeInstanceRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateServerIdeInstanceRequest} extends {@link TeaModel}
     *
     * <p>CreateServerIdeInstanceRequest</p>
     */
