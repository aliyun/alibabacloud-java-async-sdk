...
/**
 * 
 * {@link CreateSecurityStrategyRequest} extends {@link RequestModel}
 *
 * <p>CreateSecurityStrategyRequest</p>
 */
public class CreateSecurityStrategyRequest extends Request {
    ...
    private CreateSecurityStrategyRequest(Builder builder) {
        super(builder);
    ...
    public static CreateSecurityStrategyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateSecurityStrategyRequest, Builder> {
        private String regionId; 
        private String clientToken; 
        private Content content; 
        private String controlDwScope; 
        ...
        private Builder(CreateSecurityStrategyRequest request) {
            super(request);
            this.regionId = request.regionId;
            this.clientToken = request.clientToken;
            this.content = request.content;
            this.controlDwScope = request.controlDwScope;
        ...
        public Builder controlDwScope(String controlDwScope) {
            this.putBodyParameter("ControlDwScope", controlDwScope);
        ...
        @Override
        public CreateSecurityStrategyRequest build() {
            return new CreateSecurityStrategyRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateSecurityStrategyRequest} extends {@link TeaModel}
     *
     * <p>CreateSecurityStrategyRequest</p>
     */
