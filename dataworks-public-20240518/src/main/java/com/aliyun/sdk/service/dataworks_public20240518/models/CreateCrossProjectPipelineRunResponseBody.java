...
/**
 * 
 * {@link CreateCrossProjectPipelineRunResponseBody} extends {@link TeaModel}
 *
 * <p>CreateCrossProjectPipelineRunResponseBody</p>
 */
public class CreateCrossProjectPipelineRunResponseBody extends TeaModel {
    ...
    private CreateCrossProjectPipelineRunResponseBody(Builder builder) {
    ...
    public static CreateCrossProjectPipelineRunResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateCrossProjectPipelineRunResponseBody model) {
        ...
        public CreateCrossProjectPipelineRunResponseBody build() {
            return new CreateCrossProjectPipelineRunResponseBody(this);
        } 
