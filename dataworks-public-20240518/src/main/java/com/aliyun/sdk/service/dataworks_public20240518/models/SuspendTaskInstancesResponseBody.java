...
/**
 * 
 * {@link SuspendTaskInstancesResponseBody} extends {@link TeaModel}
 *
 * <p>SuspendTaskInstancesResponseBody</p>
 */
public class SuspendTaskInstancesResponseBody extends TeaModel {
    ...
    private SuspendTaskInstancesResponseBody(Builder builder) {
    ...
    public static SuspendTaskInstancesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SuspendTaskInstancesResponseBody model) {
        ...
        public SuspendTaskInstancesResponseBody build() {
            return new SuspendTaskInstancesResponseBody(this);
        } 
