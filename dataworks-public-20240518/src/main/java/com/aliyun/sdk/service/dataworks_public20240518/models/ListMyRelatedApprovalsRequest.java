...
/**
 * 
 * {@link ListMyRelatedApprovalsRequest} extends {@link RequestModel}
 *
 * <p>ListMyRelatedApprovalsRequest</p>
 */
public class ListMyRelatedApprovalsRequest extends Request {
    ...
    private ListMyRelatedApprovalsRequest(Builder builder) {
        super(builder);
    ...
    public static ListMyRelatedApprovalsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListMyRelatedApprovalsRequest, Builder> {
        private String regionId; 
        private java.util.List<String> accessTypes; 
        private String defSchema; 
        private Long endTime; 
        ...
        private Builder(ListMyRelatedApprovalsRequest request) {
            super(request);
        ...
        @Override
        public ListMyRelatedApprovalsRequest build() {
            return new ListMyRelatedApprovalsRequest(this);
        } 
    ...
    /**
     * 
     * {@link ListMyRelatedApprovalsRequest} extends {@link TeaModel}
     *
     * <p>ListMyRelatedApprovalsRequest</p>
     */
