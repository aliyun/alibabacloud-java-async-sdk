...
/**
 * 
 * {@link CreateDataQualityAlertRuleRequest} extends {@link RequestModel}
 *
 * <p>CreateDataQualityAlertRuleRequest</p>
 */
public class CreateDataQualityAlertRuleRequest extends Request {
    ...
    private CreateDataQualityAlertRuleRequest(Builder builder) {
        super(builder);
    ...
    public static CreateDataQualityAlertRuleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateDataQualityAlertRuleRequest, Builder> {
        private String regionId; 
        private String condition; 
        private Notification notification; 
        private Long projectId; 
        ...
        private Builder(CreateDataQualityAlertRuleRequest request) {
            super(request);
        ...
        @Override
        public CreateDataQualityAlertRuleRequest build() {
            return new CreateDataQualityAlertRuleRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateDataQualityAlertRuleRequest} extends {@link TeaModel}
     *
     * <p>CreateDataQualityAlertRuleRequest</p>
     */
