...
/**
 * 
 * {@link CancelAgentSessionResponseBody} extends {@link TeaModel}
 *
 * <p>CancelAgentSessionResponseBody</p>
 */
public class CancelAgentSessionResponseBody extends TeaModel {
    ...
    private CancelAgentSessionResponseBody(Builder builder) {
    ...
    public static CancelAgentSessionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CancelAgentSessionResponseBody model) {
        ...
        public CancelAgentSessionResponseBody build() {
            return new CancelAgentSessionResponseBody(this);
        } 
