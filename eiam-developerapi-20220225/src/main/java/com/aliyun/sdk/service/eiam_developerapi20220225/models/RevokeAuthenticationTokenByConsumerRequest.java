...
/**
 * 
 * {@link RevokeAuthenticationTokenByConsumerRequest} extends {@link RequestModel}
 *
 * <p>RevokeAuthenticationTokenByConsumerRequest</p>
 */
public class RevokeAuthenticationTokenByConsumerRequest extends Request {
    ...
    private RevokeAuthenticationTokenByConsumerRequest(Builder builder) {
        super(builder);
    ...
    public static RevokeAuthenticationTokenByConsumerRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<RevokeAuthenticationTokenByConsumerRequest, Builder> {
        private String regionId; 
        private String instanceId; 
        private String authorization; 
        private String consumerId; 
        ...
        private Builder(RevokeAuthenticationTokenByConsumerRequest request) {
            super(request);
        ...
        @Override
        public RevokeAuthenticationTokenByConsumerRequest build() {
            return new RevokeAuthenticationTokenByConsumerRequest(this);
        } 
