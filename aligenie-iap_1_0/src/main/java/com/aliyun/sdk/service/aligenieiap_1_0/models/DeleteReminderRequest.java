...
/**
 * 
 * {@link DeleteReminderRequest} extends {@link RequestModel}
 *
 * <p>DeleteReminderRequest</p>
 */
public class DeleteReminderRequest extends Request {
    ...
    private DeleteReminderRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteReminderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteReminderRequest, Builder> {
        private DeviceInfo deviceInfo; 
        private Payload payload; 
        private UserInfo userInfo; 
        ...
        private Builder(DeleteReminderRequest request) {
            super(request);
        ...
        @Override
        public DeleteReminderRequest build() {
            return new DeleteReminderRequest(this);
        } 
    ...
    /**
     * 
     * {@link DeleteReminderRequest} extends {@link TeaModel}
     *
     * <p>DeleteReminderRequest</p>
     */
