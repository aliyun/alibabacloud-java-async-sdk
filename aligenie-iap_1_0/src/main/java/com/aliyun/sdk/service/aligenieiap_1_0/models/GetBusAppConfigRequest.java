...
/**
 * 
 * {@link GetBusAppConfigRequest} extends {@link RequestModel}
 *
 * <p>GetBusAppConfigRequest</p>
 */
public class GetBusAppConfigRequest extends Request {
    ...
    private GetBusAppConfigRequest(Builder builder) {
        super(builder);
    ...
    public static GetBusAppConfigRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetBusAppConfigRequest, Builder> {
        private DeviceInfo deviceInfo; 
        private Payload payload; 
        private UserInfo userInfo; 
        ...
        private Builder(GetBusAppConfigRequest request) {
            super(request);
        ...
        @Override
        public GetBusAppConfigRequest build() {
            return new GetBusAppConfigRequest(this);
        } 
    ...
    /**
     * 
     * {@link GetBusAppConfigRequest} extends {@link TeaModel}
     *
     * <p>GetBusAppConfigRequest</p>
     */
