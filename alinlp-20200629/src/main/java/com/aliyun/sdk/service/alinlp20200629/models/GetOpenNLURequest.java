...
/**
 * {@link GetOpenNLURequest} extends {@link RequestModel}
 *
 * <p>GetOpenNLURequest</p>
 */
public class GetOpenNLURequest extends Request {
    ...
    private GetOpenNLURequest(Builder builder) {
        super(builder);
    ...
    public static GetOpenNLURequest create() {
    ...
    public static final class Builder extends Request.Builder<GetOpenNLURequest, Builder> {
        private String examples; 
        private String labels; 
        private String sentence; 
        private String serviceCode; 
        ...
        private Builder(GetOpenNLURequest request) {
            super(request);
        ...
        @Override
        public GetOpenNLURequest build() {
            return new GetOpenNLURequest(this);
        } 
