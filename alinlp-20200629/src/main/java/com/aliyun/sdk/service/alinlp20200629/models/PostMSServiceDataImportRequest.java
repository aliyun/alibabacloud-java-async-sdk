...
/**
 * {@link PostMSServiceDataImportRequest} extends {@link RequestModel}
 *
 * <p>PostMSServiceDataImportRequest</p>
 */
public class PostMSServiceDataImportRequest extends Request {
    @Body
    @NameInMap("DataType")
    ...
    private PostMSServiceDataImportRequest(Builder builder) {
        super(builder);
    ...
    public static PostMSServiceDataImportRequest create() {
    ...
    public static final class Builder extends Request.Builder<PostMSServiceDataImportRequest, Builder> {
        private String dataType; 
        private java.util.List < Documents> documents; 
        private Long serviceId; 
        ...
        private Builder(PostMSServiceDataImportRequest request) {
            super(request);
        ...
        @Override
        public PostMSServiceDataImportRequest build() {
            return new PostMSServiceDataImportRequest(this);
        } 
