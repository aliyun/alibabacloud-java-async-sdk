...
/**
 * {@link GetWeChEntertainmentRequest} extends {@link RequestModel}
 *
...
public class GetWeChEntertainmentRequest extends Request {
    ...
    public static GetWeChEntertainmentRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetWeChEntertainmentRequest, Builder> {
        private String operation; 
        private String serviceCode; 
        private String size; 
        private String text; 
        ...
        private Builder(GetWeChEntertainmentRequest request) {
            super(request);
        ...
        @Override
        public GetWeChEntertainmentRequest build() {
            return new GetWeChEntertainmentRequest(this);
        } 
