...
public class DescribeDohDomainStatisticsResponseBody extends TeaModel {
    ...
    private DescribeDohDomainStatisticsResponseBody(Builder builder) {
    ...
    public static DescribeDohDomainStatisticsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeDohDomainStatisticsResponseBody build() {
            return new DescribeDohDomainStatisticsResponseBody(this);
        } 
