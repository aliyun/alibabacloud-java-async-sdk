...
/**
 * 
 * {@link ListRecursionRecordsResponseBody} extends {@link TeaModel}
 *
 * <p>ListRecursionRecordsResponseBody</p>
 */
public class ListRecursionRecordsResponseBody extends TeaModel {
    ...
    private ListRecursionRecordsResponseBody(Builder builder) {
    ...
    public static ListRecursionRecordsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListRecursionRecordsResponseBody model) {
        ...
        public ListRecursionRecordsResponseBody build() {
            return new ListRecursionRecordsResponseBody(this);
        } 
