...
public class DeleteCloudGtmMonitorTemplateResponseBody extends TeaModel {
    ...
    private DeleteCloudGtmMonitorTemplateResponseBody(Builder builder) {
    ...
    public static DeleteCloudGtmMonitorTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteCloudGtmMonitorTemplateResponseBody model) {
        ...
        public DeleteCloudGtmMonitorTemplateResponseBody build() {
            return new DeleteCloudGtmMonitorTemplateResponseBody(this);
        } 
