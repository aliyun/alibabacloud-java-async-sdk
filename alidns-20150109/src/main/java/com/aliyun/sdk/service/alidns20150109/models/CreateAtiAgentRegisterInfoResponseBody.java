...
/**
 * 
 * {@link CreateAtiAgentRegisterInfoResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAtiAgentRegisterInfoResponseBody</p>
 */
public class CreateAtiAgentRegisterInfoResponseBody extends TeaModel {
    ...
    private CreateAtiAgentRegisterInfoResponseBody(Builder builder) {
    ...
    public static CreateAtiAgentRegisterInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAtiAgentRegisterInfoResponseBody model) {
        ...
        public CreateAtiAgentRegisterInfoResponseBody build() {
            return new CreateAtiAgentRegisterInfoResponseBody(this);
        } 
