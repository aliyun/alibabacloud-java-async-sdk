...
/**
 * 
 * {@link VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody} extends {@link TeaModel}
 *
 * <p>VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody</p>
 */
public class VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody extends TeaModel {
    ...
    @com.aliyun.core.annotation.NameInMap("VerifyTimestamp")
    private Long verifyTimestamp;

    private VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody(Builder builder) {
        ...
        this.verifyTimestamp = builder.verifyTimestamp;
    }
    ...
    public static VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody model) {
            ...
            this.verifyTimestamp = model.verifyTimestamp;
        } 
         ...
         * VerifyTimestamp.
         */
        public Builder verifyTimestamp(Long verifyTimestamp) {
            this.verifyTimestamp = verifyTimestamp;
            return this;
        }

        public VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody build() {
            return new VerifyAtiAgentRegisterInfoAcmeChallengeRecordResponseBody(this);
        } 
