...
/**
 * 
 * {@link DeleteCloudGtmInstanceConfigRequest} extends {@link RequestModel}
 *
 * <p>DeleteCloudGtmInstanceConfigRequest</p>
 */
public class DeleteCloudGtmInstanceConfigRequest extends Request {
    ...
    private DeleteCloudGtmInstanceConfigRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteCloudGtmInstanceConfigRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteCloudGtmInstanceConfigRequest, Builder> {
        private String acceptLanguage; 
        private String clientToken; 
        private String configId; 
        private String instanceId; 
        ...
        private Builder(DeleteCloudGtmInstanceConfigRequest request) {
            super(request);
        ...
        @Override
        public DeleteCloudGtmInstanceConfigRequest build() {
            return new DeleteCloudGtmInstanceConfigRequest(this);
        } 
