...
/**
 * 
 * {@link ListRecursionZonesResponseBody} extends {@link TeaModel}
 *
 * <p>ListRecursionZonesResponseBody</p>
 */
public class ListRecursionZonesResponseBody extends TeaModel {
    ...
    private ListRecursionZonesResponseBody(Builder builder) {
    ...
    public static ListRecursionZonesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListRecursionZonesResponseBody model) {
        ...
        public ListRecursionZonesResponseBody build() {
            return new ListRecursionZonesResponseBody(this);
        } 
