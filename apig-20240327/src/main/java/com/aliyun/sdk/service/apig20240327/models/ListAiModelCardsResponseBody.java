...
/**
 * 
 * {@link ListAiModelCardsResponseBody} extends {@link TeaModel}
 *
 * <p>ListAiModelCardsResponseBody</p>
 */
public class ListAiModelCardsResponseBody extends TeaModel {
    ...
    private ListAiModelCardsResponseBody(Builder builder) {
    ...
    public static ListAiModelCardsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAiModelCardsResponseBody model) {
        ...
        public ListAiModelCardsResponseBody build() {
            return new ListAiModelCardsResponseBody(this);
        } 
