...
/**
 * 
 * {@link ListAiModelProvidersResponseBody} extends {@link TeaModel}
 *
 * <p>ListAiModelProvidersResponseBody</p>
 */
public class ListAiModelProvidersResponseBody extends TeaModel {
    ...
    private ListAiModelProvidersResponseBody(Builder builder) {
    ...
    public static ListAiModelProvidersResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAiModelProvidersResponseBody model) {
        ...
        public ListAiModelProvidersResponseBody build() {
            return new ListAiModelProvidersResponseBody(this);
        } 
