...
/**
 * 
 * {@link UpdateAiModelCardRequest} extends {@link RequestModel}
 *
 * <p>UpdateAiModelCardRequest</p>
 */
public class UpdateAiModelCardRequest extends Request {
    ...
    private UpdateAiModelCardRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateAiModelCardRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateAiModelCardRequest, Builder> {
        private String modelCardId; 
        private java.util.List<AvailablePaths> availablePaths; 
        private Credit credit; 
        private java.util.Map<String, ?> features; 
        ...
        private Builder(UpdateAiModelCardRequest request) {
            super(request);
        ...
        @Override
        public UpdateAiModelCardRequest build() {
            return new UpdateAiModelCardRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateAiModelCardRequest} extends {@link TeaModel}
     *
     * <p>UpdateAiModelCardRequest</p>
     */
