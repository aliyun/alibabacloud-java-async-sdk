...
/**
 * 
 * {@link ListConsumerGroupQuotaRulesResponseBody} extends {@link TeaModel}
 *
 * <p>ListConsumerGroupQuotaRulesResponseBody</p>
 */
public class ListConsumerGroupQuotaRulesResponseBody extends TeaModel {
    ...
    private ListConsumerGroupQuotaRulesResponseBody(Builder builder) {
    ...
    public static ListConsumerGroupQuotaRulesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListConsumerGroupQuotaRulesResponseBody model) {
        ...
        public ListConsumerGroupQuotaRulesResponseBody build() {
            return new ListConsumerGroupQuotaRulesResponseBody(this);
        } 
