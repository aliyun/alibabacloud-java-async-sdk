...
/**
 * 
 * {@link UpdateAiModelProviderResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAiModelProviderResponseBody</p>
 */
public class UpdateAiModelProviderResponseBody extends TeaModel {
    ...
    private UpdateAiModelProviderResponseBody(Builder builder) {
    ...
    public static UpdateAiModelProviderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAiModelProviderResponseBody model) {
        ...
        public UpdateAiModelProviderResponseBody build() {
            return new UpdateAiModelProviderResponseBody(this);
        } 
