...
public class ListHttpApisResponseBody extends TeaModel {
    ...
    private ListHttpApisResponseBody(Builder builder) {
    ...
    public static ListHttpApisResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListHttpApisResponseBody model) {
        ...
        public ListHttpApisResponseBody build() {
            return new ListHttpApisResponseBody(this);
        } 
