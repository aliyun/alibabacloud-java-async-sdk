...
/**
 * 
 * {@link CreateAiModelCardResponseBody} extends {@link TeaModel}
 *
 * <p>CreateAiModelCardResponseBody</p>
 */
public class CreateAiModelCardResponseBody extends TeaModel {
    ...
    private CreateAiModelCardResponseBody(Builder builder) {
    ...
    public static CreateAiModelCardResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateAiModelCardResponseBody model) {
        ...
        public CreateAiModelCardResponseBody build() {
            return new CreateAiModelCardResponseBody(this);
        } 
