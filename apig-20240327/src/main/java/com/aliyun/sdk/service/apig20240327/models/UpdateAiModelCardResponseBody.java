...
/**
 * 
 * {@link UpdateAiModelCardResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAiModelCardResponseBody</p>
 */
public class UpdateAiModelCardResponseBody extends TeaModel {
    ...
    private UpdateAiModelCardResponseBody(Builder builder) {
    ...
    public static UpdateAiModelCardResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAiModelCardResponseBody model) {
        ...
        public UpdateAiModelCardResponseBody build() {
            return new UpdateAiModelCardResponseBody(this);
        } 
