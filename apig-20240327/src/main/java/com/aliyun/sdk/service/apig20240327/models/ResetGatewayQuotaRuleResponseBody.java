...
/**
 * 
 * {@link ResetGatewayQuotaRuleResponseBody} extends {@link TeaModel}
 *
 * <p>ResetGatewayQuotaRuleResponseBody</p>
 */
public class ResetGatewayQuotaRuleResponseBody extends TeaModel {
    ...
    private ResetGatewayQuotaRuleResponseBody(Builder builder) {
    ...
    public static ResetGatewayQuotaRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResetGatewayQuotaRuleResponseBody model) {
        ...
        public ResetGatewayQuotaRuleResponseBody build() {
            return new ResetGatewayQuotaRuleResponseBody(this);
        } 
