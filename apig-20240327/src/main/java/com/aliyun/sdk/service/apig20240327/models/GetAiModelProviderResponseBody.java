...
/**
 * 
 * {@link GetAiModelProviderResponseBody} extends {@link TeaModel}
 *
 * <p>GetAiModelProviderResponseBody</p>
 */
public class GetAiModelProviderResponseBody extends TeaModel {
    ...
    private GetAiModelProviderResponseBody(Builder builder) {
    ...
    public static GetAiModelProviderResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAiModelProviderResponseBody model) {
        ...
        public GetAiModelProviderResponseBody build() {
            return new GetAiModelProviderResponseBody(this);
        } 
