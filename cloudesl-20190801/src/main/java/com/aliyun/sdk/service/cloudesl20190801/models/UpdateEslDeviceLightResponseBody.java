...
public class UpdateEslDeviceLightResponseBody extends TeaModel {
    ...
    @com.aliyun.core.annotation.NameInMap("FailEslBarCodes")
    ...
    private UpdateEslDeviceLightResponseBody(Builder builder) {
        ...
        this.failEslBarCodes = builder.failEslBarCodes;
    ...
    public static final class Builder {
         ...
         * FailEslBarCodes.
         */
        public Builder failEslBarCodes(String failEslBarCodes) {
