 ...
 *
 * <p>DescribeMobileOperatorAttributeRequest</p>
 */
public class DescribeMobileOperatorAttributeRequest extends Request {
    ...
    private DescribeMobileOperatorAttributeRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeMobileOperatorAttributeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeMobileOperatorAttributeRequest, Builder> {
        private String authCode; 
        private String inputNumber; 
        private String mask; 
        private Long ownerId; 
        ...
        private Builder(DescribeMobileOperatorAttributeRequest request) {
            super(request);
        ...
        @Override
        public DescribeMobileOperatorAttributeRequest build() {
