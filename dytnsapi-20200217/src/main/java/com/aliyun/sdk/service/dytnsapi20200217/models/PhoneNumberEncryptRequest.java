...
/**
 * {@link PhoneNumberEncryptRequest} extends {@link RequestModel}
 *
 * <p>PhoneNumberEncryptRequest</p>
 */
public class PhoneNumberEncryptRequest extends Request {
    ...
    private PhoneNumberEncryptRequest(Builder builder) {
        super(builder);
    ...
    public static PhoneNumberEncryptRequest create() {
    ...
    public static final class Builder extends Request.Builder<PhoneNumberEncryptRequest, Builder> {
        private String authCode; 
        private String inputNumber; 
        private String mask; 
        private Long ownerId; 
        ...
        private Builder(PhoneNumberEncryptRequest request) {
            super(request);
        ...
        @Override
        public PhoneNumberEncryptRequest build() {
            return new PhoneNumberEncryptRequest(this);
        } 
