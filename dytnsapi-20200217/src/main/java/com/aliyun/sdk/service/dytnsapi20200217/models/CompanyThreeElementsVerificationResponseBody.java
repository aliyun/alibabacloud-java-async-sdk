...
public class CompanyThreeElementsVerificationResponseBody extends TeaModel {
    ...
    public static CompanyThreeElementsVerificationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CompanyThreeElementsVerificationResponseBody model) {
        ...
        public CompanyThreeElementsVerificationResponseBody build() {
            return new CompanyThreeElementsVerificationResponseBody(this);
        } 
