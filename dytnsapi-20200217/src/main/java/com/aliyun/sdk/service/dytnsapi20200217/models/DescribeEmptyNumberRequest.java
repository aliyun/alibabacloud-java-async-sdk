 ...
 */
public class DescribeEmptyNumberRequest extends Request {
    ...
    private DescribeEmptyNumberRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeEmptyNumberRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeEmptyNumberRequest, Builder> {
        private String authCode; 
        private String inputNumber; 
        private String mask; 
        private Long ownerId; 
        ...
        private Builder(DescribeEmptyNumberRequest request) {
            super(request);
        ...
        @Override
        public DescribeEmptyNumberRequest build() {
            return new DescribeEmptyNumberRequest(this);
        } 
