 ...
 */
public class PhoneNumberConvertServiceRequest extends Request {
    ...
    private PhoneNumberConvertServiceRequest(Builder builder) {
        super(builder);
    ...
    public static PhoneNumberConvertServiceRequest create() {
    ...
    public static final class Builder extends Request.Builder<PhoneNumberConvertServiceRequest, Builder> {
        private String authCode; 
        private String inputNumber; 
        private String mask; 
        private Long ownerId; 
        ...
        private Builder(PhoneNumberConvertServiceRequest request) {
            super(request);
        ...
        @Override
        public PhoneNumberConvertServiceRequest build() {
            return new PhoneNumberConvertServiceRequest(this);
        } 
