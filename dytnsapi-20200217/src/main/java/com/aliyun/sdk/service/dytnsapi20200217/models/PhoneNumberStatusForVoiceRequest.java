...
/**
 * {@link PhoneNumberStatusForVoiceRequest} extends {@link RequestModel}
 *
 * <p>PhoneNumberStatusForVoiceRequest</p>
 */
public class PhoneNumberStatusForVoiceRequest extends Request {
    ...
    private PhoneNumberStatusForVoiceRequest(Builder builder) {
        super(builder);
    ...
    public static PhoneNumberStatusForVoiceRequest create() {
    ...
    public static final class Builder extends Request.Builder<PhoneNumberStatusForVoiceRequest, Builder> {
        private String authCode; 
        private String inputNumber; 
        private String mask; 
        private Long ownerId; 
        ...
        private Builder(PhoneNumberStatusForVoiceRequest request) {
            super(request);
        ...
        @Override
        public PhoneNumberStatusForVoiceRequest build() {
            return new PhoneNumberStatusForVoiceRequest(this);
        } 
