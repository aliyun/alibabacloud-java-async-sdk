 ...
 */
public class DescribePhoneNumberRiskRequest extends Request {
    ...
    private DescribePhoneNumberRiskRequest(Builder builder) {
        super(builder);
    ...
    public static DescribePhoneNumberRiskRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribePhoneNumberRiskRequest, Builder> {
        private String authCode; 
        private String inputNumber; 
        private String mask; 
        private Long ownerId; 
        ...
        private Builder(DescribePhoneNumberRiskRequest request) {
            super(request);
        ...
        @Override
        public DescribePhoneNumberRiskRequest build() {
            return new DescribePhoneNumberRiskRequest(this);
        } 
