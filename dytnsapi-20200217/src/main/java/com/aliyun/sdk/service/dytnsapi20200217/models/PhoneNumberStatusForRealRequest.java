 ...
 */
public class PhoneNumberStatusForRealRequest extends Request {
    ...
    private PhoneNumberStatusForRealRequest(Builder builder) {
        super(builder);
    ...
    public static PhoneNumberStatusForRealRequest create() {
    ...
    public static final class Builder extends Request.Builder<PhoneNumberStatusForRealRequest, Builder> {
        private String authCode; 
        private String inputNumber; 
        private String mask; 
        private Long ownerId; 
        ...
        private Builder(PhoneNumberStatusForRealRequest request) {
            super(request);
        ...
        @Override
        public PhoneNumberStatusForRealRequest build() {
            return new PhoneNumberStatusForRealRequest(this);
        } 
