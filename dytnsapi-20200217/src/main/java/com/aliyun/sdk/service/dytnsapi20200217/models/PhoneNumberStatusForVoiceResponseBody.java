...
/**
 * 
 * {@link PhoneNumberStatusForVoiceResponseBody} extends {@link TeaModel}
 *
 * <p>PhoneNumberStatusForVoiceResponseBody</p>
 */
public class PhoneNumberStatusForVoiceResponseBody extends TeaModel {
    ...
    private PhoneNumberStatusForVoiceResponseBody(Builder builder) {
    ...
    public static PhoneNumberStatusForVoiceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(PhoneNumberStatusForVoiceResponseBody model) {
        ...
        public PhoneNumberStatusForVoiceResponseBody build() {
            return new PhoneNumberStatusForVoiceResponseBody(this);
        } 
