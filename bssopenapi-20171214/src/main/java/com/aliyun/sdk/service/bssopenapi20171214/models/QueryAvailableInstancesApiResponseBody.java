...
/**
 * {@link QueryAvailableInstancesApiResponseBody} extends {@link TeaModel}
 *
 * <p>QueryAvailableInstancesApiResponseBody</p>
 */
public class QueryAvailableInstancesApiResponseBody extends TeaModel {
    @NameInMap("Code")
    private String code;
    ...
    private QueryAvailableInstancesApiResponseBody(Builder builder) {
    ...
    public static QueryAvailableInstancesApiResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryAvailableInstancesApiResponseBody build() {
            return new QueryAvailableInstancesApiResponseBody(this);
        } 
