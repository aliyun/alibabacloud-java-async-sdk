...
/**
 * {@link QueryUserCouponResponseBody} extends {@link TeaModel}
 *
 * <p>QueryUserCouponResponseBody</p>
 */
public class QueryUserCouponResponseBody extends TeaModel {
    @NameInMap("Code")
    private String code;
    ...
    private QueryUserCouponResponseBody(Builder builder) {
    ...
    public static QueryUserCouponResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QueryUserCouponResponseBody build() {
            return new QueryUserCouponResponseBody(this);
        } 
