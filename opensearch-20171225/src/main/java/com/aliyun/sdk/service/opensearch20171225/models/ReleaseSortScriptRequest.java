 ...
 */
public class ReleaseSortScriptRequest extends Request {
    ...
    private ReleaseSortScriptRequest(Builder builder) {
        super(builder);
    ...
    public static ReleaseSortScriptRequest create() {
    ...
    public static final class Builder extends Request.Builder<ReleaseSortScriptRequest, Builder> {
        private String appGroupIdentity; 
        private String scriptName; 
        private String appVersionId; 
        ...
        @Override
        public ReleaseSortScriptRequest build() {
            return new ReleaseSortScriptRequest(this);
        } 
