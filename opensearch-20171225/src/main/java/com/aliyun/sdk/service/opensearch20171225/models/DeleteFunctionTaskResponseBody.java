...
/**
 * 
 * {@link DeleteFunctionTaskResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteFunctionTaskResponseBody</p>
 */
public class DeleteFunctionTaskResponseBody extends TeaModel {
    ...
    private DeleteFunctionTaskResponseBody(Builder builder) {
    ...
    public static DeleteFunctionTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteFunctionTaskResponseBody model) {
        ...
        public DeleteFunctionTaskResponseBody build() {
            return new DeleteFunctionTaskResponseBody(this);
        } 
