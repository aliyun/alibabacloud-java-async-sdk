...
/**
 * 
 * {@link GetFunctionResourceResponseBody} extends {@link TeaModel}
 *
 * <p>GetFunctionResourceResponseBody</p>
 */
public class GetFunctionResourceResponseBody extends TeaModel {
    ...
    private GetFunctionResourceResponseBody(Builder builder) {
    ...
    public static GetFunctionResourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetFunctionResourceResponseBody model) {
        ...
        public GetFunctionResourceResponseBody build() {
            return new GetFunctionResourceResponseBody(this);
        } 
