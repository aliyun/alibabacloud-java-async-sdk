...
/**
 * {@link CreateDataCollectionResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDataCollectionResponseBody</p>
 */
public class CreateDataCollectionResponseBody extends TeaModel {
    ...
    private CreateDataCollectionResponseBody(Builder builder) {
    ...
    public static CreateDataCollectionResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateDataCollectionResponseBody build() {
            return new CreateDataCollectionResponseBody(this);
        } 
