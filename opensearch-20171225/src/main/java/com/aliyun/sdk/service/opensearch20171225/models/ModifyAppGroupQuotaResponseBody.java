...
public class ModifyAppGroupQuotaResponseBody extends TeaModel {
    ...
    private ModifyAppGroupQuotaResponseBody(Builder builder) {
    ...
    public static ModifyAppGroupQuotaResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifyAppGroupQuotaResponseBody build() {
            return new ModifyAppGroupQuotaResponseBody(this);
        } 
