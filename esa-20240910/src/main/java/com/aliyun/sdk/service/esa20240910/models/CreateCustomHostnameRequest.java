...
/**
 * 
 * {@link CreateCustomHostnameRequest} extends {@link RequestModel}
 *
 * <p>CreateCustomHostnameRequest</p>
 */
public class CreateCustomHostnameRequest extends Request {
    ...
    private CreateCustomHostnameRequest(Builder builder) {
        super(builder);
    ...
    public static CreateCustomHostnameRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateCustomHostnameRequest, Builder> {
        private Long casId; 
        private String casRegion; 
        private String certType; 
        private String certificate; 
        ...
        private Builder(CreateCustomHostnameRequest request) {
            super(request);
        ...
        @Override
        public CreateCustomHostnameRequest build() {
            return new CreateCustomHostnameRequest(this);
        } 
