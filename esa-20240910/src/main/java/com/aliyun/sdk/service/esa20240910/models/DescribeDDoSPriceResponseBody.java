...
/**
 * 
 * {@link DescribeDDoSPriceResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDDoSPriceResponseBody</p>
 */
public class DescribeDDoSPriceResponseBody extends TeaModel {
    ...
    private DescribeDDoSPriceResponseBody(Builder builder) {
    ...
    public static DescribeDDoSPriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeDDoSPriceResponseBody model) {
        ...
        public DescribeDDoSPriceResponseBody build() {
            return new DescribeDDoSPriceResponseBody(this);
        } 
