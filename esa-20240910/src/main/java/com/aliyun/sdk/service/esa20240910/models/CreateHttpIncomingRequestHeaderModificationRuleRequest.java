...
/**
 * 
 * {@link CreateHttpIncomingRequestHeaderModificationRuleRequest} extends {@link RequestModel}
 *
 * <p>CreateHttpIncomingRequestHeaderModificationRuleRequest</p>
 */
public class CreateHttpIncomingRequestHeaderModificationRuleRequest extends Request {
    ...
    private CreateHttpIncomingRequestHeaderModificationRuleRequest(Builder builder) {
        super(builder);
    ...
    public static CreateHttpIncomingRequestHeaderModificationRuleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateHttpIncomingRequestHeaderModificationRuleRequest, Builder> {
        private java.util.List<RequestHeaderModification> requestHeaderModification; 
        private String rule; 
        private String ruleEnable; 
        private String ruleName; 
        ...
        private Builder(CreateHttpIncomingRequestHeaderModificationRuleRequest request) {
            super(request);
        ...
        @Override
        public CreateHttpIncomingRequestHeaderModificationRuleRequest build() {
            return new CreateHttpIncomingRequestHeaderModificationRuleRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateHttpIncomingRequestHeaderModificationRuleRequest} extends {@link TeaModel}
     *
     * <p>CreateHttpIncomingRequestHeaderModificationRuleRequest</p>
     */
