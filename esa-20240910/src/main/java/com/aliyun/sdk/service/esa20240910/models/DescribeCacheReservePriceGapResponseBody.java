...
/**
 * 
 * {@link DescribeCacheReservePriceGapResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeCacheReservePriceGapResponseBody</p>
 */
public class DescribeCacheReservePriceGapResponseBody extends TeaModel {
    ...
    private DescribeCacheReservePriceGapResponseBody(Builder builder) {
    ...
    public static DescribeCacheReservePriceGapResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeCacheReservePriceGapResponseBody model) {
        ...
        public DescribeCacheReservePriceGapResponseBody build() {
            return new DescribeCacheReservePriceGapResponseBody(this);
        } 
