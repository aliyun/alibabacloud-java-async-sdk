...
/**
 * 
 * {@link GetHttpIncomingRequestHeaderModificationRuleResponseBody} extends {@link TeaModel}
 *
 * <p>GetHttpIncomingRequestHeaderModificationRuleResponseBody</p>
 */
public class GetHttpIncomingRequestHeaderModificationRuleResponseBody extends TeaModel {
    ...
    private GetHttpIncomingRequestHeaderModificationRuleResponseBody(Builder builder) {
    ...
    public static GetHttpIncomingRequestHeaderModificationRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetHttpIncomingRequestHeaderModificationRuleResponseBody model) {
        ...
        public GetHttpIncomingRequestHeaderModificationRuleResponseBody build() {
            return new GetHttpIncomingRequestHeaderModificationRuleResponseBody(this);
        } 
