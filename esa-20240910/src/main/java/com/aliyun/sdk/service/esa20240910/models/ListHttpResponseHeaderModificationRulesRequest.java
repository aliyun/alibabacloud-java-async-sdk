...
/**
 * 
 * {@link ListHttpResponseHeaderModificationRulesRequest} extends {@link RequestModel}
 *
 * <p>ListHttpResponseHeaderModificationRulesRequest</p>
 */
public class ListHttpResponseHeaderModificationRulesRequest extends Request {
    ...
    private ListHttpResponseHeaderModificationRulesRequest(Builder builder) {
        super(builder);
    ...
    public static ListHttpResponseHeaderModificationRulesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListHttpResponseHeaderModificationRulesRequest, Builder> {
        private Long configId; 
        private String configType; 
        private Integer pageNumber; 
        private Integer pageSize; 
        ...
        private Builder(ListHttpResponseHeaderModificationRulesRequest request) {
            super(request);
        ...
        @Override
        public ListHttpResponseHeaderModificationRulesRequest build() {
            return new ListHttpResponseHeaderModificationRulesRequest(this);
        } 
