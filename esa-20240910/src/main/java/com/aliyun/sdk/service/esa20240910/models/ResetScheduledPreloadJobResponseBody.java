...
/**
 * 
 * {@link ResetScheduledPreloadJobResponseBody} extends {@link TeaModel}
 *
 * <p>ResetScheduledPreloadJobResponseBody</p>
 */
public class ResetScheduledPreloadJobResponseBody extends TeaModel {
    ...
    private ResetScheduledPreloadJobResponseBody(Builder builder) {
    ...
    public static ResetScheduledPreloadJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResetScheduledPreloadJobResponseBody model) {
        ...
        public ResetScheduledPreloadJobResponseBody build() {
            return new ResetScheduledPreloadJobResponseBody(this);
        } 
