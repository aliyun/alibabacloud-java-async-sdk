...
/**
 * 
 * {@link ListRewriteUrlRulesRequest} extends {@link RequestModel}
 *
 * <p>ListRewriteUrlRulesRequest</p>
 */
public class ListRewriteUrlRulesRequest extends Request {
    ...
    private ListRewriteUrlRulesRequest(Builder builder) {
        super(builder);
    ...
    public static ListRewriteUrlRulesRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListRewriteUrlRulesRequest, Builder> {
        private Long configId; 
        private String configType; 
        private Integer pageNumber; 
        private Integer pageSize; 
        ...
        private Builder(ListRewriteUrlRulesRequest request) {
            super(request);
        ...
        @Override
        public ListRewriteUrlRulesRequest build() {
            return new ListRewriteUrlRulesRequest(this);
        } 
