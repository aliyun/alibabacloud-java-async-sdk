...
/**
 * 
 * {@link UploadOriginClientCertificateResponseBody} extends {@link TeaModel}
 *
 * <p>UploadOriginClientCertificateResponseBody</p>
 */
public class UploadOriginClientCertificateResponseBody extends TeaModel {
    ...
    private UploadOriginClientCertificateResponseBody(Builder builder) {
    ...
    public static UploadOriginClientCertificateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UploadOriginClientCertificateResponseBody model) {
        ...
        public UploadOriginClientCertificateResponseBody build() {
            return new UploadOriginClientCertificateResponseBody(this);
        } 
