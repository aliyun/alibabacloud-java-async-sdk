...
/**
 * 
 * {@link ListOriginClientCertificatesResponseBody} extends {@link TeaModel}
 *
 * <p>ListOriginClientCertificatesResponseBody</p>
 */
public class ListOriginClientCertificatesResponseBody extends TeaModel {
    ...
    private ListOriginClientCertificatesResponseBody(Builder builder) {
    ...
    public static ListOriginClientCertificatesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListOriginClientCertificatesResponseBody model) {
        ...
        public ListOriginClientCertificatesResponseBody build() {
            return new ListOriginClientCertificatesResponseBody(this);
        } 
