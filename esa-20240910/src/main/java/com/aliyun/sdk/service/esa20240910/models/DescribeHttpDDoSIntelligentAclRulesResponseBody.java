...
/**
 * 
 * {@link DescribeHttpDDoSIntelligentAclRulesResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeHttpDDoSIntelligentAclRulesResponseBody</p>
 */
public class DescribeHttpDDoSIntelligentAclRulesResponseBody extends TeaModel {
    ...
    private DescribeHttpDDoSIntelligentAclRulesResponseBody(Builder builder) {
    ...
    public static DescribeHttpDDoSIntelligentAclRulesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeHttpDDoSIntelligentAclRulesResponseBody model) {
        ...
        public DescribeHttpDDoSIntelligentAclRulesResponseBody build() {
            return new DescribeHttpDDoSIntelligentAclRulesResponseBody(this);
        } 
