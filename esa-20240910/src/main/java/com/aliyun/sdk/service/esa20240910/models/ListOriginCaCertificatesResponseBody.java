...
/**
 * 
 * {@link ListOriginCaCertificatesResponseBody} extends {@link TeaModel}
 *
 * <p>ListOriginCaCertificatesResponseBody</p>
 */
public class ListOriginCaCertificatesResponseBody extends TeaModel {
    ...
    private ListOriginCaCertificatesResponseBody(Builder builder) {
    ...
    public static ListOriginCaCertificatesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListOriginCaCertificatesResponseBody model) {
        ...
        public ListOriginCaCertificatesResponseBody build() {
            return new ListOriginCaCertificatesResponseBody(this);
        } 
