...
/**
 * 
 * {@link GetSiteOriginClientCertificateResponseBody} extends {@link TeaModel}
 *
 * <p>GetSiteOriginClientCertificateResponseBody</p>
 */
public class GetSiteOriginClientCertificateResponseBody extends TeaModel {
    ...
    private GetSiteOriginClientCertificateResponseBody(Builder builder) {
    ...
    public static GetSiteOriginClientCertificateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetSiteOriginClientCertificateResponseBody model) {
        ...
        public GetSiteOriginClientCertificateResponseBody build() {
            return new GetSiteOriginClientCertificateResponseBody(this);
        } 
