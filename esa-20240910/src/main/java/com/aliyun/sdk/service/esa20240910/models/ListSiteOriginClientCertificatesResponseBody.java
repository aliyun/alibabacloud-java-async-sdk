...
/**
 * 
 * {@link ListSiteOriginClientCertificatesResponseBody} extends {@link TeaModel}
 *
 * <p>ListSiteOriginClientCertificatesResponseBody</p>
 */
public class ListSiteOriginClientCertificatesResponseBody extends TeaModel {
    ...
    private ListSiteOriginClientCertificatesResponseBody(Builder builder) {
    ...
    public static ListSiteOriginClientCertificatesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListSiteOriginClientCertificatesResponseBody model) {
        ...
        public ListSiteOriginClientCertificatesResponseBody build() {
            return new ListSiteOriginClientCertificatesResponseBody(this);
        } 
