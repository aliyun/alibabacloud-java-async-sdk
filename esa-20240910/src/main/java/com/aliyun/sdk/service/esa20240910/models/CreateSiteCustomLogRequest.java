...
/**
 * 
 * {@link CreateSiteCustomLogRequest} extends {@link RequestModel}
 *
 * <p>CreateSiteCustomLogRequest</p>
 */
public class CreateSiteCustomLogRequest extends Request {
    ...
    private CreateSiteCustomLogRequest(Builder builder) {
        super(builder);
    ...
    public static CreateSiteCustomLogRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateSiteCustomLogRequest, Builder> {
        ...
        private Builder(CreateSiteCustomLogRequest request) {
            super(request);
        ...
        @Override
        public CreateSiteCustomLogRequest build() {
            return new CreateSiteCustomLogRequest(this);
        } 
