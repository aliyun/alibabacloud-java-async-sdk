...
/**
 * 
 * {@link CreateScheduledPreloadJobResponseBody} extends {@link TeaModel}
 *
 * <p>CreateScheduledPreloadJobResponseBody</p>
 */
public class CreateScheduledPreloadJobResponseBody extends TeaModel {
    ...
    private CreateScheduledPreloadJobResponseBody(Builder builder) {
    ...
    public static CreateScheduledPreloadJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateScheduledPreloadJobResponseBody build() {
            return new CreateScheduledPreloadJobResponseBody(this);
        } 
