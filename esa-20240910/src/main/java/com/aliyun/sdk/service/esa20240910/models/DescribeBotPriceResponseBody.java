...
/**
 * 
 * {@link DescribeBotPriceResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeBotPriceResponseBody</p>
 */
public class DescribeBotPriceResponseBody extends TeaModel {
    ...
    private DescribeBotPriceResponseBody(Builder builder) {
    ...
    public static DescribeBotPriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeBotPriceResponseBody model) {
        ...
        public DescribeBotPriceResponseBody build() {
            return new DescribeBotPriceResponseBody(this);
        } 
