...
/**
 * 
 * {@link UpdateSiteFunctionRequest} extends {@link RequestModel}
 *
 * <p>UpdateSiteFunctionRequest</p>
 */
public class UpdateSiteFunctionRequest extends Request {
    ...
    private UpdateSiteFunctionRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateSiteFunctionRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateSiteFunctionRequest, Builder> {
        private java.util.List < CacheReserve> cacheReserve; 
        private java.util.List < CacheRules> cacheRules; 
        private java.util.List < CacheTags> cacheTags; 
        private java.util.List < CnameFlattening> cnameFlattening; 
        ...
        private Builder(UpdateSiteFunctionRequest request) {
            super(request);
        ...
        @Override
        public UpdateSiteFunctionRequest build() {
            return new UpdateSiteFunctionRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateSiteFunctionRequest} extends {@link TeaModel}
     *
     * <p>UpdateSiteFunctionRequest</p>
     */
