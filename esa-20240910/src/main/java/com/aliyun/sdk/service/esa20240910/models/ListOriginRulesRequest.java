...
/**
 * 
 * {@link ListOriginRulesRequest} extends {@link RequestModel}
 *
 * <p>ListOriginRulesRequest</p>
 */
public class ListOriginRulesRequest extends Request {
    ...
    private ListOriginRulesRequest(Builder builder) {
        super(builder);
    ...
    public static ListOriginRulesRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListOriginRulesRequest, Builder> {
        private Long configId; 
        private String configType; 
        private Integer pageNumber; 
        private Integer pageSize; 
        ...
        private Builder(ListOriginRulesRequest request) {
            super(request);
        ...
        @Override
        public ListOriginRulesRequest build() {
            return new ListOriginRulesRequest(this);
        } 
