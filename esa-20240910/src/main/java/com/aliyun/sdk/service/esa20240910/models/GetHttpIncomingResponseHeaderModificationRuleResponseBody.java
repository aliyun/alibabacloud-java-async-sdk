...
/**
 * 
 * {@link GetHttpIncomingResponseHeaderModificationRuleResponseBody} extends {@link TeaModel}
 *
 * <p>GetHttpIncomingResponseHeaderModificationRuleResponseBody</p>
 */
public class GetHttpIncomingResponseHeaderModificationRuleResponseBody extends TeaModel {
    ...
    private GetHttpIncomingResponseHeaderModificationRuleResponseBody(Builder builder) {
    ...
    public static GetHttpIncomingResponseHeaderModificationRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetHttpIncomingResponseHeaderModificationRuleResponseBody model) {
        ...
        public GetHttpIncomingResponseHeaderModificationRuleResponseBody build() {
            return new GetHttpIncomingResponseHeaderModificationRuleResponseBody(this);
        } 
