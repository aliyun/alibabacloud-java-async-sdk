...
/**
 * 
 * {@link ListCacheRulesRequest} extends {@link RequestModel}
 *
 * <p>ListCacheRulesRequest</p>
 */
public class ListCacheRulesRequest extends Request {
    ...
    private ListCacheRulesRequest(Builder builder) {
        super(builder);
    ...
    public static ListCacheRulesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListCacheRulesRequest, Builder> {
        private Long configId; 
        private String configType; 
        private Integer pageNumber; 
        private Integer pageSize; 
        ...
        private Builder(ListCacheRulesRequest request) {
            super(request);
        ...
        @Override
        public ListCacheRulesRequest build() {
            return new ListCacheRulesRequest(this);
        } 
