...
/**
 * 
 * {@link GetOriginClientCertificateResponseBody} extends {@link TeaModel}
 *
 * <p>GetOriginClientCertificateResponseBody</p>
 */
public class GetOriginClientCertificateResponseBody extends TeaModel {
    ...
    private GetOriginClientCertificateResponseBody(Builder builder) {
    ...
    public static GetOriginClientCertificateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetOriginClientCertificateResponseBody model) {
        ...
        public GetOriginClientCertificateResponseBody build() {
            return new GetOriginClientCertificateResponseBody(this);
        } 
