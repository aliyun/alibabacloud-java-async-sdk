...
/**
 * 
 * {@link UploadOriginCaCertificateResponseBody} extends {@link TeaModel}
 *
 * <p>UploadOriginCaCertificateResponseBody</p>
 */
public class UploadOriginCaCertificateResponseBody extends TeaModel {
    ...
    private UploadOriginCaCertificateResponseBody(Builder builder) {
    ...
    public static UploadOriginCaCertificateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UploadOriginCaCertificateResponseBody model) {
        ...
        public UploadOriginCaCertificateResponseBody build() {
            return new UploadOriginCaCertificateResponseBody(this);
        } 
