...
/**
 * 
 * {@link CreateTTSVoiceCustomResponseBody} extends {@link TeaModel}
 *
 * <p>CreateTTSVoiceCustomResponseBody</p>
 */
public class CreateTTSVoiceCustomResponseBody extends TeaModel {
    ...
    private CreateTTSVoiceCustomResponseBody(Builder builder) {
    ...
    public static CreateTTSVoiceCustomResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateTTSVoiceCustomResponseBody model) {
        ...
        public CreateTTSVoiceCustomResponseBody build() {
            return new CreateTTSVoiceCustomResponseBody(this);
        } 
