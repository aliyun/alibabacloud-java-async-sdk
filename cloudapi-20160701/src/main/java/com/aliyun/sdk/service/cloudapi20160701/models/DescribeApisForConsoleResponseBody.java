...
/**
 * {@link DescribeApisForConsoleResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeApisForConsoleResponseBody</p>
 */
public class DescribeApisForConsoleResponseBody extends TeaModel {
    ...
    private DescribeApisForConsoleResponseBody(Builder builder) {
    ...
    public static DescribeApisForConsoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeApisForConsoleResponseBody build() {
            return new DescribeApisForConsoleResponseBody(this);
        } 
