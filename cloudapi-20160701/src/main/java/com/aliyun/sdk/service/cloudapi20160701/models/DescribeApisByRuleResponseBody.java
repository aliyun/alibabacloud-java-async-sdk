...
/**
 * {@link DescribeApisByRuleResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeApisByRuleResponseBody</p>
 */
public class DescribeApisByRuleResponseBody extends TeaModel {
    ...
    private DescribeApisByRuleResponseBody(Builder builder) {
    ...
    public static DescribeApisByRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeApisByRuleResponseBody build() {
            return new DescribeApisByRuleResponseBody(this);
        } 
