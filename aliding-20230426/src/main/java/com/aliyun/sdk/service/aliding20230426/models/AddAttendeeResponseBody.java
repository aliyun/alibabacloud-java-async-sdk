...
/**
 * 
 * {@link AddAttendeeResponseBody} extends {@link TeaModel}
 *
 * <p>AddAttendeeResponseBody</p>
 */
public class AddAttendeeResponseBody extends TeaModel {
    ...
    private AddAttendeeResponseBody(Builder builder) {
    ...
    public static AddAttendeeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddAttendeeResponseBody model) {
        ...
        public AddAttendeeResponseBody build() {
            return new AddAttendeeResponseBody(this);
        } 
