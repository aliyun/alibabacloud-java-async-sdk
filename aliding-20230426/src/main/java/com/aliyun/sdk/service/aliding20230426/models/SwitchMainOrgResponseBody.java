...
/**
 * 
 * {@link SwitchMainOrgResponseBody} extends {@link TeaModel}
 *
 * <p>SwitchMainOrgResponseBody</p>
 */
public class SwitchMainOrgResponseBody extends TeaModel {
    ...
    private SwitchMainOrgResponseBody(Builder builder) {
    ...
    public static SwitchMainOrgResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SwitchMainOrgResponseBody model) {
        ...
        public SwitchMainOrgResponseBody build() {
            return new SwitchMainOrgResponseBody(this);
        } 
