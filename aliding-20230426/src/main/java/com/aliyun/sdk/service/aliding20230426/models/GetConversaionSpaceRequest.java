 ...
 */
public class GetConversaionSpaceRequest extends Request {
    ...
    private GetConversaionSpaceRequest(Builder builder) {
        super(builder);
    ...
    public static GetConversaionSpaceRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetConversaionSpaceRequest, Builder> {
        private AccountContext accountContext; 
        private String openConversationId; 
        private TenantContext tenantContext; 
        ...
        private Builder(GetConversaionSpaceRequest request) {
            super(request);
        ...
        @Override
        public GetConversaionSpaceRequest build() {
            return new GetConversaionSpaceRequest(this);
        } 
