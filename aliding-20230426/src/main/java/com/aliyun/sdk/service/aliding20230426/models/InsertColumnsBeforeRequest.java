...
/**
 * 
 * {@link InsertColumnsBeforeRequest} extends {@link RequestModel}
 *
 * <p>InsertColumnsBeforeRequest</p>
 */
public class InsertColumnsBeforeRequest extends Request {
    ...
    private InsertColumnsBeforeRequest(Builder builder) {
        super(builder);
    ...
    public static InsertColumnsBeforeRequest create() {
    ...
    public static final class Builder extends Request.Builder<InsertColumnsBeforeRequest, Builder> {
        private AccountContext accountContext; 
        private Long column; 
        private Long columnCount; 
        private String sheetId; 
        ...
        private Builder(InsertColumnsBeforeRequest request) {
            super(request);
        ...
        @Override
        public InsertColumnsBeforeRequest build() {
            return new InsertColumnsBeforeRequest(this);
        } 
    ...
    /**
     * 
     * {@link InsertColumnsBeforeRequest} extends {@link TeaModel}
     *
     * <p>InsertColumnsBeforeRequest</p>
     */
