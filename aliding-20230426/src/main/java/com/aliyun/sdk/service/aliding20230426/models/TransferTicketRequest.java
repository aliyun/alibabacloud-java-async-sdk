...
/**
 * 
 * {@link TransferTicketRequest} extends {@link RequestModel}
 *
 * <p>TransferTicketRequest</p>
 */
public class TransferTicketRequest extends Request {
    ...
    private TransferTicketRequest(Builder builder) {
        super(builder);
    ...
    public static TransferTicketRequest create() {
    ...
    public static final class Builder extends Request.Builder<TransferTicketRequest, Builder> {
        private AccountContext accountContext; 
        private Notify notify; 
        private String openTeamId; 
        private String openTicketId; 
        ...
        private Builder(TransferTicketRequest request) {
            super(request);
        ...
        @Override
        public TransferTicketRequest build() {
            return new TransferTicketRequest(this);
        } 
    ...
    /**
     * 
     * {@link TransferTicketRequest} extends {@link TeaModel}
     *
     * <p>TransferTicketRequest</p>
     */
