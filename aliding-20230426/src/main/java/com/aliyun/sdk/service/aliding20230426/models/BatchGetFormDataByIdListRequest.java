 ...
 */
public class BatchGetFormDataByIdListRequest extends Request {
    ...
    @com.aliyun.core.annotation.Body
    @com.aliyun.core.annotation.NameInMap("NeedFormInstanceValue")
    ...
    private BatchGetFormDataByIdListRequest(Builder builder) {
        super(builder);
        this.accountContext = builder.accountContext;
        this.appType = builder.appType;
        this.formInstanceIdList = builder.formInstanceIdList;
        this.formUuid = builder.formUuid;
        this.needFormInstanceValue = builder.needFormInstanceValue;
    ...
    public static BatchGetFormDataByIdListRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchGetFormDataByIdListRequest, Builder> {
        ...
        private Builder(BatchGetFormDataByIdListRequest request) {
            super(request);
            this.accountContext = request.accountContext;
            this.appType = request.appType;
            this.formInstanceIdList = request.formInstanceIdList;
            this.formUuid = request.formUuid;
            this.needFormInstanceValue = request.needFormInstanceValue;
         ...
         */
        public Builder needFormInstanceValue(Boolean needFormInstanceValue) {
            this.putBodyParameter("NeedFormInstanceValue", needFormInstanceValue);
        ...
        @Override
        public BatchGetFormDataByIdListRequest build() {
            return new BatchGetFormDataByIdListRequest(this);
        } 
