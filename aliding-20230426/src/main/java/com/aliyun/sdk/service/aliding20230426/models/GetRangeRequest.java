 ...
 * <p>GetRangeRequest</p>
 */
public class GetRangeRequest extends Request {
    ...
    public static GetRangeRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetRangeRequest, Builder> {
        private AccountContext accountContext; 
        private String rangeAddress; 
        private String select; 
        private String sheetId; 
        ...
        private Builder(GetRangeRequest request) {
            super(request);
        ...
        public Builder select(String select) {
            this.putBodyParameter("Select", select);
            this.select = select;
            return this;
        }
