...
/**
 * 
 * {@link AddPermissionRequest} extends {@link RequestModel}
 *
 * <p>AddPermissionRequest</p>
 */
public class AddPermissionRequest extends Request {
    ...
    private AddPermissionRequest(Builder builder) {
        super(builder);
    ...
    public static AddPermissionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddPermissionRequest, Builder> {
        private AccountContext accountContext; 
        private String dentryUuid; 
        private java.util.List<Members> members; 
        private Option option; 
        ...
        private Builder(AddPermissionRequest request) {
            super(request);
    ...
    /**
     * 
     * {@link AddPermissionRequest} extends {@link TeaModel}
     *
     * <p>AddPermissionRequest</p>
     */
