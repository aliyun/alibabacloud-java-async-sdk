 ...
 */
public class SetRowsVisibilityRequest extends Request {
    ...
    private SetRowsVisibilityRequest(Builder builder) {
        super(builder);
    ...
    public static SetRowsVisibilityRequest create() {
    ...
    public static final class Builder extends Request.Builder<SetRowsVisibilityRequest, Builder> {
        private AccountContext accountContext; 
        private Long row; 
        private Long rowCount; 
        private String sheetId; 
        ...
        private Builder(SetRowsVisibilityRequest request) {
            super(request);
        ...
        @Override
        public SetRowsVisibilityRequest build() {
            return new SetRowsVisibilityRequest(this);
        } 
