...
/**
 * 
 * {@link AssignTicketRequest} extends {@link RequestModel}
 *
 * <p>AssignTicketRequest</p>
 */
public class AssignTicketRequest extends Request {
    ...
    public static AssignTicketRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssignTicketRequest, Builder> {
        private AccountContext accountContext; 
        private Notify notify; 
        private String openTeamId; 
        private String openTicketId; 
        ...
        private Builder(AssignTicketRequest request) {
            super(request);
    ...
    /**
     * 
     * {@link AssignTicketRequest} extends {@link TeaModel}
     *
     * <p>AssignTicketRequest</p>
     */
