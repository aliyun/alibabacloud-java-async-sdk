...
/**
 * 
 * {@link GetInstancesRequest} extends {@link RequestModel}
 *
 * <p>GetInstancesRequest</p>
 */
public class GetInstancesRequest extends Request {
    ...
    private GetInstancesRequest(Builder builder) {
        super(builder);
    ...
    public static GetInstancesRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetInstancesRequest, Builder> {
        private AccountContext accountContext; 
        private String appType; 
        private String approvedResult; 
        private String createFromTimeGMT; 
        ...
        private Builder(GetInstancesRequest request) {
            super(request);
    ...
    /**
     * 
     * {@link GetInstancesRequest} extends {@link TeaModel}
     *
     * <p>GetInstancesRequest</p>
     */
