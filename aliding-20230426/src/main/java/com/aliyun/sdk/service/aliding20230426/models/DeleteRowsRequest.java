 ...
 */
public class DeleteRowsRequest extends Request {
    ...
    private DeleteRowsRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteRowsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteRowsRequest, Builder> {
        private AccountContext accountContext; 
        private Long row; 
        private Long rowCount; 
        private String sheetId; 
        ...
        private Builder(DeleteRowsRequest request) {
            super(request);
        ...
        @Override
        public DeleteRowsRequest build() {
            return new DeleteRowsRequest(this);
        } 
