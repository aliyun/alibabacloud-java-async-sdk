...
public class CommitFileResponseBody extends TeaModel {
    ...
    private CommitFileResponseBody(Builder builder) {
    ...
    public static CommitFileResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CommitFileResponseBody model) {
        ...
        public CommitFileResponseBody build() {
            return new CommitFileResponseBody(this);
        } 
