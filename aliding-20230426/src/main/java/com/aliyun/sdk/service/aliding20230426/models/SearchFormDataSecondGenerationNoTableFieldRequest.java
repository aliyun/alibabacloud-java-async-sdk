...
/**
 * 
 * {@link SearchFormDataSecondGenerationNoTableFieldRequest} extends {@link RequestModel}
 *
 * <p>SearchFormDataSecondGenerationNoTableFieldRequest</p>
 */
public class SearchFormDataSecondGenerationNoTableFieldRequest extends Request {
    ...
    private SearchFormDataSecondGenerationNoTableFieldRequest(Builder builder) {
        super(builder);
    ...
    public static SearchFormDataSecondGenerationNoTableFieldRequest create() {
    ...
    public static final class Builder extends Request.Builder<SearchFormDataSecondGenerationNoTableFieldRequest, Builder> {
        private AccountContext accountContext; 
        private String appType; 
        private String createFromTimeGMT; 
        private String createToTimeGMT; 
        ...
        private Builder(SearchFormDataSecondGenerationNoTableFieldRequest request) {
            super(request);
        ...
        @Override
        public SearchFormDataSecondGenerationNoTableFieldRequest build() {
            return new SearchFormDataSecondGenerationNoTableFieldRequest(this);
        } 
    ...
    /**
     * 
     * {@link SearchFormDataSecondGenerationNoTableFieldRequest} extends {@link TeaModel}
     *
     * <p>SearchFormDataSecondGenerationNoTableFieldRequest</p>
     */
