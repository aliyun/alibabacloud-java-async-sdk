 ...
 */
public class CreateDingtalkPersonalTodoTaskRequest extends Request {
    ...
    private CreateDingtalkPersonalTodoTaskRequest(Builder builder) {
        super(builder);
    ...
    public static CreateDingtalkPersonalTodoTaskRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateDingtalkPersonalTodoTaskRequest, Builder> {
        private AccountContext accountContext; 
        private String description; 
        private Long dueTime; 
        private java.util.List<String> executorIds; 
        ...
        private Builder(CreateDingtalkPersonalTodoTaskRequest request) {
            super(request);
        ...
        @Override
        public CreateDingtalkPersonalTodoTaskRequest build() {
            return new CreateDingtalkPersonalTodoTaskRequest(this);
        } 
