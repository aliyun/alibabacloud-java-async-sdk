...
/**
 * 
 * {@link ListEventsViewResponseBody} extends {@link TeaModel}
 *
 * <p>ListEventsViewResponseBody</p>
 */
public class ListEventsViewResponseBody extends TeaModel {
    ...
    private ListEventsViewResponseBody(Builder builder) {
    ...
    public static ListEventsViewResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListEventsViewResponseBody model) {
        ...
        public ListEventsViewResponseBody build() {
            return new ListEventsViewResponseBody(this);
        } 
