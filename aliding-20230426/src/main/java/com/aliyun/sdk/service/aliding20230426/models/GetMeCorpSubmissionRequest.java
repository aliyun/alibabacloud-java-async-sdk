...
/**
 * 
 * {@link GetMeCorpSubmissionRequest} extends {@link RequestModel}
 *
 * <p>GetMeCorpSubmissionRequest</p>
 */
public class GetMeCorpSubmissionRequest extends Request {
    ...
    private GetMeCorpSubmissionRequest(Builder builder) {
        super(builder);
    ...
    public static GetMeCorpSubmissionRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetMeCorpSubmissionRequest, Builder> {
        private AccountContext accountContext; 
        private String appTypes; 
        private String corpId; 
        private Long createFromTimeGMT; 
        ...
        private Builder(GetMeCorpSubmissionRequest request) {
            super(request);
        ...
        @Override
        public GetMeCorpSubmissionRequest build() {
            return new GetMeCorpSubmissionRequest(this);
        } 
    ...
    /**
     * 
     * {@link GetMeCorpSubmissionRequest} extends {@link TeaModel}
     *
     * <p>GetMeCorpSubmissionRequest</p>
     */
