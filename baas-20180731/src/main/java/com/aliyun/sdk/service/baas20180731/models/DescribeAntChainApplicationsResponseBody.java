...
/**
 * {@link DescribeAntChainApplicationsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAntChainApplicationsResponseBody</p>
 */
public class DescribeAntChainApplicationsResponseBody extends TeaModel {
    ...
    private DescribeAntChainApplicationsResponseBody(Builder builder) {
    ...
    public static DescribeAntChainApplicationsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeAntChainApplicationsResponseBody build() {
            return new DescribeAntChainApplicationsResponseBody(this);
        } 
