...
/**
 * {@link DescribeConsortiumConfigResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeConsortiumConfigResponseBody</p>
 */
public class DescribeConsortiumConfigResponseBody extends TeaModel {
    ...
    private DescribeConsortiumConfigResponseBody(Builder builder) {
    ...
    public static DescribeConsortiumConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeConsortiumConfigResponseBody build() {
            return new DescribeConsortiumConfigResponseBody(this);
        } 
