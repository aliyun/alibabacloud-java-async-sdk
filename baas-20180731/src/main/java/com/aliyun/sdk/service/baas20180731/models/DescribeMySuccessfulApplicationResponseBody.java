...
/**
 * {@link DescribeMySuccessfulApplicationResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeMySuccessfulApplicationResponseBody</p>
 */
public class DescribeMySuccessfulApplicationResponseBody extends TeaModel {
    ...
    private DescribeMySuccessfulApplicationResponseBody(Builder builder) {
    ...
    public static DescribeMySuccessfulApplicationResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeMySuccessfulApplicationResponseBody build() {
            return new DescribeMySuccessfulApplicationResponseBody(this);
        } 
