...
/**
 * {@link SynchronizeChaincodeResponseBody} extends {@link TeaModel}
 *
 * <p>SynchronizeChaincodeResponseBody</p>
 */
public class SynchronizeChaincodeResponseBody extends TeaModel {
    ...
    private SynchronizeChaincodeResponseBody(Builder builder) {
    ...
    public static SynchronizeChaincodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public SynchronizeChaincodeResponseBody build() {
            return new SynchronizeChaincodeResponseBody(this);
        } 
