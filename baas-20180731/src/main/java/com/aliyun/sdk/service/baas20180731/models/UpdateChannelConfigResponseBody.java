...
/**
 * {@link UpdateChannelConfigResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateChannelConfigResponseBody</p>
 */
public class UpdateChannelConfigResponseBody extends TeaModel {
    ...
    private UpdateChannelConfigResponseBody(Builder builder) {
    ...
    public static UpdateChannelConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateChannelConfigResponseBody build() {
            return new UpdateChannelConfigResponseBody(this);
        } 
