...
/**
 * {@link CreateBlockchainRequest} extends {@link RequestModel}
 *
 * <p>CreateBlockchainRequest</p>
 */
public class CreateBlockchainRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private CreateBlockchainRequest(Builder builder) {
        super(builder);
    ...
    public static CreateBlockchainRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateBlockchainRequest, Builder> {
        private String regionId; 
        private String bizid; 
        private String blockchainRegionId; 
        private String blockchainType; 
        ...
        private Builder(CreateBlockchainRequest request) {
            super(request);
        ...
        @Override
        public CreateBlockchainRequest build() {
            return new CreateBlockchainRequest(this);
        } 
