...
/**
 * {@link ApplyPublicAntChainWithKeyAutoCreationResponseBody} extends {@link TeaModel}
 *
 * <p>ApplyPublicAntChainWithKeyAutoCreationResponseBody</p>
 */
public class ApplyPublicAntChainWithKeyAutoCreationResponseBody extends TeaModel {
    ...
    private ApplyPublicAntChainWithKeyAutoCreationResponseBody(Builder builder) {
    ...
    public static ApplyPublicAntChainWithKeyAutoCreationResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ApplyPublicAntChainWithKeyAutoCreationResponseBody build() {
            return new ApplyPublicAntChainWithKeyAutoCreationResponseBody(this);
        } 
