...
/**
 * {@link ApplyAntChainCertificateWithKeyAutoCreationResponseBody} extends {@link TeaModel}
 *
 * <p>ApplyAntChainCertificateWithKeyAutoCreationResponseBody</p>
 */
public class ApplyAntChainCertificateWithKeyAutoCreationResponseBody extends TeaModel {
    ...
    private ApplyAntChainCertificateWithKeyAutoCreationResponseBody(Builder builder) {
    ...
    public static ApplyAntChainCertificateWithKeyAutoCreationResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ApplyAntChainCertificateWithKeyAutoCreationResponseBody build() {
            return new ApplyAntChainCertificateWithKeyAutoCreationResponseBody(this);
        } 
