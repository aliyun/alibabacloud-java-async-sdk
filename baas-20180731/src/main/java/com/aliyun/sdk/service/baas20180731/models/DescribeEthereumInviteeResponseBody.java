...
/**
 * {@link DescribeEthereumInviteeResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeEthereumInviteeResponseBody</p>
 */
public class DescribeEthereumInviteeResponseBody extends TeaModel {
    ...
    private DescribeEthereumInviteeResponseBody(Builder builder) {
    ...
    public static DescribeEthereumInviteeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeEthereumInviteeResponseBody build() {
            return new DescribeEthereumInviteeResponseBody(this);
        } 
