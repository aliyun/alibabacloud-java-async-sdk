...
/**
 * {@link DescribeAntChainInformationNewResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAntChainInformationNewResponseBody</p>
 */
public class DescribeAntChainInformationNewResponseBody extends TeaModel {
    ...
    private DescribeAntChainInformationNewResponseBody(Builder builder) {
    ...
    public static DescribeAntChainInformationNewResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeAntChainInformationNewResponseBody build() {
            return new DescribeAntChainInformationNewResponseBody(this);
        } 
