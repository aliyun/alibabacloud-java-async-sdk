...
/**
 * {@link UpdateEthereumNodeResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateEthereumNodeResponseBody</p>
 */
public class UpdateEthereumNodeResponseBody extends TeaModel {
    ...
    private UpdateEthereumNodeResponseBody(Builder builder) {
    ...
    public static UpdateEthereumNodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateEthereumNodeResponseBody build() {
            return new UpdateEthereumNodeResponseBody(this);
        } 
