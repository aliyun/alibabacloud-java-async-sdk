...
/**
 * {@link DescribeMySuccessAppliesResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeMySuccessAppliesResponseBody</p>
 */
public class DescribeMySuccessAppliesResponseBody extends TeaModel {
    ...
    private DescribeMySuccessAppliesResponseBody(Builder builder) {
    ...
    public static DescribeMySuccessAppliesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeMySuccessAppliesResponseBody build() {
            return new DescribeMySuccessAppliesResponseBody(this);
        } 
