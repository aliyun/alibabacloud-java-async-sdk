...
/**
 * {@link DescribeMyBlockchanInfosResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeMyBlockchanInfosResponseBody</p>
 */
public class DescribeMyBlockchanInfosResponseBody extends TeaModel {
    ...
    private DescribeMyBlockchanInfosResponseBody(Builder builder) {
    ...
    public static DescribeMyBlockchanInfosResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeMyBlockchanInfosResponseBody build() {
            return new DescribeMyBlockchanInfosResponseBody(this);
        } 
