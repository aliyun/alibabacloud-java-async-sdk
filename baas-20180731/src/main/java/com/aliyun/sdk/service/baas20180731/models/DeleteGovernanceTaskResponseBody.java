...
/**
 * {@link DeleteGovernanceTaskResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteGovernanceTaskResponseBody</p>
 */
public class DeleteGovernanceTaskResponseBody extends TeaModel {
    ...
    private DeleteGovernanceTaskResponseBody(Builder builder) {
    ...
    public static DeleteGovernanceTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteGovernanceTaskResponseBody build() {
            return new DeleteGovernanceTaskResponseBody(this);
        } 
