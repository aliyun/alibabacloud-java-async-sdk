...
/**
 * {@link DescribeConsortiumAdminStatusResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeConsortiumAdminStatusResponseBody</p>
 */
public class DescribeConsortiumAdminStatusResponseBody extends TeaModel {
    ...
    private DescribeConsortiumAdminStatusResponseBody(Builder builder) {
    ...
    public static DescribeConsortiumAdminStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeConsortiumAdminStatusResponseBody build() {
            return new DescribeConsortiumAdminStatusResponseBody(this);
        } 
