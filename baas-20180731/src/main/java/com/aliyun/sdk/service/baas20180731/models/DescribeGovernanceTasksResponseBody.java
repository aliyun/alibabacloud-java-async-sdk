...
/**
 * {@link DescribeGovernanceTasksResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeGovernanceTasksResponseBody</p>
 */
public class DescribeGovernanceTasksResponseBody extends TeaModel {
    ...
    private DescribeGovernanceTasksResponseBody(Builder builder) {
    ...
    public static DescribeGovernanceTasksResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeGovernanceTasksResponseBody build() {
            return new DescribeGovernanceTasksResponseBody(this);
        } 
