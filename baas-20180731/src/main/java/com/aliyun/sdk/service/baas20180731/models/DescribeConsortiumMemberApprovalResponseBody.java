...
/**
 * {@link DescribeConsortiumMemberApprovalResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeConsortiumMemberApprovalResponseBody</p>
 */
public class DescribeConsortiumMemberApprovalResponseBody extends TeaModel {
    ...
    private DescribeConsortiumMemberApprovalResponseBody(Builder builder) {
    ...
    public static DescribeConsortiumMemberApprovalResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeConsortiumMemberApprovalResponseBody build() {
            return new DescribeConsortiumMemberApprovalResponseBody(this);
        } 
