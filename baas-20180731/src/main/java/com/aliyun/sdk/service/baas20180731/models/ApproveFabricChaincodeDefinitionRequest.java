...
/**
 * {@link ApproveFabricChaincodeDefinitionRequest} extends {@link RequestModel}
 *
 * <p>ApproveFabricChaincodeDefinitionRequest</p>
 */
public class ApproveFabricChaincodeDefinitionRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private ApproveFabricChaincodeDefinitionRequest(Builder builder) {
        super(builder);
    ...
    public static ApproveFabricChaincodeDefinitionRequest create() {
    ...
    public static final class Builder extends Request.Builder<ApproveFabricChaincodeDefinitionRequest, Builder> {
        private String regionId; 
        private String chaincodeId; 
        private String chaincodePackageId; 
        private String location; 
        ...
        private Builder(ApproveFabricChaincodeDefinitionRequest request) {
            super(request);
        ...
        @Override
        public ApproveFabricChaincodeDefinitionRequest build() {
            return new ApproveFabricChaincodeDefinitionRequest(this);
        } 
