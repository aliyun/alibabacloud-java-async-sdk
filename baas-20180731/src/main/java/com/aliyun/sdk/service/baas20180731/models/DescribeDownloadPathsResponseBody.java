...
/**
 * {@link DescribeDownloadPathsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeDownloadPathsResponseBody</p>
 */
public class DescribeDownloadPathsResponseBody extends TeaModel {
    ...
    private DescribeDownloadPathsResponseBody(Builder builder) {
    ...
    public static DescribeDownloadPathsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeDownloadPathsResponseBody build() {
            return new DescribeDownloadPathsResponseBody(this);
        } 
