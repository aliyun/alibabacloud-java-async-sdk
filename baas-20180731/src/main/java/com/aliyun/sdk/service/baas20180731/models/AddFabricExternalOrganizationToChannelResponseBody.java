...
/**
 * {@link AddFabricExternalOrganizationToChannelResponseBody} extends {@link TeaModel}
 *
 * <p>AddFabricExternalOrganizationToChannelResponseBody</p>
 */
public class AddFabricExternalOrganizationToChannelResponseBody extends TeaModel {
    ...
    private AddFabricExternalOrganizationToChannelResponseBody(Builder builder) {
    ...
    public static AddFabricExternalOrganizationToChannelResponseBody create() {
    ...
    public static final class Builder {
        ...
        public AddFabricExternalOrganizationToChannelResponseBody build() {
            return new AddFabricExternalOrganizationToChannelResponseBody(this);
        } 
