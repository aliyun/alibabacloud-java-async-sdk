...
/**
 * 
 * {@link OnsDLQMessageGetByIdResponseBody} extends {@link TeaModel}
 *
 * <p>OnsDLQMessageGetByIdResponseBody</p>
 */
public class OnsDLQMessageGetByIdResponseBody extends TeaModel {
    ...
    private OnsDLQMessageGetByIdResponseBody(Builder builder) {
    ...
    public static OnsDLQMessageGetByIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OnsDLQMessageGetByIdResponseBody model) {
        ...
        public OnsDLQMessageGetByIdResponseBody build() {
            return new OnsDLQMessageGetByIdResponseBody(this);
        } 
