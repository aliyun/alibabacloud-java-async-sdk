...
/**
 * 
 * {@link GetScannerTaskResultHtmlUrlRequest} extends {@link RequestModel}
 *
 * <p>GetScannerTaskResultHtmlUrlRequest</p>
 */
public class GetScannerTaskResultHtmlUrlRequest extends Request {
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("ScannerTaskId")
    @com.aliyun.core.annotation.Validation(required = true)
    private String scannerTaskId;

    private GetScannerTaskResultHtmlUrlRequest(Builder builder) {
        super(builder);
    ...
    public static GetScannerTaskResultHtmlUrlRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetScannerTaskResultHtmlUrlRequest, Builder> {
        private String scannerTaskId; 
        ...
        private Builder(GetScannerTaskResultHtmlUrlRequest request) {
            super(request);
        ...
        @Override
        public GetScannerTaskResultHtmlUrlRequest build() {
            return new GetScannerTaskResultHtmlUrlRequest(this);
        } 
