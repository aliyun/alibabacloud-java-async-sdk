...
/**
 * 
 * {@link GetPromptVersionRequest} extends {@link RequestModel}
 *
 * <p>GetPromptVersionRequest</p>
 */
public class GetPromptVersionRequest extends Request {
    ...
    private GetPromptVersionRequest(Builder builder) {
        super(builder);
    ...
    public static GetPromptVersionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetPromptVersionRequest, Builder> {
        private String namespaceId; 
        private String promptKey; 
        private String promptVersion; 
        ...
        private Builder(GetPromptVersionRequest request) {
            super(request);
        ...
        @Override
        public GetPromptVersionRequest build() {
            return new GetPromptVersionRequest(this);
        } 
