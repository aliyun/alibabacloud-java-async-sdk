...
/**
 * 
 * {@link CreateNodeGroupConfig} extends {@link TeaModel}
 *
 * <p>CreateNodeGroupConfig</p>
 */
public class CreateNodeGroupConfig extends TeaModel {
    ...
    private java.util.List<SpotBidPrices> spotBidPrices;
    ...
    private CreateNodeGroupConfig(Builder builder) {
    ...
    public static CreateNodeGroupConfig create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateNodeGroupConfig model) {
         ...
         */
        public Builder spotBidPrices(java.util.List<SpotBidPrices> spotBidPrices) {
        ...
        public CreateNodeGroupConfig build() {
            return new CreateNodeGroupConfig(this);
        } 
    ...
    public static class SpotBidPrices extends TeaModel {
        ...
        private SpotBidPrices(Builder builder) {
        ...
        public static SpotBidPrices create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            private Builder(SpotBidPrices model) {
            ...
            public SpotBidPrices build() {
                return new SpotBidPrices(this);
            } 
