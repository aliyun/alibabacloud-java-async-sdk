...
/**
 * 
 * {@link PutManagedScalingPolicyRequest} extends {@link RequestModel}
 *
 * <p>PutManagedScalingPolicyRequest</p>
 */
public class PutManagedScalingPolicyRequest extends Request {
    ...
    private PutManagedScalingPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static PutManagedScalingPolicyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<PutManagedScalingPolicyRequest, Builder> {
        private String clusterId; 
        private ManagedScalingConstraints constraints; 
        private String regionId; 
        ...
        private Builder(PutManagedScalingPolicyRequest request) {
            super(request);
