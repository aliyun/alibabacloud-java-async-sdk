...
public class GetAutoScalingPolicyResponse extends Response {
    ...
    public static GetAutoScalingPolicyResponse create() {
    ...
    public interface Builder extends Response.Builder<GetAutoScalingPolicyResponse, Builder> {
        ...
        Builder body(GetAutoScalingPolicyResponseBody body);

        @Override
        GetAutoScalingPolicyResponse build();
    ...
    private static final class BuilderImpl
        ...
        private BuilderImpl(GetAutoScalingPolicyResponse response) {
            super(response);
         ...
         */
        @Override
        public Builder body(GetAutoScalingPolicyResponseBody body) {
            this.body = body;
            return this;
        }
