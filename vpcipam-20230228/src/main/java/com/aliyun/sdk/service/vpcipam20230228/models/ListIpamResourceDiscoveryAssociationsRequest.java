...
/**
 * 
 * {@link ListIpamResourceDiscoveryAssociationsRequest} extends {@link RequestModel}
 *
 * <p>ListIpamResourceDiscoveryAssociationsRequest</p>
 */
public class ListIpamResourceDiscoveryAssociationsRequest extends Request {
    ...
    private ListIpamResourceDiscoveryAssociationsRequest(Builder builder) {
        super(builder);
    ...
    public static ListIpamResourceDiscoveryAssociationsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListIpamResourceDiscoveryAssociationsRequest, Builder> {
        private String ipamId; 
        private String ipamResourceDiscoveryId; 
        private Integer maxResults; 
        private String nextToken; 
        ...
        private Builder(ListIpamResourceDiscoveryAssociationsRequest request) {
            super(request);
        ...
        @Override
        public ListIpamResourceDiscoveryAssociationsRequest build() {
            return new ListIpamResourceDiscoveryAssociationsRequest(this);
        } 
