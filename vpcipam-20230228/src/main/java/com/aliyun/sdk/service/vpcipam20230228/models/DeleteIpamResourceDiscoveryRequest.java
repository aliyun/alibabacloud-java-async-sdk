...
/**
 * 
 * {@link DeleteIpamResourceDiscoveryRequest} extends {@link RequestModel}
 *
 * <p>DeleteIpamResourceDiscoveryRequest</p>
 */
public class DeleteIpamResourceDiscoveryRequest extends Request {
    ...
    private DeleteIpamResourceDiscoveryRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteIpamResourceDiscoveryRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteIpamResourceDiscoveryRequest, Builder> {
        private String clientToken; 
        private Boolean dryRun; 
        private String ipamResourceDiscoveryId; 
        private String ownerAccount; 
        ...
        private Builder(DeleteIpamResourceDiscoveryRequest request) {
            super(request);
