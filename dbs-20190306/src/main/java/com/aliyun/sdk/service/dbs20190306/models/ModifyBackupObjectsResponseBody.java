...
/**
 * 
 * {@link ModifyBackupObjectsResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyBackupObjectsResponseBody</p>
 */
public class ModifyBackupObjectsResponseBody extends TeaModel {
    ...
    private ModifyBackupObjectsResponseBody(Builder builder) {
    ...
    public static ModifyBackupObjectsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyBackupObjectsResponseBody model) {
        ...
        public ModifyBackupObjectsResponseBody build() {
            return new ModifyBackupObjectsResponseBody(this);
        } 
