...
/**
 * 
 * {@link ModifyBackupStrategyResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyBackupStrategyResponseBody</p>
 */
public class ModifyBackupStrategyResponseBody extends TeaModel {
    ...
    private ModifyBackupStrategyResponseBody(Builder builder) {
    ...
    public static ModifyBackupStrategyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyBackupStrategyResponseBody model) {
        ...
        public ModifyBackupStrategyResponseBody build() {
            return new ModifyBackupStrategyResponseBody(this);
        } 
