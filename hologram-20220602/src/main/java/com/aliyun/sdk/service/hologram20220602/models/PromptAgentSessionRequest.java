...
public class PromptAgentSessionRequest extends Request {
    ...
    @com.aliyun.core.annotation.NameInMap("Caller-Context")
...
@Override
    ...
    public static final class Builder extends Request.Builder<PromptAgentSessionRequest, Builder> {
        ...
        private Builder(PromptAgentSessionRequest request) {
            super(request);
            this.callerContext = request.callerContext;
            this.id = request.id;
         ...
         * Caller-Context.
         */
        public Builder callerContext(String callerContext) {
            this.putBodyParameter("Caller-Context", callerContext);
