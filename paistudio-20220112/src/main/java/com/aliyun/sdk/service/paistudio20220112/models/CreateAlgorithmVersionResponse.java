...
/**
 * {@link CreateAlgorithmVersionResponse} extends {@link TeaModel}
 *
 * <p>CreateAlgorithmVersionResponse</p>
 */
public class CreateAlgorithmVersionResponse extends Response {
    @NameInMap("headers")
    ...
    public static CreateAlgorithmVersionResponse create() {
    ...
    public interface Builder extends Response.Builder<CreateAlgorithmVersionResponse, Builder> {
        ...
        @Override
        CreateAlgorithmVersionResponse build();
    ...
    private static final class BuilderImpl
         ...
         */
        @Override
        public Builder body(CreateAlgorithmVersionResponseBody body) {
            this.body = body;
            return this;
        }

        @Override
        public CreateAlgorithmVersionResponse build() {
            return new CreateAlgorithmVersionResponse(this);
        } 
