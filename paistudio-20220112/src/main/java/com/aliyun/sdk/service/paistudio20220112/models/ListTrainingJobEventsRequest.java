 ...
 */
public class ListTrainingJobEventsRequest extends Request {
    ...
    private ListTrainingJobEventsRequest(Builder builder) {
        super(builder);
    ...
    public static ListTrainingJobEventsRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListTrainingJobEventsRequest, Builder> {
        private String trainingJobId; 
        private String endTime; 
        private Long pageNumber; 
        private Long pageSize; 
        ...
        private Builder(ListTrainingJobEventsRequest request) {
            super(request);
        ...
        @Override
        public ListTrainingJobEventsRequest build() {
            return new ListTrainingJobEventsRequest(this);
        } 
