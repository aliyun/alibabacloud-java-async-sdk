...
/**
 * 
 * {@link ListAuthorizedAccountsResponseBody} extends {@link TeaModel}
 *
 * <p>ListAuthorizedAccountsResponseBody</p>
 */
public class ListAuthorizedAccountsResponseBody extends TeaModel {
    ...
    private ListAuthorizedAccountsResponseBody(Builder builder) {
    ...
    public static ListAuthorizedAccountsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAuthorizedAccountsResponseBody model) {
        ...
        public ListAuthorizedAccountsResponseBody build() {
            return new ListAuthorizedAccountsResponseBody(this);
        } 
