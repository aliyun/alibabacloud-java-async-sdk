...
/**
 * 
 * {@link ListSystemAlarmsRequest} extends {@link RequestModel}
 *
 * <p>ListSystemAlarmsRequest</p>
 */
public class ListSystemAlarmsRequest extends Request {
    ...
    private ListSystemAlarmsRequest(Builder builder) {
        super(builder);
    ...
    public static ListSystemAlarmsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListSystemAlarmsRequest, Builder> {
        private Integer alarmType; 
        private String beginDate; 
        private String endDate; 
        private String instanceId; 
        ...
        private Builder(ListSystemAlarmsRequest request) {
            super(request);
        ...
        @Override
        public ListSystemAlarmsRequest build() {
            return new ListSystemAlarmsRequest(this);
        } 
