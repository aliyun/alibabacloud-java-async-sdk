...
/**
 * 
 * {@link UpdateDevProdProjectRequest} extends {@link RequestModel}
 *
 * <p>UpdateDevProdProjectRequest</p>
 */
public class UpdateDevProdProjectRequest extends Request {
    ...
    private UpdateDevProdProjectRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateDevProdProjectRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateDevProdProjectRequest, Builder> {
        private String regionId; 
        private Long opTenantId; 
        private UpdateCommand updateCommand; 
        ...
        private Builder(UpdateDevProdProjectRequest request) {
            super(request);
        ...
        @Override
        public UpdateDevProdProjectRequest build() {
            return new UpdateDevProdProjectRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateDevProdProjectRequest} extends {@link TeaModel}
     *
     * <p>UpdateDevProdProjectRequest</p>
     */
    ...
    public static class UpdateCommand extends TeaModel {
        ...
        @com.aliyun.core.annotation.NameInMap("DevComputeSourceId")
        private Long devComputeSourceId;

        @com.aliyun.core.annotation.NameInMap("DevDescription")
        private String devDescription;

        @com.aliyun.core.annotation.NameInMap("DevStreamComputeSourceId")
        ...
        @com.aliyun.core.annotation.NameInMap("ProdComputeSourceId")
        private Long prodComputeSourceId;

        @com.aliyun.core.annotation.NameInMap("ProdDescription")
        private String prodDescription;

        @com.aliyun.core.annotation.NameInMap("ProdStreamComputeSourceId")
        ...
        private UpdateCommand(Builder builder) {
            ...
            this.devComputeSourceId = builder.devComputeSourceId;
            this.devDescription = builder.devDescription;
            this.devStreamComputeSourceId = builder.devStreamComputeSourceId;
            this.displayName = builder.displayName;
            this.id = builder.id;
            this.name = builder.name;
            this.nameSpaceTag = builder.nameSpaceTag;
            this.prodComputeSourceId = builder.prodComputeSourceId;
            this.prodDescription = builder.prodDescription;
            this.prodStreamComputeSourceId = builder.prodStreamComputeSourceId;
        ...
        /**
         * @return devStreamComputeSourceId
         */
        ...
        /**
         * @return prodStreamComputeSourceId
         */
        ...
        public static final class Builder {
            ...
            private Builder(UpdateCommand model) {
                ...
                this.devComputeSourceId = model.devComputeSourceId;
                this.devDescription = model.devDescription;
                this.devStreamComputeSourceId = model.devStreamComputeSourceId;
                this.displayName = model.displayName;
                this.id = model.id;
                this.name = model.name;
                this.nameSpaceTag = model.nameSpaceTag;
                this.prodComputeSourceId = model.prodComputeSourceId;
                this.prodDescription = model.prodDescription;
                this.prodStreamComputeSourceId = model.prodStreamComputeSourceId;
