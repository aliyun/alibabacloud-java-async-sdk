...
/**
 * 
 * {@link CreateKgRelationRequest} extends {@link RequestModel}
 *
 * <p>CreateKgRelationRequest</p>
 */
public class CreateKgRelationRequest extends Request {
    ...
    private CreateKgRelationRequest(Builder builder) {
        super(builder);
    ...
    public static CreateKgRelationRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateKgRelationRequest, Builder> {
        private String regionId; 
        private CreateCommand createCommand; 
        private Long opTenantId; 
        private String opUserId; 
        ...
        private Builder(CreateKgRelationRequest request) {
            super(request);
        ...
        @Override
        public CreateKgRelationRequest build() {
            return new CreateKgRelationRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateKgRelationRequest} extends {@link TeaModel}
     *
     * <p>CreateKgRelationRequest</p>
     */
