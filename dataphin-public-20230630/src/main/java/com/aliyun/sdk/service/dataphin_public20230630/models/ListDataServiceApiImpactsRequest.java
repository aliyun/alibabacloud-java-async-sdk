...
/**
 * 
 * {@link ListDataServiceApiImpactsRequest} extends {@link RequestModel}
 *
 * <p>ListDataServiceApiImpactsRequest</p>
 */
public class ListDataServiceApiImpactsRequest extends Request {
    ...
    private ListDataServiceApiImpactsRequest(Builder builder) {
        super(builder);
    ...
    public static ListDataServiceApiImpactsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListDataServiceApiImpactsRequest, Builder> {
        private String regionId; 
        private ListQuery listQuery; 
        private Long opTenantId; 
        private Integer projectId; 
        ...
        private Builder(ListDataServiceApiImpactsRequest request) {
            super(request);
        ...
        @Override
        public ListDataServiceApiImpactsRequest build() {
            return new ListDataServiceApiImpactsRequest(this);
        } 
    ...
    /**
     * 
     * {@link ListDataServiceApiImpactsRequest} extends {@link TeaModel}
     *
     * <p>ListDataServiceApiImpactsRequest</p>
     */
