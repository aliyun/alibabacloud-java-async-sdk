...
/**
 * 
 * {@link GetLlmModelProviderByNameResponseBody} extends {@link TeaModel}
 *
 * <p>GetLlmModelProviderByNameResponseBody</p>
 */
public class GetLlmModelProviderByNameResponseBody extends TeaModel {
    ...
    private GetLlmModelProviderByNameResponseBody(Builder builder) {
    ...
    public static GetLlmModelProviderByNameResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetLlmModelProviderByNameResponseBody model) {
        ...
        public GetLlmModelProviderByNameResponseBody build() {
            return new GetLlmModelProviderByNameResponseBody(this);
        } 
