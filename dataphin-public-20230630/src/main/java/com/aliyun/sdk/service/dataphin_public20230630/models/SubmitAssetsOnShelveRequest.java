...
/**
 * 
 * {@link SubmitAssetsOnShelveRequest} extends {@link RequestModel}
 *
 * <p>SubmitAssetsOnShelveRequest</p>
 */
public class SubmitAssetsOnShelveRequest extends Request {
    ...
    private SubmitAssetsOnShelveRequest(Builder builder) {
        super(builder);
    ...
    public static SubmitAssetsOnShelveRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SubmitAssetsOnShelveRequest, Builder> {
        private String regionId; 
        private Long opTenantId; 
        private String opUserId; 
        private SubmitCommand submitCommand; 
        ...
        private Builder(SubmitAssetsOnShelveRequest request) {
            super(request);
        ...
        @Override
        public SubmitAssetsOnShelveRequest build() {
            return new SubmitAssetsOnShelveRequest(this);
        } 
    ...
    /**
     * 
     * {@link SubmitAssetsOnShelveRequest} extends {@link TeaModel}
     *
     * <p>SubmitAssetsOnShelveRequest</p>
     */
