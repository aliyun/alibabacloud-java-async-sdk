...
/**
 * 
 * {@link DeleteStandardValidMappingRequest} extends {@link RequestModel}
 *
 * <p>DeleteStandardValidMappingRequest</p>
 */
public class DeleteStandardValidMappingRequest extends Request {
    ...
    private DeleteStandardValidMappingRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteStandardValidMappingRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteStandardValidMappingRequest, Builder> {
        private String regionId; 
        private DeleteCommand deleteCommand; 
        private Long opTenantId; 
        ...
        private Builder(DeleteStandardValidMappingRequest request) {
            super(request);
        ...
        @Override
        public DeleteStandardValidMappingRequest build() {
            return new DeleteStandardValidMappingRequest(this);
        } 
    ...
    /**
     * 
     * {@link DeleteStandardValidMappingRequest} extends {@link TeaModel}
     *
     * <p>DeleteStandardValidMappingRequest</p>
     */
