...
/**
 * 
 * {@link ListRowPermissionResponseBody} extends {@link TeaModel}
 *
 * <p>ListRowPermissionResponseBody</p>
 */
public class ListRowPermissionResponseBody extends TeaModel {
    ...
    private ListRowPermissionResponseBody(Builder builder) {
    ...
    public static ListRowPermissionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListRowPermissionResponseBody model) {
        ...
        public ListRowPermissionResponseBody build() {
            return new ListRowPermissionResponseBody(this);
        } 
