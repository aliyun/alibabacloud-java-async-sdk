...
/**
 * 
 * {@link CreateWorkFlowByJsonResponseBody} extends {@link TeaModel}
 *
 * <p>CreateWorkFlowByJsonResponseBody</p>
 */
public class CreateWorkFlowByJsonResponseBody extends TeaModel {
    ...
    private CreateWorkFlowByJsonResponseBody(Builder builder) {
    ...
    public static CreateWorkFlowByJsonResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateWorkFlowByJsonResponseBody model) {
        ...
        public CreateWorkFlowByJsonResponseBody build() {
            return new CreateWorkFlowByJsonResponseBody(this);
        } 
