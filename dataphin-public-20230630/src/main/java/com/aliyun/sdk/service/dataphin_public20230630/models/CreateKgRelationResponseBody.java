...
/**
 * 
 * {@link CreateKgRelationResponseBody} extends {@link TeaModel}
 *
 * <p>CreateKgRelationResponseBody</p>
 */
public class CreateKgRelationResponseBody extends TeaModel {
    ...
    private CreateKgRelationResponseBody(Builder builder) {
    ...
    public static CreateKgRelationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateKgRelationResponseBody model) {
        ...
        public CreateKgRelationResponseBody build() {
            return new CreateKgRelationResponseBody(this);
        } 
