...
/**
 * 
 * {@link GetQualityWatchByObjectIdResponseBody} extends {@link TeaModel}
 *
 * <p>GetQualityWatchByObjectIdResponseBody</p>
 */
public class GetQualityWatchByObjectIdResponseBody extends TeaModel {
    ...
    private GetQualityWatchByObjectIdResponseBody(Builder builder) {
    ...
    public static GetQualityWatchByObjectIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetQualityWatchByObjectIdResponseBody model) {
        ...
        public GetQualityWatchByObjectIdResponseBody build() {
            return new GetQualityWatchByObjectIdResponseBody(this);
        } 
