...
/**
 * 
 * {@link UpdateComputeClusterRequest} extends {@link RequestModel}
 *
 * <p>UpdateComputeClusterRequest</p>
 */
public class UpdateComputeClusterRequest extends Request {
    ...
    private UpdateComputeClusterRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateComputeClusterRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateComputeClusterRequest, Builder> {
        private String regionId; 
        private ClusterConfig clusterConfig; 
        private Long id; 
        private Long opTenantId; 
        ...
        private Builder(UpdateComputeClusterRequest request) {
            super(request);
        ...
        public UpdateComputeClusterRequest build() {
            return new UpdateComputeClusterRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateComputeClusterRequest} extends {@link TeaModel}
     *
     * <p>UpdateComputeClusterRequest</p>
     */
