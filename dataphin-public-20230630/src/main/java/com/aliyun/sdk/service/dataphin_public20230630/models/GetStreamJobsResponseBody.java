...
/**
 * 
 * {@link GetStreamJobsResponseBody} extends {@link TeaModel}
 *
 * <p>GetStreamJobsResponseBody</p>
 */
public class GetStreamJobsResponseBody extends TeaModel {
    ...
    private GetStreamJobsResponseBody(Builder builder) {
    ...
    public static GetStreamJobsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetStreamJobsResponseBody model) {
        ...
        public GetStreamJobsResponseBody build() {
            return new GetStreamJobsResponseBody(this);
        } 
