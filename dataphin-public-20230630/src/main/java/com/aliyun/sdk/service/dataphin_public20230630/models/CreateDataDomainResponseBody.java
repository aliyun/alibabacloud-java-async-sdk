...
/**
 * 
 * {@link CreateDataDomainResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDataDomainResponseBody</p>
 */
public class CreateDataDomainResponseBody extends TeaModel {
    ...
    private CreateDataDomainResponseBody(Builder builder) {
    ...
    public static CreateDataDomainResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDataDomainResponseBody model) {
        ...
        public CreateDataDomainResponseBody build() {
            return new CreateDataDomainResponseBody(this);
        } 
