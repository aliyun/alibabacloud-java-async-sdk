...
/**
 * 
 * {@link ListAddableRolesResponseBody} extends {@link TeaModel}
 *
 * <p>ListAddableRolesResponseBody</p>
 */
public class ListAddableRolesResponseBody extends TeaModel {
    ...
    private ListAddableRolesResponseBody(Builder builder) {
    ...
    public static ListAddableRolesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAddableRolesResponseBody model) {
        ...
        public ListAddableRolesResponseBody build() {
            return new ListAddableRolesResponseBody(this);
        } 
