...
/**
 * 
 * {@link OfflinePipelineByAsyncRequest} extends {@link RequestModel}
 *
 * <p>OfflinePipelineByAsyncRequest</p>
 */
public class OfflinePipelineByAsyncRequest extends Request {
    ...
    private OfflinePipelineByAsyncRequest(Builder builder) {
        super(builder);
    ...
    public static OfflinePipelineByAsyncRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<OfflinePipelineByAsyncRequest, Builder> {
        private String regionId; 
        private Context context; 
        private OfflineCommand offlineCommand; 
        private Long opTenantId; 
        ...
        private Builder(OfflinePipelineByAsyncRequest request) {
            super(request);
        ...
        @Override
        public OfflinePipelineByAsyncRequest build() {
            return new OfflinePipelineByAsyncRequest(this);
        } 
    ...
    /**
     * 
     * {@link OfflinePipelineByAsyncRequest} extends {@link TeaModel}
     *
     * <p>OfflinePipelineByAsyncRequest</p>
     */
