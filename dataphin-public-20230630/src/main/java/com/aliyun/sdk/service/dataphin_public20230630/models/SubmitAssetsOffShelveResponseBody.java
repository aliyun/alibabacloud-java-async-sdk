...
/**
 * 
 * {@link SubmitAssetsOffShelveResponseBody} extends {@link TeaModel}
 *
 * <p>SubmitAssetsOffShelveResponseBody</p>
 */
public class SubmitAssetsOffShelveResponseBody extends TeaModel {
    ...
    private SubmitAssetsOffShelveResponseBody(Builder builder) {
    ...
    public static SubmitAssetsOffShelveResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SubmitAssetsOffShelveResponseBody model) {
        ...
        public SubmitAssetsOffShelveResponseBody build() {
            return new SubmitAssetsOffShelveResponseBody(this);
        } 
