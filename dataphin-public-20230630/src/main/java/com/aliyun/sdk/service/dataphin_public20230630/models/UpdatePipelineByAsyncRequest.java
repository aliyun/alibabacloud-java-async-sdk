...
/**
 * 
 * {@link UpdatePipelineByAsyncRequest} extends {@link RequestModel}
 *
 * <p>UpdatePipelineByAsyncRequest</p>
 */
public class UpdatePipelineByAsyncRequest extends Request {
    ...
    private UpdatePipelineByAsyncRequest(Builder builder) {
        super(builder);
    ...
    public static UpdatePipelineByAsyncRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdatePipelineByAsyncRequest, Builder> {
        private String regionId; 
        private Context context; 
        private Long opTenantId; 
        private UpdateCommand updateCommand; 
        ...
        private Builder(UpdatePipelineByAsyncRequest request) {
            super(request);
        ...
        @Override
        public UpdatePipelineByAsyncRequest build() {
            return new UpdatePipelineByAsyncRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdatePipelineByAsyncRequest} extends {@link TeaModel}
     *
     * <p>UpdatePipelineByAsyncRequest</p>
     */
