...
/**
 * 
 * {@link GetBizEntityInfoByVersionResponseBody} extends {@link TeaModel}
 *
 * <p>GetBizEntityInfoByVersionResponseBody</p>
 */
public class GetBizEntityInfoByVersionResponseBody extends TeaModel {
    ...
    private GetBizEntityInfoByVersionResponseBody(Builder builder) {
    ...
    public static GetBizEntityInfoByVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetBizEntityInfoByVersionResponseBody model) {
        ...
        public GetBizEntityInfoByVersionResponseBody build() {
            return new GetBizEntityInfoByVersionResponseBody(this);
        } 
