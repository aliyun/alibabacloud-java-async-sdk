...
/**
 * 
 * {@link CheckComputeSourceConnectivityRequest} extends {@link RequestModel}
 *
 * <p>CheckComputeSourceConnectivityRequest</p>
 */
public class CheckComputeSourceConnectivityRequest extends Request {
    ...
    private CheckComputeSourceConnectivityRequest(Builder builder) {
        super(builder);
    ...
    public static CheckComputeSourceConnectivityRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CheckComputeSourceConnectivityRequest, Builder> {
        private String regionId; 
        private CheckCommand checkCommand; 
        private Long opTenantId; 
        ...
        private Builder(CheckComputeSourceConnectivityRequest request) {
            super(request);
        ...
        @Override
        public CheckComputeSourceConnectivityRequest build() {
            return new CheckComputeSourceConnectivityRequest(this);
        } 
    ...
    /**
     * 
     * {@link CheckComputeSourceConnectivityRequest} extends {@link TeaModel}
     *
     * <p>CheckComputeSourceConnectivityRequest</p>
     */
