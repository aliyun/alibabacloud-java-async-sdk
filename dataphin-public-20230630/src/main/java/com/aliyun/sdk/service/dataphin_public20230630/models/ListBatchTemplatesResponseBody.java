...
/**
 * 
 * {@link ListBatchTemplatesResponseBody} extends {@link TeaModel}
 *
 * <p>ListBatchTemplatesResponseBody</p>
 */
public class ListBatchTemplatesResponseBody extends TeaModel {
    ...
    private ListBatchTemplatesResponseBody(Builder builder) {
    ...
    public static ListBatchTemplatesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListBatchTemplatesResponseBody model) {
        ...
        public ListBatchTemplatesResponseBody build() {
            return new ListBatchTemplatesResponseBody(this);
        } 
