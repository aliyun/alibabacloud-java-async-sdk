...
/**
 * 
 * {@link DeleteStandardRequest} extends {@link RequestModel}
 *
 * <p>DeleteStandardRequest</p>
 */
public class DeleteStandardRequest extends Request {
    ...
    private DeleteStandardRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteStandardRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteStandardRequest, Builder> {
        private String regionId; 
        private DeleteCommand deleteCommand; 
        private Long opTenantId; 
        ...
        private Builder(DeleteStandardRequest request) {
            super(request);
        ...
        @Override
        public DeleteStandardRequest build() {
            return new DeleteStandardRequest(this);
        } 
    ...
    /**
     * 
     * {@link DeleteStandardRequest} extends {@link TeaModel}
     *
     * <p>DeleteStandardRequest</p>
     */
