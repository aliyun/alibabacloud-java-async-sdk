...
/**
 * 
 * {@link CreateBasicProjectResponseBody} extends {@link TeaModel}
 *
 * <p>CreateBasicProjectResponseBody</p>
 */
public class CreateBasicProjectResponseBody extends TeaModel {
    ...
    private CreateBasicProjectResponseBody(Builder builder) {
    ...
    public static CreateBasicProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateBasicProjectResponseBody model) {
        ...
        public CreateBasicProjectResponseBody build() {
            return new CreateBasicProjectResponseBody(this);
        } 
