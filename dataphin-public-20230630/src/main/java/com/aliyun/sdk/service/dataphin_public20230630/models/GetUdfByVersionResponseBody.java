...
/**
 * 
 * {@link GetUdfByVersionResponseBody} extends {@link TeaModel}
 *
 * <p>GetUdfByVersionResponseBody</p>
 */
public class GetUdfByVersionResponseBody extends TeaModel {
    ...
    private GetUdfByVersionResponseBody(Builder builder) {
    ...
    public static GetUdfByVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetUdfByVersionResponseBody model) {
        ...
        public GetUdfByVersionResponseBody build() {
            return new GetUdfByVersionResponseBody(this);
        } 
