...
/**
 * 
 * {@link CreateStandardRequest} extends {@link RequestModel}
 *
 * <p>CreateStandardRequest</p>
 */
public class CreateStandardRequest extends Request {
    ...
    private CreateStandardRequest(Builder builder) {
        super(builder);
    ...
    public static CreateStandardRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateStandardRequest, Builder> {
        private String regionId; 
        private CreateCommand createCommand; 
        private Long opTenantId; 
        ...
        private Builder(CreateStandardRequest request) {
            super(request);
        ...
        @Override
        public CreateStandardRequest build() {
            return new CreateStandardRequest(this);
        } 
    ...
    /**
     * 
     * {@link CreateStandardRequest} extends {@link TeaModel}
     *
     * <p>CreateStandardRequest</p>
     */
