...
/**
 * 
 * {@link ExecKgGremlinRequest} extends {@link RequestModel}
 *
 * <p>ExecKgGremlinRequest</p>
 */
public class ExecKgGremlinRequest extends Request {
    ...
    private ExecKgGremlinRequest(Builder builder) {
        super(builder);
    ...
    public static ExecKgGremlinRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ExecKgGremlinRequest, Builder> {
        private String regionId; 
        private ExecCommand execCommand; 
        private Long opTenantId; 
        private String opUserId; 
        ...
        private Builder(ExecKgGremlinRequest request) {
            super(request);
        ...
        @Override
        public ExecKgGremlinRequest build() {
            return new ExecKgGremlinRequest(this);
        } 
    ...
    /**
     * 
     * {@link ExecKgGremlinRequest} extends {@link TeaModel}
     *
     * <p>ExecKgGremlinRequest</p>
     */
