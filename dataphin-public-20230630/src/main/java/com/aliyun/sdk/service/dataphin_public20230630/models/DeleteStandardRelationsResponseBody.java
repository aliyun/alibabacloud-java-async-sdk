...
/**
 * 
 * {@link DeleteStandardRelationsResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteStandardRelationsResponseBody</p>
 */
public class DeleteStandardRelationsResponseBody extends TeaModel {
    ...
    private DeleteStandardRelationsResponseBody(Builder builder) {
    ...
    public static DeleteStandardRelationsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteStandardRelationsResponseBody model) {
        ...
        public DeleteStandardRelationsResponseBody build() {
            return new DeleteStandardRelationsResponseBody(this);
        } 
