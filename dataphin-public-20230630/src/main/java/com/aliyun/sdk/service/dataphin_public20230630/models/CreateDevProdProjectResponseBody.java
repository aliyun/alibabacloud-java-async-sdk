...
/**
 * 
 * {@link CreateDevProdProjectResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDevProdProjectResponseBody</p>
 */
public class CreateDevProdProjectResponseBody extends TeaModel {
    ...
    private CreateDevProdProjectResponseBody(Builder builder) {
    ...
    public static CreateDevProdProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateDevProdProjectResponseBody model) {
        ...
        public CreateDevProdProjectResponseBody build() {
            return new CreateDevProdProjectResponseBody(this);
        } 
