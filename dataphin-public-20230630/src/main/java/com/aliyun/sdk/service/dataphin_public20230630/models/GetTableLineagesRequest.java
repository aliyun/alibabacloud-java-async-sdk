...
/**
 * 
 * {@link GetTableLineagesRequest} extends {@link RequestModel}
 *
 * <p>GetTableLineagesRequest</p>
 */
public class GetTableLineagesRequest extends Request {
    ...
    private GetTableLineagesRequest(Builder builder) {
        super(builder);
    ...
    public static GetTableLineagesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetTableLineagesRequest, Builder> {
        private String regionId; 
        private FilterQuery filterQuery; 
        private Long opTenantId; 
        private String tableGuid; 
        ...
        private Builder(GetTableLineagesRequest request) {
            super(request);
        ...
        @Override
        public GetTableLineagesRequest build() {
            return new GetTableLineagesRequest(this);
        } 
    ...
    /**
     * 
     * {@link GetTableLineagesRequest} extends {@link TeaModel}
     *
     * <p>GetTableLineagesRequest</p>
     */
