...
/**
 * 
 * {@link CreateKgEntityResponseBody} extends {@link TeaModel}
 *
 * <p>CreateKgEntityResponseBody</p>
 */
public class CreateKgEntityResponseBody extends TeaModel {
    ...
    private CreateKgEntityResponseBody(Builder builder) {
    ...
    public static CreateKgEntityResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateKgEntityResponseBody model) {
        ...
        public CreateKgEntityResponseBody build() {
            return new CreateKgEntityResponseBody(this);
        } 
