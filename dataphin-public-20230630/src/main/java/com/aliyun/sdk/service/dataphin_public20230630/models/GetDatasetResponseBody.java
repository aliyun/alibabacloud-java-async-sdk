...
public class GetDatasetResponseBody extends TeaModel {
    ...
    @com.aliyun.core.annotation.NameInMap("DatasetDTO")
    ...
    private GetDatasetResponseBody(Builder builder) {
        ...
        this.datasetDTO = builder.datasetDTO;
    ...
    public static final class Builder {
        ...
        private Builder(GetDatasetResponseBody model) {
            ...
            this.datasetDTO = model.datasetDTO;
         ...
         * DatasetDTO.
         */
        public Builder datasetDTO(DatasetDTO datasetDTO) {
     ...
     * <p>GetDatasetResponseBody</p>
     */
    public static class DatasetDTO extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(DatasetDTO model) {
