...
/**
 * 
 * {@link GetProjectByNameResponseBody} extends {@link TeaModel}
 *
 * <p>GetProjectByNameResponseBody</p>
 */
public class GetProjectByNameResponseBody extends TeaModel {
    ...
    private GetProjectByNameResponseBody(Builder builder) {
    ...
    public static GetProjectByNameResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetProjectByNameResponseBody model) {
        ...
        public GetProjectByNameResponseBody build() {
            return new GetProjectByNameResponseBody(this);
        } 
