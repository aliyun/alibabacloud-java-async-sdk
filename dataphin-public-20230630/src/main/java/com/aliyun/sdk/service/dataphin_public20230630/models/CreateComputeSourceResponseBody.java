...
/**
 * 
 * {@link CreateComputeSourceResponseBody} extends {@link TeaModel}
 *
 * <p>CreateComputeSourceResponseBody</p>
 */
public class CreateComputeSourceResponseBody extends TeaModel {
    ...
    private CreateComputeSourceResponseBody(Builder builder) {
    ...
    public static CreateComputeSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateComputeSourceResponseBody model) {
        ...
        public CreateComputeSourceResponseBody build() {
            return new CreateComputeSourceResponseBody(this);
        } 
