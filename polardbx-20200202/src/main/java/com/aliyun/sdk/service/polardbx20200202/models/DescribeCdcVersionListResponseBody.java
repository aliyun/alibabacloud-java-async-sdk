...
/**
 * 
 * {@link DescribeCdcVersionListResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeCdcVersionListResponseBody</p>
 */
public class DescribeCdcVersionListResponseBody extends TeaModel {
    ...
    private DescribeCdcVersionListResponseBody(Builder builder) {
    ...
    public static DescribeCdcVersionListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeCdcVersionListResponseBody model) {
        ...
        public DescribeCdcVersionListResponseBody build() {
            return new DescribeCdcVersionListResponseBody(this);
        } 
