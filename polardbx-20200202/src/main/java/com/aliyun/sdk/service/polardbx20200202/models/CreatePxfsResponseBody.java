...
/**
 * 
 * {@link CreatePxfsResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePxfsResponseBody</p>
 */
public class CreatePxfsResponseBody extends TeaModel {
    ...
    private CreatePxfsResponseBody(Builder builder) {
    ...
    public static CreatePxfsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreatePxfsResponseBody model) {
        ...
        public CreatePxfsResponseBody build() {
            return new CreatePxfsResponseBody(this);
        } 
