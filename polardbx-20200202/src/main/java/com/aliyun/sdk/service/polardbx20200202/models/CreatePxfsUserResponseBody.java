...
/**
 * 
 * {@link CreatePxfsUserResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePxfsUserResponseBody</p>
 */
public class CreatePxfsUserResponseBody extends TeaModel {
    ...
    private CreatePxfsUserResponseBody(Builder builder) {
    ...
    public static CreatePxfsUserResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreatePxfsUserResponseBody model) {
        ...
        public CreatePxfsUserResponseBody build() {
            return new CreatePxfsUserResponseBody(this);
        } 
