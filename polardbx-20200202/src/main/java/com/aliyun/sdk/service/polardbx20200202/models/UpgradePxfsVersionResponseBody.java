...
/**
 * 
 * {@link UpgradePxfsVersionResponseBody} extends {@link TeaModel}
 *
 * <p>UpgradePxfsVersionResponseBody</p>
 */
public class UpgradePxfsVersionResponseBody extends TeaModel {
    ...
    private UpgradePxfsVersionResponseBody(Builder builder) {
    ...
    public static UpgradePxfsVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpgradePxfsVersionResponseBody model) {
        ...
        public UpgradePxfsVersionResponseBody build() {
            return new UpgradePxfsVersionResponseBody(this);
        } 
