...
/**
 * 
 * {@link CreateContext0ResponseBody} extends {@link TeaModel}
 *
 * <p>CreateContext0ResponseBody</p>
 */
public class CreateContext0ResponseBody extends TeaModel {
    ...
    private CreateContext0ResponseBody(Builder builder) {
    ...
    public static CreateContext0ResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateContext0ResponseBody model) {
        ...
        public CreateContext0ResponseBody build() {
            return new CreateContext0ResponseBody(this);
        } 
