...
/**
 * 
 * {@link DescribeContext0SecurityIpsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeContext0SecurityIpsResponseBody</p>
 */
public class DescribeContext0SecurityIpsResponseBody extends TeaModel {
    ...
    private DescribeContext0SecurityIpsResponseBody(Builder builder) {
    ...
    public static DescribeContext0SecurityIpsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeContext0SecurityIpsResponseBody model) {
        ...
        public DescribeContext0SecurityIpsResponseBody build() {
            return new DescribeContext0SecurityIpsResponseBody(this);
        } 
