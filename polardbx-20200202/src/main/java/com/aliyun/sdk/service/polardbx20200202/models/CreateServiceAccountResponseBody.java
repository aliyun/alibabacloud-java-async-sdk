...
/**
 * 
 * {@link CreateServiceAccountResponseBody} extends {@link TeaModel}
 *
 * <p>CreateServiceAccountResponseBody</p>
 */
public class CreateServiceAccountResponseBody extends TeaModel {
    ...
    private CreateServiceAccountResponseBody(Builder builder) {
    ...
    public static CreateServiceAccountResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateServiceAccountResponseBody model) {
        ...
        public CreateServiceAccountResponseBody build() {
            return new CreateServiceAccountResponseBody(this);
        } 
