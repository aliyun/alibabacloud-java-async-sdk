...
/**
 * 
 * {@link StartSwitchDatabaseResponseBody} extends {@link TeaModel}
 *
 * <p>StartSwitchDatabaseResponseBody</p>
 */
public class StartSwitchDatabaseResponseBody extends TeaModel {
    ...
    private StartSwitchDatabaseResponseBody(Builder builder) {
    ...
    public static StartSwitchDatabaseResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(StartSwitchDatabaseResponseBody model) {
        ...
        public StartSwitchDatabaseResponseBody build() {
            return new StartSwitchDatabaseResponseBody(this);
        } 
