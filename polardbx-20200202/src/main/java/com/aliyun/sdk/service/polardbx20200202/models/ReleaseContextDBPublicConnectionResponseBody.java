...
/**
 * 
 * {@link ReleaseContextDBPublicConnectionResponseBody} extends {@link TeaModel}
 *
 * <p>ReleaseContextDBPublicConnectionResponseBody</p>
 */
public class ReleaseContextDBPublicConnectionResponseBody extends TeaModel {
    ...
    private ReleaseContextDBPublicConnectionResponseBody(Builder builder) {
    ...
    public static ReleaseContextDBPublicConnectionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReleaseContextDBPublicConnectionResponseBody model) {
        ...
        public ReleaseContextDBPublicConnectionResponseBody build() {
            return new ReleaseContextDBPublicConnectionResponseBody(this);
        } 
