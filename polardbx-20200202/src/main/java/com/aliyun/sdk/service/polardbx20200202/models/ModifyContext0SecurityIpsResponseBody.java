...
/**
 * 
 * {@link ModifyContext0SecurityIpsResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyContext0SecurityIpsResponseBody</p>
 */
public class ModifyContext0SecurityIpsResponseBody extends TeaModel {
    ...
    private ModifyContext0SecurityIpsResponseBody(Builder builder) {
    ...
    public static ModifyContext0SecurityIpsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyContext0SecurityIpsResponseBody model) {
        ...
        public ModifyContext0SecurityIpsResponseBody build() {
            return new ModifyContext0SecurityIpsResponseBody(this);
        } 
