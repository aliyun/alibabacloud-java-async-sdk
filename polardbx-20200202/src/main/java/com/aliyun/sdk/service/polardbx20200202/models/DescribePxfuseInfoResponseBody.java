...
/**
 * 
 * {@link DescribePxfuseInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribePxfuseInfoResponseBody</p>
 */
public class DescribePxfuseInfoResponseBody extends TeaModel {
    ...
    private DescribePxfuseInfoResponseBody(Builder builder) {
    ...
    public static DescribePxfuseInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribePxfuseInfoResponseBody model) {
        ...
        public DescribePxfuseInfoResponseBody build() {
            return new DescribePxfuseInfoResponseBody(this);
        } 
