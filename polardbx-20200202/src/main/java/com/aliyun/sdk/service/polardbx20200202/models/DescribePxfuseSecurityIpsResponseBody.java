...
/**
 * 
 * {@link DescribePxfuseSecurityIpsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribePxfuseSecurityIpsResponseBody</p>
 */
public class DescribePxfuseSecurityIpsResponseBody extends TeaModel {
    ...
    private DescribePxfuseSecurityIpsResponseBody(Builder builder) {
    ...
    public static DescribePxfuseSecurityIpsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribePxfuseSecurityIpsResponseBody model) {
        ...
        public DescribePxfuseSecurityIpsResponseBody build() {
            return new DescribePxfuseSecurityIpsResponseBody(this);
        } 
