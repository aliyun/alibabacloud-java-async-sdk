...
/**
 * 
 * {@link DescribeDataImportTaskInfoRequest} extends {@link RequestModel}
 *
 * <p>DescribeDataImportTaskInfoRequest</p>
 */
public class DescribeDataImportTaskInfoRequest extends Request {
    ...
    private DescribeDataImportTaskInfoRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeDataImportTaskInfoRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeDataImportTaskInfoRequest, Builder> {
        private Integer failPageNumber; 
        private Integer failPageSize; 
        private String regionId; 
        private String slinkTaskId; 
        ...
        private Builder(DescribeDataImportTaskInfoRequest request) {
            super(request);
        ...
        @Override
        public DescribeDataImportTaskInfoRequest build() {
            return new DescribeDataImportTaskInfoRequest(this);
        } 
