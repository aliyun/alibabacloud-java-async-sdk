...
/**
 * 
 * {@link AllocateContextDBPublicConnectionResponseBody} extends {@link TeaModel}
 *
 * <p>AllocateContextDBPublicConnectionResponseBody</p>
 */
public class AllocateContextDBPublicConnectionResponseBody extends TeaModel {
    ...
    private AllocateContextDBPublicConnectionResponseBody(Builder builder) {
    ...
    public static AllocateContextDBPublicConnectionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AllocateContextDBPublicConnectionResponseBody model) {
        ...
        public AllocateContextDBPublicConnectionResponseBody build() {
            return new AllocateContextDBPublicConnectionResponseBody(this);
        } 
