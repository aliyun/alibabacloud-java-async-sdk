...
/**
 * 
 * {@link DescribeColumnarClassListResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeColumnarClassListResponseBody</p>
 */
public class DescribeColumnarClassListResponseBody extends TeaModel {
    ...
    private DescribeColumnarClassListResponseBody(Builder builder) {
    ...
    public static DescribeColumnarClassListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeColumnarClassListResponseBody model) {
        ...
        public DescribeColumnarClassListResponseBody build() {
            return new DescribeColumnarClassListResponseBody(this);
        } 
