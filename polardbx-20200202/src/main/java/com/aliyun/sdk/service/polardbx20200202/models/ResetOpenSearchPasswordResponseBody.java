...
/**
 * 
 * {@link ResetOpenSearchPasswordResponseBody} extends {@link TeaModel}
 *
 * <p>ResetOpenSearchPasswordResponseBody</p>
 */
public class ResetOpenSearchPasswordResponseBody extends TeaModel {
    ...
    private ResetOpenSearchPasswordResponseBody(Builder builder) {
    ...
    public static ResetOpenSearchPasswordResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ResetOpenSearchPasswordResponseBody model) {
        ...
        public ResetOpenSearchPasswordResponseBody build() {
            return new ResetOpenSearchPasswordResponseBody(this);
        } 
