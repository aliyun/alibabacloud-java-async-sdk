...
/**
 * 
 * {@link DescribeSupabaseIpWhitelistResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeSupabaseIpWhitelistResponseBody</p>
 */
public class DescribeSupabaseIpWhitelistResponseBody extends TeaModel {
    ...
    private DescribeSupabaseIpWhitelistResponseBody(Builder builder) {
    ...
    public static DescribeSupabaseIpWhitelistResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeSupabaseIpWhitelistResponseBody model) {
        ...
        public DescribeSupabaseIpWhitelistResponseBody build() {
            return new DescribeSupabaseIpWhitelistResponseBody(this);
        } 
