...
/**
 * 
 * {@link DescribeOpenSearchWhitelistsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeOpenSearchWhitelistsResponseBody</p>
 */
public class DescribeOpenSearchWhitelistsResponseBody extends TeaModel {
    ...
    private DescribeOpenSearchWhitelistsResponseBody(Builder builder) {
    ...
    public static DescribeOpenSearchWhitelistsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeOpenSearchWhitelistsResponseBody model) {
        ...
        public DescribeOpenSearchWhitelistsResponseBody build() {
            return new DescribeOpenSearchWhitelistsResponseBody(this);
        } 
