...
public class GetOpenStatusResponseBody extends TeaModel {
    ...
    private GetOpenStatusResponseBody(Builder builder) {
    ...
    public static GetOpenStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetOpenStatusResponseBody build() {
            return new GetOpenStatusResponseBody(this);
        } 
