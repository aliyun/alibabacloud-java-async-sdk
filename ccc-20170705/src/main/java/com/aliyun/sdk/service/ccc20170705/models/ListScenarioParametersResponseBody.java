...
/**
 * {@link ListScenarioParametersResponseBody} extends {@link TeaModel}
 *
 * <p>ListScenarioParametersResponseBody</p>
 */
public class ListScenarioParametersResponseBody extends TeaModel {
    @NameInMap("Code")
    private String code;
    ...
    private ListScenarioParametersResponseBody(Builder builder) {
    ...
    public static ListScenarioParametersResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListScenarioParametersResponseBody build() {
            return new ListScenarioParametersResponseBody(this);
        } 
