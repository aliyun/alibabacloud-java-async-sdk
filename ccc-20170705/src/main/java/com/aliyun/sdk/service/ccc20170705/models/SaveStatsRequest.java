...
/**
 * {@link SaveStatsRequest} extends {@link RequestModel}
 *
 * <p>SaveStatsRequest</p>
 */
public class SaveStatsRequest extends Request {
    @Query
    @NameInMap("CallId")
    ...
    private SaveStatsRequest(Builder builder) {
        super(builder);
    ...
    public static SaveStatsRequest create() {
    ...
    public static final class Builder extends Request.Builder<SaveStatsRequest, Builder> {
        private String callId; 
        private Long callStartTime; 
        private String calleeNumber; 
        private String callerNumber; 
        ...
        private Builder(SaveStatsRequest response) {
            super(response);
        ...
        @Override
        public SaveStatsRequest build() {
            return new SaveStatsRequest(this);
        } 
