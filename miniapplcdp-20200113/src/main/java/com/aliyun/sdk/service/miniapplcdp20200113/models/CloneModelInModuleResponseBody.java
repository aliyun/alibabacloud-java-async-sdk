...
/**
 * {@link CloneModelInModuleResponseBody} extends {@link TeaModel}
 *
 * <p>CloneModelInModuleResponseBody</p>
 */
public class CloneModelInModuleResponseBody extends TeaModel {
    ...
    private CloneModelInModuleResponseBody(Builder builder) {
    ...
    public static CloneModelInModuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CloneModelInModuleResponseBody build() {
            return new CloneModelInModuleResponseBody(this);
        } 
