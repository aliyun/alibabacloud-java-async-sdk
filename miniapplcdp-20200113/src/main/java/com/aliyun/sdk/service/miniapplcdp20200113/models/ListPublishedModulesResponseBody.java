...
/**
 * {@link ListPublishedModulesResponseBody} extends {@link TeaModel}
 *
 * <p>ListPublishedModulesResponseBody</p>
 */
public class ListPublishedModulesResponseBody extends TeaModel {
    ...
    private ListPublishedModulesResponseBody(Builder builder) {
    ...
    public static ListPublishedModulesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListPublishedModulesResponseBody build() {
            return new ListPublishedModulesResponseBody(this);
        } 
