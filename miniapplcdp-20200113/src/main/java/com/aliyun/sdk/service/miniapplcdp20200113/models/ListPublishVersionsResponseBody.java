...
/**
 * {@link ListPublishVersionsResponseBody} extends {@link TeaModel}
 *
 * <p>ListPublishVersionsResponseBody</p>
 */
public class ListPublishVersionsResponseBody extends TeaModel {
    ...
    private ListPublishVersionsResponseBody(Builder builder) {
    ...
    public static ListPublishVersionsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListPublishVersionsResponseBody build() {
            return new ListPublishVersionsResponseBody(this);
        } 
