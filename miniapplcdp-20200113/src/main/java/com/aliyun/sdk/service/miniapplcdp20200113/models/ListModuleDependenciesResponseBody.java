...
/**
 * {@link ListModuleDependenciesResponseBody} extends {@link TeaModel}
 *
 * <p>ListModuleDependenciesResponseBody</p>
 */
public class ListModuleDependenciesResponseBody extends TeaModel {
    ...
    private ListModuleDependenciesResponseBody(Builder builder) {
    ...
    public static ListModuleDependenciesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListModuleDependenciesResponseBody build() {
            return new ListModuleDependenciesResponseBody(this);
        } 
