...
/**
 * {@link GetZipcodeRequest} extends {@link RequestModel}
 *
 * <p>GetZipcodeRequest</p>
 */
public class GetZipcodeRequest extends Request {
    @Body
    @NameInMap("AppKey")
    ...
    private GetZipcodeRequest(Builder builder) {
        super(builder);
    ...
    public static GetZipcodeRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetZipcodeRequest, Builder> {
        private String appKey; 
        private String defaultCity; 
        private String defaultDistrict; 
        private String defaultProvince; 
        ...
        private Builder(GetZipcodeRequest request) {
            super(request);
        ...
        @Override
        public GetZipcodeRequest build() {
            return new GetZipcodeRequest(this);
        } 
