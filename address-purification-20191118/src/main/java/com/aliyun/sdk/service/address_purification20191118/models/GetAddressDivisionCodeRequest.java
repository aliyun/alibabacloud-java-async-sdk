...
/**
 * {@link GetAddressDivisionCodeRequest} extends {@link RequestModel}
 *
 * <p>GetAddressDivisionCodeRequest</p>
 */
public class GetAddressDivisionCodeRequest extends Request {
    @Body
    @NameInMap("AppKey")
    ...
    private GetAddressDivisionCodeRequest(Builder builder) {
        super(builder);
    ...
    public static GetAddressDivisionCodeRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetAddressDivisionCodeRequest, Builder> {
        private String appKey; 
        private String defaultCity; 
        private String defaultDistrict; 
        private String defaultProvince; 
        ...
        private Builder(GetAddressDivisionCodeRequest request) {
            super(request);
        ...
        @Override
        public GetAddressDivisionCodeRequest build() {
            return new GetAddressDivisionCodeRequest(this);
        } 
