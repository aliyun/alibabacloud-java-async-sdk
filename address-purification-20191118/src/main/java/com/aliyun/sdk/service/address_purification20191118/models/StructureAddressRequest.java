...
/**
 * {@link StructureAddressRequest} extends {@link RequestModel}
 *
 * <p>StructureAddressRequest</p>
 */
public class StructureAddressRequest extends Request {
    @Body
    @NameInMap("AppKey")
    ...
    private StructureAddressRequest(Builder builder) {
        super(builder);
    ...
    public static StructureAddressRequest create() {
    ...
    public static final class Builder extends Request.Builder<StructureAddressRequest, Builder> {
        private String appKey; 
        private String defaultCity; 
        private String defaultDistrict; 
        private String defaultProvince; 
        ...
        private Builder(StructureAddressRequest request) {
            super(request);
        ...
        @Override
        public StructureAddressRequest build() {
            return new StructureAddressRequest(this);
        } 
