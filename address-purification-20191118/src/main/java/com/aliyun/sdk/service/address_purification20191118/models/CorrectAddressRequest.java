...
/**
 * {@link CorrectAddressRequest} extends {@link RequestModel}
 *
 * <p>CorrectAddressRequest</p>
 */
public class CorrectAddressRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<CorrectAddressRequest, Builder> {
        ...
        private Builder(CorrectAddressRequest request) {
            super(request);
        ...
        @Override
        public CorrectAddressRequest build() {
