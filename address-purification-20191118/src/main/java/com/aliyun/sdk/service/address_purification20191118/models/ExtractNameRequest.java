...
/**
 * {@link ExtractNameRequest} extends {@link RequestModel}
 *
 * <p>ExtractNameRequest</p>
 */
public class ExtractNameRequest extends Request {
    @Body
    @NameInMap("AppKey")
    ...
    private ExtractNameRequest(Builder builder) {
        super(builder);
    ...
    public static ExtractNameRequest create() {
    ...
    public static final class Builder extends Request.Builder<ExtractNameRequest, Builder> {
        private String appKey; 
        private String defaultCity; 
        private String defaultDistrict; 
        private String defaultProvince; 
        ...
        private Builder(ExtractNameRequest request) {
            super(request);
        ...
        @Override
        public ExtractNameRequest build() {
            return new ExtractNameRequest(this);
        } 
