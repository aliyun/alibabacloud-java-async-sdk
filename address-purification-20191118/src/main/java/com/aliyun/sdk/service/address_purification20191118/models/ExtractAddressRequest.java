...
/**
 * {@link ExtractAddressRequest} extends {@link RequestModel}
 *
 * <p>ExtractAddressRequest</p>
 */
public class ExtractAddressRequest extends Request {
    @Body
    @NameInMap("AppKey")
    ...
    private ExtractAddressRequest(Builder builder) {
        super(builder);
    ...
    public static ExtractAddressRequest create() {
    ...
    public static final class Builder extends Request.Builder<ExtractAddressRequest, Builder> {
        private String appKey; 
        private String defaultCity; 
        private String defaultDistrict; 
        private String defaultProvince; 
        ...
        private Builder(ExtractAddressRequest request) {
            super(request);
        ...
        @Override
        public ExtractAddressRequest build() {
            return new ExtractAddressRequest(this);
        } 
