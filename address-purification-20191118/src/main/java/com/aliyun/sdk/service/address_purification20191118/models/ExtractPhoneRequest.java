...
/**
 * {@link ExtractPhoneRequest} extends {@link RequestModel}
 *
 * <p>ExtractPhoneRequest</p>
 */
public class ExtractPhoneRequest extends Request {
    @Body
    @NameInMap("AppKey")
    ...
    private ExtractPhoneRequest(Builder builder) {
        super(builder);
    ...
    public static ExtractPhoneRequest create() {
    ...
    public static final class Builder extends Request.Builder<ExtractPhoneRequest, Builder> {
        private String appKey; 
        private String defaultCity; 
        private String defaultDistrict; 
        private String defaultProvince; 
        ...
        private Builder(ExtractPhoneRequest request) {
            super(request);
        ...
        @Override
        public ExtractPhoneRequest build() {
            return new ExtractPhoneRequest(this);
        } 
