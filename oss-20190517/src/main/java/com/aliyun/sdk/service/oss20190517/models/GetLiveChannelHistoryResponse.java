...
public class GetLiveChannelHistoryResponse extends Response {
    ...
    private GetLiveChannelHistoryResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<GetLiveChannelHistoryResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(GetLiveChannelHistoryResponseBody body);

        @Override
        GetLiveChannelHistoryResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<GetLiveChannelHistoryResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private GetLiveChannelHistoryResponseBody body; 
        ...
        private BuilderImpl(GetLiveChannelHistoryResponse response) {
            super(response);
