...
public class ListLiveChannelResponse extends Response {
    ...
    private ListLiveChannelResponse(BuilderImpl builder) {
        super(builder);
    ...
    public interface Builder extends Response.Builder<ListLiveChannelResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(ListLiveChannelResponseBody body);

        @Override
        ListLiveChannelResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<ListLiveChannelResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private ListLiveChannelResponseBody body; 
        ...
        private BuilderImpl(ListLiveChannelResponse response) {
            super(response);
