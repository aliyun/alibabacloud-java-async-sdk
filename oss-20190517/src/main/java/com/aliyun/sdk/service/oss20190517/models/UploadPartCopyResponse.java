...
public class UploadPartCopyResponse extends Response {
    ...
    public interface Builder extends Response.Builder<UploadPartCopyResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        Builder body(UploadPartCopyResponseBody body);

        @Override
        UploadPartCopyResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<UploadPartCopyResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private UploadPartCopyResponseBody body; 
        ...
        private BuilderImpl(UploadPartCopyResponse response) {
            super(response);
