...
public class DeleteObjectTaggingResponse extends Response {
    ...
    public interface Builder extends Response.Builder<DeleteObjectTaggingResponse, Builder> {

        Builder headers(java.util.Map < String, String > headers);

        @Override
        DeleteObjectTaggingResponse build();

    } 

    private static final class BuilderImpl
            extends Response.BuilderImpl<DeleteObjectTaggingResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        ...
        private BuilderImpl(DeleteObjectTaggingResponse response) {
            super(response);
