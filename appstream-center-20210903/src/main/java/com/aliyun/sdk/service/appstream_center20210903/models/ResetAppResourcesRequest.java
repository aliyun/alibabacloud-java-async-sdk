...
/**
 * 
 * {@link ResetAppResourcesRequest} extends {@link RequestModel}
 *
 * <p>ResetAppResourcesRequest</p>
 */
public class ResetAppResourcesRequest extends Request {
    ...
    private ResetAppResourcesRequest(Builder builder) {
        super(builder);
    ...
    public static ResetAppResourcesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ResetAppResourcesRequest, Builder> {
        private String appInstanceGroupId; 
        private String bizRegionId; 
        private String clientId; 
        private String clientIp; 
        ...
        private Builder(ResetAppResourcesRequest request) {
            super(request);
        ...
        @Override
        public ResetAppResourcesRequest build() {
            return new ResetAppResourcesRequest(this);
        } 
