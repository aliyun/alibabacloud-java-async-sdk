...
/**
 * 
 * {@link StopAppResourcesRequest} extends {@link RequestModel}
 *
 * <p>StopAppResourcesRequest</p>
 */
public class StopAppResourcesRequest extends Request {
    ...
    private StopAppResourcesRequest(Builder builder) {
        super(builder);
    ...
    public static StopAppResourcesRequest create() {
    ...
    public static final class Builder extends Request.Builder<StopAppResourcesRequest, Builder> {
        private String appInstanceGroupId; 
        private String bizRegionId; 
        private String clientId; 
        private String clientIp; 
        ...
        private Builder(StopAppResourcesRequest request) {
            super(request);
        ...
        @Override
        public StopAppResourcesRequest build() {
            return new StopAppResourcesRequest(this);
        } 
