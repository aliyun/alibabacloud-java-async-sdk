...
/**
 * 
 * {@link UpdateSecurityEventStatusRequest} extends {@link RequestModel}
 *
 * <p>UpdateSecurityEventStatusRequest</p>
 */
public class UpdateSecurityEventStatusRequest extends Request {
    ...
    private UpdateSecurityEventStatusRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateSecurityEventStatusRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateSecurityEventStatusRequest, Builder> {
        private String aliUid; 
        private String eventId; 
        private String status; 
        private Long callerParentId; 
        ...
        private Builder(UpdateSecurityEventStatusRequest request) {
            super(request);
        ...
        @Override
        public UpdateSecurityEventStatusRequest build() {
            return new UpdateSecurityEventStatusRequest(this);
        } 
