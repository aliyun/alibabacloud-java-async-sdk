...
/**
 * 
 * {@link ModelRouterCreateBillingRuleResponseBody} extends {@link TeaModel}
 *
 * <p>ModelRouterCreateBillingRuleResponseBody</p>
 */
public class ModelRouterCreateBillingRuleResponseBody extends TeaModel {
    ...
    private ModelRouterCreateBillingRuleResponseBody(Builder builder) {
    ...
    public static ModelRouterCreateBillingRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModelRouterCreateBillingRuleResponseBody model) {
        ...
        public ModelRouterCreateBillingRuleResponseBody build() {
            return new ModelRouterCreateBillingRuleResponseBody(this);
        } 
