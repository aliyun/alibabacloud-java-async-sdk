...
/**
 * 
 * {@link QueryProjectResponseBody} extends {@link TeaModel}
 *
 * <p>QueryProjectResponseBody</p>
 */
public class QueryProjectResponseBody extends TeaModel {
    ...
    private QueryProjectResponseBody(Builder builder) {
    ...
    public static QueryProjectResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryProjectResponseBody model) {
        ...
        public QueryProjectResponseBody build() {
            return new QueryProjectResponseBody(this);
        } 
