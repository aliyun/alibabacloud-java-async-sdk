...
/**
 * 
 * {@link ModelRouterUpdateBillingRuleResponseBody} extends {@link TeaModel}
 *
 * <p>ModelRouterUpdateBillingRuleResponseBody</p>
 */
public class ModelRouterUpdateBillingRuleResponseBody extends TeaModel {
    ...
    private ModelRouterUpdateBillingRuleResponseBody(Builder builder) {
    ...
    public static ModelRouterUpdateBillingRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModelRouterUpdateBillingRuleResponseBody model) {
        ...
        public ModelRouterUpdateBillingRuleResponseBody build() {
            return new ModelRouterUpdateBillingRuleResponseBody(this);
        } 
