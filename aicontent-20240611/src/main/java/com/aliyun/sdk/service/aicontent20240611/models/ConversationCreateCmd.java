...
/**
 * 
 * {@link ConversationCreateCmd} extends {@link TeaModel}
 *
 * <p>ConversationCreateCmd</p>
 */
public class ConversationCreateCmd extends TeaModel {
    ...
    private ConversationCreateCmd(Builder builder) {
    ...
    public static ConversationCreateCmd create() {
    ...
    public static final class Builder {
        ...
        private Builder(ConversationCreateCmd model) {
        ...
        public ConversationCreateCmd build() {
            return new ConversationCreateCmd(this);
        } 
