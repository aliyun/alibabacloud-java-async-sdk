...
public class Personalizedtxt2imgQueryModelTrainJobListResponseBody extends TeaModel {
    ...
    private Personalizedtxt2imgQueryModelTrainJobListResponseBody(Builder builder) {
    ...
    public static Personalizedtxt2imgQueryModelTrainJobListResponseBody create() {
    ...
    public static final class Builder {
        ...
        public Personalizedtxt2imgQueryModelTrainJobListResponseBody build() {
            return new Personalizedtxt2imgQueryModelTrainJobListResponseBody(this);
        } 
