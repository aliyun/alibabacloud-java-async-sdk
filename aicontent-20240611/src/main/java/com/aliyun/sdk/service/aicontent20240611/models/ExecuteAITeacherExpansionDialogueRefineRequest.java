...
/**
 * 
 * {@link ExecuteAITeacherExpansionDialogueRefineRequest} extends {@link RequestModel}
 *
 * <p>ExecuteAITeacherExpansionDialogueRefineRequest</p>
 */
public class ExecuteAITeacherExpansionDialogueRefineRequest extends Request {
    ...
    private ExecuteAITeacherExpansionDialogueRefineRequest(Builder builder) {
        super(builder);
    ...
    public static ExecuteAITeacherExpansionDialogueRefineRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ExecuteAITeacherExpansionDialogueRefineRequest, Builder> {
        private String background; 
        private java.util.List<DialogueTasks> dialogueTasks; 
        private String languageCode; 
        private java.util.List<Records> records; 
        ...
        private Builder(ExecuteAITeacherExpansionDialogueRefineRequest request) {
            super(request);
        ...
        @Override
        public ExecuteAITeacherExpansionDialogueRefineRequest build() {
            return new ExecuteAITeacherExpansionDialogueRefineRequest(this);
        } 
    ...
    /**
     * 
     * {@link ExecuteAITeacherExpansionDialogueRefineRequest} extends {@link TeaModel}
     *
     * <p>ExecuteAITeacherExpansionDialogueRefineRequest</p>
     */
