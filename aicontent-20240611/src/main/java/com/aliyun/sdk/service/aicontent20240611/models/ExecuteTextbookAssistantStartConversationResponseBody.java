...
/**
 * 
 * {@link ExecuteTextbookAssistantStartConversationResponseBody} extends {@link TeaModel}
 *
 * <p>ExecuteTextbookAssistantStartConversationResponseBody</p>
 */
public class ExecuteTextbookAssistantStartConversationResponseBody extends TeaModel {
    ...
    private ExecuteTextbookAssistantStartConversationResponseBody(Builder builder) {
    ...
    public static ExecuteTextbookAssistantStartConversationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ExecuteTextbookAssistantStartConversationResponseBody model) {
        ...
        public ExecuteTextbookAssistantStartConversationResponseBody build() {
            return new ExecuteTextbookAssistantStartConversationResponseBody(this);
        } 
