...
/**
 * 
 * {@link ApiKeyDecryptedDTO} extends {@link TeaModel}
 *
 * <p>ApiKeyDecryptedDTO</p>
 */
public class ApiKeyDecryptedDTO extends TeaModel {
    ...
    private ApiKeyDecryptedDTO(Builder builder) {
    ...
    public static ApiKeyDecryptedDTO create() {
    ...
    public static final class Builder {
        ...
        private Builder(ApiKeyDecryptedDTO model) {
        ...
        public ApiKeyDecryptedDTO build() {
            return new ApiKeyDecryptedDTO(this);
        } 
