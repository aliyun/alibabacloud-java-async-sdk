...
/**
 * 
 * {@link ModelCreateCmd} extends {@link TeaModel}
 *
 * <p>ModelCreateCmd</p>
 */
public class ModelCreateCmd extends TeaModel {
    ...
    private ModelCreateCmd(Builder builder) {
    ...
    public static ModelCreateCmd create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModelCreateCmd model) {
        ...
        public ModelCreateCmd build() {
            return new ModelCreateCmd(this);
        } 
