...
/**
 * 
 * {@link AITeacherSyncPracticeTaskGenerateRequest} extends {@link RequestModel}
 *
 * <p>AITeacherSyncPracticeTaskGenerateRequest</p>
 */
public class AITeacherSyncPracticeTaskGenerateRequest extends Request {
    ...
    private AITeacherSyncPracticeTaskGenerateRequest(Builder builder) {
        super(builder);
    ...
    public static AITeacherSyncPracticeTaskGenerateRequest create() {
    ...
    public static final class Builder extends Request.Builder<AITeacherSyncPracticeTaskGenerateRequest, Builder> {
        private String grade; 
        private java.util.List<String> keySentences; 
        private java.util.List<String> keyWords; 
        private String learningObject; 
        ...
        private Builder(AITeacherSyncPracticeTaskGenerateRequest request) {
            super(request);
        ...
        @Override
        public AITeacherSyncPracticeTaskGenerateRequest build() {
            return new AITeacherSyncPracticeTaskGenerateRequest(this);
        } 
