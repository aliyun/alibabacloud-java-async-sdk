...
/**
 * 
 * {@link ExecuteAITeacherSyncDialogueRequest} extends {@link RequestModel}
 *
 * <p>ExecuteAITeacherSyncDialogueRequest</p>
 */
public class ExecuteAITeacherSyncDialogueRequest extends Request {
    ...
    private ExecuteAITeacherSyncDialogueRequest(Builder builder) {
        super(builder);
    ...
    public static ExecuteAITeacherSyncDialogueRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ExecuteAITeacherSyncDialogueRequest, Builder> {
        private java.util.List<DialogueTasks> dialogueTasks; 
        private String languageCode; 
        private java.util.List<Records> records; 
        private String userId; 
        ...
        private Builder(ExecuteAITeacherSyncDialogueRequest request) {
            super(request);
        ...
        @Override
        public ExecuteAITeacherSyncDialogueRequest build() {
            return new ExecuteAITeacherSyncDialogueRequest(this);
        } 
    ...
    /**
     * 
     * {@link ExecuteAITeacherSyncDialogueRequest} extends {@link TeaModel}
     *
     * <p>ExecuteAITeacherSyncDialogueRequest</p>
     */
