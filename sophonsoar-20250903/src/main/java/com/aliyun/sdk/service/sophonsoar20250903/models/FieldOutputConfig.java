...
/**
 * 
 * {@link FieldOutputConfig} extends {@link TeaModel}
 *
 * <p>FieldOutputConfig</p>
 */
public class FieldOutputConfig extends TeaModel {
    ...
    private FieldOutputConfig(Builder builder) {
    ...
    public static FieldOutputConfig create() {
    ...
    public static final class Builder {
        ...
        private Builder(FieldOutputConfig model) {
        ...
        public FieldOutputConfig build() {
            return new FieldOutputConfig(this);
        } 
