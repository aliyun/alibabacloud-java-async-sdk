...
public class CreateSubscribeRelationRequest extends Request {
    ...
    public static CreateSubscribeRelationRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateSubscribeRelationRequest, Builder> {
        ...
        private Builder(CreateSubscribeRelationRequest response) {
            super(response);
        ...
        @Override
        public CreateSubscribeRelationRequest build() {
            return new CreateSubscribeRelationRequest(this);
        } 
