...
/**
 * 
 * {@link UpdateEdgeDriverVersionResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateEdgeDriverVersionResponseBody</p>
 */
public class UpdateEdgeDriverVersionResponseBody extends TeaModel {
    ...
    private UpdateEdgeDriverVersionResponseBody(Builder builder) {
    ...
    public static UpdateEdgeDriverVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateEdgeDriverVersionResponseBody model) {
        ...
        public UpdateEdgeDriverVersionResponseBody build() {
            return new UpdateEdgeDriverVersionResponseBody(this);
        } 
