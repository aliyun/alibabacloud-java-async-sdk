...
/**
 * 
 * {@link UnbindDriverFromEdgeInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>UnbindDriverFromEdgeInstanceResponseBody</p>
 */
public class UnbindDriverFromEdgeInstanceResponseBody extends TeaModel {
    ...
    private UnbindDriverFromEdgeInstanceResponseBody(Builder builder) {
    ...
    public static UnbindDriverFromEdgeInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UnbindDriverFromEdgeInstanceResponseBody model) {
        ...
        public UnbindDriverFromEdgeInstanceResponseBody build() {
            return new UnbindDriverFromEdgeInstanceResponseBody(this);
        } 
