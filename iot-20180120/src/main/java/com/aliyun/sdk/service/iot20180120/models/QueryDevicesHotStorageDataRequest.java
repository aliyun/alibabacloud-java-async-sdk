...
public class QueryDevicesHotStorageDataRequest extends Request {
    ...
    public static QueryDevicesHotStorageDataRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryDevicesHotStorageDataRequest, Builder> {
        private Integer asc; 
        private String deviceName; 
        private Long endTime; 
        private String identifier; 
        ...
        private Builder(QueryDevicesHotStorageDataRequest request) {
            super(request);
        ...
        @Override
        public QueryDevicesHotStorageDataRequest build() {
            return new QueryDevicesHotStorageDataRequest(this);
        } 
