...
/**
 * 
 * {@link CloseEdgeInstanceDeploymentResponseBody} extends {@link TeaModel}
 *
 * <p>CloseEdgeInstanceDeploymentResponseBody</p>
 */
public class CloseEdgeInstanceDeploymentResponseBody extends TeaModel {
    ...
    private CloseEdgeInstanceDeploymentResponseBody(Builder builder) {
    ...
    public static CloseEdgeInstanceDeploymentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CloseEdgeInstanceDeploymentResponseBody model) {
        ...
        public CloseEdgeInstanceDeploymentResponseBody build() {
            return new CloseEdgeInstanceDeploymentResponseBody(this);
        } 
