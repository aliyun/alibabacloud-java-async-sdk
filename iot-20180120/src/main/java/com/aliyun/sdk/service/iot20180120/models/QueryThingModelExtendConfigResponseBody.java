...
/**
 * 
 * {@link QueryThingModelExtendConfigResponseBody} extends {@link TeaModel}
 *
 * <p>QueryThingModelExtendConfigResponseBody</p>
 */
public class QueryThingModelExtendConfigResponseBody extends TeaModel {
    ...
    private QueryThingModelExtendConfigResponseBody(Builder builder) {
    ...
    public static QueryThingModelExtendConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryThingModelExtendConfigResponseBody model) {
        ...
        public QueryThingModelExtendConfigResponseBody build() {
            return new QueryThingModelExtendConfigResponseBody(this);
        } 
