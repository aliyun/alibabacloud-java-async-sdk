...
/**
 * 
 * {@link BindDriverToEdgeInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>BindDriverToEdgeInstanceResponseBody</p>
 */
public class BindDriverToEdgeInstanceResponseBody extends TeaModel {
    ...
    private BindDriverToEdgeInstanceResponseBody(Builder builder) {
    ...
    public static BindDriverToEdgeInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BindDriverToEdgeInstanceResponseBody model) {
        ...
        public BindDriverToEdgeInstanceResponseBody build() {
            return new BindDriverToEdgeInstanceResponseBody(this);
        } 
