...
/**
 * 
 * {@link DeleteTopicRouteTableResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteTopicRouteTableResponseBody</p>
 */
public class DeleteTopicRouteTableResponseBody extends TeaModel {
    ...
    private DeleteTopicRouteTableResponseBody(Builder builder) {
    ...
    public static DeleteTopicRouteTableResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteTopicRouteTableResponseBody model) {
        ...
        public DeleteTopicRouteTableResponseBody build() {
            return new DeleteTopicRouteTableResponseBody(this);
        } 
