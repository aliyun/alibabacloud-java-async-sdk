...
/**
 * {@link BatchGetEdgeInstanceChannelRequest} extends {@link RequestModel}
 *
 * <p>BatchGetEdgeInstanceChannelRequest</p>
 */
public class BatchGetEdgeInstanceChannelRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<BatchGetEdgeInstanceChannelRequest, Builder> {
        ...
        private Builder(BatchGetEdgeInstanceChannelRequest response) {
            super(response);
        ...
        @Override
        public BatchGetEdgeInstanceChannelRequest build() {
