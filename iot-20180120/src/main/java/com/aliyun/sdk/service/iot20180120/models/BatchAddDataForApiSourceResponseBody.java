...
public class BatchAddDataForApiSourceResponseBody extends TeaModel {
    ...
    public static BatchAddDataForApiSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        public BatchAddDataForApiSourceResponseBody build() {
            return new BatchAddDataForApiSourceResponseBody(this);
        } 
