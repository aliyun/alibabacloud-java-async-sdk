...
/**
 * {@link QuerySchedulePeriodListResponseBody} extends {@link TeaModel}
 *
 * <p>QuerySchedulePeriodListResponseBody</p>
 */
public class QuerySchedulePeriodListResponseBody extends TeaModel {
    ...
    private QuerySchedulePeriodListResponseBody(Builder builder) {
    ...
    public static QuerySchedulePeriodListResponseBody create() {
    ...
    public static final class Builder {
        ...
        public QuerySchedulePeriodListResponseBody build() {
            return new QuerySchedulePeriodListResponseBody(this);
        } 
