...
/**
 * 
 * {@link BindGatewayToEdgeInstanceResponseBody} extends {@link TeaModel}
 *
 * <p>BindGatewayToEdgeInstanceResponseBody</p>
 */
public class BindGatewayToEdgeInstanceResponseBody extends TeaModel {
    ...
    private BindGatewayToEdgeInstanceResponseBody(Builder builder) {
    ...
    public static BindGatewayToEdgeInstanceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BindGatewayToEdgeInstanceResponseBody model) {
        ...
        public BindGatewayToEdgeInstanceResponseBody build() {
            return new BindGatewayToEdgeInstanceResponseBody(this);
        } 
