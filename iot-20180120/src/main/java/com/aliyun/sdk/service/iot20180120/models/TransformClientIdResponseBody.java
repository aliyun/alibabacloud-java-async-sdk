...
/**
 * 
 * {@link TransformClientIdResponseBody} extends {@link TeaModel}
 *
 * <p>TransformClientIdResponseBody</p>
 */
public class TransformClientIdResponseBody extends TeaModel {
    ...
    private TransformClientIdResponseBody(Builder builder) {
    ...
    public static TransformClientIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(TransformClientIdResponseBody model) {
        ...
        public TransformClientIdResponseBody build() {
            return new TransformClientIdResponseBody(this);
        } 
