...
/**
 * 
 * {@link ListArtifactBuildLogsResponseBody} extends {@link TeaModel}
 *
 * <p>ListArtifactBuildLogsResponseBody</p>
 */
public class ListArtifactBuildLogsResponseBody extends TeaModel {
    ...
    private ListArtifactBuildLogsResponseBody(Builder builder) {
    ...
    public static ListArtifactBuildLogsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListArtifactBuildLogsResponseBody model) {
        ...
        public ListArtifactBuildLogsResponseBody build() {
            return new ListArtifactBuildLogsResponseBody(this);
        } 
