...
/**
 * {@link AddGroupsResponse} extends {@link TeaModel}
 *
 * <p>AddGroupsResponse</p>
 */
public class AddGroupsResponse extends Response {
    ...
    private static final class BuilderImpl
            extends Response.BuilderImpl<AddGroupsResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private AddGroupsResponseBody body; 
        ...
        private BuilderImpl(AddGroupsResponse response) {
            super(response);
        ...
        @Override
        public AddGroupsResponse build() {
            return new AddGroupsResponse(this);
        } 
