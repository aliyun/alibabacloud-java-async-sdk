...
/**
 * {@link ImageSyncScanResponse} extends {@link TeaModel}
 *
 * <p>ImageSyncScanResponse</p>
 */
public class ImageSyncScanResponse extends Response {
    ...
    private static final class BuilderImpl
            extends Response.BuilderImpl<ImageSyncScanResponse, Builder>
            implements Builder {
        private java.util.Map < String, String > headers; 
        private Integer statusCode; 
        private ImageSyncScanResponseBody body; 
        ...
        private BuilderImpl(ImageSyncScanResponse response) {
            super(response);
        ...
        @Override
        public ImageSyncScanResponse build() {
            return new ImageSyncScanResponse(this);
        } 
