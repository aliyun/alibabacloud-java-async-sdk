...
public class VideoModerationResponseBody extends TeaModel {
    ...
    public static VideoModerationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(VideoModerationResponseBody model) {
        ...
        public VideoModerationResponseBody build() {
            return new VideoModerationResponseBody(this);
        } 
