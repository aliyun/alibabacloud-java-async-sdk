...
/**
 * 
 * {@link CreateLoadForecastByFileUrlJobResponseBody} extends {@link TeaModel}
 *
 * <p>CreateLoadForecastByFileUrlJobResponseBody</p>
 */
public class CreateLoadForecastByFileUrlJobResponseBody extends TeaModel {
    ...
    private CreateLoadForecastByFileUrlJobResponseBody(Builder builder) {
    ...
    public static CreateLoadForecastByFileUrlJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateLoadForecastByFileUrlJobResponseBody model) {
        ...
        public CreateLoadForecastByFileUrlJobResponseBody build() {
            return new CreateLoadForecastByFileUrlJobResponseBody(this);
        } 
