...
/**
 * 
 * {@link CreateLoadForecastJobResponseBody} extends {@link TeaModel}
 *
 * <p>CreateLoadForecastJobResponseBody</p>
 */
public class CreateLoadForecastJobResponseBody extends TeaModel {
    ...
    private CreateLoadForecastJobResponseBody(Builder builder) {
    ...
    public static CreateLoadForecastJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateLoadForecastJobResponseBody build() {
            return new CreateLoadForecastJobResponseBody(this);
        } 
