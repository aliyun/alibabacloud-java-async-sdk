...
/**
 * 
 * {@link GetAivppAlgoJobResponseBody} extends {@link TeaModel}
 *
 * <p>GetAivppAlgoJobResponseBody</p>
 */
public class GetAivppAlgoJobResponseBody extends TeaModel {
    ...
    private GetAivppAlgoJobResponseBody(Builder builder) {
    ...
    public static GetAivppAlgoJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetAivppAlgoJobResponseBody model) {
        ...
        public GetAivppAlgoJobResponseBody build() {
            return new GetAivppAlgoJobResponseBody(this);
        } 
