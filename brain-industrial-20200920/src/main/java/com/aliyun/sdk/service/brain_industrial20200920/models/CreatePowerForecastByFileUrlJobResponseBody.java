...
/**
 * 
 * {@link CreatePowerForecastByFileUrlJobResponseBody} extends {@link TeaModel}
 *
 * <p>CreatePowerForecastByFileUrlJobResponseBody</p>
 */
public class CreatePowerForecastByFileUrlJobResponseBody extends TeaModel {
    ...
    private CreatePowerForecastByFileUrlJobResponseBody(Builder builder) {
    ...
    public static CreatePowerForecastByFileUrlJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreatePowerForecastByFileUrlJobResponseBody model) {
        ...
        public CreatePowerForecastByFileUrlJobResponseBody build() {
            return new CreatePowerForecastByFileUrlJobResponseBody(this);
        } 
