...
/**
 * 
 * {@link CreateEssOptJobResponseBody} extends {@link TeaModel}
 *
 * <p>CreateEssOptJobResponseBody</p>
 */
public class CreateEssOptJobResponseBody extends TeaModel {
    ...
    private CreateEssOptJobResponseBody(Builder builder) {
    ...
    public static CreateEssOptJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateEssOptJobResponseBody model) {
        ...
        public CreateEssOptJobResponseBody build() {
            return new CreateEssOptJobResponseBody(this);
        } 
