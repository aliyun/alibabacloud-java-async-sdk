...
@Override
    ...
    public static final class Builder extends Request.Builder<RolloverDataStreamRequest, Builder> {
        ...
        /**
         * <p>A unique token used to ensure the idempotence of the request. This parameter value is generated by the client and must be unique across different requests. The value cannot exceed 64 ASCII characters in length.</p>
         * 
         * <strong>example:</strong>
