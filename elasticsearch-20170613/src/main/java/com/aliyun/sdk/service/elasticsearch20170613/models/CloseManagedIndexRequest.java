...
@Override
    ...
    public static final class Builder extends Request.Builder<CloseManagedIndexRequest, Builder> {
        ...
        /**
         * <p>The index name. For more information about how to obtain the parameter value, see <a href="https://help.aliyun.com/document_detail/213188.html">ListDataStreams</a>.</p>
         * <p>This parameter is required.</p>
         * 
         * <strong>example:</strong>
         * <p>test-index1</p>
        ...
        /**
         * <p>A unique token used to ensure idempotence. This parameter value is generated by the client and must be unique across different requests. The value cannot exceed 64 ASCII characters in length.</p>
         * 
         * <strong>example:</strong>
