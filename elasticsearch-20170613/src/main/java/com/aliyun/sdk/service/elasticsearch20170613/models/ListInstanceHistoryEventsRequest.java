...
public class ListInstanceHistoryEventsRequest extends Request {
    ...
    public static final class Builder extends Request.Builder<ListInstanceHistoryEventsRequest, Builder> {
        ...
        private Builder(ListInstanceHistoryEventsRequest response) {
            super(response);
            this.body = response.body;
            this.eventCreateEndTime = response.eventCreateEndTime;
            this.eventCreateStartTime = response.eventCreateStartTime;
            this.eventCycleStatus = response.eventCycleStatus;
            this.eventExecuteEndTime = response.eventExecuteEndTime;
            this.eventExecuteStartTime = response.eventExecuteStartTime;
            this.eventFinashEndTime = response.eventFinashEndTime;
            this.eventFinashStartTime = response.eventFinashStartTime;
            this.eventLevel = response.eventLevel;
