...
/**
 * 
 * {@link InvokeEsAgentRequest} extends {@link RequestModel}
 *
 * <p>InvokeEsAgentRequest</p>
 */
public class InvokeEsAgentRequest extends Request {
    @com.aliyun.core.annotation.Body
    @com.aliyun.core.annotation.NameInMap("body")
    private java.util.Map<String, ?> body;

    private InvokeEsAgentRequest(Builder builder) {
        super(builder);
    ...
    public static InvokeEsAgentRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<InvokeEsAgentRequest, Builder> {
        private java.util.Map<String, ?> body; 
        ...
        private Builder(InvokeEsAgentRequest request) {
            super(request);
        ...
        @Override
        public InvokeEsAgentRequest build() {
            return new InvokeEsAgentRequest(this);
        } 
