...
public final class DefaultAsyncClient implements AsyncClient {
     ...
     */
    @Override
    public CompletableFuture<GrayPublishResponse> grayPublish(GrayPublishRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("GrayPublish").setMethod(HttpMethod.POST).setPathRegex("/openapi/instances/{InstanceId}/actions/grayPublish").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(GrayPublishResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
     ...
     */
    @Override
    public CompletableFuture<InvokeEsAgentResponse> invokeEsAgent(InvokeEsAgentRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("InvokeEsAgent").setMethod(HttpMethod.POST).setPathRegex("/openapi/agent/acp").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(InvokeEsAgentResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<InvokeEsAgentResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
    ...
    @Override
    public <ReturnT> CompletableFuture<ReturnT> invokeEsAgentWithAsyncResponseHandler(InvokeEsAgentRequest request, AsyncResponseHandler<InvokeEsAgentResponse, ReturnT> responseHandler) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("InvokeEsAgent").setMethod(HttpMethod.POST).setPathRegex("/openapi/agent/acp").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withResponseHandler(responseHandler).withOutput(InvokeEsAgentResponse.create());
            return this.handler.execute(params)
                    .thenCompose((output) -> CompletableFuture.completedFuture(responseHandler.transform((InvokeEsAgentResponse)output)));
        } catch (Exception e) {
    ...
    @Override
    public ResponseIterable<InvokeEsAgentResponseBody> invokeEsAgentWithResponseIterable(InvokeEsAgentRequest request) {
        this.handler.validateRequestModel(request);
        TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.SSE).setAction("InvokeEsAgent").setMethod(HttpMethod.POST).setPathRegex("/openapi/agent/acp").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
        InvokeEsAgentResponseBodyIterator iterator = InvokeEsAgentResponseBodyIterator.create();
     ...
     */
    @Override
    public CompletableFuture<InvokeEsRequestResponse> invokeEsRequest(InvokeEsRequestRequest request) {
        try {
            this.handler.validateRequestModel(request);
            TeaRequest teaRequest = REQUEST.copy().setStyle(RequestStyle.RESTFUL).setAction("InvokeEsRequest").setMethod(HttpMethod.POST).setPathRegex("/openapi/instances/{instanceId}/es-request").setBodyType(BodyType.JSON).setBodyIsForm(false).setReqBodyType(BodyType.JSON).formModel(request);
            ClientExecutionParams params = new ClientExecutionParams().withInput(request).withRequest(teaRequest).withOutput(InvokeEsRequestResponse.create());
            return this.handler.execute(params);
        } catch (Exception e) {
            CompletableFuture<InvokeEsRequestResponse> future = new CompletableFuture<>();
            future.completeExceptionally(e);
            return future;
        }
    }
