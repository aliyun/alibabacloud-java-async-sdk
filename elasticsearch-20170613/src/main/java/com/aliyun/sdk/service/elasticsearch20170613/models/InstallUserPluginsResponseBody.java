...
public class InstallUserPluginsResponseBody extends TeaModel {
    ...
    private InstallUserPluginsResponseBody(Builder builder) {
    ...
    public static InstallUserPluginsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public InstallUserPluginsResponseBody build() {
            return new InstallUserPluginsResponseBody(this);
        } 
