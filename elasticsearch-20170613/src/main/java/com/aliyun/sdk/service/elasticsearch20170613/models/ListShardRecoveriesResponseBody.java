...
public class ListShardRecoveriesResponseBody extends TeaModel {
    ...
    public static final class Builder {
        ...
        private Builder(ListShardRecoveriesResponseBody model) {
    ...
    public static class Result extends TeaModel {
        ...
        public static final class Builder {
            ...
            private Builder(Result model) {
                this.bytesPercent = model.bytesPercent;
                this.bytesTotal = model.bytesTotal;
                this.filesPercent = model.filesPercent;
                this.filesTotal = model.filesTotal;
                this.index = model.index;
                this.sourceHost = model.sourceHost;
                this.sourceNode = model.sourceNode;
                this.stage = model.stage;
                this.targetHost = model.targetHost;
                this.targetNode = model.targetNode;
                this.translogOps = model.translogOps;
                this.translogOpsPercent = model.translogOpsPercent;
            } 
