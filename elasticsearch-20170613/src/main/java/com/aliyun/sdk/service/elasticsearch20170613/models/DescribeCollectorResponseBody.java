...
public class DescribeCollectorResponseBody extends TeaModel {
    ...
    public static DescribeCollectorResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeCollectorResponseBody model) {
        ...
        public DescribeCollectorResponseBody build() {
            return new DescribeCollectorResponseBody(this);
        } 
