...
/**
 * 
 * {@link GetSavingPlanShareAccountsRequest} extends {@link RequestModel}
 *
 * <p>GetSavingPlanShareAccountsRequest</p>
 */
public class GetSavingPlanShareAccountsRequest extends Request {
    ...
    private GetSavingPlanShareAccountsRequest(Builder builder) {
        super(builder);
    ...
    public static GetSavingPlanShareAccountsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetSavingPlanShareAccountsRequest, Builder> {
        private Integer currentPage; 
        private java.util.List<EcIdAccountIds> ecIdAccountIds; 
        private String nbid; 
        private Integer pageSize; 
        ...
        private Builder(GetSavingPlanShareAccountsRequest request) {
            super(request);
        ...
        @Override
        public GetSavingPlanShareAccountsRequest build() {
            return new GetSavingPlanShareAccountsRequest(this);
        } 
    ...
    /**
     * 
     * {@link GetSavingPlanShareAccountsRequest} extends {@link TeaModel}
     *
     * <p>GetSavingPlanShareAccountsRequest</p>
     */
