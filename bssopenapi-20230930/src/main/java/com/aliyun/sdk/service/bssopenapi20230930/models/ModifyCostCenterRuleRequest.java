...
/**
 * 
 * {@link ModifyCostCenterRuleRequest} extends {@link RequestModel}
 *
 * <p>ModifyCostCenterRuleRequest</p>
 */
public class ModifyCostCenterRuleRequest extends Request {
    ...
    private ModifyCostCenterRuleRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyCostCenterRuleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyCostCenterRuleRequest, Builder> {
        private Long costCenterId; 
        private FilterExpression filterExpression; 
        private String nbid; 
        private Long ownerAccountId; 
        ...
        private Builder(ModifyCostCenterRuleRequest request) {
            super(request);
        ...
        @Override
        public ModifyCostCenterRuleRequest build() {
            return new ModifyCostCenterRuleRequest(this);
        } 
    ...
    /**
     * 
     * {@link ModifyCostCenterRuleRequest} extends {@link TeaModel}
     *
     * <p>ModifyCostCenterRuleRequest</p>
     */
