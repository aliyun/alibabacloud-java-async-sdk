...
/**
 * 
 * {@link DeleteCostCenterRuleRequest} extends {@link RequestModel}
 *
 * <p>DeleteCostCenterRuleRequest</p>
 */
public class DeleteCostCenterRuleRequest extends Request {
    ...
    private DeleteCostCenterRuleRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteCostCenterRuleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteCostCenterRuleRequest, Builder> {
        private Long costCenterId; 
        private FilterExpression filterExpression; 
        private String nbid; 
        ...
        private Builder(DeleteCostCenterRuleRequest request) {
            super(request);
        ...
        @Override
        public DeleteCostCenterRuleRequest build() {
            return new DeleteCostCenterRuleRequest(this);
        } 
    ...
    /**
     * 
     * {@link DeleteCostCenterRuleRequest} extends {@link TeaModel}
     *
     * <p>DeleteCostCenterRuleRequest</p>
     */
