...
/**
 * 
 * {@link UpdateBudgetRequest} extends {@link RequestModel}
 *
 * <p>UpdateBudgetRequest</p>
 */
public class UpdateBudgetRequest extends Request {
    ...
    @com.aliyun.core.annotation.Body
    @com.aliyun.core.annotation.NameInMap("OriginalBudgetName")
    @com.aliyun.core.annotation.Validation(required = true)
    ...
    private UpdateBudgetRequest(Builder builder) {
        ...
        this.originalBudgetName = builder.originalBudgetName;
    ...
    public static UpdateBudgetRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateBudgetRequest, Builder> {
        private String budgetName; 
        private String budgetType; 
        private String comment; 
        private String cycleEndPeriod; 
        ...
        private Builder(UpdateBudgetRequest request) {
            super(request);
            ...
            this.originalBudgetName = request.originalBudgetName;
         ...
         */
        public Builder originalBudgetName(String originalBudgetName) {
            this.putBodyParameter("OriginalBudgetName", originalBudgetName);
    ...
    /**
     * 
     * {@link UpdateBudgetRequest} extends {@link TeaModel}
     *
     * <p>UpdateBudgetRequest</p>
     */
