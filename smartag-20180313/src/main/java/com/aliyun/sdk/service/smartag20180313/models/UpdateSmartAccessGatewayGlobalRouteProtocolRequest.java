...
/**
 * 
 * {@link UpdateSmartAccessGatewayGlobalRouteProtocolRequest} extends {@link RequestModel}
 *
 * <p>UpdateSmartAccessGatewayGlobalRouteProtocolRequest</p>
 */
public class UpdateSmartAccessGatewayGlobalRouteProtocolRequest extends Request {
    ...
    private UpdateSmartAccessGatewayGlobalRouteProtocolRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateSmartAccessGatewayGlobalRouteProtocolRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateSmartAccessGatewayGlobalRouteProtocolRequest, Builder> {
        private Boolean crossAccount; 
        private String regionId; 
        private String resourceUid; 
        private String routeProtocol; 
        ...
        private Builder(UpdateSmartAccessGatewayGlobalRouteProtocolRequest request) {
            super(request);
        ...
        @Override
        public UpdateSmartAccessGatewayGlobalRouteProtocolRequest build() {
            return new UpdateSmartAccessGatewayGlobalRouteProtocolRequest(this);
        } 
