...
/**
 * 
 * {@link DescribeSagGlobalRouteProtocolRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagGlobalRouteProtocolRequest</p>
 */
public class DescribeSagGlobalRouteProtocolRequest extends Request {
    ...
    private DescribeSagGlobalRouteProtocolRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagGlobalRouteProtocolRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagGlobalRouteProtocolRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagGlobalRouteProtocolRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagGlobalRouteProtocolRequest build() {
            return new DescribeSagGlobalRouteProtocolRequest(this);
        } 
