...
/**
 * 
 * {@link ModifySagExpressConnectInterfaceRequest} extends {@link RequestModel}
 *
 * <p>ModifySagExpressConnectInterfaceRequest</p>
 */
public class ModifySagExpressConnectInterfaceRequest extends Request {
    ...
    private ModifySagExpressConnectInterfaceRequest(Builder builder) {
        super(builder);
        this.ip = builder.ip;
    ...
    public static ModifySagExpressConnectInterfaceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifySagExpressConnectInterfaceRequest, Builder> {
        private String ip; 
        private String mask; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ModifySagExpressConnectInterfaceRequest request) {
            super(request);
            this.ip = request.ip;
        ...
        @Override
        public ModifySagExpressConnectInterfaceRequest build() {
            return new ModifySagExpressConnectInterfaceRequest(this);
        } 
