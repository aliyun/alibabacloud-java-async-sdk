...
/**
 * 
 * {@link DescribeFlowLogSagsRequest} extends {@link RequestModel}
 *
 * <p>DescribeFlowLogSagsRequest</p>
 */
public class DescribeFlowLogSagsRequest extends Request {
    ...
    private DescribeFlowLogSagsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeFlowLogSagsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeFlowLogSagsRequest, Builder> {
        private String flowLogId; 
        private String ownerAccount; 
        private Long ownerId; 
        private Integer pageNumber; 
        ...
        private Builder(DescribeFlowLogSagsRequest request) {
            super(request);
        ...
        @Override
        public DescribeFlowLogSagsRequest build() {
            return new DescribeFlowLogSagsRequest(this);
        } 
