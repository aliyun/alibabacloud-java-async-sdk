...
/**
 * 
 * {@link UpdateSmartAccessGatewayDnsRequest} extends {@link RequestModel}
 *
 * <p>UpdateSmartAccessGatewayDnsRequest</p>
 */
public class UpdateSmartAccessGatewayDnsRequest extends Request {
    ...
    private UpdateSmartAccessGatewayDnsRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateSmartAccessGatewayDnsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateSmartAccessGatewayDnsRequest, Builder> {
        private Boolean crossAccount; 
        private String masterDns; 
        private String regionId; 
        private String resourceUid; 
        ...
        public Builder masterDns(String masterDns) {
            this.putQueryParameter("MasterDns", masterDns);
        ...
        public Builder slaveDns(String slaveDns) {
            this.putQueryParameter("SlaveDns", slaveDns);
            this.slaveDns = slaveDns;
            return this;
        }

        @Override
        public UpdateSmartAccessGatewayDnsRequest build() {
            return new UpdateSmartAccessGatewayDnsRequest(this);
        } 
