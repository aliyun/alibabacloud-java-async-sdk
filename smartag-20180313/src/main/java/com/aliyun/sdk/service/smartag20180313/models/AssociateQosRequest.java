...
/**
 * 
 * {@link AssociateQosRequest} extends {@link RequestModel}
 *
 * <p>AssociateQosRequest</p>
 */
public class AssociateQosRequest extends Request {
    ...
    private AssociateQosRequest(Builder builder) {
        super(builder);
    ...
    public static AssociateQosRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssociateQosRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String qosId; 
        private String regionId; 
        ...
        private Builder(AssociateQosRequest request) {
            super(request);
        ...
        @Override
        public AssociateQosRequest build() {
            return new AssociateQosRequest(this);
        } 
