...
/**
 * 
 * {@link DescribeSmartAccessGatewayVersionsRequest} extends {@link RequestModel}
 *
 * <p>DescribeSmartAccessGatewayVersionsRequest</p>
 */
public class DescribeSmartAccessGatewayVersionsRequest extends Request {
    ...
    private DescribeSmartAccessGatewayVersionsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSmartAccessGatewayVersionsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSmartAccessGatewayVersionsRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSmartAccessGatewayVersionsRequest request) {
            super(request);
        ...
        @Override
        public DescribeSmartAccessGatewayVersionsRequest build() {
            return new DescribeSmartAccessGatewayVersionsRequest(this);
        } 
