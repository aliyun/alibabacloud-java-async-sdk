...
/**
 * 
 * {@link ViewSmartAccessGatewayBgpRouteRequest} extends {@link RequestModel}
 *
 * <p>ViewSmartAccessGatewayBgpRouteRequest</p>
 */
public class ViewSmartAccessGatewayBgpRouteRequest extends Request {
    ...
    private ViewSmartAccessGatewayBgpRouteRequest(Builder builder) {
        super(builder);
    ...
    public static ViewSmartAccessGatewayBgpRouteRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ViewSmartAccessGatewayBgpRouteRequest, Builder> {
        private Boolean crossAccount; 
        private String regionId; 
        private String resourceUid; 
        private String sagInsId; 
        ...
        private Builder(ViewSmartAccessGatewayBgpRouteRequest request) {
            super(request);
        ...
        @Override
        public ViewSmartAccessGatewayBgpRouteRequest build() {
            return new ViewSmartAccessGatewayBgpRouteRequest(this);
        } 
