...
/**
 * 
 * {@link DescribeSagWanListRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagWanListRequest</p>
 */
public class DescribeSagWanListRequest extends Request {
    ...
    private DescribeSagWanListRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagWanListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagWanListRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagWanListRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagWanListRequest build() {
            return new DescribeSagWanListRequest(this);
        } 
