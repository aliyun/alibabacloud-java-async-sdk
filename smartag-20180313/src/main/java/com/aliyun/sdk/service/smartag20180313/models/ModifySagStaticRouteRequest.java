...
/**
 * 
 * {@link ModifySagStaticRouteRequest} extends {@link RequestModel}
 *
 * <p>ModifySagStaticRouteRequest</p>
 */
public class ModifySagStaticRouteRequest extends Request {
    ...
    private ModifySagStaticRouteRequest(Builder builder) {
        super(builder);
    ...
    public static ModifySagStaticRouteRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifySagStaticRouteRequest, Builder> {
        private String destinationCidr; 
        private String nextHop; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ModifySagStaticRouteRequest request) {
            super(request);
        ...
        @Override
        public ModifySagStaticRouteRequest build() {
            return new ModifySagStaticRouteRequest(this);
        } 
