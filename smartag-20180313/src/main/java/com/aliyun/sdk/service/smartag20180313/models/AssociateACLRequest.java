...
/**
 * 
 * {@link AssociateACLRequest} extends {@link RequestModel}
 *
 * <p>AssociateACLRequest</p>
 */
public class AssociateACLRequest extends Request {
    ...
    private AssociateACLRequest(Builder builder) {
        super(builder);
    ...
    public static AssociateACLRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssociateACLRequest, Builder> {
        private String aclId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(AssociateACLRequest request) {
            super(request);
        ...
        @Override
        public AssociateACLRequest build() {
            return new AssociateACLRequest(this);
        } 
