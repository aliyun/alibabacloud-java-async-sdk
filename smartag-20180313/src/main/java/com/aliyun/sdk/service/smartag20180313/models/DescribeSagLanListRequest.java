...
/**
 * 
 * {@link DescribeSagLanListRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagLanListRequest</p>
 */
public class DescribeSagLanListRequest extends Request {
    ...
    private DescribeSagLanListRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagLanListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagLanListRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagLanListRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagLanListRequest build() {
            return new DescribeSagLanListRequest(this);
        } 
