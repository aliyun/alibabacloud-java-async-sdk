...
/**
 * 
 * {@link UpdateSmartAccessGatewayWanSnatRequest} extends {@link RequestModel}
 *
 * <p>UpdateSmartAccessGatewayWanSnatRequest</p>
 */
public class UpdateSmartAccessGatewayWanSnatRequest extends Request {
    ...
    private UpdateSmartAccessGatewayWanSnatRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateSmartAccessGatewayWanSnatRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateSmartAccessGatewayWanSnatRequest, Builder> {
        private Boolean crossAccount; 
        private String regionId; 
        private String resourceUid; 
        private String sagInsId; 
        ...
        private Builder(UpdateSmartAccessGatewayWanSnatRequest request) {
            super(request);
        ...
        public Builder snat(String snat) {
            this.putQueryParameter("Snat", snat);
            this.snat = snat;
            return this;
        }

        @Override
        public UpdateSmartAccessGatewayWanSnatRequest build() {
            return new UpdateSmartAccessGatewayWanSnatRequest(this);
        } 
