...
/**
 * 
 * {@link ViewSmartAccessGatewayOspfRouteRequest} extends {@link RequestModel}
 *
 * <p>ViewSmartAccessGatewayOspfRouteRequest</p>
 */
public class ViewSmartAccessGatewayOspfRouteRequest extends Request {
    ...
    private ViewSmartAccessGatewayOspfRouteRequest(Builder builder) {
        super(builder);
    ...
    public static ViewSmartAccessGatewayOspfRouteRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ViewSmartAccessGatewayOspfRouteRequest, Builder> {
        private Boolean crossAccount; 
        private String regionId; 
        private String resourceUid; 
        private String sagInsId; 
        ...
        private Builder(ViewSmartAccessGatewayOspfRouteRequest request) {
            super(request);
        ...
        @Override
        public ViewSmartAccessGatewayOspfRouteRequest build() {
            return new ViewSmartAccessGatewayOspfRouteRequest(this);
        } 
