...
/**
 * 
 * {@link DescribeSagPortListRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagPortListRequest</p>
 */
public class DescribeSagPortListRequest extends Request {
    ...
    private DescribeSagPortListRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagPortListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagPortListRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagPortListRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagPortListRequest build() {
            return new DescribeSagPortListRequest(this);
        } 
