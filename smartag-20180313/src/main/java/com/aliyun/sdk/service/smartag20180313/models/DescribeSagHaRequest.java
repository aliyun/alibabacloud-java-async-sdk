...
/**
 * 
 * {@link DescribeSagHaRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagHaRequest</p>
 */
public class DescribeSagHaRequest extends Request {
    ...
    private DescribeSagHaRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagHaRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagHaRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagHaRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagHaRequest build() {
            return new DescribeSagHaRequest(this);
        } 
