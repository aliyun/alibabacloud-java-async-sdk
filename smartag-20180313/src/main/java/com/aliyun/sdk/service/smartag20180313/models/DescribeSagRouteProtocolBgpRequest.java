...
/**
 * 
 * {@link DescribeSagRouteProtocolBgpRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagRouteProtocolBgpRequest</p>
 */
public class DescribeSagRouteProtocolBgpRequest extends Request {
    ...
    private DescribeSagRouteProtocolBgpRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagRouteProtocolBgpRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagRouteProtocolBgpRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagRouteProtocolBgpRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagRouteProtocolBgpRequest build() {
            return new DescribeSagRouteProtocolBgpRequest(this);
        } 
