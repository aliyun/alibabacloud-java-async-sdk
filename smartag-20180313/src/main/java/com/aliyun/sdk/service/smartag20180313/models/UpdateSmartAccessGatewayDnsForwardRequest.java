...
/**
 * 
 * {@link UpdateSmartAccessGatewayDnsForwardRequest} extends {@link RequestModel}
 *
 * <p>UpdateSmartAccessGatewayDnsForwardRequest</p>
 */
public class UpdateSmartAccessGatewayDnsForwardRequest extends Request {
    ...
    private UpdateSmartAccessGatewayDnsForwardRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateSmartAccessGatewayDnsForwardRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateSmartAccessGatewayDnsForwardRequest, Builder> {
        private String domain; 
        private String instanceId; 
        private String masterIp; 
        private String mode; 
        ...
        private Builder(UpdateSmartAccessGatewayDnsForwardRequest request) {
            super(request);
        ...
        @Override
        public UpdateSmartAccessGatewayDnsForwardRequest build() {
            return new UpdateSmartAccessGatewayDnsForwardRequest(this);
        } 
