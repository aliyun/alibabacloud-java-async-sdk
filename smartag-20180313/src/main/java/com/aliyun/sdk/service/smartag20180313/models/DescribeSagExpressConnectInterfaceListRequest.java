...
/**
 * 
 * {@link DescribeSagExpressConnectInterfaceListRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagExpressConnectInterfaceListRequest</p>
 */
public class DescribeSagExpressConnectInterfaceListRequest extends Request {
    ...
    private DescribeSagExpressConnectInterfaceListRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagExpressConnectInterfaceListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagExpressConnectInterfaceListRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String portName; 
        private String regionId; 
        ...
        private Builder(DescribeSagExpressConnectInterfaceListRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagExpressConnectInterfaceListRequest build() {
            return new DescribeSagExpressConnectInterfaceListRequest(this);
        } 
