...
/**
 * 
 * {@link DescribeSagUserDnsRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagUserDnsRequest</p>
 */
public class DescribeSagUserDnsRequest extends Request {
    ...
    private DescribeSagUserDnsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagUserDnsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagUserDnsRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagUserDnsRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagUserDnsRequest build() {
            return new DescribeSagUserDnsRequest(this);
        } 
