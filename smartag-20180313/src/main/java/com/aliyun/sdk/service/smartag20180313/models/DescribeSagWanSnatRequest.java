...
/**
 * 
 * {@link DescribeSagWanSnatRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagWanSnatRequest</p>
 */
public class DescribeSagWanSnatRequest extends Request {
    ...
    private DescribeSagWanSnatRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagWanSnatRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagWanSnatRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagWanSnatRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagWanSnatRequest build() {
            return new DescribeSagWanSnatRequest(this);
        } 
