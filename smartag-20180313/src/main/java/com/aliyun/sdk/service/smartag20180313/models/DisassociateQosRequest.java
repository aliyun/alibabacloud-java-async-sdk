...
/**
 * 
 * {@link DisassociateQosRequest} extends {@link RequestModel}
 *
 * <p>DisassociateQosRequest</p>
 */
public class DisassociateQosRequest extends Request {
    ...
    private DisassociateQosRequest(Builder builder) {
        super(builder);
    ...
    public static DisassociateQosRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DisassociateQosRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String qosId; 
        private String regionId; 
        ...
        private Builder(DisassociateQosRequest request) {
            super(request);
        ...
        @Override
        public DisassociateQosRequest build() {
            return new DisassociateQosRequest(this);
        } 
