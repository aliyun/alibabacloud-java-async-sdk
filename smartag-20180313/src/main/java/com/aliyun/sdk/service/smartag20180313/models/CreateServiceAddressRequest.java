...
/**
 * 
 * {@link CreateServiceAddressRequest} extends {@link RequestModel}
 *
 * <p>CreateServiceAddressRequest</p>
 */
public class CreateServiceAddressRequest extends Request {
    ...
    private CreateServiceAddressRequest(Builder builder) {
        super(builder);
    ...
    public static CreateServiceAddressRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateServiceAddressRequest, Builder> {
        private String address; 
        private String addressType; 
        private String regionId; 
        private String sagId; 
        ...
        private Builder(CreateServiceAddressRequest request) {
            super(request);
        ...
        @Override
        public CreateServiceAddressRequest build() {
            return new CreateServiceAddressRequest(this);
        } 
