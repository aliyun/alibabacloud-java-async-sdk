...
/**
 * 
 * {@link DescribeGrantRulesRequest} extends {@link RequestModel}
 *
 * <p>DescribeGrantRulesRequest</p>
 */
public class DescribeGrantRulesRequest extends Request {
    ...
    private DescribeGrantRulesRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeGrantRulesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeGrantRulesRequest, Builder> {
        private String associatedCcnId; 
        private String ownerAccount; 
        private Long ownerId; 
        private Integer pageNumber; 
        ...
        private Builder(DescribeGrantRulesRequest request) {
            super(request);
        ...
        @Override
        public DescribeGrantRulesRequest build() {
            return new DescribeGrantRulesRequest(this);
        } 
