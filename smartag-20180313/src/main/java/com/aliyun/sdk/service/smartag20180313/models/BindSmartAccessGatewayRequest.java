...
/**
 * 
 * {@link BindSmartAccessGatewayRequest} extends {@link RequestModel}
 *
 * <p>BindSmartAccessGatewayRequest</p>
 */
public class BindSmartAccessGatewayRequest extends Request {
    ...
    private BindSmartAccessGatewayRequest(Builder builder) {
        super(builder);
    ...
    public static BindSmartAccessGatewayRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<BindSmartAccessGatewayRequest, Builder> {
        private String ccnId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(BindSmartAccessGatewayRequest request) {
            super(request);
        ...
        @Override
        public BindSmartAccessGatewayRequest build() {
            return new BindSmartAccessGatewayRequest(this);
        } 
