...
/**
 * 
 * {@link DescribeDnatEntriesRequest} extends {@link RequestModel}
 *
 * <p>DescribeDnatEntriesRequest</p>
 */
public class DescribeDnatEntriesRequest extends Request {
    ...
    private DescribeDnatEntriesRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeDnatEntriesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeDnatEntriesRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private Integer pageNumber; 
        private Integer pageSize; 
        ...
        private Builder(DescribeDnatEntriesRequest request) {
            super(request);
        ...
        @Override
        public DescribeDnatEntriesRequest build() {
            return new DescribeDnatEntriesRequest(this);
        } 
