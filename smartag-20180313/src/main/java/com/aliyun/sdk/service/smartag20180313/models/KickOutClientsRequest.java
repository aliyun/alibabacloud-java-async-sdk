...
/**
 * 
 * {@link KickOutClientsRequest} extends {@link RequestModel}
 *
 * <p>KickOutClientsRequest</p>
 */
public class KickOutClientsRequest extends Request {
    ...
    private KickOutClientsRequest(Builder builder) {
        super(builder);
    ...
    public static KickOutClientsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<KickOutClientsRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(KickOutClientsRequest request) {
            super(request);
        ...
        @Override
        public KickOutClientsRequest build() {
            return new KickOutClientsRequest(this);
        } 
