...
/**
 * 
 * {@link DescribeSAGDeviceInfoRequest} extends {@link RequestModel}
 *
 * <p>DescribeSAGDeviceInfoRequest</p>
 */
public class DescribeSAGDeviceInfoRequest extends Request {
    ...
    private DescribeSAGDeviceInfoRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSAGDeviceInfoRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSAGDeviceInfoRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSAGDeviceInfoRequest request) {
            super(request);
        ...
        @Override
        public DescribeSAGDeviceInfoRequest build() {
            return new DescribeSAGDeviceInfoRequest(this);
        } 
