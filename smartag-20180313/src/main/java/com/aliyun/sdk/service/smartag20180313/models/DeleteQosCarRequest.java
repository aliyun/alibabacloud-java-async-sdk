...
/**
 * 
 * {@link DeleteQosCarRequest} extends {@link RequestModel}
 *
 * <p>DeleteQosCarRequest</p>
 */
public class DeleteQosCarRequest extends Request {
    ...
    private DeleteQosCarRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteQosCarRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteQosCarRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String qosCarId; 
        private String qosId; 
        ...
        private Builder(DeleteQosCarRequest request) {
            super(request);
        ...
        @Override
        public DeleteQosCarRequest build() {
            return new DeleteQosCarRequest(this);
        } 
