...
/**
 * 
 * {@link ModifySagUserDnsRequest} extends {@link RequestModel}
 *
 * <p>ModifySagUserDnsRequest</p>
 */
public class ModifySagUserDnsRequest extends Request {
    ...
    private ModifySagUserDnsRequest(Builder builder) {
        super(builder);
    ...
    public static ModifySagUserDnsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifySagUserDnsRequest, Builder> {
        private String masterDns; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(ModifySagUserDnsRequest request) {
            super(request);
        ...
        @Override
        public ModifySagUserDnsRequest build() {
            return new ModifySagUserDnsRequest(this);
        } 
