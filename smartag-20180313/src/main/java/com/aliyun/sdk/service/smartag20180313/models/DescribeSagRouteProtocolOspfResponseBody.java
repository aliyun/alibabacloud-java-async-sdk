...
/**
 * 
 * {@link DescribeSagRouteProtocolOspfResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeSagRouteProtocolOspfResponseBody</p>
 */
public class DescribeSagRouteProtocolOspfResponseBody extends TeaModel {
    @com.aliyun.core.annotation.NameInMap("AreaId")
    private String areaId;

    @com.aliyun.core.annotation.NameInMap("AreaType")
    ...
    private DescribeSagRouteProtocolOspfResponseBody(Builder builder) {
    ...
    public static DescribeSagRouteProtocolOspfResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeSagRouteProtocolOspfResponseBody model) {
            this.areaId = model.areaId;
            this.areaType = model.areaType;
        ...
        public DescribeSagRouteProtocolOspfResponseBody build() {
            return new DescribeSagRouteProtocolOspfResponseBody(this);
        } 
