...
/**
 * 
 * {@link DeleteSagExpressConnectInterfaceRequest} extends {@link RequestModel}
 *
 * <p>DeleteSagExpressConnectInterfaceRequest</p>
 */
public class DeleteSagExpressConnectInterfaceRequest extends Request {
    ...
    private DeleteSagExpressConnectInterfaceRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteSagExpressConnectInterfaceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteSagExpressConnectInterfaceRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String portName; 
        private String regionId; 
        ...
        private Builder(DeleteSagExpressConnectInterfaceRequest request) {
            super(request);
        ...
        @Override
        public DeleteSagExpressConnectInterfaceRequest build() {
            return new DeleteSagExpressConnectInterfaceRequest(this);
        } 
