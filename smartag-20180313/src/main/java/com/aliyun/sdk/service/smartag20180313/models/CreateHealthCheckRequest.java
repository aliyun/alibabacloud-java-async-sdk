...
/**
 * 
 * {@link CreateHealthCheckRequest} extends {@link RequestModel}
 *
 * <p>CreateHealthCheckRequest</p>
 */
public class CreateHealthCheckRequest extends Request {
    ...
    @com.aliyun.core.annotation.Validation(maximum = 60000, minimum = 1000)
    private Integer probeInterval;

    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("ProbeTimeout")
    @com.aliyun.core.annotation.Validation(maximum = 30000, minimum = 10)
    ...
    private CreateHealthCheckRequest(Builder builder) {
        super(builder);
    ...
    public static CreateHealthCheckRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateHealthCheckRequest, Builder> {
        private String description; 
        private String dstIpAddr; 
        private Integer dstPort; 
        private Integer failCountThreshold; 
        ...
        private Builder(CreateHealthCheckRequest request) {
            super(request);
