...
/**
 * 
 * {@link UnbindVbrRequest} extends {@link RequestModel}
 *
 * <p>UnbindVbrRequest</p>
 */
public class UnbindVbrRequest extends Request {
    ...
    private UnbindVbrRequest(Builder builder) {
        super(builder);
    ...
    public static UnbindVbrRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UnbindVbrRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(UnbindVbrRequest request) {
            super(request);
        ...
        @Override
        public UnbindVbrRequest build() {
            return new UnbindVbrRequest(this);
        } 
