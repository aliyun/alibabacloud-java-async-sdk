...
/**
 * 
 * {@link ModifySagWanSnatRequest} extends {@link RequestModel}
 *
 * <p>ModifySagWanSnatRequest</p>
 */
public class ModifySagWanSnatRequest extends Request {
    ...
    private ModifySagWanSnatRequest(Builder builder) {
        super(builder);
    ...
    public static ModifySagWanSnatRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifySagWanSnatRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(ModifySagWanSnatRequest request) {
            super(request);
        ...
        @Override
        public ModifySagWanSnatRequest build() {
            return new ModifySagWanSnatRequest(this);
        } 
