...
/**
 * 
 * {@link DeleteHealthCheckRequest} extends {@link RequestModel}
 *
 * <p>DeleteHealthCheckRequest</p>
 */
public class DeleteHealthCheckRequest extends Request {
    ...
    private DeleteHealthCheckRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteHealthCheckRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteHealthCheckRequest, Builder> {
        private String hcInstanceId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(DeleteHealthCheckRequest request) {
            super(request);
