...
/**
 * 
 * {@link CreateSagStaticRouteRequest} extends {@link RequestModel}
 *
 * <p>CreateSagStaticRouteRequest</p>
 */
public class CreateSagStaticRouteRequest extends Request {
    ...
    private CreateSagStaticRouteRequest(Builder builder) {
        super(builder);
    ...
    public static CreateSagStaticRouteRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateSagStaticRouteRequest, Builder> {
        private String destinationCidr; 
        private String nextHop; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(CreateSagStaticRouteRequest request) {
            super(request);
        ...
        @Override
        public CreateSagStaticRouteRequest build() {
            return new CreateSagStaticRouteRequest(this);
        } 
