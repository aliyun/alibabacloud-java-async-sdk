...
/**
 * 
 * {@link BindVbrRequest} extends {@link RequestModel}
 *
 * <p>BindVbrRequest</p>
 */
public class BindVbrRequest extends Request {
    ...
    private BindVbrRequest(Builder builder) {
        super(builder);
    ...
    public static BindVbrRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<BindVbrRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(BindVbrRequest request) {
            super(request);
        ...
        @Override
        public BindVbrRequest build() {
            return new BindVbrRequest(this);
        } 
