...
/**
 * 
 * {@link ViewSmartAccessGatewayDnsRequest} extends {@link RequestModel}
 *
 * <p>ViewSmartAccessGatewayDnsRequest</p>
 */
public class ViewSmartAccessGatewayDnsRequest extends Request {
    ...
    private ViewSmartAccessGatewayDnsRequest(Builder builder) {
        super(builder);
    ...
    public static ViewSmartAccessGatewayDnsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ViewSmartAccessGatewayDnsRequest, Builder> {
        private Boolean crossAccount; 
        private String regionId; 
        private String resourceUid; 
        private String sagInsId; 
        ...
        private Builder(ViewSmartAccessGatewayDnsRequest request) {
            super(request);
        ...
        @Override
        public ViewSmartAccessGatewayDnsRequest build() {
            return new ViewSmartAccessGatewayDnsRequest(this);
        } 
