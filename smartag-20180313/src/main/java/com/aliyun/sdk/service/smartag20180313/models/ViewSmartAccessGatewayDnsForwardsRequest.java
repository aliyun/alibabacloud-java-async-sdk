...
/**
 * 
 * {@link ViewSmartAccessGatewayDnsForwardsRequest} extends {@link RequestModel}
 *
 * <p>ViewSmartAccessGatewayDnsForwardsRequest</p>
 */
public class ViewSmartAccessGatewayDnsForwardsRequest extends Request {
    ...
    private ViewSmartAccessGatewayDnsForwardsRequest(Builder builder) {
        super(builder);
    ...
    public static ViewSmartAccessGatewayDnsForwardsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ViewSmartAccessGatewayDnsForwardsRequest, Builder> {
        private String regionId; 
        private String sagInsId; 
        private String sagSn; 
        ...
        private Builder(ViewSmartAccessGatewayDnsForwardsRequest request) {
            super(request);
        ...
        @Override
        public ViewSmartAccessGatewayDnsForwardsRequest build() {
            return new ViewSmartAccessGatewayDnsForwardsRequest(this);
        } 
