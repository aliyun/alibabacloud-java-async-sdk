...
/**
 * 
 * {@link DescribeSagWifiRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagWifiRequest</p>
 */
public class DescribeSagWifiRequest extends Request {
    ...
    private DescribeSagWifiRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagWifiRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagWifiRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagWifiRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagWifiRequest build() {
            return new DescribeSagWifiRequest(this);
        } 
