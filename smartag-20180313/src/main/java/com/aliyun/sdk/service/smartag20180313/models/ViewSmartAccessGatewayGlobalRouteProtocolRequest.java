...
/**
 * 
 * {@link ViewSmartAccessGatewayGlobalRouteProtocolRequest} extends {@link RequestModel}
 *
 * <p>ViewSmartAccessGatewayGlobalRouteProtocolRequest</p>
 */
public class ViewSmartAccessGatewayGlobalRouteProtocolRequest extends Request {
    ...
    private ViewSmartAccessGatewayGlobalRouteProtocolRequest(Builder builder) {
        super(builder);
    ...
    public static ViewSmartAccessGatewayGlobalRouteProtocolRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ViewSmartAccessGatewayGlobalRouteProtocolRequest, Builder> {
        private Boolean crossAccount; 
        private String regionId; 
        private String resourceUid; 
        private String sagInsId; 
        ...
        private Builder(ViewSmartAccessGatewayGlobalRouteProtocolRequest request) {
            super(request);
        ...
        @Override
        public ViewSmartAccessGatewayGlobalRouteProtocolRequest build() {
            return new ViewSmartAccessGatewayGlobalRouteProtocolRequest(this);
        } 
