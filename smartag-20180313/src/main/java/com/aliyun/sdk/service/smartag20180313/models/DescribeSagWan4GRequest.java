...
/**
 * 
 * {@link DescribeSagWan4GRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagWan4GRequest</p>
 */
public class DescribeSagWan4GRequest extends Request {
    ...
    private DescribeSagWan4GRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagWan4GRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagWan4GRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagWan4GRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagWan4GRequest build() {
            return new DescribeSagWan4GRequest(this);
        } 
