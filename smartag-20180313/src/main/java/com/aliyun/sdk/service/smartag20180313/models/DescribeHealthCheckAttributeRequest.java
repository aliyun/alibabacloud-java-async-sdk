...
/**
 * 
 * {@link DescribeHealthCheckAttributeRequest} extends {@link RequestModel}
 *
 * <p>DescribeHealthCheckAttributeRequest</p>
 */
public class DescribeHealthCheckAttributeRequest extends Request {
    ...
    private DescribeHealthCheckAttributeRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeHealthCheckAttributeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeHealthCheckAttributeRequest, Builder> {
        private String hcInstanceId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(DescribeHealthCheckAttributeRequest request) {
            super(request);
        ...
        @Override
        public DescribeHealthCheckAttributeRequest build() {
            return new DescribeHealthCheckAttributeRequest(this);
        } 
