...
/**
 * 
 * {@link AssociateFlowLogRequest} extends {@link RequestModel}
 *
 * <p>AssociateFlowLogRequest</p>
 */
public class AssociateFlowLogRequest extends Request {
    ...
    private AssociateFlowLogRequest(Builder builder) {
        super(builder);
    ...
    public static AssociateFlowLogRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssociateFlowLogRequest, Builder> {
        private String flowLogId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        ...
        private Builder(AssociateFlowLogRequest request) {
            super(request);
        ...
        @Override
        public AssociateFlowLogRequest build() {
            return new AssociateFlowLogRequest(this);
        } 
