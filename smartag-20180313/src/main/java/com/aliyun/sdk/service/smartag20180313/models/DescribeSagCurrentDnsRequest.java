...
/**
 * 
 * {@link DescribeSagCurrentDnsRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagCurrentDnsRequest</p>
 */
public class DescribeSagCurrentDnsRequest extends Request {
    ...
    private DescribeSagCurrentDnsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagCurrentDnsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagCurrentDnsRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagCurrentDnsRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagCurrentDnsRequest build() {
            return new DescribeSagCurrentDnsRequest(this);
        } 
