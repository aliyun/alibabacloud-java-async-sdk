...
/**
 * 
 * {@link ModifySmartAccessGatewayUpBandwidthRequest} extends {@link RequestModel}
 *
 * <p>ModifySmartAccessGatewayUpBandwidthRequest</p>
 */
public class ModifySmartAccessGatewayUpBandwidthRequest extends Request {
    ...
    private ModifySmartAccessGatewayUpBandwidthRequest(Builder builder) {
        super(builder);
    ...
    public static ModifySmartAccessGatewayUpBandwidthRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifySmartAccessGatewayUpBandwidthRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(ModifySmartAccessGatewayUpBandwidthRequest request) {
            super(request);
            ...
            this.upBandwidth4G = request.upBandwidth4G;
            this.upBandwidthWan = request.upBandwidthWan;
        } 
        ...
        public Builder upBandwidth4G(Integer upBandwidth4G) {
            this.putQueryParameter("UpBandwidth4G", upBandwidth4G);
        ...
        public Builder upBandwidthWan(Integer upBandwidthWan) {
            this.putQueryParameter("UpBandwidthWan", upBandwidthWan);
            this.upBandwidthWan = upBandwidthWan;
            return this;
        }

        @Override
        public ModifySmartAccessGatewayUpBandwidthRequest build() {
            return new ModifySmartAccessGatewayUpBandwidthRequest(this);
        } 
