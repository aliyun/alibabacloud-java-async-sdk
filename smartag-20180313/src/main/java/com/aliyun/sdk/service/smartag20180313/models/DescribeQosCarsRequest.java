...
/**
 * 
 * {@link DescribeQosCarsRequest} extends {@link RequestModel}
 *
 * <p>DescribeQosCarsRequest</p>
 */
public class DescribeQosCarsRequest extends Request {
    ...
    private DescribeQosCarsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeQosCarsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeQosCarsRequest, Builder> {
        private String description; 
        private String order; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(DescribeQosCarsRequest request) {
            super(request);
        ...
        @Override
        public DescribeQosCarsRequest build() {
            return new DescribeQosCarsRequest(this);
        } 
