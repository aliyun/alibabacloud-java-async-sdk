...
/**
 * 
 * {@link DescribeDeviceAutoUpgradePolicyRequest} extends {@link RequestModel}
 *
 * <p>DescribeDeviceAutoUpgradePolicyRequest</p>
 */
public class DescribeDeviceAutoUpgradePolicyRequest extends Request {
    ...
    private DescribeDeviceAutoUpgradePolicyRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeDeviceAutoUpgradePolicyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeDeviceAutoUpgradePolicyRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeDeviceAutoUpgradePolicyRequest request) {
            super(request);
        ...
        @Override
        public DescribeDeviceAutoUpgradePolicyRequest build() {
            return new DescribeDeviceAutoUpgradePolicyRequest(this);
        } 
