...
/**
 * 
 * {@link ViewSmartAccessGatewayWanSnatRequest} extends {@link RequestModel}
 *
 * <p>ViewSmartAccessGatewayWanSnatRequest</p>
 */
public class ViewSmartAccessGatewayWanSnatRequest extends Request {
    ...
    private ViewSmartAccessGatewayWanSnatRequest(Builder builder) {
        super(builder);
    ...
    public static ViewSmartAccessGatewayWanSnatRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ViewSmartAccessGatewayWanSnatRequest, Builder> {
        private Boolean crossAccount; 
        private String regionId; 
        private String resourceUid; 
        private String sagInsId; 
        ...
        private Builder(ViewSmartAccessGatewayWanSnatRequest request) {
            super(request);
        ...
        @Override
        public ViewSmartAccessGatewayWanSnatRequest build() {
            return new ViewSmartAccessGatewayWanSnatRequest(this);
        } 
