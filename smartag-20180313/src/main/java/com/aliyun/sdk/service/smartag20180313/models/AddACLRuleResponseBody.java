...
/**
 * 
 * {@link AddACLRuleResponseBody} extends {@link TeaModel}
 *
 * <p>AddACLRuleResponseBody</p>
 */
public class AddACLRuleResponseBody extends TeaModel {
    ...
    private AddACLRuleResponseBody(Builder builder) {
    ...
    public static AddACLRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddACLRuleResponseBody model) {
        ...
        public AddACLRuleResponseBody build() {
            return new AddACLRuleResponseBody(this);
        } 
