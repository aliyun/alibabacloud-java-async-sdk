...
/**
 * 
 * {@link DescribeSagRouteListRequest} extends {@link RequestModel}
 *
 * <p>DescribeSagRouteListRequest</p>
 */
public class DescribeSagRouteListRequest extends Request {
    ...
    private DescribeSagRouteListRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSagRouteListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSagRouteListRequest, Builder> {
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(DescribeSagRouteListRequest request) {
            super(request);
        ...
        @Override
        public DescribeSagRouteListRequest build() {
            return new DescribeSagRouteListRequest(this);
        } 
