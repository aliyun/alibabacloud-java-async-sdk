...
/**
 * 
 * {@link DescribeBindableSmartAccessGatewaysRequest} extends {@link RequestModel}
 *
 * <p>DescribeBindableSmartAccessGatewaysRequest</p>
 */
public class DescribeBindableSmartAccessGatewaysRequest extends Request {
    ...
    private DescribeBindableSmartAccessGatewaysRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeBindableSmartAccessGatewaysRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeBindableSmartAccessGatewaysRequest, Builder> {
        private String ccnId; 
        private Boolean crossAccount; 
        private String name; 
        private String ownerAccount; 
        ...
        private Builder(DescribeBindableSmartAccessGatewaysRequest request) {
            super(request);
        ...
        @Override
        public DescribeBindableSmartAccessGatewaysRequest build() {
            return new DescribeBindableSmartAccessGatewaysRequest(this);
        } 
