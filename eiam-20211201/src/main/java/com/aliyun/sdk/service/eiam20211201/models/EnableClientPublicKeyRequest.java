...
/**
 * 
 * {@link EnableClientPublicKeyRequest} extends {@link RequestModel}
 *
 * <p>EnableClientPublicKeyRequest</p>
 */
public class EnableClientPublicKeyRequest extends Request {
    ...
    private EnableClientPublicKeyRequest(Builder builder) {
        super(builder);
    ...
    public static EnableClientPublicKeyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnableClientPublicKeyRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String clientPublicKeyId; 
        private String clientToken; 
        ...
        private Builder(EnableClientPublicKeyRequest request) {
            super(request);
        ...
        @Override
        public EnableClientPublicKeyRequest build() {
            return new EnableClientPublicKeyRequest(this);
        } 
