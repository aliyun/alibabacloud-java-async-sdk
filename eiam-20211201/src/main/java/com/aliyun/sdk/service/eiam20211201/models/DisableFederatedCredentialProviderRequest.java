...
/**
 * 
 * {@link DisableFederatedCredentialProviderRequest} extends {@link RequestModel}
 *
 * <p>DisableFederatedCredentialProviderRequest</p>
 */
public class DisableFederatedCredentialProviderRequest extends Request {
    ...
    private DisableFederatedCredentialProviderRequest(Builder builder) {
        super(builder);
    ...
    public static DisableFederatedCredentialProviderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DisableFederatedCredentialProviderRequest, Builder> {
        private String regionId; 
        private String federatedCredentialProviderId; 
        private String instanceId; 
        ...
        private Builder(DisableFederatedCredentialProviderRequest request) {
            super(request);
        ...
        @Override
        public DisableFederatedCredentialProviderRequest build() {
            return new DisableFederatedCredentialProviderRequest(this);
        } 
