...
/**
 * 
 * {@link DeleteApplicationTokenRequest} extends {@link RequestModel}
 *
 * <p>DeleteApplicationTokenRequest</p>
 */
public class DeleteApplicationTokenRequest extends Request {
    ...
    private DeleteApplicationTokenRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteApplicationTokenRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteApplicationTokenRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String applicationTokenId; 
        private String instanceId; 
        ...
        private Builder(DeleteApplicationTokenRequest request) {
            super(request);
        ...
        @Override
        public DeleteApplicationTokenRequest build() {
            return new DeleteApplicationTokenRequest(this);
        } 
