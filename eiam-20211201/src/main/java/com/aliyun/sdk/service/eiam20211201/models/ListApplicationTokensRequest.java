...
/**
 * 
 * {@link ListApplicationTokensRequest} extends {@link RequestModel}
 *
 * <p>ListApplicationTokensRequest</p>
 */
public class ListApplicationTokensRequest extends Request {
    ...
    private ListApplicationTokensRequest(Builder builder) {
        super(builder);
    ...
    public static ListApplicationTokensRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListApplicationTokensRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String applicationTokenType; 
        private String instanceId; 
        ...
        private Builder(ListApplicationTokensRequest request) {
            super(request);
        ...
        @Override
        public ListApplicationTokensRequest build() {
            return new ListApplicationTokensRequest(this);
        } 
