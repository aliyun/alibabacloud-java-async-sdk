...
/**
 * 
 * {@link ListConditionalAccessPoliciesForNetworkZoneResponseBody} extends {@link TeaModel}
 *
 * <p>ListConditionalAccessPoliciesForNetworkZoneResponseBody</p>
 */
public class ListConditionalAccessPoliciesForNetworkZoneResponseBody extends TeaModel {
    ...
    private ListConditionalAccessPoliciesForNetworkZoneResponseBody(Builder builder) {
    ...
    public static ListConditionalAccessPoliciesForNetworkZoneResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListConditionalAccessPoliciesForNetworkZoneResponseBody model) {
        ...
        public ListConditionalAccessPoliciesForNetworkZoneResponseBody build() {
            return new ListConditionalAccessPoliciesForNetworkZoneResponseBody(this);
        } 
