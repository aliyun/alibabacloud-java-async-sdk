...
/**
 * 
 * {@link UpdateApplicationRoleRequest} extends {@link RequestModel}
 *
 * <p>UpdateApplicationRoleRequest</p>
 */
public class UpdateApplicationRoleRequest extends Request {
    ...
    private UpdateApplicationRoleRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateApplicationRoleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateApplicationRoleRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String applicationRoleId; 
        private String applicationRoleName; 
        ...
        private Builder(UpdateApplicationRoleRequest request) {
            super(request);
        ...
        @Override
        public UpdateApplicationRoleRequest build() {
            return new UpdateApplicationRoleRequest(this);
        } 
