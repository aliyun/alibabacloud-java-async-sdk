...
public class ListNetworkAccessEndpointAvailableZonesResponseBody extends TeaModel {
    ...
    public static ListNetworkAccessEndpointAvailableZonesResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListNetworkAccessEndpointAvailableZonesResponseBody build() {
            return new ListNetworkAccessEndpointAvailableZonesResponseBody(this);
        } 
