...
/**
 * 
 * {@link EnableApplicationFederatedCredentialRequest} extends {@link RequestModel}
 *
 * <p>EnableApplicationFederatedCredentialRequest</p>
 */
public class EnableApplicationFederatedCredentialRequest extends Request {
    ...
    private EnableApplicationFederatedCredentialRequest(Builder builder) {
        super(builder);
    ...
    public static EnableApplicationFederatedCredentialRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnableApplicationFederatedCredentialRequest, Builder> {
        private String regionId; 
        private String applicationFederatedCredentialId; 
        private String applicationId; 
        private String instanceId; 
        ...
        private Builder(EnableApplicationFederatedCredentialRequest request) {
            super(request);
        ...
        @Override
        public EnableApplicationFederatedCredentialRequest build() {
            return new EnableApplicationFederatedCredentialRequest(this);
        } 
