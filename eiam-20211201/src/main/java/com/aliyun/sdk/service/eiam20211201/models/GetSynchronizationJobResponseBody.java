...
public class GetSynchronizationJobResponseBody extends TeaModel {
    ...
    private GetSynchronizationJobResponseBody(Builder builder) {
    ...
    public static GetSynchronizationJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetSynchronizationJobResponseBody build() {
            return new GetSynchronizationJobResponseBody(this);
        } 
