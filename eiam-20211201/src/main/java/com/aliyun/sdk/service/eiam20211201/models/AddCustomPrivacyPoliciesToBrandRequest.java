...
/**
 * 
 * {@link AddCustomPrivacyPoliciesToBrandRequest} extends {@link RequestModel}
 *
 * <p>AddCustomPrivacyPoliciesToBrandRequest</p>
 */
public class AddCustomPrivacyPoliciesToBrandRequest extends Request {
    ...
    private AddCustomPrivacyPoliciesToBrandRequest(Builder builder) {
        super(builder);
    ...
    public static AddCustomPrivacyPoliciesToBrandRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddCustomPrivacyPoliciesToBrandRequest, Builder> {
        private String regionId; 
        private String brandId; 
        private java.util.List<String> customPrivacyPolicyIds; 
        private String instanceId; 
        ...
        private Builder(AddCustomPrivacyPoliciesToBrandRequest request) {
            super(request);
        ...
        @Override
        public AddCustomPrivacyPoliciesToBrandRequest build() {
            return new AddCustomPrivacyPoliciesToBrandRequest(this);
        } 
