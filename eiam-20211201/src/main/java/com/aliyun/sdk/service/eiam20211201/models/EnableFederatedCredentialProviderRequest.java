...
/**
 * 
 * {@link EnableFederatedCredentialProviderRequest} extends {@link RequestModel}
 *
 * <p>EnableFederatedCredentialProviderRequest</p>
 */
public class EnableFederatedCredentialProviderRequest extends Request {
    ...
    private EnableFederatedCredentialProviderRequest(Builder builder) {
        super(builder);
    ...
    public static EnableFederatedCredentialProviderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<EnableFederatedCredentialProviderRequest, Builder> {
        private String regionId; 
        private String federatedCredentialProviderId; 
        private String instanceId; 
        ...
        private Builder(EnableFederatedCredentialProviderRequest request) {
            super(request);
        ...
        @Override
        public EnableFederatedCredentialProviderRequest build() {
            return new EnableFederatedCredentialProviderRequest(this);
        } 
