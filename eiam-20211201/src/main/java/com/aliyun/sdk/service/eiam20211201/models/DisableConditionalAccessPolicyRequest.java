...
/**
 * 
 * {@link DisableConditionalAccessPolicyRequest} extends {@link RequestModel}
 *
 * <p>DisableConditionalAccessPolicyRequest</p>
 */
public class DisableConditionalAccessPolicyRequest extends Request {
    ...
    private DisableConditionalAccessPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static DisableConditionalAccessPolicyRequest create() {
    ...
    public static final class Builder extends Request.Builder<DisableConditionalAccessPolicyRequest, Builder> {
        private String regionId; 
        private String conditionalAccessPolicyId; 
        private String instanceId; 
        ...
        private Builder(DisableConditionalAccessPolicyRequest request) {
            super(request);
        ...
        @Override
        public DisableConditionalAccessPolicyRequest build() {
            return new DisableConditionalAccessPolicyRequest(this);
        } 
