...
/**
 * 
 * {@link ListApplicationFederatedCredentialsForProviderRequest} extends {@link RequestModel}
 *
 * <p>ListApplicationFederatedCredentialsForProviderRequest</p>
 */
public class ListApplicationFederatedCredentialsForProviderRequest extends Request {
    ...
    private ListApplicationFederatedCredentialsForProviderRequest(Builder builder) {
        super(builder);
    ...
    public static ListApplicationFederatedCredentialsForProviderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListApplicationFederatedCredentialsForProviderRequest, Builder> {
        private String regionId; 
        private String federatedCredentialProviderId; 
        private String instanceId; 
        private Integer maxResults; 
        ...
        private Builder(ListApplicationFederatedCredentialsForProviderRequest request) {
            super(request);
        ...
        @Override
        public ListApplicationFederatedCredentialsForProviderRequest build() {
            return new ListApplicationFederatedCredentialsForProviderRequest(this);
        } 
