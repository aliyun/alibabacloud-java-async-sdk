...
/**
 * 
 * {@link DeleteClientPublicKeyRequest} extends {@link RequestModel}
 *
 * <p>DeleteClientPublicKeyRequest</p>
 */
public class DeleteClientPublicKeyRequest extends Request {
    ...
    private DeleteClientPublicKeyRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteClientPublicKeyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteClientPublicKeyRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String clientPublicKeyId; 
        private String instanceId; 
        ...
        private Builder(DeleteClientPublicKeyRequest request) {
            super(request);
        ...
        @Override
        public DeleteClientPublicKeyRequest build() {
            return new DeleteClientPublicKeyRequest(this);
        } 
