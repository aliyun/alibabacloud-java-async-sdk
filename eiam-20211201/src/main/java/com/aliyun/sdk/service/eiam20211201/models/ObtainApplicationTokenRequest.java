...
/**
 * 
 * {@link ObtainApplicationTokenRequest} extends {@link RequestModel}
 *
 * <p>ObtainApplicationTokenRequest</p>
 */
public class ObtainApplicationTokenRequest extends Request {
    ...
    private ObtainApplicationTokenRequest(Builder builder) {
        super(builder);
    ...
    public static ObtainApplicationTokenRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ObtainApplicationTokenRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String applicationTokenId; 
        private String instanceId; 
        ...
        private Builder(ObtainApplicationTokenRequest request) {
            super(request);
        ...
        @Override
        public ObtainApplicationTokenRequest build() {
            return new ObtainApplicationTokenRequest(this);
        } 
