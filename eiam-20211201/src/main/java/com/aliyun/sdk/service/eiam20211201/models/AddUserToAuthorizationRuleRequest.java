...
/**
 * 
 * {@link AddUserToAuthorizationRuleRequest} extends {@link RequestModel}
 *
 * <p>AddUserToAuthorizationRuleRequest</p>
 */
public class AddUserToAuthorizationRuleRequest extends Request {
    ...
    private AddUserToAuthorizationRuleRequest(Builder builder) {
        super(builder);
    ...
    public static AddUserToAuthorizationRuleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddUserToAuthorizationRuleRequest, Builder> {
        private String regionId; 
        private String authorizationRuleId; 
        private String clientToken; 
        private String instanceId; 
        ...
        private Builder(AddUserToAuthorizationRuleRequest request) {
            super(request);
        ...
        @Override
        public AddUserToAuthorizationRuleRequest build() {
            return new AddUserToAuthorizationRuleRequest(this);
        } 
    ...
    /**
     * 
     * {@link AddUserToAuthorizationRuleRequest} extends {@link TeaModel}
     *
     * <p>AddUserToAuthorizationRuleRequest</p>
     */
