...
/**
 * 
 * {@link DisableCloudAccountRoleRequest} extends {@link RequestModel}
 *
 * <p>DisableCloudAccountRoleRequest</p>
 */
public class DisableCloudAccountRoleRequest extends Request {
    ...
    private DisableCloudAccountRoleRequest(Builder builder) {
        super(builder);
    ...
    public static DisableCloudAccountRoleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DisableCloudAccountRoleRequest, Builder> {
        private String regionId; 
        private String clientToken; 
        private String cloudAccountId; 
        private String cloudAccountRoleId; 
        ...
        private Builder(DisableCloudAccountRoleRequest request) {
            super(request);
        ...
        @Override
        public DisableCloudAccountRoleRequest build() {
            return new DisableCloudAccountRoleRequest(this);
        } 
