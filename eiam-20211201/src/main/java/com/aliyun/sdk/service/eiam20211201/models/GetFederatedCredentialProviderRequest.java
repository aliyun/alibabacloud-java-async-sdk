...
/**
 * 
 * {@link GetFederatedCredentialProviderRequest} extends {@link RequestModel}
 *
 * <p>GetFederatedCredentialProviderRequest</p>
 */
public class GetFederatedCredentialProviderRequest extends Request {
    ...
    private GetFederatedCredentialProviderRequest(Builder builder) {
        super(builder);
    ...
    public static GetFederatedCredentialProviderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetFederatedCredentialProviderRequest, Builder> {
        private String regionId; 
        private String federatedCredentialProviderId; 
        private String instanceId; 
        ...
        private Builder(GetFederatedCredentialProviderRequest request) {
            super(request);
        ...
        @Override
        public GetFederatedCredentialProviderRequest build() {
            return new GetFederatedCredentialProviderRequest(this);
        } 
