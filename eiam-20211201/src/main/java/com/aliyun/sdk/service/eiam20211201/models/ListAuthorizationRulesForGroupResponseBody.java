...
/**
 * 
 * {@link ListAuthorizationRulesForGroupResponseBody} extends {@link TeaModel}
 *
 * <p>ListAuthorizationRulesForGroupResponseBody</p>
 */
public class ListAuthorizationRulesForGroupResponseBody extends TeaModel {
    ...
    private ListAuthorizationRulesForGroupResponseBody(Builder builder) {
    ...
    public static ListAuthorizationRulesForGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAuthorizationRulesForGroupResponseBody model) {
        ...
        public ListAuthorizationRulesForGroupResponseBody build() {
            return new ListAuthorizationRulesForGroupResponseBody(this);
        } 
