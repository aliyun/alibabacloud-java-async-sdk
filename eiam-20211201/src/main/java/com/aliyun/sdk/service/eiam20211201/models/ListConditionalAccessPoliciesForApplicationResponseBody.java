...
/**
 * 
 * {@link ListConditionalAccessPoliciesForApplicationResponseBody} extends {@link TeaModel}
 *
 * <p>ListConditionalAccessPoliciesForApplicationResponseBody</p>
 */
public class ListConditionalAccessPoliciesForApplicationResponseBody extends TeaModel {
    ...
    private ListConditionalAccessPoliciesForApplicationResponseBody(Builder builder) {
    ...
    public static ListConditionalAccessPoliciesForApplicationResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListConditionalAccessPoliciesForApplicationResponseBody model) {
        ...
        public ListConditionalAccessPoliciesForApplicationResponseBody build() {
            return new ListConditionalAccessPoliciesForApplicationResponseBody(this);
        } 
