...
/**
 * 
 * {@link GetApplicationFederatedCredentialRequest} extends {@link RequestModel}
 *
 * <p>GetApplicationFederatedCredentialRequest</p>
 */
public class GetApplicationFederatedCredentialRequest extends Request {
    ...
    private GetApplicationFederatedCredentialRequest(Builder builder) {
        super(builder);
    ...
    public static GetApplicationFederatedCredentialRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetApplicationFederatedCredentialRequest, Builder> {
        private String regionId; 
        private String applicationFederatedCredentialId; 
        private String applicationId; 
        private String instanceId; 
        ...
        private Builder(GetApplicationFederatedCredentialRequest request) {
            super(request);
        ...
        @Override
        public GetApplicationFederatedCredentialRequest build() {
            return new GetApplicationFederatedCredentialRequest(this);
        } 
