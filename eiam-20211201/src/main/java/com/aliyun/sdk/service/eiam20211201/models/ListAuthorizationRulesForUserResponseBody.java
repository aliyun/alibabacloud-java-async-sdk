...
/**
 * 
 * {@link ListAuthorizationRulesForUserResponseBody} extends {@link TeaModel}
 *
 * <p>ListAuthorizationRulesForUserResponseBody</p>
 */
public class ListAuthorizationRulesForUserResponseBody extends TeaModel {
    ...
    private ListAuthorizationRulesForUserResponseBody(Builder builder) {
    ...
    public static ListAuthorizationRulesForUserResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAuthorizationRulesForUserResponseBody model) {
        ...
        public ListAuthorizationRulesForUserResponseBody build() {
            return new ListAuthorizationRulesForUserResponseBody(this);
        } 
