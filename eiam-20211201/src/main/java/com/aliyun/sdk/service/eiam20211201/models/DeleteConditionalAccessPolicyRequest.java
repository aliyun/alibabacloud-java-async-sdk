...
/**
 * 
 * {@link DeleteConditionalAccessPolicyRequest} extends {@link RequestModel}
 *
 * <p>DeleteConditionalAccessPolicyRequest</p>
 */
public class DeleteConditionalAccessPolicyRequest extends Request {
    ...
    private DeleteConditionalAccessPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteConditionalAccessPolicyRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteConditionalAccessPolicyRequest, Builder> {
        private String regionId; 
        private String conditionalAccessPolicyId; 
        private String instanceId; 
        ...
        private Builder(DeleteConditionalAccessPolicyRequest request) {
            super(request);
        ...
        @Override
        public DeleteConditionalAccessPolicyRequest build() {
            return new DeleteConditionalAccessPolicyRequest(this);
        } 
