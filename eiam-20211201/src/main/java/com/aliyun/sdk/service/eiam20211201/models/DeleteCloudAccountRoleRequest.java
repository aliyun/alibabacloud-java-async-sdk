...
/**
 * 
 * {@link DeleteCloudAccountRoleRequest} extends {@link RequestModel}
 *
 * <p>DeleteCloudAccountRoleRequest</p>
 */
public class DeleteCloudAccountRoleRequest extends Request {
    ...
    private DeleteCloudAccountRoleRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteCloudAccountRoleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteCloudAccountRoleRequest, Builder> {
        private String regionId; 
        private String cloudAccountId; 
        private String cloudAccountRoleId; 
        private String instanceId; 
        ...
        private Builder(DeleteCloudAccountRoleRequest request) {
            super(request);
        ...
        @Override
        public DeleteCloudAccountRoleRequest build() {
            return new DeleteCloudAccountRoleRequest(this);
        } 
