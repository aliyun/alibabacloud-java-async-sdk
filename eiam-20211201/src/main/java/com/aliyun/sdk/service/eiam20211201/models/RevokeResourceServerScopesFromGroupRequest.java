...
/**
 * 
 * {@link RevokeResourceServerScopesFromGroupRequest} extends {@link RequestModel}
 *
 * <p>RevokeResourceServerScopesFromGroupRequest</p>
 */
public class RevokeResourceServerScopesFromGroupRequest extends Request {
    ...
    private RevokeResourceServerScopesFromGroupRequest(Builder builder) {
        super(builder);
    ...
    public static RevokeResourceServerScopesFromGroupRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<RevokeResourceServerScopesFromGroupRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String groupId; 
        private String instanceId; 
        ...
        private Builder(RevokeResourceServerScopesFromGroupRequest request) {
            super(request);
        ...
        @Override
        public RevokeResourceServerScopesFromGroupRequest build() {
            return new RevokeResourceServerScopesFromGroupRequest(this);
        } 
