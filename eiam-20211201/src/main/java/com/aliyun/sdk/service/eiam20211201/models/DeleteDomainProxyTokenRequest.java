...
public class DeleteDomainProxyTokenRequest extends Request {
    ...
    public static DeleteDomainProxyTokenRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteDomainProxyTokenRequest, Builder> {
        private String regionId; 
        private String domainId; 
        private String domainProxyTokenId; 
        private String instanceId; 
        ...
        private Builder(DeleteDomainProxyTokenRequest request) {
            super(request);
        ...
        @Override
        public DeleteDomainProxyTokenRequest build() {
            return new DeleteDomainProxyTokenRequest(this);
        } 
