...
/**
 * 
 * {@link UpdateConditionalAccessPolicyDescriptionRequest} extends {@link RequestModel}
 *
 * <p>UpdateConditionalAccessPolicyDescriptionRequest</p>
 */
public class UpdateConditionalAccessPolicyDescriptionRequest extends Request {
    ...
    public static UpdateConditionalAccessPolicyDescriptionRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateConditionalAccessPolicyDescriptionRequest, Builder> {
        ...
        @Override
        public UpdateConditionalAccessPolicyDescriptionRequest build() {
            return new UpdateConditionalAccessPolicyDescriptionRequest(this);
        } 
