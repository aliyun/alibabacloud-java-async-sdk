...
/**
 * 
 * {@link ListFederatedCredentialProvidersRequest} extends {@link RequestModel}
 *
 * <p>ListFederatedCredentialProvidersRequest</p>
 */
public class ListFederatedCredentialProvidersRequest extends Request {
    ...
    private ListFederatedCredentialProvidersRequest(Builder builder) {
        super(builder);
    ...
    public static ListFederatedCredentialProvidersRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListFederatedCredentialProvidersRequest, Builder> {
        private String regionId; 
        private String federatedCredentialProviderName; 
        private String federatedCredentialProviderType; 
        private String instanceId; 
        ...
        private Builder(ListFederatedCredentialProvidersRequest request) {
            super(request);
        ...
        @Override
        public ListFederatedCredentialProvidersRequest build() {
            return new ListFederatedCredentialProvidersRequest(this);
        } 
