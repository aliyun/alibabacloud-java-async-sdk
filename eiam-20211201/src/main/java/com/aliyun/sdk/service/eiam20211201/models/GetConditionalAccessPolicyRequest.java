...
/**
 * 
 * {@link GetConditionalAccessPolicyRequest} extends {@link RequestModel}
 *
 * <p>GetConditionalAccessPolicyRequest</p>
 */
public class GetConditionalAccessPolicyRequest extends Request {
    ...
    private GetConditionalAccessPolicyRequest(Builder builder) {
        super(builder);
    ...
    public static GetConditionalAccessPolicyRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetConditionalAccessPolicyRequest, Builder> {
        private String regionId; 
        private String conditionalAccessPolicyId; 
        private String instanceId; 
        ...
        private Builder(GetConditionalAccessPolicyRequest request) {
            super(request);
        ...
        @Override
        public GetConditionalAccessPolicyRequest build() {
            return new GetConditionalAccessPolicyRequest(this);
        } 
