...
/**
 * 
 * {@link DeleteApplicationFederatedCredentialRequest} extends {@link RequestModel}
 *
 * <p>DeleteApplicationFederatedCredentialRequest</p>
 */
public class DeleteApplicationFederatedCredentialRequest extends Request {
    ...
    private DeleteApplicationFederatedCredentialRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteApplicationFederatedCredentialRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteApplicationFederatedCredentialRequest, Builder> {
        private String regionId; 
        private String applicationFederatedCredentialId; 
        private String applicationId; 
        private String instanceId; 
        ...
        private Builder(DeleteApplicationFederatedCredentialRequest request) {
            super(request);
        ...
        @Override
        public DeleteApplicationFederatedCredentialRequest build() {
            return new DeleteApplicationFederatedCredentialRequest(this);
        } 
