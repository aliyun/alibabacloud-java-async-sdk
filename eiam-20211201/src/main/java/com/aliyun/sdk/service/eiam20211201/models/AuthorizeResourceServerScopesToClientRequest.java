...
/**
 * 
 * {@link AuthorizeResourceServerScopesToClientRequest} extends {@link RequestModel}
 *
 * <p>AuthorizeResourceServerScopesToClientRequest</p>
 */
public class AuthorizeResourceServerScopesToClientRequest extends Request {
    ...
    private AuthorizeResourceServerScopesToClientRequest(Builder builder) {
        super(builder);
    ...
    public static AuthorizeResourceServerScopesToClientRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AuthorizeResourceServerScopesToClientRequest, Builder> {
        private String regionId; 
        private String clientApplicationId; 
        private String instanceId; 
        private String resourceServerApplicationId; 
        ...
        private Builder(AuthorizeResourceServerScopesToClientRequest request) {
            super(request);
        ...
        @Override
        public AuthorizeResourceServerScopesToClientRequest build() {
            return new AuthorizeResourceServerScopesToClientRequest(this);
        } 
