...
/**
 * 
 * {@link GetAuthorizationResourceRequest} extends {@link RequestModel}
 *
 * <p>GetAuthorizationResourceRequest</p>
 */
public class GetAuthorizationResourceRequest extends Request {
    ...
    private GetAuthorizationResourceRequest(Builder builder) {
        super(builder);
    ...
    public static GetAuthorizationResourceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetAuthorizationResourceRequest, Builder> {
        private String regionId; 
        private String authorizationResourceId; 
        private String authorizationRuleId; 
        private String instanceId; 
        ...
        private Builder(GetAuthorizationResourceRequest request) {
            super(request);
        ...
        @Override
        public GetAuthorizationResourceRequest build() {
            return new GetAuthorizationResourceRequest(this);
        } 
