...
/**
 * 
 * {@link UpdateResourceServerScopeRequest} extends {@link RequestModel}
 *
 * <p>UpdateResourceServerScopeRequest</p>
 */
public class UpdateResourceServerScopeRequest extends Request {
    ...
    private UpdateResourceServerScopeRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateResourceServerScopeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateResourceServerScopeRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String instanceId; 
        private String resourceServerScopeId; 
        ...
        private Builder(UpdateResourceServerScopeRequest request) {
            super(request);
        ...
        @Override
        public UpdateResourceServerScopeRequest build() {
            return new UpdateResourceServerScopeRequest(this);
        } 
