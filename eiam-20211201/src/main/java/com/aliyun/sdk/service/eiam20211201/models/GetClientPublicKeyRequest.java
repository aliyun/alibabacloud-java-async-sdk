...
/**
 * 
 * {@link GetClientPublicKeyRequest} extends {@link RequestModel}
 *
 * <p>GetClientPublicKeyRequest</p>
 */
public class GetClientPublicKeyRequest extends Request {
    ...
    private GetClientPublicKeyRequest(Builder builder) {
        super(builder);
    ...
    public static GetClientPublicKeyRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetClientPublicKeyRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String clientPublicKeyId; 
        private String instanceId; 
        ...
        private Builder(GetClientPublicKeyRequest request) {
            super(request);
        ...
        public GetClientPublicKeyRequest build() {
            return new GetClientPublicKeyRequest(this);
        } 
