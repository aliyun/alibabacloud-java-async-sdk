...
/**
 * 
 * {@link ListApplicationAccountsForUserResponseBody} extends {@link TeaModel}
 *
 * <p>ListApplicationAccountsForUserResponseBody</p>
 */
public class ListApplicationAccountsForUserResponseBody extends TeaModel {
    ...
    private ListApplicationAccountsForUserResponseBody(Builder builder) {
    ...
    public static ListApplicationAccountsForUserResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListApplicationAccountsForUserResponseBody model) {
        ...
        public ListApplicationAccountsForUserResponseBody build() {
            return new ListApplicationAccountsForUserResponseBody(this);
        } 
