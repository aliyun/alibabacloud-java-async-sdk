...
public class GetCloudAccountRoleResponseBody extends TeaModel {
    ...
    public static class CloudAccountRole extends TeaModel {
        ...
        public static final class Builder {
             ...
             * <ul>
             * <li>system_init: system-created. The role is automatically generated by the platform as a preset and typically cannot be modified or deleted.</li>
             * <li>user_custom: user-created. The role is manually created by a user and can be edited and managed throughout its lifecycle.</li>
             * </ul>
             * 
             * <strong>example:</strong>
             * <p>user_custom</p>
