...
/**
 * 
 * {@link AddGroupToAuthorizationRuleRequest} extends {@link RequestModel}
 *
 * <p>AddGroupToAuthorizationRuleRequest</p>
 */
public class AddGroupToAuthorizationRuleRequest extends Request {
    ...
    private AddGroupToAuthorizationRuleRequest(Builder builder) {
        super(builder);
    ...
    public static AddGroupToAuthorizationRuleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddGroupToAuthorizationRuleRequest, Builder> {
        private String regionId; 
        private String authorizationRuleId; 
        private String clientToken; 
        private String groupId; 
        ...
        private Builder(AddGroupToAuthorizationRuleRequest request) {
            super(request);
        ...
        @Override
        public AddGroupToAuthorizationRuleRequest build() {
            return new AddGroupToAuthorizationRuleRequest(this);
        } 
    ...
    /**
     * 
     * {@link AddGroupToAuthorizationRuleRequest} extends {@link TeaModel}
     *
     * <p>AddGroupToAuthorizationRuleRequest</p>
     */
