...
/**
 * 
 * {@link GetResourceServerScopeRequest} extends {@link RequestModel}
 *
 * <p>GetResourceServerScopeRequest</p>
 */
public class GetResourceServerScopeRequest extends Request {
    ...
    private GetResourceServerScopeRequest(Builder builder) {
        super(builder);
    ...
    public static GetResourceServerScopeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetResourceServerScopeRequest, Builder> {
        private String regionId; 
        private String applicationId; 
        private String instanceId; 
        private String resourceServerScopeId; 
        ...
        private Builder(GetResourceServerScopeRequest request) {
            super(request);
        ...
        @Override
        public GetResourceServerScopeRequest build() {
            return new GetResourceServerScopeRequest(this);
        } 
