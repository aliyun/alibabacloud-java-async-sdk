...
/**
 * {@link DescribeAntChainContractProjectsV2ResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAntChainContractProjectsV2ResponseBody</p>
 */
public class DescribeAntChainContractProjectsV2ResponseBody extends TeaModel {
    ...
    private DescribeAntChainContractProjectsV2ResponseBody(Builder builder) {
    ...
    public static DescribeAntChainContractProjectsV2ResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeAntChainContractProjectsV2ResponseBody build() {
            return new DescribeAntChainContractProjectsV2ResponseBody(this);
        } 
