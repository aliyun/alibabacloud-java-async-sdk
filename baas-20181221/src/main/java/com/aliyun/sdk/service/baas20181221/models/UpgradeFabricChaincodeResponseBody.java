...
/**
 * {@link UpgradeFabricChaincodeResponseBody} extends {@link TeaModel}
 *
 * <p>UpgradeFabricChaincodeResponseBody</p>
 */
public class UpgradeFabricChaincodeResponseBody extends TeaModel {
    ...
    private UpgradeFabricChaincodeResponseBody(Builder builder) {
    ...
    public static UpgradeFabricChaincodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpgradeFabricChaincodeResponseBody build() {
            return new UpgradeFabricChaincodeResponseBody(this);
        } 
