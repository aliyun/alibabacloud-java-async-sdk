...
/**
 * {@link CreateFabricChaincodeResponseBody} extends {@link TeaModel}
 *
 * <p>CreateFabricChaincodeResponseBody</p>
 */
public class CreateFabricChaincodeResponseBody extends TeaModel {
    ...
    private CreateFabricChaincodeResponseBody(Builder builder) {
    ...
    public static CreateFabricChaincodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateFabricChaincodeResponseBody build() {
            return new CreateFabricChaincodeResponseBody(this);
        } 
