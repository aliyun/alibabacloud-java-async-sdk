...
/**
 * {@link DescribeFabricInviterResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeFabricInviterResponseBody</p>
 */
public class DescribeFabricInviterResponseBody extends TeaModel {
    ...
    private DescribeFabricInviterResponseBody(Builder builder) {
    ...
    public static DescribeFabricInviterResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeFabricInviterResponseBody build() {
            return new DescribeFabricInviterResponseBody(this);
        } 
