...
/**
 * {@link UpgradeFabricChaincodeRequest} extends {@link RequestModel}
 *
 * <p>UpgradeFabricChaincodeRequest</p>
 */
public class UpgradeFabricChaincodeRequest extends Request {
    @Body
    ...
    private UpgradeFabricChaincodeRequest(Builder builder) {
        super(builder);
    ...
    public static UpgradeFabricChaincodeRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpgradeFabricChaincodeRequest, Builder> {
        private String chaincodeId; 
        private String collectionConfig; 
        private String endorsePolicy; 
        private String location; 
        ...
        private Builder(UpgradeFabricChaincodeRequest response) {
            super(response);
        ...
        @Override
        public UpgradeFabricChaincodeRequest build() {
            return new UpgradeFabricChaincodeRequest(this);
        } 
