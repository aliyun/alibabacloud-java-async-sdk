...
/**
 * {@link InstallFabricChaincodeResponseBody} extends {@link TeaModel}
 *
 * <p>InstallFabricChaincodeResponseBody</p>
 */
public class InstallFabricChaincodeResponseBody extends TeaModel {
    ...
    private InstallFabricChaincodeResponseBody(Builder builder) {
    ...
    public static InstallFabricChaincodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public InstallFabricChaincodeResponseBody build() {
            return new InstallFabricChaincodeResponseBody(this);
        } 
