...
/**
 * {@link DescribeFabricOrganizationsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeFabricOrganizationsResponseBody</p>
 */
public class DescribeFabricOrganizationsResponseBody extends TeaModel {
    ...
    private DescribeFabricOrganizationsResponseBody(Builder builder) {
    ...
    public static DescribeFabricOrganizationsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeFabricOrganizationsResponseBody build() {
            return new DescribeFabricOrganizationsResponseBody(this);
        } 
