...
/**
 * {@link CreateFabricConsortiumResponseBody} extends {@link TeaModel}
 *
 * <p>CreateFabricConsortiumResponseBody</p>
 */
public class CreateFabricConsortiumResponseBody extends TeaModel {
    ...
    private CreateFabricConsortiumResponseBody(Builder builder) {
    ...
    public static CreateFabricConsortiumResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateFabricConsortiumResponseBody build() {
            return new CreateFabricConsortiumResponseBody(this);
        } 
