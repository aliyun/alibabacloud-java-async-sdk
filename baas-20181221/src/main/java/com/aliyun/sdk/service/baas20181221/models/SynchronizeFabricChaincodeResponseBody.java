...
/**
 * {@link SynchronizeFabricChaincodeResponseBody} extends {@link TeaModel}
 *
 * <p>SynchronizeFabricChaincodeResponseBody</p>
 */
public class SynchronizeFabricChaincodeResponseBody extends TeaModel {
    ...
    private SynchronizeFabricChaincodeResponseBody(Builder builder) {
    ...
    public static SynchronizeFabricChaincodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        public SynchronizeFabricChaincodeResponseBody build() {
            return new SynchronizeFabricChaincodeResponseBody(this);
        } 
