...
public class DeployApplicationGroupResponseBody extends TeaModel {
    ...
    public static class DeployOutputs extends TeaModel {
        @NameInMap("Outputs")
        private java.util.List < java.util.Map<String, String>> outputs;

        @NameInMap("StackId")
        private String stackId;

        private DeployOutputs(Builder builder) {
        ...
        public static DeployOutputs create() {
            return builder().build();
        }
         ...
         * @return outputs
         */
        public java.util.List < java.util.Map<String, String>> getOutputs() {
            return this.outputs;
        }
        ...
        public static final class Builder {
             ...
             * Outputs.
             */
            public Builder outputs(java.util.List < java.util.Map<String, String>> outputs) {
            ...
            public DeployOutputs build() {
                return new DeployOutputs(this);
            } 

        } 

    }
    public static class DeployParameters extends TeaModel {
        @NameInMap("Parameters")
        private java.util.List < java.util.Map<String, String>> parameters;

        @NameInMap("TemplateUrl")
        private String templateUrl;

        private DeployParameters(Builder builder) {
        ...
        public static DeployParameters create() {
            return builder().build();
        }
         ...
         * @return parameters
         */
        public java.util.List < java.util.Map<String, String>> getParameters() {
        ...
        public static final class Builder {
             ...
             * Parameters.
             */
            public Builder parameters(java.util.List < java.util.Map<String, String>> parameters) {
            ...
            public DeployParameters build() {
                return new DeployParameters(this);
            } 
    ...
    public static class ApplicationGroup extends TeaModel {
        ...
        private DeployOutputs deployOutputs;
         ...
         */
        public DeployOutputs getDeployOutputs() {
         ...
         */
        public DeployParameters getDeployParameters() {
        ...
        public static final class Builder {
             ...
             * DeployOutputs.
             */
            public Builder deployOutputs(DeployOutputs deployOutputs) {
             ...
             * DeployParameters.
             */
            public Builder deployParameters(DeployParameters deployParameters) {
