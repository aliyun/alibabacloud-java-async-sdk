...
/**
 * 
 * {@link DescribeApisecProtectionGroupsRequest} extends {@link RequestModel}
 *
 * <p>DescribeApisecProtectionGroupsRequest</p>
 */
public class DescribeApisecProtectionGroupsRequest extends Request {
    ...
    private DescribeApisecProtectionGroupsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeApisecProtectionGroupsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeApisecProtectionGroupsRequest, Builder> {
        private Integer apisecStatus; 
        private String instanceId; 
        private Long pageNumber; 
        private Long pageSize; 
        ...
        private Builder(DescribeApisecProtectionGroupsRequest request) {
            super(request);
        ...
        @Override
        public DescribeApisecProtectionGroupsRequest build() {
            return new DescribeApisecProtectionGroupsRequest(this);
        } 
