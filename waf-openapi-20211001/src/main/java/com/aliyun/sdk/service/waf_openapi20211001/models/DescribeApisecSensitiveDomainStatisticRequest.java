 ...
 */
public class DescribeApisecSensitiveDomainStatisticRequest extends Request {
    ...
    private DescribeApisecSensitiveDomainStatisticRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeApisecSensitiveDomainStatisticRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeApisecSensitiveDomainStatisticRequest, Builder> {
        private String clusterId; 
        private Long endTime; 
        private String instanceId; 
        private String orderWay; 
        ...
        private Builder(DescribeApisecSensitiveDomainStatisticRequest request) {
            super(request);
        ...
        @Override
        public DescribeApisecSensitiveDomainStatisticRequest build() {
            return new DescribeApisecSensitiveDomainStatisticRequest(this);
        } 
