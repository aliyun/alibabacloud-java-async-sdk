...
/**
 * 
 * {@link CreateHybridCloudClusterRequest} extends {@link RequestModel}
 *
 * <p>CreateHybridCloudClusterRequest</p>
 */
public class CreateHybridCloudClusterRequest extends Request {
    ...
    private CreateHybridCloudClusterRequest(Builder builder) {
        super(builder);
    ...
    public static CreateHybridCloudClusterRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateHybridCloudClusterRequest, Builder> {
        private String accessMode; 
        private String accessRegion; 
        private String clusterName; 
        private String httpPorts; 
        ...
        private Builder(CreateHybridCloudClusterRequest request) {
            super(request);
        ...
        @Override
        public CreateHybridCloudClusterRequest build() {
            return new CreateHybridCloudClusterRequest(this);
        } 
