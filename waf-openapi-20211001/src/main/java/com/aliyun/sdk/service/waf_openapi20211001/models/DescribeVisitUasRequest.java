...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeVisitUasRequest, Builder> {
        ...
        /**
         * <p>The end time of the query. Unit: seconds. If you do not set this parameter, the end time is the current query time.</p>
         * 
        ...
        /**
         * <p>The start time of the query. Unit: seconds.</p>
         * <p>This parameter is required.</p>
         * 
         * <strong>example:</strong>
         * <p>1665331200</p>
