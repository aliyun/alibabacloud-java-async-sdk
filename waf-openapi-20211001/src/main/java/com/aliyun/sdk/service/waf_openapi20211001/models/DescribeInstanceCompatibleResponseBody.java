...
/**
 * {@link DescribeInstanceCompatibleResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeInstanceCompatibleResponseBody</p>
 */
public class DescribeInstanceCompatibleResponseBody extends TeaModel {
    ...
    private DescribeInstanceCompatibleResponseBody(Builder builder) {
    ...
    public static DescribeInstanceCompatibleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeInstanceCompatibleResponseBody build() {
            return new DescribeInstanceCompatibleResponseBody(this);
        } 
