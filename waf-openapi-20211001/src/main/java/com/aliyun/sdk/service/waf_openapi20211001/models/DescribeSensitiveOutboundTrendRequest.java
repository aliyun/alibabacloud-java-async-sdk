 ...
 *
 * <p>DescribeSensitiveOutboundTrendRequest</p>
 */
public class DescribeSensitiveOutboundTrendRequest extends Request {
    ...
    private DescribeSensitiveOutboundTrendRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSensitiveOutboundTrendRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeSensitiveOutboundTrendRequest, Builder> {
        private String clusterId; 
        private Long endTime; 
        private String instanceId; 
        private String regionId; 
        ...
        private Builder(DescribeSensitiveOutboundTrendRequest request) {
            super(request);
        ...
        @Override
        public DescribeSensitiveOutboundTrendRequest build() {
            return new DescribeSensitiveOutboundTrendRequest(this);
        } 
