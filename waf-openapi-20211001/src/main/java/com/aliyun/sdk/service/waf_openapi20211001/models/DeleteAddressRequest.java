...
/**
 * 
 * {@link DeleteAddressRequest} extends {@link RequestModel}
 *
 * <p>DeleteAddressRequest</p>
 */
public class DeleteAddressRequest extends Request {
    ...
    private DeleteAddressRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteAddressRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteAddressRequest, Builder> {
        private java.util.List<String> addressList; 
        private String instanceId; 
        private String resourceManagerResourceGroupId; 
        private Long ruleId; 
        ...
        private Builder(DeleteAddressRequest request) {
            super(request);
