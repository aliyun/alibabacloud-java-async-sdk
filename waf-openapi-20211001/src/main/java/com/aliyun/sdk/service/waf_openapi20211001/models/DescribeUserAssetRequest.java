...
/**
 * 
 * {@link DescribeUserAssetRequest} extends {@link RequestModel}
 *
 * <p>DescribeUserAssetRequest</p>
 */
public class DescribeUserAssetRequest extends Request {
    ...
    private DescribeUserAssetRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeUserAssetRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeUserAssetRequest, Builder> {
        private String clusterId; 
        private String dataType; 
        private String days; 
        private String instanceId; 
        ...
        private Builder(DescribeUserAssetRequest request) {
            super(request);
        ...
        @Override
        public DescribeUserAssetRequest build() {
            return new DescribeUserAssetRequest(this);
        } 
