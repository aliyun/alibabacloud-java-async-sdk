 ...
 */
public class DeleteMediaWorkflowRequest extends Request {
    ...
    private DeleteMediaWorkflowRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteMediaWorkflowRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteMediaWorkflowRequest, Builder> {
        private String mediaWorkflowId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String resourceOwnerAccount; 
        ...
        @Override
        public DeleteMediaWorkflowRequest build() {
            return new DeleteMediaWorkflowRequest(this);
        } 
