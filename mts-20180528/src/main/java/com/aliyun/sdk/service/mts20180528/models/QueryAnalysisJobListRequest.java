...
public class QueryAnalysisJobListRequest extends Request {
    ...
    private QueryAnalysisJobListRequest(Builder builder) {
        super(builder);
        this.analysisJobIds = builder.analysisJobIds;
    ...
    public static QueryAnalysisJobListRequest create() {
    ...
    public static final class Builder extends Request.Builder<QueryAnalysisJobListRequest, Builder> {
        private String analysisJobIds; 
        private String ownerAccount; 
        private Long ownerId; 
        private String resourceOwnerAccount; 
        ...
        @Override
        public QueryAnalysisJobListRequest build() {
            return new QueryAnalysisJobListRequest(this);
        } 
