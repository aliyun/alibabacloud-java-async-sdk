...
/**
 * 
 * {@link SearchCityPageRequest} extends {@link RequestModel}
 *
 * <p>SearchCityPageRequest</p>
 */
public class SearchCityPageRequest extends Request {
    ...
    private SearchCityPageRequest(Builder builder) {
        super(builder);
    ...
    public static SearchCityPageRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SearchCityPageRequest, Builder> {
        private Long accountNo; 
        private Integer count; 
        private String countryCode; 
        private Integer start; 
        ...
        private Builder(SearchCityPageRequest request) {
            super(request);
        ...
        @Override
        public SearchCityPageRequest build() {
            return new SearchCityPageRequest(this);
        } 
