...
/**
 * 
 * {@link CancelOrRefundResponseBody} extends {@link TeaModel}
 *
 * <p>CancelOrRefundResponseBody</p>
 */
public class CancelOrRefundResponseBody extends TeaModel {
    ...
    private CancelOrRefundResponseBody(Builder builder) {
    ...
    public static CancelOrRefundResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CancelOrRefundResponseBody model) {
        ...
        public CancelOrRefundResponseBody build() {
            return new CancelOrRefundResponseBody(this);
        } 
    ...
    public static class Data extends TeaModel {
        @com.aliyun.core.annotation.NameInMap("RefundOrderId")
