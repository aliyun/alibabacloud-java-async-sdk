...
/**
 * 
 * {@link TicketApplyRefundRequest} extends {@link RequestModel}
 *
 * <p>TicketApplyRefundRequest</p>
 */
public class TicketApplyRefundRequest extends Request {
    ...
    private TicketApplyRefundRequest(Builder builder) {
        super(builder);
    ...
    public static TicketApplyRefundRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<TicketApplyRefundRequest, Builder> {
        private Long accountNo; 
        private String distributorOrderId; 
        private String refundReason; 
        private String refundRemark; 
        ...
        private Builder(TicketApplyRefundRequest request) {
            super(request);
        ...
        @Override
        public TicketApplyRefundRequest build() {
            return new TicketApplyRefundRequest(this);
        } 
