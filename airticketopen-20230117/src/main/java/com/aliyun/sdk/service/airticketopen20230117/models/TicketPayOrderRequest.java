...
/**
 * 
 * {@link TicketPayOrderRequest} extends {@link RequestModel}
 *
 * <p>TicketPayOrderRequest</p>
 */
public class TicketPayOrderRequest extends Request {
    ...
    private TicketPayOrderRequest(Builder builder) {
        super(builder);
    ...
    public static TicketPayOrderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<TicketPayOrderRequest, Builder> {
        private Long accountNo; 
        private String distributorOrderId; 
        ...
        private Builder(TicketPayOrderRequest request) {
            super(request);
        ...
        @Override
        public TicketPayOrderRequest build() {
            return new TicketPayOrderRequest(this);
        } 
