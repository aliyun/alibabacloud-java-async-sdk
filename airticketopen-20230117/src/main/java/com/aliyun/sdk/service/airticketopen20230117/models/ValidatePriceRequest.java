...
/**
 * 
 * {@link ValidatePriceRequest} extends {@link RequestModel}
 *
 * <p>ValidatePriceRequest</p>
 */
public class ValidatePriceRequest extends Request {
    ...
    private ValidatePriceRequest(Builder builder) {
        super(builder);
    ...
    public static ValidatePriceRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ValidatePriceRequest, Builder> {
        private Long accountNo; 
        private Integer adults; 
        private Integer children; 
        private java.util.List<Integer> childrenAges; 
        ...
        private Builder(ValidatePriceRequest request) {
            super(request);
        ...
        @Override
        public ValidatePriceRequest build() {
            return new ValidatePriceRequest(this);
        } 
