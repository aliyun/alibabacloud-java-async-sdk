...
/**
 * 
 * {@link BatchGetHotelDetailResponseBody} extends {@link TeaModel}
 *
 * <p>BatchGetHotelDetailResponseBody</p>
 */
public class BatchGetHotelDetailResponseBody extends TeaModel {
    ...
    private BatchGetHotelDetailResponseBody(Builder builder) {
    ...
    public static BatchGetHotelDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(BatchGetHotelDetailResponseBody model) {
        ...
        public BatchGetHotelDetailResponseBody build() {
            return new BatchGetHotelDetailResponseBody(this);
        } 
