...
/**
 * 
 * {@link TicketQueryOrderRequest} extends {@link RequestModel}
 *
 * <p>TicketQueryOrderRequest</p>
 */
public class TicketQueryOrderRequest extends Request {
    ...
    private TicketQueryOrderRequest(Builder builder) {
        super(builder);
    ...
    public static TicketQueryOrderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<TicketQueryOrderRequest, Builder> {
        private Long accountNo; 
        private String distributorOrderId; 
        ...
        private Builder(TicketQueryOrderRequest request) {
            super(request);
        ...
        @Override
        public TicketQueryOrderRequest build() {
            return new TicketQueryOrderRequest(this);
        } 
