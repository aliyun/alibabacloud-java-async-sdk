...
/**
 * 
 * {@link GlobalHotelApplyRefundRequest} extends {@link RequestModel}
 *
 * <p>GlobalHotelApplyRefundRequest</p>
 */
public class GlobalHotelApplyRefundRequest extends Request {
    ...
    private GlobalHotelApplyRefundRequest(Builder builder) {
        super(builder);
    ...
    public static GlobalHotelApplyRefundRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GlobalHotelApplyRefundRequest, Builder> {
        private Long accountNo; 
        private String orderNo; 
        private String refundReason; 
        private String tracerId; 
        ...
        private Builder(GlobalHotelApplyRefundRequest request) {
            super(request);
        ...
        @Override
        public GlobalHotelApplyRefundRequest build() {
            return new GlobalHotelApplyRefundRequest(this);
        } 
