...
/**
 * 
 * {@link GlobalHotelCreateOrderRequest} extends {@link RequestModel}
 *
 * <p>GlobalHotelCreateOrderRequest</p>
 */
public class GlobalHotelCreateOrderRequest extends Request {
    ...
    private GlobalHotelCreateOrderRequest(Builder builder) {
        super(builder);
    ...
    public static GlobalHotelCreateOrderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GlobalHotelCreateOrderRequest, Builder> {
        private Long accountNo; 
        private Contact contact; 
        private String externalOrderNo; 
        private java.util.List<java.util.List<Guests>> guests; 
        ...
        private Builder(GlobalHotelCreateOrderRequest request) {
            super(request);
        ...
        @Override
        public GlobalHotelCreateOrderRequest build() {
            return new GlobalHotelCreateOrderRequest(this);
        } 
    ...
    /**
     * 
     * {@link GlobalHotelCreateOrderRequest} extends {@link TeaModel}
     *
     * <p>GlobalHotelCreateOrderRequest</p>
     */
