...
/**
 * 
 * {@link GlobalHotelQueryAvailabilityRequest} extends {@link RequestModel}
 *
 * <p>GlobalHotelQueryAvailabilityRequest</p>
 */
public class GlobalHotelQueryAvailabilityRequest extends Request {
    ...
    private GlobalHotelQueryAvailabilityRequest(Builder builder) {
        super(builder);
    ...
    public static GlobalHotelQueryAvailabilityRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GlobalHotelQueryAvailabilityRequest, Builder> {
        private Long accountNo; 
        private Integer adultCount; 
        private String checkInDate; 
        private String checkOutDate; 
        ...
        private Builder(GlobalHotelQueryAvailabilityRequest request) {
            super(request);
        ...
        @Override
        public GlobalHotelQueryAvailabilityRequest build() {
            return new GlobalHotelQueryAvailabilityRequest(this);
        } 
