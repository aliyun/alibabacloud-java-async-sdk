...
/**
 * 
 * {@link StandardSearchRequest} extends {@link RequestModel}
 *
 * <p>StandardSearchRequest</p>
 */
public class StandardSearchRequest extends Request {
    ...
    private StandardSearchRequest(Builder builder) {
        super(builder);
    ...
    public static StandardSearchRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<StandardSearchRequest, Builder> {
        private Integer adults; 
        private java.util.List<AirLegs> airLegs; 
        private String cabinClass; 
        private Integer children; 
        ...
        private Builder(StandardSearchRequest request) {
            super(request);
        ...
        @Override
        public StandardSearchRequest build() {
            return new StandardSearchRequest(this);
        } 
    ...
    /**
     * 
     * {@link StandardSearchRequest} extends {@link TeaModel}
     *
     * <p>StandardSearchRequest</p>
     */
