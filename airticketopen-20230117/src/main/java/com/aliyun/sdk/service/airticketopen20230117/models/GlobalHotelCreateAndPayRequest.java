...
/**
 * 
 * {@link GlobalHotelCreateAndPayRequest} extends {@link RequestModel}
 *
 * <p>GlobalHotelCreateAndPayRequest</p>
 */
public class GlobalHotelCreateAndPayRequest extends Request {
    ...
    private GlobalHotelCreateAndPayRequest(Builder builder) {
        super(builder);
    ...
    public static GlobalHotelCreateAndPayRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GlobalHotelCreateAndPayRequest, Builder> {
        private Long accountNo; 
        private Contact contact; 
        private String externalOrderNo; 
        private java.util.List<java.util.List<Guests>> guests; 
        ...
        private Builder(GlobalHotelCreateAndPayRequest request) {
            super(request);
        ...
        @Override
        public GlobalHotelCreateAndPayRequest build() {
            return new GlobalHotelCreateAndPayRequest(this);
        } 
    ...
    /**
     * 
     * {@link GlobalHotelCreateAndPayRequest} extends {@link TeaModel}
     *
     * <p>GlobalHotelCreateAndPayRequest</p>
     */
