...
/**
 * {@link TicketingCheckRequest} extends {@link RequestModel}
 *
 * <p>TicketingCheckRequest</p>
 */
public class TicketingCheckRequest extends Request {
    @Body
    @NameInMap("order_num")
    ...
    private TicketingCheckRequest(Builder builder) {
        super(builder);
    ...
    public static TicketingCheckRequest create() {
    ...
    public static final class Builder extends Request.Builder<TicketingCheckRequest, Builder> {
        private Long orderNum; 
        private String xAcsAirticketAccessToken; 
        private String xAcsAirticketLanguage; 
        ...
        private Builder(TicketingCheckRequest request) {
            super(request);
        ...
        @Override
        public TicketingCheckRequest build() {
            return new TicketingCheckRequest(this);
        } 
