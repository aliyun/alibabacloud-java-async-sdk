...
/**
 * 
 * {@link GlobalHotelQueryAvailabilityResponseBody} extends {@link TeaModel}
 *
 * <p>GlobalHotelQueryAvailabilityResponseBody</p>
 */
public class GlobalHotelQueryAvailabilityResponseBody extends TeaModel {
    ...
    private GlobalHotelQueryAvailabilityResponseBody(Builder builder) {
    ...
    public static GlobalHotelQueryAvailabilityResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GlobalHotelQueryAvailabilityResponseBody model) {
        ...
        public GlobalHotelQueryAvailabilityResponseBody build() {
            return new GlobalHotelQueryAvailabilityResponseBody(this);
        } 
