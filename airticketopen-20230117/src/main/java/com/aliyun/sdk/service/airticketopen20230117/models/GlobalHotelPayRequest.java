...
/**
 * 
 * {@link GlobalHotelPayRequest} extends {@link RequestModel}
 *
 * <p>GlobalHotelPayRequest</p>
 */
public class GlobalHotelPayRequest extends Request {
    ...
    private GlobalHotelPayRequest(Builder builder) {
        super(builder);
    ...
    public static GlobalHotelPayRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GlobalHotelPayRequest, Builder> {
        private Long accountNo; 
        private String orderNo; 
        private String tracerId; 
        ...
        private Builder(GlobalHotelPayRequest request) {
            super(request);
        ...
        @Override
        public GlobalHotelPayRequest build() {
            return new GlobalHotelPayRequest(this);
        } 
