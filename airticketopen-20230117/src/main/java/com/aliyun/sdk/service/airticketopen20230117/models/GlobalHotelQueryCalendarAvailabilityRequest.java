...
/**
 * 
 * {@link GlobalHotelQueryCalendarAvailabilityRequest} extends {@link RequestModel}
 *
 * <p>GlobalHotelQueryCalendarAvailabilityRequest</p>
 */
public class GlobalHotelQueryCalendarAvailabilityRequest extends Request {
    ...
    private GlobalHotelQueryCalendarAvailabilityRequest(Builder builder) {
        super(builder);
    ...
    public static GlobalHotelQueryCalendarAvailabilityRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GlobalHotelQueryCalendarAvailabilityRequest, Builder> {
        private Long accountNo; 
        private Integer adultCount; 
        private String checkInDateEnd; 
        private String checkInDateStart; 
        ...
        private Builder(GlobalHotelQueryCalendarAvailabilityRequest request) {
            super(request);
        ...
        @Override
        public GlobalHotelQueryCalendarAvailabilityRequest build() {
            return new GlobalHotelQueryCalendarAvailabilityRequest(this);
        } 
