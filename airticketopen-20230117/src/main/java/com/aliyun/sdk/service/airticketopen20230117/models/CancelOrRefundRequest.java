...
/**
 * 
 * {@link CancelOrRefundRequest} extends {@link RequestModel}
 *
 * <p>CancelOrRefundRequest</p>
 */
public class CancelOrRefundRequest extends Request {
    ...
    private CancelOrRefundRequest(Builder builder) {
        super(builder);
    ...
    public static CancelOrRefundRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CancelOrRefundRequest, Builder> {
        private Long accountNo; 
        private String orderNo; 
        private String tracerId; 
        ...
        private Builder(CancelOrRefundRequest request) {
            super(request);
        ...
        public CancelOrRefundRequest build() {
            return new CancelOrRefundRequest(this);
        } 
