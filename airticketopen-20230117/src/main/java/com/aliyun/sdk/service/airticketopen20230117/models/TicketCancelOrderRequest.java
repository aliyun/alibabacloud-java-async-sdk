...
/**
 * 
 * {@link TicketCancelOrderRequest} extends {@link RequestModel}
 *
 * <p>TicketCancelOrderRequest</p>
 */
public class TicketCancelOrderRequest extends Request {
    ...
    private TicketCancelOrderRequest(Builder builder) {
        super(builder);
    ...
    public static TicketCancelOrderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<TicketCancelOrderRequest, Builder> {
        private Long accountNo; 
        private String distributorOrderId; 
        ...
        private Builder(TicketCancelOrderRequest request) {
            super(request);
        ...
        @Override
        public TicketCancelOrderRequest build() {
            return new TicketCancelOrderRequest(this);
        } 
