...
public class TicketPageQueryProductResponseBody extends TeaModel {
    ...
    private TicketPageQueryProductResponseBody(Builder builder) {
    ...
    public static TicketPageQueryProductResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(TicketPageQueryProductResponseBody model) {
        ...
        public TicketPageQueryProductResponseBody build() {
            return new TicketPageQueryProductResponseBody(this);
        } 
