...
/**
 * 
 * {@link ValidatePriceResponseBody} extends {@link TeaModel}
 *
 * <p>ValidatePriceResponseBody</p>
 */
public class ValidatePriceResponseBody extends TeaModel {
    ...
    private ValidatePriceResponseBody(Builder builder) {
    ...
    public static ValidatePriceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ValidatePriceResponseBody model) {
        ...
        public ValidatePriceResponseBody build() {
            return new ValidatePriceResponseBody(this);
        } 
