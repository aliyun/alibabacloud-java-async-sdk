...
/**
 * 
 * {@link QueryAvailabilityResponseBody} extends {@link TeaModel}
 *
 * <p>QueryAvailabilityResponseBody</p>
 */
public class QueryAvailabilityResponseBody extends TeaModel {
    ...
    private QueryAvailabilityResponseBody(Builder builder) {
    ...
    public static QueryAvailabilityResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryAvailabilityResponseBody model) {
        ...
        public QueryAvailabilityResponseBody build() {
            return new QueryAvailabilityResponseBody(this);
        } 
