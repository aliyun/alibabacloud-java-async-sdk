...
/**
 * 
 * {@link KnowledgeBaseFileChunk} extends {@link TeaModel}
 *
 * <p>KnowledgeBaseFileChunk</p>
 */
public class KnowledgeBaseFileChunk extends TeaModel {
    ...
    private KnowledgeBaseFileChunk(Builder builder) {
    ...
    public static KnowledgeBaseFileChunk create() {
    ...
    public static final class Builder {
        ...
        private Builder(KnowledgeBaseFileChunk model) {
        ...
        public KnowledgeBaseFileChunk build() {
            return new KnowledgeBaseFileChunk(this);
        } 
