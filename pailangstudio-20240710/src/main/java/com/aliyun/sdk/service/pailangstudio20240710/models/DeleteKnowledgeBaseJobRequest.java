...
/**
 * 
 * {@link DeleteKnowledgeBaseJobRequest} extends {@link RequestModel}
 *
 * <p>DeleteKnowledgeBaseJobRequest</p>
 */
public class DeleteKnowledgeBaseJobRequest extends Request {
    ...
    private DeleteKnowledgeBaseJobRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteKnowledgeBaseJobRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DeleteKnowledgeBaseJobRequest, Builder> {
        private String knowledgeBaseId; 
        private String knowledgeBaseJobId; 
        private String workspaceId; 
        ...
        private Builder(DeleteKnowledgeBaseJobRequest request) {
            super(request);
        ...
        @Override
        public DeleteKnowledgeBaseJobRequest build() {
            return new DeleteKnowledgeBaseJobRequest(this);
        } 
