...
public class RestoreCapacityResponseBody extends TeaModel {
    ...
    private RestoreCapacityResponseBody(Builder builder) {
    ...
    public static RestoreCapacityResponseBody create() {
    ...
    public static final class Builder {
        ...
        public RestoreCapacityResponseBody build() {
            return new RestoreCapacityResponseBody(this);
        } 
