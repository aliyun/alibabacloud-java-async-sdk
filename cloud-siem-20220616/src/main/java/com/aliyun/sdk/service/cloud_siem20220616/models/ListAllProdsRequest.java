...
@Override
    ...
    public static final class Builder extends Request.Builder<ListAllProdsRequest, Builder> {
        ...
        /**
         * <p>The region of the Data Management hub for Threat Analysis. Select the region that corresponds to the location of your assets. Valid values:</p>
         * <ul>
        ...
        /**
         * <p>The user ID of a member. An administrator can specify this parameter to switch to the member\&quot;s view.</p>
         * 
         * <strong>example:</strong>
         * <p>113091674488****</p>
         */
