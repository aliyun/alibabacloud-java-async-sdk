...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribeAutomateResponseConfigCounterRequest, Builder> {
        ...
        /**
         * <p>The region of the Management Hub. Select the region based on the location of your assets. Valid values:</p>
         * <ul>
        ...
        /**
         * <p>The user ID of the member whose view the administrator wants to switch to.</p>
         * 
         * <strong>example:</strong>
         * <p>113091674488****</p>
         */
