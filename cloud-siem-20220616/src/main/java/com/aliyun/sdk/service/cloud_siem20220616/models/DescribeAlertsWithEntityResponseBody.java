...
/**
 * 
 * {@link DescribeAlertsWithEntityResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeAlertsWithEntityResponseBody</p>
 */
public class DescribeAlertsWithEntityResponseBody extends TeaModel {
    ...
    private DescribeAlertsWithEntityResponseBody(Builder builder) {
    ...
    public static DescribeAlertsWithEntityResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeAlertsWithEntityResponseBody model) {
        ...
        public DescribeAlertsWithEntityResponseBody build() {
            return new DescribeAlertsWithEntityResponseBody(this);
        } 
