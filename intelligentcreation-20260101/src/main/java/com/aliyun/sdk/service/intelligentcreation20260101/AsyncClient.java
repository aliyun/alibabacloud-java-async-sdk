...
public interface AsyncClient extends SdkAutoCloseable {
     ...
     */
    CompletableFuture<CheckTuringTaskResponse> checkTuringTask(CheckTuringTaskRequest request);

    /**
     * @param request the request parameters of SubmitTuringTask  SubmitTuringTaskRequest
     * @return SubmitTuringTaskResponse
     */
    CompletableFuture<SubmitTuringTaskResponse> submitTuringTask(SubmitTuringTaskRequest request);
