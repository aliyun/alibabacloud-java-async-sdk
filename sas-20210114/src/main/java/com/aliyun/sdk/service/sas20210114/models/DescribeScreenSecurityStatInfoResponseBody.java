...
/**
 * 
 * {@link DescribeScreenSecurityStatInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScreenSecurityStatInfoResponseBody</p>
 */
public class DescribeScreenSecurityStatInfoResponseBody extends TeaModel {
    ...
    private DescribeScreenSecurityStatInfoResponseBody(Builder builder) {
    ...
    public static DescribeScreenSecurityStatInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeScreenSecurityStatInfoResponseBody model) {
        ...
        public DescribeScreenSecurityStatInfoResponseBody build() {
            return new DescribeScreenSecurityStatInfoResponseBody(this);
        } 
