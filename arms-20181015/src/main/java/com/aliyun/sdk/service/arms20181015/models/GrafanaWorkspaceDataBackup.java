...
public class GrafanaWorkspaceDataBackup extends TeaModel {
    ...
    private GrafanaWorkspaceDataBackup(Builder builder) {
    ...
    public static GrafanaWorkspaceDataBackup create() {
    ...
    public static final class Builder {
        ...
        private Builder(GrafanaWorkspaceDataBackup model) {
        ...
        public GrafanaWorkspaceDataBackup build() {
            return new GrafanaWorkspaceDataBackup(this);
        } 
