...
/**
 * {@link GetPipelineInstanceGroupStatusResponseBody} extends {@link TeaModel}
 *
 * <p>GetPipelineInstanceGroupStatusResponseBody</p>
 */
public class GetPipelineInstanceGroupStatusResponseBody extends TeaModel {
    ...
    private GetPipelineInstanceGroupStatusResponseBody(Builder builder) {
    ...
    public static GetPipelineInstanceGroupStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetPipelineInstanceGroupStatusResponseBody build() {
            return new GetPipelineInstanceGroupStatusResponseBody(this);
        } 
