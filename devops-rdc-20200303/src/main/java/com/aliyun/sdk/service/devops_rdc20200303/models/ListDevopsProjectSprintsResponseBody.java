...
/**
 * {@link ListDevopsProjectSprintsResponseBody} extends {@link TeaModel}
 *
 * <p>ListDevopsProjectSprintsResponseBody</p>
 */
public class ListDevopsProjectSprintsResponseBody extends TeaModel {
    ...
    private ListDevopsProjectSprintsResponseBody(Builder builder) {
    ...
    public static ListDevopsProjectSprintsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListDevopsProjectSprintsResponseBody build() {
            return new ListDevopsProjectSprintsResponseBody(this);
        } 
