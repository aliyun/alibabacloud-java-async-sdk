...
/**
 * {@link GetPipelineInstanceBuildNumberStatusResponseBody} extends {@link TeaModel}
 *
 * <p>GetPipelineInstanceBuildNumberStatusResponseBody</p>
 */
public class GetPipelineInstanceBuildNumberStatusResponseBody extends TeaModel {
    ...
    private GetPipelineInstanceBuildNumberStatusResponseBody(Builder builder) {
    ...
    public static GetPipelineInstanceBuildNumberStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetPipelineInstanceBuildNumberStatusResponseBody build() {
            return new GetPipelineInstanceBuildNumberStatusResponseBody(this);
        } 
