...
/**
 * {@link CreateDevopsProjectSprintResponseBody} extends {@link TeaModel}
 *
 * <p>CreateDevopsProjectSprintResponseBody</p>
 */
public class CreateDevopsProjectSprintResponseBody extends TeaModel {
    ...
    private CreateDevopsProjectSprintResponseBody(Builder builder) {
    ...
    public static CreateDevopsProjectSprintResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateDevopsProjectSprintResponseBody build() {
            return new CreateDevopsProjectSprintResponseBody(this);
        } 
