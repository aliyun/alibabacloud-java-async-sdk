...
/**
 * 
 * {@link DescribeImageInstanceForIsvResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeImageInstanceForIsvResponseBody</p>
 */
public class DescribeImageInstanceForIsvResponseBody extends TeaModel {
    ...
    private DescribeImageInstanceForIsvResponseBody(Builder builder) {
    ...
    public static DescribeImageInstanceForIsvResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeImageInstanceForIsvResponseBody build() {
            return new DescribeImageInstanceForIsvResponseBody(this);
        } 
