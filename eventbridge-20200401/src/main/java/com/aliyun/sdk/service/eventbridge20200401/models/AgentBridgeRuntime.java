...
/**
 * 
 * {@link AgentBridgeRuntime} extends {@link TeaModel}
 *
 * <p>AgentBridgeRuntime</p>
 */
public class AgentBridgeRuntime extends TeaModel {
    ...
    private AgentBridgeRuntime(Builder builder) {
        this.cu = builder.cu;
    ...
    public static AgentBridgeRuntime create() {
    ...
    public static final class Builder {
        ...
        private Builder(AgentBridgeRuntime model) {
            this.cu = model.cu;
        ...
        public AgentBridgeRuntime build() {
            return new AgentBridgeRuntime(this);
        } 
