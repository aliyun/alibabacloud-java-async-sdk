...
/**
 * 
 * {@link UpdateEventSourceRequest} extends {@link RequestModel}
 *
...
public class UpdateEventSourceRequest extends Request {
    ...
    public static UpdateEventSourceRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateEventSourceRequest, Builder> {
        private String description; 
        private String eventBusName; 
        private String eventSourceName; 
        private java.util.Map<String, ?> externalSourceConfig; 
        ...
        private Builder(UpdateEventSourceRequest request) {
            super(request);
        ...
        @Override
        public UpdateEventSourceRequest build() {
            return new UpdateEventSourceRequest(this);
        } 
    ...
    /**
     * 
     * {@link UpdateEventSourceRequest} extends {@link TeaModel}
     *
     * <p>UpdateEventSourceRequest</p>
     */
