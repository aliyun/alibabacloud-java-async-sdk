...
/**
 * 
 * {@link QueryLumaWithSQLResponseBody} extends {@link TeaModel}
 *
 * <p>QueryLumaWithSQLResponseBody</p>
 */
public class QueryLumaWithSQLResponseBody extends TeaModel {
    ...
    private QueryLumaWithSQLResponseBody(Builder builder) {
    ...
    public static QueryLumaWithSQLResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryLumaWithSQLResponseBody model) {
         ...
         */
        public Builder data(ExecutionResult data) {
            this.data = data;
            return this;
        }
        ...
        public QueryLumaWithSQLResponseBody build() {
            return new QueryLumaWithSQLResponseBody(this);
        } 
