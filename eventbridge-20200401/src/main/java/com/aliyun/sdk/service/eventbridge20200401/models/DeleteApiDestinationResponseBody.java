...
/**
 * 
 * {@link DeleteApiDestinationResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteApiDestinationResponseBody</p>
 */
public class DeleteApiDestinationResponseBody extends TeaModel {
    ...
    private DeleteApiDestinationResponseBody(Builder builder) {
    ...
    public static DeleteApiDestinationResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DeleteApiDestinationResponseBody build() {
            return new DeleteApiDestinationResponseBody(this);
        } 
