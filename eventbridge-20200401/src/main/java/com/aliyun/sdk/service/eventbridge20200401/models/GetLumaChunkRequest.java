...
/**
 * 
 * {@link GetLumaChunkRequest} extends {@link RequestModel}
 *
 * <p>GetLumaChunkRequest</p>
 */
public class GetLumaChunkRequest extends Request {
    ...
    private GetLumaChunkRequest(Builder builder) {
        super(builder);
    ...
    public static GetLumaChunkRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetLumaChunkRequest, Builder> {
        private String agentName; 
        private String catalog; 
        private Integer chunkSeq; 
        private String documentId; 
        ...
        private Builder(GetLumaChunkRequest request) {
            super(request);
        ...
        public Builder chunkSeq(Integer chunkSeq) {
            this.putBodyParameter("ChunkSeq", chunkSeq);
        ...
        @Override
        public GetLumaChunkRequest build() {
            return new GetLumaChunkRequest(this);
        } 
