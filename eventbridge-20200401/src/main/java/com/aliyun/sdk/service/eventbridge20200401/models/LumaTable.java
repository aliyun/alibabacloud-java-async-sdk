...
/**
 * 
 * {@link LumaTable} extends {@link TeaModel}
 *
 * <p>LumaTable</p>
 */
public class LumaTable extends TeaModel {
    ...
    private LumaTable(Builder builder) {
    ...
    public static LumaTable create() {
    ...
    public static final class Builder {
        ...
        private Builder(LumaTable model) {
        ...
        public LumaTable build() {
            return new LumaTable(this);
        } 
