...
public class UpdateRuleResponseBody extends TeaModel {
    ...
    private UpdateRuleResponseBody(Builder builder) {
    ...
    public static UpdateRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateRuleResponseBody model) {
        ...
        public UpdateRuleResponseBody build() {
            return new UpdateRuleResponseBody(this);
        } 
