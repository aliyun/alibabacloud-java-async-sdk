...
/**
 * 
 * {@link ListLumaDocumentsResponseBody} extends {@link TeaModel}
 *
 * <p>ListLumaDocumentsResponseBody</p>
 */
public class ListLumaDocumentsResponseBody extends TeaModel {
    ...
    private ListLumaDocumentsResponseBody(Builder builder) {
    ...
    public static ListLumaDocumentsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListLumaDocumentsResponseBody model) {
        ...
        public ListLumaDocumentsResponseBody build() {
            return new ListLumaDocumentsResponseBody(this);
        } 
