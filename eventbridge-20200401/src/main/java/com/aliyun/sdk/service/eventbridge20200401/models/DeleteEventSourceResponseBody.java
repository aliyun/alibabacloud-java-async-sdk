...
/**
 * 
 * {@link DeleteEventSourceResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteEventSourceResponseBody</p>
 */
public class DeleteEventSourceResponseBody extends TeaModel {
    ...
    private DeleteEventSourceResponseBody(Builder builder) {
    ...
    public static DeleteEventSourceResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteEventSourceResponseBody model) {
        ...
        public DeleteEventSourceResponseBody build() {
            return new DeleteEventSourceResponseBody(this);
        } 
