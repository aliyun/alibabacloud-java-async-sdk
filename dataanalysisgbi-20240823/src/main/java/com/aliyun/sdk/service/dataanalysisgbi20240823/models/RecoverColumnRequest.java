...
/**
 * 
 * {@link RecoverColumnRequest} extends {@link RequestModel}
 *
 * <p>RecoverColumnRequest</p>
 */
public class RecoverColumnRequest extends Request {
    ...
    private RecoverColumnRequest(Builder builder) {
        super(builder);
    ...
    public static RecoverColumnRequest create() {
    ...
    public static final class Builder extends Request.Builder<RecoverColumnRequest, Builder> {
        private String regionId; 
        private String columnIdKey; 
        private String tableIdKey; 
        private String workspaceId; 
        ...
        private Builder(RecoverColumnRequest request) {
            super(request);
        ...
        @Override
        public RecoverColumnRequest build() {
            return new RecoverColumnRequest(this);
        } 
