...
/**
 * 
 * {@link ListEnumMappingRequest} extends {@link RequestModel}
 *
 * <p>ListEnumMappingRequest</p>
 */
public class ListEnumMappingRequest extends Request {
    ...
    private ListEnumMappingRequest(Builder builder) {
        super(builder);
    ...
    public static ListEnumMappingRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListEnumMappingRequest, Builder> {
        private String regionId; 
        private String columnIdKey; 
        private String tableIdKey; 
        private String workspaceId; 
        ...
        private Builder(ListEnumMappingRequest request) {
            super(request);
        ...
        @Override
        public ListEnumMappingRequest build() {
            return new ListEnumMappingRequest(this);
        } 
