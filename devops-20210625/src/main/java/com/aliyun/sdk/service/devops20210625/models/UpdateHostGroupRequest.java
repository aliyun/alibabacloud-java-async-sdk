 ...
 */
public class UpdateHostGroupRequest extends Request {
    @Path
    ...
    private UpdateHostGroupRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateHostGroupRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateHostGroupRequest, Builder> {
        private String organizationId; 
        private Long id; 
        private String aliyunRegion; 
        private String ecsLabelKey; 
