...
public class GetReleaseStagePipelineRunResponseBody extends TeaModel {
    ...
    private GetReleaseStagePipelineRunResponseBody(Builder builder) {
    ...
    public static GetReleaseStagePipelineRunResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetReleaseStagePipelineRunResponseBody build() {
            return new GetReleaseStagePipelineRunResponseBody(this);
        } 
