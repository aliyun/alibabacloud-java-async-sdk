...
/**
 * 
 * {@link GetGroupDetailResponseBody} extends {@link TeaModel}
 *
 * <p>GetGroupDetailResponseBody</p>
 */
public class GetGroupDetailResponseBody extends TeaModel {
    ...
    private GetGroupDetailResponseBody(Builder builder) {
    ...
    public static GetGroupDetailResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetGroupDetailResponseBody model) {
        ...
        public GetGroupDetailResponseBody build() {
            return new GetGroupDetailResponseBody(this);
        } 
