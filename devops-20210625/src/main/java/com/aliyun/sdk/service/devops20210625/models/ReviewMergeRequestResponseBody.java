...
public class ReviewMergeRequestResponseBody extends TeaModel {
    ...
    public static ReviewMergeRequestResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReviewMergeRequestResponseBody model) {
        ...
        public ReviewMergeRequestResponseBody build() {
            return new ReviewMergeRequestResponseBody(this);
        } 
