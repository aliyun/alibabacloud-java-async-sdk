...
/**
 * 
 * {@link ListRepositoryTagsResponseBody} extends {@link TeaModel}
 *
 * <p>ListRepositoryTagsResponseBody</p>
 */
public class ListRepositoryTagsResponseBody extends TeaModel {
    ...
    private ListRepositoryTagsResponseBody(Builder builder) {
    ...
    public static ListRepositoryTagsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListRepositoryTagsResponseBody model) {
        ...
        public ListRepositoryTagsResponseBody build() {
            return new ListRepositoryTagsResponseBody(this);
        } 
