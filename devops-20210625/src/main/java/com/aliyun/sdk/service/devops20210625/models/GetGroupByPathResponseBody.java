...
/**
 * 
 * {@link GetGroupByPathResponseBody} extends {@link TeaModel}
 *
 * <p>GetGroupByPathResponseBody</p>
 */
public class GetGroupByPathResponseBody extends TeaModel {
    ...
    private GetGroupByPathResponseBody(Builder builder) {
    ...
    public static GetGroupByPathResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetGroupByPathResponseBody model) {
        ...
        public GetGroupByPathResponseBody build() {
            return new GetGroupByPathResponseBody(this);
        } 
