...
/**
 * {@link GetRepositoryCommitResponseBody} extends {@link TeaModel}
 *
 * <p>GetRepositoryCommitResponseBody</p>
 */
public class GetRepositoryCommitResponseBody extends TeaModel {
    ...
    private GetRepositoryCommitResponseBody(Builder builder) {
    ...
    public static GetRepositoryCommitResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetRepositoryCommitResponseBody build() {
            return new GetRepositoryCommitResponseBody(this);
        } 
