...
public class ListCheckRunsResponseBody extends TeaModel {
    ...
    private ListCheckRunsResponseBody(Builder builder) {
    ...
    public static ListCheckRunsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListCheckRunsResponseBody model) {
        ...
        public ListCheckRunsResponseBody build() {
            return new ListCheckRunsResponseBody(this);
        } 
