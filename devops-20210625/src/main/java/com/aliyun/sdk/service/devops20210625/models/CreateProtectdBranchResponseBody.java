...
/**
 * 
 * {@link CreateProtectdBranchResponseBody} extends {@link TeaModel}
 *
 * <p>CreateProtectdBranchResponseBody</p>
 */
public class CreateProtectdBranchResponseBody extends TeaModel {
    ...
    private CreateProtectdBranchResponseBody(Builder builder) {
    ...
    public static CreateProtectdBranchResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateProtectdBranchResponseBody build() {
            return new CreateProtectdBranchResponseBody(this);
        } 
