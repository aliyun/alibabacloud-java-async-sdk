...
public class CreatePushRuleResponseBody extends TeaModel {
    ...
    public static CreatePushRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreatePushRuleResponseBody model) {
        ...
        public CreatePushRuleResponseBody build() {
            return new CreatePushRuleResponseBody(this);
        } 
