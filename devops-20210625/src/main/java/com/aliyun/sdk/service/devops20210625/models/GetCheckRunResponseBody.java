...
/**
 * 
 * {@link GetCheckRunResponseBody} extends {@link TeaModel}
 *
 * <p>GetCheckRunResponseBody</p>
 */
public class GetCheckRunResponseBody extends TeaModel {
    ...
    private GetCheckRunResponseBody(Builder builder) {
    ...
    public static GetCheckRunResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetCheckRunResponseBody model) {
        ...
        public GetCheckRunResponseBody build() {
            return new GetCheckRunResponseBody(this);
        } 
