...
/**
 * 
 * {@link DescribeFlowAliasResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeFlowAliasResponseBody</p>
 */
public class DescribeFlowAliasResponseBody extends TeaModel {
    ...
    private DescribeFlowAliasResponseBody(Builder builder) {
    ...
    public static DescribeFlowAliasResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeFlowAliasResponseBody model) {
        ...
        public DescribeFlowAliasResponseBody build() {
            return new DescribeFlowAliasResponseBody(this);
        } 
