...
/**
 * 
 * {@link QueryMessageByQueueNameRequest} extends {@link RequestModel}
 *
 * <p>QueryMessageByQueueNameRequest</p>
 */
public class QueryMessageByQueueNameRequest extends Request {
    ...
    private QueryMessageByQueueNameRequest(Builder builder) {
        super(builder);
    ...
    public static QueryMessageByQueueNameRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<QueryMessageByQueueNameRequest, Builder> {
        private String regionId; 
        private Long beginTime; 
        private String consoleSessionId; 
        private Integer currentPage; 
        ...
        private Builder(QueryMessageByQueueNameRequest request) {
            super(request);
        ...
        @Override
        public QueryMessageByQueueNameRequest build() {
            return new QueryMessageByQueueNameRequest(this);
        } 
