...
/**
 * 
 * {@link ListExchangeDownstreamBindingsRequest} extends {@link RequestModel}
 *
 * <p>ListExchangeDownstreamBindingsRequest</p>
 */
public class ListExchangeDownstreamBindingsRequest extends Request {
    ...
    private ListExchangeDownstreamBindingsRequest(Builder builder) {
        super(builder);
    ...
    public static ListExchangeDownstreamBindingsRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListExchangeDownstreamBindingsRequest, Builder> {
        private String regionId; 
        private String consoleSessionId; 
        private Integer currentPage; 
        private String exchangeName; 
        ...
        private Builder(ListExchangeDownstreamBindingsRequest request) {
            super(request);
        ...
        @Override
        public ListExchangeDownstreamBindingsRequest build() {
            return new ListExchangeDownstreamBindingsRequest(this);
        } 
