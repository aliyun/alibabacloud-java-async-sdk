...
/**
 * 
 * {@link BindRequest} extends {@link RequestModel}
 *
 * <p>BindRequest</p>
 */
public class BindRequest extends Request {
    ...
    public static BindRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<BindRequest, Builder> {
        private String regionId; 
        private String argument; 
        private String bindingKey; 
        private Integer bindingType; 
        ...
        private Builder(BindRequest request) {
            super(request);
