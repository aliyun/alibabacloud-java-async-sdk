...
/**
 * 
 * {@link UpdateServerlessSwitchRequest} extends {@link RequestModel}
 *
 * <p>UpdateServerlessSwitchRequest</p>
 */
public class UpdateServerlessSwitchRequest extends Request {
    ...
    private UpdateServerlessSwitchRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateServerlessSwitchRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateServerlessSwitchRequest, Builder> {
        private String regionId; 
        private String consoleSessionId; 
        private String instanceId; 
        private Boolean serverlessSwitch; 
        ...
        private Builder(UpdateServerlessSwitchRequest request) {
            super(request);
        ...
        @Override
        public UpdateServerlessSwitchRequest build() {
            return new UpdateServerlessSwitchRequest(this);
        } 
