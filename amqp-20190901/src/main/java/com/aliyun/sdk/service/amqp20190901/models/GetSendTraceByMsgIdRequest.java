...
/**
 * 
 * {@link GetSendTraceByMsgIdRequest} extends {@link RequestModel}
 *
 * <p>GetSendTraceByMsgIdRequest</p>
 */
public class GetSendTraceByMsgIdRequest extends Request {
    ...
    private GetSendTraceByMsgIdRequest(Builder builder) {
        super(builder);
    ...
    public static GetSendTraceByMsgIdRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetSendTraceByMsgIdRequest, Builder> {
        private String regionId; 
        private String clientToken; 
        private String consoleSessionId; 
        private Integer currentPage; 
        ...
        private Builder(GetSendTraceByMsgIdRequest request) {
            super(request);
        ...
        @Override
        public GetSendTraceByMsgIdRequest build() {
            return new GetSendTraceByMsgIdRequest(this);
        } 
