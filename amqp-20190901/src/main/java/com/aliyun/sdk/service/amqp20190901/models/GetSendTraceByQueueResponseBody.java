...
/**
 * 
 * {@link GetSendTraceByQueueResponseBody} extends {@link TeaModel}
 *
 * <p>GetSendTraceByQueueResponseBody</p>
 */
public class GetSendTraceByQueueResponseBody extends TeaModel {
    ...
    private GetSendTraceByQueueResponseBody(Builder builder) {
    ...
    public static GetSendTraceByQueueResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetSendTraceByQueueResponseBody model) {
        ...
        public GetSendTraceByQueueResponseBody build() {
            return new GetSendTraceByQueueResponseBody(this);
        } 
