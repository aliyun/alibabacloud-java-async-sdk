...
/**
 * 
 * {@link CreateVhostRequest} extends {@link RequestModel}
 *
 * <p>CreateVhostRequest</p>
 */
public class CreateVhostRequest extends Request {
    ...
    private CreateVhostRequest(Builder builder) {
        super(builder);
    ...
    public static CreateVhostRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateVhostRequest, Builder> {
        private String regionId; 
        private String consoleSessionId; 
        private String instanceId; 
        private String vhostName; 
        ...
        private Builder(CreateVhostRequest request) {
            super(request);
        ...
        @Override
        public CreateVhostRequest build() {
            return new CreateVhostRequest(this);
        } 
