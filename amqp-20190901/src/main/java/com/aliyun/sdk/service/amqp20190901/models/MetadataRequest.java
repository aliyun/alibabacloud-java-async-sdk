...
/**
 * 
 * {@link MetadataRequest} extends {@link RequestModel}
 *
 * <p>MetadataRequest</p>
 */
public class MetadataRequest extends Request {
    ...
    private MetadataRequest(Builder builder) {
        super(builder);
...
@Override
    ...
    public static final class Builder extends Request.Builder<MetadataRequest, Builder> {
        private String regionId; 
        private String consoleSessionId; 
        ...
        private Builder(MetadataRequest request) {
            super(request);
