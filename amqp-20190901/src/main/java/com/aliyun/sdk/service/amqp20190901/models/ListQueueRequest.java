...
public class ListQueueRequest extends Request {
    ...
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("QueueNamePrefix")
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListQueueRequest, Builder> {
        ...
        private Builder(ListQueueRequest request) {
            ...
            this.queueNamePrefix = request.queueNamePrefix;
        ...
        public Builder queueNamePrefix(String queueNamePrefix) {
            this.putQueryParameter("QueueNamePrefix", queueNamePrefix);
