...
/**
 * 
 * {@link QueryMessageByMessageIdResponseBody} extends {@link TeaModel}
 *
 * <p>QueryMessageByMessageIdResponseBody</p>
 */
public class QueryMessageByMessageIdResponseBody extends TeaModel {
    ...
    private QueryMessageByMessageIdResponseBody(Builder builder) {
    ...
    public static QueryMessageByMessageIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(QueryMessageByMessageIdResponseBody model) {
        ...
        public QueryMessageByMessageIdResponseBody build() {
            return new QueryMessageByMessageIdResponseBody(this);
        } 
