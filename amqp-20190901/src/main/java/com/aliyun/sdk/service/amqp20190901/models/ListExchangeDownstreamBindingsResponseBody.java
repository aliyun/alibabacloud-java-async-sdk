...
/**
 * 
 * {@link ListExchangeDownstreamBindingsResponseBody} extends {@link TeaModel}
 *
 * <p>ListExchangeDownstreamBindingsResponseBody</p>
 */
public class ListExchangeDownstreamBindingsResponseBody extends TeaModel {
    ...
    private ListExchangeDownstreamBindingsResponseBody(Builder builder) {
    ...
    public static ListExchangeDownstreamBindingsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListExchangeDownstreamBindingsResponseBody model) {
        ...
        public ListExchangeDownstreamBindingsResponseBody build() {
            return new ListExchangeDownstreamBindingsResponseBody(this);
        } 
