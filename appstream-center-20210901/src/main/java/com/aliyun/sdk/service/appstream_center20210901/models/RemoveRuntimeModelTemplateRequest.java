...
/**
 * 
 * {@link RemoveRuntimeModelTemplateRequest} extends {@link RequestModel}
 *
 * <p>RemoveRuntimeModelTemplateRequest</p>
 */
public class RemoveRuntimeModelTemplateRequest extends Request {
    ...
    private RemoveRuntimeModelTemplateRequest(Builder builder) {
        super(builder);
    ...
    public static RemoveRuntimeModelTemplateRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<RemoveRuntimeModelTemplateRequest, Builder> {
        private String modelTemplateId; 
        private java.util.List<String> runtimeIds; 
        private String runtimeType; 
        ...
        private Builder(RemoveRuntimeModelTemplateRequest request) {
            super(request);
        ...
        @Override
        public RemoveRuntimeModelTemplateRequest build() {
            return new RemoveRuntimeModelTemplateRequest(this);
        } 
