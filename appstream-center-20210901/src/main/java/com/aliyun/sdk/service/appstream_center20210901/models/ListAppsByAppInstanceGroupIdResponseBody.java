...
/**
 * 
 * {@link ListAppsByAppInstanceGroupIdResponseBody} extends {@link TeaModel}
 *
 * <p>ListAppsByAppInstanceGroupIdResponseBody</p>
 */
public class ListAppsByAppInstanceGroupIdResponseBody extends TeaModel {
    ...
    private ListAppsByAppInstanceGroupIdResponseBody(Builder builder) {
    ...
    public static ListAppsByAppInstanceGroupIdResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAppsByAppInstanceGroupIdResponseBody model) {
        ...
        public ListAppsByAppInstanceGroupIdResponseBody build() {
            return new ListAppsByAppInstanceGroupIdResponseBody(this);
        } 
