...
/**
 * 
 * {@link GetOSSStatisRequest} extends {@link RequestModel}
 *
 * <p>GetOSSStatisRequest</p>
 */
public class GetOSSStatisRequest extends Request {
    ...
    private GetOSSStatisRequest(Builder builder) {
        super(builder);
    ...
    public static GetOSSStatisRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetOSSStatisRequest, Builder> {
        private String division; 
        private Long endTime; 
        private String endTimeUTC; 
        private String level; 
        ...
        private Builder(GetOSSStatisRequest request) {
            super(request);
        ...
        @Override
        public GetOSSStatisRequest build() {
            return new GetOSSStatisRequest(this);
        } 
