...
/**
 * 
 * {@link DescribeVodPlayerCollectDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeVodPlayerCollectDataResponseBody</p>
 */
public class DescribeVodPlayerCollectDataResponseBody extends TeaModel {
    ...
    private DescribeVodPlayerCollectDataResponseBody(Builder builder) {
    ...
    public static DescribeVodPlayerCollectDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeVodPlayerCollectDataResponseBody model) {
        ...
        public DescribeVodPlayerCollectDataResponseBody build() {
            return new DescribeVodPlayerCollectDataResponseBody(this);
        } 
