...
/**
 * 
 * {@link AssumeOssRoleRequest} extends {@link RequestModel}
 *
 * <p>AssumeOssRoleRequest</p>
 */
public class AssumeOssRoleRequest extends Request {
    ...
    private AssumeOssRoleRequest(Builder builder) {
        super(builder);
    ...
    public static AssumeOssRoleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssumeOssRoleRequest, Builder> {
        private String appVersion; 
        private String authInfo; 
        private Long authTimestamp; 
        private String businessType; 
        ...
        private Builder(AssumeOssRoleRequest request) {
            super(request);
        ...
        @Override
        public AssumeOssRoleRequest build() {
            return new AssumeOssRoleRequest(this);
        } 
