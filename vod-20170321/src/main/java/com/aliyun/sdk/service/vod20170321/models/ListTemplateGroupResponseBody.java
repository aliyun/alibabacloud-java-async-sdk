...
/**
 * 
 * {@link ListTemplateGroupResponseBody} extends {@link TeaModel}
 *
 * <p>ListTemplateGroupResponseBody</p>
 */
public class ListTemplateGroupResponseBody extends TeaModel {
    ...
    private ListTemplateGroupResponseBody(Builder builder) {
    ...
    public static ListTemplateGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListTemplateGroupResponseBody model) {
        ...
        public ListTemplateGroupResponseBody build() {
            return new ListTemplateGroupResponseBody(this);
        } 
