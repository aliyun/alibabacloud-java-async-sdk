...
/**
 * 
 * {@link CancelMediaExportJobsResponseBody} extends {@link TeaModel}
 *
 * <p>CancelMediaExportJobsResponseBody</p>
 */
public class CancelMediaExportJobsResponseBody extends TeaModel {
    ...
    private CancelMediaExportJobsResponseBody(Builder builder) {
    ...
    public static CancelMediaExportJobsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CancelMediaExportJobsResponseBody model) {
        ...
        public CancelMediaExportJobsResponseBody build() {
            return new CancelMediaExportJobsResponseBody(this);
        } 
