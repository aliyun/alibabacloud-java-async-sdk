...
/**
 * 
 * {@link SubmitAIVideoPornRecogJobResponseBody} extends {@link TeaModel}
 *
 * <p>SubmitAIVideoPornRecogJobResponseBody</p>
 */
public class SubmitAIVideoPornRecogJobResponseBody extends TeaModel {
    ...
    private SubmitAIVideoPornRecogJobResponseBody(Builder builder) {
    ...
    public static SubmitAIVideoPornRecogJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SubmitAIVideoPornRecogJobResponseBody model) {
         ...
         * AIVideoPornRecogJob.
         */
        public Builder AIVideoPornRecogJob(AIVideoPornRecogJob AIVideoPornRecogJob) {
        ...
        public SubmitAIVideoPornRecogJobResponseBody build() {
            return new SubmitAIVideoPornRecogJobResponseBody(this);
        } 
