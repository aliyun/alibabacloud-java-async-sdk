...
/**
 * 
 * {@link UpdateWatermarkConsoleResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateWatermarkConsoleResponseBody</p>
 */
public class UpdateWatermarkConsoleResponseBody extends TeaModel {
    ...
    private UpdateWatermarkConsoleResponseBody(Builder builder) {
    ...
    public static UpdateWatermarkConsoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateWatermarkConsoleResponseBody model) {
        ...
        public UpdateWatermarkConsoleResponseBody build() {
            return new UpdateWatermarkConsoleResponseBody(this);
        } 
