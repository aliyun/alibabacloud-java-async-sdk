...
/**
 * 
 * {@link RenewFreeLicenseResponseBody} extends {@link TeaModel}
 *
 * <p>RenewFreeLicenseResponseBody</p>
 */
public class RenewFreeLicenseResponseBody extends TeaModel {
    ...
    private RenewFreeLicenseResponseBody(Builder builder) {
    ...
    public static RenewFreeLicenseResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RenewFreeLicenseResponseBody model) {
        ...
        public RenewFreeLicenseResponseBody build() {
            return new RenewFreeLicenseResponseBody(this);
        } 
