...
/**
 * 
 * {@link DescribeVodDomainRegionDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeVodDomainRegionDataResponseBody</p>
 */
public class DescribeVodDomainRegionDataResponseBody extends TeaModel {
    ...
    private DescribeVodDomainRegionDataResponseBody(Builder builder) {
    ...
    public static DescribeVodDomainRegionDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeVodDomainRegionDataResponseBody model) {
        ...
        public DescribeVodDomainRegionDataResponseBody build() {
            return new DescribeVodDomainRegionDataResponseBody(this);
        } 
