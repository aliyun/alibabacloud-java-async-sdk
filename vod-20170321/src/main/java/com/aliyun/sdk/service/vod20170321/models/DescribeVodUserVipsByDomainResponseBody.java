...
/**
 * 
 * {@link DescribeVodUserVipsByDomainResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeVodUserVipsByDomainResponseBody</p>
 */
public class DescribeVodUserVipsByDomainResponseBody extends TeaModel {
    ...
    private DescribeVodUserVipsByDomainResponseBody(Builder builder) {
    ...
    public static DescribeVodUserVipsByDomainResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeVodUserVipsByDomainResponseBody model) {
        ...
        public DescribeVodUserVipsByDomainResponseBody build() {
            return new DescribeVodUserVipsByDomainResponseBody(this);
        } 
