...
/**
 * 
 * {@link GetOSSFlowStatisRequest} extends {@link RequestModel}
 *
 * <p>GetOSSFlowStatisRequest</p>
 */
public class GetOSSFlowStatisRequest extends Request {
    ...
    private GetOSSFlowStatisRequest(Builder builder) {
        super(builder);
    ...
    public static GetOSSFlowStatisRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetOSSFlowStatisRequest, Builder> {
        private String division; 
        private Long endTime; 
        private String endTimeUTC; 
        private String level; 
        ...
        private Builder(GetOSSFlowStatisRequest request) {
            super(request);
        ...
        @Override
        public GetOSSFlowStatisRequest build() {
            return new GetOSSFlowStatisRequest(this);
        } 
