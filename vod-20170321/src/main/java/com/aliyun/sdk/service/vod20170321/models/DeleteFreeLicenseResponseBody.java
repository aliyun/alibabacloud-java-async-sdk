...
/**
 * 
 * {@link DeleteFreeLicenseResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteFreeLicenseResponseBody</p>
 */
public class DeleteFreeLicenseResponseBody extends TeaModel {
    ...
    private DeleteFreeLicenseResponseBody(Builder builder) {
    ...
    public static DeleteFreeLicenseResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteFreeLicenseResponseBody model) {
        ...
        public DeleteFreeLicenseResponseBody build() {
            return new DeleteFreeLicenseResponseBody(this);
        } 
