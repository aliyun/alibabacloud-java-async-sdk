...
/**
 * 
 * {@link CreateLicenseResponseBody} extends {@link TeaModel}
 *
 * <p>CreateLicenseResponseBody</p>
 */
public class CreateLicenseResponseBody extends TeaModel {
    ...
    private CreateLicenseResponseBody(Builder builder) {
    ...
    public static CreateLicenseResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateLicenseResponseBody model) {
        ...
        public CreateLicenseResponseBody build() {
            return new CreateLicenseResponseBody(this);
        } 
