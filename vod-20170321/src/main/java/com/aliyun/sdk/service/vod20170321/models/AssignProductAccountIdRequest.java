...
/**
 * 
 * {@link AssignProductAccountIdRequest} extends {@link RequestModel}
 *
 * <p>AssignProductAccountIdRequest</p>
 */
public class AssignProductAccountIdRequest extends Request {
    ...
    private AssignProductAccountIdRequest(Builder builder) {
        super(builder);
    ...
    public static AssignProductAccountIdRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssignProductAccountIdRequest, Builder> {
        private String ownerAccount; 
        private String ownerId; 
        private String resourceOwnerAccount; 
        private String resourceOwnerId; 
        ...
        private Builder(AssignProductAccountIdRequest request) {
            super(request);
        ...
        @Override
        public AssignProductAccountIdRequest build() {
            return new AssignProductAccountIdRequest(this);
        } 
