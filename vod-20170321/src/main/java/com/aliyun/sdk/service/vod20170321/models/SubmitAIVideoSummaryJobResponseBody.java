...
/**
 * 
 * {@link SubmitAIVideoSummaryJobResponseBody} extends {@link TeaModel}
 *
 * <p>SubmitAIVideoSummaryJobResponseBody</p>
 */
public class SubmitAIVideoSummaryJobResponseBody extends TeaModel {
    @com.aliyun.core.annotation.NameInMap("AIVideoSummaryJob")
    private AIVideoSummaryJob AIVideoSummaryJob;

    @com.aliyun.core.annotation.NameInMap("RequestId")
    private String requestId;

    private SubmitAIVideoSummaryJobResponseBody(Builder builder) {
    ...
    public static SubmitAIVideoSummaryJobResponseBody create() {
     ...
     */
    public AIVideoSummaryJob getAIVideoSummaryJob() {
    ...
    public static final class Builder {
        ...
        private Builder(SubmitAIVideoSummaryJobResponseBody model) {
         ...
         * AIVideoSummaryJob.
         */
        public Builder AIVideoSummaryJob(AIVideoSummaryJob AIVideoSummaryJob) {
        ...
        public SubmitAIVideoSummaryJobResponseBody build() {
            return new SubmitAIVideoSummaryJobResponseBody(this);
        } 
