...
/**
 * 
 * {@link SetVodDomainStagingConfigResponseBody} extends {@link TeaModel}
 *
 * <p>SetVodDomainStagingConfigResponseBody</p>
 */
public class SetVodDomainStagingConfigResponseBody extends TeaModel {
    ...
    private SetVodDomainStagingConfigResponseBody(Builder builder) {
    ...
    public static SetVodDomainStagingConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SetVodDomainStagingConfigResponseBody model) {
        ...
        public SetVodDomainStagingConfigResponseBody build() {
            return new SetVodDomainStagingConfigResponseBody(this);
        } 
