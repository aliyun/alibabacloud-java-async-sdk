...
/**
 * 
 * {@link ModifyLicenseInfoResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyLicenseInfoResponseBody</p>
 */
public class ModifyLicenseInfoResponseBody extends TeaModel {
    ...
    private ModifyLicenseInfoResponseBody(Builder builder) {
    ...
    public static ModifyLicenseInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyLicenseInfoResponseBody model) {
        ...
        public ModifyLicenseInfoResponseBody build() {
            return new ModifyLicenseInfoResponseBody(this);
        } 
