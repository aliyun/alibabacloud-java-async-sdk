...
/**
 * 
 * {@link ListVodTagResourcesResponseBody} extends {@link TeaModel}
 *
 * <p>ListVodTagResourcesResponseBody</p>
 */
public class ListVodTagResourcesResponseBody extends TeaModel {
    ...
    private ListVodTagResourcesResponseBody(Builder builder) {
    ...
    public static ListVodTagResourcesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListVodTagResourcesResponseBody model) {
        ...
        public ListVodTagResourcesResponseBody build() {
            return new ListVodTagResourcesResponseBody(this);
        } 
