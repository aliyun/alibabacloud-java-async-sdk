...
/**
 * 
 * {@link AssumeSlsRoleRequest} extends {@link RequestModel}
 *
 * <p>AssumeSlsRoleRequest</p>
 */
public class AssumeSlsRoleRequest extends Request {
    ...
    private AssumeSlsRoleRequest(Builder builder) {
        super(builder);
    ...
    public static AssumeSlsRoleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AssumeSlsRoleRequest, Builder> {
        private String appVersion; 
        private String authInfo; 
        private Long authTimestamp; 
        private String businessType; 
        ...
        private Builder(AssumeSlsRoleRequest request) {
            super(request);
        ...
        @Override
        public AssumeSlsRoleRequest build() {
            return new AssumeSlsRoleRequest(this);
        } 
