...
/**
 * 
 * {@link UpdateWatermarkConsoleRequest} extends {@link RequestModel}
 *
 * <p>UpdateWatermarkConsoleRequest</p>
 */
public class UpdateWatermarkConsoleRequest extends Request {
    ...
    private UpdateWatermarkConsoleRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateWatermarkConsoleRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateWatermarkConsoleRequest, Builder> {
        private String bucket; 
        private String fileName; 
        private String height; 
        private String horizontalOffet; 
        ...
        private Builder(UpdateWatermarkConsoleRequest request) {
            super(request);
        ...
        @Override
        public UpdateWatermarkConsoleRequest build() {
            return new UpdateWatermarkConsoleRequest(this);
        } 
