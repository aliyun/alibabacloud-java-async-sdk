 ...
 */
public class DescribeVodDomainRealTimeBpsDataRequest extends Request {
    ...
    private DescribeVodDomainRealTimeBpsDataRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeVodDomainRealTimeBpsDataRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeVodDomainRealTimeBpsDataRequest, Builder> {
        private String domainName; 
        private String endTime; 
        private String ispNameEn; 
        private String locationNameEn; 
        ...
        private Builder(DescribeVodDomainRealTimeBpsDataRequest request) {
            super(request);
        ...
        @Override
        public DescribeVodDomainRealTimeBpsDataRequest build() {
            return new DescribeVodDomainRealTimeBpsDataRequest(this);
        } 
