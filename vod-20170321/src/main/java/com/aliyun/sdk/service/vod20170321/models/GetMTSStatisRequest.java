...
/**
 * 
 * {@link GetMTSStatisRequest} extends {@link RequestModel}
 *
 * <p>GetMTSStatisRequest</p>
 */
public class GetMTSStatisRequest extends Request {
    ...
    private GetMTSStatisRequest(Builder builder) {
        super(builder);
    ...
    public static GetMTSStatisRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetMTSStatisRequest, Builder> {
        private String division; 
        private Long endTime; 
        private String endTimeUTC; 
        private String level; 
        ...
        private Builder(GetMTSStatisRequest request) {
            super(request);
        ...
        @Override
        public GetMTSStatisRequest build() {
            return new GetMTSStatisRequest(this);
        } 
