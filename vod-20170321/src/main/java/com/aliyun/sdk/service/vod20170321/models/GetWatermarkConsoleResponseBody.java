...
/**
 * 
 * {@link GetWatermarkConsoleResponseBody} extends {@link TeaModel}
 *
 * <p>GetWatermarkConsoleResponseBody</p>
 */
public class GetWatermarkConsoleResponseBody extends TeaModel {
    ...
    private GetWatermarkConsoleResponseBody(Builder builder) {
    ...
    public static GetWatermarkConsoleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetWatermarkConsoleResponseBody model) {
        ...
        public GetWatermarkConsoleResponseBody build() {
            return new GetWatermarkConsoleResponseBody(this);
        } 
