...
/**
 * 
 * {@link SubmitAIVideoCategoryJobResponseBody} extends {@link TeaModel}
 *
 * <p>SubmitAIVideoCategoryJobResponseBody</p>
 */
public class SubmitAIVideoCategoryJobResponseBody extends TeaModel {
    ...
    private SubmitAIVideoCategoryJobResponseBody(Builder builder) {
    ...
    public static SubmitAIVideoCategoryJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SubmitAIVideoCategoryJobResponseBody model) {
         ...
         * AIVideoCategoryJob.
         */
        public Builder AIVideoCategoryJob(AIVideoCategoryJob AIVideoCategoryJob) {
        ...
        public SubmitAIVideoCategoryJobResponseBody build() {
            return new SubmitAIVideoCategoryJobResponseBody(this);
        } 
