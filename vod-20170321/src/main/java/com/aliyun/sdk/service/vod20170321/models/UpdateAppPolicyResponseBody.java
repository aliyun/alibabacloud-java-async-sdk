...
/**
 * 
 * {@link UpdateAppPolicyResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateAppPolicyResponseBody</p>
 */
public class UpdateAppPolicyResponseBody extends TeaModel {
    ...
    private UpdateAppPolicyResponseBody(Builder builder) {
    ...
    public static UpdateAppPolicyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateAppPolicyResponseBody model) {
        ...
        public UpdateAppPolicyResponseBody build() {
            return new UpdateAppPolicyResponseBody(this);
        } 
