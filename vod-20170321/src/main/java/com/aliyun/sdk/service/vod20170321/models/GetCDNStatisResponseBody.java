...
/**
 * 
 * {@link GetCDNStatisResponseBody} extends {@link TeaModel}
 *
 * <p>GetCDNStatisResponseBody</p>
 */
public class GetCDNStatisResponseBody extends TeaModel {
    ...
    private GetCDNStatisResponseBody(Builder builder) {
    ...
    public static GetCDNStatisResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetCDNStatisResponseBody model) {
        ...
        public GetCDNStatisResponseBody build() {
            return new GetCDNStatisResponseBody(this);
        } 
