...
/**
 * 
 * {@link ModifyLicenseInfoRequest} extends {@link RequestModel}
 *
 * <p>ModifyLicenseInfoRequest</p>
 */
public class ModifyLicenseInfoRequest extends Request {
    ...
    private ModifyLicenseInfoRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyLicenseInfoRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyLicenseInfoRequest, Builder> {
        private Long accountId; 
        private String beginTime; 
        private String businessType; 
        private String contractNo; 
        ...
        private Builder(ModifyLicenseInfoRequest request) {
            super(request);
        ...
        @Override
        public ModifyLicenseInfoRequest build() {
            return new ModifyLicenseInfoRequest(this);
        } 
