...
/**
 * 
 * {@link DescribeFileIdPlayStatisByEdgeResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeFileIdPlayStatisByEdgeResponseBody</p>
 */
public class DescribeFileIdPlayStatisByEdgeResponseBody extends TeaModel {
    ...
    private DescribeFileIdPlayStatisByEdgeResponseBody(Builder builder) {
    ...
    public static DescribeFileIdPlayStatisByEdgeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeFileIdPlayStatisByEdgeResponseBody model) {
        ...
        public DescribeFileIdPlayStatisByEdgeResponseBody build() {
            return new DescribeFileIdPlayStatisByEdgeResponseBody(this);
        } 
