...
/**
 * 
 * {@link GetCheckChannelResponseBody} extends {@link TeaModel}
 *
 * <p>GetCheckChannelResponseBody</p>
 */
public class GetCheckChannelResponseBody extends TeaModel {
    ...
    private GetCheckChannelResponseBody(Builder builder) {
    ...
    public static GetCheckChannelResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetCheckChannelResponseBody model) {
        ...
        public GetCheckChannelResponseBody build() {
            return new GetCheckChannelResponseBody(this);
        } 
