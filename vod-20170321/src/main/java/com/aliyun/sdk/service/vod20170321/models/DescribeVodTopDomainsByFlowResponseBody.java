...
/**
 * 
 * {@link DescribeVodTopDomainsByFlowResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeVodTopDomainsByFlowResponseBody</p>
 */
public class DescribeVodTopDomainsByFlowResponseBody extends TeaModel {
    ...
    private DescribeVodTopDomainsByFlowResponseBody(Builder builder) {
    ...
    public static DescribeVodTopDomainsByFlowResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DescribeVodTopDomainsByFlowResponseBody model) {
        ...
        public DescribeVodTopDomainsByFlowResponseBody build() {
            return new DescribeVodTopDomainsByFlowResponseBody(this);
        } 
