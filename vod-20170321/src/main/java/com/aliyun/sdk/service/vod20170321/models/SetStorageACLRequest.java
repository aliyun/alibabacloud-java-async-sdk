...
/**
 * 
 * {@link SetStorageACLRequest} extends {@link RequestModel}
 *
 * <p>SetStorageACLRequest</p>
 */
public class SetStorageACLRequest extends Request {
    ...
    private SetStorageACLRequest(Builder builder) {
        super(builder);
    ...
    public static SetStorageACLRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SetStorageACLRequest, Builder> {
        private String ownerAccount; 
        private String ownerId; 
        private String resourceOwnerAccount; 
        private String resourceOwnerId; 
        ...
        private Builder(SetStorageACLRequest request) {
            super(request);
            ...
            this.storageACL = request.storageACL;
        ...
        public Builder storageACL(String storageACL) {
            this.putQueryParameter("StorageACL", storageACL);
        ...
        @Override
        public SetStorageACLRequest build() {
            return new SetStorageACLRequest(this);
        } 
