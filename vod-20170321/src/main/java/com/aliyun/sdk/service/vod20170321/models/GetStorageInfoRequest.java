...
/**
 * 
 * {@link GetStorageInfoRequest} extends {@link RequestModel}
 *
 * <p>GetStorageInfoRequest</p>
 */
public class GetStorageInfoRequest extends Request {
    ...
    private GetStorageInfoRequest(Builder builder) {
        super(builder);
    ...
    public static GetStorageInfoRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GetStorageInfoRequest, Builder> {
        private String ownerAccount; 
        private String ownerId; 
        private String resourceOwnerAccount; 
        private String resourceOwnerId; 
        ...
        private Builder(GetStorageInfoRequest request) {
            super(request);
        ...
        @Override
        public GetStorageInfoRequest build() {
