...
/**
 * {@link IgnoreEventsRequest} extends {@link RequestModel}
 *
 * <p>IgnoreEventsRequest</p>
 */
public class IgnoreEventsRequest extends Request {
    @Host
    @NameInMap("RegionId")
    ...
    private IgnoreEventsRequest(Builder builder) {
        super(builder);
    ...
    public static IgnoreEventsRequest create() {
    ...
    public static final class Builder extends Request.Builder<IgnoreEventsRequest, Builder> {
        private String regionId; 
        private String eventUuids; 
        private Integer handleStyle; 
        ...
        private Builder(IgnoreEventsRequest request) {
            super(request);
        ...
        @Override
        public IgnoreEventsRequest build() {
            return new IgnoreEventsRequest(this);
        } 
