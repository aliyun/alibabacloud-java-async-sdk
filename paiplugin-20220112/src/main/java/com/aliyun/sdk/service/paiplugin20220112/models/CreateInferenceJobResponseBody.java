...
/**
 * {@link CreateInferenceJobResponseBody} extends {@link TeaModel}
 *
 * <p>CreateInferenceJobResponseBody</p>
 */
public class CreateInferenceJobResponseBody extends TeaModel {
    ...
    private CreateInferenceJobResponseBody(Builder builder) {
    ...
    public static CreateInferenceJobResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CreateInferenceJobResponseBody build() {
            return new CreateInferenceJobResponseBody(this);
        } 
