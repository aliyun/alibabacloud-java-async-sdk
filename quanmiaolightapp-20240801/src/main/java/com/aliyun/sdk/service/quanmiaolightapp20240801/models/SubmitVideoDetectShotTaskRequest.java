...
/**
 * 
 * {@link SubmitVideoDetectShotTaskRequest} extends {@link RequestModel}
 *
 * <p>SubmitVideoDetectShotTaskRequest</p>
 */
public class SubmitVideoDetectShotTaskRequest extends Request {
    ...
    private SubmitVideoDetectShotTaskRequest(Builder builder) {
        super(builder);
    ...
    public static SubmitVideoDetectShotTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<SubmitVideoDetectShotTaskRequest, Builder> {
        private String regionId; 
        private String workspaceId; 
        private String deduplicationId; 
        private String intelliSimpPrompt; 
        ...
        private Builder(SubmitVideoDetectShotTaskRequest request) {
            super(request);
        ...
        @Override
        public SubmitVideoDetectShotTaskRequest build() {
            return new SubmitVideoDetectShotTaskRequest(this);
        } 
