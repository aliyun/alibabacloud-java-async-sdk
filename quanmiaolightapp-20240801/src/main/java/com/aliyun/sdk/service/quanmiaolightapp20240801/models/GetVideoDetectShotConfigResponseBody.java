...
/**
 * 
 * {@link GetVideoDetectShotConfigResponseBody} extends {@link TeaModel}
 *
 * <p>GetVideoDetectShotConfigResponseBody</p>
 */
public class GetVideoDetectShotConfigResponseBody extends TeaModel {
    ...
    private GetVideoDetectShotConfigResponseBody(Builder builder) {
    ...
    public static GetVideoDetectShotConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetVideoDetectShotConfigResponseBody model) {
        ...
        public GetVideoDetectShotConfigResponseBody build() {
            return new GetVideoDetectShotConfigResponseBody(this);
        } 
