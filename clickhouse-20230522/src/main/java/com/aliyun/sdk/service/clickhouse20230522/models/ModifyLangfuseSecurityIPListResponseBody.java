...
/**
 * 
 * {@link ModifyLangfuseSecurityIPListResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyLangfuseSecurityIPListResponseBody</p>
 */
public class ModifyLangfuseSecurityIPListResponseBody extends TeaModel {
    ...
    private ModifyLangfuseSecurityIPListResponseBody(Builder builder) {
    ...
    public static ModifyLangfuseSecurityIPListResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ModifyLangfuseSecurityIPListResponseBody model) {
        ...
        public ModifyLangfuseSecurityIPListResponseBody build() {
            return new ModifyLangfuseSecurityIPListResponseBody(this);
        } 
