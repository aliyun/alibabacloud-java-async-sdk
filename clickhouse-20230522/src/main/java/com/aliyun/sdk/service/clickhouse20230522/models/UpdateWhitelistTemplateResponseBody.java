...
/**
 * 
 * {@link UpdateWhitelistTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateWhitelistTemplateResponseBody</p>
 */
public class UpdateWhitelistTemplateResponseBody extends TeaModel {
    ...
    private UpdateWhitelistTemplateResponseBody(Builder builder) {
    ...
    public static UpdateWhitelistTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateWhitelistTemplateResponseBody model) {
        ...
        public UpdateWhitelistTemplateResponseBody build() {
            return new UpdateWhitelistTemplateResponseBody(this);
        } 
