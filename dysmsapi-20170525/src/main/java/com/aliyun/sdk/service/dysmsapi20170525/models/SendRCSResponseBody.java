...
/**
 * 
 * {@link SendRCSResponseBody} extends {@link TeaModel}
 *
 * <p>SendRCSResponseBody</p>
 */
public class SendRCSResponseBody extends TeaModel {
    ...
    private SendRCSResponseBody(Builder builder) {
    ...
    public static SendRCSResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SendRCSResponseBody model) {
        ...
        public SendRCSResponseBody build() {
            return new SendRCSResponseBody(this);
        } 
