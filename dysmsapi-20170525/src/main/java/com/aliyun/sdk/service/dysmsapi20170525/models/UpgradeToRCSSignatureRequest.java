...
/**
 * 
 * {@link UpgradeToRCSSignatureRequest} extends {@link RequestModel}
 *
 * <p>UpgradeToRCSSignatureRequest</p>
 */
public class UpgradeToRCSSignatureRequest extends Request {
    ...
    private UpgradeToRCSSignatureRequest(Builder builder) {
        super(builder);
    ...
    public static UpgradeToRCSSignatureRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpgradeToRCSSignatureRequest, Builder> {
        private String backgroundImage; 
        private String bubbleColor; 
        private Long category; 
        private String description; 
        ...
        private Builder(UpgradeToRCSSignatureRequest request) {
            super(request);
        ...
        @Override
        public UpgradeToRCSSignatureRequest build() {
            return new UpgradeToRCSSignatureRequest(this);
        } 
