...
/**
 * {@link DescribeScdnCertificateListResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnCertificateListResponseBody</p>
 */
public class DescribeScdnCertificateListResponseBody extends TeaModel {
    ...
    private DescribeScdnCertificateListResponseBody(Builder builder) {
    ...
    public static DescribeScdnCertificateListResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnCertificateListResponseBody build() {
            return new DescribeScdnCertificateListResponseBody(this);
        } 
