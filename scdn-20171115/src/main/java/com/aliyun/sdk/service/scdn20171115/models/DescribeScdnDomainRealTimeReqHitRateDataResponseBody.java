...
/**
 * {@link DescribeScdnDomainRealTimeReqHitRateDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainRealTimeReqHitRateDataResponseBody</p>
 */
public class DescribeScdnDomainRealTimeReqHitRateDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainRealTimeReqHitRateDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainRealTimeReqHitRateDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainRealTimeReqHitRateDataResponseBody build() {
            return new DescribeScdnDomainRealTimeReqHitRateDataResponseBody(this);
        } 
