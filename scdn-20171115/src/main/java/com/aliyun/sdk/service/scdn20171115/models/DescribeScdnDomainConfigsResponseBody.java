...
/**
 * {@link DescribeScdnDomainConfigsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainConfigsResponseBody</p>
 */
public class DescribeScdnDomainConfigsResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainConfigsResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainConfigsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainConfigsResponseBody build() {
            return new DescribeScdnDomainConfigsResponseBody(this);
        } 
