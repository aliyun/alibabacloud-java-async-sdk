...
/**
 * {@link DescribeScdnDomainRealTimeHttpCodeDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainRealTimeHttpCodeDataResponseBody</p>
 */
public class DescribeScdnDomainRealTimeHttpCodeDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainRealTimeHttpCodeDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainRealTimeHttpCodeDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainRealTimeHttpCodeDataResponseBody build() {
            return new DescribeScdnDomainRealTimeHttpCodeDataResponseBody(this);
        } 
