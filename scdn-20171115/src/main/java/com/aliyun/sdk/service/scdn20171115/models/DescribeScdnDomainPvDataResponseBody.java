...
/**
 * {@link DescribeScdnDomainPvDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainPvDataResponseBody</p>
 */
public class DescribeScdnDomainPvDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainPvDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainPvDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainPvDataResponseBody build() {
            return new DescribeScdnDomainPvDataResponseBody(this);
        } 
