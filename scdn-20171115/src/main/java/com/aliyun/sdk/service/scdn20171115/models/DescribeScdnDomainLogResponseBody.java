...
/**
 * {@link DescribeScdnDomainLogResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainLogResponseBody</p>
 */
public class DescribeScdnDomainLogResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainLogResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainLogResponseBody build() {
            return new DescribeScdnDomainLogResponseBody(this);
        } 
