...
/**
 * {@link DescribeScdnDomainRealTimeQpsDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainRealTimeQpsDataResponseBody</p>
 */
public class DescribeScdnDomainRealTimeQpsDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainRealTimeQpsDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainRealTimeQpsDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainRealTimeQpsDataResponseBody build() {
            return new DescribeScdnDomainRealTimeQpsDataResponseBody(this);
        } 
