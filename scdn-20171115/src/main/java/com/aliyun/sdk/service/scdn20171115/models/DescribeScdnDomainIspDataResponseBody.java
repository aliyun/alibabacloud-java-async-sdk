...
/**
 * {@link DescribeScdnDomainIspDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainIspDataResponseBody</p>
 */
public class DescribeScdnDomainIspDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainIspDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainIspDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainIspDataResponseBody build() {
            return new DescribeScdnDomainIspDataResponseBody(this);
        } 
