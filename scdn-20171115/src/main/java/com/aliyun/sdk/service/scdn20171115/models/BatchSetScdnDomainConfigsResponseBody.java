...
/**
 * {@link BatchSetScdnDomainConfigsResponseBody} extends {@link TeaModel}
 *
 * <p>BatchSetScdnDomainConfigsResponseBody</p>
 */
public class BatchSetScdnDomainConfigsResponseBody extends TeaModel {
    ...
    private BatchSetScdnDomainConfigsResponseBody(Builder builder) {
    ...
    public static BatchSetScdnDomainConfigsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public BatchSetScdnDomainConfigsResponseBody build() {
            return new BatchSetScdnDomainConfigsResponseBody(this);
        } 
