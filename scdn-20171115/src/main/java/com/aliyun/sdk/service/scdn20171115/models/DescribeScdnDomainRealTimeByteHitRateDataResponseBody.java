...
/**
 * {@link DescribeScdnDomainRealTimeByteHitRateDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainRealTimeByteHitRateDataResponseBody</p>
 */
public class DescribeScdnDomainRealTimeByteHitRateDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainRealTimeByteHitRateDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainRealTimeByteHitRateDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainRealTimeByteHitRateDataResponseBody build() {
            return new DescribeScdnDomainRealTimeByteHitRateDataResponseBody(this);
        } 
