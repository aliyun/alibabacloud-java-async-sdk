...
/**
 * {@link DescribeScdnDomainRealTimeTrafficDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainRealTimeTrafficDataResponseBody</p>
 */
public class DescribeScdnDomainRealTimeTrafficDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainRealTimeTrafficDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainRealTimeTrafficDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainRealTimeTrafficDataResponseBody build() {
            return new DescribeScdnDomainRealTimeTrafficDataResponseBody(this);
        } 
