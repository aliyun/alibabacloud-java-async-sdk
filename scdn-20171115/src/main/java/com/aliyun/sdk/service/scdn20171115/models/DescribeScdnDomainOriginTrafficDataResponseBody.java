...
/**
 * {@link DescribeScdnDomainOriginTrafficDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainOriginTrafficDataResponseBody</p>
 */
public class DescribeScdnDomainOriginTrafficDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainOriginTrafficDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainOriginTrafficDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainOriginTrafficDataResponseBody build() {
            return new DescribeScdnDomainOriginTrafficDataResponseBody(this);
        } 
