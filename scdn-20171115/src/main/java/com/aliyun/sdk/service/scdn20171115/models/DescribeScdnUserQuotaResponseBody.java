...
/**
 * {@link DescribeScdnUserQuotaResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnUserQuotaResponseBody</p>
 */
public class DescribeScdnUserQuotaResponseBody extends TeaModel {
    ...
    private DescribeScdnUserQuotaResponseBody(Builder builder) {
    ...
    public static DescribeScdnUserQuotaResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnUserQuotaResponseBody build() {
            return new DescribeScdnUserQuotaResponseBody(this);
        } 
