...
/**
 * {@link DescribeScdnUserDomainsResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnUserDomainsResponseBody</p>
 */
public class DescribeScdnUserDomainsResponseBody extends TeaModel {
    ...
    private DescribeScdnUserDomainsResponseBody(Builder builder) {
    ...
    public static DescribeScdnUserDomainsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnUserDomainsResponseBody build() {
            return new DescribeScdnUserDomainsResponseBody(this);
        } 
