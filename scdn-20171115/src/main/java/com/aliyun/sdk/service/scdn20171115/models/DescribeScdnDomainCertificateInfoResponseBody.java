...
/**
 * {@link DescribeScdnDomainCertificateInfoResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainCertificateInfoResponseBody</p>
 */
public class DescribeScdnDomainCertificateInfoResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainCertificateInfoResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainCertificateInfoResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainCertificateInfoResponseBody build() {
            return new DescribeScdnDomainCertificateInfoResponseBody(this);
        } 
