...
/**
 * {@link DescribeScdnDomainUvDataResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeScdnDomainUvDataResponseBody</p>
 */
public class DescribeScdnDomainUvDataResponseBody extends TeaModel {
    ...
    private DescribeScdnDomainUvDataResponseBody(Builder builder) {
    ...
    public static DescribeScdnDomainUvDataResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeScdnDomainUvDataResponseBody build() {
            return new DescribeScdnDomainUvDataResponseBody(this);
        } 
