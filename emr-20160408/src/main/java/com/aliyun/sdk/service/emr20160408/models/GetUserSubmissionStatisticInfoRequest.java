...
/**
 * {@link GetUserSubmissionStatisticInfoRequest} extends {@link RequestModel}
 *
 * <p>GetUserSubmissionStatisticInfoRequest</p>
 */
public class GetUserSubmissionStatisticInfoRequest extends Request {
    @Query
    ...
    private GetUserSubmissionStatisticInfoRequest(Builder builder) {
        super(builder);
    ...
    public static GetUserSubmissionStatisticInfoRequest create() {
    ...
    public static final class Builder extends Request.Builder<GetUserSubmissionStatisticInfoRequest, Builder> {
        private String applicationType; 
        private String clusterId; 
        private String finalStatus; 
        private String fromDatetime; 
        ...
        private Builder(GetUserSubmissionStatisticInfoRequest response) {
            super(response);
        ...
        @Override
        public GetUserSubmissionStatisticInfoRequest build() {
            return new GetUserSubmissionStatisticInfoRequest(this);
        } 
