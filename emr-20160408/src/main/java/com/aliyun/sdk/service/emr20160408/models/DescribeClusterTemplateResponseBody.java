...
/**
 * {@link DescribeClusterTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeClusterTemplateResponseBody</p>
 */
public class DescribeClusterTemplateResponseBody extends TeaModel {
    ...
    private DescribeClusterTemplateResponseBody(Builder builder) {
    ...
    public static DescribeClusterTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeClusterTemplateResponseBody build() {
            return new DescribeClusterTemplateResponseBody(this);
        } 
