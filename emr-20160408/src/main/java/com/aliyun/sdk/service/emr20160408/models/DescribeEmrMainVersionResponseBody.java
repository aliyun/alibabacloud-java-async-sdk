...
/**
 * {@link DescribeEmrMainVersionResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeEmrMainVersionResponseBody</p>
 */
public class DescribeEmrMainVersionResponseBody extends TeaModel {
    ...
    private DescribeEmrMainVersionResponseBody(Builder builder) {
    ...
    public static DescribeEmrMainVersionResponseBody create() {
    ...
    public static final class Builder {
         ...
         * EmrMainVersion.
         */
        public Builder emrMainVersion(EmrMainVersion emrMainVersion) {
        ...
        public DescribeEmrMainVersionResponseBody build() {
            return new DescribeEmrMainVersionResponseBody(this);
        } 
    ...
    public static class WhiteUserList extends TeaModel {
        ...
        private java.util.List < String > wwhiteUser;

        private WhiteUserList(Builder builder) {
            this.wwhiteUser = builder.wwhiteUser;
        }
         ...
         * @return wwhiteUser
         */
        public java.util.List < String > getWwhiteUser() {
            return this.wwhiteUser;
        }
        ...
        public static final class Builder {
             ...
             * WwhiteUser.
             */
            public Builder wwhiteUser(java.util.List < String > wwhiteUser) {
                this.wwhiteUser = wwhiteUser;
                return this;
            }
