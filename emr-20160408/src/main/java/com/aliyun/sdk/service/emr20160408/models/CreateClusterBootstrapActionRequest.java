...
/**
 * {@link CreateClusterBootstrapActionRequest} extends {@link RequestModel}
 *
 * <p>CreateClusterBootstrapActionRequest</p>
 */
public class CreateClusterBootstrapActionRequest extends Request {
    @Query
    ...
    private CreateClusterBootstrapActionRequest(Builder builder) {
        super(builder);
    ...
    public static CreateClusterBootstrapActionRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateClusterBootstrapActionRequest, Builder> {
        private java.util.List < BootstrapAction> bootstrapAction; 
        private String clusterId; 
        private String regionId; 
        private Long resourceOwnerId; 
        ...
        private Builder(CreateClusterBootstrapActionRequest response) {
            super(response);
        ...
        @Override
        public CreateClusterBootstrapActionRequest build() {
            return new CreateClusterBootstrapActionRequest(this);
        } 
