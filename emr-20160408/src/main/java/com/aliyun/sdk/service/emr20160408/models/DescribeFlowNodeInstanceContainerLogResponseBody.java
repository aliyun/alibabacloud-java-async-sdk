...
/**
 * {@link DescribeFlowNodeInstanceContainerLogResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeFlowNodeInstanceContainerLogResponseBody</p>
 */
public class DescribeFlowNodeInstanceContainerLogResponseBody extends TeaModel {
    ...
    private DescribeFlowNodeInstanceContainerLogResponseBody(Builder builder) {
    ...
    public static DescribeFlowNodeInstanceContainerLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeFlowNodeInstanceContainerLogResponseBody build() {
            return new DescribeFlowNodeInstanceContainerLogResponseBody(this);
        } 
