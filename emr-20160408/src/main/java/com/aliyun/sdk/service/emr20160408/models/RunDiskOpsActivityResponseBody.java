...
/**
 * {@link RunDiskOpsActivityResponseBody} extends {@link TeaModel}
 *
 * <p>RunDiskOpsActivityResponseBody</p>
 */
public class RunDiskOpsActivityResponseBody extends TeaModel {
    ...
    private RunDiskOpsActivityResponseBody(Builder builder) {
    ...
    public static RunDiskOpsActivityResponseBody create() {
    ...
    public static final class Builder {
        ...
        public RunDiskOpsActivityResponseBody build() {
            return new RunDiskOpsActivityResponseBody(this);
        } 
