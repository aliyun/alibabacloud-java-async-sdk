...
/**
 * {@link ListLibraryStatusRequest} extends {@link RequestModel}
 *
 * <p>ListLibraryStatusRequest</p>
 */
public class ListLibraryStatusRequest extends Request {
    @Query
    ...
    private ListLibraryStatusRequest(Builder builder) {
        super(builder);
    ...
    public static ListLibraryStatusRequest create() {
    ...
    public static final class Builder extends Request.Builder<ListLibraryStatusRequest, Builder> {
        private String clusterBizId; 
        private Integer currentSize; 
        private String libraryBizId; 
        private Integer limit; 
        ...
        private Builder(ListLibraryStatusRequest response) {
            super(response);
        ...
        @Override
        public ListLibraryStatusRequest build() {
            return new ListLibraryStatusRequest(this);
        } 
