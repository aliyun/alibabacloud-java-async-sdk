...
/**
 * {@link ModifyResourceQueueRequest} extends {@link RequestModel}
 *
 * <p>ModifyResourceQueueRequest</p>
 */
public class ModifyResourceQueueRequest extends Request {
    @Query
    @NameInMap("ClusterId")
    ...
    private ModifyResourceQueueRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyResourceQueueRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyResourceQueueRequest, Builder> {
        private String clusterId; 
        private java.util.List < Config> config; 
        private String id; 
        private Boolean leaf; 
        ...
        @Override
        public ModifyResourceQueueRequest build() {
            return new ModifyResourceQueueRequest(this);
        } 
