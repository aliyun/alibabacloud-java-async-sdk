...
/**
 * {@link ListFlowClusterAllHostsResponseBody} extends {@link TeaModel}
 *
 * <p>ListFlowClusterAllHostsResponseBody</p>
 */
public class ListFlowClusterAllHostsResponseBody extends TeaModel {
    ...
    private ListFlowClusterAllHostsResponseBody(Builder builder) {
    ...
    public static ListFlowClusterAllHostsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListFlowClusterAllHostsResponseBody build() {
            return new ListFlowClusterAllHostsResponseBody(this);
        } 
