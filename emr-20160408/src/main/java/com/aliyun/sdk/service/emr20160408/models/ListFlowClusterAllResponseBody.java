...
/**
 * {@link ListFlowClusterAllResponseBody} extends {@link TeaModel}
 *
 * <p>ListFlowClusterAllResponseBody</p>
 */
public class ListFlowClusterAllResponseBody extends TeaModel {
    ...
    private ListFlowClusterAllResponseBody(Builder builder) {
    ...
    public static ListFlowClusterAllResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListFlowClusterAllResponseBody build() {
            return new ListFlowClusterAllResponseBody(this);
        } 
