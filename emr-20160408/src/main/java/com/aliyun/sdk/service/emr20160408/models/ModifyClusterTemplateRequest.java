...
/**
 * {@link ModifyClusterTemplateRequest} extends {@link RequestModel}
 *
 * <p>ModifyClusterTemplateRequest</p>
 */
public class ModifyClusterTemplateRequest extends Request {
    @Query
    @NameInMap("AutoRenew")
    ...
    private ModifyClusterTemplateRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyClusterTemplateRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyClusterTemplateRequest, Builder> {
        private Boolean autoRenew; 
        private String bizId; 
        private java.util.List < BootstrapAction> bootstrapAction; 
        private String chargeType; 
        ...
        private Builder(ModifyClusterTemplateRequest response) {
            super(response);
        ...
        @Override
        public ModifyClusterTemplateRequest build() {
            return new ModifyClusterTemplateRequest(this);
        } 
