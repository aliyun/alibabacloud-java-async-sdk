...
/**
 * {@link ModifyFlowProjectClusterSettingRequest} extends {@link RequestModel}
 *
 * <p>ModifyFlowProjectClusterSettingRequest</p>
 */
public class ModifyFlowProjectClusterSettingRequest extends Request {
    @Query
    @NameInMap("ClusterId")
    ...
    private ModifyFlowProjectClusterSettingRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyFlowProjectClusterSettingRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyFlowProjectClusterSettingRequest, Builder> {
        private String clusterId; 
        private String defaultQueue; 
        private String defaultUser; 
        private java.util.List < String > hostList; 
        ...
        @Override
        public ModifyFlowProjectClusterSettingRequest build() {
            return new ModifyFlowProjectClusterSettingRequest(this);
        } 
