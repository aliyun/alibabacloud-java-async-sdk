...
/**
 * {@link CreateFlowForWebRequest} extends {@link RequestModel}
 *
 * <p>CreateFlowForWebRequest</p>
 */
public class CreateFlowForWebRequest extends Request {
    @Query
    @NameInMap("AlertConf")
    ...
    private CreateFlowForWebRequest(Builder builder) {
        super(builder);
    ...
    public static CreateFlowForWebRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateFlowForWebRequest, Builder> {
        private String alertConf; 
        private String alertDingDingGroupBizId; 
        private String alertUserGroupBizId; 
        private String clusterId; 
        ...
        private Builder(CreateFlowForWebRequest response) {
            super(response);
        ...
        @Override
        public CreateFlowForWebRequest build() {
            return new CreateFlowForWebRequest(this);
        } 
