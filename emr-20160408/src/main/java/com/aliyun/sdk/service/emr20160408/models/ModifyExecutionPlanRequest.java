...
/**
 * {@link ModifyExecutionPlanRequest} extends {@link RequestModel}
 *
 * <p>ModifyExecutionPlanRequest</p>
 */
public class ModifyExecutionPlanRequest extends Request {
    @Query
    ...
    private ModifyExecutionPlanRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyExecutionPlanRequest create() {
    ...
    public static final class Builder extends Request.Builder<ModifyExecutionPlanRequest, Builder> {
        private java.util.List < BootstrapAction> bootstrapAction; 
        private String clusterId; 
        private String clusterName; 
        private String clusterType; 
        ...
        private Builder(ModifyExecutionPlanRequest response) {
            super(response);
            ...
            this.executionPlanVersion = response.executionPlanVersion;
        ...
        public Builder executionPlanVersion(Long executionPlanVersion) {
            this.putQueryParameter("ExecutionPlanVersion", executionPlanVersion);
        ...
        @Override
        public ModifyExecutionPlanRequest build() {
            return new ModifyExecutionPlanRequest(this);
        } 
