...
/**
 * 
 * {@link UpdateExecutorGroupResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateExecutorGroupResponseBody</p>
 */
public class UpdateExecutorGroupResponseBody extends TeaModel {
    ...
    private UpdateExecutorGroupResponseBody(Builder builder) {
    ...
    public static UpdateExecutorGroupResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateExecutorGroupResponseBody model) {
        ...
        public UpdateExecutorGroupResponseBody build() {
            return new UpdateExecutorGroupResponseBody(this);
        } 
