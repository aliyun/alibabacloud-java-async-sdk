...
/**
 * 
 * {@link GetWorkflowDAGResponseBody} extends {@link TeaModel}
 *
 * <p>GetWorkflowDAGResponseBody</p>
 */
public class GetWorkflowDAGResponseBody extends TeaModel {
    ...
    private GetWorkflowDAGResponseBody(Builder builder) {
    ...
    public static GetWorkflowDAGResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetWorkflowDAGResponseBody model) {
        ...
        public GetWorkflowDAGResponseBody build() {
            return new GetWorkflowDAGResponseBody(this);
        } 
