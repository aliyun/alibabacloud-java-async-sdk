...
/**
 * 
 * {@link GetPageLogResponseBody} extends {@link TeaModel}
 *
 * <p>GetPageLogResponseBody</p>
 */
public class GetPageLogResponseBody extends TeaModel {
    ...
    private GetPageLogResponseBody(Builder builder) {
    ...
    public static GetPageLogResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetPageLogResponseBody model) {
        ...
        public GetPageLogResponseBody build() {
            return new GetPageLogResponseBody(this);
        } 
