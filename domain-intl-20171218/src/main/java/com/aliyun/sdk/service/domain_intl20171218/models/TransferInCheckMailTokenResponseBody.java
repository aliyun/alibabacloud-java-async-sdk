...
/**
 * 
 * {@link TransferInCheckMailTokenResponseBody} extends {@link TeaModel}
 *
 * <p>TransferInCheckMailTokenResponseBody</p>
 */
public class TransferInCheckMailTokenResponseBody extends TeaModel {
    ...
    private TransferInCheckMailTokenResponseBody(Builder builder) {
    ...
    public static TransferInCheckMailTokenResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(TransferInCheckMailTokenResponseBody model) {
        ...
        public TransferInCheckMailTokenResponseBody build() {
            return new TransferInCheckMailTokenResponseBody(this);
        } 
