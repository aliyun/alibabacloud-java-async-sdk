...
public class BatchFuzzyMatchDomainSensitiveWordRequest extends Request {
    ...
    public static BatchFuzzyMatchDomainSensitiveWordRequest create() {
    ...
    public static final class Builder extends Request.Builder<BatchFuzzyMatchDomainSensitiveWordRequest, Builder> {
        private String keyword; 
        private String lang; 
        private String userClientIp; 
        ...
        @Override
        public BatchFuzzyMatchDomainSensitiveWordRequest build() {
            return new BatchFuzzyMatchDomainSensitiveWordRequest(this);
        } 
