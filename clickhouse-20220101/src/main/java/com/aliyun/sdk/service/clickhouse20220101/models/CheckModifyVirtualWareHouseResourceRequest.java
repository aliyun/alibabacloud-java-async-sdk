...
/**
 * 
 * {@link CheckModifyVirtualWareHouseResourceRequest} extends {@link RequestModel}
 *
 * <p>CheckModifyVirtualWareHouseResourceRequest</p>
 */
public class CheckModifyVirtualWareHouseResourceRequest extends Request {
    ...
    private CheckModifyVirtualWareHouseResourceRequest(Builder builder) {
        super(builder);
    ...
    public static CheckModifyVirtualWareHouseResourceRequest create() {
    ...
    public static final class Builder extends Request.Builder<CheckModifyVirtualWareHouseResourceRequest, Builder> {
        private String DBClusterId; 
        private String regionId; 
        private Integer virtualWareHouseCacheStorage; 
        private String virtualWareHouseClass; 
        ...
        private Builder(CheckModifyVirtualWareHouseResourceRequest request) {
            super(request);
        ...
        @Override
        public CheckModifyVirtualWareHouseResourceRequest build() {
            return new CheckModifyVirtualWareHouseResourceRequest(this);
        } 
