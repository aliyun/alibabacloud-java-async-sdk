...
/**
 * 
 * {@link CheckCreateVirtualWareHouseResponseBody} extends {@link TeaModel}
 *
 * <p>CheckCreateVirtualWareHouseResponseBody</p>
 */
public class CheckCreateVirtualWareHouseResponseBody extends TeaModel {
    ...
    private CheckCreateVirtualWareHouseResponseBody(Builder builder) {
    ...
    public static CheckCreateVirtualWareHouseResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CheckCreateVirtualWareHouseResponseBody build() {
            return new CheckCreateVirtualWareHouseResponseBody(this);
        } 
