...
/**
 * 
 * {@link DescribeSlowQueryRequest} extends {@link RequestModel}
 *
 * <p>DescribeSlowQueryRequest</p>
 */
public class DescribeSlowQueryRequest extends Request {
    ...
    private DescribeSlowQueryRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeSlowQueryRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeSlowQueryRequest, Builder> {
        private String DBClusterId; 
        private String endTime; 
        private Integer pageNumber; 
        private Integer pageSize; 
        ...
        private Builder(DescribeSlowQueryRequest request) {
            super(request);
        ...
        @Override
        public DescribeSlowQueryRequest build() {
            return new DescribeSlowQueryRequest(this);
        } 
