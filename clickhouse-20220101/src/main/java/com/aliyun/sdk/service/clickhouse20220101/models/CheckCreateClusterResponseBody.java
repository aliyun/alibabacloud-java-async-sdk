...
/**
 * 
 * {@link CheckCreateClusterResponseBody} extends {@link TeaModel}
 *
 * <p>CheckCreateClusterResponseBody</p>
 */
public class CheckCreateClusterResponseBody extends TeaModel {
    ...
    private CheckCreateClusterResponseBody(Builder builder) {
    ...
    public static CheckCreateClusterResponseBody create() {
    ...
    public static final class Builder {
        ...
        public CheckCreateClusterResponseBody build() {
            return new CheckCreateClusterResponseBody(this);
        } 
