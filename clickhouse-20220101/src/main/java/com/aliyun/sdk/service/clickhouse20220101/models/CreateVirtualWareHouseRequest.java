...
/**
 * 
 * {@link CreateVirtualWareHouseRequest} extends {@link RequestModel}
 *
 * <p>CreateVirtualWareHouseRequest</p>
 */
public class CreateVirtualWareHouseRequest extends Request {
    ...
    private CreateVirtualWareHouseRequest(Builder builder) {
        super(builder);
    ...
    public static CreateVirtualWareHouseRequest create() {
    ...
    public static final class Builder extends Request.Builder<CreateVirtualWareHouseRequest, Builder> {
        private String DBClusterId; 
        private String regionId; 
        private Integer virtualWareHouseCacheStorage; 
        private String virtualWareHouseClass; 
        ...
        private Builder(CreateVirtualWareHouseRequest request) {
            super(request);
        ...
        @Override
        public CreateVirtualWareHouseRequest build() {
            return new CreateVirtualWareHouseRequest(this);
        } 
