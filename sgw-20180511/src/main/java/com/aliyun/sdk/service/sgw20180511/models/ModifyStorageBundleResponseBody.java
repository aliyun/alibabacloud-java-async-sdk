...
/**
 * {@link ModifyStorageBundleResponseBody} extends {@link TeaModel}
 *
 * <p>ModifyStorageBundleResponseBody</p>
 */
public class ModifyStorageBundleResponseBody extends TeaModel {
    ...
    private ModifyStorageBundleResponseBody(Builder builder) {
    ...
    public static ModifyStorageBundleResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ModifyStorageBundleResponseBody build() {
            return new ModifyStorageBundleResponseBody(this);
        } 
