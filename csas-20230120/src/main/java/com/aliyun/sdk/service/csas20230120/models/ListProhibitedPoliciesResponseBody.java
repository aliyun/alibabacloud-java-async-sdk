...
/**
 * 
 * {@link ListProhibitedPoliciesResponseBody} extends {@link TeaModel}
 *
 * <p>ListProhibitedPoliciesResponseBody</p>
 */
public class ListProhibitedPoliciesResponseBody extends TeaModel {
    ...
    private ListProhibitedPoliciesResponseBody(Builder builder) {
    ...
    public static ListProhibitedPoliciesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListProhibitedPoliciesResponseBody model) {
        ...
        public ListProhibitedPoliciesResponseBody build() {
            return new ListProhibitedPoliciesResponseBody(this);
        } 
