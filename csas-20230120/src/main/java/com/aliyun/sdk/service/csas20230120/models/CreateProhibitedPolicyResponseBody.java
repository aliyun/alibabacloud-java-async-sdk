...
/**
 * 
 * {@link CreateProhibitedPolicyResponseBody} extends {@link TeaModel}
 *
 * <p>CreateProhibitedPolicyResponseBody</p>
 */
public class CreateProhibitedPolicyResponseBody extends TeaModel {
    ...
    private CreateProhibitedPolicyResponseBody(Builder builder) {
    ...
    public static CreateProhibitedPolicyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateProhibitedPolicyResponseBody model) {
        ...
        public CreateProhibitedPolicyResponseBody build() {
            return new CreateProhibitedPolicyResponseBody(this);
        } 
