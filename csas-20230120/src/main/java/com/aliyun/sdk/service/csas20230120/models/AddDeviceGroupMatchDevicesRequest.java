...
/**
 * 
 * {@link AddDeviceGroupMatchDevicesRequest} extends {@link RequestModel}
 *
 * <p>AddDeviceGroupMatchDevicesRequest</p>
 */
public class AddDeviceGroupMatchDevicesRequest extends Request {
    ...
    private AddDeviceGroupMatchDevicesRequest(Builder builder) {
        super(builder);
    ...
    public static AddDeviceGroupMatchDevicesRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddDeviceGroupMatchDevicesRequest, Builder> {
        private java.util.List<String> devTags; 
        private String deviceGroupId; 
        ...
        private Builder(AddDeviceGroupMatchDevicesRequest request) {
            super(request);
        ...
        @Override
        public AddDeviceGroupMatchDevicesRequest build() {
            return new AddDeviceGroupMatchDevicesRequest(this);
        } 
