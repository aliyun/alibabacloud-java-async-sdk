...
@Override
    ...
    public static class CsvControl extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * <p>The timestamp watermark parameter that specifies how much information a single timestamp can contain. This must be consistent with the corresponding parameter used during embedding. Otherwise, extraction fails.</p>
             * 
             * <strong>example:</strong>
             * <p>1</p>
             */
            ...
            /**
             * <p>The lossy embedding control parameter that specifies the column to modify. This must be consistent with the parameter used during embedding. Otherwise, extraction fails.</p>
             * 
             * <strong>example:</strong>
             * <p>1</p>
             */
            ...
            /**
             * <p>The lossy embedding control parameter that specifies the modification precision. This must be consistent with the parameter used during embedding. Otherwise, extraction fails.</p>
             * 
             * <strong>example:</strong>
             * <p>0</p>
             */
            ...
            /**
             * <p>The timestamp watermark parameter that controls the embedding position of the timestamp watermark. This must be consistent with the corresponding parameter used during embedding. Otherwise, extraction fails.</p>
             * 
             * <strong>example:</strong>
             * <p>Min</p>
             */
            ...
            /**
             * <p>The CSV watermark embedding method. This must be consistent with the parameter used during embedding. Otherwise, extraction fails.</p>
             * 
             * <strong>example:</strong>
            ...
            /**
             * <p>The timestamp watermark parameter that specifies the timestamp format. This must be consistent with the corresponding parameter used during embedding. Otherwise, extraction fails.</p>
             * 
             * <strong>example:</strong>
    ...
    public static class ImageExtractParamsOpenApi extends TeaModel {
        ...
        public static final class Builder {
            ...
            /**
             * <p>The base64-encoded original file of the enhanced visible watermark logo. This is used to extract the enhanced visible watermark.</p>
             * 
             * <strong>example:</strong>
