...
/**
 * 
 * {@link CreateForwardStrategyResponseBody} extends {@link TeaModel}
 *
 * <p>CreateForwardStrategyResponseBody</p>
 */
public class CreateForwardStrategyResponseBody extends TeaModel {
    ...
    private CreateForwardStrategyResponseBody(Builder builder) {
    ...
    public static CreateForwardStrategyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateForwardStrategyResponseBody model) {
        ...
        public CreateForwardStrategyResponseBody build() {
            return new CreateForwardStrategyResponseBody(this);
        } 
