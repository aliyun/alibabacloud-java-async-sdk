...
/**
 * 
 * {@link CreateVulScanScheduledStrategyResponseBody} extends {@link TeaModel}
 *
 * <p>CreateVulScanScheduledStrategyResponseBody</p>
 */
public class CreateVulScanScheduledStrategyResponseBody extends TeaModel {
    ...
    private CreateVulScanScheduledStrategyResponseBody(Builder builder) {
    ...
    public static CreateVulScanScheduledStrategyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateVulScanScheduledStrategyResponseBody model) {
        ...
        public CreateVulScanScheduledStrategyResponseBody build() {
            return new CreateVulScanScheduledStrategyResponseBody(this);
        } 
