...
/**
 * 
 * {@link UpdateProhibitedSoftwareResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateProhibitedSoftwareResponseBody</p>
 */
public class UpdateProhibitedSoftwareResponseBody extends TeaModel {
    ...
    private UpdateProhibitedSoftwareResponseBody(Builder builder) {
    ...
    public static UpdateProhibitedSoftwareResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateProhibitedSoftwareResponseBody model) {
        ...
        public UpdateProhibitedSoftwareResponseBody build() {
            return new UpdateProhibitedSoftwareResponseBody(this);
        } 
