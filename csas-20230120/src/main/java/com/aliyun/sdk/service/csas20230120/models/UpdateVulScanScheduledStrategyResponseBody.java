...
/**
 * 
 * {@link UpdateVulScanScheduledStrategyResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateVulScanScheduledStrategyResponseBody</p>
 */
public class UpdateVulScanScheduledStrategyResponseBody extends TeaModel {
    ...
    private UpdateVulScanScheduledStrategyResponseBody(Builder builder) {
    ...
    public static UpdateVulScanScheduledStrategyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateVulScanScheduledStrategyResponseBody model) {
        ...
        public UpdateVulScanScheduledStrategyResponseBody build() {
            return new UpdateVulScanScheduledStrategyResponseBody(this);
        } 
