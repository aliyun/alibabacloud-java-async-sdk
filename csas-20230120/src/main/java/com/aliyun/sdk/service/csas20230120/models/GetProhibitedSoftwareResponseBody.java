...
/**
 * 
 * {@link GetProhibitedSoftwareResponseBody} extends {@link TeaModel}
 *
 * <p>GetProhibitedSoftwareResponseBody</p>
 */
public class GetProhibitedSoftwareResponseBody extends TeaModel {
    ...
    private GetProhibitedSoftwareResponseBody(Builder builder) {
    ...
    public static GetProhibitedSoftwareResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetProhibitedSoftwareResponseBody model) {
        ...
        public GetProhibitedSoftwareResponseBody build() {
            return new GetProhibitedSoftwareResponseBody(this);
        } 
