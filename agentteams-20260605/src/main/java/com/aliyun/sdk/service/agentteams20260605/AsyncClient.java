...
public interface AsyncClient extends SdkAutoCloseable {
     ...
     */
    CompletableFuture<BindIdentityProviderResponse> bindIdentityProvider(BindIdentityProviderRequest request);
     ...
     */
    CompletableFuture<ConfigureNatGatewayResponse> configureNatGateway(ConfigureNatGatewayRequest request);
     ...
     */
    CompletableFuture<CreateModelProviderResponse> createModelProvider(CreateModelProviderRequest request);
     ...
     */
    CompletableFuture<CreateServiceEndpointResponse> createServiceEndpoint(CreateServiceEndpointRequest request);
     ...
     */
    CompletableFuture<CreateWorkerResponse> createWorker(CreateWorkerRequest request);
     ...
     */
    CompletableFuture<CreateWorkerBootstrapTokenResponse> createWorkerBootstrapToken(CreateWorkerBootstrapTokenRequest request);
     ...
     */
    CompletableFuture<DeleteModelProviderResponse> deleteModelProvider(DeleteModelProviderRequest request);
     ...
     */
    CompletableFuture<DeleteServiceEndpointResponse> deleteServiceEndpoint(DeleteServiceEndpointRequest request);
     ...
     */
    CompletableFuture<DeleteWorkerResponse> deleteWorker(DeleteWorkerRequest request);
     ...
     */
    CompletableFuture<GetInstanceAsyncTaskResponse> getInstanceAsyncTask(GetInstanceAsyncTaskRequest request);
     ...
     */
    CompletableFuture<GetInstanceOssMountRamAuthorizeUrlResponse> getInstanceOssMountRamAuthorizeUrl(GetInstanceOssMountRamAuthorizeUrlRequest request);
     ...
     */
    CompletableFuture<GetModelInvocationSummaryResponse> getModelInvocationSummary(GetModelInvocationSummaryRequest request);
     ...
     */
    CompletableFuture<GetModelProviderResponse> getModelProvider(GetModelProviderRequest request);
     ...
     */
    CompletableFuture<GetNatGatewayStatusResponse> getNatGatewayStatus(GetNatGatewayStatusRequest request);
     ...
     */
    CompletableFuture<GetTaskStatsSummaryResponse> getTaskStatsSummary(GetTaskStatsSummaryRequest request);
     ...
     */
    CompletableFuture<GetTokenTrendResponse> getTokenTrend(GetTokenTrendRequest request);
     ...
     */
    CompletableFuture<GetToolCallDistributionResponse> getToolCallDistribution(GetToolCallDistributionRequest request);
     ...
     */
    CompletableFuture<GetUserPasswordResponse> getUserPassword(GetUserPasswordRequest request);

    /**
     * @param request the request parameters of GetWorker  GetWorkerRequest
     * @return GetWorkerResponse
     */
    CompletableFuture<GetWorkerResponse> getWorker(GetWorkerRequest request);
     ...
     */
    CompletableFuture<GetWorkerBootstrapOptionsResponse> getWorkerBootstrapOptions(GetWorkerBootstrapOptionsRequest request);

    /**
     * @param request the request parameters of GetWorkerMaxVersion  GetWorkerMaxVersionRequest
     * @return GetWorkerMaxVersionResponse
     */
    CompletableFuture<GetWorkerMaxVersionResponse> getWorkerMaxVersion(GetWorkerMaxVersionRequest request);
     ...
     */
    CompletableFuture<GetWorkerStatsSummaryResponse> getWorkerStatsSummary(GetWorkerStatsSummaryRequest request);
     ...
     */
    CompletableFuture<ListTeamDetailsResponse> listTeamDetails(ListTeamDetailsRequest request);

    /**
     * @param request the request parameters of ListTeamTasks  ListTeamTasksRequest
     * @return ListTeamTasksResponse
     */
    CompletableFuture<ListTeamTasksResponse> listTeamTasks(ListTeamTasksRequest request);
     ...
     */
    CompletableFuture<ListWorkerStatsDetailsResponse> listWorkerStatsDetails(ListWorkerStatsDetailsRequest request);

    /**
     * @param request the request parameters of ListWorkers  ListWorkersRequest
     * @return ListWorkersResponse
     */
    CompletableFuture<ListWorkersResponse> listWorkers(ListWorkersRequest request);

    /**
     * @param request the request parameters of PutCmsWorkspace  PutCmsWorkspaceRequest
     * @return PutCmsWorkspaceResponse
     */
    CompletableFuture<PutCmsWorkspaceResponse> putCmsWorkspace(PutCmsWorkspaceRequest request);
     ...
     */
    CompletableFuture<QueryFeaturesResponse> queryFeatures(QueryFeaturesRequest request);
     ...
     */
    CompletableFuture<QuerySupportedZonesResponse> querySupportedZones(QuerySupportedZonesRequest request);
     ...
     */
    CompletableFuture<TestModelProviderResponse> testModelProvider(TestModelProviderRequest request);
     ...
     */
    CompletableFuture<UnbindIdentityProviderResponse> unbindIdentityProvider(UnbindIdentityProviderRequest request);
     ...
     */
    CompletableFuture<UpdateInstanceAsyncTaskResponse> updateInstanceAsyncTask(UpdateInstanceAsyncTaskRequest request);
     ...
     */
    CompletableFuture<UpdateModelProviderResponse> updateModelProvider(UpdateModelProviderRequest request);
     ...
     */
    CompletableFuture<UpdateServiceEndpointResponse> updateServiceEndpoint(UpdateServiceEndpointRequest request);
     ...
     */
    CompletableFuture<UpdateWorkerResponse> updateWorker(UpdateWorkerRequest request);
