...
/**
 * 
 * {@link BindIdentityProviderRequest} extends {@link RequestModel}
 *
 * <p>BindIdentityProviderRequest</p>
 */
public class BindIdentityProviderRequest extends Request {
    ...
    private BindIdentityProviderRequest(Builder builder) {
        super(builder);
    ...
    public static BindIdentityProviderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<BindIdentityProviderRequest, Builder> {
        private String clientToken; 
        private String identityProviderType; 
        private String idpMetadata; 
        private String instanceId; 
        ...
        private Builder(BindIdentityProviderRequest request) {
            super(request);
        ...
        @Override
        public BindIdentityProviderRequest build() {
            return new BindIdentityProviderRequest(this);
        } 
