...
/**
 * 
 * {@link UpdateWorkerResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateWorkerResponseBody</p>
 */
public class UpdateWorkerResponseBody extends TeaModel {
    ...
    private UpdateWorkerResponseBody(Builder builder) {
    ...
    public static UpdateWorkerResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateWorkerResponseBody model) {
        ...
        public UpdateWorkerResponseBody build() {
            return new UpdateWorkerResponseBody(this);
        } 
