...
/**
 * 
 * {@link CreateModelProviderRequest} extends {@link RequestModel}
 *
 * <p>CreateModelProviderRequest</p>
 */
public class CreateModelProviderRequest extends Request {
    ...
    private CreateModelProviderRequest(Builder builder) {
        super(builder);
    ...
    public static CreateModelProviderRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<CreateModelProviderRequest, Builder> {
        private String regionId; 
        private String address; 
        private java.util.List<String> apiKeys; 
        private String clientToken; 
        ...
        private Builder(CreateModelProviderRequest request) {
            super(request);
        ...
        @Override
        public CreateModelProviderRequest build() {
            return new CreateModelProviderRequest(this);
        } 
