...
/**
 * 
 * {@link RemoveEnvResponseBody} extends {@link TeaModel}
 *
 * <p>RemoveEnvResponseBody</p>
 */
public class RemoveEnvResponseBody extends TeaModel {
    ...
    private RemoveEnvResponseBody(Builder builder) {
    ...
    public static RemoveEnvResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RemoveEnvResponseBody model) {
        ...
        public RemoveEnvResponseBody build() {
            return new RemoveEnvResponseBody(this);
        } 
