...
/**
 * 
 * {@link DeletePtsSceneResponseBody} extends {@link TeaModel}
 *
 * <p>DeletePtsSceneResponseBody</p>
 */
public class DeletePtsSceneResponseBody extends TeaModel {
    ...
    private DeletePtsSceneResponseBody(Builder builder) {
    ...
    public static DeletePtsSceneResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeletePtsSceneResponseBody model) {
        ...
        public DeletePtsSceneResponseBody build() {
            return new DeletePtsSceneResponseBody(this);
        } 
