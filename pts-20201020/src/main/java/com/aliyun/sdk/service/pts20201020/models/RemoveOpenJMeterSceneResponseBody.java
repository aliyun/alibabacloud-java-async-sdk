...
/**
 * 
 * {@link RemoveOpenJMeterSceneResponseBody} extends {@link TeaModel}
 *
 * <p>RemoveOpenJMeterSceneResponseBody</p>
 */
public class RemoveOpenJMeterSceneResponseBody extends TeaModel {
    ...
    private RemoveOpenJMeterSceneResponseBody(Builder builder) {
    ...
    public static RemoveOpenJMeterSceneResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(RemoveOpenJMeterSceneResponseBody model) {
        ...
        public RemoveOpenJMeterSceneResponseBody build() {
            return new RemoveOpenJMeterSceneResponseBody(this);
        } 
