...
/**
 * 
 * {@link SaveEnvResponseBody} extends {@link TeaModel}
 *
 * <p>SaveEnvResponseBody</p>
 */
public class SaveEnvResponseBody extends TeaModel {
    ...
    private SaveEnvResponseBody(Builder builder) {
    ...
    public static SaveEnvResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SaveEnvResponseBody model) {
        ...
        public SaveEnvResponseBody build() {
            return new SaveEnvResponseBody(this);
        } 
