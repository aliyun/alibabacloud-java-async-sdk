...
/**
 * 
 * {@link AgentCancelCallResponseBody} extends {@link TeaModel}
 *
 * <p>AgentCancelCallResponseBody</p>
 */
public class AgentCancelCallResponseBody extends TeaModel {
    ...
    private AgentCancelCallResponseBody(Builder builder) {
    ...
    public static AgentCancelCallResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AgentCancelCallResponseBody model) {
        ...
        public AgentCancelCallResponseBody build() {
            return new AgentCancelCallResponseBody(this);
        } 
