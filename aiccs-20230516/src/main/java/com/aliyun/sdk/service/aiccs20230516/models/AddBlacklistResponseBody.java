...
/**
 * 
 * {@link AddBlacklistResponseBody} extends {@link TeaModel}
 *
 * <p>AddBlacklistResponseBody</p>
 */
public class AddBlacklistResponseBody extends TeaModel {
    ...
    private AddBlacklistResponseBody(Builder builder) {
    ...
    public static AddBlacklistResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddBlacklistResponseBody model) {
        ...
        public AddBlacklistResponseBody build() {
            return new AddBlacklistResponseBody(this);
        } 
