...
public class UpdateAgentStatusResponseBody extends TeaModel {
    ...
    private UpdateAgentStatusResponseBody(Builder builder) {
    ...
    public static UpdateAgentStatusResponseBody create() {
    ...
    public static final class Builder {
        ...
        public UpdateAgentStatusResponseBody build() {
            return new UpdateAgentStatusResponseBody(this);
        } 
