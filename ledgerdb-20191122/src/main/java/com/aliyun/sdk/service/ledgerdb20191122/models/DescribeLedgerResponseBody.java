...
/**
 * {@link DescribeLedgerResponseBody} extends {@link TeaModel}
 *
 * <p>DescribeLedgerResponseBody</p>
 */
public class DescribeLedgerResponseBody extends TeaModel {
    ...
    private DescribeLedgerResponseBody(Builder builder) {
    ...
    public static DescribeLedgerResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DescribeLedgerResponseBody build() {
            return new DescribeLedgerResponseBody(this);
        } 
    ...
    public static class Ledger extends TeaModel {
