...
/**
 * 
 * {@link GetIssueRequest} extends {@link RequestModel}
 *
 * <p>GetIssueRequest</p>
 */
public class GetIssueRequest extends Request {
    ...
    private GetIssueRequest(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends Request.Builder<GetIssueRequest, Builder> {
        private Long appKey; 
        private String bizModule; 
        private String digestHash; 
        private Filter filter; 
        ...
        private Builder(GetIssueRequest request) {
            super(request);
    ...
    /**
     * 
     * {@link GetIssueRequest} extends {@link TeaModel}
     *
     * <p>GetIssueRequest</p>
     */
