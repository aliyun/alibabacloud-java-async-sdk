...
public interface AsyncClient extends SdkAutoCloseable {
     ...
     */
    CompletableFuture<ChatUserSecAgentResponse> chatUserSecAgent(ChatUserSecAgentRequest request);

    ResponseIterable<String> chatUserSecAgentWithResponseIterable(ChatUserSecAgentRequest request);
