...
public class DescribeScalingActivitiesRequest extends Request {
    ...
    private java.util.List < String > scalingActivityId;
    ...
    public static final class Builder extends Request.Builder<DescribeScalingActivitiesRequest, Builder> {
        ...
        private Builder(DescribeScalingActivitiesRequest response) {
            super(response);
         ...
         * ScalingActivityId.
         */
        public Builder scalingActivityId(java.util.List < String > scalingActivityId) {
