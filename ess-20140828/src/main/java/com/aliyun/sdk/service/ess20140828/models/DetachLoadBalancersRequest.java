...
public class DetachLoadBalancersRequest extends Request {
    ...
    private java.util.List < String > loadBalancer;
    ...
    public static final class Builder extends Request.Builder<DetachLoadBalancersRequest, Builder> {
        ...
        private Builder(DetachLoadBalancersRequest response) {
            super(response);
            this.async = response.async;
            this.clientToken = response.clientToken;
            this.forceDetach = response.forceDetach;
            this.loadBalancer = response.loadBalancer;
         ...
         * LoadBalancer.
         */
        public Builder loadBalancer(java.util.List < String > loadBalancer) {
            this.putQueryParameter("LoadBalancer", loadBalancer);
