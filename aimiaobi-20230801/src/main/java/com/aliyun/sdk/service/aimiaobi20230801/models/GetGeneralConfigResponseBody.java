...
/**
 * 
 * {@link GetGeneralConfigResponseBody} extends {@link TeaModel}
 *
 * <p>GetGeneralConfigResponseBody</p>
 */
public class GetGeneralConfigResponseBody extends TeaModel {
    ...
    private GetGeneralConfigResponseBody(Builder builder) {
    ...
    public static GetGeneralConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetGeneralConfigResponseBody model) {
        ...
        public GetGeneralConfigResponseBody build() {
            return new GetGeneralConfigResponseBody(this);
        } 
