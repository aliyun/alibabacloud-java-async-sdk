...
/**
 * 
 * {@link UploadDocResponseBody} extends {@link TeaModel}
 *
 * <p>UploadDocResponseBody</p>
 */
public class UploadDocResponseBody extends TeaModel {
    ...
    private UploadDocResponseBody(Builder builder) {
    ...
    public static UploadDocResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UploadDocResponseBody model) {
        ...
        public UploadDocResponseBody build() {
            return new UploadDocResponseBody(this);
        } 
