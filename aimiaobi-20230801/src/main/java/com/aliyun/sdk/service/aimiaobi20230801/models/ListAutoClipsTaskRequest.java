...
/**
 * 
 * {@link ListAutoClipsTaskRequest} extends {@link RequestModel}
 *
 * <p>ListAutoClipsTaskRequest</p>
 */
public class ListAutoClipsTaskRequest extends Request {
    ...
    private ListAutoClipsTaskRequest(Builder builder) {
        super(builder);
    ...
    public static ListAutoClipsTaskRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ListAutoClipsTaskRequest, Builder> {
        private String regionId; 
        private String createTimeEnd; 
        private String createTimeStart; 
        private Integer current; 
        ...
        private Builder(ListAutoClipsTaskRequest request) {
            super(request);
        ...
        @Override
        public ListAutoClipsTaskRequest build() {
            return new ListAutoClipsTaskRequest(this);
        } 
