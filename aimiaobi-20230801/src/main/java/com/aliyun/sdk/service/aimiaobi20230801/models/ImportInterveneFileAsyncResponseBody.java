...
public class ImportInterveneFileAsyncResponseBody extends TeaModel {
    ...
    private ImportInterveneFileAsyncResponseBody(Builder builder) {
    ...
    public static ImportInterveneFileAsyncResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ImportInterveneFileAsyncResponseBody model) {
        ...
        public ImportInterveneFileAsyncResponseBody build() {
            return new ImportInterveneFileAsyncResponseBody(this);
        } 
