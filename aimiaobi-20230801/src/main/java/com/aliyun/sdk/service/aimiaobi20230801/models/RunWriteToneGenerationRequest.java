 ...
 */
public class RunWriteToneGenerationRequest extends Request {
    ...
    private RunWriteToneGenerationRequest(Builder builder) {
        super(builder);
    ...
    public static RunWriteToneGenerationRequest create() {
    ...
    public static final class Builder extends Request.Builder<RunWriteToneGenerationRequest, Builder> {
        private String regionId; 
        private String prompt; 
        private ReferenceData referenceData; 
        private String taskId; 
        ...
        private Builder(RunWriteToneGenerationRequest request) {
            super(request);
        ...
        @Override
        public RunWriteToneGenerationRequest build() {
            return new RunWriteToneGenerationRequest(this);
        } 
