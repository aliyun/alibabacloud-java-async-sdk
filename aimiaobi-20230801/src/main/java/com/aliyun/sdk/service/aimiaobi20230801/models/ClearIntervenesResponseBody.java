...
/**
 * 
 * {@link ClearIntervenesResponseBody} extends {@link TeaModel}
 *
 * <p>ClearIntervenesResponseBody</p>
 */
public class ClearIntervenesResponseBody extends TeaModel {
    ...
    private ClearIntervenesResponseBody(Builder builder) {
    ...
    public static ClearIntervenesResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ClearIntervenesResponseBody model) {
        ...
        public ClearIntervenesResponseBody build() {
            return new ClearIntervenesResponseBody(this);
        } 
