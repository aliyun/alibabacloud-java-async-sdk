...
/**
 * 
 * {@link UpdateGeneralConfigResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateGeneralConfigResponseBody</p>
 */
public class UpdateGeneralConfigResponseBody extends TeaModel {
    ...
    private UpdateGeneralConfigResponseBody(Builder builder) {
    ...
    public static UpdateGeneralConfigResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateGeneralConfigResponseBody model) {
        ...
        public UpdateGeneralConfigResponseBody build() {
            return new UpdateGeneralConfigResponseBody(this);
        } 
