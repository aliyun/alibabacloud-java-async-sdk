...
/**
 * 
 * {@link ListGeneralConfigsResponseBody} extends {@link TeaModel}
 *
 * <p>ListGeneralConfigsResponseBody</p>
 */
public class ListGeneralConfigsResponseBody extends TeaModel {
    ...
    private ListGeneralConfigsResponseBody(Builder builder) {
    ...
    public static ListGeneralConfigsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListGeneralConfigsResponseBody model) {
        ...
        public ListGeneralConfigsResponseBody build() {
            return new ListGeneralConfigsResponseBody(this);
        } 
