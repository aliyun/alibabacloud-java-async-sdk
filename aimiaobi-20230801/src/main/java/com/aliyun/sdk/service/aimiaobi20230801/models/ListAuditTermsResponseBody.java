...
/**
 * 
 * {@link ListAuditTermsResponseBody} extends {@link TeaModel}
 *
...
public class ListAuditTermsResponseBody extends TeaModel {
    ...
    private ListAuditTermsResponseBody(Builder builder) {
    ...
    public static ListAuditTermsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAuditTermsResponseBody model) {
        ...
        public ListAuditTermsResponseBody build() {
            return new ListAuditTermsResponseBody(this);
        } 
