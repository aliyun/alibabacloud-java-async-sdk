...
public class RunExpandContentResponseBody extends TeaModel {
    ...
    private RunExpandContentResponseBody(Builder builder) {
    ...
    public static RunExpandContentResponseBody create() {
    ...
    public static final class Builder {
         ...
         * Header.
         */
        public Builder header(RunExpandContentResponseBodyHeader header) {
            this.header = header;
            return this;
        }
        ...
        public RunExpandContentResponseBody build() {
            return new RunExpandContentResponseBody(this);
        } 
    ...
    public static class RunExpandContentResponseBodyHeader extends TeaModel {
        ...
        private RunExpandContentResponseBodyHeader(Builder builder) {
        ...
        public static RunExpandContentResponseBodyHeader create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public RunExpandContentResponseBodyHeader build() {
                return new RunExpandContentResponseBodyHeader(this);
            } 
