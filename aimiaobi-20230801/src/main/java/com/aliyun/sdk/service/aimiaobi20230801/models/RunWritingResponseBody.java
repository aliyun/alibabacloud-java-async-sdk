...
public class RunWritingResponseBody extends TeaModel {
    ...
    public static final class Builder {
         ...
         * Header.
         */
        public Builder header(RunWritingResponseBodyHeader header) {
            this.header = header;
            return this;
        }
        ...
        public RunWritingResponseBody build() {
            return new RunWritingResponseBody(this);
        } 
    ...
    public static class RunWritingResponseBodyHeader extends TeaModel {
        ...
        private RunWritingResponseBodyHeader(Builder builder) {
        ...
        public static RunWritingResponseBodyHeader create() {
            return builder().build();
        }
        ...
        public static final class Builder {
            ...
            public RunWritingResponseBodyHeader build() {
                return new RunWritingResponseBodyHeader(this);
            } 
