...
/**
 * 
 * {@link DeleteInterveneRuleResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteInterveneRuleResponseBody</p>
 */
public class DeleteInterveneRuleResponseBody extends TeaModel {
    ...
    private DeleteInterveneRuleResponseBody(Builder builder) {
    ...
    public static DeleteInterveneRuleResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteInterveneRuleResponseBody model) {
        ...
        public DeleteInterveneRuleResponseBody build() {
            return new DeleteInterveneRuleResponseBody(this);
        } 
