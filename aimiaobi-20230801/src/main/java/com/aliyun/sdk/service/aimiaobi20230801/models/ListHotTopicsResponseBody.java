...
public class ListHotTopicsResponseBody extends TeaModel {
    ...
    private ListHotTopicsResponseBody(Builder builder) {
    ...
    public static ListHotTopicsResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListHotTopicsResponseBody model) {
        ...
        public ListHotTopicsResponseBody build() {
            return new ListHotTopicsResponseBody(this);
        } 
