...
/**
 * 
 * {@link ListAutoClipsTaskResponseBody} extends {@link TeaModel}
 *
 * <p>ListAutoClipsTaskResponseBody</p>
 */
public class ListAutoClipsTaskResponseBody extends TeaModel {
    ...
    private ListAutoClipsTaskResponseBody(Builder builder) {
    ...
    public static ListAutoClipsTaskResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListAutoClipsTaskResponseBody model) {
        ...
        public ListAutoClipsTaskResponseBody build() {
            return new ListAutoClipsTaskResponseBody(this);
        } 
