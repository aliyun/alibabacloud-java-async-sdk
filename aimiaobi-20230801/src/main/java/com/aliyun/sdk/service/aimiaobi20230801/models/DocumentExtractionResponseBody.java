...
public class DocumentExtractionResponseBody extends TeaModel {
    ...
    private DocumentExtractionResponseBody(Builder builder) {
    ...
    public static DocumentExtractionResponseBody create() {
    ...
    public static final class Builder {
        ...
        public DocumentExtractionResponseBody build() {
            return new DocumentExtractionResponseBody(this);
        } 
