...
/**
 * 
 * {@link GetPptArtifactExportResultResponseBody} extends {@link TeaModel}
 *
 * <p>GetPptArtifactExportResultResponseBody</p>
 */
public class GetPptArtifactExportResultResponseBody extends TeaModel {
    ...
    private GetPptArtifactExportResultResponseBody(Builder builder) {
    ...
    public static GetPptArtifactExportResultResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(GetPptArtifactExportResultResponseBody model) {
        ...
        public GetPptArtifactExportResultResponseBody build() {
            return new GetPptArtifactExportResultResponseBody(this);
        } 
