...
/**
 * 
 * {@link VolumeMountConfig} extends {@link TeaModel}
 *
 * <p>VolumeMountConfig</p>
 */
public class VolumeMountConfig extends TeaModel {
    ...
    private VolumeMountConfig(Builder builder) {
    ...
    public static VolumeMountConfig create() {
    ...
    public static final class Builder {
        ...
        private Builder(VolumeMountConfig model) {
        ...
        public VolumeMountConfig build() {
            return new VolumeMountConfig(this);
        } 
