...
/**
 * 
 * {@link CreateEaiEciResponseBody} extends {@link TeaModel}
 *
 * <p>CreateEaiEciResponseBody</p>
 */
public class CreateEaiEciResponseBody extends TeaModel {
    ...
    private CreateEaiEciResponseBody(Builder builder) {
    ...
    public static CreateEaiEciResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateEaiEciResponseBody model) {
        ...
        public CreateEaiEciResponseBody build() {
            return new CreateEaiEciResponseBody(this);
        } 
