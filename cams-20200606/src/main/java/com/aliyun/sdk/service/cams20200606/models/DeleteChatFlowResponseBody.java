...
/**
 * 
 * {@link DeleteChatFlowResponseBody} extends {@link TeaModel}
 *
 * <p>DeleteChatFlowResponseBody</p>
 */
public class DeleteChatFlowResponseBody extends TeaModel {
    ...
    private DeleteChatFlowResponseBody(Builder builder) {
    ...
    public static DeleteChatFlowResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DeleteChatFlowResponseBody model) {
        ...
        public DeleteChatFlowResponseBody build() {
            return new DeleteChatFlowResponseBody(this);
        } 
