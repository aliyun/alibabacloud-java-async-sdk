...
/**
 * 
 * {@link ListChatFlowResponseBody} extends {@link TeaModel}
 *
 * <p>ListChatFlowResponseBody</p>
 */
public class ListChatFlowResponseBody extends TeaModel {
    ...
    private ListChatFlowResponseBody(Builder builder) {
    ...
    public static ListChatFlowResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListChatFlowResponseBody model) {
        ...
        public ListChatFlowResponseBody build() {
            return new ListChatFlowResponseBody(this);
        } 
