...
/**
 * 
 * {@link OfflineFlowVersionRequest} extends {@link RequestModel}
 *
 * <p>OfflineFlowVersionRequest</p>
 */
public class OfflineFlowVersionRequest extends Request {
    ...
    private OfflineFlowVersionRequest(Builder builder) {
        super(builder);
    ...
    public static OfflineFlowVersionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<OfflineFlowVersionRequest, Builder> {
        private String bizCode; 
        private java.util.Map<String, ?> bizExtend; 
        private String flowCode; 
        private String flowVersion; 
        ...
        private Builder(OfflineFlowVersionRequest request) {
            super(request);
        ...
        @Override
        public OfflineFlowVersionRequest build() {
            return new OfflineFlowVersionRequest(this);
        } 
