...
/**
 * 
 * {@link OnlineFlowVersionResponseBody} extends {@link TeaModel}
 *
 * <p>OnlineFlowVersionResponseBody</p>
 */
public class OnlineFlowVersionResponseBody extends TeaModel {
    ...
    private OnlineFlowVersionResponseBody(Builder builder) {
    ...
    public static OnlineFlowVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OnlineFlowVersionResponseBody model) {
        ...
        public OnlineFlowVersionResponseBody build() {
            return new OnlineFlowVersionResponseBody(this);
        } 
