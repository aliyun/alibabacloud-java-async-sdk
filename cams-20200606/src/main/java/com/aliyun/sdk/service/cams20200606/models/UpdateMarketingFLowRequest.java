...
/**
 * 
 * {@link UpdateMarketingFLowRequest} extends {@link RequestModel}
 *
 * <p>UpdateMarketingFLowRequest</p>
 */
public class UpdateMarketingFLowRequest extends Request {
    ...
    private UpdateMarketingFLowRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateMarketingFLowRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<UpdateMarketingFLowRequest, Builder> {
        private String activityCode; 
        private String activityDesc; 
        private String activityId; 
        private String activityName; 
        ...
        private Builder(UpdateMarketingFLowRequest request) {
            super(request);
        ...
        @Override
        public UpdateMarketingFLowRequest build() {
            return new UpdateMarketingFLowRequest(this);
        } 
