...
/**
 * 
 * {@link CreateFlowVersionResponseBody} extends {@link TeaModel}
 *
 * <p>CreateFlowVersionResponseBody</p>
 */
public class CreateFlowVersionResponseBody extends TeaModel {
    ...
    private CreateFlowVersionResponseBody(Builder builder) {
    ...
    public static CreateFlowVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(CreateFlowVersionResponseBody model) {
        ...
        public CreateFlowVersionResponseBody build() {
            return new CreateFlowVersionResponseBody(this);
        } 
