...
/**
 * 
 * {@link OfflineFlowVersionResponseBody} extends {@link TeaModel}
 *
 * <p>OfflineFlowVersionResponseBody</p>
 */
public class OfflineFlowVersionResponseBody extends TeaModel {
    ...
    private OfflineFlowVersionResponseBody(Builder builder) {
    ...
    public static OfflineFlowVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(OfflineFlowVersionResponseBody model) {
        ...
        public OfflineFlowVersionResponseBody build() {
            return new OfflineFlowVersionResponseBody(this);
        } 
