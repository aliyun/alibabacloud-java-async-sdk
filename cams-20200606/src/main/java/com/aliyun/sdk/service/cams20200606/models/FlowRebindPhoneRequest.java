...
/**
 * 
 * {@link FlowRebindPhoneRequest} extends {@link RequestModel}
 *
 * <p>FlowRebindPhoneRequest</p>
 */
public class FlowRebindPhoneRequest extends Request {
    ...
    private FlowRebindPhoneRequest(Builder builder) {
        super(builder);
    ...
    public static FlowRebindPhoneRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<FlowRebindPhoneRequest, Builder> {
        private String channelCode; 
        private String channelType; 
        private String flowCode; 
        private String flowVersion; 
        ...
        private Builder(FlowRebindPhoneRequest request) {
            super(request);
        ...
        @Override
        public FlowRebindPhoneRequest build() {
            return new FlowRebindPhoneRequest(this);
        } 
    ...
    /**
     * 
     * {@link FlowRebindPhoneRequest} extends {@link TeaModel}
     *
     * <p>FlowRebindPhoneRequest</p>
     */
