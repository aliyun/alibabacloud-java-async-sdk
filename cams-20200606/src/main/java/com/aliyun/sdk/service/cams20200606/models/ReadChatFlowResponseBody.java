...
/**
 * 
 * {@link ReadChatFlowResponseBody} extends {@link TeaModel}
 *
 * <p>ReadChatFlowResponseBody</p>
 */
public class ReadChatFlowResponseBody extends TeaModel {
    ...
    private ReadChatFlowResponseBody(Builder builder) {
    ...
    public static ReadChatFlowResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReadChatFlowResponseBody model) {
        ...
        public ReadChatFlowResponseBody build() {
            return new ReadChatFlowResponseBody(this);
        } 
