...
/**
 * 
 * {@link UpdateChatFlowResponseBody} extends {@link TeaModel}
 *
 * <p>UpdateChatFlowResponseBody</p>
 */
public class UpdateChatFlowResponseBody extends TeaModel {
    ...
    private UpdateChatFlowResponseBody(Builder builder) {
    ...
    public static UpdateChatFlowResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdateChatFlowResponseBody model) {
        ...
        public UpdateChatFlowResponseBody build() {
            return new UpdateChatFlowResponseBody(this);
        } 
