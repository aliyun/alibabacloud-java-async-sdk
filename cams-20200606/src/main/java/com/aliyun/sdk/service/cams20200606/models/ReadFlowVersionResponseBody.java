...
/**
 * 
 * {@link ReadFlowVersionResponseBody} extends {@link TeaModel}
 *
 * <p>ReadFlowVersionResponseBody</p>
 */
public class ReadFlowVersionResponseBody extends TeaModel {
    ...
    private ReadFlowVersionResponseBody(Builder builder) {
    ...
    public static ReadFlowVersionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ReadFlowVersionResponseBody model) {
        ...
        public ReadFlowVersionResponseBody build() {
            return new ReadFlowVersionResponseBody(this);
        } 
