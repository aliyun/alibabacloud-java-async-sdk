...
/**
 * 
 * {@link OnlineFlowVersionRequest} extends {@link RequestModel}
 *
 * <p>OnlineFlowVersionRequest</p>
 */
public class OnlineFlowVersionRequest extends Request {
    ...
    private OnlineFlowVersionRequest(Builder builder) {
        super(builder);
    ...
    public static OnlineFlowVersionRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<OnlineFlowVersionRequest, Builder> {
        private String bizCode; 
        private java.util.Map<String, ?> bizExtend; 
        private String flowCode; 
        private String flowVersion; 
        ...
        private Builder(OnlineFlowVersionRequest request) {
            super(request);
        ...
        @Override
        public OnlineFlowVersionRequest build() {
            return new OnlineFlowVersionRequest(this);
        } 
