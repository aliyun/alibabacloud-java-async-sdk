...
public class UpdatePhoneEncryptionPublicKeyResponseBody extends TeaModel {
    ...
    public static UpdatePhoneEncryptionPublicKeyResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdatePhoneEncryptionPublicKeyResponseBody model) {
        ...
        public UpdatePhoneEncryptionPublicKeyResponseBody build() {
            return new UpdatePhoneEncryptionPublicKeyResponseBody(this);
        } 
