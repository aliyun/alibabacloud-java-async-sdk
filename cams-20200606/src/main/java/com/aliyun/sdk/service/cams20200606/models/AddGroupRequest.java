...
/**
 * 
 * {@link AddGroupRequest} extends {@link RequestModel}
 *
 * <p>AddGroupRequest</p>
 */
public class AddGroupRequest extends Request {
    ...
    public static AddGroupRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddGroupRequest, Builder> {
        private String bizCode; 
        private java.util.Map<String, ?> bizExtend; 
        private String contactDetails; 
        private String contactName; 
        ...
        private Builder(AddGroupRequest request) {
            super(request);
