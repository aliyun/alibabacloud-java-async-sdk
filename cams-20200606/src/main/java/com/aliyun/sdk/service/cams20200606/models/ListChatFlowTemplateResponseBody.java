...
/**
 * 
 * {@link ListChatFlowTemplateResponseBody} extends {@link TeaModel}
 *
 * <p>ListChatFlowTemplateResponseBody</p>
 */
public class ListChatFlowTemplateResponseBody extends TeaModel {
    ...
    private ListChatFlowTemplateResponseBody(Builder builder) {
    ...
    public static ListChatFlowTemplateResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListChatFlowTemplateResponseBody model) {
        ...
        public ListChatFlowTemplateResponseBody build() {
            return new ListChatFlowTemplateResponseBody(this);
        } 
