...
public class SaveTaskForUpdatingRegistrantInfoByRegistrantProfileIDResponseBody extends TeaModel {
    ...
    public static SaveTaskForUpdatingRegistrantInfoByRegistrantProfileIDResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(SaveTaskForUpdatingRegistrantInfoByRegistrantProfileIDResponseBody model) {
        ...
        public SaveTaskForUpdatingRegistrantInfoByRegistrantProfileIDResponseBody build() {
            return new SaveTaskForUpdatingRegistrantInfoByRegistrantProfileIDResponseBody(this);
        } 
