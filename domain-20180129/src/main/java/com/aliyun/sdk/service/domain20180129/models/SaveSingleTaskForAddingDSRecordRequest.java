...
public class SaveSingleTaskForAddingDSRecordRequest extends Request {
    ...
    public static SaveSingleTaskForAddingDSRecordRequest create() {
    ...
    public static final class Builder extends Request.Builder<SaveSingleTaskForAddingDSRecordRequest, Builder> {
        private Integer algorithm; 
        private String digest; 
        private Integer digestType; 
        private String domainName; 
        ...
        @Override
        public SaveSingleTaskForAddingDSRecordRequest build() {
            return new SaveSingleTaskForAddingDSRecordRequest(this);
        } 
