...
public class TransferInReenterTransferAuthorizationCodeResponseBody extends TeaModel {
    ...
    public static TransferInReenterTransferAuthorizationCodeResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(TransferInReenterTransferAuthorizationCodeResponseBody model) {
        ...
        public TransferInReenterTransferAuthorizationCodeResponseBody build() {
            return new TransferInReenterTransferAuthorizationCodeResponseBody(this);
        } 
