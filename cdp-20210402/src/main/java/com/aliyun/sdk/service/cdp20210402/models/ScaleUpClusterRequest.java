...
/**
 * {@link ScaleUpClusterRequest} extends {@link RequestModel}
 *
 * <p>ScaleUpClusterRequest</p>
 */
public class ScaleUpClusterRequest extends Request {
    @Query
    ...
    private ScaleUpClusterRequest(Builder builder) {
        super(builder);
    ...
    public static ScaleUpClusterRequest create() {
    ...
    public static final class Builder extends Request.Builder<ScaleUpClusterRequest, Builder> {
        private String clusterBizId; 
        private Long coreNumber; 
        private Long duration; 
        private String instanceId; 
        ...
        private Builder(ScaleUpClusterRequest request) {
            super(request);
        ...
        @Override
        public ScaleUpClusterRequest build() {
            return new ScaleUpClusterRequest(this);
        } 
