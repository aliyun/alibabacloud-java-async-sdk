...
/**
 * {@link GetDeliveryPackageResponseBody} extends {@link TeaModel}
 *
 * <p>GetDeliveryPackageResponseBody</p>
 */
public class GetDeliveryPackageResponseBody extends TeaModel {
    ...
    private GetDeliveryPackageResponseBody(Builder builder) {
    ...
    public static GetDeliveryPackageResponseBody create() {
    ...
    public static final class Builder {
        ...
        public GetDeliveryPackageResponseBody build() {
            return new GetDeliveryPackageResponseBody(this);
        } 
