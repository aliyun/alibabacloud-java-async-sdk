...
/**
 * {@link UpdateDeliverableRequest} extends {@link RequestModel}
 *
 * <p>UpdateDeliverableRequest</p>
 */
public class UpdateDeliverableRequest extends Request {
    @Path
    @NameInMap("uid")
    private String uid;
    ...
    private UpdateDeliverableRequest(Builder builder) {
        super(builder);
    ...
    public static UpdateDeliverableRequest create() {
    ...
    public static final class Builder extends Request.Builder<UpdateDeliverableRequest, Builder> {
        private String uid; 
        private Foundation foundation; 
        private java.util.List < Products> products; 
        private String status; 
        ...
        private Builder(UpdateDeliverableRequest request) {
            super(request);
        ...
        @Override
        public UpdateDeliverableRequest build() {
            return new UpdateDeliverableRequest(this);
        } 
