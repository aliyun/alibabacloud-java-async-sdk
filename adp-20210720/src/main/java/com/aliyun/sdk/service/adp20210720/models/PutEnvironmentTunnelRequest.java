...
/**
 * {@link PutEnvironmentTunnelRequest} extends {@link RequestModel}
 *
 * <p>PutEnvironmentTunnelRequest</p>
 */
public class PutEnvironmentTunnelRequest extends Request {
    @Path
    @NameInMap("uid")
    ...
    private PutEnvironmentTunnelRequest(Builder builder) {
        super(builder);
    ...
    public static PutEnvironmentTunnelRequest create() {
    ...
    public static final class Builder extends Request.Builder<PutEnvironmentTunnelRequest, Builder> {
        private String uid; 
        private TunnelConfig tunnelConfig; 
        private String tunnelType; 
        ...
        private Builder(PutEnvironmentTunnelRequest request) {
            super(request);
        ...
        @Override
        public PutEnvironmentTunnelRequest build() {
            return new PutEnvironmentTunnelRequest(this);
        } 
