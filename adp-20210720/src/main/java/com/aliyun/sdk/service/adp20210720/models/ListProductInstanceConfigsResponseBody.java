...
/**
 * {@link ListProductInstanceConfigsResponseBody} extends {@link TeaModel}
 *
 * <p>ListProductInstanceConfigsResponseBody</p>
 */
public class ListProductInstanceConfigsResponseBody extends TeaModel {
    ...
    private ListProductInstanceConfigsResponseBody(Builder builder) {
    ...
    public static ListProductInstanceConfigsResponseBody create() {
    ...
    public static final class Builder {
        ...
        public ListProductInstanceConfigsResponseBody build() {
            return new ListProductInstanceConfigsResponseBody(this);
        } 
