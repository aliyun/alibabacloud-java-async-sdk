...
/**
 * {@link DescribeGlobalDatabaseNetworkRequest} extends {@link RequestModel}
 *
...
public class DescribeGlobalDatabaseNetworkRequest extends Request {
    ...
    public static DescribeGlobalDatabaseNetworkRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeGlobalDatabaseNetworkRequest, Builder> {
        ...
        private Builder(DescribeGlobalDatabaseNetworkRequest response) {
            super(response);
        ...
        @Override
        public DescribeGlobalDatabaseNetworkRequest build() {
            return new DescribeGlobalDatabaseNetworkRequest(this);
        } 
