...
/**
 * 
 * {@link DisablePolarClawChannelResponseBody} extends {@link TeaModel}
 *
 * <p>DisablePolarClawChannelResponseBody</p>
 */
public class DisablePolarClawChannelResponseBody extends TeaModel {
    ...
    private DisablePolarClawChannelResponseBody(Builder builder) {
    ...
    public static DisablePolarClawChannelResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(DisablePolarClawChannelResponseBody model) {
        ...
        /**
         * <p>The ID of the disabled channel.</p>
         * 
         * <strong>example:</strong>
         * <p>feishu</p>
         */
        ...
        public DisablePolarClawChannelResponseBody build() {
            return new DisablePolarClawChannelResponseBody(this);
        } 
