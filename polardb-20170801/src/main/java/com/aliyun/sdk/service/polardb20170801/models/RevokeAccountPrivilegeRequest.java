...
public class RevokeAccountPrivilegeRequest extends Request {
    ...
    private RevokeAccountPrivilegeRequest(Builder builder) {
        super(builder);
    ...
    public static RevokeAccountPrivilegeRequest create() {
    ...
    public static final class Builder extends Request.Builder<RevokeAccountPrivilegeRequest, Builder> {
        private String accountName; 
        private String DBClusterId; 
        private String DBName; 
        private String ownerAccount; 
        ...
        @Override
        public RevokeAccountPrivilegeRequest build() {
            return new RevokeAccountPrivilegeRequest(this);
        } 
