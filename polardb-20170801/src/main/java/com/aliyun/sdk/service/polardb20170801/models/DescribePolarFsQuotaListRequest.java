...
/**
 * 
 * {@link DescribePolarFsQuotaListRequest} extends {@link RequestModel}
 *
 * <p>DescribePolarFsQuotaListRequest</p>
 */
public class DescribePolarFsQuotaListRequest extends Request {
    ...
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("QuotaMode")
    ...
    public static DescribePolarFsQuotaListRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DescribePolarFsQuotaListRequest, Builder> {
        ...
        @Override
        public DescribePolarFsQuotaListRequest build() {
            return new DescribePolarFsQuotaListRequest(this);
        } 
