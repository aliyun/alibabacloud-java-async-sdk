...
/**
 * 
 * {@link AddPolarFsPathMappingRequest} extends {@link RequestModel}
 *
 * <p>AddPolarFsPathMappingRequest</p>
 */
public class AddPolarFsPathMappingRequest extends Request {
    ...
    private AddPolarFsPathMappingRequest(Builder builder) {
        super(builder);
    ...
    public static AddPolarFsPathMappingRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddPolarFsPathMappingRequest, Builder> {
        private java.util.List<CustomBucketPathList> customBucketPathList; 
        private String DBClusterId; 
        private String polarFsInstanceId; 
        ...
        private Builder(AddPolarFsPathMappingRequest request) {
            super(request);
        ...
        @Override
        public AddPolarFsPathMappingRequest build() {
            return new AddPolarFsPathMappingRequest(this);
        } 
    ...
    /**
     * 
     * {@link AddPolarFsPathMappingRequest} extends {@link TeaModel}
     *
     * <p>AddPolarFsPathMappingRequest</p>
     */
