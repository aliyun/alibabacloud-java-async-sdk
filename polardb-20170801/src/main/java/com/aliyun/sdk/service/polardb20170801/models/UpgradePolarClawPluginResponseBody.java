...
/**
 * 
 * {@link UpgradePolarClawPluginResponseBody} extends {@link TeaModel}
 *
 * <p>UpgradePolarClawPluginResponseBody</p>
 */
public class UpgradePolarClawPluginResponseBody extends TeaModel {
    ...
    private UpgradePolarClawPluginResponseBody(Builder builder) {
    ...
    public static UpgradePolarClawPluginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpgradePolarClawPluginResponseBody model) {
        ...
        public UpgradePolarClawPluginResponseBody build() {
            return new UpgradePolarClawPluginResponseBody(this);
        } 
