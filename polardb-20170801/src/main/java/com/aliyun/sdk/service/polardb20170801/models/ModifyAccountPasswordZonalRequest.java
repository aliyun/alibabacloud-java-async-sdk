...
/**
 * 
 * {@link ModifyAccountPasswordZonalRequest} extends {@link RequestModel}
 *
 * <p>ModifyAccountPasswordZonalRequest</p>
 */
public class ModifyAccountPasswordZonalRequest extends Request {
    ...
    private ModifyAccountPasswordZonalRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyAccountPasswordZonalRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyAccountPasswordZonalRequest, Builder> {
        private String accountName; 
        private String clientToken; 
        private String DBClusterId; 
        private String newAccountPassword; 
        ...
        private Builder(ModifyAccountPasswordZonalRequest request) {
            super(request);
        ...
        @Override
        public ModifyAccountPasswordZonalRequest build() {
            return new ModifyAccountPasswordZonalRequest(this);
        } 
