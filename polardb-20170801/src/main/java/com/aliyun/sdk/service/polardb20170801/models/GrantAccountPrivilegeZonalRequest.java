...
/**
 * 
 * {@link GrantAccountPrivilegeZonalRequest} extends {@link RequestModel}
 *
 * <p>GrantAccountPrivilegeZonalRequest</p>
 */
public class GrantAccountPrivilegeZonalRequest extends Request {
    ...
    private GrantAccountPrivilegeZonalRequest(Builder builder) {
        super(builder);
    ...
    public static GrantAccountPrivilegeZonalRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<GrantAccountPrivilegeZonalRequest, Builder> {
        private String accountName; 
        private String accountPrivilege; 
        private String clientToken; 
        private String DBClusterId; 
        ...
        private Builder(GrantAccountPrivilegeZonalRequest request) {
            super(request);
        ...
        @Override
        public GrantAccountPrivilegeZonalRequest build() {
            return new GrantAccountPrivilegeZonalRequest(this);
        } 
