 ...
 */
public class ResetGlobalDatabaseNetworkRequest extends Request {
    ...
    private ResetGlobalDatabaseNetworkRequest(Builder builder) {
        super(builder);
    ...
    public static ResetGlobalDatabaseNetworkRequest create() {
    ...
    public static final class Builder extends Request.Builder<ResetGlobalDatabaseNetworkRequest, Builder> {
        private String DBClusterId; 
        private String GDNId; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ResetGlobalDatabaseNetworkRequest request) {
            super(request);
        ...
        @Override
        public ResetGlobalDatabaseNetworkRequest build() {
            return new ResetGlobalDatabaseNetworkRequest(this);
        } 
