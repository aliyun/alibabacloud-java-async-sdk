 ...
 */
public class DeleteDBLinkRequest extends Request {
    @Query
    ...
    private DeleteDBLinkRequest(Builder builder) {
        super(builder);
    ...
    public static DeleteDBLinkRequest create() {
    ...
    public static final class Builder extends Request.Builder<DeleteDBLinkRequest, Builder> {
        private String DBClusterId; 
        private String DBLinkName; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        @Override
        public DeleteDBLinkRequest build() {
            return new DeleteDBLinkRequest(this);
        } 
