...
/**
 * 
 * {@link AddPolarOSSAuthorizedAccountResponseBody} extends {@link TeaModel}
 *
 * <p>AddPolarOSSAuthorizedAccountResponseBody</p>
 */
public class AddPolarOSSAuthorizedAccountResponseBody extends TeaModel {
    ...
    private AddPolarOSSAuthorizedAccountResponseBody(Builder builder) {
    ...
    public static AddPolarOSSAuthorizedAccountResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AddPolarOSSAuthorizedAccountResponseBody model) {
        ...
        public AddPolarOSSAuthorizedAccountResponseBody build() {
            return new AddPolarOSSAuthorizedAccountResponseBody(this);
        } 
