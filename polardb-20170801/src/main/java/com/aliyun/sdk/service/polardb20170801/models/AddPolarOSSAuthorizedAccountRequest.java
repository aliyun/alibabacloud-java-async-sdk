...
/**
 * 
 * {@link AddPolarOSSAuthorizedAccountRequest} extends {@link RequestModel}
 *
 * <p>AddPolarOSSAuthorizedAccountRequest</p>
 */
public class AddPolarOSSAuthorizedAccountRequest extends Request {
    ...
    private AddPolarOSSAuthorizedAccountRequest(Builder builder) {
        super(builder);
    ...
    public static AddPolarOSSAuthorizedAccountRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<AddPolarOSSAuthorizedAccountRequest, Builder> {
        private String authorizedUserIds; 
        private String DBClusterId; 
        private String pfsInstanceId; 
        private String regionId; 
        ...
        private Builder(AddPolarOSSAuthorizedAccountRequest request) {
            super(request);
        ...
        @Override
        public AddPolarOSSAuthorizedAccountRequest build() {
            return new AddPolarOSSAuthorizedAccountRequest(this);
        } 
