...
/**
 * 
 * {@link ModifyDBClusterMigrationEndpointRequest} extends {@link RequestModel}
 *
 * <p>ModifyDBClusterMigrationEndpointRequest</p>
 */
public class ModifyDBClusterMigrationEndpointRequest extends Request {
    ...
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("MigrationConfig")
    @com.aliyun.core.annotation.Validation(required = true)
    ...
    private ModifyDBClusterMigrationEndpointRequest(Builder builder) {
        super(builder);
        this.regionId = builder.regionId;
        this.DBClusterId = builder.DBClusterId;
        this.migrationConfig = builder.migrationConfig;
    ...
    public static ModifyDBClusterMigrationEndpointRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyDBClusterMigrationEndpointRequest, Builder> {
        private String regionId; 
        private String DBClusterId; 
        private String migrationConfig; 
        private String ownerAccount; 
        ...
        private Builder(ModifyDBClusterMigrationEndpointRequest request) {
            super(request);
            this.regionId = request.regionId;
            this.DBClusterId = request.DBClusterId;
            this.migrationConfig = request.migrationConfig;
        ...
        @Override
        public ModifyDBClusterMigrationEndpointRequest build() {
            return new ModifyDBClusterMigrationEndpointRequest(this);
        } 
