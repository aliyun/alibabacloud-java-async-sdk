...
/**
 * 
 * {@link ContinueDBClusterMigrationRequest} extends {@link RequestModel}
 *
 * <p>ContinueDBClusterMigrationRequest</p>
 */
public class ContinueDBClusterMigrationRequest extends Request {
    ...
    private ContinueDBClusterMigrationRequest(Builder builder) {
        super(builder);
    ...
    public static ContinueDBClusterMigrationRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ContinueDBClusterMigrationRequest, Builder> {
        private String DBClusterId; 
        private String forceSwitch; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        private Builder(ContinueDBClusterMigrationRequest request) {
            super(request);
        ...
        @Override
        public ContinueDBClusterMigrationRequest build() {
            return new ContinueDBClusterMigrationRequest(this);
        } 
