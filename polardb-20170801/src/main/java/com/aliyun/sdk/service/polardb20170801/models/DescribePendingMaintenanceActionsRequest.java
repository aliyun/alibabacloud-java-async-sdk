 ...
 */
public class DescribePendingMaintenanceActionsRequest extends Request {
    ...
    private DescribePendingMaintenanceActionsRequest(Builder builder) {
        super(builder);
    ...
    public static DescribePendingMaintenanceActionsRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribePendingMaintenanceActionsRequest, Builder> {
        private Integer isHistory; 
        private String ownerAccount; 
        private Long ownerId; 
        private String regionId; 
