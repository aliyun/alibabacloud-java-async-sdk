 ...
 */
public class CreateColdStorageInstanceRequest extends Request {
    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("ClientToken")
    private String clientToken;

    @com.aliyun.core.annotation.Query
    @com.aliyun.core.annotation.NameInMap("ColdStorageInstanceDescription")
    ...
    private CreateColdStorageInstanceRequest(Builder builder) {
        super(builder);
        this.clientToken = builder.clientToken;
        this.coldStorageInstanceDescription = builder.coldStorageInstanceDescription;
    ...
    public static CreateColdStorageInstanceRequest create() {
...
@Override
    ...
    /**
     * @return coldStorageInstanceDescription
     */
    ...
    public static final class Builder extends Request.Builder<CreateColdStorageInstanceRequest, Builder> {
        private String clientToken; 
        private String coldStorageInstanceDescription; 
        private String DBClusterId; 
        private String ownerAccount; 
        ...
        private Builder(CreateColdStorageInstanceRequest request) {
            super(request);
            this.clientToken = request.clientToken;
            this.coldStorageInstanceDescription = request.coldStorageInstanceDescription;
        ...
        @Override
        public CreateColdStorageInstanceRequest build() {
            return new CreateColdStorageInstanceRequest(this);
        } 
