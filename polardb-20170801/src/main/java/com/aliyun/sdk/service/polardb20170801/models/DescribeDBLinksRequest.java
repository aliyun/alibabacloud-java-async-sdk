 ...
 */
public class DescribeDBLinksRequest extends Request {
    @Query
    ...
    private DescribeDBLinksRequest(Builder builder) {
        super(builder);
    ...
    public static DescribeDBLinksRequest create() {
    ...
    public static final class Builder extends Request.Builder<DescribeDBLinksRequest, Builder> {
        private String DBClusterId; 
        private String DBLinkName; 
        private String ownerAccount; 
        private Long ownerId; 
        ...
        @Override
        public DescribeDBLinksRequest build() {
            return new DescribeDBLinksRequest(this);
        } 
