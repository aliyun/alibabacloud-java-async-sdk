...
/**
 * 
 * {@link ModifyEncryptionDBRolePrivilegeRequest} extends {@link RequestModel}
 *
 * <p>ModifyEncryptionDBRolePrivilegeRequest</p>
 */
public class ModifyEncryptionDBRolePrivilegeRequest extends Request {
    ...
    private ModifyEncryptionDBRolePrivilegeRequest(Builder builder) {
        super(builder);
    ...
    public static ModifyEncryptionDBRolePrivilegeRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<ModifyEncryptionDBRolePrivilegeRequest, Builder> {
        private String DBClusterId; 
        private String ownerAccount; 
        private Long ownerId; 
        private String resourceOwnerAccount; 
        ...
        private Builder(ModifyEncryptionDBRolePrivilegeRequest request) {
            super(request);
        ...
        @Override
        public ModifyEncryptionDBRolePrivilegeRequest build() {
            return new ModifyEncryptionDBRolePrivilegeRequest(this);
        } 
