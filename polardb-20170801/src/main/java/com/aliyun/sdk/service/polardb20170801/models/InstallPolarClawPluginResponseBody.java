...
/**
 * 
 * {@link InstallPolarClawPluginResponseBody} extends {@link TeaModel}
 *
 * <p>InstallPolarClawPluginResponseBody</p>
 */
public class InstallPolarClawPluginResponseBody extends TeaModel {
    ...
    private InstallPolarClawPluginResponseBody(Builder builder) {
    ...
    public static InstallPolarClawPluginResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(InstallPolarClawPluginResponseBody model) {
        ...
        public InstallPolarClawPluginResponseBody build() {
            return new InstallPolarClawPluginResponseBody(this);
        } 
