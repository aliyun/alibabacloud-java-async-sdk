...
/**
 * 
 * {@link UpdatePolarClawAgentResponseBody} extends {@link TeaModel}
 *
 * <p>UpdatePolarClawAgentResponseBody</p>
 */
public class UpdatePolarClawAgentResponseBody extends TeaModel {
    ...
    private UpdatePolarClawAgentResponseBody(Builder builder) {
    ...
    public static UpdatePolarClawAgentResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(UpdatePolarClawAgentResponseBody model) {
        ...
        public UpdatePolarClawAgentResponseBody build() {
            return new UpdatePolarClawAgentResponseBody(this);
        } 
