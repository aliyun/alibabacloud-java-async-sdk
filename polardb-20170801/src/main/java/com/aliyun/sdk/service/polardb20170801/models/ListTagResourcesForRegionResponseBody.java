...
/**
 * 
 * {@link ListTagResourcesForRegionResponseBody} extends {@link TeaModel}
 *
 * <p>ListTagResourcesForRegionResponseBody</p>
 */
public class ListTagResourcesForRegionResponseBody extends TeaModel {
    ...
    private ListTagResourcesForRegionResponseBody(Builder builder) {
    ...
    public static ListTagResourcesForRegionResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(ListTagResourcesForRegionResponseBody model) {
        ...
        public ListTagResourcesForRegionResponseBody build() {
            return new ListTagResourcesForRegionResponseBody(this);
        } 
