...
/**
 * {@link TagRequest} extends {@link RequestModel}
 *
 * <p>TagRequest</p>
 */
public class TagRequest extends Request {
    ...
    public static TagRequest create() {
    ...
    public static final class Builder extends Request.Builder<TagRequest, Builder> {
        private Long aliUid; 
        private String bid; 
        private java.util.List < String > keys; 
        private Long ownerId; 
        ...
        private Builder(TagRequest request) {
            super(request);
