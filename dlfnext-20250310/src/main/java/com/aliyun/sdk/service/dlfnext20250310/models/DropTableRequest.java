...
/**
 * 
 * {@link DropTableRequest} extends {@link RequestModel}
 *
 * <p>DropTableRequest</p>
 */
public class DropTableRequest extends Request {
    ...
    public static DropTableRequest create() {
...
@Override
    ...
    public static final class Builder extends Request.Builder<DropTableRequest, Builder> {
        private String catalogId; 
        private String database; 
        private String table; 
        ...
        private Builder(DropTableRequest request) {
            super(request);
