...
/**
 * 
 * {@link AlterDatabaseResponseBody} extends {@link TeaModel}
 *
 * <p>AlterDatabaseResponseBody</p>
 */
public class AlterDatabaseResponseBody extends TeaModel {
    ...
    private AlterDatabaseResponseBody(Builder builder) {
    ...
    public static AlterDatabaseResponseBody create() {
    ...
    public static final class Builder {
        ...
        private Builder(AlterDatabaseResponseBody model) {
        ...
        public AlterDatabaseResponseBody build() {
            return new AlterDatabaseResponseBody(this);
        } 
